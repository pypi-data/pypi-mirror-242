...
@LastEditTime: 2023-07-30 14:55:26
...
class AssetConsoleModel():
    ...
    def __init__(self):
        ...
        """
        self.db_connect_key = "db_asset" if config.get_value("db_asset") else "db_cloudapp"
        self.redis_config_dict = config.get_value("redis_asset") if config.get_value("redis_asset") else None
