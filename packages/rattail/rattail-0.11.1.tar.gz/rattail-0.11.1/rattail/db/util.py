...
from rattail.db.config import get_engines, get_default_engine, configure_session
...
class short_session(object):
    ...
    # TODO: should reorder kwargs per typical conventions?
    def __init__(self, session=None, Session=None, commit=False,
        ...
        if not self.factory and Session:
