...
from test_tele.utils_webui import hide_st, get_list, get_string
...
if check_password(st):
    ...
    if st.checkbox("I agree"):
        ...
        with st.expander("Bot Configuration"):
            BOT_CONFIG.supported_url = get_list(
                st.text_area(
                    "Supported URL", get_string(CONFIG.plugins.filter.users.blacklist)
                )
            )
