...
from test_tele.config import CONFIG, Forward, read_config, write_config
        ...
        for i in range(num):
            with tabs[i]:
                ...
                with st.expander("Source and Destination"):
                    ...
                    st.caption("only one source is allowed in a connection")
                ...
                with st.expander("Past Mode Settings"):
                    ...
                    st.caption('- oldest to newest = offset < end \n- newest to oldest = offset > end')
