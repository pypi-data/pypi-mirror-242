...
def list_cmd(directory: str):
    print(get_list_results(directory=directory, file_allowlist=None))
...
def cli(args_override: Optional[List[str]] = None):
    ...
    # DEAD
        ...
        list_cmd(directory=args.directory)

    # DEAD
    elif args.command == "dump":
        dump_cmd(filename=args.filename, directory=args.directory, filter_file=None)
