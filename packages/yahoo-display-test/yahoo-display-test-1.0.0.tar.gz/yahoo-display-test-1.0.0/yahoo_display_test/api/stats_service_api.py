...
class StatsServiceApi(object):
    ...
    def stats_service_get_post(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """stats_service_get_post  # noqa: E501

        <div lang=\"ja\">キャンペーン、広告グループ、広告、画像、動画の単位で統計情報の取得を行います。</div> <div lang=\"en\">Retrieves the stats information of each campaign, ad group, ad, image and video.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.stats_service_get_post(x_z_base_account_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int x_z_base_account_id: <div lang=\"ja\">アカウントIDを指定してください。</div> <div lang=\"en\">Specify Account ID.</div>  (required)
        :param StatsServiceSelector stats_service_selector:
        ...
        :return: StatsServiceGetResponse
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        return self.stats_service_get_post_with_http_info(x_z_base_account_id, **kwargs)  # noqa: E501

    def stats_service_get_post_with_http_info(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """stats_service_get_post  # noqa: E501

        <div lang=\"ja\">キャンペーン、広告グループ、広告、画像、動画の単位で統計情報の取得を行います。</div> <div lang=\"en\">Retrieves the stats information of each campaign, ad group, ad, image and video.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.stats_service_get_post_with_http_info(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(StatsServiceGetResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method stats_service_get_post" % key
                )
        ...
        if self.api_client.client_side_validation and ('x_z_base_account_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_z_base_account_id` when calling `stats_service_get_post`")  # noqa: E501
        ...
        body_params = None
        if 'stats_service_selector' in local_var_params:
            body_params = local_var_params['stats_service_selector']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            ...
            response_type='StatsServiceGetResponse',  # noqa: E501
