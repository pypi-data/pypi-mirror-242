...
import yahoo_display_test.models
from yahoo_display_test import rest
from yahoo_display_test.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(yahoo_display_test.models, klass)
