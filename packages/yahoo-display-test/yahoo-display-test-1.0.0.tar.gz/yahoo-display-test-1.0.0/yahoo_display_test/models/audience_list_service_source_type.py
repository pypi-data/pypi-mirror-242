...
class AudienceListServiceSourceType(object):
    ...
    allowable_values = [SITE_RETARGETING_TAG, CUSTOMER_DATA_FILE, APP_DATA, YAHOO_JAPAN_AUDIENCE_DISCOVERY, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AudienceListServiceSourceType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudienceListServiceSourceType):
            return False
