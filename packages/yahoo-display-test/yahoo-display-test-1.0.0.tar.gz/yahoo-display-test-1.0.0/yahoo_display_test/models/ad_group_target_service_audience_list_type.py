...
class AdGroupTargetServiceAudienceListType(object):
    ...
    allowable_values = [DEFAULT_LIST, COMBINATION, SIMILARITY, WEBSITE_VISITORS, CUSTOMER_DATA, OFFERED_BY_YAHOO_JAPAN, APP_USER, YAHOO_JAPAN_AUDIENCE_DISCOVERY, AFFINITY, IN_MARKET, ATTRIBUTE_LIFE_EVENTS, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AdGroupTargetServiceAudienceListType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupTargetServiceAudienceListType):
            return False
