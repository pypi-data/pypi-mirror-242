...
class ContentsKeywordListServiceContentsKeyword(object):
    ...
    def __init__(self, contents_keyword_id=None, local_vars_configuration=None):  # noqa: E501
        """ContentsKeywordListServiceContentsKeyword - a model defined in OpenAPI"""  # noqa: E501
    ...
    def contents_keyword_id(self):
        """Gets the contents_keyword_id of this ContentsKeywordListServiceContentsKeyword.  # noqa: E501

        <div lang=\"ja\"> コンテンツキーワードIDです。<br> このフィールドは、ADDおよびSET時に必須となります。 </div> <div lang=\"en\"> Contents keyword ID.<br> This field is required in ADD and SET operation. </div>   # noqa: E501

        :return: The contents_keyword_id of this ContentsKeywordListServiceContentsKeyword.  # noqa: E501
        :rtype: int
        """
    ...
    def contents_keyword_id(self, contents_keyword_id):
        """Sets the contents_keyword_id of this ContentsKeywordListServiceContentsKeyword.

        <div lang=\"ja\"> コンテンツキーワードIDです。<br> このフィールドは、ADDおよびSET時に必須となります。 </div> <div lang=\"en\"> Contents keyword ID.<br> This field is required in ADD and SET operation. </div>   # noqa: E501

        :param contents_keyword_id: The contents_keyword_id of this ContentsKeywordListServiceContentsKeyword.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ContentsKeywordListServiceContentsKeyword):
            return False
