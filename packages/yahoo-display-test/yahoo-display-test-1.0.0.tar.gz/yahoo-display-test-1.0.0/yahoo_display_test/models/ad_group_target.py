...
class AdGroupTarget(object):
    ...
    def ad_group_id(self):
        ...
        <div lang=\"ja\"> 広告グループIDです。<br> このフィールドは、リクエストの場合は必須です。<br> ※GuaranteedAdGroupServiceでADDおよびSETする際、このフィールドは無視されます。 </div> <div lang=\"en\"> Ad group ID.<br> This field is required in requests.<br> *This field will be ignored in ADD and SET operation via GuaranteedAdGroupService. </div>   # noqa: E501
    ...
    def campaign_id(self):
        ...
        <div lang=\"ja\"> キャンペーンIDです。<br> このフィールドは、リクエストの場合は必須です。<br> ※GuaranteedAdGroupServiceでADDおよびSETする際、このフィールドは無視されます。 </div> <div lang=\"en\"> Campaign ID.<br> This field is required in requests.<br> *This field will be ignored in ADD and SET operation via GuaranteedAdGroupService. </div>   # noqa: E501
