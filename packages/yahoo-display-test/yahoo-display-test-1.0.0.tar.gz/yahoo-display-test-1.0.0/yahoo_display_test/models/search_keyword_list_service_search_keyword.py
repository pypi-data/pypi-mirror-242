...
class SearchKeywordListServiceSearchKeyword(object):
    ...
    def __init__(self, search_keyword_id=None, local_vars_configuration=None):  # noqa: E501
        """SearchKeywordListServiceSearchKeyword - a model defined in OpenAPI"""  # noqa: E501
    ...
    def search_keyword_id(self):
        """Gets the search_keyword_id of this SearchKeywordListServiceSearchKeyword.  # noqa: E501

        <div lang=\"ja\"> サーチキーワードIDです。<br> このフィールドは、ADDおよびSET時に必須となります。 </div> <div lang=\"en\"> Search keyword ID.<br> This field is required in ADD and SET operation. </div>   # noqa: E501

        :return: The search_keyword_id of this SearchKeywordListServiceSearchKeyword.  # noqa: E501
        :rtype: int
        """
    ...
    def search_keyword_id(self, search_keyword_id):
        """Sets the search_keyword_id of this SearchKeywordListServiceSearchKeyword.

        <div lang=\"ja\"> サーチキーワードIDです。<br> このフィールドは、ADDおよびSET時に必須となります。 </div> <div lang=\"en\"> Search keyword ID.<br> This field is required in ADD and SET operation. </div>   # noqa: E501

        :param search_keyword_id: The search_keyword_id of this SearchKeywordListServiceSearchKeyword.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchKeywordListServiceSearchKeyword):
            return False
