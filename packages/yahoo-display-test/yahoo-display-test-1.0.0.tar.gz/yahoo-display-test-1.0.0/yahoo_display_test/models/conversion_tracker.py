...
class ConversionTracker(object):
    ...
    openapi_types = {
        ...
        'is_previous_conversion': 'ConversionTrackerServiceIsPreviousConversion',
        'advanced_matching_enabled': 'ConversionTrackerServiceAdvancedMatchingEnabled'
    }
    ...
    attribute_map = {
        ...
        'is_previous_conversion': 'isPreviousConversion',
        'advanced_matching_enabled': 'advancedMatchingEnabled'
    }

    def __init__(self, account_id=None, all_conversion_value=None, all_conversions=None, view_through_conversions=None, app_conversion=None, category=None, conversion_tracker_id=None, conversion_tracker_name=None, conversion_tracker_type=None, conversion_value=None, conversion_value_via_ad_click=None, conversions=None, conversions_via_ad_click=None, counting_type=None, cross_device_conversions=None, exclude_from_bidding=None, measurement_period=None, measurement_period_view=None, most_recent_conversion_date=None, status=None, user_revenue_value=None, web_conversion=None, is_previous_conversion=None, advanced_matching_enabled=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._view_through_conversions = None
        ...
        self._is_previous_conversion = None
        self._advanced_matching_enabled = None
        self.discriminator = None

        self.account_id = account_id
        self.all_conversion_value = all_conversion_value
        self.all_conversions = all_conversions
        self.view_through_conversions = view_through_conversions
        ...
        self.is_previous_conversion = is_previous_conversion
        self.advanced_matching_enabled = advanced_matching_enabled
    ...
    def all_conversion_value(self):
        ...
        <div lang=\"ja\"> コンバージョンの価値（全て）です。<br> ADD、SET時のレスポンスではnullで返却されます。必要な場合はGETしてください。 </div> <div lang=\"en\"> Conv. value (all).<br> ADD and SET responses will return null. Please GET if necessary. </div>   # noqa: E501
    ...
    def all_conversions(self):
        ...
        <div lang=\"ja\"> コンバージョン数（全て）です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> ADD、SET時のレスポンスではnullで返却されます。必要な場合はGETしてください。 </div> <div lang=\"en\"> Conversions (all).<br> Although this field will be returned in the response, it will be ignored on input.<br> ADD and SET responses will return null. Please GET if necessary. </div>   # noqa: E501
    ...
    @property
    def view_through_conversions(self):
        """Gets the view_through_conversions of this ConversionTracker.  # noqa: E501

        <div lang=\"ja\">ビュースルーコンバージョン数</div> <div lang=\"en\">View through conversions</div>   # noqa: E501

        :return: The view_through_conversions of this ConversionTracker.  # noqa: E501
        :rtype: int
        """
        return self._view_through_conversions

    @view_through_conversions.setter
    def view_through_conversions(self, view_through_conversions):
        """Sets the view_through_conversions of this ConversionTracker.

        <div lang=\"ja\">ビュースルーコンバージョン数</div> <div lang=\"en\">View through conversions</div>   # noqa: E501

        :param view_through_conversions: The view_through_conversions of this ConversionTracker.  # noqa: E501
        :type: int
        """

        self._view_through_conversions = view_through_conversions
    ...
    def conversion_value(self):
        ...
        <div lang=\"ja\"> コンバージョンの価値/コンバージョン数です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> ADD、SET時のレスポンスではnullで返却されます。必要な場合はGETしてください。 </div> <div lang=\"en\"> Conv. value/conv.<br> Although this field will be returned in the response, it will be ignored on input.<br> ADD and SET responses will return null. Please GET if necessary. </div>   # noqa: E501
    ...
    def conversion_value_via_ad_click(self):
        ...
        <div lang=\"ja\"> コンバージョンの価値（クリック経由）です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> ADD、SET時のレスポンスではnullで返却されます。必要な場合はGETしてください。 </div> <div lang=\"en\"> Conv. value (via click).<br> Although this field will be returned in the response, it will be ignored on input.<br> ADD and SET responses will return null. Please GET if necessary. </div>   # noqa: E501
    ...
    def conversions(self):
        ...
        <div lang=\"ja\"> コンバージョン数です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> ADD、SET時のレスポンスではnullで返却されます。必要な場合はGETしてください。 </div> <div lang=\"en\"> Conversions.<br> Although this field will be returned in the response, it will be ignored on input.<br> ADD and SET responses will return null. Please GET if necessary. </div>   # noqa: E501
    ...
    def conversions_via_ad_click(self):
        ...
        <div lang=\"ja\"> コンバージョン数（クリック経由）です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> ADD、SET時のレスポンスではnullで返却されます。必要な場合はGETしてください。 </div> <div lang=\"en\"> Conversions (via click).<br> Although this field will be returned in the response, it will be ignored on input.<br> ADD and SET responses will return null. Please GET if necessary. </div>   # noqa: E501
    ...
    def measurement_period_view(self):
        ...
        <div lang=\"ja\"> 測定期間（動画視聴）<br> ※1-30の範囲で指定可能です。<br> このフィールドは、リクエストの場合は省略可能です。ADD時のデフォルト設定値は3となります。 </div> <div lang=\"en\"> Counting period (video view).<br> ∗ Can be specified within the range of 1 to 30.<br> This field is optional in requests. The default value in ADD operation will be 3. </div>   # noqa: E501
    ...
    @property
    def is_previous_conversion(self):
        """Gets the is_previous_conversion of this ConversionTracker.  # noqa: E501


        :return: The is_previous_conversion of this ConversionTracker.  # noqa: E501
        :rtype: ConversionTrackerServiceIsPreviousConversion
        """
        return self._is_previous_conversion

    @is_previous_conversion.setter
    def is_previous_conversion(self, is_previous_conversion):
        """Sets the is_previous_conversion of this ConversionTracker.


        :param is_previous_conversion: The is_previous_conversion of this ConversionTracker.  # noqa: E501
        :type: ConversionTrackerServiceIsPreviousConversion
        """

        self._is_previous_conversion = is_previous_conversion

    @property
    def advanced_matching_enabled(self):
        """Gets the advanced_matching_enabled of this ConversionTracker.  # noqa: E501


        :return: The advanced_matching_enabled of this ConversionTracker.  # noqa: E501
        :rtype: ConversionTrackerServiceAdvancedMatchingEnabled
        """
        return self._advanced_matching_enabled

    @advanced_matching_enabled.setter
    def advanced_matching_enabled(self, advanced_matching_enabled):
        """Sets the advanced_matching_enabled of this ConversionTracker.


        :param advanced_matching_enabled: The advanced_matching_enabled of this ConversionTracker.  # noqa: E501
        :type: ConversionTrackerServiceAdvancedMatchingEnabled
        """

        self._advanced_matching_enabled = advanced_matching_enabled
