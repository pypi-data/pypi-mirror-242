...
class DictionaryServiceSharedAudienceListType(object):
    ...
    allowable_values = [AFFINITY, IN_MARKET, ATTRIBUTE_LIFE_EVENTS, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """DictionaryServiceSharedAudienceListType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DictionaryServiceSharedAudienceListType):
            return False
