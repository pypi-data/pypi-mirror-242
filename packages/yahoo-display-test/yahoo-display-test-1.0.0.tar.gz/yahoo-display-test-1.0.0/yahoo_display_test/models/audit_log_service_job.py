...
class AuditLogServiceJob(object):
    ...
    def __init__(self, account_id=None, audit_log_job_end_date=None, audit_log_job_id=None, audit_log_job_name=None, audit_log_job_start_date=None, audit_log_job_user_name=None, campaign_ids=None, date_range=None, encoding=None, job_status=None, lang=None, output=None, progress=None, source_type=None, local_vars_configuration=None):  # noqa: E501
