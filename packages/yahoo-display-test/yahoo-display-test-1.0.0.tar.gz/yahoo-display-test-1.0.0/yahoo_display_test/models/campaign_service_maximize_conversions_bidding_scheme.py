...
class CampaignServiceMaximizeConversionsBiddingScheme(object):
    ...
    def __init__(self, target_cpa=None, local_vars_configuration=None):  # noqa: E501
    ...
    def target_cpa(self):
        ...
        <div lang=\"ja\"> キャンペーン目標単価(tCPA)です。<br> ADDおよびSET時、このフィールドは任意で指定できます。<br> SET時、BiddingStrategyTypeにMAXIMIZE_CONVERSIONSが指定されていて、targetCpaを指定しない場合、targetCpaの値がクリアされます。 </div> <div lang=\"en\"> Target CPA (tCPA) of campaign.<br> This field can be optionally specified in ADD and SET operation.<br> If BiddingStrategyType is MAXIMIZE_CONVERSION and targetCpa is not specified in SET operation, the value in this field will be cleared. </div>   # noqa: E501
