...
class FeedFtpServiceScheduleDaily(object):
    ...
    @property
    def time(self):
        """Gets the time of this FeedFtpServiceScheduleDaily.  # noqa: E501
        ...
        :return: The time of this FeedFtpServiceScheduleDaily.  # noqa: E501
        :rtype: int
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this FeedFtpServiceScheduleDaily.

        <div lang=\"ja\"> 何時に実行するかを表します。<br> このフィールドは、リクエストの場合は必須です。 </div> <div lang=\"en\"> Execution time.<br> This field is required in requests. </div>   # noqa: E501

        :param time: The time of this FeedFtpServiceScheduleDaily.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedFtpServiceScheduleDaily):
            return False
