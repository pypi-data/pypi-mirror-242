...
class AdGroupAdServiceButtonText(object):
    ...
    allowable_values = [FOR_MORE_INFO, CONFIRM_NOW, APPLY_HERE, PURCHASE, EXPERIENCE, CONFIRM_PROPERTY, REQUEST_INFO, DOWNLOAD, INSTALL, MORE_DETAIL, RESERVE_HERE, REGISTER, APPLY_NOW, PURCHASE_NOW, RESERVE_NOW, REGISTER_NOW, CONTACT_US, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AdGroupAdServiceButtonText - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupAdServiceButtonText):
            return False
