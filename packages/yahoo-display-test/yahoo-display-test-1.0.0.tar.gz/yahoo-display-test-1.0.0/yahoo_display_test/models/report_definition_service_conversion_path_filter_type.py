...
class ReportDefinitionServiceConversionPathFilterType(object):
    ...
    allowable_values = [CAMPAIGN_ID, CAMPAIGN_NAME, CONVERSION_ID, ADGROUP_ID, ADGROUP_NAME, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ReportDefinitionServiceConversionPathFilterType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportDefinitionServiceConversionPathFilterType):
            return False
