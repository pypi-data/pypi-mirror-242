...
class ReportDefinition(object):
    ...
    openapi_types = {
        ...
        'report_name': 'str',
        'request_time': 'str',
        'report_skip_column_header': 'ReportDefinitionServiceReportSkipColumnHeader',
        'report_skip_report_summary': 'ReportDefinitionServiceReportSkipReportSummary',
        'report_decimal_part_display_type': 'ReportDefinitionServiceReportDecimalPartDisplayType',
        'report_type_condition': 'ReportDefinitionServiceReportTypeCondition',
    ...
    def __init__(self, account_id=None, complete_time=None, date_range=None, fields=None, filters=None, report_compress_type=None, report_date_range_type=None, report_download_encode=None, report_download_format=None, report_include_deleted=None, report_job_status=None, report_job_error_detail=None, report_job_id=None, report_language=None, report_name=None, request_time=None, report_skip_column_header=None, report_skip_report_summary=None, report_decimal_part_display_type=None, report_type_condition=None, sort_fields=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._report_skip_column_header = None
        self._report_skip_report_summary = None
        self._report_decimal_part_display_type = None
        self._report_type_condition = None
        ...
        self.report_skip_column_header = report_skip_column_header
        self.report_skip_report_summary = report_skip_report_summary
        self.report_decimal_part_display_type = report_decimal_part_display_type
        self.report_type_condition = report_type_condition
    ...
    def complete_time(self):
        ...
        <div lang=\"ja\"> ジョブ完了日時です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> ※フォーマット: yyyy/MM/dd HH:mm:ss </div> <div lang=\"en\"> The date and time of Job completion. <br> Although this field will be returned in the response, it will be ignored on input.<br> *Format: yyyy/MM/dd HH:mm:ss </div>   # noqa: E501
    ...
    def report_job_error_detail(self):
        ...
        <div lang=\"ja\"> ジョブエラー詳細です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> 「Over limit of file size.」が返される場合は、レポートのサイズが小さくなるようにレポート作成時の条件を変更してください。 </div> <div lang=\"en\"> Job error detail. <br> Although this field will be returned in the response, it will be ignored on input.<br> If the message \"Over limit of file size.\" is returned, change the report creation conditions to reduce the size of the report. </div>   # noqa: E501
    ...
    def request_time(self):
        ...
        <div lang=\"ja\"> リクエストの到着日時です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。<br> ※フォーマット: yyyy/MM/dd HH:mm:ss </div> <div lang=\"en\"> Arrival date and time of your request. <br> Although this field will be returned in the response, it will be ignored on input.<br> *Format: yyyy/MM/dd HH:mm:ss </div>   # noqa: E501
    ...
    @property
    def report_skip_column_header(self):
        """Gets the report_skip_column_header of this ReportDefinition.  # noqa: E501


        :return: The report_skip_column_header of this ReportDefinition.  # noqa: E501
        :rtype: ReportDefinitionServiceReportSkipColumnHeader
        """
        return self._report_skip_column_header

    @report_skip_column_header.setter
    def report_skip_column_header(self, report_skip_column_header):
        """Sets the report_skip_column_header of this ReportDefinition.


        :param report_skip_column_header: The report_skip_column_header of this ReportDefinition.  # noqa: E501
        :type: ReportDefinitionServiceReportSkipColumnHeader
        """

        self._report_skip_column_header = report_skip_column_header

    @property
    def report_skip_report_summary(self):
        """Gets the report_skip_report_summary of this ReportDefinition.  # noqa: E501


        :return: The report_skip_report_summary of this ReportDefinition.  # noqa: E501
        :rtype: ReportDefinitionServiceReportSkipReportSummary
        """
        return self._report_skip_report_summary

    @report_skip_report_summary.setter
    def report_skip_report_summary(self, report_skip_report_summary):
        """Sets the report_skip_report_summary of this ReportDefinition.


        :param report_skip_report_summary: The report_skip_report_summary of this ReportDefinition.  # noqa: E501
        :type: ReportDefinitionServiceReportSkipReportSummary
        """

        self._report_skip_report_summary = report_skip_report_summary

    @property
    def report_decimal_part_display_type(self):
        """Gets the report_decimal_part_display_type of this ReportDefinition.  # noqa: E501


        :return: The report_decimal_part_display_type of this ReportDefinition.  # noqa: E501
        :rtype: ReportDefinitionServiceReportDecimalPartDisplayType
        """
        return self._report_decimal_part_display_type

    @report_decimal_part_display_type.setter
    def report_decimal_part_display_type(self, report_decimal_part_display_type):
        """Sets the report_decimal_part_display_type of this ReportDefinition.


        :param report_decimal_part_display_type: The report_decimal_part_display_type of this ReportDefinition.  # noqa: E501
        :type: ReportDefinitionServiceReportDecimalPartDisplayType
        """

        self._report_decimal_part_display_type = report_decimal_part_display_type

    @property
    def report_type_condition(self):
        """Gets the report_type_condition of this ReportDefinition.  # noqa: E501


        :return: The report_type_condition of this ReportDefinition.  # noqa: E501
        :rtype: ReportDefinitionServiceReportTypeCondition
        """
        return self._report_type_condition

    @report_type_condition.setter
    def report_type_condition(self, report_type_condition):
        """Sets the report_type_condition of this ReportDefinition.


        :param report_type_condition: The report_type_condition of this ReportDefinition.  # noqa: E501
        :type: ReportDefinitionServiceReportTypeCondition
        """

        self._report_type_condition = report_type_condition
