...
class FeedServiceSourceType(object):
    ...
    allowable_values = [FTP_SCHEDULE, FTP_DIRECT, API, FTP_AND_API, CAMPAIGN_MANAGEMENT_TOOL, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """FeedServiceSourceType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedServiceSourceType):
            return False
