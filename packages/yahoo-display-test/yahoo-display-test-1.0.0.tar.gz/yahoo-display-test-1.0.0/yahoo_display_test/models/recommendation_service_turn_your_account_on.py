...
class RecommendationServiceTurnYourAccountOn(object):
    ...
    def __init__(self, recommendation_id=None, local_vars_configuration=None):  # noqa: E501
        """RecommendationServiceTurnYourAccountOn - a model defined in OpenAPI"""  # noqa: E501
    ...
    def recommendation_id(self):
        """Gets the recommendation_id of this RecommendationServiceTurnYourAccountOn.  # noqa: E501
        ...
        :return: The recommendation_id of this RecommendationServiceTurnYourAccountOn.  # noqa: E501
        :rtype: int
        """
    ...
    def recommendation_id(self, recommendation_id):
        """Sets the recommendation_id of this RecommendationServiceTurnYourAccountOn.

        <div lang=\"ja\"> 最適化提案IDです。<br> optimizationScoreLiftがnullでない場合は、1つのキャンペーンに関する提案に共通の最適化提案IDが割り当てられます。 </div> <div lang=\"en\"> Recommendation ID.<br> When optimizationScoreLift isn't null, the system will assign a common recommendation ID to the suggestion for the campaign. </div>   # noqa: E501

        :param recommendation_id: The recommendation_id of this RecommendationServiceTurnYourAccountOn.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RecommendationServiceTurnYourAccountOn):
            return False
