...
class StatsServiceTargetType(object):
    ...
    allowable_values = [AD_SCHEDULE_TARGET, GEO_TARGET, AGE_TARGET, GENDER_TARGET, SITE_CATEGORY, AUDIENCE_LIST_TARGET, SEARCH_TARGET, PLACEMENT_TARGET, DEVICE_TARGET, AUDIENCE_CATEGORY, PLACEMENT_CATEGORY_DETAIL_TARGET, CONTENTS_TARGET, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """StatsServiceTargetType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatsServiceTargetType):
            return False
