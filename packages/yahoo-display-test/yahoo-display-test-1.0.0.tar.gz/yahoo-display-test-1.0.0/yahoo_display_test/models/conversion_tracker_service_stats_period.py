...
class ConversionTrackerServiceStatsPeriod(object):
    ...
    allowable_values = [DEFINITE_VALUE_YESTERDAY, DEFINITE_VALUE_LASTBSDAY, DEFINITE_VALUE_LASTWEEK, DEFINITE_VALUE_WEEK, DEFINITE_VALUE_TWOWEEK, DEFINITE_VALUE_THIRTYDAY, DEFINITE_VALUE_LASTMONTH, REALTIME_TODAY, REALTIME_MONTH, REALTIME_LAST25MONTH, REALTIME_LAST37MONTH, CUSTOM_DATE, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ConversionTrackerServiceStatsPeriod - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConversionTrackerServiceStatsPeriod):
            return False
