...
class StatsServiceType(object):
    ...
    allowable_values = [CAMPAIGN, ADGROUP, AD, IMAGE, VIDEO, TARGET, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """StatsServiceType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatsServiceType):
            return False
