...
class FeedSetServiceConditionType(object):
    ...
    allowable_values = [CATEGORY_ID, STOCK_QUANTITY, PRICE, SALE_PRICE, RATING, REVIEWS, BADGE, AGE_GROUP, AVAILABILITY_DATE, GENDER_GROUP, GOOGLE_PRODUCT_CATEGORY, LOCATION, SALES_RANK, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """FeedSetServiceConditionType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedSetServiceConditionType):
            return False
