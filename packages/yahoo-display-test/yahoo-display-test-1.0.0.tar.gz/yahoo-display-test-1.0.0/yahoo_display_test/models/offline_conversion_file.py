...
class OfflineConversionFile(object):
    ...
    def __init__(self, account_id=None, upload_id=None, upload_file_name=None, uploaded_date=None, upload_source_type=None, process_status=None, local_vars_configuration=None):  # noqa: E501
