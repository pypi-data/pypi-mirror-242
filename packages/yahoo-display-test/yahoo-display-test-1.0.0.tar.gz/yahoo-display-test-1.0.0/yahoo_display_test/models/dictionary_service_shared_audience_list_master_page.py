...
class DictionaryServiceSharedAudienceListMasterPage(object):
    ...
    openapi_types = {
        ...
        'values': 'list[DictionaryServiceSharedAudienceListMasterValue]'
    }
    ...
    def __init__(self, total_num_entries=None, values=None, local_vars_configuration=None):  # noqa: E501
        """DictionaryServiceSharedAudienceListMasterPage - a model defined in OpenAPI"""  # noqa: E501
    ...
    def total_num_entries(self):
        """Gets the total_num_entries of this DictionaryServiceSharedAudienceListMasterPage.  # noqa: E501

        <div lang=\"ja\">取得される項目の総件数です。</div> <div lang=\"en\">Total number of items to be retrieved.</div>   # noqa: E501

        :return: The total_num_entries of this DictionaryServiceSharedAudienceListMasterPage.  # noqa: E501
        :rtype: int
        """
    ...
    def total_num_entries(self, total_num_entries):
        """Sets the total_num_entries of this DictionaryServiceSharedAudienceListMasterPage.

        <div lang=\"ja\">取得される項目の総件数です。</div> <div lang=\"en\">Total number of items to be retrieved.</div>   # noqa: E501

        :param total_num_entries: The total_num_entries of this DictionaryServiceSharedAudienceListMasterPage.  # noqa: E501
        :type: int
        """
    ...
    @property
    def values(self):
        """Gets the values of this DictionaryServiceSharedAudienceListMasterPage.  # noqa: E501


        :return: The values of this DictionaryServiceSharedAudienceListMasterPage.  # noqa: E501
        :rtype: list[DictionaryServiceSharedAudienceListMasterValue]
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this DictionaryServiceSharedAudienceListMasterPage.


        :param values: The values of this DictionaryServiceSharedAudienceListMasterPage.  # noqa: E501
        :type: list[DictionaryServiceSharedAudienceListMasterValue]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DictionaryServiceSharedAudienceListMasterPage):
            return False
