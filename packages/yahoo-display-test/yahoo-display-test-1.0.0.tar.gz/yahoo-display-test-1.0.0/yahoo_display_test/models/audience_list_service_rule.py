...
class AudienceListServiceRule(object):
    ...
    """
    openapi_types = {
        'rule_conditions': 'list[AudienceListServiceRuleCondition]'
    }
    ...
    def __init__(self, rule_conditions=None, local_vars_configuration=None):  # noqa: E501
        """AudienceListServiceRule - a model defined in OpenAPI"""  # noqa: E501
    ...
    def rule_conditions(self):
        """Gets the rule_conditions of this AudienceListServiceRule.  # noqa: E501


        :return: The rule_conditions of this AudienceListServiceRule.  # noqa: E501
        :rtype: list[AudienceListServiceRuleCondition]
        """
        return self._rule_conditions

    @rule_conditions.setter
    def rule_conditions(self, rule_conditions):
        """Sets the rule_conditions of this AudienceListServiceRule.


        :param rule_conditions: The rule_conditions of this AudienceListServiceRule.  # noqa: E501
        :type: list[AudienceListServiceRuleCondition]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudienceListServiceRule):
            return False
