...
class SearchKeywordIdeaServiceSortField(object):
    ...
    allowable_values = [KEYWORD, KEYWORD_ID, DESKTOP_SEARCH_VOLUME, SMART_PHONE_SEARCH_VOLUME, TABLET_SEARCH_VOLUME, RELEASE_DATE, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """SearchKeywordIdeaServiceSortField - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchKeywordIdeaServiceSortField):
            return False
