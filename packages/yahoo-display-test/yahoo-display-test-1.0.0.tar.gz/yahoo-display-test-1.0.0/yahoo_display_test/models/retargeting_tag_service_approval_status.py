...
class RetargetingTagServiceApprovalStatus(object):
    ...
    allowable_values = [AVAILABLE, DISAPPROVED, DISAPPROVED_WITH_REVIEW, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """RetargetingTagServiceApprovalStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RetargetingTagServiceApprovalStatus):
            return False
