...
class CampaignServiceBudget(object):
    ...
    def amount(self):
        ...
        <div lang=\"ja\"> キャンペーンの一日あたりの予算（一日単位の利用金額）です。<br> ADD時、このフィールドは必須となります。 </div> <div lang=\"en\"> The daily budget.<br> In ADD operation, this field is required. </div>   # noqa: E501
