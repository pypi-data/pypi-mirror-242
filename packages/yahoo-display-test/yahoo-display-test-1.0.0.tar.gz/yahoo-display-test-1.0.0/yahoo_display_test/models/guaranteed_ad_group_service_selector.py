...
class GuaranteedAdGroupServiceSelector(object):
    ...
    def __init__(self, account_id=None, campaign_ids=None, ad_group_ids=None, contains_label_id_flg=None, label_ids=None, number_results=500, start_index=1, local_vars_configuration=None):  # noqa: E501
        """GuaranteedAdGroupServiceSelector - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this GuaranteedAdGroupServiceSelector.  # noqa: E501

        <div lang=\"ja\">検索条件 : アカウントID</div> <div lang=\"en\">Search condition: Account ID</div>   # noqa: E501

        :return: The account_id of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :rtype: int
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this GuaranteedAdGroupServiceSelector.

        <div lang=\"ja\">検索条件 : アカウントID</div> <div lang=\"en\">Search condition: Account ID</div>   # noqa: E501

        :param account_id: The account_id of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :type: int
        """
    ...
    def campaign_ids(self):
        """Gets the campaign_ids of this GuaranteedAdGroupServiceSelector.  # noqa: E501

        <div lang=\"ja\">検索条件 : キャンペーンID</div> <div lang=\"en\">Search condition: Campaign ID</div>   # noqa: E501

        :return: The campaign_ids of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def campaign_ids(self, campaign_ids):
        """Sets the campaign_ids of this GuaranteedAdGroupServiceSelector.

        <div lang=\"ja\">検索条件 : キャンペーンID</div> <div lang=\"en\">Search condition: Campaign ID</div>   # noqa: E501

        :param campaign_ids: The campaign_ids of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :type: list[int]
        """
    ...
    def ad_group_ids(self):
        """Gets the ad_group_ids of this GuaranteedAdGroupServiceSelector.  # noqa: E501

        <div lang=\"ja\">検索条件 : 広告グループID</div> <div lang=\"en\">Search condition: Ad group ID</div>   # noqa: E501

        :return: The ad_group_ids of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def ad_group_ids(self, ad_group_ids):
        """Sets the ad_group_ids of this GuaranteedAdGroupServiceSelector.

        <div lang=\"ja\">検索条件 : 広告グループID</div> <div lang=\"en\">Search condition: Ad group ID</div>   # noqa: E501

        :param ad_group_ids: The ad_group_ids of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :type: list[int]
        """
    ...
    def contains_label_id_flg(self):
        """Gets the contains_label_id_flg of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        ...
        :return: The contains_label_id_flg of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :rtype: bool
        """
    ...
    def contains_label_id_flg(self, contains_label_id_flg):
        """Sets the contains_label_id_flg of this GuaranteedAdGroupServiceSelector.

        <div lang=\"ja\">ラベルID取得フラグです。<br> このフィールドは省略可能となります。その際、デフォルト値はfalseとなります。 </div> <div lang=\"en\">Flag of contains label ID.<br> This field is optional. The default value will be false. </div>   # noqa: E501

        :param contains_label_id_flg: The contains_label_id_flg of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def label_ids(self):
        """Gets the label_ids of this GuaranteedAdGroupServiceSelector.  # noqa: E501

        <div lang=\"ja\">検索条件 : ラベルID</div> <div lang=\"en\">Search condition: Label ID</div>   # noqa: E501

        :return: The label_ids of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def label_ids(self, label_ids):
        """Sets the label_ids of this GuaranteedAdGroupServiceSelector.

        <div lang=\"ja\">検索条件 : ラベルID</div> <div lang=\"en\">Search condition: Label ID</div>   # noqa: E501

        :param label_ids: The label_ids of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :type: list[int]
        """
    ...
    def number_results(self):
        """Gets the number_results of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        ...
        :return: The number_results of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :rtype: int
        """
    ...
    def number_results(self, number_results):
        """Sets the number_results of this GuaranteedAdGroupServiceSelector.

        <div lang=\"ja\">ページの最大件数です。このフィールドは、1以上を指定する必要があります。</div> <div lang=\"en\">Maximum number of results to return in this page. This field must be greater than or equal to 1. Also see Entity Limits per operation.</div>   # noqa: E501

        :param number_results: The number_results of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :type: int
        """
    ...
    def start_index(self):
        """Gets the start_index of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        ...
        :return: The start_index of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :rtype: int
        """
    ...
    def start_index(self, start_index):
        """Sets the start_index of this GuaranteedAdGroupServiceSelector.

        <div lang=\"ja\">ページの先頭のインデックスです。このフィールドは、1以上を指定する必要があります。</div> <div lang=\"en\">Index of the first result to return in this page. This field must be greater than or equal to 1.</div>   # noqa: E501

        :param start_index: The start_index of this GuaranteedAdGroupServiceSelector.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedAdGroupServiceSelector):
            return False
