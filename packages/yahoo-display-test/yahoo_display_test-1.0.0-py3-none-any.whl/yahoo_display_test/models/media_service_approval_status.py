...
class MediaServiceApprovalStatus(object):
    ...
    allowable_values = [APPROVED, REVIEW, PRE_DISAPPROVED, POST_DISAPPROVED, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """MediaServiceApprovalStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MediaServiceApprovalStatus):
            return False
