...
class AudienceListServiceAppVendor(object):
    ...
    allowable_values = [ADJUST, APPSFLYER, BRANCH, KOCHAVA, SINGULAR, METAPS, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AudienceListServiceAppVendor - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudienceListServiceAppVendor):
            return False
