...
class ReportDefinitionServiceFrequencyRange(object):
    ...
    allowable_values = [DAILY, WEEKLY, MONTHLY, GUARANTEED_CAMPAIGN_PERIOD, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ReportDefinitionServiceFrequencyRange - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportDefinitionServiceFrequencyRange):
            return False
