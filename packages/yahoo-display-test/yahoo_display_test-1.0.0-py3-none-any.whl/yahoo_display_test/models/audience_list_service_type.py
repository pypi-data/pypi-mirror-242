...
class AudienceListServiceType(object):
    ...
    allowable_values = [DEFAULT_LIST, COMBINATION, SIMILARITY, WEBSITE_VISITORS, CUSTOMER_DATA, APP_USER, YAHOO_JAPAN_AUDIENCE_DISCOVERY, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AudienceListServiceType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudienceListServiceType):
            return False
