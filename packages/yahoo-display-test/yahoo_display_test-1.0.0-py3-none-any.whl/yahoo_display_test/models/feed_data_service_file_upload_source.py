...
class FeedDataServiceFileUploadSource(object):
    ...
    allowable_values = [CAMPAIGN_MANAGEMENT_TOOL, API, FTP_SCHEDULE, FTP_DIRECT, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """FeedDataServiceFileUploadSource - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedDataServiceFileUploadSource):
            return False
