...
class FeedItemServiceReturnValue(object):
    ...
    @property
    def values(self):
        """Gets the values of this FeedItemServiceReturnValue.  # noqa: E501


        :return: The values of this FeedItemServiceReturnValue.  # noqa: E501
    ...
    def values(self, values):
        """Sets the values of this FeedItemServiceReturnValue.


        :param values: The values of this FeedItemServiceReturnValue.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedItemServiceReturnValue):
            return False
