...
class GuaranteedAdGroupAdLandingPageStatus(object):
    ...
    allowable_values = [COMPLETED, SPECIFIED_UPDATE_SCHEDULED_TIME, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GuaranteedAdGroupAdLandingPageStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedAdGroupAdLandingPageStatus):
            return False
