...
class ReportDefinitionServiceFilterOperator(object):
    ...
    allowable_values = [EQUALS, NOT_EQUALS, GREATER_THAN, GREATER_THAN_EQUALS, LESS_THAN, LESS_THAN_EQUALS, CONTAINS, IN, CONTAINS_ALL, CONTAINS_ANY, NOT_IN, UNKNOWN]  # noqa: E501
