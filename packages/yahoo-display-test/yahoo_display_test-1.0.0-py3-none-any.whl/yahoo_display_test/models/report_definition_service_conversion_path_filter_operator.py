...
class ReportDefinitionServiceConversionPathFilterOperator(object):
    ...
    allowable_values = [EQUALS, NOT_EQUALS, CONTAINS, NOT_CONTAINS, START_WITH, END_WITH, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ReportDefinitionServiceConversionPathFilterOperator - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportDefinitionServiceConversionPathFilterOperator):
            return False
