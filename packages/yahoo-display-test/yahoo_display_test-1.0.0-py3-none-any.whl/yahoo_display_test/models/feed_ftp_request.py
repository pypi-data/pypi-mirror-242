...
class FeedFtpRequest(object):
    ...
    def __init__(self, feed_id=None, local_vars_configuration=None):  # noqa: E501
        """FeedFtpRequest - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def feed_id(self):
        """Gets the feed_id of this FeedFtpRequest.  # noqa: E501
        ...
        :return: The feed_id of this FeedFtpRequest.  # noqa: E501
        :rtype: int
        """
    ...
    def feed_id(self, feed_id):
        """Sets the feed_id of this FeedFtpRequest.

        <div lang=\"ja\"> Feedを識別するIdです。<br> このフィールドは、リクエストの場合は必須です。 </div> <div lang=\"en\"> Feed ID.<br> This field is required in requests. </div>   # noqa: E501

        :param feed_id: The feed_id of this FeedFtpRequest.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedFtpRequest):
            return False
