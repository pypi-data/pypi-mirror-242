...
class FeedServiceControlType(object):
    ...
    allowable_values = [UPLOAD_COUNT_LIMIT, FILE_ROWS_LIMIT, FILE_SIZE_LIMIT_COMPRESS, FILE_SIZE_LIMIT_UNCOMPRESS, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """FeedServiceControlType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedServiceControlType):
            return False
