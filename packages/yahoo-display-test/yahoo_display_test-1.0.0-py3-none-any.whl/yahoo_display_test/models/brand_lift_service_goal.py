...
class BrandLiftServiceGoal(object):
    ...
    allowable_values = [AD_RECALL, BRAND_AWARENESS, MESSAGE_ASSOCIATION, PURCHASE_INTENTION, FAVOR, COMPARISON, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """BrandLiftServiceGoal - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BrandLiftServiceGoal):
            return False
