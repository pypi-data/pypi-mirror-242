...
class FeedFtpRequestServiceReturnValue(object):
    ...
    """
    openapi_types = {
        'values': 'list[FeedFtpRequestServiceValue]'
    }
    ...
    def __init__(self, values=None, local_vars_configuration=None):  # noqa: E501
        """FeedFtpRequestServiceReturnValue - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def values(self):
        """Gets the values of this FeedFtpRequestServiceReturnValue.  # noqa: E501


        :return: The values of this FeedFtpRequestServiceReturnValue.  # noqa: E501
        :rtype: list[FeedFtpRequestServiceValue]
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this FeedFtpRequestServiceReturnValue.


        :param values: The values of this FeedFtpRequestServiceReturnValue.  # noqa: E501
        :type: list[FeedFtpRequestServiceValue]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedFtpRequestServiceReturnValue):
            return False
