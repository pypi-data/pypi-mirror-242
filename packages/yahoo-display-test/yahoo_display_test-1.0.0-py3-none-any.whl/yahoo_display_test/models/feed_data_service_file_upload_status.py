...
class FeedDataServiceFileUploadStatus(object):
    ...
    allowable_values = [UPLOADED, COMPLETED, FILE_FORMAT_ERROR, SYSTEM_ERROR, NETWORK_ERROR, FILE_NOT_FOUND_ERROR, FILE_SIZE_OVER_ERROR, AUTH_ERROR, UPLOAD_COUNT_OVER_ERROR, NOT_MODIFIED, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """FeedDataServiceFileUploadStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedDataServiceFileUploadStatus):
            return False
