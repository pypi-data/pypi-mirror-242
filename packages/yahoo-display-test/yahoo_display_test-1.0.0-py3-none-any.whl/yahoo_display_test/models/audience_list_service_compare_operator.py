...
class AudienceListServiceCompareOperator(object):
    ...
    allowable_values = [EQUAL, INCLUDED, START_WITH, END_WITH, NOT_EQUAL, NOT_INCLUDED, NOT_START_WITH, NOT_END_WITH, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AudienceListServiceCompareOperator - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AudienceListServiceCompareOperator):
            return False
