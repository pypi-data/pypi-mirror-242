...
class SearchKeywordListServiceKeywordFrequency(object):
    ...
    allowable_values = [ONCE_OR_MORE, TWICE_OR_MORE, THREE_TIMES_OR_MORE, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """SearchKeywordListServiceKeywordFrequency - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SearchKeywordListServiceKeywordFrequency):
            return False
