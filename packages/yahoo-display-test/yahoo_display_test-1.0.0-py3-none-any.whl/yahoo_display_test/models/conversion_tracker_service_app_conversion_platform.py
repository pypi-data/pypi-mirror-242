...
class ConversionTrackerServiceAppConversionPlatform(object):
    ...
    allowable_values = [ITUNES, ANDROID_MARKET, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ConversionTrackerServiceAppConversionPlatform - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConversionTrackerServiceAppConversionPlatform):
            return False
