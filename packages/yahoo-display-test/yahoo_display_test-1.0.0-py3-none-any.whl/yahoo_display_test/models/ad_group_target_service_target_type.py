...
class AdGroupTargetServiceTargetType(object):
    ...
    allowable_values = [AD_SCHEDULE_TARGET, GEO_TARGET, AGE_TARGET, GENDER_TARGET, SITE_CATEGORY, AUDIENCE_LIST_TARGET, SEARCH_TARGET, PLACEMENT_TARGET, DEVICE_TARGET, APP_TARGET, OS_TARGET, OS_VERSION_TARGET, AUDIENCE_CATEGORY_TARGET, POSITION_TARGET, PLACEMENT_CATEGORY_TARGET, PLACEMENT_CATEGORY_DETAIL_TARGET, CONTENTS_TARGET, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AdGroupTargetServiceTargetType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupTargetServiceTargetType):
            return False
