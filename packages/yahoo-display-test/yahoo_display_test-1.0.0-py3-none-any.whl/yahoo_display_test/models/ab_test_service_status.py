...
class AbTestServiceStatus(object):
    ...
    allowable_values = [PENDING, PENDING_UNBALANCED_CAMPAIGN_BUDGET, PENDING_DEACTIVATED_CAMPAIGN, PENDING_DEDUPE, PENDING_PAUSED_CAMPAIGN, PENDING_EXPIRED_CAMPAIGN, PENDING_DUPLICATED_CAMPAIGNS_EXPECTED, ACTIVE, ACTIVE_UNBALANCED_CAMPAIGN_BUDGET, ACTIVE_DEACTIVATED_CAMPAIGN, ACTIVE_PAUSED_CAMPAIGN, ACTIVE_EXPIRED_CAMPAIGN, ACTIVE_DUPLICATED_CAMPAIGNS_EXPECTED, ENDED, ENDED_DUPLICATED_CAMPAIGNS, ENDED_DUPLICATED_CAMPAIGNS_EXPECTED, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AbTestServiceStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AbTestServiceStatus):
            return False
