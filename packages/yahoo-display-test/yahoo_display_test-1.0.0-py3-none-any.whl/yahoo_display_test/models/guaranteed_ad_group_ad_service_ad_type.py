...
class GuaranteedAdGroupAdServiceAdType(object):
    ...
    allowable_values = [BANNER_AD, CAROUSEL_AD, INSTREAM_AD, BRANDPANEL_QUINTIE, BRANDPANEL_PANORAMA, BRANDPANEL_PANORAMA_PANEL_SWITCH, TOP_IMPACT_SQUARE, TOP_IMPACT_QUINTIE, TOP_IMPACT_THEATER, TOP_IMPACT_PRIME_DISPLAY_DOUBLE, TOP_IMPACT_PANORAMA, TOP_IMPACT_PANORAMA_SIDE_VISION, TOP_IMPACT_PANORAMA_SIDE_SWITCH, TOP_IMPACT_PANORAMA_PANEL_SWITCH, TOP_PAGE_TOPICS_PR, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """GuaranteedAdGroupAdServiceAdType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GuaranteedAdGroupAdServiceAdType):
            return False
