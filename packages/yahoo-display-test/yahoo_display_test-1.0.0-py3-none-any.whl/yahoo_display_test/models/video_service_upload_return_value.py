...
class VideoServiceUploadReturnValue(object):
    ...
    """
    openapi_types = {
        'values': 'list[VideoServiceUploadValue]'
    }
    ...
    def __init__(self, values=None, local_vars_configuration=None):  # noqa: E501
        """VideoServiceUploadReturnValue - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def values(self):
        """Gets the values of this VideoServiceUploadReturnValue.  # noqa: E501


        :return: The values of this VideoServiceUploadReturnValue.  # noqa: E501
        :rtype: list[VideoServiceUploadValue]
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this VideoServiceUploadReturnValue.


        :param values: The values of this VideoServiceUploadReturnValue.  # noqa: E501
        :type: list[VideoServiceUploadValue]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, VideoServiceUploadReturnValue):
            return False
