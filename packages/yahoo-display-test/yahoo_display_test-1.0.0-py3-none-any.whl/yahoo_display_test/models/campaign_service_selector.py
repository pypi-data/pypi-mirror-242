...
class CampaignServiceSelector(object):
    ...
    def __init__(self, account_id=None, campaign_ids=None, contains_label=None, feed_ids=None, label_ids=None, number_results=500, start_index=1, user_statuses=None, created_date_range=None, conversion_group_ids=None, conversion_tracker_ids=None, budget_amount_range=None, local_vars_configuration=None):  # noqa: E501
    ...
    def conversion_group_ids(self):
        """Gets the conversion_group_ids of this CampaignServiceSelector.  # noqa: E501

        <div lang=\"ja\">検索条件 : コンバージョングループID</div> <div lang=\"en\">Search condition: Conversion Group ID</div>   # noqa: E501

        :return: The conversion_group_ids of this CampaignServiceSelector.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def conversion_group_ids(self, conversion_group_ids):
        """Sets the conversion_group_ids of this CampaignServiceSelector.

        <div lang=\"ja\">検索条件 : コンバージョングループID</div> <div lang=\"en\">Search condition: Conversion Group ID</div>   # noqa: E501

        :param conversion_group_ids: The conversion_group_ids of this CampaignServiceSelector.  # noqa: E501
        :type: list[int]
        """
    ...
    def conversion_tracker_ids(self):
        """Gets the conversion_tracker_ids of this CampaignServiceSelector.  # noqa: E501

        <div lang=\"ja\">検索条件 : コンバージョントラッカーID</div> <div lang=\"en\">Search condition: Conversion Tracking ID</div>   # noqa: E501

        :return: The conversion_tracker_ids of this CampaignServiceSelector.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def conversion_tracker_ids(self, conversion_tracker_ids):
        """Sets the conversion_tracker_ids of this CampaignServiceSelector.

        <div lang=\"ja\">検索条件 : コンバージョントラッカーID</div> <div lang=\"en\">Search condition: Conversion Tracking ID</div>   # noqa: E501

        :param conversion_tracker_ids: The conversion_tracker_ids of this CampaignServiceSelector.  # noqa: E501
        :type: list[int]
        """
