...
class FeedDataServiceApi(object):
    ...
    def feed_data_service_download_error_file_post(self, x_z_base_account_id, **kwargs):  # noqa: E501
        ...
        >>> thread = api.feed_data_service_download_error_file_post(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.feed_data_service_download_error_file_post_with_http_info(x_z_base_account_id, **kwargs)  # noqa: E501

    def feed_data_service_download_error_file_post_with_http_info(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """feed_data_service_download_error_file_post  # noqa: E501

        <div lang=\"ja\">商品情報のエラーファイルダウンロード処理を実施します。</div> <div lang=\"en\">Downloads error file.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feed_data_service_download_error_file_post_with_http_info(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_z_base_account_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_z_base_account_id` when calling `feed_data_service_download_error_file_post`")  # noqa: E501
    ...
    def feed_data_service_get_post(self, x_z_base_account_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feed_data_service_get_post(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.feed_data_service_get_post_with_http_info(x_z_base_account_id, **kwargs)  # noqa: E501

    def feed_data_service_get_post_with_http_info(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """feed_data_service_get_post  # noqa: E501

        <div lang=\"ja\">アップロードした商品情報の処理状況を照会します。</div> <div lang=\"en\">Returns status of uploaded item list.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feed_data_service_get_post_with_http_info(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_z_base_account_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_z_base_account_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_z_base_account_id` when calling `feed_data_service_get_post`")  # noqa: E501
    ...
    def feed_data_service_upload_post(self, x_z_base_account_id, account_id, feed_id, upload_type, is_debug, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feed_data_service_upload_post(x_z_base_account_id, account_id, feed_id, upload_type, is_debug, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.feed_data_service_upload_post_with_http_info(x_z_base_account_id, account_id, feed_id, upload_type, is_debug, **kwargs)  # noqa: E501

    def feed_data_service_upload_post_with_http_info(self, x_z_base_account_id, account_id, feed_id, upload_type, is_debug, **kwargs):  # noqa: E501
        """feed_data_service_upload_post  # noqa: E501

        <div lang=\"ja\">商品情報のアップロード処理を実施します。</div> <div lang=\"en\">Executes upload item list.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feed_data_service_upload_post_with_http_info(x_z_base_account_id, account_id, feed_id, upload_type, is_debug, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_z_base_account_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_z_base_account_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_z_base_account_id` when calling `feed_data_service_upload_post`")  # noqa: E501
