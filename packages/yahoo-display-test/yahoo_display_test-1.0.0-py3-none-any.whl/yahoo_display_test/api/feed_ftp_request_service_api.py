...
class FeedFtpRequestServiceApi(object):
    ...
    def feed_ftp_request_service_add_post(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """feed_ftp_request_service_add_post  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feed_ftp_request_service_add_post(x_z_base_account_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param int x_z_base_account_id: <div lang=\"ja\">アカウントIDを指定してください。</div> <div lang=\"en\">Specify Account ID.</div>  (required)
        :param FeedFtpRequestServiceOperation feed_ftp_request_service_operation:
        ...
        return self.feed_ftp_request_service_add_post_with_http_info(x_z_base_account_id, **kwargs)  # noqa: E501

    def feed_ftp_request_service_add_post_with_http_info(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """feed_ftp_request_service_add_post  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.feed_ftp_request_service_add_post_with_http_info(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(FeedFtpRequestServiceMutateResponse, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method feed_ftp_request_service_add_post" % key
                )
        ...
        if self.api_client.client_side_validation and ('x_z_base_account_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_z_base_account_id` when calling `feed_ftp_request_service_add_post`")  # noqa: E501
        ...
        body_params = None
        if 'feed_ftp_request_service_operation' in local_var_params:
            body_params = local_var_params['feed_ftp_request_service_operation']
        # HTTP header `Accept`
        ...
        return self.api_client.call_api(
            '/FeedFtpRequestService/add', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='FeedFtpRequestServiceMutateResponse',  # noqa: E501
