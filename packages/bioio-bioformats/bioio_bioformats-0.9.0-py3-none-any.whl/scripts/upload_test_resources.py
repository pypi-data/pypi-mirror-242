...
from bioio_bioformats import __version__
...
def upload_test_resources(args: Args):
    ...
    try:
        ...
        resources_dir = (
            Path(__file__).parent.parent / "bioio_bioformats" / "tests" / "resources"
        ).resolve(strict=True)
        ...
        package_name = "bioio_bioformats/test_resources"
        ...
        # Upload
            ...
            if confirmation:
                pushed = package.push(
                    ...
                    message=f"Test resources for `bioio_bioformats` version: {__version__}.",
                )
