...
def _make_session() -> requests.Session:
    if not robotgpt.verify_ssl_certs:
        warnings.warn("verify_ssl_certs is ignored; robotgpt always verifies.")
    s = requests.Session()
    s.mount(
        "https://",
...
class APIRequestor:
    def __init__(
        ...
        self.api_token = token or util.default_api_token()
        self.model = model
    ...
    ) -> Tuple[Iterator[RobotGPTResponse], bool, str]:
        pass
    ...
    def request(
        ...
        request_id: Optional[str] = ...,
        request_timeout: Optional[Union[float, Tuple[float, float]]] = ...,
    ) -> Tuple[RobotGPTResponse, bool, str]:
        pass
    ...
    def request(
        ...
        request_id: Optional[str] = ...,
        request_timeout: Optional[Union[float, Tuple[float, float]]] = ...,
    ) -> Tuple[Union[RobotGPTResponse, Iterator[RobotGPTResponse]], bool, str]:
        pass
    ...
    def request(
        ...
        return resp, got_stream, self.api_token
    ...
    async def arequest(
        ...
        request_id: Optional[str] = ...,
        request_timeout: Optional[Union[float, Tuple[float, float]]] = ...,
    ) -> Tuple[AsyncGenerator[RobotGPTResponse, None], bool, str]:
        pass
    ...
    async def arequest(
        ...
        request_id: Optional[str] = ...,
        request_timeout: Optional[Union[float, Tuple[float, float]]] = ...,
    ) -> Tuple[Union[RobotGPTResponse, AsyncGenerator[RobotGPTResponse, None]], bool, str]:
        pass
    ...
    def handle_error_response(self, rbody, rcode, resp, rheaders, stream_error=False):
        ...
        if isinstance(error_data, dict):
            ...
            util.log_info(error_data)
            return error.APIError(
                f"{error_data} {rbody} {rcode} {resp} {rheaders}",
                rbody,
                rcode,
                resp,
                rheaders,
    ...
    def request_headers(
        ...
        headers.update(util.api_token_to_header(self.api_token))
    ...
    def _prepare_request_raw(
        ...
        util.log_debug("Request to RobotGpt API", method=method, path=abs_url)
    ...
    def request_raw(
        ...
        *,
        ...
        abs_url, headers, data = self._prepare_request_raw(
            supplied_headers, method, params, files, request_id
        )
        ...
        try:
            ...
            raise error.APIConnectionError(
                "Error communicating with RobotGPT: {}".format(e)
            ) from e
        util.log_debug(
            "RobotGPT API response",
            path=abs_url,
            response_code=result.status_code,
            processing_ms=result.headers.get("RobotGPT-Processing-Ms"),
            request_id=result.headers.get("X-Request-Id"),
        )
        # Don't read the whole stream for debug logging unless necessary.
        if robotgpt.log == "debug":
            util.log_debug(
    ...
    async def arequest_raw(
        ...
        *,
        ...
        try:
            ...
            raise error.APIConnectionError("Error communicating with RobotGPT") from e

    def _interpret_response(
        self, result: requests.Response, stream: bool
    ) -> Tuple[Union[RobotGPTResponse, Iterator[RobotGPTResponse]], bool]:
    ...
    ) -> Tuple[Union[RobotGPTResponse, AsyncGenerator[RobotGPTResponse, None]], bool]:
        """Returns the response(s) and a bool indicating whether it is a stream."""
        if stream and "text/event-stream" in result.headers.get("Content-Type", ""):
            return (
                self._interpret_response_line(
    ...
    def _interpret_response_line(
        ...
        if rcode == 204:
            return RobotGPTResponse(None, rheaders)
        ...
        resp = RobotGPTResponse(data, rheaders)
...
async def aiohttp_session() -> AsyncIterator[aiohttp.ClientSession]:
    user_set_session = robotgpt.aiosession.get()
    if user_set_session:
