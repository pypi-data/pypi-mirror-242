...
class Resource(
    ...
    def __init__(
        ...
        *,
        ...
        :param triggers: A map of arbitrary strings that, when changed, will force the null resource to be replaced, re-running any associated provisioners. Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/null/3.2.2/docs/resources/resource#triggers Resource#triggers}
        :param connection: 
        :param count: 
        :param depends_on: 
        :param for_each: 
        ...
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__bcca22b711b6a266a2fb9e0fd1d2a6b4c7819b841eb701f668ae37626b64c4bf)
    ...
    def generate_config_for_import(
        ...
        :param import_from_id: The id of the existing Resource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/null/3.2.2/docs/resources/resource#import import section} in the documentation of this resource for the id to use
        :param provider: ? Optional instance of the provider where the Resource to import is found.
        '''
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__b321408ee7c589421626e2b37c0becf720756728ea3adee6a32a2a40547444df)
            check_type(argname="argument scope", value=scope, expected_type=type_hints["scope"])
    ...
    def triggers(self, value: typing.Mapping[builtins.str, builtins.str]) -> None:
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__2f571a27e19e5e885d08414bf3417454519309048e3e916441885577b64d299a)
            check_type(argname="argument value", value=value, expected_type=type_hints["value"])
        jsii.set(self, "triggers", value)


@jsii.data_type(
    jsii_type="@cdktf/provider-null.resource.ResourceConfig",
...
def _typecheckingstub__b321408ee7c589421626e2b37c0becf720756728ea3adee6a32a2a40547444df(
    scope: _constructs_77d1e7e8.Construct,
    import_to_id: builtins.str,
    import_from_id: builtins.str,
    provider: typing.Optional[_cdktf_9a9027ec.TerraformProvider] = None,
...
def _typecheckingstub__2f571a27e19e5e885d08414bf3417454519309048e3e916441885577b64d299a(
