...
class BarGraphParamData(IData):
    def __init__(self, id: str = '', name: str = '', style: int = 0, framestyle: int = 0, color: str = "white", linewidth: int = 1, plotindex: int = 0,
                 valueaxisid: int = -1, showlegend: bool = True, legendformat: str = '', legendcolor: str = "", joinvalueaxis: bool = True,
                 tickvalidmul: float = -1.0, validmaxvalue: float = 9999999.99, validminvalue: float = -9999999.99, userdata: Dict[str, str] = {}):
