        ...
        if self.w_out_target>self.w_in:
            ...
            if self.HumidType=="adiabatique" :
               ...
               # print(x)
                ...
                self.m_water=self.F_dry*(self.w_out_target-self.w_in)/1000 #débit d'eau en kgH2O/s
            ...
            if self.HumidType=="vapeur" :
              #  print("hvap=",self.h_vap)
               ...
               # print(x)
                ...
                self.m_water=self.F_dry*(self.w_out_target-self.w_in)/1000 #débit d'eau en kgH2O/s = [kg_air_sec/s] * kg_H20 /kg_air_sec
           ...
           # self.m_water=self.F_dry*(self.w_out_target-self.w_in)/1000
