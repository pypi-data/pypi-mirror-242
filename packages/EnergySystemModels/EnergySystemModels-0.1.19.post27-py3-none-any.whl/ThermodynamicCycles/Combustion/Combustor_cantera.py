...
class Object:
    def __init__(self):
        ...
        # Initialisation d'un DataFrame pandas pour stocker les données de sortie
    ...
    def calculate(self):
        ...
        if self.fuel_Inlet.F_kgs is not None:
            print('----------------------------------------',self.fuel_Inlet.F_kgs)
            self.fuel_F_kgs = self.fuel_Inlet.F_kgs

        if self.oxidizer_Inlet.F_kgs is not None:
            self.oxidizer_F_kgs = self.oxidizer_Inlet.F_kgs
