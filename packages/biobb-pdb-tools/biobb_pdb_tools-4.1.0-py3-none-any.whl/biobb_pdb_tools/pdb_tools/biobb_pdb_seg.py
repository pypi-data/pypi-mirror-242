...
def biobb_pdb_seg(input_file_path: str, output_file_path: str,  properties: dict = None, **kwargs) -> int:
    ...
    return Pdbseg(input_file_path=input_file_path,output_file_path=output_file_path,
                    properties=properties, **kwargs).launch()

def main():
    """Command line execution of this building block. Please check the command line documentation."""
    parser = argparse.ArgumentParser(description='Modifies the segment identifier column of a PDB file.', formatter_class=lambda prog: argparse.RawTextHelpFormatter(prog, width=99999))
    ...
    biobb_pdb_seg(input_file_path=args.input_file_path, 
