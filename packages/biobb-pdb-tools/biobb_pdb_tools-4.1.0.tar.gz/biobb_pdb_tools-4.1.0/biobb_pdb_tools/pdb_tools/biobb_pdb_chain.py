...
class Pdbchain(BiobbObject):
    ...
    Args:        
        ...
        properties (dic):
            ...
            * **binary_path** (*str*) - ("pdb_chain") Modifies the chain identifier column of a PDB file.
    ...
    Examples:
        This is a use example of how to use the building block from Python::
            ...
            from biobb_pdb_tools.pdb_tools.biobb_pdb_chain import Pdbchain
...
def biobb_pdb_chain(input_file_path: str, output_file_path: str,  properties: dict = None, **kwargs) -> int:
    ...
    return Pdbchain(input_file_path=input_file_path,output_file_path=output_file_path,
                    properties=properties, **kwargs).launch()

def main():
    """Command line execution of this building block. Please check the command line documentation."""
    parser = argparse.ArgumentParser(description='Modifies the chain identifier column of a PDB file.', formatter_class=lambda prog: argparse.RawTextHelpFormatter(prog, width=99999))
    ...
    biobb_pdb_chain(input_file_path=args.input_file_path, 
