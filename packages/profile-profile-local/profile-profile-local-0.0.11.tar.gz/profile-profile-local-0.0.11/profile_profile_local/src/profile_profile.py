...
class ProfileProfile(GenericCRUD):
    def __init__(self) -> None:
        super().__init__(default_schema_name=SCHEMA_NAME, default_table_name=PROFILE_PROFILE__DEFULT_TABLE_NAME,
    ...
    def update_profile_profile_by_profile_profile_id(self, profile_profile_id: int, profile_profile_json_data: object) -> None:
        json = {
            'data': profile_profile_json_data
        }
        logger.start(object=json)
        self.update_by_id(data_json=profile_profile_json_data, id_column_value=profile_profile_id)
