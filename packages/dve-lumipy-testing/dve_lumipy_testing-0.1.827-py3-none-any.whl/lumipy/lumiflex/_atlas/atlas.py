...
def get_atlas(**kwargs):
    """Get luminesce provider atlas instance by passing any of the following: a token, api_url and app_name; a path to a secrets file
    ...
    atlas = Atlas(data_metas + direct_metas, c)
