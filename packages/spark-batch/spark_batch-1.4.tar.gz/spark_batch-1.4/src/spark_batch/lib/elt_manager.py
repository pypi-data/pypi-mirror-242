...
class EltManager:
    ...
    def ingest_full(self, source_object, target_object, source_customSchema=None, target_customSchema=None, count=True, offset=0, cleansing_conditions=None, append=False) :    
        ...
        while True:
            ...
            # Save to Delta
            if offset == 0 and append is True:
                # 컬럼 이름을 소문자로 변환
