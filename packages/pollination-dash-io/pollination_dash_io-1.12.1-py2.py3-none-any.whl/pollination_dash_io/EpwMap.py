...
class EpwMap(Component):
    """An EpwMap component.
Show EPW Map

State
- epw (dictionay): EPW information

Keyword arguments:

- id (string; default 'po-epw-map'):
...
- staticImageStyle (dict; optional):
    Style of the static image.

    `staticImageStyle` is a dict with keys:
...
- widgetStyle (dict; optional):
    Style of the widgets.

    `widgetStyle` is a dict with keys:
    ...
    _type = 'EpwMap'
    @_explicitize_args
    def __init__(self, staticImageStyle=Component.UNDEFINED, style=Component.UNDEFINED, widgetStyle=Component.UNDEFINED, showLegend=Component.UNDEFINED, latitude=Component.UNDEFINED, longitude=Component.UNDEFINED, id=Component.UNDEFINED, **kwargs):
        self._prop_names = ['id', 'latitude', 'longitude', 'showLegend', 'staticImageStyle', 'style', 'widgetStyle']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['id', 'latitude', 'longitude', 'showLegend', 'staticImageStyle', 'style', 'widgetStyle']
        ...
        super(EpwMap, self).__init__(**args)
