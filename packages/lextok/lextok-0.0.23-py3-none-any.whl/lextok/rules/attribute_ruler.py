...
class WordAttributes(Enum):
    num = Attr(
        ...
        attrs={"POS": "PROPN", "ENT_TYPE": Label.GenericNum.name},
        indexes=[0, 1],
    )
    ...
    people_v = Attr(
        ...
        attrs={"POS": "PROPN", "ENT_TYPE": Label.JuridicalEntity.name},
        indexes=[0],
    )

    v_court = Attr(
        pattern=[VS, {"ORTH": {"IN": ["CA", "CFI", "Sandiganbayan"]}}],
        attrs={"POS": "PROPN", "ENT_TYPE": Label.CourtName.name},
        indexes=[1],
    )
    ...
    year = Attr(
        ...
        attrs={"POS": "NUM", "ENT_TYPE": Label.DATE.name},
        indexes=[0],
