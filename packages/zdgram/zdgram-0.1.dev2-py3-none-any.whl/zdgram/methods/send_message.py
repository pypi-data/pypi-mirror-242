...
class SendMessage:
    async def sendMessage(
        ...
        if entities:
            data['entities']=dumps([str(i) if isinstance(i, zdgram.types.MessageEntity) else i.__dict__.get("_DictionaryToClass__dict") for i in entities], ensure_ascii=False)
