...
from bioio_ome_tiled_tiff import __version__
...
def upload_test_resources(args: Args):
    ...
    try:
        ...
        resources_dir = (
            Path(__file__).parent.parent / "bioio_ome_tiled_tiff" / "tests" / "resources"
        ).resolve(strict=True)
        ...
        package_name = "bioio_ome_tiled_tiff/test_resources"
        ...
        # Upload
            ...
            if confirmation:
                pushed = package.push(
                    ...
                    message=f"Test resources for `bioio_ome_tiled_tiff` version: {__version__}.",
                )
