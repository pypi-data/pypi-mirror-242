...
def assert_mocks_calls(get_module_namespace, auto_explorer, main_script_path, namespace):
...
def test_define_manual_py_env(get_module_namespace_mock, auto_explorer_mock, main_script_path, namespace, tmp_path):
