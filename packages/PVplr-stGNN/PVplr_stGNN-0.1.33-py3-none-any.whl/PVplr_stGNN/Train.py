...
def model_train(train_iter, val_iter, device, args, model_saved_path):
    """
    Train a Spatio-Temporal Convolutional Autoencoder (STConvAE) model on the given training data.

    Args:
        train_iter (iterable): An iterable providing training data batches.
        val_iter (iterable): An iterable providing validation data batches.
        ...
        model_saved_path (str): Path to save the trained model checkpoint.
