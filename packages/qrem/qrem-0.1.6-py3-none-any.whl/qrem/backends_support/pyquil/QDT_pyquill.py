...
# ORGANIZE: All of these functions are almost exactly duplicated in QDT_pyquil. Delete one of them (carefully)
# ORGANIZE: this function is identical (up to two newline symbols) to get_list_of_lists_indices_qdt in QDT_qiskit
...
# ORGANIZE: This is almost identical to QDT_circuits_qiskit from QDT_qikit, except there there is option to add measurement
...
# ORGANIZE: This is almost exactly duplicated in QDT_qiskit. This seems slightly more developed. Delete in QDT_qiskit?
...
# ORGANIZE: the two functions below are duplicated in QDT_qiskit. Delete them?
