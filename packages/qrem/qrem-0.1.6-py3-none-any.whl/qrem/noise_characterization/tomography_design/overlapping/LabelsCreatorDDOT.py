...
class LabelsCreatorDDOT(LabelsBaseDDOT):
    ...
    def __init__(self,
        ...
        if subsets_list is None and subsets_locality is None:
            ...
            subsets_list = qrem_math.get_k_local_subsets(number_of_elements=number_of_qubits, 
    ...
    def calculate_properties_of_circuits(self) -> None:
        ...
        self._circuits_properties_dictionary['SD'] = SD/mean
    ...
    def __compute_1q_collection(self):
        ...
        circuits_now = [[unique_symbol for _ in range(self._number_of_qubits)] for unique_symbol in [0,1]]
    ...
    def compute_perfect_collection(self,
        ...
        "Perfect" means that for each subset of qubits self._subsets_list[i],
         each symbol out of 2^self._subsets_list[i],
