SELECT   dh.drillhole_no AS dh_no,     --col
         ...
         con.drill_meth                     AS drill_method,         --col
         con.drill_fr                       AS drill_from,           --col
         con.drill_to                       AS drill_to,             --col
         con.drill_diam                     AS drill_diam,           --col
         con.case_mtrl                      AS casing_material,      --col
         con.case_fr                        AS casing_from,          --col
         con.case_to                        AS casing_to,            --col
         con.case_diam                      AS casing_diam,          --col
         con.min_diam                       AS casing_min_diam,      --col
         con.pzone_type                     AS pzone_type,           --col
         con.pzone_mtrl                     AS pzone_material,       --col
         con.pzone_fr                       AS pzone_from,           --col
         con.pzone_to                       AS pzone_to,             --col
         con.pzone_diam                     AS pzone_diam,           --col
         con.pcem_fr                        AS pcement_from,         --col
         con.pcem_to                        AS pcement_to,           --col
         con.dev_meth                       AS development_method,   --col
         con.dev_duration                   AS development_duration, --col
