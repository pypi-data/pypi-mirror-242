SELECT dh.drillhole_no                             AS dh_no,   --col
       ...
       gdh.comments                                AS dh_comments,           --col comment regarding this drillhole's membership in this group
       ...
       g.comments                                  AS group_comments,        --col comment on the group itself
...
WHERE  g.group_type_code = {group_type_code} --arg group_type_code (str): drillhole group type code e.g. "OMN", default='OMN'
AND    dh.deletion_ind = 'N'
-- Valid values as of January 2020 are:
-- 
--  - "OMN" -Observation Well Monitoring networks
--  - "OMH" - Historical Obs Well Monitoring Network
--  - "PR" - Project
--  - "GDC" - Groundwater Data Checking
--  - "GDU" - Groundwater Data Uploads
--  - "MDU" - Mineral Data Uploads
-- 