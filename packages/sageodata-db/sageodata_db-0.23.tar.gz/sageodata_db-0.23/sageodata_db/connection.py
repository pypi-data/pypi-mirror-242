...
class SAGeodataConnection(cx_Oracle.Connection):
    ...
    See :ref:`predefined-queries-label` for more information on accessing
    data using predefined SQL queries.
    ...
    def find_wells(self, input_text, **kwargs):
        ...
        Returns:
            a list of :class:`sa_gwdata.Well` objects.
        ...
        For example::
            ...
            >>> wells
            ['6628-1265', 'YAT030', 'MOR201', 'ULE205']
    ...
    def find_wells_from_df(
        ...
        **kwargs,
        ...
        Returns:
            a copy of *df* with *return_id_cols* added at the start, with all
            well identifiers matched.
        ...
        for search in chunk(search_lines, 1000):
            ...
            vwids_dfs.append(self.find_wells("/".join(search), **kwargs).df())
        ...
        for wid in wids:
            ...
            if wid == "":
                ...
                row_sel = vwids[vwids["unit_no.hyphen"] == wid[1]]
                if len(row_sel) == 1:
                    row = row_sel.iloc[0]
            elif wid[0] == "obs_no":
                row_sel = vwids[vwids["obs_no.id"] == wid[1]]
                if len(row_sel) == 1:
                    row = row_sel.iloc[0]
            elif wid[0] == "dh_no":
