...
WHERE  u.strat_unit_no = {STRAT_UNIT_NO} --arg STRAT_UNIT_NO (sequence of int): stratigraphic unit numbers or a :class:`pandas.DataFrame` with a "strat_unit_no" column