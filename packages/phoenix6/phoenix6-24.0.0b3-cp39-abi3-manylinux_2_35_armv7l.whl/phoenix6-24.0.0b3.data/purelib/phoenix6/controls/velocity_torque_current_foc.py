...
class VelocityTorqueCurrentFOC:
    ...
    def __init__(self, velocity: rotations_per_second, acceleration: rotations_per_second_squared = 0.0, feed_forward: ampere = 0.0, slot: int = 0, override_coast_dur_neutral: bool = False):
