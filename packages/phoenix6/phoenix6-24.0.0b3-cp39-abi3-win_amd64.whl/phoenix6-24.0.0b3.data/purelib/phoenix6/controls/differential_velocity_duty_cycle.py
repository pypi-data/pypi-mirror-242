...
class DifferentialVelocityDutyCycle:
    ...
    def __init__(self, target_velocity: rotations_per_second, differential_position: rotation, enable_foc: bool = True, target_slot: int = 0, differential_slot: int = 1, override_brake_dur_neutral: bool = False):
