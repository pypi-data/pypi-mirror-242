...
class DifferentialDutyCycle:
    ...
    def __init__(self, target_output: float, differential_position: rotation, enable_foc: bool = True, differential_slot: int = 1, override_brake_dur_neutral: bool = False):
