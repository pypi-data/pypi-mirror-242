...
class DifferentialPositionVoltage:
    ...
    def __init__(self, target_position: rotation, differential_position: rotation, enable_foc: bool = True, target_slot: int = 0, differential_slot: int = 1, override_brake_dur_neutral: bool = False):
