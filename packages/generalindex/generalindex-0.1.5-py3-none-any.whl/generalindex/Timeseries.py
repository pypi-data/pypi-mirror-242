...
class Timeseries:
    ...
    def get_symbols(self, search_for: str = None, group_name: str = None, _size=1000, _from=0):
        ...
        assert (group_name not in ["", None]) or (search_for not in ["",
                                                                     None]), 'Please specify either group_name or search_for parameter of get_symbols() method'
    ...
    @deprecated(version='0.1.5', reason="Please use newer API version with output_format")
    def retrieve_data_as_csv(self, symbols: dict, columns, group_name: str,
        ...
        output_format = "NCSV" if NCSV else "PANDAS"

        self.retrieve_data_as_json(symbols, columns, group_name, file_name, start_date, end_date, timezone, metadata,
                                   allow_wildcard, output_format, corrections, delta)
        return

    def retrieve_data_as_csv(self, symbols: dict, columns, group_name: str,
                             file_name: str = None, start_date: str = None, end_date: str = None, timezone: str = None,
