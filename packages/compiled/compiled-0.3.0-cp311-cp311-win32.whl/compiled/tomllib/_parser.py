...
if TYPE_CHECKING:
    from compiled.tomllib import TOMLDecodeError

from compiled.tomllib._re import RE_DATETIME, RE_LOCALTIME, RE_NUMBER, match_to_datetime, match_to_localtime, match_to_number
from compiled.tomllib._types import Key, ParseFloat, Pos
