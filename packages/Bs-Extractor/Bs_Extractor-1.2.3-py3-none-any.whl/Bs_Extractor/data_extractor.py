...
class Bs_Extractor:
        ...
        def __init__(self, pdf_bytes,customer_name):
                
                self.pdf_bytes = pdf_bytes
                self.customer_name = customer_name

        def get_sal_and_name(self, data):
            openai.api_key = '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'
            data = limit_string_to_tokens(data, 14000)
...
#             ### 8. Customer Name Extraction ---------------------------------
            ...
            if not avg_salary or not Cust_Name:
                ...
                Cust_Name, avg_salary = extract_name_and_salary_from_gpt_resp(gpt_extraction)
            ...
            final_json={
              ...
              #  'salary_list':salary,
                ...
                'is_more_than_3_months':is_more_than_3_months,
                'Name_check':Name_check,
                'gpt_extraction':gpt_extraction
