...
from .models import CiscoDeviceSupport, CiscoDeviceTypeSupport, FortinetSupport
...
class FortinetSupportFilterForm(SavedFiltersMixin, FilterForm):
    model = FortinetSupport
