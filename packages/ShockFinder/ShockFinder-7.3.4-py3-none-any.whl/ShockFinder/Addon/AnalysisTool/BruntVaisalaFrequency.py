...
def get(Dataobj,quantity_name,args={},vargs={}):
	...
	quantities={
		"BVF_"+rho+"_"+prs:-1/fix_rho*Dataobj.quantities["Gradient_"+prs+"_x1"]*(1/Dataobj.quantities["gamma"]/fix_prs*Dataobj.quantities["Gradient_"+prs+"_x1"]-1/fix_rho*Dataobj.quantities["Gradient_"+rho+"_x1"])  if not np.all(fix_rho==0) and not np.all(fix_prs==0) else np.full(fix_prs.shape,0)
	}
