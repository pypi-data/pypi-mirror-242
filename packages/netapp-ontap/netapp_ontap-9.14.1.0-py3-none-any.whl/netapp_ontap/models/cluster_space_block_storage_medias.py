...
class ClusterSpaceBlockStorageMediasSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" Available space of all the aggregates based on media type. """
    ...
    r""" Total physical used space of all the aggregates based on media type. """

    size = Size(data_key="size", allow_none=True)
    r""" Total space of all the aggregates based on media type. """
...
* vmdisk """
    ...
    r""" Used space of all the aggregates based on media type. """
