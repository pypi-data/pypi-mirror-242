...
class IgroupInitiatorConnectivityTrackingSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    alerts = marshmallow_fields.List(marshmallow_fields.Nested("netapp_ontap.models.igroup_initiator_connectivity_tracking_alerts.IgroupInitiatorConnectivityTrackingAlertsSchema", unknown=EXCLUDE, allow_none=True), data_key="alerts", allow_none=True)
