...
class S3BucketLifecycleManagementRulesSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    r""" The abort_incomplete_multipart_upload field of the s3_bucket_lifecycle_management_rules. """
...
Example: bucket1 """
    ...
    r""" The expiration field of the s3_bucket_lifecycle_management_rules. """
    ...
    r""" The non_current_version_expiration field of the s3_bucket_lifecycle_management_rules. """
    ...
    r""" The object_filter field of the s3_bucket_lifecycle_management_rules. """
...
Example: 414b29a1-3b26-11e9-bd58-0050568ea055 """
    ...
    """abort_incomplete_multipart_upload,enabled,expiration,non_current_version_expiration,svm.name,svm.uuid,"""
    ...
    """abort_incomplete_multipart_upload,bucket_name,enabled,expiration,name,non_current_version_expiration,object_filter,svm.name,svm.uuid,"""
