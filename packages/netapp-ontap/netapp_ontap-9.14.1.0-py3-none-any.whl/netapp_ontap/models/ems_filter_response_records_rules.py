...
Example: 1 """
    ...
    parameter_criteria = marshmallow_fields.List(marshmallow_fields.Nested("netapp_ontap.models.ems_filter_rules_parameter_criteria.EmsFilterRulesParameterCriteriaSchema", unknown=EXCLUDE, allow_none=True), data_key="parameter_criteria", allow_none=True)
