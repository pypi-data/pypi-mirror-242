    ...
    if RECLINE_INSTALLED:
        ...
        def snapmirror_policy_show(
            ...
            Args:
                ...
                rpo: Specifies the duration of time for which a change to be propagated to a mirror should be delayed, in seconds. This is an intentional propagation delay between mirrors and is configurable down to zero, which means an immediate propagation. This is supported for policies of type 'continuous'.
                scope: Set to \"svm\" for policies owned by an SVM, otherwise set to \"cluster\".
                sync_type: 
                throttle: Throttle in KB/s. Default to unlimited.
                type: 
                uuid: Unique identifier of the SnapMirror policy.
            """
    ...
    if RECLINE_INSTALLED:
        ...
        async def snapmirror_policy_modify(
            ...
            Args:
                ...
                rpo: Specifies the duration of time for which a change to be propagated to a mirror should be delayed, in seconds. This is an intentional propagation delay between mirrors and is configurable down to zero, which means an immediate propagation. This is supported for policies of type 'continuous'.
                query_rpo: Specifies the duration of time for which a change to be propagated to a mirror should be delayed, in seconds. This is an intentional propagation delay between mirrors and is configurable down to zero, which means an immediate propagation. This is supported for policies of type 'continuous'.
                scope: Set to \"svm\" for policies owned by an SVM, otherwise set to \"cluster\".
                ...
                query_type: 
                uuid: Unique identifier of the SnapMirror policy.
                query_uuid: Unique identifier of the SnapMirror policy.
            """
