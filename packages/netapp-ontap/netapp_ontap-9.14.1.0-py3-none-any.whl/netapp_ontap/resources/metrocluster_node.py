...
* disabled"""
    ...
    """cluster.name,cluster.uuid,dr_auxiliary_cluster.name,dr_auxiliary_cluster.uuid,dr_auxiliary_partner.links,dr_auxiliary_partner.name,dr_auxiliary_partner.uuid,dr_partner.links,dr_partner.name,dr_partner.uuid,dr_partner_cluster.name,dr_partner_cluster.uuid,ha_partner.links,ha_partner.name,ha_partner.uuid,ha_partner_cluster.name,ha_partner_cluster.uuid,node.links,node.name,node.uuid,"""
