...
class PerformanceFcPortMetric(Resource):
    ...
    def get_collection(
        ...
        **kwargs
        ...
        r"""Retrieves historical performance metrics for a Fibre Channel port.
"""
    ...
    def fast_get_collection(
        ...
        **kwargs
        ...
        """Returns a list of RawResources that represent PerformanceFcPortMetric resources that match the provided query"""
...
"""
    ...
    def get(self, **kwargs) -> NetAppResponse:
        r"""Retrieves historical performance metrics for a Fibre Channel port for a specific time.
"""
