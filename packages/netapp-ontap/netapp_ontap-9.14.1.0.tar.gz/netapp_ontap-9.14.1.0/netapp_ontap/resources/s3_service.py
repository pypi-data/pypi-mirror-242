    ...
    S3Service(
        {
            ...
            "users": [
                ...
                {"name": "user-2", "comment": "", "access_key": "ANOYV22L156K8AB4ZISB"},
            ],
            "buckets": [
                {
...
S3Service(
    {
        "users": [
            {"name": "user-1", "access_key": "KEOYV21G156K8AB4ZISH"},
            {"name": "user-2", "access_key": "ANOYV22L156K8AB4ZISB"},
        ],
...
S3Service(
    {
        "users": [
            {"name": "user-1", "access_key": "KEOYV21G156K8AB4ZISH"},
            {"name": "user-2", "access_key": "M4U4922OTO9QGXM3YR2I"},
        ],
        "_links": {"self": {"href": "/api/protocols/s3/services/"}},
    }
)
