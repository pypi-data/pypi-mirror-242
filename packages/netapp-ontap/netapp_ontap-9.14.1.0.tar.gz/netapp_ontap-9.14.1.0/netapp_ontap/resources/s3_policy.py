    ...
    if RECLINE_INSTALLED:
        ...
        def s3_policy_show(
            ...
            Args:
                ...
                name: Specifies the name of the policy. A policy name length can range from 1 to 128 characters and can only contain the following combination of characters 0-9, A-Z, a-z, \"_\", \"+\", \"=\", \",\", \".\",\"@\", and \"-\". It cannot be specified in a PATCH method.
    ...
    if RECLINE_INSTALLED:
        ...
        async def s3_policy_modify(
            ...
            Args:
                ...
                name: Specifies the name of the policy. A policy name length can range from 1 to 128 characters and can only contain the following combination of characters 0-9, A-Z, a-z, \"_\", \"+\", \"=\", \",\", \".\",\"@\", and \"-\". It cannot be specified in a PATCH method.
                query_name: Specifies the name of the policy. A policy name length can range from 1 to 128 characters and can only contain the following combination of characters 0-9, A-Z, a-z, \"_\", \"+\", \"=\", \",\", \".\",\"@\", and \"-\". It cannot be specified in a PATCH method.
                read_only: Specifies whether or not the s3 policy is read only. This parameter should not be specified in the POST method.
