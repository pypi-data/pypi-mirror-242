...
class VscanSchema(ResourceSchema, metaclass=ResourceSchemaMeta):
    ...
    on_access_policies = marshmallow_fields.List(marshmallow_fields.Nested("netapp_ontap.resources.vscan_on_access.VscanOnAccessSchema", unknown=EXCLUDE, allow_none=True), data_key="on_access_policies", allow_none=True)
