...
If not provided and the consistency group contains only one volume, the name will be generated based on the volume name. If the consistency group contains more than one volume, the name is required. """
    ...
    namespaces = marshmallow_fields.List(marshmallow_fields.Nested("netapp_ontap.models.consistency_group_child_namespaces.ConsistencyGroupChildNamespacesSchema", unknown=EXCLUDE, allow_none=True), data_key="namespaces", allow_none=True)
...
Example: 1cd8a442-86d1-11e0-ae1c-123478563412 """
    ...
    volumes = marshmallow_fields.List(marshmallow_fields.Nested("netapp_ontap.models.consistency_group_child_volumes.ConsistencyGroupChildVolumesSchema", unknown=EXCLUDE, allow_none=True), data_key="volumes", allow_none=True)
