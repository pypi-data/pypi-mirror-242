...
class GroupV2:
    ...
    async def AddOptionalConversation(
        self, groupId: int, chatName: str, chatSecurity: int
    ) -> dict:
    ...
    async def ApproveAllPending(self, groupId: int, message: str) -> dict:
    ...
    async def DenyAllPending(self, groupId: int, message: str) -> dict:
    ...
    async def ApprovePendingForList(
        self, groupId: int, memberships: list, message: str
    ) -> dict:
        """Approve all of the pending users for the given group.
    ...
    async def ApprovePending(
        self, groupId: int, membershipId: int, membershipType: int, message: str
    ) -> dict:
