...
def download_and_prepare_UTRs(source = None, min_size = 50):
    ...
    with gzip.open(local_filename, 'rb') as f_in:
        with open('Homo_sapiens.GRCh38.107.utrs', 'wb') as f_out:
...
def install_muscle(source = None):
    ...
    linux = 'https://drive5.com/muscle/downloads3.8.31/muscle3.8.31_i86linux64.tar.gz'
    ...
    if system == "Windows":
        ...
        muscle_executable = os.path.join(source, 'muscle/linux/muscle3.8.31_i86linux64.tar.gz')
