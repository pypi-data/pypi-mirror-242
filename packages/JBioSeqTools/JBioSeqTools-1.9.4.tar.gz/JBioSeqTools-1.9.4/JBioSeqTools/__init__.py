...
print('')
print('Welcome in JBioSeqTools v.1.9.1 library')
print('')
...
if 'instalation.dec' not in os.listdir(_libd):
    ...
    location = os.path.join(_libd, 'JBioSeqTools')
    from location import install
    import subprocess
...
if 'instalation.dec' in os.listdir(_libd):
