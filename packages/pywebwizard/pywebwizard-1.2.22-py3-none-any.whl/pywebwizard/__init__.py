...
class SeleniumManagerBase:
    ...
    def _replace_env(self, search_value):
        ...
        _result = re.sub(pattern, replace_local_env, search_value)
        return re.sub(pattern, replace_system_env, search_value)
    ...
    def _get_env(self, search_value):
        ...
        if (not _search_value.startswith(self.env_var_separator_start)
            ...
            _search_value = self._replace_env(_search_value)
            return search_value
