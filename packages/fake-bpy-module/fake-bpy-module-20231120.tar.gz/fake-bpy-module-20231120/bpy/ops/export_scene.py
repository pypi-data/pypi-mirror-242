...
def gltf(
    ...
    ''' Export scene as glTF 2.0 file :File: `addons/io_scene_gltf2/__init__.py\:817 <https://projects.blender.org/blender/blender-addons/addons/io_scene_gltf2/__init__.py#L817>`__
    ...
    :param export_unused_textures: Unused textures, Export image texture nodes not assigned to any material
