...
class BaseScript:
    ...
    def init_logger(self):
        ...
        logger.remove()
        logger.add(sink=sys.stderr, level=logging_level, format=settings.get('logging.format.simple'))
        logger.add(sink=sink, level=logging_level, format=settings.get('logging.format.simple'))
