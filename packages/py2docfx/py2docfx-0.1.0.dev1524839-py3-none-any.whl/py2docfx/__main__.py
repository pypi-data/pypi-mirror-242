...
from py2docfx.convert_prepare.params import load_file_params, load_command_params, load_extension_configs_from_command_line
...
def get_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="The extension configs to write to the Sphinx config file",
    )
    parser.add_argument(
        "exclude_path",
        default=[],
...
def parse_command_line_args(argv) -> (
    ...
    if args.param_file_path:
        ...
        package_info.extension_config = load_extension_configs_from_command_line(
