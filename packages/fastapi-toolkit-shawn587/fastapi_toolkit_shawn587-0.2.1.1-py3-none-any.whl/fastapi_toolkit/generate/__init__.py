...
from fastapi_toolkit.generate.model_metadata import ModelMetadata, LinkTableMetadata, RelationshipMetadata, RelationshipSide, FKMetadata
from fastapi_toolkit.generate.router_metadata import RouterMetadata
from fastapi_toolkit.generate.utils import name_convert_to_snake, plural, get_combinations
from fastapi_toolkit.generate.mock import MockType
from fastapi_toolkit.define.link import OneManyLink, ManyManyLink
from fastapi_toolkit.define.model import ModelManager
...
class CodeGenerator:
    def __init__(self, root_path='inner_code'):
        ...
        self.env = Environment(loader=PackageLoader('fastapi_toolkit_shawn587', 'templates'))
