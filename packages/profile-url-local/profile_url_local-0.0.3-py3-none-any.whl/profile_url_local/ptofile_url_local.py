...
class UrlProfilesLocal(GenericCRUD):
    ...
    def __init__(self):
        ...
        super().__init__(default_schema_name="profile_url",default_table_name='profile_url_table',default_id_column_name='profile_id', 
                        default_view_table_name = 'profile_url_view' )
    ...
    def update(self,url_id: str,url_type_id: int,profile_id: int):
        ...
        profile_url_json = {'profile_id': profile_id,
                'url_type_id':url_type_id,
                'url':url_id}
        GenericCRUD.update_by_id(self, data_json=profile_url_json, id_column_value=profile_id, order_by='start_timestamp desc')
    ...
    def get_last_url_by_profile_id(self, profile_id: int) -> url:
        ...
        logger.start(GET_LAST_URL_ID_BY_PROFILE_ID_METHOD_NAME,
                     object={'profile_id': profile_id})
        url = GenericCRUD.select_multi_tuple_by_where(self, select_clause_value="url",
