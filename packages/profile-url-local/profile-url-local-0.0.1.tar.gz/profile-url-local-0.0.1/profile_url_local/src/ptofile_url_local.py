...
class UrlProfiles(GenericCRUD):
    
    def __init__(self):
        INIT_METHOD_NAME = '__init__'
        
        logger.start(INIT_METHOD_NAME)
        super().__init__(schema_name="profile_url")
    ...
    def update_url(self,url_id: str,url_type_id: int,profile_id: int):
        ...
        data = {'profile_id': profile_id,
                'url_type_id':url_type_id,
                'url':url_id}
        GenericCRUD.update_by_where(self,table_name="profile_url_table", data_json=data, where="profile_id=%s" , params=(profile_id,),order_by='start_timestamp desc')
    ...
    def delete_url(self,profile_id: int):
        ...
        GenericCRUD.delete_by_where(self,table_name="profile_url_table", where="profile_id=%s" , params=(profile_id,))
