...
PACKAGE_NAME = "profile-url-local"
...
setuptools.setup(
    ...
    name=PACKAGE_NAME,
    version='0.0.4',  # update only the minor version each time # https://pypi.org/project/<short-project-name-with-underscores>/
    author="Circles",
    author_email="info@circlez.ai",
    # TODO: Please update the description and delete this line
    description="PyPI Package for Circles profile-url-local Python",
