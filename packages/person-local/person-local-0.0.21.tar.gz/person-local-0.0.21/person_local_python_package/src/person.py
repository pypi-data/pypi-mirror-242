...
class PersonsLocal(GenericCRUD):
    ...
    def delete_by_person_id(self, person_id: int) -> None:
        ...
        GenericCRUD(self.schema_name).delete_by_id(
            table_name="person_table",  id_column_name="person_id", id_column_value=person_id)
    ...
    def insert(self, person: PersonDto) -> int:
        ...
        query = (
            f"INSERT INTO person_table (number, gender_id, last_coordinate, "
            f"location_id, start_timestamp) "
            f"VALUES ({person.number}, {person.gender_id}, {person.last_coordinate}, "
            f"{person.location_id}, CURRENT_TIMESTAMP)"
        )
    ...
    def update_birthday_date(person_id: int, birthday_date: datetime.date) -> None:
        ...
        GenericCRUD("person").update_by_id(
            table_name="person_table", id_column_name="person_id", id_column_value=person_id,
    ...
    def update_first_name_by_profile_id(profile_id: int, first_name: str) -> None:
        ...
        GenericCRUD("person").update_by_id(
            table_name="person_table", id_column_name="person_id", id_column_value=profile_id,
            data_json=person_json)
        logger.end()
    ...
    def update_person_ml_first_name_by_person_id(person_id: int,
        ...
        GenericCRUD("person").update_by_id(
            table_name="person_ml_table", id_column_name="person_id", id_column_value=person_id,
            data_json=person_json)
        logger.end()
