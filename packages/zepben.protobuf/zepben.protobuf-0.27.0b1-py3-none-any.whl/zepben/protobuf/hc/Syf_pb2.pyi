...
class Syf(_message.Message):
    __slots__ = ["scenario", "year", "feeder", "installedTxCapacity", "normVMinPu", "normVMaxPu", "emergVMinPu", "emergVMaxPu", "resultsConfig", "qualityAssuranceProcessing", "fixedTime", "timePeriod", "timezone", "executorConfig", "resultsProcessorConfig"]
