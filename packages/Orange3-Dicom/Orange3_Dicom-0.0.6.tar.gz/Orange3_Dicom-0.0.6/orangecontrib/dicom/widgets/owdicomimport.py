...
Import DICOM images 'into' canvas session from a local file system
...
class OWImportDicom(widget.OWWidget):
    name = "Import DICOM"
    description = "Import DICOM images from a directory(s)"
    ...
    def __init__(self):
        ...
        browseaction = QAction(
            ...
            toolTip="Select a directory from which to load the DICOM images"
        )
    ...
    def __initRecentItemsModel(self):
        ...
        recent_paths = recent_paths[:OWImportDicom.MaxRecentItems]
    ...
    def __runOpenDialog(self):
        ...
        if OWImportDicom.Modality == Qt.WindowModal:
            dlg = QFileDialog(
    ...
    def start(self):
        ...
        task = ImportDicom(report_progress=report_progress)
...
if __name__ == "__main__":
    ...
    WidgetPreview(OWImportDicom).run()
