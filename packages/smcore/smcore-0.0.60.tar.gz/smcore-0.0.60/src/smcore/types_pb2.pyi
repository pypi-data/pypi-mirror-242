...
class Promise(_message.Message):
    __slots__ = ["name", "type", "source", "state", "data"]
    ...
    data: bytes
    def __init__(self, name: _Optional[str] = ..., type: _Optional[str] = ..., source: _Optional[str] = ..., state: _Optional[_Union[Promise.PromiseState, str]] = ..., data: _Optional[bytes] = ...) -> None: ...
