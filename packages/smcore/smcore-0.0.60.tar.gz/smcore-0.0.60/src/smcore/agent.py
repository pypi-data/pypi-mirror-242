...
class Agent(client_type):
    ...
    def __init__(self, spec, bb_addr):
        ...
        # This probably needs to be removed, since attributes will
        # handle managing all promises
        #self.promises = PromiseSet(spec)

        # Special decoding of the attributes structure:
        attr_dict = json.loads(spec.attributes.decode("utf-8"))
        
        self.attributes = Attributes(attr_dict)

        #print(self.attributes)
        
    # DEPRECATED: See Attributes.value and Attributes.await_value
