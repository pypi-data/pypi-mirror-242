...
class Result_cal:
    '''  Ƭ₳₦łꚃⷮꚕⷹq 0.0.7 '''        
    def __init__(self,File_Path,Sub_Code,Sub_name,EX_Usn,Teacher_name,cradite,text) -> None:
        try:
            ...
            self.l=new#[self.subject1,self.subject2,self.subject3,self.subject4,self.subject5,self.subject6,self.subject7,self.subject8,self.subject9,self.subject10]
            ...
            self.newsheet()
            # print("\n This is the final marks : ",self.Final)
            # print("\n This is the percentage : ",self.percentage)
            # print("\n This is the per : ",self.per2)
            # print("\n This is the p : ",self.p)
            # print("\n This is the total people who attended the marks self.given_test_data: ",self.given_test_data)
            # print("\n This is the total number of person present in the college self.strength: ",self.strength)
            # print("\n This is the hight Usn of marks scored self.dv : ",self.dv)
            # print("\n This is the hight marks self.dk : ",self.dk)
            # print("\n this is the self.lk: ",self.lk)
            # print()
    ...
    def per(self):
        try:
            ...
            # print("\n line 80 total marks after sum printing : ",self.Total)
            # print("\nline 81 printing the marks list : ",self.marks_list)
    ...
    def newsheet(self):
        try:
            ...
            def create_pdf_report(filename):
                ...
                data.append([" "," "," "," "," "," "," "," "," ","FCD",br[0][0],str(int((br[0][0]/w*100)))+"%"])
                data.append([" "," "," "," "," "," "," "," "," ","FC",br[0][1],str(int((br[0][1]/w)*100))+"%"])
                data.append([" "," "," "," "," "," "," "," "," ","SC",br[0][2],str(int((br[0][2]/w*100)))+"%"])
                data.append([" "," "," "," "," "," "," "," "," ","Fail",br[0][3],str(int((br[0][3]/w)*100))+"%"])
