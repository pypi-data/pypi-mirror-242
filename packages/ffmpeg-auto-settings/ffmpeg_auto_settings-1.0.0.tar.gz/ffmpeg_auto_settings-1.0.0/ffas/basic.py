...
from . import files
from .videostore import VideoStore, Video, Tag, NoResultFound
from .misc import print_err, singleton
...
def get_mimetype_extension_mapping():
...
def cmd_export(args):
    ...
    if not args.no_guess_ext:
        ...
        try:
            extension = '.' + get_mimetype_extension_mapping()[mimetype]
        except KeyError:
