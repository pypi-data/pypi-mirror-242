-- include-file of the supports from MQT and MQS corrector magnets/Bernhard Auchmann - 01.09.00
-- referring to: LHCMQT_C0005|2|B, LHCMQS_A0001|0|B
...
XEDGE = 164.56;		xedge = XEDGE*mm*shrink;
