...
class AgxToBrickMapper(object):
    ...
    def __init__(self, *args):
        r"""
        __init__(AgxToBrickMapper self, uint32_t precision=2) -> AgxToBrickMapper
...
class ClickAdapter(object):
    ...
    def add_listeners(self, app, simulation, click_server_addr, brick_scene):
        r"""
        add_listeners(ClickAdapter self, agxOSG::ExampleApplication * app, Simulation simulation, std::string const & click_server_addr, std::shared_ptr< Brick::Core::Object > const & brick_scene)
        ...
        """
        return _BrickAgxPyApi.ClickAdapter_add_listeners(self, app, simulation, click_server_addr, brick_scene)
