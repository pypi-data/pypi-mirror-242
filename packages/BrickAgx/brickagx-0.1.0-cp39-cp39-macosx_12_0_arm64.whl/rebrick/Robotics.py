...
class Joints_FlexibleTorqueJoint(Joints_HingeJoint):
    ...
    def actuator_input(self):
        r"""actuator_input(Joints_FlexibleTorqueJoint self) -> std::shared_ptr< DriveTrain::TorqueMotorInput >"""
...
class Signals_RobotInput(rebrick.Physics.Signals_Input):
    ...
    def torque_targets(self):
        r"""torque_targets(Signals_RobotInput self) -> DriveTrain_TorqueMotorInput_Vector"""
