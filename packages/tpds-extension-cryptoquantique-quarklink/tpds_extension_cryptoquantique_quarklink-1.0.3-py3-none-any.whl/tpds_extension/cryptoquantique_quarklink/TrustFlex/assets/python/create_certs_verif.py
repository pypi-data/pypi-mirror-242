...
def create_iotconnect_root_verify(verif_code, root_key_path='root_key.key', root_verif_path='root_verification.cer'):
    """
    Create a verification certificate to be sent to the Quarklink Cloud to give a proof of possession of the
    root certificate private key using verification code provided by the server. This is mandatory for
    the Quarklink IoTConnect cloud to activate the root CA and later verify the device certificate chain.
    """
