...
from . import api_v1_salary_avg_list
from . import api_v1_salary_diagram_list
from . import api_v1_searchandstopkeywords_retrieve
from . import api_v1_searchandstopkeywords_create
from . import api_v1_searchandstopkeywords_retrieve_2
from . import api_v1_searchandstopkeywords_update
from . import api_v1_searchandstopkeywords_destroy
from . import api_v1_searchkeywords_retrieve
from . import api_v1_searchkeywords_create
from . import api_v1_searchkeywords_retrieve_2
from . import api_v1_searchkeywords_update
from . import api_v1_searchkeywords_destroy
...
from . import api_v1_stopkeywords_retrieve
from . import api_v1_stopkeywords_create
from . import api_v1_stopkeywords_retrieve_2
...
class ApiApi(BaseApi):
    ...
    api_v1_salary_avg_list = api_v1_salary_avg_list.make_request
    api_v1_salary_diagram_list = api_v1_salary_diagram_list.make_request
    api_v1_searchandstopkeywords_retrieve = api_v1_searchandstopkeywords_retrieve.make_request
    api_v1_searchandstopkeywords_create = api_v1_searchandstopkeywords_create.make_request
    api_v1_searchandstopkeywords_retrieve_2 = api_v1_searchandstopkeywords_retrieve_2.make_request
    api_v1_searchandstopkeywords_update = api_v1_searchandstopkeywords_update.make_request
    api_v1_searchandstopkeywords_destroy = api_v1_searchandstopkeywords_destroy.make_request
    api_v1_searchkeywords_retrieve = api_v1_searchkeywords_retrieve.make_request
    api_v1_searchkeywords_create = api_v1_searchkeywords_create.make_request
    api_v1_searchkeywords_retrieve_2 = api_v1_searchkeywords_retrieve_2.make_request
    api_v1_searchkeywords_update = api_v1_searchkeywords_update.make_request
    api_v1_searchkeywords_destroy = api_v1_searchkeywords_destroy.make_request
    ...
    api_v1_stopkeywords_retrieve = api_v1_stopkeywords_retrieve.make_request
    api_v1_stopkeywords_create = api_v1_stopkeywords_create.make_request
    api_v1_stopkeywords_retrieve_2 = api_v1_stopkeywords_retrieve_2.make_request
