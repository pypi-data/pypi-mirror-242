...
FIELD_VALIDATION_DATABASE = {
    'oracle': {
        'database': { 'required': ['host', 'user', 'service_name'], },
        'table': { 'required': ['host', 'user', 'service_name', 'database'] },
        'data': { 'required': ['host', 'user', 'service_name', 'database'], 'optional': [['table', 'query']] },
    ...
    'snowflake': {
        ...
        'data': { 'required': ['account', 'user', 'password', 'project', 'database'], 'optional': [['table', 'query']] },
