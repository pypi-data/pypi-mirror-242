class Pipeline:
    ...
    def exec(self, flow_id: str, node: dict, input_port: dict):
        ...
        for port_name in node["meta"]["ports_map"]["pout"].keys():
            ...
            prev_dtypes: dict = node["meta"]["ports_map"]["pout"][port_name]["dtypes"] if port_name in node["meta"]["ports_map"]["pout"] and "dtypes" in node["meta"]["ports_map"]["pout"][port_name] else {}
            ...
            # if "deploy_enabled" in node["meta"]["config"]: 
            #     del node["meta"]["config"]["deploy_enabled"]
