...
class VoronoiDiagram:
    ...
    def remove_vertices(
        ...
        If calculate all the vertices, it will take a lot of time and be inefficient.
        ...
        consider_pore: 'bool'
            Default to be True, whether to consider the relative positions between vertices and pore.
        verbose: 'bool'
    ...
    def get_binding_positions(self, method=KMeans,
        ...
        """
        return np.round(self.remove_vertices(method, consider_pore, verbose, **kwargs), 3)
