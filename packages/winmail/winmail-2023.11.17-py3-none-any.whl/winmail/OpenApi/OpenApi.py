...
class OpenApi:
    ...
    # user login pc: tid=2, mobile: tid=6
    login_result = api.login('adminUser', 'myPassword', tid=2)
    ...
    def request(self, method_params: Dict[str, Any]) -> Dict[str, Any]:
        """ http/https请求
    ...
    # login 
    def login(self, user: str, pwd: str, manage_path: Optional[str] = '', tid: Optional[int] = 0):
        """认证
