...
def calculate(hessian: numpy.ndarray, atoms: scine_utilities.AtomCollection) -> container:
    ...
    Calculate the mass weighted normal modes from apartial Hessian and the super system.

    Calculate the mass weighted normal modes from a partial Hessian and the super system.
    """
@typing.overload
def calculate(hessian: numpy.ndarray, elements: typing.List[scine_utilities.ElementType], positions: numpy.ndarray, normalize: bool = False) -> container:
    pass
@typing.overload
def calculate(partial_hessian: scine_utilities.PartialHessian, atoms: scine_utilities.AtomCollection) -> container:
    pass
@typing.overload
def calculate(partial_hessian: scine_utilities.PartialHessian, elements: typing.List[scine_utilities.ElementType], positions: numpy.ndarray, normalize: bool = False) -> container:
    pass
