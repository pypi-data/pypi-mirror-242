...
class AvoidSelfCollisionsDynamicsConstraint:
  ...
  def configure(
    ...
    name: str, # std::string
    priority: any, # placo::dynamics::RelativePositionTask::Priority
...
class Footstep:
  ...
  def overlap(
    self: Footstep,
    other: Footstep, # placo::FootstepsPlanner::Footstep
    margin: float = 0., # double
  ...
  side: any # placo::model::HumanoidRobot::Side
...
class FootstepsPlanner:
  def __init__(
    ...
    parameters: HumanoidParameters, # placo::model::HumanoidParameters
  ...
  def add_first_support(
    supports: list[Support], # std::vector<placo::FootstepsPlanner::Support>
    support: Support, # placo::FootstepsPlanner::Support
  ...
  @staticmethod
  def make_supports(
    footsteps: list[Footstep], # std::vector<placo::FootstepsPlanner::Footstep>
  ...
  def opposite_footstep(
    self: FootstepsPlanner,
    footstep: Footstep, # placo::FootstepsPlanner::Footstep
    d_x: float = 0., # double
    d_y: float = 0., # double
...
class FootstepsPlannerNaive:
  ...
  def plan(
    self: FootstepsPlannerNaive,
    flying_side: any, # placo::model::HumanoidRobot::Side
...
class HumanoidRobot:
  ...
  def get_com_velocity(
    self: HumanoidRobot,
    support: any, # placo::model::HumanoidRobot::Side
...
class SwingFoot:
  ...
  def remake_trajectory(
    old_trajectory: SwingFootTrajectory, # placo::trajectory::SwingFoot::Trajectory
    t: float, # double
    target: numpy.ndarray, # Eigen::Vector3d
...
class WalkPatternGenerator:
  def __init__(
    ...
    robot: HumanoidRobot, # placo::model::HumanoidRobot
    parameters: HumanoidParameters, # placo::model::HumanoidParameters
  ...
  def can_replan_supports(
    self: WalkPatternGenerator,
    trajectory: WalkTrajectory, # placo::WalkPatternGenerator::Trajectory
  ...
  def replan(
    self: WalkPatternGenerator,
    supports: list[Support], # std::vector<placo::FootstepsPlanner::Support>
    old_trajectory: WalkTrajectory, # placo::WalkPatternGenerator::Trajectory
    t_replan: float, # double
  ...
  def replan_supports(
    self: WalkPatternGenerator,
    planner: FootstepsPlanner, # placo::FootstepsPlanner
    trajectory: WalkTrajectory, # placo::WalkPatternGenerator::Trajectory
    t_replan: float, # double
...
__groups__ = {'placo::dynamics': ['AvoidSelfCollisionsDynamicsConstraint', 'Contact', 'Contact6D', 'DynamicsCoMTask', 'DynamicsConstraint', 'DynamicsFrameTask', 'DynamicsGearTask', 'DynamicsJointsTask', 'DynamicsOrientationTask', 'DynamicsPositionTask', 'DynamicsReactionRatioConstraint', 'DynamicsRelativeFrameTask', 'DynamicsRelativeOrientationTask', 'DynamicsRelativePositionTask', 'DynamicsSolver', 'DynamicsSolverResult', 'DynamicsTask', 'ExternalWrenchContact', 'PointContact', 'PuppetContact', 'Relative6DContact', 'RelativePointContact', 'TaskContact'], 'placo::kinematics': ['AvoidSelfCollisionsKinematicsConstraint', 'CentroidalMomentumTask', 'CoMPolygonConstraint', 'CoMTask', 'DistanceTask', 'FrameTask', 'GearTask', 'JointsTask', 'KinematicsConstraint', 'KinematicsSolver', 'OrientationTask', 'PositionTask', 'RegularizationTask', 'RelativeFrameTask', 'RelativeOrientationTask', 'RelativePositionTask', 'Task', 'WheelTask'], 'placo::tools': ['AxisesMask', 'Prioritized'], 'placo::model': ['Collision', 'Distance', 'HumanoidParameters', 'HumanoidRobot', 'RobotWrapper', 'RobotWrapper_State'], 'placo::trajectory': ['CubicSpline', 'CubicSpline3D', 'SwingFoot', 'SwingFootCubic', 'SwingFootCubicTrajectory', 'SwingFootQuintic', 'SwingFootQuinticTrajectory', 'SwingFootTrajectory'], 'placo::problem': ['Expression', 'Integrator', 'IntegratorTrajectory', 'PolygonConstraint', 'Problem', 'ProblemConstraint', 'QPError', 'Sparsity', 'SparsityInterval', 'Variable'], 'placo::FootstepsPlanner': ['Footstep', 'Support'], 'placo': ['FootstepsPlanner', 'FootstepsPlannerNaive', 'FootstepsPlannerRepetitive', 'LIPM', 'WalkPatternGenerator', 'WalkTasks'], 'placo::LIPM': ['LIPMTrajectory'], 'placo::WalkPatternGenerator': ['WalkTrajectory']}
