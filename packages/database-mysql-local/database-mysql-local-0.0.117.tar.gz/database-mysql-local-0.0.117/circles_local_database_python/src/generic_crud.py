...
class GenericCRUD:
    ...
    def __init__(self, schema_name: str, default_table_name: str = None,
                 view_table_name: str = None, default_id_column_name: str = None,
        ...
        self.default_view_table_name = view_table_name
        logger.end()
    ...
    def insert(self, table_name: str = None, data_json: dict = None, ignore_duplicate: bool = False) -> int:
        ...
        insert_query = f"INSERT " + ("IGNORE " if ignore_duplicate else "") + \
        ...
        try:
            ...
            logger.exception(self._log_error_message(message="Error inserting data_json",
                                                     sql_statement=insert_query), object=e)
            logger.end()
            raise
    ...
    def update_by_where(self, table_name: str = None, where: str = None, params: tuple = None,
        ...
        translates into:
        update_by_where(table_name="table_name", data_json={"A": A_val, "B": B_val}, where="C=%s AND D=%s", params=(C_val, D_val)"""
