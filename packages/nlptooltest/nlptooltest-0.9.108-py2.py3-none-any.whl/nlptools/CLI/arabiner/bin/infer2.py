...
def corpus_tokenizer(input_csv, output_csv, text_column, additional_columns, row_id = 1, global_sentence_id = 1):
...
def main():
    ...
    corpus_tokenizer(args.input_csv, args.output_csv, args.text_column, args.additional_columns, row_id = 1, global_sentence_id = 1)
