...
class MaterializedFeatureViewSpec(FeatureViewSpec):
    ...
    # TODO(samantha): remove divergence once we settle on the top level sdk param name
    materialization_technique: Optional[feature_view__data_pb2.MaterializationVersion.ValueType] = attrs.field(
        metadata={utils.LOCAL_REMOTE_DIVERGENCE_ALLOWED: True}
    )
    ...
    def from_data_proto(cls, proto: feature_view__data_pb2.FeatureView) -> "MaterializedFeatureViewSpec":
        ...
        return cls(
            ...
            materialization_technique=utils.get_field_or_none(
                proto.materialization_params, "materialization_technique"
            ),
        )
    ...
    def from_args_proto(
        ...
        return cls(
            ...
            materialization_technique=None,
        )
