...
from ..core.base_entity import BaseRef, CodeRef, DataRef, BaseMetric
from ..core.store import StoreContext
    ...
    def f(cls):
        ...
        if dimension:
            if isinstance(dimension, EvaluationDimension):
                cls.dimension = str(dimension.value)
            elif isinstance(dimension, str):
                cls.dimension = dimension
            else:
                cls.dimension = os.getenv('dimension')
