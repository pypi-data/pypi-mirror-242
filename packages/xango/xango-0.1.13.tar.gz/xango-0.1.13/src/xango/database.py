...
class GraphEdgeCollection(object):
    ...
    def join(self, edge_collection=None, from_item:"CollectionItem"=None, kind:str=None, direction="OUTBOUND", depth:int=1, edge_filters:dict={}, node_filters:dict={}, limit:int=100, offset:int=0, joins:list=[]) -> list:
        """
        To do a graph traversal query
...
def graph_traversal_query_builder(xql:dict, idx=None, parent_idx=None, edge_coll=None) -> dict:
    """
