...
def image_url(x):
    return f"https://satsure-raga-testing-platform-backend-s3-storage.s3.ap-south-1.amazonaws.com/GrassLands_image/{pathlib.Path(x).name}"

def mask_url(x):
    return f"https://satsure-raga-testing-platform-backend-s3-storage.s3.ap-south-1.amazonaws.com/GrassLands_label/{pathlib.Path(x).name}"
