...
class TestTp010(unittest.TestCase):
    ...
    def test_tp010(self):
        ...
        ack_nak = services.th.set_text_at(x, y, '')
        pth.ver.verify_equal('ack', ack_nak['value'])
