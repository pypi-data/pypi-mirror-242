...
def test_bresenham():
    ...
    assert bresenham([0, 1, 4], [0, 4, 1]) == [[0, 1, 4], [0, 2, 3], [0, 3, 2], [0, 4, 1]]
...
def test_smoothen_path():
    ...
    path = [[0, 0, 0], [1, 0, 0], [2, 0, 0], [2, 1, 0], [2, 2, 0], [3, 2, 0], [3, 3, 1], [3, 3, 2], [4, 4, 2]]
    smooth_path = [[0, 0, 0], [1, 0, 0], [2, 0, 0], [2, 1, 0], [2, 2, 0], [3, 2, 0], [3, 3, 1], [4, 4, 2]]
