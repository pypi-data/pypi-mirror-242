...
#if !defined( _LIBCAES_TYPES_H )
#define _LIBCAES_TYPES_H
...
#define __USE_UNIX98
#define LIBCAES_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBCAES_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBCAES_DEFINITION_UNIX98
#endif
...
#endif /* !defined( _LIBCAES_TYPES_H ) */
