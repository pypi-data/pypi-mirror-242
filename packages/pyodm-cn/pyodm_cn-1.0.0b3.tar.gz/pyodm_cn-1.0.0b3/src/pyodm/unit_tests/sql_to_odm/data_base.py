...
from pyodm.unit_tests.sql_to_odm.mappers.subject_mapper import SubjectMapper
from pyodm.unit_tests.sql_to_odm.otree_reader import OtreeReader
...
if __name__ == '__main__':
    registry = CdiscXsdFactory(data_file=pathlib.Path(""), xsd_files=xsd_files())
