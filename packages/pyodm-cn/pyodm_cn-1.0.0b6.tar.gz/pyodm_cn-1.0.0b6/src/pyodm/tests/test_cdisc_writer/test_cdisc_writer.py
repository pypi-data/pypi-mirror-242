...
def test_case1():
    file_path = "/pyodm/tests\\test_cdisc_writer\\resources\\test_case1.xml"
...
def test_case2():
    file_path = "/pyodm/tests\\test_cdisc_writer\\resources\\test_case2.xml"
...
def test_case3():
    file_path = "/pyodm/tests\\test_cdisc_writer\\resources\\test_case3.xml"
    p = CdiscXMLXsdFactory(data_file=Path(file_path), xsd_files=odm_xsd_description())
    cw = CdiscXmlWriter(p.odm(),out_put=Path("test.xml"))
    cw.write()
...
def test_case4():
    file_path = "/pyodm/tests\\test_cdisc_writer\\resources\\test_case4.xml"
    p = CdiscXMLXsdFactory(data_file=Path(file_path), xsd_files=odm_xsd_description())
    cw = CdiscXmlWriter(p.odm(),out_put=Path("test.xml"))
    cw.write()
...
def assert_case1(output_name):
    file_path = f"/pyodm/tests\\test_cdisc_writer\\{output_name}"
    p = CdiscXMLXsdFactory(data_file=Path(file_path), xsd_files=odm_xsd_description())
...
def assert_case3(output_name):
    file = f"/pyodm/tests\\test_cdisc_writer\\{output_name}"
