""" Build an MDC2024 PDF document from a supplied markdown file and source dir
...
IMAGE = "registry.gitlab.com/mdc-2024/pdf-creator"
...
def build_pdf(source_dir, source_file, pull=False, debug=False):
    ...
    res = client.containers.run(
        IMAGE,
        name="md410_2024_conv_pdf_creator",
        command=source_file,
        volumes=volumes,
        auto_remove=True,
        stdout=True,
