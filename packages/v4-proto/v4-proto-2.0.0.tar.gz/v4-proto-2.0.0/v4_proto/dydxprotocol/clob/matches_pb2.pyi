...
class MatchPerpetualDeleveraging(_message.Message):
    __slots__ = ["liquidated", "perpetual_id", "fills"]
    ...
    def __init__(self, liquidated: _Optional[_Union[_subaccount_pb2.SubaccountId, _Mapping]] = ..., perpetual_id: _Optional[int] = ..., fills: _Optional[_Iterable[_Union[MatchPerpetualDeleveraging.Fill, _Mapping]]] = ...) -> None: ...
