...
def _install_agg(cls, method, parent=None):
    ...
    def wrapper(self, *args, **kwargs):
        ...
        if args or kwargs:
            return self._fallback_call(method, *utils._unwrap(args), **kwargs)
...
class FireDucksGroupBy:
    ...
    def _has_unsupported_groupby_args(self):
        ...
        return self._groupby_args or self._groupby_kwargs
    ...
    def __iter__(self):
        return self._fallback_call("__iter__")
    ...
    def aggregate(self, func=None, *args, **kwargs):
        ...
        reason = None
        if self._has_unsupported_groupby_args():
            reason = "unsupported groupby args"
    ...
    def apply(self, func, *args, **kwargs):
        if callable(func):
            ...
            return self._fallback_call("apply", wrapper, *args, **kwargs)
        return self._fallback_call("apply", func, *args, **kwargs)
...
class SeriesGroupBy(FireDucksGroupBy):
    ...
    def aggregate(self, *args, **kwargs):
        ...
        if (
            ...
            reason = "Series.groupby is not suported"
            return self._fallback_call(
                "agg",
                *utils._unwrap(args),
                __fireducks_reason=reason,
    ...
    def transform(self, func, *args, **kwargs):
        ...
        if False:
            if (
                self._has_unsupported_groupby_args()
    ...
    def _head_or_tail(self, is_head, n=5):
        ...
        if (
            ...
            reason.append("Series.groupby is not suported")

        if self._has_unsupported_groupby_args():
            reason.append("unsupported groupby args")
