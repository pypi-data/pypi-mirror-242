...
class parser_ros2(parser_base):
    ...
    def __init__(self, citros) -> None:                                
        ...
        self.ignore_list = citros.get_ignore_list()
    ...
    def get_project_packages(self, package_paths):
        ...
        for package_path in package_paths:            
            ...
            package_launch_paths = [plp for plp in package_launch_paths \
                                    if os.path.relpath(plp, self.project['path']) not in self.ignore_list]
    ...
    def get_project_package_paths(self, project_path : str):
        ...
        package_paths = [pp for pp in package_paths \
                         if os.path.relpath(pp, project_path) not in self.ignore_list]
    ...
    def get_project_launch_paths(self, project_path, package_paths):
        ...
        # filter ignored files
        project_launch_paths = [plp for plp in project_launch_paths \
                                if os.path.relpath(plp, project_path) not in self.ignore_list]
