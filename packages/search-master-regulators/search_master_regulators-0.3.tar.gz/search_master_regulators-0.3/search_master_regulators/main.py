...
def main():
	parser = argparse.ArgumentParser(prog='arabidopsis_master_regulators', description='A Python script to derive Master Regulators based on David & Rebay work', epilog='Developed by Sebastian Contreras-Riquelme (github.com/Cold7)')
