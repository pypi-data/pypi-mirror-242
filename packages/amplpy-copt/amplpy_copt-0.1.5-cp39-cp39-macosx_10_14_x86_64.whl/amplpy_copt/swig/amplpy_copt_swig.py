...
class BaseCallback(object):
    ...
    def add_cut(self, vars, coeffs, direction, rhs):
        return _amplpy_copt_swig.BaseCallback_add_cut(self, vars, coeffs, direction, rhs)

    def add_lazy(self, vars, coeffs, direction, rhs):
        return _amplpy_copt_swig.BaseCallback_add_lazy(self, vars, coeffs, direction, rhs)

    def add_cut_indices(self, nvars, coeffs, direction, rhs):
        return _amplpy_copt_swig.BaseCallback_add_cut_indices(self, nvars, coeffs, direction, rhs)

    def add_lazy_indices(self, nvars, coeffs, direction, rhs):
        return _amplpy_copt_swig.BaseCallback_add_lazy_indices(self, nvars, coeffs, direction, rhs)
    ...
    def getSolutionDict(self):
        val = _amplpy_copt_swig.BaseCallback_getSolutionDict(self)
        return val.asdict()
...
class AMPLModel(object):
    ...
    def addConstraint(self, nnz, vars, coefficients, sense, rhs, name=None):
        return _amplpy_copt_swig.AMPLModel_addConstraint(self, nnz, vars, coefficients, sense, rhs, name)
    ...
    def add_constraint(self, nnz, vars, coefficients, sense, rhs, name=None):
        return _amplpy_copt_swig.AMPLModel_add_constraint(self, nnz, vars, coefficients, sense, rhs, name)
    ...
    def getSolutionDict(self):
        val = _amplpy_copt_swig.AMPLModel_getSolutionDict(self)
        return val.asdict()
...
class CoptCallback(BaseCallback):
    ...
    def getAMPLWhere(self):
        return _amplpy_copt_swig.CoptCallback_getAMPLWhere(self)
