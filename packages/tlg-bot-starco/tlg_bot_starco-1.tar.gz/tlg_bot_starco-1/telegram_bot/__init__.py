...
from .classes import Base, Conversation, Scheduler
...
class TlgBot:
    def __init__(
        ...
        '''
        languages={'fa':1,'en':2} #{'name':lang_id} lang id >0
        '''
        self.token = token
    ...
    def need_init_tables(self):
        ...
        defulat_setting = {
            'edit_mode': {'value': str(0), 'unit': '', 'type': 'bool', 'subset': 'onoff_defulat'},
        }
    ...
    def webhook(self, json_data):
        update = Update(json.loads(json_data), self.bot)
