...
class AsyncTaskExecutor:
    ...
    def add_event_listener(self, func: Callable, *subjects: Any) -> NoReturn:
        """
        注册事件监听器
    ...
    def remove_event_listener(self, *subjects: Any, func: Optional[Callable] = None) -> bool:
        """
        移除事件监听器回调函数
    ...
    def on(self, *subjects: Any) -> Callable:
        """
        注册事件监听器装饰器
        ...
        def decorator(func: Callable):
            self.add_event_listener(func, *subjects)
            return func

        return decorator

    def dispatch(self, data: Any, *subjects: Any, recursion: bool = True) -> NoReturn:
        """
        发布消息主题
