...
{
    "distutils": {
        "name": "guerrilla.device.__init__",
        "sources": [
            "src\\guerrilla\\device\\__init__.py"
        ]
    },
    "module_name": "guerrilla.device.__init__"
}
END: Cython Metadata */
...
#define __PYX_HAVE__guerrilla__device
#define __PYX_HAVE_API__guerrilla__device
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from "guerrilla.device" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "guerrilla.device.__init__"
extern int __pyx_module_is_main_guerrilla__device____init__;
int __pyx_module_is_main_guerrilla__device____init__ = 0;

/* Implementation of "guerrilla.device" */
...
static const char __pyx_k_guerrilla_device___init[] = "guerrilla.device.__init__";
/* #### Code section: decls ### */
...
typedef struct {
  ...
  PyObject *__pyx_kp_u_guerrilla_device___init;
...
static int __pyx_m_clear(PyObject *m) {
  ...
  Py_CLEAR(clear_module_state->__pyx_kp_u_guerrilla_device___init);
...
static int __pyx_m_traverse(PyObject *m, visitproc visit, void *arg) {
  ...
  Py_VISIT(traverse_module_state->__pyx_kp_u_guerrilla_device___init);
...
#define __pyx_kp_u_guerrilla_device___init __pyx_mstate_global->__pyx_kp_u_guerrilla_device___init
...
static int __Pyx_CreateStringTabAndInitStrings(void) {
  __Pyx_StringTabEntry __pyx_string_tab[] = {
    ...
    {&__pyx_kp_u_guerrilla_device___init, __pyx_k_guerrilla_device___init, sizeof(__pyx_k_guerrilla_device___init), 0, 1, 0, 0},
...
__Pyx_PyMODINIT_FUNC init__init__(void) { initdevice(); }
#endif
__Pyx_PyMODINIT_FUNC initdevice(void)
#else
__Pyx_PyMODINIT_FUNC PyInit_device(void) CYTHON_SMALL_CODE; /*proto*/
#if !defined(CYTHON_NO_PYINIT_EXPORT) && (defined(_WIN32) || defined(WIN32) || defined(MS_WINDOWS))
__Pyx_PyMODINIT_FUNC PyInit___init__(void) { return PyInit_device(); }
#endif
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_guerrilla__device____init__) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely((__Pyx_SetPackagePathFromImportLib(__pyx_kp_u_guerrilla_device___init) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "guerrilla.device")) {
      if (unlikely((PyDict_SetItemString(modules, "guerrilla.device", __pyx_m) < 0))) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "guerrilla/device/__init__.py":1
 ...
 */
  ...
  /* "guerrilla/device/__init__.py":3
 * from .base import Device
 * 
 * __all__ = ["Device"]             # <<<<<<<<<<<<<<
 */
  ...
  if (__Pyx_PyList_SET_ITEM(__pyx_t_3, 0, __pyx_n_u_Device)) __PYX_ERR(0, 3, __pyx_L1_error);
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init guerrilla.device", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init guerrilla.device");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
