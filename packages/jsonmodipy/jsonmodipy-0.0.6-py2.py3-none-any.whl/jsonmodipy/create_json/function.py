"""Creates a .json backup of a function in a .py file if it exists and is not
yet backed up."""
from typeguard import typechecked


@typechecked
def create_src_code_function_backup_json(filepath: str) -> None:
    """
...
@typechecked
def generate_json_from_py_function(
    *,
    filedir: str,
    filename: str,
    func_name: str,
    ...
    1. Makes the a json of the function named:
    <filedir>/<filename>_func_<function>_<iteration>.json
    2. Applies black formatting to the Json.
    3. Verifies the <filedir>/<filename>_func_<function>_<iteration>.json can
    ...
    file.
    """
    print("TODO: Generate Json code from function in code of Python file.")
    print(filedir)
    print(filename)
    print(func_name)
    print(iteration)
