...
# -*- coding: utf-8 -*-
"""
This is the example stated in the README.md file.
"""
...
def main(do_plot=True):
    ...
    print(city_district.get_aggr_space_heating_power_curve(currentValues=True))
    print()

    print('Get city district overall space cooling power load curve:')
    print(city_district.get_aggr_space_cooling_power_curve(currentValues=True))
    print()
