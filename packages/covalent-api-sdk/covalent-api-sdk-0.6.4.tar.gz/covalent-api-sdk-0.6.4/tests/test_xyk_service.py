...
class TestXykService:
    ...
    def test_get_pool_for_token_address_success(self, client: CovalentClient):
        pools_token_address = client.xyk_service.get_pools_for_token_address("eth-mainnet", "0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48", 0)
    ...
    def test_dex_for_pool_success(self, client: CovalentClient):
        res = client.xyk_service.get_dex_for_pool_address("eth-mainnet", "0x21b8065d10f73ee2e260e5b47d3344d3ced7596e")
