...
class TestBaseService:
    ...
    def test_get_block_heights_by_page_success(self, client: CovalentClient):
        """ test for get address activity endpoint success """
        blockHeightsByPage = client.base_service.get_block_heights_by_page("eth-mainnet", "2023-01-01", "2023-01-02")
    ...
    def test_get_log_events_contract_by_page_sucess(self, client: CovalentClient):
        ...
        logEventsContractByPage = client.base_service.get_log_events_by_address_by_page("eth-mainnet", "0xdac17f958d2ee523a2206206994597c13d831ec7", 17679143, "17679148")
    ...
    def test_get_log_events_hash_by_page_sucess(self, client: CovalentClient):
        ...
        logEventsHashByPage = client.base_service.get_log_events_by_topic_hash_by_page("eth-mainnet", "0x27f12abfe35860a9a927b465bb3d4a9c23c8428174b83f278fe45ed7b4da2662", 17666774, "17679143")
    ...
    def test_get_log_events_hash_by_page_fail(self, client: CovalentClient):
        ...
        logEventsHashByPage = client.base_service.get_log_events_by_topic_hash_by_page("eth-mainnet", "0xdac17f958d2ee523a2206206994597c13d831e", 17679143, "17679148")
