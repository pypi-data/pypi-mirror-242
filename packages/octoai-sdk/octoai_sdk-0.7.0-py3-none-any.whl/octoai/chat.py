...
class TextModel(str, Enum):
    ...
    LLAMA_2_70B_CHAT_INT4 = "llama-2-70b-chat-int4"
    ...
    CODELLAMA_34B_INSTRUCT_INT4 = "codellama-34b-instruct-int4"
    ...
    def to_name(self):
        ...
        elif self == self.LLAMA_2_70B_CHAT_INT4:
            return "llama-2-70b-chat-int4"
    ...
    def create(
        ...
        *,
        ...
        :param frequency_penalty: Positive values make it less likely that the model
            ...
            -2.0 and 2.0.
        :param function_call: Specify a function that the model should call instead
            of generating a message.
        :param functions: A list of functions that the model can generate inputs for.
        :param logit_bias: A dictionary of tokens and their bias values.
        :param max_tokens: The maximum number of tokens to generate.
        :param n: The number of completions to generate for a given input.
