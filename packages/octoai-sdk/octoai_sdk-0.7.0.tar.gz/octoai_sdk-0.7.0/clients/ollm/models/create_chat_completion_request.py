...
class CreateChatCompletionRequest(BaseModel):
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic.v1 by calling `to_dict()` of each item in functions (list)
        _items = []
        if self.functions:
        ...
        # override the default output from pydantic.v1 by calling `to_dict()` of function_call
        if self.function_call:
            _dict["function_call"] = self.function_call.to_dict()
        # override the default output from pydantic.v1 by calling `to_dict()` of stop
        if self.stop:
            _dict["stop"] = self.stop.to_dict()
        # override the default output from pydantic.v1 by calling `to_dict()` of octoai
        if self.octoai:
        ...
        _obj = CreateChatCompletionRequest.parse_obj(
            {
                "model": obj.get("model"),
                "messages": [
                    ChatMessage.from_dict(_item) for _item in obj.get("messages")
                ]
                if obj.get("messages") is not None
                else None,
                "functions": [
                    Function.from_dict(_item) for _item in obj.get("functions")
                ]
                if obj.get("functions") is not None
                else None,
                "function_call": FunctionCall.from_dict(obj.get("function_call"))
                ...
                "user": obj.get("user"),
                "octoai": ChatCompletionRequestExt.from_dict(obj.get("octoai"))
                if obj.get("octoai") is not None
                else None,
            }
        )
        return _obj
