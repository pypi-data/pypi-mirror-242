...
class VAEData(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VAEData:
        """Create an instance of VAEData from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VAEData:
        """Create an instance of VAEData from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VAEData.parse_obj(obj)

        _obj = VAEData.parse_obj(
            {
