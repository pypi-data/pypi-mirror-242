...
from clients.image_gen.exceptions import ApiTypeError, ApiValueError  # noqa: F401
...
class DefaultApi:
    ...
    def generate_images_generate_sd_post(
        ...
        force_engine: Optional[Any] = None,
        **kwargs
    ) -> ImageGenerationResponse:  # noqa: E501
        ...
        return self.generate_images_generate_sd_post_with_http_info(
            request_body, force_engine, **kwargs
        )  # noqa: E501
    ...
    def generate_images_generate_sd_post_with_http_info(
        ...
        **kwargs
        ...
        _all_params = ["request_body", "force_engine"]
        _all_params.extend(
            [
                "async_req",
    ...
    def generate_images_generate_sdxl_post(
        ...
        **kwargs
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return self.generate_images_generate_sdxl_post_with_http_info(
            request_body, force_engine, **kwargs
        )  # noqa: E501
    ...
    @validate_arguments
    def predict_predict_post(
        self, legacy_image_generation_request: LegacyImageGenerationRequest, **kwargs
    ) -> LegacyImageGenerationResponse:  # noqa: E501
        """Predict  # noqa: E501
        ...
        if "_preload_content" in kwargs:
            ...
            raise ValueError(message)
        return self.predict_predict_post_with_http_info(
            legacy_image_generation_request, **kwargs
        )  # noqa: E501

    @validate_arguments
    def predict_predict_post_with_http_info(
        self, legacy_image_generation_request: LegacyImageGenerationRequest, **kwargs
    ) -> ApiResponse:  # noqa: E501
        """Predict  # noqa: E501
        ...
        _all_params = ["legacy_image_generation_request"]
        _all_params.extend(
            [
                "async_req",
                "_return_http_data_only",
