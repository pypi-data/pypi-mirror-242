...
from clients.image_gen.models.dictionary_of_textual_inversions import (
    DictionaryOfTextualInversions,
)
...
class ImageGenerationRequest(BaseModel):
    ...
    enable_safety: Optional[Any] = Field(
        None,
    ...
    def to_dict(self):
        ...
        # and __fields_set__ contains the field
        if (
            self.force_asset_download is None
            and "force_asset_download" in self.__fields_set__
        ):
        ...
        # and __fields_set__ contains the field
        if (
            self.force_asset_gpu_copy is None
            and "force_asset_gpu_copy" in self.__fields_set__
        ):
        ...
        _obj = ImageGenerationRequest.parse_obj(
            {
                ...
                "prompt_2": SecondInputPrompt.from_dict(obj.get("prompt_2"))
                if obj.get("prompt_2") is not None
                else None,
                "negative_prompt": NegativePrompt.from_dict(obj.get("negative_prompt"))
                if obj.get("negative_prompt") is not None
                else None,
                "negative_prompt_2": SecondNegativePrompt.from_dict(
                    obj.get("negative_prompt_2")
                )
                if obj.get("negative_prompt_2") is not None
                else None,
                "checkpoint": Checkpoint.from_dict(obj.get("checkpoint"))
                if obj.get("checkpoint") is not None
                else None,
                "vae": VAE.from_dict(obj.get("vae"))
                if obj.get("vae") is not None
                else None,
                "textual_inversions": DictionaryOfTextualInversions.from_dict(
                    obj.get("textual_inversions")
                )
                if obj.get("textual_inversions") is not None
                else None,
                "loras": DictionaryOfLoRAs.from_dict(obj.get("loras"))
                if obj.get("loras") is not None
                else None,
                "sampler": obj.get("sampler"),
                "height": OutputImageHeight.from_dict(obj.get("height"))
                if obj.get("height") is not None
                else None,
                "width": OutputImageWidth.from_dict(obj.get("width"))
                if obj.get("width") is not None
                else None,
                "cfg_scale": obj.get("cfg_scale"),
                "steps": obj.get("steps"),
                "num_images": obj.get("num_images"),
                "seed": FixedRandomSeed.from_dict(obj.get("seed"))
                if obj.get("seed") is not None
                else None,
                "init_image": InitialImage.from_dict(obj.get("init_image"))
                if obj.get("init_image") is not None
                else None,
                "mask_image": MaskImage.from_dict(obj.get("mask_image"))
                if obj.get("mask_image") is not None
                else None,
                "strength": obj.get("strength"),
                "style_preset": PreDefinedStyles.from_dict(obj.get("style_preset"))
                if obj.get("style_preset") is not None
                else None,
