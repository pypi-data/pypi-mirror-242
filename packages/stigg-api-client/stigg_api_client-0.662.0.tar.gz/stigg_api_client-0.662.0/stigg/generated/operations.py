...
def fragment_migration_completed_payload():
    _frag = sgqlc.operation.Fragment(_schema.MigrationCompleted, 'MigrationCompletedPayload')
    _frag.account_id()
...
class Fragment:
    ...
    migration_completed_payload = fragment_migration_completed_payload()
...
def subscription_on_migration_completed():
    _op = sgqlc.operation.Operation(_schema_root.subscription_type, name='OnMigrationCompleted')
    _op_migration_completed = _op.migration_completed()
    _op_migration_completed.__fragment__(fragment_migration_completed_payload())
    return _op


class Subscription:
    on_entitlements_updated = subscription_on_entitlements_updated()
    on_migration_completed = subscription_on_migration_completed()
