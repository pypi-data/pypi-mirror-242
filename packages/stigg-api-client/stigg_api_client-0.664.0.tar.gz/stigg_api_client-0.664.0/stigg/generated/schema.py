...
class AwsProduct(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('description', 'logo_url', 'product_code', 'product_id', 'stigg_product_id', 'title', 'visibility')
    description = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='description')
...
class MigrationCompleted(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('account_id', 'environment_id')
    account_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='accountId')
    environment_id = sgqlc.types.Field(sgqlc.types.non_null(String), graphql_name='environmentId')
...
class Subscription(sgqlc.types.Type):
    __schema__ = schema
    __field_names__ = ('entitlements_updated', 'migration_completed', 'usage_updated')
    entitlements_updated = sgqlc.types.Field(sgqlc.types.non_null(EntitlementsUpdated), graphql_name='entitlementsUpdated')
    migration_completed = sgqlc.types.Field(sgqlc.types.non_null(MigrationCompleted), graphql_name='migrationCompleted')
