...
class SignalTransformer:
    def __init__(self, config_hnd, num_of_samples, average_time_difference, signal_values, sign_envel_reqd, ft_phase_reqd, psd_reqd, frequency_filter, wavelet_reqd):
    ...
    def transform(self):
        ...
        # with REAL, all fine
        return num_freq_vals, sampl_freq, frequencies, signal_fft, np.abs(signal_fft), ft_phase, sig_filtered, signal_peaks, psd_x_axis_vals, psd_y_axis_vals, wv_scales, wavelet_transform_data, wavelet_type
