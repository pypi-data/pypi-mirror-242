...
class stratage_timing():
    ...
    def industry_states_distinguish(self,start_date,end_date):
        ...
        ind_states_data['偏股显著阈值']=0.5
        data, layout = plot.plotly_line_and_area(ind_states_data[['行业偏度','主线清晰化','主线模糊化','偏股显著阈值']],title_text='行业偏度',
                                  line_col=['行业偏度','偏股显著阈值'],area_col=['主线清晰化','主线模糊化'],left_axis_name='',right_axis_name='')
...
if __name__ == '__main__':
    ...
    st.currency_states_distinguish('2007-12-01', '2023-10-31')
    # st.industry_states_distinguish('20070101','20231031')
    ...
    # Industry_track.update_elec_car_data(latest_date='2023-08-31')
