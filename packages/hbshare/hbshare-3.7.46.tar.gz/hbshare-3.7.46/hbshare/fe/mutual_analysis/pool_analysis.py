...
class Mutual_fund_report():
    ...
    def get_fund_index_weekly_return_table(end_date):
        ...
        sql = "SELECT JYRQ FROM funddb.JYRL WHERE JYRQ >= {0} and JYRQ<={1} and SFJJ=0 and SFYM=1".format(
...
if __name__ == '__main__':
    ...
    #
    # mr=Mutual_fund_report(start_date='20230928',end_date='20231031',
    #                       asofdate='20230630')
    ...
    # #
    #return_test('HB主题池20221025',int_solution=False)
    ...
    # for asofdate in asofdate_list:
    #     tempdf=pd.DataFrame()
    #     tempdf['jjdm']=simple_filter(asofdate)
    #     tempdf['flag'] = 1
    #     tempdf['asofdate']=asofdate
    #     simple_pool.append(tempdf)
