...
class Crowding:
    def __init__(self, start_date, end_date, data_path):
        ...
        self.sw_industry = get_industry_info()
        self.sw_industry = self.sw_industry[self.sw_industry['INDUSTRY_TYPE'] == 1]
        self.sw_industry = self.sw_industry[self.sw_industry['IS_NEW'] == 1]
        self.sw_industry = self.sw_industry[['INDUSTRY_NAME', 'INDUSTRY_ID', 'BEGIN_DATE', 'END_DATE']]
        self.sw_industry['INDUSTRY_ID'] = self.sw_industry['INDUSTRY_ID'].apply(lambda x: str(x) + '.SI')
        self.sw_symbol_name_dic = self.sw_industry.set_index('INDUSTRY_ID')['INDUSTRY_NAME'].to_dict()
        self.sw_name_symbol_dic = self.sw_industry.set_index('INDUSTRY_NAME')['INDUSTRY_ID'].to_dict()
    ...
    def get_tech_crowding(self, index):
        ...
        index_cons = index_cons.pivot(index='TRADE_DATE', columns='TICKER_SYMBOL', values='IS_CON')
    ...
    def get_etf(self):
        ...
        self.etf_info = pd.read_excel(etf_path, sheet_name='2023.10数据')
    ...
    def get_all(self):
        ...
        fund_holding_volume_change_1Q = fund_holding_volume.pct_change(1)
        ...
        fund_holding_value_change_1Q = fund_holding_value.pct_change(1)
...
if __name__ == '__main__':
    ...
    Crowding(start_date, end_date, data_path).get_all()