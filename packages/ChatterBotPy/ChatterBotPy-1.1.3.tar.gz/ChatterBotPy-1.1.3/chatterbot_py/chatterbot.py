...
class ChatBot(object):
    ...
    def __init__(self, name, **kwargs):
        ...
        storage_adapter = kwargs.get('storage_adapter', 'chatterbot_py.storage.SQLStorageAdapter')

        logic_adapters = kwargs.get('logic_adapters', [
            'chatterbot_py.logic.BestMatch'
        ])
        ...
        preprocessors = kwargs.get(
            'preprocessors', [
                'chatterbot_py.preprocessors.clean_whitespace'
            ]
        )
