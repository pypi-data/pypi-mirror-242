from chatterbot_py.adapters import Adapter
from chatterbot_py.storage import StorageAdapter
from chatterbot_py.search import IndexedTextSearch
from chatterbot_py.conversation import Statement
...
class LogicAdapter(Adapter):
    ...
    def __init__(self, chatbot, **kwargs):
        ...
        from chatterbot_py.response_selection import get_first_response
