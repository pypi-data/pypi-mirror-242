...
from httpx import _types as HttpType
...
class _ClientBase:
    ...
    def __init__(
            self,
            verify: HttpType.VerifyTypes = False,
            limits: httpx.Limits = DEFAULT_LIMITS,
            timeout: HttpType.TimeoutTypes = DOWNLOAD_TIMEOUT,
            **kwargs
    ):
...
class HTTPClientPool(_ClientBase):
    ...
    def __init__(
            ...
            verify: HttpType.VerifyTypes = False,
            limits: httpx.Limits = DEFAULT_LIMITS,
            timeout: HttpType.TimeoutTypes = DEFAULT_TIMEOUT,
            **kwargs
    ):
    ...
    async def send_request(
            self,
            method: str,
            url: HttpType.URLTypes,
            *,
            content: typing.Optional[HttpType.RequestContent] = None,
            data: typing.Optional[HttpType.RequestData] = None,
            files: typing.Optional[HttpType.RequestFiles] = None,
            json: typing.Optional[typing.Any] = None,
            params: typing.Optional[HttpType.QueryParamTypes] = None,
