...
from asyncmy import Connection, Pool, create_pool
...
from ..error import MySQLReadOnlyError
...
class MySQLClient(AsyncContextManager):
    ...
    async def _execute(self, query: str, args: MYSQL_EXECUTE_ARGUMENTS_TYPE = None) -> Cursor:
    ...
    async def execute(self, query: str, args: MYSQL_EXECUTE_ARGUMENTS_TYPE = None) -> Cursor:
    ...
    async def count(self, column: sqlalchemy.Column, select_where: typing.Optional[ClauseElement] = None) -> int:
...
class MySQLPool:
    ...
    def __init__(
            ...
            *, name: str = None, minsize: int = 8, maxsize: int = 32, echo: bool = False, pool_recycle: int = 21600,
            ...
            cursor_class: Cursor = DictCursor, readonly: bool = False,
            **settings
    ):
        ...
        self._cursor_class: Cursor = cursor_class
