...
class BTModule:
  ...
  def __init__(self, ad: ANDROID_DEVICE):
    ...
    self.get_current_le_audio_active_group_id = partial(get_current_le_audio_active_group_id, ad=ad)
...
def get_current_le_audio_active_group_id(ad: android_device.AndroidDevice) -> int:
