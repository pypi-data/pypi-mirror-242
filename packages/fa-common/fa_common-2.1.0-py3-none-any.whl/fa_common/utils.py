...
def check_env():
    ...
    assert Path("./tests/.env-firebase").is_file(), "No .env-firebase file in tests folder"
    assert Path("./tests/.env-minio").is_file(), "No .env-minio file in tests folder"
    assert Path("./tests/.env.secret").is_file(), "No .env.secret file in tests folder"
    assert Path("./firebase-creds.json").is_file(), "No .firebase-creds.json file in root folder"
