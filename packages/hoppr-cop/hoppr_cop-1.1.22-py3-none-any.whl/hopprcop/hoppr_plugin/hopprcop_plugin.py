...
class HopprCopPlugin(HopprPlugin):
    ...
    def pre_stage_process(self) -> Result:
        ...
        purl_to_component = {component.purl.lower(): component for component in parsed_bom.components}
        ...
        bom_serial_number = (
            parsed_bom.serialNumber.split(":")[-1] if parsed_bom.serialNumber is not None else uuid.uuid4()
        )
