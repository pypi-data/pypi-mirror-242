...
def set_credentials_secret_path(
    project="emart-datafabric",
    mount_point="datafabric",
    path="gcp/emart-datafabric/datafabric",
):
    global PROJECT_ID
    PROJECT_ID = project
    global CREDENTIALS_SECRET_MOUNT_POINT
    CREDENTIALS_SECRET_MOUNT_POINT = mount_point
    global CREDENTIALS_SECRET_PATH
    CREDENTIALS_SECRET_PATH = path
...
def _bq_table_to_df(
    ...
    if not spark_session:
        spark_session = get_spark(
            mount=CREDENTIALS_SECRET_MOUNT_POINT, path=CREDENTIALS_SECRET_PATH
        )
