...
class ReportDefinitionServiceReportDateRangeType(object):
    ...
    allowable_values = [TODAY, YESTERDAY, LAST_7_DAYS, LAST_WEEK, LAST_14_DAYS, LAST_30_DAYS, LAST_BUSINESS_WEEK, THIS_MONTH, THIS_MONTH_EXCEPT_TODAY, LAST_MONTH, ALL_TIME, CUSTOM_DATE, NO_RANGE, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ReportDefinitionServiceReportDateRangeType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportDefinitionServiceReportDateRangeType):
            return False
