...
class AccountManagementServiceEnterpriseType(object):
    ...
    allowable_values = [KABUSHIKI, YUGEN, GOSI, ZAIDAN, SYADAN, SYUKYO, GAKKO, KOJIN, OTHER, GOMEI, HIEIRI, GODO, KYODO, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AccountManagementServiceEnterpriseType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountManagementServiceEnterpriseType):
            return False
