...
class FeedServicePlaceholderType(object):
    ...
    allowable_values = [AD_CUSTOMIZER, DYNAMIC_AD_FOR_SEARCH_PAGE_FEEDS, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """FeedServicePlaceholderType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedServicePlaceholderType):
            return False
