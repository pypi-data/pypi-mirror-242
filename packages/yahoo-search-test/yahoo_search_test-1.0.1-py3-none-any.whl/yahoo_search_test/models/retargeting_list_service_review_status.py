...
class RetargetingListServiceReviewStatus(object):
    ...
    allowable_values = [APPROVED, DISAPPROVED, DISAPPROVED_WITH_REVIEW, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """RetargetingListServiceReviewStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RetargetingListServiceReviewStatus):
            return False
