...
class CampaignServiceSettingType(object):
    ...
    allowable_values = [GEO_TARGET_TYPE_SETTING, TARGET_LIST_SETTING, DYNAMIC_ADS_FOR_SEARCH_SETTING, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CampaignServiceSettingType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CampaignServiceSettingType):
            return False
