...
class AdGroupServiceFrequentlyRunBetterPerformingAdsMode(object):
    ...
    allowable_values = [APPLY, DONT_APPLY, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AdGroupServiceFrequentlyRunBetterPerformingAdsMode - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupServiceFrequentlyRunBetterPerformingAdsMode):
            return False
