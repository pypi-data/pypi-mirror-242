...
class AuditLogServiceSelector(object):
    ...
    @property
    def job_ids(self):
        """Gets the job_ids of this AuditLogServiceSelector.  # noqa: E501

        <div lang=\"ja\">登録したジョブのIDです。</div> <div lang=\"en\">Created job ID.</div>   # noqa: E501

        :return: The job_ids of this AuditLogServiceSelector.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def job_ids(self, job_ids):
        """Sets the job_ids of this AuditLogServiceSelector.

        <div lang=\"ja\">登録したジョブのIDです。</div> <div lang=\"en\">Created job ID.</div>   # noqa: E501

        :param job_ids: The job_ids of this AuditLogServiceSelector.  # noqa: E501
        :type: list[int]
        """
