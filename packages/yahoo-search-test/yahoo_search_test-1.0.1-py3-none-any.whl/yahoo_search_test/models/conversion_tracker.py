...
class ConversionTracker(object):
    ...
    def all_conversion_value(self):
        ...
        <div lang=\"ja\"> 自動入札設定対象のコンバージョン値と、対象外のコンバージョン値の合計です。<br> この値はGETでのみ取得可能です。ADD、SET時のレスポンスではnullで返却されます。 </div> <div lang=\"en\"> Total value of conversions to be included to auto bidding and to be exluded from auto bidding.<br> This value can be obtained by GET operation only. ADD and SET responses will return null. </div>   # noqa: E501
    ...
    def conversion_tracker_name(self):
        ...
        <div lang=\"ja\">コンバージョントラッカーの名称です。<br> このフィールドは、ADD時に必須となり、SET時に省略可能となります。</div> <div lang=\"en\">Conversion tracker name.<br> This field is required in ADD operation, and is optional in SET operation.</div>   # noqa: E501
    ...
    def conversion_value(self):
        ...
        <div lang=\"ja\"> 自動入札設定対象のコンバージョン値です。<br> この値はGETでのみ取得可能です。ADD、SET時のレスポンスではnullで返却されます。 </div> <div lang=\"en\"> Conversion value to be included to auto bidding.<br> This value can be obtained by GET operation only. ADD and SET responses will return null. </div>   # noqa: E501
    ...
    def conversions(self):
        ...
        <div lang=\"ja\"> 自動入札設定対象のコンバージョン数です。<br> ユニークコンバージョンか総コンバージョンかは、countingTypeに依存します。<br> この値はGETでのみ取得可能です。ADD、SET時のレスポンスではnullで返却されます。 </div> <div lang=\"en\"> Conversions which counts as included to auto bidding setting.<br> countingType specifies whether one-per-click or many-per-click.<br> This value can be obtained by GET operation only. ADD and SET responses will return null. </div>   # noqa: E501
    ...
    def most_recent_conversion_date(self):
        ...
        <div lang=\"ja\">直近のコンバージョン発生日です。</div> <div lang=\"en\">The most latest date when conversion occurred.</div>   # noqa: E501
