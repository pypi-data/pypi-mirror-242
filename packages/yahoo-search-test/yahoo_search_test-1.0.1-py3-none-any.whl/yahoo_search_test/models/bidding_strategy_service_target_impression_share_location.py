...
class BiddingStrategyServiceTargetImpressionShareLocation(object):
    ...
    allowable_values = [ANYWHERE_ON_PAGE, TOP_OF_PAGE, ABSOLUTE_TOP_OF_PAGE, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """BiddingStrategyServiceTargetImpressionShareLocation - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BiddingStrategyServiceTargetImpressionShareLocation):
            return False
