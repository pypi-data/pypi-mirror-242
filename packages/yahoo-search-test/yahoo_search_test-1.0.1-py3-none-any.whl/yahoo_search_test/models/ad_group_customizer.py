...
class AdGroupCustomizer(object):
    ...
    openapi_types = {
        ...
        'value': 'str',
        'approval_status': 'AdGroupCustomizerServiceApprovalStatus',
    ...
    def __init__(self, account_id=None, ad_group_id=None, customizer_attribute_id=None, value=None, approval_status=None, disapproval_reason_codes=None, local_vars_configuration=None):  # noqa: E501
        """AdGroupCustomizer - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this AdGroupCustomizer.  # noqa: E501
        ...
        :return: The account_id of this AdGroupCustomizer.  # noqa: E501
        :rtype: int
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this AdGroupCustomizer.

        <div lang=\"ja\">アカウントIDです。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。</div> <div lang=\"en\">Account ID.<br> Although this field will be returned in the response, it will be ignored on input.</div>   # noqa: E501

        :param account_id: The account_id of this AdGroupCustomizer.  # noqa: E501
        :type: int
        """
    ...
    def ad_group_id(self):
        """Gets the ad_group_id of this AdGroupCustomizer.  # noqa: E501

        <div lang=\"ja\">広告グループIDです。<br> ADDおよびREMOVE時、このフィールドは必須となります。</div> <div lang=\"en\">Ad group ID.<br> This field is required in ADD and REMOVE operation.</div>   # noqa: E501

        :return: The ad_group_id of this AdGroupCustomizer.  # noqa: E501
        :rtype: int
        """
    ...
    def ad_group_id(self, ad_group_id):
        """Sets the ad_group_id of this AdGroupCustomizer.

        <div lang=\"ja\">広告グループIDです。<br> ADDおよびREMOVE時、このフィールドは必須となります。</div> <div lang=\"en\">Ad group ID.<br> This field is required in ADD and REMOVE operation.</div>   # noqa: E501

        :param ad_group_id: The ad_group_id of this AdGroupCustomizer.  # noqa: E501
        :type: int
        """
    ...
    def customizer_attribute_id(self):
        """Gets the customizer_attribute_id of this AdGroupCustomizer.  # noqa: E501
        ...
        :return: The customizer_attribute_id of this AdGroupCustomizer.  # noqa: E501
        :rtype: int
        """
    ...
    def customizer_attribute_id(self, customizer_attribute_id):
        """Sets the customizer_attribute_id of this AdGroupCustomizer.

        <div lang=\"ja\">カスタマイザー属性IDです。<br> ADDおよびREMOVE時、このフィールドは必須となります。</div> <div lang=\"en\">CustomizerAttribute ID.<br> This field is required in ADD and REMOVE operation.</div>   # noqa: E501

        :param customizer_attribute_id: The customizer_attribute_id of this AdGroupCustomizer.  # noqa: E501
        :type: int
        """
    ...
    @property
    def value(self):
        """Gets the value of this AdGroupCustomizer.  # noqa: E501
        ...
        :return: The value of this AdGroupCustomizer.  # noqa: E501
        :rtype: str
        """
        return self._value
    ...
    def value(self, value):
        """Sets the value of this AdGroupCustomizer.

        <div lang=\"ja\">属性値です。挿入用広告に挿入されます。<br> 入力仕様の詳細は以下のヘルプを参照してください。<br> ・<a href=\"https://ads-help.yahoo-net.jp/s/article/H000044225?language=ja\">アドカスタマイザー属性を関連付ける</a><br> ADD時、このフィールドは必須となります。</div> <div lang=\"en\">The attribute value. It will be inserted into the ad for insertion.<br> See also the help below.<br> * <a href=\"https://ads-help.yahoo-net.jp/s/article/H000044225?language=en_US\">Associate ad customizer attributes</a><br> This field is required in ADD operation.</div>   # noqa: E501

        :param value: The value of this AdGroupCustomizer.  # noqa: E501
        :type: str
        """
    ...
    def approval_status(self):
        """Gets the approval_status of this AdGroupCustomizer.  # noqa: E501


        :return: The approval_status of this AdGroupCustomizer.  # noqa: E501
        :rtype: AdGroupCustomizerServiceApprovalStatus
        """
        return self._approval_status

    @approval_status.setter
    def approval_status(self, approval_status):
        """Sets the approval_status of this AdGroupCustomizer.


        :param approval_status: The approval_status of this AdGroupCustomizer.  # noqa: E501
        :type: AdGroupCustomizerServiceApprovalStatus
        """
    ...
    def disapproval_reason_codes(self):
        """Gets the disapproval_reason_codes of this AdGroupCustomizer.  # noqa: E501
        ...
        :return: The disapproval_reason_codes of this AdGroupCustomizer.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def disapproval_reason_codes(self, disapproval_reason_codes):
        """Sets the disapproval_reason_codes of this AdGroupCustomizer.

        <div lang=\"ja\">審査否認理由です。<br> このフィールドは、レスポンスの際に返却されますが、リクエストの際には無視されます。</div> <div lang=\"en\">Reject reason on editorial review.<br> Although this field will be returned in the response, it will be ignored on input.</div>   # noqa: E501

        :param disapproval_reason_codes: The disapproval_reason_codes of this AdGroupCustomizer.  # noqa: E501
        :type: list[str]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupCustomizer):
            return False
