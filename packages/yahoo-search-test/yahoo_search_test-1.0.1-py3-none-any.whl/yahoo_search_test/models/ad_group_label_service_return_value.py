...
class AdGroupLabelServiceReturnValue(object):
    ...
    """
    openapi_types = {
        'values': 'list[AdGroupLabelServiceValue]'
    }
    ...
    def __init__(self, values=None, local_vars_configuration=None):  # noqa: E501
        """AdGroupLabelServiceReturnValue - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def values(self):
        """Gets the values of this AdGroupLabelServiceReturnValue.  # noqa: E501


        :return: The values of this AdGroupLabelServiceReturnValue.  # noqa: E501
        :rtype: list[AdGroupLabelServiceValue]
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this AdGroupLabelServiceReturnValue.


        :param values: The values of this AdGroupLabelServiceReturnValue.  # noqa: E501
        :type: list[AdGroupLabelServiceValue]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupLabelServiceReturnValue):
            return False
