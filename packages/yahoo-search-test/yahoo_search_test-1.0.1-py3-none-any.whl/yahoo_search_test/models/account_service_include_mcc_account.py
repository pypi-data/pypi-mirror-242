...
class AccountServiceIncludeMccAccount(object):
    ...
    allowable_values = [ONLY_MCC_ACCOUNT, ONLY_ADS_ACCOUNT, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AccountServiceIncludeMccAccount - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountServiceIncludeMccAccount):
            return False
