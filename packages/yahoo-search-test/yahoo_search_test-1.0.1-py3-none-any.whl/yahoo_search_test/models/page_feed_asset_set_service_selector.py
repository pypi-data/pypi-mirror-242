...
class PageFeedAssetSetServiceSelector(object):
    ...
    def __init__(self, account_id=None, page_feed_asset_set_ids=None, number_results=500, start_index=1, local_vars_configuration=None):  # noqa: E501
        """PageFeedAssetSetServiceSelector - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account_id(self):
        """Gets the account_id of this PageFeedAssetSetServiceSelector.  # noqa: E501

        <div lang=\"ja\">アカウントIDです。</div> <div lang=\"en\">Account ID.</div>   # noqa: E501

        :return: The account_id of this PageFeedAssetSetServiceSelector.  # noqa: E501
        :rtype: int
        """
    ...
    def account_id(self, account_id):
        """Sets the account_id of this PageFeedAssetSetServiceSelector.

        <div lang=\"ja\">アカウントIDです。</div> <div lang=\"en\">Account ID.</div>   # noqa: E501

        :param account_id: The account_id of this PageFeedAssetSetServiceSelector.  # noqa: E501
        :type: int
        """
    ...
    def page_feed_asset_set_ids(self):
        """Gets the page_feed_asset_set_ids of this PageFeedAssetSetServiceSelector.  # noqa: E501

        <div lang=\"ja\">ページフィードアセットセットIDです。</div> <div lang=\"en\">PageFeedAssetSet ID.</div>   # noqa: E501

        :return: The page_feed_asset_set_ids of this PageFeedAssetSetServiceSelector.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def page_feed_asset_set_ids(self, page_feed_asset_set_ids):
        """Sets the page_feed_asset_set_ids of this PageFeedAssetSetServiceSelector.

        <div lang=\"ja\">ページフィードアセットセットIDです。</div> <div lang=\"en\">PageFeedAssetSet ID.</div>   # noqa: E501

        :param page_feed_asset_set_ids: The page_feed_asset_set_ids of this PageFeedAssetSetServiceSelector.  # noqa: E501
        :type: list[int]
        """
    ...
    def number_results(self):
        """Gets the number_results of this PageFeedAssetSetServiceSelector.  # noqa: E501
        ...
        :return: The number_results of this PageFeedAssetSetServiceSelector.  # noqa: E501
        :rtype: int
        """
    ...
    def number_results(self, number_results):
        """Sets the number_results of this PageFeedAssetSetServiceSelector.

        <div lang=\"ja\">ページの最大件数です。このフィールドは、1以上を指定する必要があります。</div> <div lang=\"en\">Maximum number of results to return in this page. This field must be greater than or equal to 1. Also see Entity Limits per operation.</div>   # noqa: E501

        :param number_results: The number_results of this PageFeedAssetSetServiceSelector.  # noqa: E501
        :type: int
        """
    ...
    def start_index(self):
        """Gets the start_index of this PageFeedAssetSetServiceSelector.  # noqa: E501
        ...
        :return: The start_index of this PageFeedAssetSetServiceSelector.  # noqa: E501
        :rtype: int
        """
    ...
    def start_index(self, start_index):
        """Sets the start_index of this PageFeedAssetSetServiceSelector.

        <div lang=\"ja\">ページの先頭のインデックスです。このフィールドは、1以上を指定する必要があります。</div> <div lang=\"en\">Index of the first result to return in this page. This field must be greater than or equal to 1.</div>   # noqa: E501

        :param start_index: The start_index of this PageFeedAssetSetServiceSelector.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PageFeedAssetSetServiceSelector):
            return False
