...
class AccountTrackingUrlServiceUrlApprovalStatus(object):
    ...
    allowable_values = [NONE, APPROVED, APPROVED_WITH_REVIEW, REVIEW, DISAPPROVED, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AccountTrackingUrlServiceUrlApprovalStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountTrackingUrlServiceUrlApprovalStatus):
            return False
