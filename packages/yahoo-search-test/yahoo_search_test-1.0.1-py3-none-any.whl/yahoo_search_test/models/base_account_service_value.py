...
class BaseAccountServiceValue(object):
    ...
    def __init__(self, account=None, errors=None, operation_succeeded=None, local_vars_configuration=None):  # noqa: E501
        """BaseAccountServiceValue - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def account(self):
        """Gets the account of this BaseAccountServiceValue.  # noqa: E501


        :return: The account of this BaseAccountServiceValue.  # noqa: E501
        :rtype: BaseAccount
        """
    ...
    def account(self, account):
        """Sets the account of this BaseAccountServiceValue.


        :param account: The account of this BaseAccountServiceValue.  # noqa: E501
        :type: BaseAccount
        """
    ...
    @property
    def errors(self):
        """Gets the errors of this BaseAccountServiceValue.  # noqa: E501


        :return: The errors of this BaseAccountServiceValue.  # noqa: E501
        :rtype: list[Error]
        """
        return self._errors
    ...
    def errors(self, errors):
        """Sets the errors of this BaseAccountServiceValue.


        :param errors: The errors of this BaseAccountServiceValue.  # noqa: E501
        :type: list[Error]
        """
    ...
    def operation_succeeded(self):
        """Gets the operation_succeeded of this BaseAccountServiceValue.  # noqa: E501
        ...
        :return: The operation_succeeded of this BaseAccountServiceValue.  # noqa: E501
        :rtype: bool
        """
    ...
    def operation_succeeded(self, operation_succeeded):
        """Sets the operation_succeeded of this BaseAccountServiceValue.

        <div lang=\"ja\">処理結果です。trueの場合は、処理は成功しました。falseの場合は処理が失敗しています。</div> <div lang=\"en\">The process results. If true, the process succeeded. If false, the process failed.</div>   # noqa: E501

        :param operation_succeeded: The operation_succeeded of this BaseAccountServiceValue.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseAccountServiceValue):
            return False
