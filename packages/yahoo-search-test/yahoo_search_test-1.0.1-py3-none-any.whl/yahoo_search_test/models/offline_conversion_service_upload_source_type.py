...
class OfflineConversionServiceUploadSourceType(object):
    ...
    allowable_values = [API, YAHOO_JAPAN, CAMPAIGN_MANAGEMENT_TOOL, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """OfflineConversionServiceUploadSourceType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OfflineConversionServiceUploadSourceType):
            return False
