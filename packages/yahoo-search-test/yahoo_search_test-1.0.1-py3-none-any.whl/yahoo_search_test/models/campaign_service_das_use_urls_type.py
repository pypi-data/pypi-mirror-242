...
class CampaignServiceDasUseUrlsType(object):
    ...
    allowable_values = [USE_SUPPLIED_URLS_ONLY, TOP_DOMAIN_ONLY, DOMAIN_AND_SUPPLIED_URLS, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CampaignServiceDasUseUrlsType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CampaignServiceDasUseUrlsType):
            return False
