...
class ReportDefinition(object):
    ...
    def __init__(self, account_id=None, complete_time=None, date_range=None, fields=None, filters=None, report_compress_type=None, report_date_range_type=None, report_decimal_part_display_type=None, report_download_encode=None, report_download_format=None, report_include_deleted=None, report_job_error_detail=None, report_job_id=None, report_job_status=None, report_language=None, report_name=None, report_skip_column_header=None, report_skip_report_summary=None, report_type=None, request_time=None, sort_fields=None, local_vars_configuration=None):  # noqa: E501
