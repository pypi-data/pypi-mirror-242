...
class ReportDefinitionServiceFilterOperator(object):
    ...
    allowable_values = [EQUALS, NOT_EQUALS, GREATER_THAN, GREATER_THAN_EQUALS, LESS_THAN, LESS_THAN_EQUALS, CONTAINS, IN, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ReportDefinitionServiceFilterOperator - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReportDefinitionServiceFilterOperator):
            return False
