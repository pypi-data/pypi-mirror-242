...
import yahoo_search_test.models
from yahoo_search_test import rest
from yahoo_search_test.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(yahoo_search_test.models, klass)
