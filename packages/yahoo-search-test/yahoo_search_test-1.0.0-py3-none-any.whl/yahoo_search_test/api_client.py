...
import yahoo_search_api_v12.models
from yahoo_search_api_v12 import rest
from yahoo_search_api_v12.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(yahoo_search_api_v12.models, klass)
