...
class AdGroupAd(object):
    ...
    def __init__(self, account_id=None, ad=None, ad_group_id=None, ad_group_name=None, ad_group_track_id=None, ad_id=None, ad_name=None, ad_track_id=None, approval_status=None, campaign_id=None, campaign_name=None, campaign_track_id=None, disapproval_reason_codes=None, feed_id=None, invalided_trademarks=None, labels=None, trademark_status=None, user_status=None, created_date=None, local_vars_configuration=None):  # noqa: E501
    ...
    def created_date(self):
        ...
        <div lang=\"ja\">広告が作成された日です。<br>※フォーマット：yyyyMMdd</div> <div lang=\"en\">Date of Ad made.<br>* Format: yyyyMMdd</div>   # noqa: E501
