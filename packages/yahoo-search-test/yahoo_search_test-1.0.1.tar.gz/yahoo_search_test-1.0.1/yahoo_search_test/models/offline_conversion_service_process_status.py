...
class OfflineConversionServiceProcessStatus(object):
    ...
    allowable_values = [PROCESSING, DONE, DONE_WITH_ERROR, ERROR, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """OfflineConversionServiceProcessStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OfflineConversionServiceProcessStatus):
            return False
