...
class CampaignServiceConversionOptimizerEligibility(object):
    ...
    allowable_values = [ENABLE, DISABLE, CAMPAIGN_IS_NOT_ACTIVE, NOT_CPC_CAMPAIGN, CONVERSION_TRACKING_NOT_ENABLED, NOT_ENOUGH_CONVERSIONS, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CampaignServiceConversionOptimizerEligibility - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CampaignServiceConversionOptimizerEligibility):
            return False
