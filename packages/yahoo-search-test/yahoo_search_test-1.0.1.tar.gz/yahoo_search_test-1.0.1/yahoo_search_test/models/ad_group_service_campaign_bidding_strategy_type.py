...
class AdGroupServiceCampaignBiddingStrategyType(object):
    ...
    allowable_values = [CPC, TARGET_ROAS, MAXIMIZE_CLICKS, TARGET_CPA, MAXIMIZE_CONVERSIONS, MAXIMIZE_CONVERSION_VALUE, TARGET_IMPRESSION_SHARE, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AdGroupServiceCampaignBiddingStrategyType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupServiceCampaignBiddingStrategyType):
            return False
