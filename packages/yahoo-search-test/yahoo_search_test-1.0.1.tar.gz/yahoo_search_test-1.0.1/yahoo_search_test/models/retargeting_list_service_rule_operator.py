...
class RetargetingListServiceRuleOperator(object):
    ...
    allowable_values = [UNKNOWN, EQUALS, NOT_EQUAL, CONTAINS, NOT_CONTAIN, STARTS_WITH, NOT_START_WITH, ENDS_WITH, NOT_END_WITH]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """RetargetingListServiceRuleOperator - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RetargetingListServiceRuleOperator):
            return False
