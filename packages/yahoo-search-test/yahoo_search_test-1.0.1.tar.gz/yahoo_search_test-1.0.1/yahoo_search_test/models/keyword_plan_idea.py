...
class KeywordPlanIdea(object):
    ...
    def __init__(self, text=None, local_vars_configuration=None):  # noqa: E501
        """KeywordPlanIdea - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def text(self):
        """Gets the text of this KeywordPlanIdea.  # noqa: E501

        <div lang=\"ja\">キーワードです。</div> <div lang=\"en\">Keyword.</div>   # noqa: E501

        :return: The text of this KeywordPlanIdea.  # noqa: E501
        :rtype: str
        """
        return self._text
    ...
    @text.setter
    def text(self, text):
        """Sets the text of this KeywordPlanIdea.

        <div lang=\"ja\">キーワードです。</div> <div lang=\"en\">Keyword.</div>   # noqa: E501

        :param text: The text of this KeywordPlanIdea.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeywordPlanIdea):
            return False
