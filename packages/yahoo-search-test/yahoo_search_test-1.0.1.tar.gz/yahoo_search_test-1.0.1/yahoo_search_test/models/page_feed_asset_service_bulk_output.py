...
class PageFeedAssetServiceBulkOutput(object):
    ...
    allowable_values = [CSV, TSV, ZIPPED_CSV, ZIPPED_TSV, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """PageFeedAssetServiceBulkOutput - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PageFeedAssetServiceBulkOutput):
            return False
