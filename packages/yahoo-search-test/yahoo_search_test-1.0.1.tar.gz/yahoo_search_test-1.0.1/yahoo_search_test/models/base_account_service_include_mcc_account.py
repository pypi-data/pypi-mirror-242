...
class BaseAccountServiceIncludeMccAccount(object):
    ...
    allowable_values = [ONLY_MCC, ONLY_ROOT_MCC, ONLY_ADS_ACCOUNT, ALL, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """BaseAccountServiceIncludeMccAccount - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, BaseAccountServiceIncludeMccAccount):
            return False
