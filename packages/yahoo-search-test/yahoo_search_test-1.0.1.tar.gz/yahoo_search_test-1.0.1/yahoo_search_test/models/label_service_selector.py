...
class LabelServiceSelector(object):
    ...
    openapi_types = {
        'account_id': 'int',
        'count_labeled_entity': 'LabelServiceCountLabeledEntity',
        'label_ids': 'list[int]',
        'number_results': 'int',
        'start_index': 'int'
    }
    ...
    def __init__(self, account_id=None, count_labeled_entity=None, label_ids=None, number_results=2000, start_index=1, local_vars_configuration=None):  # noqa: E501
        ...
        self._count_labeled_entity = None
        ...
        self.count_labeled_entity = count_labeled_entity
    ...
    @property
    def count_labeled_entity(self):
        """Gets the count_labeled_entity of this LabelServiceSelector.  # noqa: E501


        :return: The count_labeled_entity of this LabelServiceSelector.  # noqa: E501
        :rtype: LabelServiceCountLabeledEntity
        """
        return self._count_labeled_entity

    @count_labeled_entity.setter
    def count_labeled_entity(self, count_labeled_entity):
        """Sets the count_labeled_entity of this LabelServiceSelector.


        :param count_labeled_entity: The count_labeled_entity of this LabelServiceSelector.  # noqa: E501
        :type: LabelServiceCountLabeledEntity
        """

        self._count_labeled_entity = count_labeled_entity

    @property
    def label_ids(self):
        """Gets the label_ids of this LabelServiceSelector.  # noqa: E501

        <div lang=\"ja\">ラベルID<br>指定しない場合は、フィルタ条件に すべてのラベルが含まれます。</div> <div lang=\"en\">Label ID.<br>If not specified, the filter condition includes all labels.</div>   # noqa: E501
