...
class FeedItemServicePlaceholderType(object):
    ...
    allowable_values = [QUICKLINK, CALLEXTENSION, AD_CUSTOMIZER, CALLOUT, STRUCTURED_SNIPPET, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """FeedItemServicePlaceholderType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedItemServicePlaceholderType):
            return False
