...
class RetargetingListServiceTag(object):
    ...
    def __init__(self, advanced_snippet=None, local_vars_configuration=None):  # noqa: E501
        """RetargetingListServiceTag - a model defined in OpenAPI"""  # noqa: E501
    ...
    def advanced_snippet(self, advanced_snippet):
        """Sets the advanced_snippet of this RetargetingListServiceTag.

        <div lang=\"ja\">   リニューアル版のサイトリターゲティングタグは、従来のタグよりもブラウザーなどの環境の影響を受けづらい新しいフォーマットのタグです。 <br/>   詳細は以下のヘルプを参照してください。<br>   ・<a href=\"https://ads-help.yahoo-net.jp/s/article/H000044937?language=ja\">サイトリターゲティング用タグの取得とサイトへの設置</a> </div> <div lang=\"en\">   The new format of site retargeting tag avoids the impacts such as changes made to the browser. <br/>   See also the help below.<br>   * <a href=\"https://ads-help.yahoo-net.jp/s/article/H000044937?language=en_US\">Acquire Site Retargeting Tag and Tagging on Site</a> </div>   # noqa: E501

        :param advanced_snippet: The advanced_snippet of this RetargetingListServiceTag.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RetargetingListServiceTag):
            return False
