...
class AdGroupAdLabelServiceReturnValue(object):
    ...
    """
    openapi_types = {
        'values': 'list[AdGroupAdLabelServiceValue]'
    }
    ...
    def __init__(self, values=None, local_vars_configuration=None):  # noqa: E501
        """AdGroupAdLabelServiceReturnValue - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def values(self):
        """Gets the values of this AdGroupAdLabelServiceReturnValue.  # noqa: E501


        :return: The values of this AdGroupAdLabelServiceReturnValue.  # noqa: E501
        :rtype: list[AdGroupAdLabelServiceValue]
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this AdGroupAdLabelServiceReturnValue.


        :param values: The values of this AdGroupAdLabelServiceReturnValue.  # noqa: E501
        :type: list[AdGroupAdLabelServiceValue]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupAdLabelServiceReturnValue):
            return False
