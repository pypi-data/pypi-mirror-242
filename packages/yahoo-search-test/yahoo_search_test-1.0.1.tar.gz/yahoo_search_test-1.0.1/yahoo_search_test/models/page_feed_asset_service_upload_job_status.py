...
class PageFeedAssetServiceUploadJobStatus(object):
    ...
    allowable_values = [IN_PROGRESS, COMPLETED, COMPLETED_WITH_VALIDATION_ERROR, FILE_FORMAT_ERROR, FILE_ENCODING_ERROR, COLUMN_HEADER_ERROR, EXCEED_ROW_LINES, EXCEED_FILE_COUNTS, INVALID_PAGE_FEED_ASSET_SET_ID, TIMEOUT, SYSTEM_ERROR, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """PageFeedAssetServiceUploadJobStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PageFeedAssetServiceUploadJobStatus):
            return False
