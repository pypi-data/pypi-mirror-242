...
class ConversionTrackerServiceConversionCountingType(object):
    ...
    allowable_values = [ONE_PER_CLICK, MANY_PER_CLICK, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """ConversionTrackerServiceConversionCountingType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConversionTrackerServiceConversionCountingType):
            return False
