...
class AdGroupLabelServiceValue(object):
    ...
    def __init__(self, ad_group_label=None, errors=None, operation_succeeded=None, local_vars_configuration=None):  # noqa: E501
        """AdGroupLabelServiceValue - a model defined in OpenAPI"""  # noqa: E501
        if local_vars_configuration is None:
            local_vars_configuration = Configuration()
        self.local_vars_configuration = local_vars_configuration

        self._ad_group_label = None
        self._errors = None
        self._operation_succeeded = None
        self.discriminator = None

        self.ad_group_label = ad_group_label
        self.errors = errors
        self.operation_succeeded = operation_succeeded

    @property
    def ad_group_label(self):
        """Gets the ad_group_label of this AdGroupLabelServiceValue.  # noqa: E501


        :return: The ad_group_label of this AdGroupLabelServiceValue.  # noqa: E501
        :rtype: AdGroupLabel
        """
    ...
    def ad_group_label(self, ad_group_label):
        """Sets the ad_group_label of this AdGroupLabelServiceValue.


        :param ad_group_label: The ad_group_label of this AdGroupLabelServiceValue.  # noqa: E501
        :type: AdGroupLabel
        """
    ...
    @property
    def errors(self):
        """Gets the errors of this AdGroupLabelServiceValue.  # noqa: E501


        :return: The errors of this AdGroupLabelServiceValue.  # noqa: E501
        :rtype: list[Error]
        """
        return self._errors
    ...
    def errors(self, errors):
        """Sets the errors of this AdGroupLabelServiceValue.


        :param errors: The errors of this AdGroupLabelServiceValue.  # noqa: E501
        :type: list[Error]
        """
    ...
    def operation_succeeded(self):
        """Gets the operation_succeeded of this AdGroupLabelServiceValue.  # noqa: E501
        ...
        :return: The operation_succeeded of this AdGroupLabelServiceValue.  # noqa: E501
        :rtype: bool
        """
    ...
    def operation_succeeded(self, operation_succeeded):
        """Sets the operation_succeeded of this AdGroupLabelServiceValue.

        <div lang=\"ja\">処理結果です。trueの場合は、処理は成功しました。falseの場合は処理が失敗しています。</div> <div lang=\"en\">The process results. If true, the process succeeded. If false, the process failed.</div>   # noqa: E501

        :param operation_succeeded: The operation_succeeded of this AdGroupLabelServiceValue.  # noqa: E501
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupLabelServiceValue):
            return False
