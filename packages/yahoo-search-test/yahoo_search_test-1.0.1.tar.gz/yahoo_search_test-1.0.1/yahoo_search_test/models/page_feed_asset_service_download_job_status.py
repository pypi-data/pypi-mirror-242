...
class PageFeedAssetServiceDownloadJobStatus(object):
    ...
    allowable_values = [IN_PROGRESS, COMPLETED, FIELDS_ERROR, TIMEOUT, SYSTEM_ERROR, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """PageFeedAssetServiceDownloadJobStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PageFeedAssetServiceDownloadJobStatus):
            return False
