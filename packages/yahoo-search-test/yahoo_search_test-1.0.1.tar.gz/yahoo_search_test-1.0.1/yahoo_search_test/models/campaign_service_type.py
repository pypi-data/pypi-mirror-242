...
class CampaignServiceType(object):
    ...
    allowable_values = [STANDARD, MOBILE_APP, DYNAMIC_ADS_FOR_SEARCH, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CampaignServiceType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CampaignServiceType):
            return False
