...
class KeywordForecastMetricsServiceKeywordPlanNetwork(object):
    ...
    allowable_values = [YAHOO_SEARCH, SEARCH_NETWORK, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """KeywordForecastMetricsServiceKeywordPlanNetwork - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeywordForecastMetricsServiceKeywordPlanNetwork):
            return False
