...
class AccountLinkServiceAccountStatus(object):
    ...
    allowable_values = [INPROGRESS, WAIT_DECIDE, SUSPENDED, SERVING, ENDED, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AccountLinkServiceAccountStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountLinkServiceAccountStatus):
            return False
