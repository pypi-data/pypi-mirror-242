...
class FeedServicePlaceholderField(object):
    ...
    allowable_values = [AD_CUSTOMIZER_INTEGER, AD_CUSTOMIZER_PRICE, AD_CUSTOMIZER_DATE, AD_CUSTOMIZER_STRING, DYNAMIC_AD_FOR_SEARCH_PAGE_FEEDS_PAGE_URL, DYNAMIC_AD_FOR_SEARCH_PAGE_FEEDS_LABEL, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """FeedServicePlaceholderField - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedServicePlaceholderField):
            return False
