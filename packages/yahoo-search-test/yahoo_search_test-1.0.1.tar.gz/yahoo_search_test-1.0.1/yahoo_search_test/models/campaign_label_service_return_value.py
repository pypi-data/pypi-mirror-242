...
class CampaignLabelServiceReturnValue(object):
    ...
    """
    openapi_types = {
        'values': 'list[CampaignLabelServiceValue]'
    }
    ...
    def __init__(self, values=None, local_vars_configuration=None):  # noqa: E501
        """CampaignLabelServiceReturnValue - a model defined in OpenAPI"""  # noqa: E501
    ...
    @property
    def values(self):
        """Gets the values of this CampaignLabelServiceReturnValue.  # noqa: E501


        :return: The values of this CampaignLabelServiceReturnValue.  # noqa: E501
        :rtype: list[CampaignLabelServiceValue]
        """
        return self._values

    @values.setter
    def values(self, values):
        """Sets the values of this CampaignLabelServiceReturnValue.


        :param values: The values of this CampaignLabelServiceReturnValue.  # noqa: E501
        :type: list[CampaignLabelServiceValue]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CampaignLabelServiceReturnValue):
            return False
