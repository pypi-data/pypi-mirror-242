...
class AccountTrackingUrlServiceSelector(object):
    ...
    def __init__(self, account_ids=None, number_results=1000, start_index=1, local_vars_configuration=None):  # noqa: E501
        """AccountTrackingUrlServiceSelector - a model defined in OpenAPI"""  # noqa: E501
    ...
    def account_ids(self):
        """Gets the account_ids of this AccountTrackingUrlServiceSelector.  # noqa: E501

        <div lang=\"ja\">検索条件：アカウントIDです。</div> <div lang=\"en\">Search condition: Account ID.</div>   # noqa: E501

        :return: The account_ids of this AccountTrackingUrlServiceSelector.  # noqa: E501
        :rtype: list[int]
        """
    ...
    def account_ids(self, account_ids):
        """Sets the account_ids of this AccountTrackingUrlServiceSelector.

        <div lang=\"ja\">検索条件：アカウントIDです。</div> <div lang=\"en\">Search condition: Account ID.</div>   # noqa: E501

        :param account_ids: The account_ids of this AccountTrackingUrlServiceSelector.  # noqa: E501
        :type: list[int]
        """
    ...
    def number_results(self):
        """Gets the number_results of this AccountTrackingUrlServiceSelector.  # noqa: E501
        ...
        :return: The number_results of this AccountTrackingUrlServiceSelector.  # noqa: E501
        :rtype: int
        """
    ...
    def number_results(self, number_results):
        """Sets the number_results of this AccountTrackingUrlServiceSelector.

        <div lang=\"ja\">ページの最大件数です。このフィールドは、1以上を指定する必要があります。</div> <div lang=\"en\">Maximum number of results to return in this page. This field must be greater than or equal to 1. Also see Entity Limits per operation.</div>   # noqa: E501

        :param number_results: The number_results of this AccountTrackingUrlServiceSelector.  # noqa: E501
        :type: int
        """
    ...
    def start_index(self):
        """Gets the start_index of this AccountTrackingUrlServiceSelector.  # noqa: E501
        ...
        :return: The start_index of this AccountTrackingUrlServiceSelector.  # noqa: E501
        :rtype: int
        """
    ...
    def start_index(self, start_index):
        """Sets the start_index of this AccountTrackingUrlServiceSelector.

        <div lang=\"ja\">ページの先頭のインデックスです。このフィールドは、1以上を指定する必要があります。</div> <div lang=\"en\">Index of the first result to return in this page. This field must be greater than or equal to 1.</div>   # noqa: E501

        :param start_index: The start_index of this AccountTrackingUrlServiceSelector.  # noqa: E501
        :type: int
        """
        if (self.local_vars_configuration.client_side_validation and
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AccountTrackingUrlServiceSelector):
            return False
