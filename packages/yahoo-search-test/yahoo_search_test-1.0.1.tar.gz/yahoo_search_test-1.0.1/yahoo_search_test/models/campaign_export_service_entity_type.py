...
class CampaignExportServiceEntityType(object):
    ...
    allowable_values = [CAMPAIGN, NEGATIVE_CAMPAIGN_CRITERION, AD_GROUP, BIDDABLE_AD_GROUP_CRITERION, NEGATIVE_AD_GROUP_CRITERION, AD, ASSET, QUICKLINK_ASSET, CALLOUT_ASSET, STRUCTURED_SNIPPET_ASSET, CALLEXTENSION_ASSET, ALL, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """CampaignExportServiceEntityType - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CampaignExportServiceEntityType):
            return False
