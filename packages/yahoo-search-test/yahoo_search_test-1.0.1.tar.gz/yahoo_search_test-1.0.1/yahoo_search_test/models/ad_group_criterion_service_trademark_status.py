...
class AdGroupCriterionServiceTrademarkStatus(object):
    ...
    allowable_values = [NO_RESTRICTION, CONFLICT_WITH_TRADEMARK, CLAIM_IN_PROGRESS, DISAPPROVED_CLAIM, DISAPPROVED_REVIEWER, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AdGroupCriterionServiceTrademarkStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupCriterionServiceTrademarkStatus):
            return False
