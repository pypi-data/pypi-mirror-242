...
class DictionaryServiceGeographicLocationStatus(object):
    ...
    allowable_values = [ACTIVE, OBSOLETE, PHASING_OUT, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """DictionaryServiceGeographicLocationStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DictionaryServiceGeographicLocationStatus):
            return False
