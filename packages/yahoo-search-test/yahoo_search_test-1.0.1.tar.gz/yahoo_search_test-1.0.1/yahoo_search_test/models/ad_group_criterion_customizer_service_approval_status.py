...
class AdGroupCriterionCustomizerServiceApprovalStatus(object):
    ...
    allowable_values = [APPROVED, APPROVED_WITH_REVIEW, REVIEW, PRE_DISAPPROVED, POST_DISAPPROVED, UNKNOWN]  # noqa: E501
    ...
    def __init__(self, local_vars_configuration=None):  # noqa: E501
        """AdGroupCriterionCustomizerServiceApprovalStatus - a model defined in OpenAPI"""  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AdGroupCriterionCustomizerServiceApprovalStatus):
            return False
