...
class CampaignWebpageServiceApi(object):
    ...
    def campaign_webpage_service_add_post(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """campaign_webpage_service_add_post  # noqa: E501

        <div lang=\"ja\">キャンペーンにPageFeedAssetを配信除外として設定します。</div> <div lang=\"en\">Set excluded settings of PageFeedAsset for campaign.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.campaign_webpage_service_add_post(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        return self.campaign_webpage_service_add_post_with_http_info(x_z_base_account_id, **kwargs)  # noqa: E501

    def campaign_webpage_service_add_post_with_http_info(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """campaign_webpage_service_add_post  # noqa: E501

        <div lang=\"ja\">キャンペーンにPageFeedAssetを配信除外として設定します。</div> <div lang=\"en\">Set excluded settings of PageFeedAsset for campaign.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.campaign_webpage_service_add_post_with_http_info(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_z_base_account_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `x_z_base_account_id` when calling `campaign_webpage_service_add_post`")  # noqa: E501
    ...
    def campaign_webpage_service_get_post(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """campaign_webpage_service_get_post  # noqa: E501

        <div lang=\"ja\">キャンペーンに設定されているPageFeedAssetを照会します。</div> <div lang=\"en\">Get PageFeedAsset setting in campaign.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.campaign_webpage_service_get_post(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.campaign_webpage_service_get_post_with_http_info(x_z_base_account_id, **kwargs)  # noqa: E501

    def campaign_webpage_service_get_post_with_http_info(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """campaign_webpage_service_get_post  # noqa: E501

        <div lang=\"ja\">キャンペーンに設定されているPageFeedAssetを照会します。</div> <div lang=\"en\">Get PageFeedAsset setting in campaign.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.campaign_webpage_service_get_post_with_http_info(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_z_base_account_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_z_base_account_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_z_base_account_id` when calling `campaign_webpage_service_get_post`")  # noqa: E501
    ...
    def campaign_webpage_service_remove_post(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """campaign_webpage_service_remove_post  # noqa: E501

        <div lang=\"ja\">キャンペーンに関連付けしているPageFeedAssetを解除します。</div> <div lang=\"en\">Remove PageFeedAsset associated with campaign.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.campaign_webpage_service_remove_post(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.campaign_webpage_service_remove_post_with_http_info(x_z_base_account_id, **kwargs)  # noqa: E501

    def campaign_webpage_service_remove_post_with_http_info(self, x_z_base_account_id, **kwargs):  # noqa: E501
        """campaign_webpage_service_remove_post  # noqa: E501

        <div lang=\"ja\">キャンペーンに関連付けしているPageFeedAssetを解除します。</div> <div lang=\"en\">Remove PageFeedAsset associated with campaign.</div>   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.campaign_webpage_service_remove_post_with_http_info(x_z_base_account_id, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('x_z_base_account_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['x_z_base_account_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `x_z_base_account_id` when calling `campaign_webpage_service_remove_post`")  # noqa: E501
