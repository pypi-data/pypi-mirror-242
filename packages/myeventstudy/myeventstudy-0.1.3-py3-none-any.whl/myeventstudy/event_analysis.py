...
def event_study(df_eventstudy = None, event_window_list = None, est_window = (-210,-10), predict_model = 'market'):
    # 检查参数有效性
    # 检查 df_eventstudy
    ...
    t_test_df.to_excel(f'{predict_model}_ttest.xlsx',index=False)
