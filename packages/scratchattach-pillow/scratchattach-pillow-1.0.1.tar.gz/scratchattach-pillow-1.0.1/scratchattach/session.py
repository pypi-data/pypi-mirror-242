...
class Session():
    ...
    def __init__(self, session_id, *, username=None):
        log.info('Creating session connection',process='Session')
        ...
        log.info('Session created',process='Session')
    ...
    def _get_xtoken(self):
        ...
        try:
            ...
            if self.banned:
                log.info(f"Warning: The account {self._username} you logged in to is BANNED. Some features may not work properly.",process='Session')
