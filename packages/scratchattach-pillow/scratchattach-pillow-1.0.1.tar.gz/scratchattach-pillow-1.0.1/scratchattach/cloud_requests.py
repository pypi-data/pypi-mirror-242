...
class CloudRequests:
    ...
    def __init__(self,
            ...
            log.info(
            "\033[1mIf you use CloudRequests in your Scratch project, please credit TimMcCool and mas6y6!\033[0m"
        )
            
        log.info("Starting Connection to cloud servers",process='CloudRequest')
