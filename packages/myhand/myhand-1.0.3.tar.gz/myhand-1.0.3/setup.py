...
setup(
    ...
    description='MyHand Bot, an advanced AI assistant, leveraging the capabilities of ChatGPT, capable of engaging in conversations, executing codes, and assisting you with a wide range of tasks.',
