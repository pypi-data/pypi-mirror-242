...
class TaskWizAI:
    ...
    def setup(self):
        ...
        if not config.openaiApiKey:
            ...
            print("Read https://github.com/eliranwong/taskwiz/wiki/ChatGPT-API-Key")
            exit(0)
        ...
        # chat records
        chat_history = os.path.join(config.historyParentFolder if config.historyParentFolder else config.taskWizAIFolder, "history", "chats")
    ...
    def getFiles(self):
        ...
        preferredDir = self.preferredDir if self.preferredDir else os.path.join(config.taskWizAIFolder, "files")
...
Otherwise, answer "chat". Here is the request:"""
    ...
    def runOptions(self, features, userInput):
        ...
        if feature:
            if feature == ".chatgptmodel":
                ...
                SharedUtil.openURL('https://github.com/eliranwong/taskwiz/wiki')
    ...
    def setDeveloperMode(self):
        ...
        option = self.dialogs.getValidOptions(
            ...
            text="Read TaskWiz wiki for more information.\nSelect an option below:"
        )
        if option:
    ...
    def isTtsAvailable(self):
        ...
        self.print("Read more at:\nhttps://github.com/eliranwong/taskwiz/wiki/taskWiz-Speaks")
        return False
    ...
    def defineTtsCommand(self):
        ...
        self.print("* on Windows, simply enter 'windows' here to use Windows built-in speech engine") # taskwiz.ai will handle the command for Windows users
        ...
        while True:
            ...
            if userInput.startswith("!"):
                ...
                try:
                    ...
                    specialEntry = re.search("\[CALL ([^\[\]]*?)\]", userInput)
