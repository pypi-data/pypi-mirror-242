...
given mail_mode mm."""),
    ...
    'lino.modlib.notify.ChangeNotifier' : _("""Model mixin for things that emit notifications to a list of observers (or
...
action check_summaries."""),
    'lino.modlib.summaries.DateSummarized' : _("""A Summarized that will have more than one entries per master,
one for each month."""),
...
UserRole or some subclass thereof."""),
