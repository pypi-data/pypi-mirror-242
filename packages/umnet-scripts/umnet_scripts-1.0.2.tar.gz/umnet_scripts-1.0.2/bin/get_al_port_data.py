    ...
    for port in nd_results:
        ...
        if port['time_last']:
            ...
            if new_port in results:
                ...
                if voip_host:
                    if not(found_port['voip_last_seen']) or (found_port['voip_last_seen'] < last_seen):
                        found_port['voip_last_seen'] = last_seen
                        found_port['voip_mac'] = port['mac']
                
                elif not(found_port['host_last_seen']) or (found_port['host_last_seen'] < last_seen):
                    found_port['host_last_seen'] = last_seen
