...
LOGGER = get_logger(
    name="wind_summary_build_helper_mixins.mod", bind="wind_summary_build_helper_mixins"
)


CaseEnum = TypeVar("CaseEnum")


class BaseSummaryBuilderMixin(ABC, Generic[CaseEnum]):
    ...
    def _set_summary_case(self, case: CaseEnum) -> None:
