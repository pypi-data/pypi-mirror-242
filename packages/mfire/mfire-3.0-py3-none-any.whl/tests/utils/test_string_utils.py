...
class TestStringUtilsFunctions:
    ...
    @pytest.mark.parametrize(
        ...
        [
            (
                "lundi matin orages   ; puis averses",
                "Lundi matin orages ; puis averses.",
            ),
            ...
            (
                "rafales jusqu'à en ce milieu de nuit",
                "Rafales jusqu'en ce milieu de nuit.",
            ),
            ("rafales. ", "Rafales."),
            ("rafales..", "Rafales."),
            ("rafales.    .", "Rafales."),
            ...
            (
                "la température est de 33 celsius. il y aura des vents à partir de en "
                "ce milieu de nuit.",
                "La température est de 33°C. Il y aura des vents à partir du milieu "
                "de nuit.",
            ),
            ("text1  text2", "Text1 text2."),
            (
                "alerte sur toute la période et toute la zone",
                "Alerte sur toute la période et toute la zone.",
            ),
        ],
    )
