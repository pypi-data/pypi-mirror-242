...
from .factories import CompositeFactory1x100, CompositeFactory2x2, CompositeFactory1x1
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                generate_valid_times(periods=1),
                [[50.0, 50.1], [50.2, 50.3]],
                50.28,  # Q95 of [[nan, 50.1], [50.2, 50.3]]
            ),
            # Some gusts are > 50.
            (
                generate_valid_times(periods=2),
