...
MULTIZONE_TABLES = {
    ...
    "P3_2_4_7": {
        ...
        "config": {"production_datetime": "20190726T22"},
        "comment": (
            "Le risque est prévu samedi en matinée et mi-journée sur Marseille Bébé et "
            "concerne également Lyon samedi début de matinée et Toulouse samedi fin "
            "de matinée et mi-journée."
        ),
    },
}
