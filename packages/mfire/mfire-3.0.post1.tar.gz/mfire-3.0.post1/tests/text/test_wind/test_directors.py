...
class TestGustDirectors(TestDirectorsForOneParam):
    ...
    @pytest.mark.parametrize(
        "valid_times, data_gust, case_exp",
        [
            (
                # No gust (Case 1)
            ...
            (
                # Gust (Case 3)
                generate_valid_times(periods=12),
                [0.0] + [60.0] + [0.0] * 4 + [70.0] + [30.0] * 5,
                GustCase.CASE_2,
            ),
        ],
    )
    def test(self, valid_times, data_gust, case_exp: WindCase, assert_equals_result):
        """Test function which call _check method."""
        self._check(valid_times, data_gust, None, None, case_exp, assert_equals_result)
...
class TestDirectors:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                # Gust -> 1 merged period and 1 described period: 001111111000
                # Type 3 wind with direction 180
                generate_valid_times(periods=12),
            ...
            (
                # Only Gust -> 1 merged period and 1 described period: 111111111111
                generate_valid_times(periods=12),
                [70.0] * 12,
                [np.nan] * 12,
                [np.nan] * 12,
            ...
            (
                # Only Gust -> 1 merged period and 1 described period: 001111111000
                generate_valid_times(periods=12),
            ...
            (
                # Gust -> 2 described periods: 011100000000 and 000000001110
                # Type 3 wind with direction 0
                generate_valid_times(periods=12),
            ...
            (
                # Only Gust -> 2 described periods: 111100000000 and 000000001111
                generate_valid_times(periods=12),
                [70.0] * 4 + [2.0] * 4 + [70] * 4,
                [np.nan] * 12,
                [np.nan] * 12,
            ...
            (
                # Only Gust -> 0 merged period but 1 described period: 001000010000
                generate_valid_times(periods=12),
            ...
            (
                # Gust -> 0 merged period but 1 described period:
                # 010000000010000000000100
                # Type 3 wind with direction 90
                generate_valid_times(periods=24),
            ...
            (
                # Gust -> 0 merged period but 1 described period: 100000000001
                # Type 2 wind with direction 90
                generate_valid_times(periods=12),
                [60.0] + [40.0] * 10 + [90.0],
                [20.0] * 12,
                [90.0] * 12,
            ...
            (
                # Gust -> 3 merged periods but 1 described period:
                # 011111111111111111000000
                # Type 2 wind without direction
                generate_valid_times(periods=24),
                [2.0]
                + [60.0] * 3
                + [40.0] * 4
            ...
            (
                # Only Gust -> 2 described periods to check if "ainsi qu'" is present
                generate_valid_times(periods=72),
                [40.0] + [60.0] * 3 + [40.0] * 46 + [80.0] * 4 + [40.0] * 18,
                [100.0] * 72,
                [0.0] * 72,
            ),
        ],
