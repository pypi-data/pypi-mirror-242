...
from mfire.localisation.area_algebra import compute_IoU, compute_IoLeft
from mfire.utils.exception import LocalisationWarning, LocalisationError
...
def get_n_area(
    ...
    try:
        ...
        while n_cut < n_cuts:
            ...
            if best_area.id.values == area.id:
