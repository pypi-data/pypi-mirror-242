...
with open(path_relative_to_src('cengal_setup_scripts/setup_readme/setup_light/README.md'), 'r') as fh:
...
setuptools.setup(
    ...
    extras_require={
        'hardware__info__cpu__versions__v_0': ['py-cpuinfo'],
        'hardware__info__cpu__versions__v_1': ['py-cpuinfo', 'psutil'],
        'cengal__time_management__relative_time__relativedelta': ['python-dateutil'],
        'cengal__web_tools__help_tools': [
            'requests',
            "http_parser; python_version < '3.11'",
        ],
        'cengal__user_interface__console__chooser': ['colorama'],
        'cengal__user_interface__console__colorama_helpers': ['colorama'],
        'cengal__parallel_execution__coroutines': ['greenlet'],
        'cengal__parallel_execution__coroutines__coro_standard_services__db': ['lmdb'],
        'cengal__parallel_execution__coroutines__coro_standard_services__lmdb': ['lmdb'],
        'cengal__parallel_execution__coroutines__coro_standard_services__log': ['lmdb'],
        'cengal__parallel_execution__coroutines__coro_standard_services__loop_yield': ['async_generator'],
        'cengal__parallel_execution__coroutines__coro_standard_services__read_write_locker': ['async_generator'],
        'cengal__parallel_execution__coroutines__coro_standard_services__tkinter': ['async_generator'],
        'cengal__parallel_execution__coroutines__coro_tools__loop_administration__admin_tk': ['ttkbootstrap', 'pprintpp'],
        'cengal__data_manipulation__serialization': [
            'simplejson', 'cbor', 'cbor2', 'ujson', 'orjson', 'cloudpickle', 
        ...
        'cengal__user_interface__gui__tkinter': ['ttkbootstrap'],
        'cengal__text_processing__encoding_detection': [
            "charset-normalizer; python_version < '3.13'", 
            "chardet; python_version < '3.11'",
        ],
        'full': [
            'py-cpuinfo', 'psutil', 'python-dateutil', 'greenlet', 'greenlet', 'lmdb', 'async_generator',
            'ttkbootstrap', 'pprintpp', 'requests', 'simplejson', 'cbor', 'cbor2', 'ujson', 'orjson', 'cloudpickle', 
            "http_parser; python_version < '3.11'",
            "msgpack-python; python_version < '3.8' and platform_python_implementation == 'CPython'",
            "msgpack; python_version >= '3.8' and platform_python_implementation == 'CPython'",
            "msgpack-pypy; platform_python_implementation == 'PyPy'",
