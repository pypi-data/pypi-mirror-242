# Form implementation generated from reading ui file 'edit_driftscan_window.ui'
#
...
class Ui_DriftscanWindow(object):
    def setupUi(self, DriftscanWindow):
        ...
        self.centralwidget = QtWidgets.QWidget(parent=DriftscanWindow)
        ...
        self.LblFilename = QtWidgets.QLabel(parent=self.gridLayoutWidget)
        self.LblFilename.setObjectName("LblFilename")
        self.horizontalLayout_4.addWidget(self.LblFilename)
        self.EdtFilename = QtWidgets.QLineEdit(parent=self.gridLayoutWidget)
        ...
        self.LblObjectType = QtWidgets.QLabel(parent=self.layoutWidget)
        self.LblObjectType.setObjectName("LblObjectType")
        self.verticalLayout_10.addWidget(self.LblObjectType)
        self.EdtObjectType = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.LblObjectName = QtWidgets.QLabel(parent=self.layoutWidget)
        self.LblObjectName.setObjectName("LblObjectName")
        self.verticalLayout_10.addWidget(self.LblObjectName)
        self.EdtObjectName = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.horizontalLayoutWidget = QtWidgets.QWidget(parent=self.fit_window_tab)
        ...
        self.plot_groupbox = QtWidgets.QGroupBox(parent=self.horizontalLayoutWidget)
        self.plot_groupbox.setObjectName("plot_groupbox")
        self.verticalLayoutWidget = QtWidgets.QWidget(parent=self.plot_groupbox)
        ...
        self.ComboBoxFitType = QtWidgets.QComboBox(parent=self.verticalLayoutWidget)
        ...
        self.ComboBoxFitLoc = QtWidgets.QComboBox(parent=self.verticalLayoutWidget)
        ...
        self.ComboBoxFitOrder = QtWidgets.QComboBox(parent=self.verticalLayoutWidget)
        ...
        self.ComboBoxFilterType = QtWidgets.QComboBox(parent=self.verticalLayoutWidget)
        ...
        self.LblFilteringWindow = QtWidgets.QLabel(parent=self.verticalLayoutWidget)
        self.LblFilteringWindow.setObjectName("LblFilteringWindow")
        self.horizontalLayout_12.addWidget(self.LblFilteringWindow)
        self.EdtFilteringWindow = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget)
        ...
        self.single_beam_groupbox = QtWidgets.QGroupBox(parent=self.horizontalLayoutWidget)
        self.single_beam_groupbox.setObjectName("single_beam_groupbox")
        self.verticalLayoutWidget_2 = QtWidgets.QWidget(parent=self.single_beam_groupbox)
        ...
        self.BtnFilterData = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        ...
        self.BtnFitData = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        ...
        self.BtnClearSelection = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        ...
        self.BtnCalc = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        ...
        self.EdtAddPSS = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_2)
        self.EdtAddPSS.setEnabled(False)
        self.EdtAddPSS.setObjectName("EdtAddPSS")
        self.BrcpPSSlayout_3.addWidget(self.EdtAddPSS)
        self.DropSetPSS = QtWidgets.QComboBox(parent=self.verticalLayoutWidget_2)
        ...
        self.BtnGetPSS_2 = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        self.BtnGetPSS_2.setObjectName("BtnGetPSS_2")
        self.BrcpPSSlayout_4.addWidget(self.BtnGetPSS_2)
        self.BtnPSSreset_2 = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_2)
        ...
        self.pss_values_groupbox = QtWidgets.QGroupBox(parent=self.horizontalLayoutWidget)
        self.pss_values_groupbox.setObjectName("pss_values_groupbox")
        self.verticalLayoutWidget_3 = QtWidgets.QWidget(parent=self.pss_values_groupbox)
        ...
        self.BtnPopulatePSS = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_3)
        ...
        self.LblPSSlcpA = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.LblPSSlcpA.setObjectName("LblPSSlcpA")
        self.AlcpPSSlayout.addWidget(self.LblPSSlcpA)
        self.EdtPSSlcpA = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_3)
        ...
        self.LblPSSlcpB = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.LblPSSlcpB.setObjectName("LblPSSlcpB")
        self.BlcpPSSlayout.addWidget(self.LblPSSlcpB)
        self.EdtPSSlcpB = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_3)
        ...
        self.LblPSSrcpA = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.LblPSSrcpA.setObjectName("LblPSSrcpA")
        self.ArcpPSSlayout.addWidget(self.LblPSSrcpA)
        self.EdtPSSrcpA = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_3)
        ...
        self.LblPSSrcpB = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.LblPSSrcpB.setObjectName("LblPSSrcpB")
        self.BrcpPSSlayout.addWidget(self.LblPSSrcpB)
        self.EdtPSSrcpB = QtWidgets.QLineEdit(parent=self.verticalLayoutWidget_3)
        ...
        self.BtnSavePSS = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_3)
        ...
        self.BtnResetPSS = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_3)
        ...
        self.BtnResetPlot = QtWidgets.QPushButton(parent=self.layoutWidget1)
        ...
        self.BtnSaveToDb = QtWidgets.QPushButton(parent=self.layoutWidget1)
        ...
        self.LblPlottype = QtWidgets.QLabel(parent=self.layoutWidget4)
        self.LblPlottype.setObjectName("LblPlottype")
        self.FitBaseLayout_2.addWidget(self.LblPlottype)
        self.ComboBoxPlotType = QtWidgets.QComboBox(parent=self.layoutWidget4)
        ...
        self.BtnChoosePlot = QtWidgets.QPushButton(parent=self.layoutWidget4)
        ...
        self.statusbar = QtWidgets.QStatusBar(parent=DriftscanWindow)
        self.statusbar.setObjectName("statusbar")
        DriftscanWindow.setStatusBar(self.statusbar)
        self.actionOpen_file = QtGui.QAction(parent=DriftscanWindow)
        self.actionOpen_file.setObjectName("actionOpen_file")
        self.actionClose_program = QtGui.QAction(parent=DriftscanWindow)
        self.actionClose_program.setObjectName("actionClose_program")
        self.actionExit = QtGui.QAction(parent=DriftscanWindow)
