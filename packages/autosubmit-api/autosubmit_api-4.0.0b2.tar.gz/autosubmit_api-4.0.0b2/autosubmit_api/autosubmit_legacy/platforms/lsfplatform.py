...
from .headers.lsf_header import LsfHeader
from .wrappers.wrapper_factory import LSFWrapperFactory
...
class LsfPlatform(ParamikoPlatform):
    ...
    def update_cmds(self):
        ...
        self._submit_cmd = "bsub -cwd " + self.remote_log_dir + \
            " < " + self.remote_log_dir + "/"
        self.put_cmd = "scp"
        self.get_cmd = "scp"
    ...
    def jobs_in_queue(self):
        return list(zip(*[line.split() for line in ''.split('\n')]))[0][1:]
