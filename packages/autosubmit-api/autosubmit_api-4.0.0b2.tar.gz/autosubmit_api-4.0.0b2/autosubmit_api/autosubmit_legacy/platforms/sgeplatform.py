...
from .headers.sge_header import SgeHeader
...
class SgePlatform(ParamikoPlatform):
    ...
    def __init__(self, expid, name, config):
        ...
        self.job_status['QUEUING'] = ['qw', 'hqw',
                                      'hRwq', 'Rs', 'Rts', 'RS', 'RtS', 'RT', 'RtT']
    ...
    def update_cmds(self):
        ...
        self._submit_cmd = "qsub -wd " + self.remote_log_dir + \
            " " + self.remote_log_dir + "/"
        self.put_cmd = "scp"
        self.get_cmd = "scp"
    ...
    def jobs_in_queue(self):
        output = subprocess.check_output(
            'qstat -xml'.format(self.host), shell=True)
