...
cpdef zeros_v_m(double a, double h, double tau, int m_max, double accuracy) noexcept:
...
cpdef zeros_u_m(double a, double h, double tau, int m_max, double accuracy) noexcept:
    """Compute the roots of the equation
