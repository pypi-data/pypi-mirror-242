...
cdef object c_squeezer_fill_qnoise(ConnectorWorkspace cws) noexcept:
    r"""
...
cdef object c_squeezer_fill_rhs(ConnectorWorkspace cws) noexcept:
    cdef:
...
cdef object c_squeezer_fill_signal(ConnectorWorkspace cws) noexcept:
    cdef:
        Py_ssize_t i
        SqueezerWorkspace ws = <SqueezerWorkspace>cws
