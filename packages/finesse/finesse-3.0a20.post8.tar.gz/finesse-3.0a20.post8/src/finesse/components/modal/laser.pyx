...
cdef object c_laser_carrier_fill_rhs(ConnectorWorkspace cws) noexcept:
    r"""
...
cdef object c_laser_fill_qnoise(ConnectorWorkspace cws) noexcept:
    r"""
...
cdef object c_laser_fill_signal(ConnectorWorkspace cws) noexcept:
    cdef:
        LaserWorkspace ws = <LaserWorkspace>cws
