...
cdef class CameraWorkspace(MaskedDetectorWorkspace):
    ...
    cpdef cache(self, bint initial=False) noexcept:
...
cdef c_field_pixel_output(DetectorWorkspace dws) noexcept:
    cdef:
...
cdef c_ccd_pixel_output(DetectorWorkspace dws) noexcept:
    cdef:
...
cdef c_field_line_output(DetectorWorkspace dws) noexcept:
    cdef:
...
cdef c_ccd_line_output(DetectorWorkspace dws) noexcept:
    cdef:
...
cdef c_field_camera_output(DetectorWorkspace dws) noexcept:
    cdef:
...
cdef c_ccd_output(DetectorWorkspace dws) noexcept:
    cdef:
