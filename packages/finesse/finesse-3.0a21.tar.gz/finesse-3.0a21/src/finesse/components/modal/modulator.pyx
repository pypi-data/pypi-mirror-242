...
cdef class ModulatorWorkspace(KnmConnectorWorkspace):
    ...
    cpdef fill_quantum_matrix(self) noexcept:
        cdef:
...
cdef object compute_factors(ModulatorWorkspace ws) noexcept:
    """
    ToDo
    ----
...
cdef object c_modulator_carrier_fill(ConnectorWorkspace cws) noexcept:
...
cdef object c_modulator_signal_optical_fill(ConnectorWorkspace cws) noexcept:
    cdef ModulatorWorkspace ws = <ModulatorWorkspace>cws
...
cdef object c_modulator_signal_phase_fill(ConnectorWorkspace cws) noexcept:
    cdef ModulatorWorkspace ws = <ModulatorWorkspace>cws
...
cdef object c_modulator_signal_amp_fill(ConnectorWorkspace cws) noexcept:
    cdef ModulatorWorkspace ws = <ModulatorWorkspace>cws
    if ws.mod_type == ModulatorType.pm:
