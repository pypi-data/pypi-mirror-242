...
cdef c_pd0_DC_output(DetectorWorkspace dws) noexcept:
...
cdef c_pd0_DC_output_segmented(DetectorWorkspace dws) noexcept:
    """This expects a `PD0Workspace` input. Fast computation of DC power at a node
...
cdef c_pd0_DC_output_masked(DetectorWorkspace dws) noexcept:
...
cdef class PD1Workspace(MaskedDetectorWorkspace):
    ...
    cpdef update_beats(self) noexcept:
        """
...
cdef object c_pd1_AC_output(DetectorWorkspace dws) noexcept:
...
cdef object c_pd1_DC_output(DetectorWorkspace dws) noexcept:
...
cdef object c_pd2_DC_output(DetectorWorkspace dws) noexcept:
...
cdef object c_pd2_AC_output(DetectorWorkspace dws) noexcept:
    """This expects a `PD2Workspace` input"""
    cdef:
        PD2Workspace ws = <PD2Workspace> dws
        frequency_info_t *f1
