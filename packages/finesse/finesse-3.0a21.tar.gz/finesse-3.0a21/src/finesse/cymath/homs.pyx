...
cdef class HGModeWorkspace:
    ...
    cpdef set_values(self, qx=None, qy=None, nr=None, lambda0=None) noexcept:
        cdef:
            complex_t qx_, qy_
            double nr_, lambda0_
    ...
    cpdef u_n(self, x, complex_t[::1] out=None) noexcept:
    ...
    cpdef u_m(self, y, complex_t[::1] out=None) noexcept:
        from finesse.utilities.misc import is_iterable
    ...
    cpdef u_nm(self, x, y, out=None) noexcept:
        U_n = self.u_n(x)
...
cdef class HGModes:
    ...
    cpdef compute_1d_modes(self, double[::1] x, double[::1] y) noexcept:
    ...
    cdef c_compute_1d_modes_T(self, double[::1] x, double[::1] y) noexcept:
    ...
    cdef c_compute_1d_modes(self, double[::1] x, double[::1] y) noexcept:
        cdef Py_ssize_t i, j, Nx, Ny
    ...
    cpdef compute_2d_modes(self, double[::1] x, double[::1] y) noexcept:
    ...
    cpdef compute_points(self, double[::1] x, double[::1] y) noexcept:
    ...
    cdef c_compute_2d_modes(self, double[::1] x, double[::1] y) noexcept:
        cdef:
            complex_t[:, ::1] Un
            complex_t[:, ::1] Um
