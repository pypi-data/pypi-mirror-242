...
class RequestStatusGetResponse(object):
    ...
    openapi_types = {
        ...
        'embed_cluster': 'EmbedderClusterStatus',
    ...
    def __init__(self, cluster=None, embed=None, embed_cluster=None, featurization=None, merge_pf=None, pf_create=None, reference_pf_create=None, saliency_map=None, statistics=None, train_coreset=None, local_vars_configuration=None):  # noqa: E501
        ...
        if embed is not None:
            self.embed = embed
        if embed_cluster is not None:
            self.embed_cluster = embed_cluster
    ...
    def embed_cluster(self):
        """Gets the embed_cluster of this RequestStatusGetResponse.  # noqa: E501


        :return: The embed_cluster of this RequestStatusGetResponse.  # noqa: E501
        :rtype: EmbedderClusterStatus
        """
        return self._embed_cluster

    @embed_cluster.setter
    def embed_cluster(self, embed_cluster):
        """Sets the embed_cluster of this RequestStatusGetResponse.


        :param embed_cluster: The embed_cluster of this RequestStatusGetResponse.  # noqa: E501
        :type embed_cluster: EmbedderClusterStatus
        """

        self._embed_cluster = embed_cluster
