...
class CreateSubmitJobRequest(object):
    ...
    def __init__(self, advanced_config=None, data_source=None, distance_metric=None, job_type=None, patches=None, request_source_meta=None, saliency_map_config=None, src=None, tunables=None, vseq_config=None, local_vars_configuration=None):  # noqa: E501
