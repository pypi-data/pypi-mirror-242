...
class ResultsetCatalogSyncSessionRequest(object):
    ...
    def attributes_to_be_synced(self):
        ...
        key is attribute original name and value is alias name of that attribute provided by user. whichever attribute part of this map will be consider for sync other attributes get ignored. If attributes to be synced not provided all the available attributes for catalog sync will get synced to the catalog  # noqa: E501
