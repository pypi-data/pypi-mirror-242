...
class SimSearchInfoForList(object):
    ...
    def __init__(self, distance_metric=None, is_current_version_supported=None, jobname=None, last_updated_on=None, reqid=None, sim_search_rid=None, sim_search_title=None, tags=[], use_patch_restriction=False, user=None, version=None, vseq=None, local_vars_configuration=None):  # noqa: E501
