...
class LabelSpecClass(object):
    ...
    def __init__(self, description=None, id=None, image_prompts=None, is_approved=False, is_skipped=False, name=None, resolved_prompt=None, superclass=None, text_analysis_output=None, local_vars_configuration=None):  # noqa: E501
