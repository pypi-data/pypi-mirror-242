...
class AnalyzeMetaGetResponse(object):
    ...
    def __init__(self, analyze_slice=None, classes=None, confidence_config=None, data_source=None, iou_config=None, other_classes=None, plot_featurizer=None, local_vars_configuration=None):  # noqa: E501
