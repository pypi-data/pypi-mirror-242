...
class ResultsetUpdateRequest(object):
    ...
    def __init__(self, export_to_top_level=None, frames=None, metadata=None, persist_sim_search_resultset=None, version=None, local_vars_configuration=None):  # noqa: E501
