...
class TestConsumptionResource(unittest.TestCase):
    ...
    def test_total_report_tenant_cloud(self):
        ...
        self.adjustment.total_report(
            ...
            tenant='EPM-CIT2',
            cloud=[SdkCloud.AZURE, SdkCloud.GOOGLE,
                   SdkCloud.OPEN_STACK],
    ...
    # def test_billing_describe_billing_month(self):
    #
    #     self.billing.describe_billing_month(
    #         year=self.current_year,
    #         month=self.current_month,
    #     )
    #
    # def test_billing_describe_currency(self):
    #
    #     self.billing.describe_currency(
    #         year=self.current_year,
    #         month=self.current_month,
    #         cloud=SdkCloud.AZURE
    #     )
    #
    # def test_billing_get_top_account_reports(self):
    #
    #     self.billing.get_top_account_reports(
    #         year=self.current_year,
    #         month=self.current_month,
    #         number=10,
    #         bucket='test',
    ...
    #     )
    #
    # def test_billing_get_pricing_policy(self):
    #
    #     self.billing.get_billing_pricing_policy(
    #         region='AWS-PAAS'
    #     )
    #
    # def test_billing_pricing_policy_change_time_unit_to_per_second(self):
    #
    #     self.billing.billing_change_time_unit_to_per_second(
    #         region='AWS-PAAS'
    #     )
    #
    # def test_billing_send_paas_reports(self):
    #
    #     self.billing.send_paas_reports(
    #         year=self.current_year,
    #         month=self.current_month,
    #     )
    #
    # def test_billing_add_cost_center(self):
    #
    #     self.billing.add_cost_center(
    #         regions=['AWS-PAAS', 'AZURE-PAAS'],
    #         cost_center='test'
    #     )
    #
    # def test_billing_health_check(self):
    #
    #     self.billing.health_check(
    #         bill_from='test',
    #         skip_checkpoints=True,
    #         skip_volumes=True,
    #         skip_machine_images=True,
    #         skip_broken_events=True,
    #         skip_deleted_instances=True,
    #         skip_base_quantity=True,
    #         fix_events=True
    #     )
    #
    # def test_billing_archive_big_query(self):
    #
    #     self.billing.archive_big_query(
    #         admin_project_id='test',
    #         table_id='test',
    #         year=self.current_year,
    #         month=self.current_month,
    #         archivation='enabled'
    ...
    #
    #     self.billing.health_check_v2(
    #         email='test'
    #     )
    #
    # def test_billing_configure(self):
    #
    #     self.billing.billing_configure(
    #         aws_athena_update_schedule='test',
    #         aws_cost_explorer_update_schedule='test',
    #         aws_cost_column='BlendedCost',
    #         aws_update_period='DAYS',
    #         azure_update_schedule='test',
    #         supported_service='test',
    #         customize_report_structure='test',
    #         describe='test'
    #     )
