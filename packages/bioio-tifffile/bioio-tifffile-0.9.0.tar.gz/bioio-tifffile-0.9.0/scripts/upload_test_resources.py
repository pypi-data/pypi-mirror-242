...
from bioio_tifffile import __version__
...
def upload_test_resources(args: Args):
    ...
    try:
        ...
        resources_dir = (
            Path(__file__).parent.parent / "bioio_tifffile" / "tests" / "resources"
        ).resolve(strict=True)
        ...
        package_name = "bioio_tifffile/test_resources"
        ...
        # Upload
            ...
            if confirmation:
                pushed = package.push(
                    ...
                    message=f"Test resources for `bioio_tifffile` version: {__version__}.",
                )
