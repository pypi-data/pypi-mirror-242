...
class OpenAI:
    ...
    def _del_message_by_index(
        ...
        mask = self._del_message_by_index_mask(messages, index)
        ...
        if messages is None:
            ...
            if is_question:
                ...
                messages.append(
                    self._create_message_param(
                        "user",
                        "Okay, I trust you. Please answer my question with your best knowledge. Also, I want you to answer in the language of my question. Not limited to English.",
                    )
                )
        try:
            if len(self.tools) > 0:
    ...
    def set_python_functions(self):
        ...
        self.set_function(python_interpreter)
