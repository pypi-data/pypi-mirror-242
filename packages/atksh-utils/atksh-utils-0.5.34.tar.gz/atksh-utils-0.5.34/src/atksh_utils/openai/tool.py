...
def run_pyhton_with_session(code: str) -> str:
    ...
    """
    result = ""
    with Python_LOCK, io.StringIO() as buf, redirect_stdout(buf):
        out = None
        with tempfile.NamedTemporaryFile(mode="w", suffix=".py") as f:
            try:
                ...
                f.write("\n\n\n")
                f.write(
                    "print('\\n\\n\\nThe code is executed successfully. The following is the system message about session.')\n"
                )
                f.write(
