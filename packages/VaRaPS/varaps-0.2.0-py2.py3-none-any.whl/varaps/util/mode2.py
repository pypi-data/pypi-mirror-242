...
from util import VariantsProportionCoOcc
from util import VariantsProportionFreyjaSparse
from util import VariantsProportionFreyja1Sparse
from util import VariantsProportionLCS
import warnings
...
def analyse_file(file, PATH_RESULT, PATH_M_MATRIX, NbBootstraps, alphaInit, optibyAlpha, decov_method=1):
    ...
    if decov_method == 1:
        ...
        decov_name = "LCS"
    # elif decov_method == 3 or decov_method == :
    #     decov_func = VariantsProportionFreyjaSparse.VariantsProportionFreyjaSparse
    #     decov_name = "FreyjaSparse"
    ...
    for i in range(NbBootstraps):
        ...
        # print result
        # for i in idxs:
        #     print(variants[i], res_decov.params[i])
        # save result
    ...
    resCooc_df["nbReads"] = len(Weights)
