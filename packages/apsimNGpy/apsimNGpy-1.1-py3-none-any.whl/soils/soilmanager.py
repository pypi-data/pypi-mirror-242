...
len_layers = 10
a = 1.35  # TODO rename a to a more descriptive name
b = 1.4  # TODO rename b to a more descriptive name.


# create a variable profile constructor
def soilvar_perdep_cor(nlayers, soil_bottom=200, a=0.5, b=0.5):
    # has potential to cythonize
    depthn = np.arange(1, nlayers + 1, 1)
    if a < 0:
        print("Target parameter can not be negative")  # a * e^(-b * x).
        raise ValueError("Target parameter can not be negative")
    elif a > 0 and b != 0:
        ep = -b * depthn
        term1 = (a * depthn) * np.exp(ep)
        result = term1 / term1.max()
        return (result)  # did you mean to return (result) or return result.
    elif a == 0 and b != 0:
        ep = -b * depthn
        result = np.exp(ep) / np.exp(-b)
        return result
    elif a == 0 and b == 0:  # (a == 0, b == 0):
        # TODO this condition will always evaluate to True.
        # the statement evaluates to a tuple which has either
        # (False, False), (False, True), (True, False) or (True, True). All of these will evaluate to True.
        ans = [1] * len_layers
        return ans
...
class OrganizeAPSIMsoil_profile:
    ...
    # create a function that creates a variable profile of the provide variables
        ...
        return
      bottom depth and top depth in a turple
      TODO this method has a duplicate version up there. You do not need this one.
    ...
    def decreasing_exponential_function(self, x, amplitude, rate):
        # has potential to cythonize
        """
                                ...
                                if not counter:
                                    ...
                                    for counter, root in enumerate(
                                        ...
                                        if root['$type'] == 'Models.Soils.Soil, Models':
                                            if not counter:
                                                print("no soils found: ",
                                                      app_ap["Children"][coresimulationNode]["Name"])
                                            else:
                                                soilnode = counter
                                                # now we have a dictionary for soil node we need its children
                                                for counterr, roott in enumerate(
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"]):
                                                    if roott["$type"] == 'Models.Soils.Physical, Models':
                                                        if not counter:
                                                            ...
                                                            soilphysicalnode = \
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['Thickness'] = list(
                                                                np.full(shape=int(profile.Nlayers),
                                                                        fill_value=profile.thickness, dtype=np.float64))
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['ParticleSizeClay'] = list(
                                                                physical.ParticleSizeClay)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['ParticleSizeSand'] = list(
                                                                physical.ParticleSizeSand)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['ParticleSizeSilt'] = list(
                                                                physical.ParticleSizeSilt)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['BD'] = list(physical.BD)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['AirDry'] = list(physical.AirDry)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['LL15'] = list(physical.LL15)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['DUL'] = list(physical.DUL)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['SAT'] = list(physical.SAT)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['KS'] = list(physical.KS)
                                                            # write meta info
                                                            comment = "cockey = " + profile.cokey.values[1] + " " + \
                                                                      profile.muname.values[
                                                                          1] + " " + 'Component percentage: ' + \
                                                                      profile.componentpercent.values[1] + "%"
                                                            # timewritten = datetime.date.today()
                                                            ct = datetime.datetime.now()
                                                            formattime = "Date downloaded: {0}".format(ct)

                                                            url = "https://SDMDataAccess.nrcs.usda.gov/Tabular/SDMTabularService.asmx"
                                                            soiltype = profile.componentname.values[1] + ":" + \
                                                                       profile.chkey.values[1]
                                                            datasource = f'SSURGO {url} through PyAPSIMX function Replace_Soilprofile. {formattime}'
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]['Latitude'] = lonlat[1]
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]['Longitude'] = lonlat[
                                                                0]
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode][
                                                                'DataSource'] = datasource
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]['Comments'] = comment
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]['SoilType'] = soiltype
                                                            ...
                                                            if crop:
                                                                ...
                                                                dup = copy.deepcopy(
                                                                    app_ap["Children"][coresimulationNode]["Children"][
                                                                        fieldzone]["Children"][soilnode]["Children"][
                                                                        soilpysical]['Children'][0])
                                                                dup["Name"] = crop + "Soil"
                                                                print
                                                                # collect crop 1
                                                                cropnames = []
                                                                for i in range(len(
                                                                        app_ap["Children"][coresimulationNode][
                                                                            "Children"][fieldzone]["Children"][
                                                                            soilnode]["Children"][soilpysical][
                                                                            'Children'])):
                                                                    cropnames.append(
                                                                        app_ap["Children"][coresimulationNode][
                                                                            "Children"][fieldzone]["Children"][
                                                                ...
                                                                if cp not in cropnames:
                                                                    ...
                                                                    app_ap["Children"][coresimulationNode]["Children"][
                                                                        fieldzone]["Children"][soilnode]["Children"][
                                                                        soilpysical]['Children'].insert(3, dup)
                                                                # replace LL, KL, AND XF

                                                            for i in range(len(
                                                                    app_ap["Children"][coresimulationNode]["Children"][
                                                                        fieldzone]["Children"][soilnode]["Children"][
                                                                        soilpysical]['Children'])):
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilpysical]['Children'][i]['LL'] = list(
                                                                    organic.cropLL)
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilpysical]['Children'][i]['KL'] = list(
                                                                    organic.cropKL)
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilpysical]['Children'][i]['XF'] == list(
                                                                    np.full(shape=int(profile.Nlayers), fill_value=1,
                                                                            dtype=np.float64))
                                                            # REPLICATE THE NODE
                                                    for counterr, roott in enumerate(
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                        ...
                                                        if roott["$type"] == 'Models.WaterModel.WaterBalance, Models':
                                                            if not counter:
                                                                ...
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    waterbalance]['SummerDate']
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    waterbalance]['SummerU']
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    waterbalance]['SummerCona']
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    waterbalance]['WinterDate']
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    waterbalance]['SWCON']
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                ...
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    waterbalance]['CN2Bare']
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    waterbalance]['WinterU']
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    waterbalance]['WinterCona']
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    waterbalance]['DiffusConst']
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    waterbalance]['Salb']
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                    ...
                                                    for counterr, roott in enumerate(
                                                        ...
                                                        if roott["$type"] == 'Models.Soils.Organic, Models':
                                                            if not counter:
                                                                ...
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilorganic]['Thickness'] = list(
                                                                    np.full(shape=int(profile.Nlayers),
                                                                            fill_value=profile.thickness,
                                                                            dtype=np.float64))
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilorganic]['FOMCNRatio'] = 40
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilorganic]['Carbon'] = list(physical.Carbon)
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilorganic]['SoilCNRatio'] = list(
                                                                    organic.SoilCNRatio)
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilorganic]['FBiom'] = list(organic.FBiom)
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilorganic]['FOM'] = list(organic.FOM)
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilorganic]['FInert'] = list(organic.FInert)
                                                    for counterr, roott in enumerate(
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"]):
                                                        if roott["$type"] == 'Models.Soils.Chemical, Models':
                                                            if not counter:
                                                                ...
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilchemical]['Thickness'] = list(
                                                                    np.full(shape=int(profile.Nlayers),
                                                                            fill_value=profile.thickness,
                                                                            dtype=np.float64))
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilchemical]['PH'] = list(physical.PH)
                                                    for counter, root in enumerate(
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"]):
                                                    ...
                                                    for counter, root in enumerate(
                                                        ...
                                                        if root["$type"] == 'Models.Soils.Solute, Models':
                                                            if not counter:
                                                                ...
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilsolute]['Thickness'] = list(
                                                                    np.full(shape=int(profile.Nlayers),
                                                                            fill_value=profile.thickness,
                                                                            dtype=np.float64))
                                                                if app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilsolute]['Name'] == 'NH4':
                                                                    app_ap["Children"][coresimulationNode]["Children"][
                                                                        fieldzone]["Children"][soilnode]["Children"][
                                                                        soilsolute]['InitialValues'] = list(
                                                                        physical.Carbon)
                                                                if app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilsolute]['Name'] == 'NO3':
                                                    ...
                                                    for counterr, roott in enumerate(
                                                        ...
                                                        if roott["$type"] == 'Models.Soils.Water, Models':
                                                            if not counter:
                                                                ...
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilwater]['InitialValues'] = list(physical.DUL)
                                                                print("***Done----")
                                                                print("xxx")
                                                                apsix = json.dumps(app_ap)
                                                                filename = "edit_" + str(time.perf_counter())[
                                                                                     -5:] + "_" + apsimxfile
                                            ...
                                            for counterr, roott in enumerate(
                                                ...
                                                if roott["$type"] == 'Models.Soils.Physical, Models':
                                                    if not counter:
                                                        ...
                                                        soilphysicalnode = \
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"][soilpysical]
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"][soilpysical][
                                                            'Thickness'] = list(np.full(shape=int(profile.Nlayers),
                                                                                        fill_value=profile.thickness,
                                                                                        dtype=np.float64))
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"][soilpysical][
                                                            'ParticleSizeClay'] = list(physical.ParticleSizeClay)
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"][soilpysical][
                                                            'ParticleSizeSand'] = list(physical.ParticleSizeSand)
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"][soilpysical][
                                                            'ParticleSizeSilt'] = list(physical.ParticleSizeSilt)
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"][soilpysical]['BD'] = list(
                                                            physical.BD)
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"][soilpysical][
                                                            'AirDry'] = list(physical.AirDry)
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"][soilpysical][
                                                            'LL15'] = list(physical.LL15)
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"][soilpysical][
                                                        ...
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]["Children"][soilpysical]['KS'] = list(
                                                            physical.KS)
                                                        # write meta info
                                                        comment = "cockey = " + profile.cokey.values[1] + " " + \
                                                                  profile.muname.values[
                                                        ...
                                                        datasource = f'SSURGO {url} through PyAPSIMX function Replace_Soilprofile. {formattime}'
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]['Latitude'] = lonlat[1]
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]['Longitude'] = lonlat[0]
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]['DataSource'] = datasource
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]['Comments'] = comment
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]['SoilType'] = soiltype
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]['Site'] = gridcode
                                                        app_ap["Children"][coresimulationNode]["Children"][fieldzone][
                                                            "Children"][soilnode]['RecordNumber'] = Objectid
                                                        ...
                                                        for i in range(len(
                                                            ...
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['Children'][i]['LL'] = list(organic.cropLL)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['Children'][i]['KL'] = list(organic.cropKL)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilpysical]['Children'][i]['XF'] == list(
                                                                np.full(shape=int(profile.Nlayers), fill_value=1,
                                                ...
                                                for counterr, roott in enumerate(
                                                    ...
                                                    if roott["$type"] == 'Models.Soils.Organic, Models':
                                                        if not counter:
                                                            ...
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilorganic]['SoilCNRatio'] = list(organic.SoilCNRatio)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilorganic]['FBiom'] = list(organic.FBiom)
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                ...
                                                for counter, root in enumerate(
                                                    ...
                                                    if root["$type"] == 'Models.Soils.Water, Models':
                                                        if not counter:
                                                            ...
                                                            soilwater = counter
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][soilwater][
                                                                'Thickness'] = list(np.full(shape=int(profile.Nlayers),
                                                                                            fill_value=profile.thickness,
                                                                                            dtype=np.float64))
                                                for counter, root in enumerate(
                                                    ...
                                                    if root["$type"] == 'Models.Soils.Solute, Models':
                                                        if not counter:
                                                            ...
                                                            if app_ap["Children"][coresimulationNode]["Children"][
                                                                ...
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                                    fieldzone]["Children"][soilnode]["Children"][
                                                                    soilsolute]['InitialValues'] = list(physical.Carbon)
                                                            if app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][
                                                                soilsolute]['Name'] == 'NO3':
                                                                app_ap["Children"][coresimulationNode]["Children"][
                                                ...
                                                for counterr, roott in enumerate(
                                                    ...
                                                    if roott["$type"] == 'Models.Soils.Water, Models':
                                                        if not counter:
                                                            ...
                                                            app_ap["Children"][coresimulationNode]["Children"][
                                                                fieldzone]["Children"][soilnode]["Children"][soilwater][
                                                                'InitialValues'] = list(physical.DUL)

                                                            apsix = json.dumps(app_ap)
                                                            filenamee = "edit_" + str(filename) + "_" + \
                                                                        pathstring.split("\\")[-1]
