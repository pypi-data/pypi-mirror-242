...
class LayerNextClient:
    ...
    def auto_annotate_project(
        ...
        _automatic_analysis_client.model_annotate_collection(
            project_id, model_id, annotation_type, **kwargs)
    ...
    def generate_embeddings_for_collection(
        ...
        _automatic_analysis_client.embedding_model_inference_collection(
            collection_id, model_id, query, filters)
    ...
    def generate_embeddings_to_metalake(
        ...
        _automatic_analysis_client = automatic_analysis.AutomaticAnalysisClient(
            self.encoded_key_secret, self.layernext_url)
        _automatic_analysis_client.model_embedding_population(
            item_type, model_id, query, filters)
    ...
    def insert_image_embeddings_batch(self, embedding_list: List[Dict[str, List[float]]], model_name: str, vector_dimension: List[int]):
        ...
        return _datalake_client.insert_embeddings_batch(embedding_list, model_name, vector_dimension)
    ...
    def insert_image_embeddings(
            self, embedding_list: List[Dict[str, List[float]]], model_name: str, vector_dimension: int) -> dict:
