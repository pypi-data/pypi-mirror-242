...
from .constants import AnnotationUploadType, MediaType, JobStatus, ObjectType, AnnotationShapeType
...
class DatalakeClient:
    ...
    def insert_embeddings_batch(self, batch_data: List[dict], model_name: str, vector_dimension: str) -> dict:
