from layernext.automatic_analysis.automatic_analysis_interface import AutomaticAnalysisInterface
from .automatic_analysis import AutomaticAnalysis
from .support import make_tarfile_in_memory, validate_input_prompt, validate_input_annotation_type, validate_confidence, validate_task, validate_resolution_input
"""
...
class AutomaticAnalysisClient:
    ...
    def __init__(
        ...
        self.automatic_analysis = AutomaticAnalysis(encoded_key_secret, _automatic_analysis_url)
    ...
    def model_tag_collection(
        ...
        try:
            ...
            self.automatic_analysis.tagger_detail_send(
                application, collection_id, item_type, model_id, input_resolution, confidence_threshold,session_id,job_id,job_name)
        except ValueError as e:
            print(f"ValueError: {e}")
    ...
    def model_annotate_collection(
        ...
        try:
            ...
            self.automatic_analysis.annotater_detail_send(
                application,project_id,model_id, annotation_type, **kwargs)
        except ValueError as e:
            print(f"ValueError: {e}")
    
    def prompt_infer_image(
            self, 
            name, 
            shape, 
            **kwargs
        ...
        try:
            self.automatic_analysis_interface.prompt_detail_send(
                name, 
                shape, **kwargs)
        except ValueError as e:
            print(f"ValueError: {e}")
    ...
    def embedding_model_inference_collection(
        ...
        return self.automatic_analysis.embedding_detail_send(
            collection_id, model_id, application,item_type, query, filters, session_id,job_id,job_name)
