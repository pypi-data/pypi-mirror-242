...
class AutomaticAnalysis:
    ...
    def __init__(self, auth_token: str, automatic_analysis_url: str):
        ...
        self.automatic_analysis_interface = AutomaticAnalysisInterface(auth_token, automatic_analysis_url)

    """
    Making the payload and sending it to the given API endpoint in and handle responses in regarding to autotagging
    """

    def tagger_detail_send(self, application, collection_id, item_type, model_id, input_resolution,confidence_threshold,session_id,job_id,job_name):
        ...
        response = self.automatic_analysis_interface.main_analysis(payload,job_id,task)
        return response
    ...
    def annotater_detail_send(self,application,project_id,model_id, annotation_type, **kwargs):
        ...
        response = self.automatic_analysis_interface.main_analysis(payload,"",task)
        return response

    def embedding_detail_send(self, collection_id, model_id, application,item_type, query, filters, session_id, job_id, job_name):
