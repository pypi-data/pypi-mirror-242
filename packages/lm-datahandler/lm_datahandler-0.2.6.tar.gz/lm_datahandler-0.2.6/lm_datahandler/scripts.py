...
if __name__ == '__main__':
    ...
    local_datas_full_analyse(r'E:\dataset\X7-PSG\JZ_data\label_and_prediction\final_data',
                             ["20230520_WZY"],
                             r'E:\dataset\X7-PSG\JZ_data\label_and_prediction\final_data', analyse_param=analyse_param)
