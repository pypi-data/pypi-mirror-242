...
# run tests
test:
	pytest --cov-report xml --cov-report html --cov=bioio_tiff_glob bioio_tiff_glob/tests
...
generate-docs:
	rm -f docs/bioio_tiff_glob*.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs bioio_tiff_glob **/tests
