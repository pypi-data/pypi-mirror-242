...
Ready to contribute? Here's how to set up `bioio-tiff-glob` for local development.

1. Fork the `bioio-tiff-glob` repo on GitHub.

2. Clone your fork locally:

    ```bash
    git clone git@github.com:{your_name_here}/bioio-tiff-glob.git
    ```
