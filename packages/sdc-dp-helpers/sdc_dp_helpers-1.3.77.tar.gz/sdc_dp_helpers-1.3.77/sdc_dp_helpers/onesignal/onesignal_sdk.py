...
class CreateBulkDownload(APICallHandler):
    ...
    @retry_handler(HTTP500InternalServerError, total_tries=3, initial_wait=61, backoff_factor=1.2)
...
class FetchBulkDownload(APICallHandler):
    ...
    @retry_handler(NoDownloadYetError, total_tries=10, initial_wait=2, backoff_factor=1.8)
