...
class PublicationMetadata(BaseModel):
    ...
    year = models.PositiveIntegerField(null=False, help_text="Publication year.")
    ...
    def get_bibtex_authors(self):
        ...
        return parsed_bibtex["author"] if parsed_bibtex and "author" in parsed_bibtex else None
