...
class PeerDialogs(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.messages.PeerDialogs`.
    ...
    Parameters:
        dialogs (List of :obj:`Dialog <nan_dev.raw.base.Dialog>`):
            N/A

        messages (List of :obj:`Message <nan_dev.raw.base.Message>`):
            N/A
