...
class SentCode(Object):
    ...
    Parameters:
        type (:obj:`~nan_dev.enums.SentCodeType`):
            Type of the current sent code.

        phone_code_hash (``str``):
            Confirmation code identifier useful for the next authorization steps (either
            :meth:`~nan_dev.Client.sign_in` or :meth:`~nan_dev.Client.sign_up`).

        next_type (:obj:`~nan_dev.enums.NextCodeType`, *optional*):
            Type of the next code to be sent with :meth:`~nan_dev.Client.resend_code`.

        timeout (``int``, *optional*):
            Delay in seconds before calling :meth:`~nan_dev.Client.resend_code`.
    """
