...
class Object:
    def __init__(self, client: "nan_dev.Client" = None):
        self._client = client

    def bind(self, client: "nan_dev.Client"):
        """Bind a Client instance to this and to all nested Pyrogram objects.

        Parameters:
            client (:obj:`~nan_dev.types.Client`):
