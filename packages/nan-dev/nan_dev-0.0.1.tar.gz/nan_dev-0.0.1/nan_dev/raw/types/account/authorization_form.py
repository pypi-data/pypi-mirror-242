...
class AuthorizationForm(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.account.AuthorizationForm`.
    ...
    Parameters:
        required_types (List of :obj:`SecureRequiredType <nan_dev.raw.base.SecureRequiredType>`):
            N/A

        values (List of :obj:`SecureValue <nan_dev.raw.base.SecureValue>`):
            N/A

        errors (List of :obj:`SecureValueError <nan_dev.raw.base.SecureValueError>`):
            N/A
