...
class MessageReactions(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.MessageReactions`.
    ...
    Parameters:
        results (List of :obj:`ReactionCount <nan_dev.raw.base.ReactionCount>`):
            N/A
        ...
        recent_reactions (List of :obj:`MessagePeerReaction <nan_dev.raw.base.MessagePeerReaction>`, *optional*):
            N/A
