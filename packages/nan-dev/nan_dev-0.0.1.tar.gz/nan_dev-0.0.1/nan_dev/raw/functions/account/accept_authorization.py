...
class AcceptAuthorization(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        value_hashes (List of :obj:`SecureValueHash <nan_dev.raw.base.SecureValueHash>`):
            N/A

        credentials (:obj:`SecureCredentialsEncrypted <nan_dev.raw.base.SecureCredentialsEncrypted>`):
            N/A
