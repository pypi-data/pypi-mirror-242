...
class Search(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`MessagesFilter <nan_dev.raw.base.MessagesFilter>`):
            N/A
        ...
        from_id (:obj:`InputPeer <nan_dev.raw.base.InputPeer>`, *optional*):
            N/A
    ...
    Returns:
        :obj:`messages.Messages <nan_dev.raw.base.messages.Messages>`
    """
