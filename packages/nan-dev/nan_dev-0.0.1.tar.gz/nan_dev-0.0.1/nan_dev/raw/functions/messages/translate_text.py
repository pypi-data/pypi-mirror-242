...
class TranslateText(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        peer (:obj:`InputPeer <nan_dev.raw.base.InputPeer>`, *optional*):
            N/A

        id (List of ``int`` ``32-bit``, *optional*):
            N/A

        text (List of :obj:`TextWithEntities <nan_dev.raw.base.TextWithEntities>`, *optional*):
            N/A

    Returns:
        :obj:`messages.TranslatedText <nan_dev.raw.base.messages.TranslatedText>`
    """
