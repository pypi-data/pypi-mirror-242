...
class GetBotCommands:
    async def get_bot_commands(
        ...
        Parameters:
            scope (:obj:`~nan_dev.types.BotCommandScope`, *optional*):
                An object describing the scope of users for which the commands are relevant.
                Defaults to :obj:`~nan_dev.types.BotCommandScopeDefault`.
        ...
        Returns:
            List of :obj:`~nan_dev.types.BotCommand`: On success, the list of bot commands is returned.
