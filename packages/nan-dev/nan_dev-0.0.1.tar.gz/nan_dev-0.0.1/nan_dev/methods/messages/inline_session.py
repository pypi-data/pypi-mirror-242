...
from nan_dev.errors import AuthBytesInvalid
from nan_dev.session import Session
from nan_dev.session.auth import Auth


async def get_session(client: "nan_dev.Client", dc_id: int):
