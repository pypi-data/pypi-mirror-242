...
class GetUsers:
    async def get_users(
        self: "nan_dev.Client", user_ids: Union[int, str, Iterable[Union[int, str]]]
        ...
        Returns:
            :obj:`~nan_dev.types.User` | List of :obj:`~nan_dev.types.User`: In case *user_ids* was not a list,
