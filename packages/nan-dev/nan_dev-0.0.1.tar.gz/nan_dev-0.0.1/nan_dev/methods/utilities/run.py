...
import nan_dev
from nan_dev.methods.utilities.idle import idle


class Run:
    def run(self: "nan_dev.Client", coroutine=None):
        """Start the client, idle the main script and finally stop the client.

        When calling this method without any argument it acts as a convenience method that calls
        :meth:`~nan_dev.Client.start`, :meth:`~nan_dev.idle` and :meth:`~nan_dev.Client.stop` in sequence.
        ...
        If you want to run multiple clients at once, see :meth:`nan_dev.compose`.
