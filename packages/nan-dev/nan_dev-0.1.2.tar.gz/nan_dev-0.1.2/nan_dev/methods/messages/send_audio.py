...
import nan_dev
from nan_dev import StopTransmission, enums, raw, types, utils
from nan_dev.errors import FilePartMissing
from nan_dev.file_id import FileType
...
class SendAudio:
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~nan_dev.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~nan_dev.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~nan_dev.Client.stop_transmission`, None is returned.
