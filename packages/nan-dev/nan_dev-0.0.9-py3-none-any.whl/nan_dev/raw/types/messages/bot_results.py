...
class BotResults(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.messages.BotResults`.
    ...
    Parameters:
        ...
        results (List of :obj:`BotInlineResult <nan_dev.raw.base.BotInlineResult>`):
            N/A
        ...
        switch_pm (:obj:`InlineBotSwitchPM <nan_dev.raw.base.InlineBotSwitchPM>`, *optional*):
            N/A

        switch_webview (:obj:`InlineBotWebView <nan_dev.raw.base.InlineBotWebView>`, *optional*):
            N/A
