...
import nan_dev
from nan_dev import raw, types, utils
...
class SendMediaGroup:
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~nan_dev.types.InputMediaPhoto`, :obj:`~nan_dev.types.InputMediaVideo`, :obj:`~nan_dev.types.InputMediaAudio` and :obj:`~nan_dev.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~nan_dev.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from nan_dev.types import InputMediaPhoto, InputMediaVideo
