...
from nan_dev.errors import PeerIdInvalid
...
class ResolvePeer:
    async def resolve_peer(
        self: "nan_dev.Client", peer_id: Union[int, str]
        ...
        .. note::
            ...
            :obj:`functions <nan_dev.api.functions>` (i.e: a Telegram API method you wish to use which is not
