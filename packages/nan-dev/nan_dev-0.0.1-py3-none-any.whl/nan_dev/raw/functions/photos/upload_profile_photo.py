...
class UploadProfilePhoto(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        bot (:obj:`InputUser <nan_dev.raw.base.InputUser>`, *optional*):
            N/A

        file (:obj:`InputFile <nan_dev.raw.base.InputFile>`, *optional*):
            N/A

        video (:obj:`InputFile <nan_dev.raw.base.InputFile>`, *optional*):
            N/A

        video_start_ts (``float`` ``64-bit``, *optional*):
            N/A

        video_emoji_markup (:obj:`VideoSize <nan_dev.raw.base.VideoSize>`, *optional*):
            N/A

    Returns:
        :obj:`photos.Photo <nan_dev.raw.base.photos.Photo>`
    """
