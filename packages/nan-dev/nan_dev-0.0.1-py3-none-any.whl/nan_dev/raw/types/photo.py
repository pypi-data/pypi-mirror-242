...
class Photo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.Photo`.
    ...
    Parameters:
        ...
        sizes (List of :obj:`PhotoSize <nan_dev.raw.base.PhotoSize>`):
            N/A
        ...
        video_sizes (List of :obj:`VideoSize <nan_dev.raw.base.VideoSize>`, *optional*):
            N/A
