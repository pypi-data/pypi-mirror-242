...
class DifferenceSlice(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.updates.Difference`.
    ...
    Parameters:
        new_messages (List of :obj:`Message <nan_dev.raw.base.Message>`):
            N/A

        new_encrypted_messages (List of :obj:`EncryptedMessage <nan_dev.raw.base.EncryptedMessage>`):
            N/A

        other_updates (List of :obj:`Update <nan_dev.raw.base.Update>`):
            N/A
        ...
        intermediate_state (:obj:`updates.State <nan_dev.raw.base.updates.State>`):
            N/A
