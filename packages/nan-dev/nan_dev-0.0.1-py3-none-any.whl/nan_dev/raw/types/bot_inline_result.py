...
class BotInlineResult(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.BotInlineResult`.
    ...
    Parameters:
        ...
        send_message (:obj:`BotInlineMessage <nan_dev.raw.base.BotInlineMessage>`):
            N/A
        ...
        thumb (:obj:`WebDocument <nan_dev.raw.base.WebDocument>`, *optional*):
            N/A

        content (:obj:`WebDocument <nan_dev.raw.base.WebDocument>`, *optional*):
            N/A
