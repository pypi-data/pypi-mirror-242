...
class InputMediaUploadedDocument(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.InputMedia`.
    ...
    Parameters:
        file (:obj:`InputFile <nan_dev.raw.base.InputFile>`):
            N/A

        mime_type (``str``):
            N/A

        attributes (List of :obj:`DocumentAttribute <nan_dev.raw.base.DocumentAttribute>`):
            N/A
        ...
        thumb (:obj:`InputFile <nan_dev.raw.base.InputFile>`, *optional*):
            N/A

        stickers (List of :obj:`InputDocument <nan_dev.raw.base.InputDocument>`, *optional*):
            N/A
