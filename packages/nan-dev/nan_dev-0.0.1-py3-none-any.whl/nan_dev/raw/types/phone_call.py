...
class PhoneCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.PhoneCall`.
    ...
    Parameters:
        ...
        protocol (:obj:`PhoneCallProtocol <nan_dev.raw.base.PhoneCallProtocol>`):
            N/A

        connections (List of :obj:`PhoneConnection <nan_dev.raw.base.PhoneConnection>`):
            N/A
