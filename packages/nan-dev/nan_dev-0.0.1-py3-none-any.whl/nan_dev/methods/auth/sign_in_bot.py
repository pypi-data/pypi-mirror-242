...
from nan_dev.errors import UserMigrate
...
class SignInBot:
    async def sign_in_bot(self: "nan_dev.Client", bot_token: str) -> "types.User":
        ...
        Returns:
            :obj:`~nan_dev.types.User`: On success, the bot identity is return in form of a user object.
