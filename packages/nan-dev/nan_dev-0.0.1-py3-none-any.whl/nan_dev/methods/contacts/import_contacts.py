...
class ImportContacts:
    async def import_contacts(
        self: "nan_dev.Client", contacts: List["types.InputPhoneContact"]
    ):
        ...
        Parameters:
            contacts (List of :obj:`~nan_dev.types.InputPhoneContact`):
        ...
        Example:
            .. code-block:: python
                ...
                from nan_dev.types import InputPhoneContact
