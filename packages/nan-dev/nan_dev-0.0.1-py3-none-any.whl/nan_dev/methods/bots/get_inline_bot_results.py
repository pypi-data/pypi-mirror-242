...
from nan_dev.errors import UnknownError
...
class GetInlineBotResults:
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~nan_dev.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <nan_dev.api.types.messages.BotResults>`: On Success.
        ...
        Example:
            .. code-block:: python
                ...
                results = await app.get_inline_bot_results("nan_devbot")
                print(results)
        """
