...
class ChatlistInviteAlready(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.chatlists.ChatlistInvite`.
    ...
    Parameters:
        ...
        missing_peers (List of :obj:`Peer <nan_dev.raw.base.Peer>`):
            N/A

        already_peers (List of :obj:`Peer <nan_dev.raw.base.Peer>`):
            N/A
