...
import nan_dev
from nan_dev import __license__, __version__, enums, raw, utils
from nan_dev.crypto import aes
from nan_dev.errors import (BadRequest, CDNFileHashMismatch, ChannelPrivate,
                            SessionPasswordNeeded, VolumeLocNotFound)
from nan_dev.handlers.handler import Handler
from nan_dev.methods import Methods
from nan_dev.session import Auth, Session
from nan_dev.storage import FileStorage, MemoryStorage
from nan_dev.types import TermsOfService, User
from nan_dev.utils import ainput
...
class Client(Methods):
    ...
    Parameters:
        ...
        in_memory (``bool``, *optional*):
            ...
            :meth:`~nan_dev.Client.export_session_string` before stopping the client to get a session string you can
    ...
    APP_VERSION = f"Nan-Dev {__version__}"
    DEVICE_MODEL = "Nan-Dev"
    ...
    def set_parse_mode(self, parse_mode: Optional["enums.ParseMode"]):
        ...
        Parameters:
            parse_mode (:obj:`~nan_dev.enums.ParseMode`):
        ...
        if session_empty:
            if not self.api_id or not self.api_hash:
                raise AttributeError(
                    ...
                    "More info: https://docs.nan_dev.org/start/auth"
                )
    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            except nan_dev.StopTransmission:
                raise
            except Exception as e:
                log.exception(e)
            finally:
