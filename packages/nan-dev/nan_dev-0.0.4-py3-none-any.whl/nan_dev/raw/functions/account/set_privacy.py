...
class SetPrivacy(TLObject):  # type: ignore
    ...
    Parameters:
        key (:obj:`InputPrivacyKey <nan_dev.raw.base.InputPrivacyKey>`):
            N/A

        rules (List of :obj:`InputPrivacyRule <nan_dev.raw.base.InputPrivacyRule>`):
            N/A

    Returns:
        :obj:`account.PrivacyRules <nan_dev.raw.base.account.PrivacyRules>`
    """
