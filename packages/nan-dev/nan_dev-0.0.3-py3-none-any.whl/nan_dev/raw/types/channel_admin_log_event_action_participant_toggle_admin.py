...
class ChannelAdminLogEventActionParticipantToggleAdmin(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.ChannelAdminLogEventAction`.
    ...
    Parameters:
        prev_participant (:obj:`ChannelParticipant <nan_dev.raw.base.ChannelParticipant>`):
            N/A

        new_participant (:obj:`ChannelParticipant <nan_dev.raw.base.ChannelParticipant>`):
            N/A
