...
class AttachMenuBot(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.AttachMenuBot`.
    ...
    Parameters:
        ...
        peer_types (List of :obj:`AttachMenuPeerType <nan_dev.raw.base.AttachMenuPeerType>`):
            N/A

        icons (List of :obj:`AttachMenuBotIcon <nan_dev.raw.base.AttachMenuBotIcon>`):
            N/A
