...
class InitConnection(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        query (Any function from :obj:`~nan_dev.raw.functions`):
            N/A

        proxy (:obj:`InputClientProxy <nan_dev.raw.base.InputClientProxy>`, *optional*):
            N/A

        params (:obj:`JSONValue <nan_dev.raw.base.JSONValue>`, *optional*):
            N/A

    Returns:
        Any object from :obj:`~nan_dev.raw.types`
    """
