...
class Chat(Object):
    ...
    Parameters:
        ...
        type (:obj:`~nan_dev.enums.ChatType`):
            Type of chat.
        ...
        photo (:obj:`~nan_dev.types.ChatPhoto`, *optional*):
            Chat photo. Suitable for downloads only.

        bio (``str``, *optional*):
            Bio of the other party in a private chat.
            Returned only in :meth:`~nan_dev.Client.get_chat`.
        ...
        restrictions (List of :obj:`~nan_dev.types.Restriction`, *optional*):
            The list of reasons why this chat might be unavailable to some users.
            This field is available only in case *is_restricted* is True.

        permissions (:obj:`~nan_dev.types.ChatPermissions` *optional*):
            Default chat member permissions, for groups and supergroups.

        distance (``int``, *optional*):
            Distance in meters of this group chat from your location.
            Returned only in :meth:`~nan_dev.Client.get_nearby_chats`.

        linked_chat (:obj:`~nan_dev.types.Chat`, *optional*):
            The linked discussion group (in case of channels) or the linked channel (in case of supergroups).
            Returned only in :meth:`~nan_dev.Client.get_chat`.

        send_as_chat (:obj:`~nan_dev.types.Chat`, *optional*):
            The default "send_as" chat.
            Returned only in :meth:`~nan_dev.Client.get_chat`.

        available_reactions (:obj:`~nan_dev.types.ChatReactions`, *optional*):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~nan_dev.types.Chat`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~nan_dev.types.Chat`.
    ...
    async def set_title(self, title: str) -> bool:
        """Bound method *set_title* of :obj:`~nan_dev.types.Chat`.
    ...
    async def set_description(self, description: str) -> bool:
        """Bound method *set_description* of :obj:`~nan_dev.types.Chat`.
    ...
    async def set_photo(
        ...
        *,
        ...
        """Bound method *set_photo* of :obj:`~nan_dev.types.Chat`.
        ...
        Parameters:
            photo (``str`` | ``BinaryIO``, *optional*):
                New chat photo. You can pass a :obj:`~nan_dev.types.Photo` file_id, a file path to upload a new photo
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.

            video (``str`` | ``BinaryIO``, *optional*):
                New chat video. You can pass a :obj:`~nan_dev.types.Video` file_id, a file path to upload a new video
                from your local machine or a binary file-like object with its attribute
                ".name" set for in-memory uploads.
    ...
    async def ban_member(
        ...
        """Bound method *ban_member* of :obj:`~nan_dev.types.Chat`.
        ...
        Returns:
            :obj:`~nan_dev.types.Message` | ``bool``: On success, a service message will be returned (when applicable), otherwise, in
    ...
    async def unban_member(self, user_id: Union[int, str]) -> bool:
        """Bound method *unban_member* of :obj:`~nan_dev.types.Chat`.
    ...
    async def restrict_member(
        ...
        Parameters:
            ...
            permissions (:obj:`~nan_dev.types.ChatPermissions`):
        ...
        Returns:
            :obj:`~nan_dev.types.Chat`: On success, a chat object is returned.
    ...
    async def promote_member(
        ...
        """Bound method *promote_member* of :obj:`~nan_dev.types.Chat`.
        ...
        Parameters:
            ...
            privileges (:obj:`~nan_dev.types.ChatPrivileges`, *optional*):
                New user privileges.
    ...
    async def join(self):
        """Bound method *join* of :obj:`~nan_dev.types.Chat`.
    ...
    async def leave(self):
        """Bound method *leave* of :obj:`~nan_dev.types.Chat`.
    ...
    async def export_invite_link(self):
        """Bound method *export_invite_link* of :obj:`~nan_dev.types.Chat`.
    ...
    async def get_member(
        ...
        """Bound method *get_member* of :obj:`~nan_dev.types.Chat`.
        ...
        Returns:
            :obj:`~nan_dev.types.ChatMember`: On success, a chat member is returned.
        """
    ...
    def get_members(
        ...
        """Bound method *get_members* of :obj:`~nan_dev.types.Chat`.
        ...
        Parameters:
            query (``str``, *optional*):
                ...
                A query string is applicable only for :obj:`~nan_dev.enums.ChatMembersFilter.SEARCH`,
                :obj:`~nan_dev.enums.ChatMembersFilter.BANNED` and :obj:`~nan_dev.enums.ChatMembersFilter.RESTRICTED`
                filters only.

            limit (``int``, *optional*):
                Limits the number of members to be retrieved.

            filter (:obj:`~nan_dev.enums.ChatMembersFilter`, *optional*):
                Filter used to select the kind of members you want to retrieve. Only applicable for supergroups
                and channels.

        Returns:
            ``Generator``: On success, a generator yielding :obj:`~nan_dev.types.ChatMember` objects is returned.
        """
    ...
    async def add_members(
        ...
        """Bound method *add_members* of :obj:`~nan_dev.types.Chat`.
    ...
    async def mark_unread(
        ...
        """Bound method *mark_unread* of :obj:`~nan_dev.types.Chat`.
    ...
    async def set_protected_content(self, enabled: bool) -> bool:
        """Bound method *set_protected_content* of :obj:`~nan_dev.types.Chat`.
    ...
    async def unpin_all_messages(self) -> bool:
        """Bound method *unpin_all_messages* of :obj:`~nan_dev.types.Chat`.
