...
from nan_dev.crypto import aes, prime, rsa
from nan_dev.errors import SecurityCheckMismatch
from nan_dev.raw.core import Int, Long, TLObject
...
class Auth:
    ...
    def __init__(self, client: "nan_dev.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
