...
class GetChat:
    async def get_chat(
        self: "nan_dev.Client", chat_id: Union[int, str]
        ...
        Returns:
            :obj:`~nan_dev.types.Chat` | :obj:`~nan_dev.types.ChatPreview`: On success, if you've already joined the chat, a chat object is returned,
        ...
        Example:
            .. code-block:: python
                ...
                chat = await app.get_chat("nan_dev")
                print(chat)
        """
