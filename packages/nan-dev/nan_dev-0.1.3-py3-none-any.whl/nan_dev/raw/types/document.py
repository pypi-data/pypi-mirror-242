...
class Document(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.Document`.
    ...
    Parameters:
        ...
        thumbs (List of :obj:`PhotoSize <nan_dev.raw.base.PhotoSize>`, *optional*):
            N/A

        video_thumbs (List of :obj:`VideoSize <nan_dev.raw.base.VideoSize>`, *optional*):
            N/A
