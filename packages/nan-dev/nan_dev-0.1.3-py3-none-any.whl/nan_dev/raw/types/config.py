...
class Config(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.Config`.
    ...
    Parameters:
        ...
        dc_options (List of :obj:`DcOption <nan_dev.raw.base.DcOption>`):
            N/A
        ...
        reactions_default (:obj:`Reaction <nan_dev.raw.base.Reaction>`, *optional*):
            N/A
