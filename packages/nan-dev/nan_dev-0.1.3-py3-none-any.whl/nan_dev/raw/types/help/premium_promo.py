...
class PremiumPromo(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.help.PremiumPromo`.
    ...
    Parameters:
        ...
        status_entities (List of :obj:`MessageEntity <nan_dev.raw.base.MessageEntity>`):
            N/A

        video_sections (List of ``str``):
            N/A

        videos (List of :obj:`Document <nan_dev.raw.base.Document>`):
            N/A

        period_options (List of :obj:`PremiumSubscriptionOption <nan_dev.raw.base.PremiumSubscriptionOption>`):
            N/A
