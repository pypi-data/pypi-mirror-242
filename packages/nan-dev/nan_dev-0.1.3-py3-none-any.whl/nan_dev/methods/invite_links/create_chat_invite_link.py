...
class CreateChatInviteLink:
    async def create_chat_invite_link(
        ...
        The link can be revoked using the method :meth:`~nan_dev.Client.revoke_chat_invite_link`.
        ...
        Returns:
            :obj:`~nan_dev.types.ChatInviteLink`: On success, the new invite link is returned.
