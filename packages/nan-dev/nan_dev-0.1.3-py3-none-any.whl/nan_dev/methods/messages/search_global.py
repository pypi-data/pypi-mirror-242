...
class SearchGlobal:
    async def search_global(
        ...
        If you want to get the messages count only, see :meth:`~nan_dev.Client.search_global_count`.
        ...
        Parameters:
            ...
            filter (:obj:`~nan_dev.enums.MessagesFilter`, *optional*):
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~nan_dev.types.Message` objects.
        ...
        Example:
            .. code-block:: python
                ...
                # Search for "nan_dev". Get the first 50 results
                async for message in app.search_global("nan_dev", limit=50):
                    print(message.text)
