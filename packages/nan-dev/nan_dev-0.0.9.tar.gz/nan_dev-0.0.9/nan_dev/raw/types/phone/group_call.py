...
class GroupCall(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.phone.GroupCall`.
    ...
    Parameters:
        call (:obj:`GroupCall <nan_dev.raw.base.GroupCall>`):
            N/A

        participants (List of :obj:`GroupCallParticipant <nan_dev.raw.base.GroupCallParticipant>`):
            N/A
