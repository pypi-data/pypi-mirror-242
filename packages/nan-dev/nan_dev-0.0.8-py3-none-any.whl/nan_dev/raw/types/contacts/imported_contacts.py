...
class ImportedContacts(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.contacts.ImportedContacts`.
    ...
    Parameters:
        imported (List of :obj:`ImportedContact <nan_dev.raw.base.ImportedContact>`):
            N/A

        popular_invites (List of :obj:`PopularContact <nan_dev.raw.base.PopularContact>`):
            N/A
