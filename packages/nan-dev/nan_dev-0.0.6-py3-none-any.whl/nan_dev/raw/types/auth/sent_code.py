...
class SentCode(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.auth.SentCode`.
    ...
    Parameters:
        type (:obj:`auth.SentCodeType <nan_dev.raw.base.auth.SentCodeType>`):
            N/A

        phone_code_hash (``str``):
            N/A

        next_type (:obj:`auth.CodeType <nan_dev.raw.base.auth.CodeType>`, *optional*):
            N/A
