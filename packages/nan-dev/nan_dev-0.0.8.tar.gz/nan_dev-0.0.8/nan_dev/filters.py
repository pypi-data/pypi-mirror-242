...
from nan_dev.types import (CallbackQuery, InlineKeyboardMarkup, InlineQuery,
                           Message, ReplyKeyboardMarkup, Update)


class Filter:
    async def __call__(self, client: "nan_dev.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``Callable``):
            ...
            The *client* argument refers to the :obj:`~nan_dev.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from.
            For example, in a :obj:`~nan_dev.handlers.MessageHandler` the *update* argument will be a :obj:`~nan_dev.types.Message`; in a :obj:`~nan_dev.handlers.CallbackQueryHandler` the *update* will be a :obj:`~nan_dev.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~nan_dev.filters.command` or :meth:`~nan_dev.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~nan_dev.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Document` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Game` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Video` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Location` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~nan_dev.types.Dice` objects."""
...
def command(
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~nan_dev.types.Message`.
    ...
    async def func(flt, client: nan_dev.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~nan_dev.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~nan_dev.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~nan_dev.types.InlineQuery`: The filter will match ``query``.
