...
class PageBlockRelatedArticles(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.PageBlock`.
    ...
    Parameters:
        title (:obj:`RichText <nan_dev.raw.base.RichText>`):
            N/A

        articles (List of :obj:`PageRelatedArticle <nan_dev.raw.base.PageRelatedArticle>`):
            N/A
