...
class GetParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        filter (:obj:`ChannelParticipantsFilter <nan_dev.raw.base.ChannelParticipantsFilter>`):
            N/A
    ...
    Returns:
        :obj:`channels.ChannelParticipants <nan_dev.raw.base.channels.ChannelParticipants>`
    """
