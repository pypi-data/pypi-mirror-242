...
class DialogFilter(TLObject):  # type: ignore
    ...
    Constructor of :obj:`~nan_dev.raw.base.DialogFilter`.
    ...
    Parameters:
        ...
        pinned_peers (List of :obj:`InputPeer <nan_dev.raw.base.InputPeer>`):
            N/A

        include_peers (List of :obj:`InputPeer <nan_dev.raw.base.InputPeer>`):
            N/A

        exclude_peers (List of :obj:`InputPeer <nan_dev.raw.base.InputPeer>`):
            N/A
