...
class GetAdminLog(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        events_filter (:obj:`ChannelAdminLogEventsFilter <nan_dev.raw.base.ChannelAdminLogEventsFilter>`, *optional*):
            N/A

        admins (List of :obj:`InputUser <nan_dev.raw.base.InputUser>`, *optional*):
            N/A

    Returns:
        :obj:`channels.AdminLogResults <nan_dev.raw.base.channels.AdminLogResults>`
    """
