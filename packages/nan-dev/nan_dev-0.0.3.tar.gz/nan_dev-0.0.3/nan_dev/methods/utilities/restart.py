...
class Restart:
    async def restart(self: "nan_dev.Client", block: bool = True):
        """Restart the Client.

        This method will first call :meth:`~nan_dev.Client.stop` and then :meth:`~nan_dev.Client.start` in a row in
        ...
        Returns:
            :obj:`~nan_dev.Client`: The restarted client itself.
