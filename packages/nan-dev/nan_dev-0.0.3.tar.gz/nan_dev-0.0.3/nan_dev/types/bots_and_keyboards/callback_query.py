...
import nan_dev
from nan_dev import enums, raw, types
...
class CallbackQuery(Object, Update):
    ...
    *inline_message_id* will be present. Exactly one of the fields *data* or *game_short_name* will be present.
    ...
    Parameters:
        ...
        from_user (:obj:`~nan_dev.types.User`):
            Sender.
        ...
        message (:obj:`~nan_dev.types.Message`, *optional*):
        ...
        matches (List of regex Matches, *optional*):
            ...
            the data of this callback query. Only applicable when using :obj:`Filters.regex <nan_dev.Filters.regex>`.
    """
    ...
    @staticmethod
    async def _parse(
        client: "nan_dev.Client", callback_query, users
    ) -> "CallbackQuery":
        message = None
    ...
    async def answer(
        ...
        """Bound method *answer* of :obj:`~nan_dev.types.CallbackQuery`.
    ...
    async def edit_message_text(
        ...
        Bound method *edit_message_text* of :obj:`~nan_dev.types.CallbackQuery`.
        ...
        Returns:
            :obj:`~nan_dev.types.Message` | ``bool``: On success, if the edited message was sent by the bot, the edited
    ...
    async def edit_message_caption(
        ...
        Bound method *edit_message_caption* of :obj:`~nan_dev.types.CallbackQuery`.
    ...
    async def edit_message_media(
        ...
        Bound method *edit_message_media* of :obj:`~nan_dev.types.CallbackQuery`.
    ...
    async def edit_message_reply_markup(
        ...
        Bound method *edit_message_reply_markup* of :obj:`~nan_dev.types.CallbackQuery`.
