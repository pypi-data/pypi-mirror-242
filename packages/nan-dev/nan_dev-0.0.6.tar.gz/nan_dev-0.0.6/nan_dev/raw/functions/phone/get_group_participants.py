...
class GetGroupParticipants(TLObject):  # type: ignore
    ...
    Parameters:
        call (:obj:`InputGroupCall <nan_dev.raw.base.InputGroupCall>`):
            N/A

        ids (List of :obj:`InputPeer <nan_dev.raw.base.InputPeer>`):
            N/A
    ...
    Returns:
        :obj:`phone.GroupParticipants <nan_dev.raw.base.phone.GroupParticipants>`
    """
