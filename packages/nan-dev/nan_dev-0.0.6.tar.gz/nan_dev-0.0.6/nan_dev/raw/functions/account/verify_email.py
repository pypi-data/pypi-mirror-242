...
class VerifyEmail(TLObject):  # type: ignore
    ...
    Parameters:
        purpose (:obj:`EmailVerifyPurpose <nan_dev.raw.base.EmailVerifyPurpose>`):
            N/A

        verification (:obj:`EmailVerification <nan_dev.raw.base.EmailVerification>`):
            N/A

    Returns:
        :obj:`account.EmailVerified <nan_dev.raw.base.account.EmailVerified>`
    """
