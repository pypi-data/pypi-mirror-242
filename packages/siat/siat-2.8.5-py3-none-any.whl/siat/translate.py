...
def codetranslate0(code):
    ...
    codedict=pd.DataFrame([
        ...
        # 瑞典知名上市公司
        ['ATCO-A.ST','阿特拉斯-科普柯'],['VOLCAR-B.ST','沃尔沃轿车'],['VOLV-A.ST','沃尔沃集团'],
        ['HEXA-B.ST','海克斯康科技'],['SPOT.US','Spotify科技'],
        ['SAND.ST','山特维克机械'],['EQT.UK','EQT投资集团'],['SEB-A.ST','瑞典北欧斯安银行'],
        ...
        # 希腊知名上市公司
        ['OPAP.AT','希腊足球博彩公司'],['EUROB.AT','希腊欧洲银行'],['ETE.AT','希腊国家银行'],
        ['TENERGY.AT','希腊泰纳能源'],['CCH.UK','希腊可口可乐灌装公司'],
