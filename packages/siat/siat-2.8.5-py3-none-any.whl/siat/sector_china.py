...
def industry_stock_sw(industry='801270.SW',top=5,printout=False):
    ...
    try:
        ...
        print("  #Warning(industry_stock_sw): internal failure in fetching component stocks for shenwan industry index",industry)
        print("  Possible solution: upgrade akshare and then try again (no guarantee to resolve)")
        return None,None
...
def find_peers_china(industry='',top=5,rank=20,sw_level='2'):
    ...
    if industry != '':
        ...
        if industry.isdigit():
            ...
            if iname is None:
                print("  #Error(find_peers_china): Shenwan industry code not found for",industry)
                return None
            ...
            if icode is None:
                print("  #Error(find_peers_china): Shenwan industry name not found for",industry)
                return None
            else:
        ...
        if not (swlist is None):
            ...
            print("  #Warning(find_peers_china):  internal failure in fetching component stocks for shenwan industry",industry)
            return []
