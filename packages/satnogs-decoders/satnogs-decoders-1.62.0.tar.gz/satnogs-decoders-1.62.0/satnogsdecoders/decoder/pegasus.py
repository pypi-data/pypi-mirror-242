...
class Pegasus(KaitaiStruct):
    ...
    :field script_slot_padding: tt64_frame.beacon.script_slot_padding
    ...
    class HkdDownload(KaitaiStruct):
        ...
        def vcc_cc2(self):
            ...
            if hasattr(self, '_m_vcc_cc2'):
                return self._m_vcc_cc2 if hasattr(self, '_m_vcc_cc2') else None
        ...
        def v_bat2(self):
            ...
            if hasattr(self, '_m_v_bat2'):
                return self._m_v_bat2 if hasattr(self, '_m_v_bat2') else None
        ...
        def rssi_a(self):
            ...
            if hasattr(self, '_m_rssi_a'):
                return self._m_rssi_a if hasattr(self, '_m_rssi_a') else None
        ...
        def rssi_b(self):
            ...
            if hasattr(self, '_m_rssi_b'):
                return self._m_rssi_b if hasattr(self, '_m_rssi_b') else None
        ...
        def v_pv1(self):
            ...
            if hasattr(self, '_m_v_pv1'):
                return self._m_v_pv1 if hasattr(self, '_m_v_pv1') else None
        ...
        def v_hv(self):
            ...
            if hasattr(self, '_m_v_hv'):
                return self._m_v_hv if hasattr(self, '_m_v_hv') else None
        ...
        def v_bat1(self):
            ...
            if hasattr(self, '_m_v_bat1'):
                return self._m_v_bat1 if hasattr(self, '_m_v_bat1') else None
        ...
        def i_pv1_bat2(self):
            ...
            if hasattr(self, '_m_i_pv1_bat2'):
                return self._m_i_pv1_bat2 if hasattr(self, '_m_i_pv1_bat2') else None
        ...
        def v_3v3_out(self):
            ...
            if hasattr(self, '_m_v_3v3_out'):
                return self._m_v_3v3_out if hasattr(self, '_m_v_3v3_out') else None
        ...
        def v_3v3_in(self):
            ...
            if hasattr(self, '_m_v_3v3_in'):
                return self._m_v_3v3_in if hasattr(self, '_m_v_3v3_in') else None
        ...
        def i_pv1_bat1(self):
            ...
            if hasattr(self, '_m_i_pv1_bat1'):
                return self._m_i_pv1_bat1 if hasattr(self, '_m_i_pv1_bat1') else None
        ...
        def i_pv2_3v3(self):
            ...
            if hasattr(self, '_m_i_pv2_3v3'):
                return self._m_i_pv2_3v3 if hasattr(self, '_m_i_pv2_3v3') else None
        ...
        def vcc_cc1(self):
            ...
            if hasattr(self, '_m_vcc_cc1'):
                return self._m_vcc_cc1 if hasattr(self, '_m_vcc_cc1') else None
        ...
        def v_5v_out(self):
            ...
            if hasattr(self, '_m_v_5v_out'):
                return self._m_v_5v_out if hasattr(self, '_m_v_5v_out') else None
        ...
        def v_5v_in(self):
            ...
            if hasattr(self, '_m_v_5v_in'):
                return self._m_v_5v_in if hasattr(self, '_m_v_5v_in') else None
        ...
        def i_pv1_5v(self):
            ...
            if hasattr(self, '_m_i_pv1_5v'):
                return self._m_i_pv1_5v if hasattr(self, '_m_i_pv1_5v') else None
        ...
        def i_pv2_bat2(self):
            ...
            if hasattr(self, '_m_i_pv2_bat2'):
                return self._m_i_pv2_bat2 if hasattr(self, '_m_i_pv2_bat2') else None
        ...
        def i_pv2_bat1(self):
            ...
            if hasattr(self, '_m_i_pv2_bat1'):
                return self._m_i_pv2_bat1 if hasattr(self, '_m_i_pv2_bat1') else None
        ...
        def i_pv1_3v3(self):
            ...
            if hasattr(self, '_m_i_pv1_3v3'):
                return self._m_i_pv1_3v3 if hasattr(self, '_m_i_pv1_3v3') else None
        ...
        def v_pv2(self):
            ...
            if hasattr(self, '_m_v_pv2'):
                return self._m_v_pv2 if hasattr(self, '_m_v_pv2') else None
        ...
        def i_pv2_5v(self):
            ...
            if hasattr(self, '_m_i_pv2_5v'):
                return self._m_i_pv2_5v if hasattr(self, '_m_i_pv2_5v') else None
    ...
    class O2Beacon(KaitaiStruct):
        ...
        def temp_sp_x_minus(self):
            ...
            if hasattr(self, '_m_temp_sp_x_minus'):
                return self._m_temp_sp_x_minus if hasattr(self, '_m_temp_sp_x_minus') else None
        ...
        def temp_sp_x_plus(self):
            ...
            if hasattr(self, '_m_temp_sp_x_plus'):
                return self._m_temp_sp_x_plus if hasattr(self, '_m_temp_sp_x_plus') else None
        ...
        def temp_sp_y_minus(self):
            ...
            if hasattr(self, '_m_temp_sp_y_minus'):
                return self._m_temp_sp_y_minus if hasattr(self, '_m_temp_sp_y_minus') else None
        ...
        def temp_sp_y_plus(self):
            ...
            if hasattr(self, '_m_temp_sp_y_plus'):
                return self._m_temp_sp_y_plus if hasattr(self, '_m_temp_sp_y_plus') else None
    ...
    class ABeacon(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.ant_deploy_status = self._io.read_bytes(2)
        ...
        def ant_temp(self):
            ...
            if hasattr(self, '_m_ant_temp'):
                return self._m_ant_temp if hasattr(self, '_m_ant_temp') else None
    ...
    class SBeacon(KaitaiStruct):
        ...
        def _read(self):
            ...
            self.tan = self._io.read_bytes(4)

        @property
        def used_carrier(self):
            """Used carrier frequency for this S-beacon [Hz]."""
            if hasattr(self, '_m_used_carrier'):
                return self._m_used_carrier if hasattr(self, '_m_used_carrier') else None
        ...
        def s_time(self):
            ...
            if hasattr(self, '_m_s_time'):
                return self._m_s_time if hasattr(self, '_m_s_time') else None
        ...
        def usp(self):
            ...
            if hasattr(self, '_m_usp'):
                return self._m_usp if hasattr(self, '_m_usp') else None
        ...
        def rssi_idle(self):
            ...
            if hasattr(self, '_m_rssi_idle'):
                return self._m_rssi_idle if hasattr(self, '_m_rssi_idle') else None
        ...
        def primary_carrier(self):
            ...
            if hasattr(self, '_m_primary_carrier'):
                return self._m_primary_carrier if hasattr(self, '_m_primary_carrier') else None
        ...
        def rssi_rx(self):
            ...
            if hasattr(self, '_m_rssi_rx'):
                return self._m_rssi_rx if hasattr(self, '_m_rssi_rx') else None
        ...
        def temperature_compensation_carrier(self):
            ...
            if hasattr(self, '_m_temperature_compensation_carrier'):
                return self._m_temperature_compensation_carrier if hasattr(self, '_m_temperature_compensation_carrier') else None
        ...
        def secondary_carrier(self):
            ...
            if hasattr(self, '_m_secondary_carrier'):
                return self._m_secondary_carrier if hasattr(self, '_m_secondary_carrier') else None
