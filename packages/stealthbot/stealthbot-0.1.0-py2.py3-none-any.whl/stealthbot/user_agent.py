...
class UserAgent(BaseData):
    ...
    user_agent_119 = get_correct_agent(
        "Mozilla/5.0 (Windows NT 10.0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.37",
        "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_15) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36",
        "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.37")
    ...
    def get_data(self):
        ...
        _119 = [self.user_agent_119] * V_119
        ...
        result = _119 + _106 + _105 + _104 + _103 + \
