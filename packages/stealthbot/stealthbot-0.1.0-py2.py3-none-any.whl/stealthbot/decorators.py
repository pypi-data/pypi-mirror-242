...
from stealthbot.check_and_download_driver import check_and_download_driver
        ...
        def wrapper_browser(passed_data: Optional[Any] = None) -> Any:
            ...
            def run_task(data, is_retry, retry_attempt, retry_driver=None) -> Any:
                ...
                if retry_driver is not None:
                    ...
                    driver = create_driver(tiny_profile, evaluated_profile, evaluated_window_size, evaluated_user_agent,
                                           evaluated_proxy, is_eager, headless, evaluated_lang, block_images, beep)
