...
from hxz_pandora.exts.hooks import hook_logging
from hxz_pandora.exts.token import check_access_token
from hxz_pandora.openai.auth import Auth0
...
class ChatBot:
    ...
    def __after_request(resp):
        resp.headers['X-Server'] = 'hxz_pandora_cloud/{}'.format(__version__)
        return resp
