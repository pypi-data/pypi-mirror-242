...
async def download(url: str, client: FlippitTikTokLiveClient) -> Optional[bytes]:
    """
    Download an image from the TikTok API
    :param url: URL for image download
    :param client: FlippitTikTokLiveClient with which to download (use its HTTP client)
    :return: The result
