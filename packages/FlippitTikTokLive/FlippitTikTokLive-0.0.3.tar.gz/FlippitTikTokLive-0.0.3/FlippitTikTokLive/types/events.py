...
if TYPE_CHECKING:
    from FlippitTikTokLive import FlippitTikTokLiveClient
...
from FlippitTikTokLive.types import User, Gift, Emote, TreasureBoxData, ExtraRankData, LinkUser, BattleArmy, TopViewer, \
    ChatImage, ValueLabel
from FlippitTikTokLive.types.utilities import LiveEvent, alias
...
class AbstractEvent(DataClassDictMixin):
    ...
    """The name of the FlippitTikTokLive event"""
    ...
    def _forward_client(self, client: FlippitTikTokLiveClient):
        """
