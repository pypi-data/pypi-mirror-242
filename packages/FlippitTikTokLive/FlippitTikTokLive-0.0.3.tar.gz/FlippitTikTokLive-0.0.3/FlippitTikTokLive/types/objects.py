...
from FlippitTikTokLive.types import utilities
from FlippitTikTokLive.types.utilities import alias
...
class GiftDetailed(AbstractObject):
    ...
    """Whether the gift is a broadcast gift (usually YES since... this is FlippitTikTokLive)"""
...
class FFmpegWrapper:
    """
    A wrapper for the FFmpeg Stream Download utility in the FlippitTikTokLive Package
