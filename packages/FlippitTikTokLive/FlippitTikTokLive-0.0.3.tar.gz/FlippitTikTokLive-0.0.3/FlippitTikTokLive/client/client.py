...
class FlippitTikTokLiveClient(WebcastPushConnection, AsyncIOEventEmitter):
    """
    FlippitTikTokLive Client responsible for emitting events asynchronously

    """

    def __init__(self, unique_id: str, **options):
        """
        Initialize the WebcastPushConnection for FlippitTikTokLive Webcast tracking
    ...
    def _disconnect(self) -> None:
        ...
        super(FlippitTikTokLiveClient, self)._disconnect()
