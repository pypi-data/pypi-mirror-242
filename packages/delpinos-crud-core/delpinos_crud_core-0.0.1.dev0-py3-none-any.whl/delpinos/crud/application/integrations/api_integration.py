...
from delpinos.crud.domain.enums.exceptions.api_integration_exceptions_enum import (
    ApiIntegrationExceptionMessageEnum,
)
from delpinos.crud.domain.exceptions.api_integration_exception import (
    ApiIntegrationException,
)
from delpinos.crud.domain.integrations.api_integration_abstract import (
    ApiIntegrationAbstract,
)
from delpinos.crud.application.integrations.base_integration import BaseIntegration
...
class ApiIntegration(ApiIntegrationAbstract, BaseIntegration):
    ...
    def execute_api(
        ...
        try:
            ...
            api_integration.exception = str(err)
        api_integration = self.save_api_integration(api_integration)
        if exception:
            raise exception
        return api_integration
