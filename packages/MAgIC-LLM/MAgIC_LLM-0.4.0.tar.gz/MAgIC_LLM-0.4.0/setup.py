...
pkg_name = "MAgIC_LLM"  # 更新为新的包名
pkg_version = "0.4.0"  # 更新版本号
...
setup(
    name=pkg_name,  # 更新为新的包名
    version=pkg_version,  # 更新版本号
    author="Zhiyuan Hu",  # 更新为你的名字
    author_email="zhiyuan.hu.bj@gmail.com",  # 更新为你的邮箱
    description="A new version of the chat arena with llm-agent",  # 添加一个描述
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/zhiyuanhubj/llm-agent",  # 更新为新的 GitHub 仓库 URL
