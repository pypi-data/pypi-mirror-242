...
class Arena:
    ...
    def __init__(self, players: List[Player], environment: Environment, global_prompt: str = None):
        ...
        self._is_backend_reset  = False  # the flag indicates whether environment is reset by 
    ...
    def step(self) -> TimeStep:
        ...
        """
        print("hahaahh")
        if not self._is_backend_reset:
            for player in self.environment.player_backends:
