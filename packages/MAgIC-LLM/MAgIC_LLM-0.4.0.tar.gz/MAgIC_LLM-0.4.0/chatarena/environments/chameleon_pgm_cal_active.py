...
class Chameleon_PGM_Cal_Active(Environment):
    type_name = "chameleon_pgm_cal_active"
    ...
    def __init__(self, player_names: List[str], topic_codes: Dict[str, List[str]] = None, **kwargs):
        ...
        self._view_chameleon_templ = view_templ_active_chameleon
        ...
        if self._current_phase == "give clues":
            ...
            if self._next_player_idx < len(self.player_names) - 1:
                ...
                if self._finish_clue:
                    ...
                    mod_text = mod_text.replace("<TARGET_PLAYER>",self.player_names[target_player_idx])
