...
class Chameleon_Competition(Environment):
    ...
    def reset(self):
        ...
        if self.rewrite_game_setting and self.game_setting:
            ...
            if "game_path" in self.game_setting:
                self.game_path=self.game_setting["game_path"]
            ...
            # self.game_path = "results/game_results/chosen_settings/set_1_wpath/0.json"
        ...
        if self.competition:
            for player_name in self.player_names:
                ...
                if self.game_path:
                    self.player_backends[player_name]["game_path"] = self.game_path
        print("backends in env: ", self.player_backends)
        self._current_turn = 0
        self._next_player_idx = 0
