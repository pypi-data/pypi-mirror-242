...
class Chameleon_Competition_PGM(Environment):
    ...
    def reset(self):
        ...
        if self.rewrite_game_setting and self.game_setting:
            self.topic = self.game_setting["topic"]
            self.code = self.game_setting["code"]
            self.chameleon_name = self.game_setting["chameleon_name"]
        else:
            ...
            # self.save_game_setting({"topic": self.topic, "code": self.code, "chameleon_name": self.chameleon_name})
