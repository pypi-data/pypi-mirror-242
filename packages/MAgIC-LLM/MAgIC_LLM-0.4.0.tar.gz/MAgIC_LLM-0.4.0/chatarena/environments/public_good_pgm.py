...
import json
import re
from ...prompts.public_good_prompt import *
...
class Public_Good_PGM(Environment):
    type_name = "public_good_pgm"
    ...
    def __init__(self, player_names: List[str], topic_codes: Dict[str, List[str]] = None, competition=None, **kwargs):
        ...
        self.decision_template = "Now make a decision, you must answer with the template \"I contribute xx\"."
    ...
    def reset(self):
        ...
        # print("current player models=========>", self.player_models)
        ...
        request_msg = self.decision_template
    ...
    def step(self, player_name: str, action: str) -> TimeStep:
        ...
        if self._current_phase == "decide":
            ...
            if self._next_player_idx < len(self.player_names) - 1:
                ...
                # print("pgm player==============>:", self._next_player_idx, self._current_phase)
