...
async def create_chat_completion(request: ChatCompletionRequest, raw_request: Request):
    ...
    prompt, sampling = await generate_parameters(request)
    ...
    result_generator = worker.generate(None, sampling, request_id, prompt_ids)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="Qwen-14B-Chat, Qwen-Chat",
