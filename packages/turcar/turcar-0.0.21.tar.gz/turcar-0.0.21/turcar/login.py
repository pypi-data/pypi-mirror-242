...
class UserLogin:
    ...
    def create_login_view(self):
        ...
        login_bg = os.path.join(os.path.dirname(__file__), "../../tur-ai/turcar/res", "login-poster.png")
        ...
        img_dir = os.path.join(os.path.dirname(__file__), "../../tur-ai/turcar/res", "login_logo.png")
