...
class UserLogin:
    ...
    def login(self):
        ...
        query_sql = f"SELECT COUNT(*) FROM {user_table} WHERE SUBSTRING(id_card_num, LENGTH(id_card_num)-5) = {account} AND SUBSTRING(phone, LENGTH(phone)-3) ={password}"
    ...
    def create_login_view(self):
        ...
        login_bg = os.path.join(os.path.dirname(__file__), "../../thonny/thonny/res", "login-poster.png")
        ...
        img_dir = os.path.join(os.path.dirname(__file__), "../../thonny/thonny/res", "login_logo.png")
