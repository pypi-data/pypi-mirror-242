...
#define __USE_UNIX98
#define LIBEVT_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBEVT_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBEVT_DEFINITION_UNIX98
#endif
