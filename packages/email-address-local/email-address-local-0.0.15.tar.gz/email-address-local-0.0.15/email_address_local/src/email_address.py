...
EMAIL_ADRESS_ML_TABLE_NAME = "email_address_ml_table"
...
class EmailAddress(GenericCRUD):
    ...
    # Can we create generic function for that in GenericCRUD and use it multiple times in https://github.com/circles-zone/email-address-local-python-package
    ...
    def insert(self, email_address: str, lang_code: lang_code.LangCode, name: str) -> int or None:
        ...
        email_json = {
            ...
            # TODO Make sure we have those two in lang_code
            # https://www.digitalocean.com/community/tutorials/python-str-repr-functions
            "lang_code": f'{lang_code.value}',
            "name": f'{name}'
        }
        super().insert(
            table_name=EMAIL_ADRESS_ML_TABLE_NAME, data_json=email_json)
    ...
    def update_email_adress(self, email_address_id: int, new_email: str) -> None:
        ...
        self.update_by_id(id_column_value=email_address_id,
                          data_json=email_json)
        logger.end(object={})
