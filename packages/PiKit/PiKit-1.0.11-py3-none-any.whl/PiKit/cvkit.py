...
def paint_arrow(img,x0,y0,x1,y1,color,thichness=1 ,line_type = 8 ,shift = 0 ,tiplength = 0.1):
    cv2.arrowedLine(img, (x0,y0), (x1,y1), color, thichness, line_type, shift, tiplength)
