...
print(*map(ns.__getitem__, a.within_std(vs, -6, to_random=True)))
...
print(f"{BHV.std_to_frac(-6, to_random=True):<7.2%} more/less activation compared to random, corresponding to -6σ")
print(f"{BHV.frac_to_std(-0.033, to_random=True):<7.1f} more/less standard deviations compared to random, corresponding to -3.3%")
print(f"{BHV.std_to_frac(10, to_random=True):<7.2%} more/less activation compared to random, corresponding to 10σ")
print(f"{BHV.frac_to_std(0.055, to_random=True):<7.1f} more/less standard deviations compared to random, corresponding to 5.5%")
...
print(f"{BHV.std_apart(a, b, to_random=True):<6.1f} more/less standard deviations than two randoms: d(a, b)")
print(f"{BHV.std_apart(a, a1, to_random=True):<6.1f} more/less standard deviations than two randoms: d(a, a1)")
print(f"{BHV.std_apart(a, ~a, to_random=True):<6.1f} more/less standard deviations than two randoms: d(a, ~a)")
print(f"{BHV.std_apart(a, BHV.ZERO, to_random=True):<6.1f} more/less standard deviations than two randoms: d(a, 0)")
print(f"{BHV.std_apart(a, BHV.ONE, to_random=True):<6.1f} more/less standard deviations than two randoms: d(a, 1)")
