...
def isboolindex(x) -> TypeGuard[pdbindex]:
    ...
    '''
    return isinstance(x, BoolIndex)

def isboolidx(x) -> TypeGuard[pdbindex]:
    '''Check if `x` is an `BoolIndex`.    
    ...
    '''
    return isboolindex(x)

def isbidx(x) -> TypeGuard[pdbindex]:
    '''Check if `x` is an `BoolIndex`.    
