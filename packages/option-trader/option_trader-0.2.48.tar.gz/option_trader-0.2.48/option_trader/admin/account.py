...
class account():
    ...
    def get_account_summary(self):
        ...
        summary[cl.AVG_ALL_TRX_WIN_PL] = round(o[o[position_summary.GAIN]>0][position_summary.PL].sum() if tc > 0 else 0,2)
        summary[cl.AVG_ALL_TRX_LOSS_PL] = round(o[o[position_summary.GAIN]<0][position_summary.PL].sum() if tc > 0 else 0,2)        
        ...
        summary[cl.AVG_OPENED_TRX_WIN_PL] = round(oo[oo[position_summary.GAIN]>0][position_summary.PL].sum() if oc > 0 else 0,2)
        summary[cl.AVG_OPENED_TRX_LOSS_PL] = round(oo[oo[position_summary.GAIN]<0][position_summary.PL].sum() if oc > 0 else 0,2)           
        ...
        summary[cl.AVG_CLOSED_TRX_WIN_PL] = round(co[co[position_summary.GAIN]>0][position_summary.PL].sum() if cc > 0 else 0,2)
        summary[cl.AVG_CLOSED_TRX_LOSS_PL] = round(co[co[position_summary.GAIN]<0][position_summary.PL].sum() if cc > 0 else 0,2)            
