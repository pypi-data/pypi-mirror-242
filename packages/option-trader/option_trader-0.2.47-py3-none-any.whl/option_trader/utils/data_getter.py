...
def pick_option_long( symbol, 
    ...
    if otype == at.PUT:
        i = single_df.shape[0]         
        singl_df = single_df[(single_df[position_summary.BREAKEVEN_H]/single_df[position_summary.TARGET_HIGH]) > 1.01]
    ...
    if otype == at.CALL:
        i = single_df.shape[0]          
        singl_df = single_df[(single_df[position_summary.BREAKEVEN_L]/single_df[position_summary.TARGET_LOW]) < 1.03]
...
def pick_option_short( symbol, 
    ...
    if otype == at.PUT:
        i = single_df.shape[0]         
        singl_df = single_df[single_df[position_summary.BREAKEVEN_H] < single_df[position_summary.TARGET_LOW]]
        logger.debug('%d -> %d reduced by h < low' % (i, single_df.shape[0]))
    if otype == at.CALL:
        i = single_df.shape[0]              
        singl_df = single_df[single_df[position_summary.BREAKEVEN_L] > single_df[position_summary.TARGET_HIGH]]
...
def pick_vertical_put_spreads( symbol,                          
    ...
    if spread_df.shape[0] > 0:
        ...
        if credit:
            i =spread_df.shape[0]               
            spread_df = spread_df[(spread_df[position_summary.BREAKEVEN_L]/spread_df[position_summary.TARGET_LOW]) < 1.01]
            ...
            i =spread_df.shape[0]               
            spread_df = spread_df[(spread_df[position_summary.BREAKEVEN_H]/spread_df[position_summary.TARGET_HIGH]) > 0.97]
...
def pick_vertical_call_spreads(symbol,                          
    ...
    if credit:
        i =spread_df.shape[0]               
        spread_df = spread_df[(spread_df[position_summary.BREAKEVEN_H]/spread_df[position_summary.TARGET_HIGH]) > 0.99]
...
def pick_iron_condor(symbol,                                              
    ...
    if credit:
        i =iron_condor_df.shape[0]               
        #iron_condor_df = iron_condor_df[((iron_condor_df[position_summary.BREAKEVEN_L]/iron_condor_df[position_summary.TARGET_LOW])<1.00) &  ((iron_condor_df[position_summary.BREAKEVEN_H]/iron_condor_df[position_summary.TARGET_HIGH]) > 0.98)]
        ...
        i =iron_condor_df.shape[0]               
        #iron_condor_df = iron_condor_df[((iron_condor_df[position_summary.BREAKEVEN_L]/iron_condor_df[position_summary.TARGET_LOW])<1.03)]
...
def pick_call_butterfly(symbol,                         
    ...
    if credit:
        i = butterfly_df.shape[0]               
        #butterfly_df = butterfly_df[((butterfly_df[position_summary.BREAKEVEN_L]/butterfly_df[position_summary.TARGET_LOW])<1.05) &  ((butterfly_df[position_summary.BREAKEVEN_H]/butterfly_df[position_summary.TARGET_HIGH]) > 1.01)]  
        ...
        i = butterfly_df.shape[0]               
        #butterfly_df = butterfly_df[((butterfly_df[position_summary.BREAKEVEN_L]/butterfly_df[position_summary.TARGET_LOW])<1.25)]
...
def pick_put_butterfly(symbol,                          
    ...
    if credit:
        i = butterfly_df.shape[0]               
        #butterfly_df = butterfly_df[((butterfly_df[position_summary.BREAKEVEN_L]/butterfly_df[position_summary.TARGET_LOW])<1.04) &  ((butterfly_df[position_summary.BREAKEVEN_H]/butterfly_df[position_summary.TARGET_HIGH]) > 1.02)]
        ...
        i = butterfly_df.shape[0]               
        #butterfly_df = butterfly_df[((butterfly_df[position_summary.BREAKEVEN_L]/butterfly_df[position_summary.TARGET_LOW])<0.99) &  ((butterfly_df[position_summary.BREAKEVEN_H]/butterfly_df[position_summary.TARGET_HIGH]) > 0.98)]
...
def pick_iron_butterfly(symbol,      
    ...
    if credit:
        i = butterfly_df.shape[0]               
        #butterfly_df = butterfly_df[((butterfly_df[position_summary.BREAKEVEN_L]/butterfly_df[position_summary.TARGET_LOW])<0.99) &  ((butterfly_df[position_summary.BREAKEVEN_H]/butterfly_df[position_summary.TARGET_HIGH]) > 0.99)]
        ...
        i = butterfly_df.shape[0]               
        #butterfly_df = butterfly_df[((butterfly_df[position_summary.BREAKEVEN_L]/butterfly_df[position_summary.TARGET_LOW])<0.98) ]
