...
class GroupProfilesRemote:
    ...
    def create(self, group_id: str, relationship_type_id: str):
        ...
        effective_profile_id = str(
            self.logger.userContext.get_effective_profile_id())
        try:
    ...
    def get_group_profile_by_group_id(self, group_id: str):
        ...
        try:
            url = self.url_circlez.endpoint_url(
                ...
                query_parameters={
                    'groupId': group_id,
                    'profileId': str(self.logger.userContext.get_effective_profile_id()),
                }
            )
            self.logger.info(
