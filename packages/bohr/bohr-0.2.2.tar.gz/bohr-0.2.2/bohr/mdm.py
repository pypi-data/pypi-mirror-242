...
class MarketDataManager:
    ...
    def get_gos(self, payload={}):
        req_json = self._get_data(self.base_url + '/get_gos', self.GET_METHOD, payload)
        if req_json:
            df = req_json
        else:
            df = []
    ...
    def get_gos_volume(self, payload={}):
        req_json = self._get_data(self.base_url + '/get_gos_volume', self.GET_METHOD, payload)
        if req_json:
            df = req_json
        else:
            df = []
    ...
    def get_gos_volume_txt(self, payload={}):
        req_json = self._get_data(self.base_url + '/get_gos_volume_txt', self.GET_METHOD, payload)
        if req_json:
            df = req_json
        else:
            df = []
    ...
    def get_aggregation(self, payload={}):
        req_json = self._get_data(self.base_url + '/get_aggregation', self.GET_METHOD, payload)
        if req_json:
            df = req_json
        else:
            df = []
