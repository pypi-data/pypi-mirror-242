...
from trainerbase.memory import ARCH, AbstractAddress, ConvertibleToAddress, ensure_address, pm


FASM_EXECUTABLE_PATH = Path(__file__).resolve().parent.parent / "vendor" / "FASM.EXE"
