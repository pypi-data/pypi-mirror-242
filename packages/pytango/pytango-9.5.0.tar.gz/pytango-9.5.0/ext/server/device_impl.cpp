...
namespace PyDeviceImpl
{
    ...
    void add_command(Tango::DeviceImpl &self, boost::python::object cmd_name, boost::python::object cmd_data,
                     boost::python::object is_allowed_name, boost::python::object disp_level, bool device_level = false)
    {
        ...
        std::string is_allowed = boost::python::extract<std::string>(is_allowed_name);
...
DeviceImplWrap::DeviceImplWrap(PyObject *_self, CppDeviceClass *cl,
                               std::string &st)
    :Tango::DeviceImpl(cl,st), m_self(_self)
{
    Py_INCREF(m_self);
}
...
DeviceImplWrap::DeviceImplWrap(PyObject *_self, CppDeviceClass *cl,
    ...
    :Tango::DeviceImpl(cl, name, _desc, sta, status), m_self(_self)
{
    Py_INCREF(m_self);
}
...
Device_2ImplWrap::Device_2ImplWrap(PyObject *_self, CppDeviceClass *cl,
                                   std::string &st)
    :Tango::Device_2Impl(cl,st),m_self(_self)
{
    Py_INCREF(m_self);
}
...
Device_2ImplWrap::Device_2ImplWrap(PyObject *_self, CppDeviceClass *cl,
                                   ...
                                   Tango::DevState sta /* = Tango::UNKNOWN */,
                                   const char *status /* = StatusNotSet */)
    :Tango::Device_2Impl(cl, name, _desc, sta, status), m_self(_self)
{
    Py_INCREF(m_self);
}
...
PyDeviceImplBase::PyDeviceImplBase(PyObject *_self):the_self(_self)
{
    Py_INCREF(the_self);
}
...
Device_3ImplWrap::Device_3ImplWrap(PyObject *_self, CppDeviceClass *cl,
                                   std::string &st)
...
Device_3ImplWrap::Device_3ImplWrap(PyObject *_self, CppDeviceClass *cl,
                                   ...
                                   Tango::DevState sta /* = Tango::UNKNOWN */,
                                   const char *status /* = StatusNotSet */)
    :Tango::Device_3Impl(cl, name, _desc, sta, status),
    PyDeviceImplBase(_self)
{
    _init();
}
...
Device_4ImplWrap::Device_4ImplWrap(PyObject *_self, CppDeviceClass *cl,
                                   std::string &st)
...
Device_4ImplWrap::Device_4ImplWrap(PyObject *_self, CppDeviceClass *cl,
                                   ...
                                   Tango::DevState sta /* = Tango::UNKNOWN */,
                                   const char *status /* = StatusNotSet */)
    :Tango::Device_4Impl(cl, name, _desc, sta, status),
    PyDeviceImplBase(_self)
{
    _init();
}
...
Device_5ImplWrap::Device_5ImplWrap(PyObject *_self, CppDeviceClass *cl,
                                   std::string &st)
...
Device_5ImplWrap::Device_5ImplWrap(PyObject *_self, CppDeviceClass *cl,
                                   ...
                                   Tango::DevState sta /* = Tango::UNKNOWN */,
                                   const char *status /* = StatusNotSet */)
    :Tango::Device_5Impl(cl, name, _desc, sta, status),
    PyDeviceImplBase(_self)
{
    _init();
}
