...
class exptserve(object):
    ...
    def BroadcastNotification(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/foxtrot.exptserve/BroadcastNotification',
    ...
    def GetServerInfo(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/foxtrot.exptserve/GetServerInfo',
    ...
    def Disconnect(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/foxtrot.exptserve/Disconnect',
            ft__types__pb2.empty.SerializeToString,
