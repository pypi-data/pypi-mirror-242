...
class ActorMotionComponentServer(BaseComponent):
    ...
    def AddEntityTrackMotion(self, targetPos, duraTime, startPos=None, relativeCoord=False, isLoop=False, targetRot=None, startRot=None, useVelocityDir=False):
        # type: (Tuple[float,float,float], float, Tuple[float,float,float], bool, bool, Tuple[float,float], Tuple[float,float], bool) -> int
        """
        给实体（不含玩家）添加轨迹运动器
        """
        pass
    ...
    def AddPlayerTrackMotion(self, targetPos, duraTime, startPos=None, relativeCoord=False, isLoop=False, targetRot=None, startRot=None, useVelocityDir=False):
        # type: (Tuple[float,float,float], float, Tuple[float,float,float], bool, bool, Tuple[float,float], Tuple[float,float], bool) -> int
        """
        给玩家添加轨迹运动器
        """
