...
class DPSHelper:
    ...
    def initialise_series_subscription_data(self, series_id : str, country_id : str, option_id : list[str], handle_data_method : callable):
        ...
        initial_series_data['DateTimeLastUpdated'] = now
    ...
    def handle_new_series_data(self, all_data : pd.DataFrame, data_push_holder : list) -> pd.DataFrame:
        try:
            ...
            push_ids = list(all_data.columns)
            ...
            for push in pushes:
                ...
                for index, push_id in enumerate(push_ids):
                    ...
                    all_data.loc[push_date_time, 'DateTimeLastUpdated'] = dt.now()
            return all_data
        except:
    ...
    def subscribe_to_epex_trade_updates(self, handle_data_method : callable):
        '''
    ...
    def subscribe_to_series_updates(self, handle_data_method : callable, series_id : str, option_id : list[str] = None, country_id = 'Gb'):
        '''
