...
class APIHelper(APIHelperBase):
    ...
    #Leaderboard:
    def get_leaderboard_data(self, date_from, date_to, type = "Plant", revenue_metric = 'PoundPerMwPerH', market_price_assumption = 'WeightedAverageDayAheadPrice', gas_price_assumption = 'DayAheadForward') -> pd.DataFrame:
    ...
    #Ancillary Contracts:
    def get_ancillary_contract_data(self, ancillary_contract_type : str, option_one : str | int, option_two : int | str = None) -> dict[str, pd.DataFrame]:
