...
class MacalInstructionList:
    def __init__(self):
        ...
        self.add("CALL", ["addr", "reg"], "call function at addr")
        ...
        self.add("DBGVAR", ["str", "imm", "imm"], "print variable information for debugging.")
        self.add("BREAK", ["addr"], "break instruction")
        self.add("CONTINUE", ["addr"], "continue instruction")
        self.add("RETURN", ["addr"], "return instruction")
        self.add("JMPBREAK", ["addr"], "jump to addr if break flag is set") 
        self.add("JMPCONTINUE", ["addr"], "jump to addr if continue flag is set")
        self.add("JMPRETURN", ["addr"], "jump to addr if return flag is set")
        self.add("RSTBREAK", [], "reset break flag")
        self.add("RSTCONTINUE", [], "reset continue flag")
        self.add("RSTRETURN", [], "reset return flag")
