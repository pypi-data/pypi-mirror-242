...
from .config import MetadataProviderApi, read_search_overrides
...
# semaphore = asyncio.Semaphore(config.maximum_concurrent_requests)
    ...
    async def try_harder(
        ...
        while len(split) >= min_len:
            ...
            try:
                ...
                return await validation_func(response_data, search_title, *(validation_callback_args or tuple()))
