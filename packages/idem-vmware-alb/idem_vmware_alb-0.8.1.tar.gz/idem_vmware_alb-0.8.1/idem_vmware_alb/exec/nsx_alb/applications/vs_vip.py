...
async def get(
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resource:
              exec.run:
                - path: nsx_alb.applications.vs_vip.get
                - kwargs:
                  resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.applications.vs_vip.get resource_id=value
    """
...
async def list_(hub, ctx) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resources:
              exec.run:
                - path: nsx_alb.applications.vs_vip.list
                - kwargs:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.applications.vs_vip.list
...
async def create(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.applications.vs_vip.create x_avi_version=value
    """
...
async def update(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.applications.vs_vip.update resource_id=value
    """
...
async def delete(hub, ctx, resource_id: str, name: str = None) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              nsx_alb.applications.vs_vip.absent:
                - resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.applications.vs_vip.delete resource_id=value
    """
