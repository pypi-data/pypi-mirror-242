...
async def get(
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resource:
              exec.run:
                - path: nsx_alb.applications.pool.get
                - kwargs:
                  resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.applications.pool.get resource_id=value
    """
...
async def list_(hub, ctx) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            unmanaged_resources:
              exec.run:
                - path: nsx_alb.applications.pool.list
                - kwargs:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.applications.pool.list
...
async def create(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.applications.pool.create
    """
    ...
    result["comment"].append(
        f"Created nsx_alb.applications.pool '{name}'",
    )
...
async def update(
    ...
    Examples:
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.applications.pool.update resource_id=value
    """
...
async def delete(hub, ctx, resource_id: str, name: str = None) -> Dict[str, Any]:
    ...
    Examples:
        ...
        .. code-block:: sls
            ...
            resource_is_absent:
              nsx_alb.applications.pool.absent:
                - resource_id: value
        ...
        .. code-block:: bash
            ...
            idem exec nsx_alb.applications.pool.delete resource_id=value
    """
