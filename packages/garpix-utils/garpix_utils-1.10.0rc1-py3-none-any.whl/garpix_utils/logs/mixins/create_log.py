from garpix_utils.logs.services.logger_iso import LoggerIso, ActionResult, Action
...
class CreateLogMixin:
    ...
    @staticmethod
    def log_delete(request, obj, action):
        ...
        return LoggerIso.create_log(action=action,
