...
class Task(irisml.core.TaskBase):
    ...
    def _predict(self, inputs):
        ...
        dataloader = build_dataloader(inputs.dataset, inputs.transform, batch_size=self.config.batch_size, shuffle=False, drop_last=False, collate_function=inputs.collate_function)
