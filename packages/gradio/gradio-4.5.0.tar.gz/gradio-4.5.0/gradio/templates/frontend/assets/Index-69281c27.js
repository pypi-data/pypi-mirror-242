import { B as Block } from './Button-724396e3.js';
import { B as BlockLabel } from './BlockLabel-5c4e486a.js';
import { E as Empty } from './Empty-ff602cf2.js';
import { S as Static } from './Index-045b93a3.js';
import { F as File$1 } from './File-e96cd7d6.js';
import { U as Upload } from './Upload-6a0049ea.js';
import { M as ModifyUpload } from './ModifyUpload-a3ea9b01.js';
import { n as normalise_file } from './index-11cab7ad.js';
import { U as UploadText } from './UploadText-bcf87342.js';
export { default as BaseExample } from './Example-d9b38e6f.js';
/* empty css                                                     */import './IconButton-ea23565c.js';
...
function create_else_block$3(ctx) {
	...
	return {
		...
		p(ctx, dirty) {
			if (dirty & /*i18n*/ 8 && t_value !== (t_value = /*i18n*/ ctx[3]("file.uploading") + "")) set_data(t, t_value);
		},
		d(detaching) {
			if (detaching) {
				detach$3(t);
...
function create_if_block$3(ctx) {
	...
	return {
		c() {
			...
			t = text(" ⇣");
			html_tag.a = t;
			attr(a, "href", a_href_value = /*file*/ ctx[6].url);
			attr(a, "target", "_blank");
			attr(a, "download", a_download_value = window.__is_colab__ ? null : /*file*/ ctx[6].orig_name);
			attr(a, "class", "svelte-1lop6bc");
		},
		m(target, anchor) {
		...
		p(ctx, dirty) {
			...
			if (dirty & /*value*/ 1 && a_href_value !== (a_href_value = /*file*/ ctx[6].url)) {
				attr(a, "href", a_href_value);
			}

			if (dirty & /*value*/ 1 && a_download_value !== (a_download_value = window.__is_colab__ ? null : /*file*/ ctx[6].orig_name)) {
...
function create_each_block(ctx) {
	...
	function select_block_type(ctx, dirty) {
		if (/*file*/ ctx[6].url) return create_if_block$3;
	...
	return {
		c() {
			...
			if_block.c();
			t2 = space$3();
			attr(td0, "class", "svelte-1lop6bc");
			attr(td1, "class", "download svelte-1lop6bc");
			attr(tr, "class", "file svelte-1lop6bc");
		...
		p(new_ctx, dirty) {
			ctx = new_ctx;
			if (dirty & /*value*/ 1 && t0_value !== (t0_value = display_file_name(/*file*/ ctx[6]) + "")) set_data(t0, t0_value);
...
function create_fragment$3(ctx) {
	...
	return {
		c() {
			...
			attr(tbody, "class", "svelte-1lop6bc");
			attr(table, "class", "file-preview svelte-1lop6bc");
			attr(div, "class", "file-preview-holder svelte-1lop6bc");
		...
		p(ctx, [dirty]) {
			if (dirty & /*selectable, dispatch, Array, value, window, i18n*/ 27) {
...
//# sourceMappingURL=Index-69281c27.js.map
