...
const ENTRY_CSS = "./assets/index-01b71e7a.css";
let FONTS;
FONTS = [];
let IndexComponent;
let _res;
...
async function get_index() {
  IndexComponent = (await __vitePreload(() => import('./Index-045b93a3.js').then(n => n.I),true?["./Index-045b93a3.js","./Index-abbe767f.css"]:void 0,import.meta.url)).default;
  _res();
}
...
//# sourceMappingURL=index-11cab7ad.js.map
