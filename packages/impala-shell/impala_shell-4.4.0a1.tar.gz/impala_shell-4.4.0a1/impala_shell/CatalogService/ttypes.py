...
class TGetPartialCatalogObjectResponse(object):
    ...
    def __init__(self, status=None, lookup_status=0, object_version_number=None, table_info=None, db_info=None, catalog_info=None, functions=None, data_srcs=None,):
        self.status = status
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i168 in range(_size164):
                        _elem169 = CatalogObjects.ttypes.TDataSource()
                        _elem169.read(iprot)
                        self.data_srcs.append(_elem169)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TGetPartitionStatsResponse(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i176 in range(_size172):
                        ...
                        self.partition_stats[_key177] = _val178
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.partition_stats is not None:
            ...
            for kiter179, viter180 in self.partition_stats.items():
                oprot.writeString(kiter179)
                oprot.writeBinary(viter180)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TPrioritizeLoadRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i185 in range(_size181):
                        _elem186 = CatalogObjects.ttypes.TCatalogObject()
                        _elem186.read(iprot)
                        self.object_descs.append(_elem186)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.object_descs is not None:
            ...
            for iter187 in self.object_descs:
                iter187.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i192 in range(_size188):
                        _elem193 = TTableUsage()
                        _elem193.read(iprot)
                        self.usages.append(_elem193)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
