...
class TPlanNode(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i262 in range(_size258):
                        ...
                        self.row_tuples.append(_elem263)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.LIST:
                    ...
                    for _i268 in range(_size264):
                        _elem269 = iprot.readBool()
                        self.nullable_tuples.append(_elem269)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.LIST:
                    ...
                    for _i274 in range(_size270):
                        _elem275 = Exprs.ttypes.TExpr()
                        _elem275.read(iprot)
                        self.conjuncts.append(_elem275)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i280 in range(_size276):
                        _elem281 = TPipelineMembership()
                        _elem281.read(iprot)
                        self.pipelines.append(_elem281)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i286 in range(_size282):
                        _elem287 = TRuntimeFilterDesc()
                        _elem287.read(iprot)
                        self.runtime_filters.append(_elem287)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 26:
    ...
    def write(self, oprot):
        ...
        if self.row_tuples is not None:
            ...
            for iter288 in self.row_tuples:
        ...
        if self.nullable_tuples is not None:
            ...
            for iter289 in self.nullable_tuples:
                oprot.writeBool(iter289)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        ...
        if self.runtime_filters is not None:
            ...
            for iter292 in self.runtime_filters:
                iter292.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.resource_profile is not None:
