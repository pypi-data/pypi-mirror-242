...
class TExecRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i146 in range(_size142):
                        _elem147 = TAccessEvent()
                        _elem147.read(iprot)
                        self.access_events.append(_elem147)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.LIST:
                    ...
                    for _i152 in range(_size148):
                        ...
                        self.analysis_warnings.append(_elem153)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i158 in range(_size154):
                        _elem159 = RuntimeProfile.ttypes.TRuntimeProfileNode()
                        _elem159.read(iprot)
                        self.profile_children.append(_elem159)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 18:
    ...
    def write(self, oprot):
        ...
        if self.access_events is not None:
            ...
            for iter160 in self.access_events:
                iter160.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.analysis_warnings is not None:
            ...
            for iter161 in self.analysis_warnings:
        ...
        if self.profile_children is not None:
            ...
            for iter162 in self.profile_children:
                iter162.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
...
class TUpdateExecutorMembershipRequest(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i200 in range(_size196):
                        _elem201 = TExecutorGroupSet()
                        _elem201.read(iprot)
                        self.exec_group_sets.append(_elem201)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.ip_addresses is not None:
            ...
            for iter203 in self.ip_addresses:
        ...
        if self.exec_group_sets is not None:
            ...
            for iter204 in self.exec_group_sets:
                iter204.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TBuildTestDescriptorTableParams(object):
                ...
                if ftype == TType.LIST:
                    ...
                    for _i239 in range(_size235):
                        ...
                        for _i245 in range(_size241):
                            ...
                            _elem246.read(iprot)
                            _elem240.append(_elem246)
                        iprot.readListEnd()
                        self.slot_types.append(_elem240)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.slot_types is not None:
            ...
            for iter247 in self.slot_types:
                oprot.writeListBegin(TType.STRUCT, len(iter247))
...
class TTestCaseData(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i253 in range(_size249):
                        _elem254 = CatalogObjects.ttypes.TTable()
                        _elem254.read(iprot)
                        self.tables_and_views.append(_elem254)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.LIST:
                    ...
                    for _i259 in range(_size255):
                        _elem260 = CatalogObjects.ttypes.TDatabase()
                        _elem260.read(iprot)
                        self.dbs.append(_elem260)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
    ...
    def write(self, oprot):
        ...
        if self.tables_and_views is not None:
            ...
            for iter261 in self.tables_and_views:
                iter261.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.dbs is not None:
...
class TWrappedHttpRequest(object):
    ...
    def write(self, oprot):
        ...
        if self.params is not None:
            ...
            for kiter284, viter285 in self.params.items():
        ...
        if self.headers is not None:
            ...
            for kiter286, viter287 in self.headers.items():
        ...
        if self.cookies is not None:
            ...
            for kiter288, viter289 in self.cookies.items():
...
class TWrappedHttpResponse(object):
    ...
    def write(self, oprot):
        ...
        if self.headers is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.headers))
            for kiter304, viter305 in self.headers.items():
        ...
        if self.cookies is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.cookies))
            for kiter306, viter307 in self.cookies.items():
