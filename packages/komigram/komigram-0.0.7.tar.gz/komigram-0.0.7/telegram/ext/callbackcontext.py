...
class CallbackContext(Generic[UD, CD, BD]):
    ...
    Warning:
         Do not combine custom attributes and ``@block``/
         :meth:`telegram.ext.Disptacher.block`. Due to how ``block`` works, it will
    ...
    Attributes:
        ...
        async_args (List[:obj:`object`]): Optional. Positional arguments of the function that
            ...
            :meth:`telegram.ext.Dispatcher.block`.
        async_kwargs (Dict[:obj:`str`, :obj:`object`]): Optional. Keyword arguments of the function
            ...
            using :meth:`telegram.ext.Dispatcher.block`.
    ...
    def from_error(
        ...
        Args:
            ...
            async_kwargs (Dict[:obj:`str`, :obj:`object`]): Optional. Keyword arguments of the
                ...
                asynchronously using :meth:`telegram.ext.Dispatcher.block`.
