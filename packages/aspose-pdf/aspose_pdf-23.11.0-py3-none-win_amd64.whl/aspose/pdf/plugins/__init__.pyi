...
class PdfConverterToDocOptions(aspose.pdf.plugins.PdfConverterOptions):
    '''Represents PDF to DOC converter options for :class:`PdfConverter` plugin.'''
    
    @overload
    def __init__(self):
        '''Initializes new instance of the :class:`PdfConverterToDocOptions` object with default options.'''
        ...
    
    @overload
    def __init__(self, format: aspose.pdf.plugins.SaveFormat, mode: aspose.pdf.plugins.ConversionMode):
        '''Initializes a new instance of the :class:`PdfConverterToDocOptions`  object for the specified format and mode.
        
        :param format: Save format of the output document.
        :param mode: Conversion mode of the output document.'''
        ...
    ...
    @property
    def save_format(self) -> aspose.pdf.plugins.SaveFormat:
        '''Save format of the output document.'''
        ...

    @save_format.setter
    def save_format(self, value: aspose.pdf.plugins.SaveFormat):
        ...
...
class PdfConverterToExcelOptions(aspose.pdf.plugins.PdfConverterOptions):
    ...
    class ExcelFormat:
          ...
          XML_SPREAD_SHEET2003: ExcelFormat
          XLSX: ExcelFormat
          CSV: ExcelFormat
          XLSM: ExcelFormat
          ODS: ExcelFormat 
...
class PdfConverterToHtmlOptions(aspose.pdf.plugins.PdfConverterOptions):
    ...
    class SaveDataType:
          ...
          FILE_WITH_EXTERNAL_RESOURCES: SaveDataType
          FILE_WITH_EMBEDDED_RESOURCES: SaveDataType
          STREAM_WITH_EMBEDDED_RESOURCES: SaveDataType  
...
class PdfExtractorToTextOptions(aspose.pdf.plugins.PdfExtractorOptions):
    ...
    class TextFormattingMode:
          '''Defines different modes which can be used while converting a PDF document into text. See <see cref="PdfExtractorToTextOptions"/> class.'''

          PURE: TextFormattingMode
          RAW: TextFormattingMode
          PLAIN: TextFormattingMode
...
class PdfGeneratorTableBuilder:
    ...
    def add_row(self) -> aspose.pdf.plugins.PdfGeneratorTableRowBuidler:
        '''Add new row to table.
        
        :returns: Instance of current :class:`PdfGeneratorTableRowBuidler`.'''
        ...
    
    def add_table(self) -> aspose.pdf.plugins.PdfGeneratorTableBuilder:
        '''Add new table to document.
        
        :returns: Instance of current :class:`PdfGeneratorTableBuilder`.'''
        ...
    
    def set_page(self, page: int) -> aspose.pdf.plugins.PdfGeneratorTableBuilder:
...
class PdfGeneratorTableCellBuilder(aspose.pdf.plugins.PdfGeneratorTableRowBuidler):
    '''Class represents builder for table cell.'''
    
    def add_cell(self) -> aspose.pdf.plugins.PdfGeneratorTableCellBuilder:
        '''Add cell to table.
        
        :returns: Instance of current :class:`PdfGeneratorTableCellBuilder`.'''
        ...
    
    def add_paragraph(self, paragraph: list[aspose.pdf.BaseParagraph]) -> aspose.pdf.plugins.PdfGeneratorTableCellBuilder:
...
class PdfGeneratorTableRowBuidler(aspose.pdf.plugins.PdfGeneratorTableBuilder):
...
class PdfImageToJpegOptions(aspose.pdf.plugins.PdfImageOptions):
    ...
    class ImageConversionMode:
          '''Defines different modes which can be used while converting from PDF document to Jpeg image. See <see cref="PdfImageToJpegOptions"/> class.'''

          NONE: ImageConversionMode
