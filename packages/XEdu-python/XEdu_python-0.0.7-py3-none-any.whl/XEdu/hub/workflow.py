...
class Workflow:
    ...
    def __init__(self, task,checkpoint=None,download_path=None,**kwargs):
        ...
        if checkpoint is None and self.task in['det_body','det_body_l','det_coco','det_coco_l','pose_body17','pose_body17_l','pose_body26','pose_wholebody133','pose_face106','pose_hand21','det_hand','cls_imagenet','gen_style','nlp_qa','drive_perception']: # 若不指定权重文件，则使用对应任务的默认模型
    ...
    def format_output(self,lang='zh',**kwargs): # check
        language = lang
        if self.task in ["pose_body17","pose_body26","pose_face106","pose_hand21","pose_wholebody133","pose_body17_l"]:
            formalize_keys = {
                "zh":["关键点坐标","分数"],
            ...
            pprint.pprint(formalize_results,sort_dicts=False)
        elif self.task in ['drive_perception']:
            formalize_keys = {  
