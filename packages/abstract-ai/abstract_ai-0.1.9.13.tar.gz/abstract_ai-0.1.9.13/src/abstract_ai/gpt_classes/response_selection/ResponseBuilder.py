...
class ResponseManager:
    ...
    def process_response(self, response):
        ...
        self.save_mgr = self.SaveManager(data=response_json, title=self.title, directory=self.directory, model=self.model_mgr.selected_model_name)
    ...
    def send_query(self):
        ...
        self.break_current = self.abort_js('additional_responses',False)
        self.break_current = self.abort_js('request_chunks',False)
