...
class ResponseManager:
    ...
    def process_response(self, response):
        ...
        SaveManager(data=response_json, title=self.title, directory=f'response_data/{self.model}/raw_response', model=self.model)
    ...
    def send_query(self):
        ...
        self.save_mgr = SaveManager(data=self.query_js, title=self.title, directory=self.directory, model=self.model)
