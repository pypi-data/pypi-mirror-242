...
class SaveManager:
    ...
    def __init__(self, data={},title:str=None,directory:str=None,model:str='default')->None:
        ...
        if data:
            ...
            self.safe_dump_to_file(data = data,file_path = self.file_path)
...
class ResponseManager:
    ...
    def process_response(self, response):
        ...
        self.response_content=safe_json_loads(str(self.response_message.get('content')))
        self.generate_title=safe_json_loads(self.response_content.get('generate_title'))
