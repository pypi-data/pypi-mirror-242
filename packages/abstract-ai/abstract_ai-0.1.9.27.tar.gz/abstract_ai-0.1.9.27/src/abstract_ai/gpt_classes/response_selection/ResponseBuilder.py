...
class ResponseManager:
    ...
    def create_save_directory(self,response_json,query_js=None):
        ...
        self.response_choices = safe_json_loads(response_json.get('choices'))
        if isinstance(self.response_choices,list):
            self.response_choices=self.response_choices[0]
        self.response_choices=safe_json_loads(self.response_choices)
        self.response_message=safe_json_loads(self.response_choices.get('message'))
        self.response_content=safe_json_loads(self.response_message.get('content'))
        self.response_title=safe_json_loads(self.response_content.get('generate_title'))
    ...
    def send_query(self):
        ...
        self.create_save_directory(response_json=self.query_js['response'],query_js=self.query_js)
