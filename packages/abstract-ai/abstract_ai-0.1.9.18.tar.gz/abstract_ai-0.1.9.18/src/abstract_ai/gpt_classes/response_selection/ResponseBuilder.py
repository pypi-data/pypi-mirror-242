...
class ResponseManager:
    ...
    def send_query(self):
        ...
        self.loop_current = True if True in [getattr(self, "additional_responses"),getattr(self, "request_chunks")] else False
    ...
    def initial_query(self):
        ...
        for chunk_token_distribution_number, distributions in enumerate(self.chunk_token_distributions):
            for chunk_number, _ in enumerate(distributions):
                ...
                while self.loop_current or getattr(self, "abort") != True:
                    self.send_query()
                self.i_query += 1
