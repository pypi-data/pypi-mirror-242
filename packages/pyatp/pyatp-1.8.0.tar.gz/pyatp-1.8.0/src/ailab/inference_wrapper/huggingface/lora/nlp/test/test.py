...
pretrain_model_name = '/opt/ailab_sdk/src/test/ailabmodel/my_baichuan_model_full/checkpoint-1000'
token_path = '/opt/ailab_sdk/src/test/ailabmodel/my_baichuan_model_full/checkpoint-1000'
zip_path = '/opt/ailab_sdk/src/test/ailabmodel/my_baichuan_model_qlora/checkpoint-1000/adapter.zip'
stream = 1
finetune_type = 'full'
infer_type = 'trained'
""""""
