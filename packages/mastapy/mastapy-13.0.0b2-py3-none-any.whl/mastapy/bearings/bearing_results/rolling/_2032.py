...
class LoadedRollingBearingRow(_0.APIBase):
    ...
    class _Cast_LoadedRollingBearingRow:
        ...
        def loaded_angular_contact_ball_bearing_row(
            ...
            return self._parent._cast(_1982.LoadedAngularContactBallBearingRow)
        ...
        def loaded_angular_contact_thrust_ball_bearing_row(
            ...
            return self._parent._cast(_1985.LoadedAngularContactThrustBallBearingRow)
        ...
        def loaded_asymmetric_spherical_roller_bearing_row(
            ...
            return self._parent._cast(_1988.LoadedAsymmetricSphericalRollerBearingRow)
        ...
        def loaded_axial_thrust_needle_roller_bearing_row(
            ...
            return self._parent._cast(_1996.LoadedAxialThrustNeedleRollerBearingRow)
        ...
        def loaded_ball_bearing_row(
            ...
            return self._parent._cast(_2001.LoadedBallBearingRow)
        ...
        def loaded_crossed_roller_bearing_row(
            ...
            return self._parent._cast(_2004.LoadedCrossedRollerBearingRow)
        ...
        def loaded_cylindrical_roller_bearing_row(
            ...
            return self._parent._cast(_2008.LoadedCylindricalRollerBearingRow)
        ...
        def loaded_deep_groove_ball_bearing_row(
            ...
            return self._parent._cast(_2011.LoadedDeepGrooveBallBearingRow)
        ...
        def loaded_four_point_contact_ball_bearing_row(
            ...
            return self._parent._cast(_2016.LoadedFourPointContactBallBearingRow)
        ...
        def loaded_needle_roller_bearing_row(
            ...
            return self._parent._cast(_2020.LoadedNeedleRollerBearingRow)
        ...
        def loaded_non_barrel_roller_bearing_row(
            ...
            return self._parent._cast(_2023.LoadedNonBarrelRollerBearingRow)
        ...
        def loaded_roller_bearing_row(
            ...
            return self._parent._cast(_2028.LoadedRollerBearingRow)
        ...
        def loaded_self_aligning_ball_bearing_row(
            ...
            return self._parent._cast(_2035.LoadedSelfAligningBallBearingRow)
        ...
        def loaded_spherical_roller_radial_bearing_row(
            ...
            return self._parent._cast(_2039.LoadedSphericalRollerRadialBearingRow)
        ...
        def loaded_spherical_roller_thrust_bearing_row(
            ...
            return self._parent._cast(_2042.LoadedSphericalRollerThrustBearingRow)
        ...
        def loaded_taper_roller_bearing_row(
            ...
            return self._parent._cast(_2047.LoadedTaperRollerBearingRow)
        ...
        def loaded_three_point_contact_ball_bearing_row(
            ...
            return self._parent._cast(_2050.LoadedThreePointContactBallBearingRow)
        ...
        def loaded_thrust_ball_bearing_row(
            ...
            return self._parent._cast(_2053.LoadedThrustBallBearingRow)
        ...
        def loaded_toroidal_roller_bearing_row(
            ...
            return self._parent._cast(_2056.LoadedToroidalRollerBearingRow)
    ...
    @property
    def subsurface_shear_stress_chart_inner(self: Self) -> "_1865.TwoDChartDefinition":
    ...
    @property
    def subsurface_shear_stress_chart_outer(self: Self) -> "_1865.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def loaded_bearing(self: Self) -> "_2031.LoadedRollingBearingResults":
    ...
    @property
    def maximum_operating_internal_clearance(self: Self) -> "_1971.InternalClearance":
    ...
    @property
    def minimum_operating_internal_clearance(self: Self) -> "_1971.InternalClearance":
        """mastapy.bearings.bearing_results.rolling.InternalClearance
    ...
    @property
    def elements(self: Self) -> "List[_2012.LoadedElement]":
    ...
    @property
    def race_results(self: Self) -> "List[_2030.LoadedRollingBearingRaceResults]":
    ...
    def ring_force_and_displacement_results(
        self: Self,
    ) -> "List[_2066.RingForceAndDisplacement]":
