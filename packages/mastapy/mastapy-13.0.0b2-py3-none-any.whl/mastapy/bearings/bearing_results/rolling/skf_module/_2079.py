...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2080, _2092
...
class Frequencies(_2094.SKFCalculationResult):
    """Frequencies
    ...
    @property
    def frequency_of_over_rolling(self: Self) -> "_2080.FrequencyOfOverRolling":
    ...
    @property
    def rotational_frequency(self: Self) -> "_2092.RotationalFrequency":
