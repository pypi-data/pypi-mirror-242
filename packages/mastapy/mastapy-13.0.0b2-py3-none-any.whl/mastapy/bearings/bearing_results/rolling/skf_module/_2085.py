...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2084, _2086, _2087
...
class GreaseLifeAndRelubricationInterval(_2094.SKFCalculationResult):
    """GreaseLifeAndRelubricationInterval
    ...
    class _Cast_GreaseLifeAndRelubricationInterval:
        ...
        def skf_calculation_result(
            ...
            return self._parent._cast(_2094.SKFCalculationResult)
    ...
    @property
    def grease(self: Self) -> "_2084.Grease":
    ...
    @property
    def grease_quantity(self: Self) -> "_2086.GreaseQuantity":
    ...
    @property
    def initial_fill(self: Self) -> "_2087.InitialFill":
