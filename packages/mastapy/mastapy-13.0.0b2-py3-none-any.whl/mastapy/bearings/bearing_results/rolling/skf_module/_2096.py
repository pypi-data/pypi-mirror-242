...
class SKFModuleResults(_0.APIBase):
    ...
    @property
    def adjusted_speed(self: Self) -> "_2074.AdjustedSpeed":
    ...
    @property
    def bearing_loads(self: Self) -> "_2076.BearingLoads":
    ...
    @property
    def bearing_rating_life(self: Self) -> "_2077.BearingRatingLife":
    ...
    @property
    def frequencies(self: Self) -> "_2079.Frequencies":
    ...
    @property
    def friction(self: Self) -> "_2081.Friction":
    ...
    @property
    def minimum_load(self: Self) -> "_2089.MinimumLoad":
    ...
    @property
    def static_safety_factors(self: Self) -> "_2097.StaticSafetyFactors":
    ...
    @property
    def viscosities(self: Self) -> "_2098.Viscosities":
