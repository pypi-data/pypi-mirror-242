...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.measured_data import _1565, _1566
...
class ISO14179Settings(_1827.NamedDatabaseItem):
    """ISO14179Settings
    ...
    def isotr141792001f1_specification_method(
        self: Self, value: "_2063.PowerRatingF1EstimationMethod"
    ):
