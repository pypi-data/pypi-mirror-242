...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.fitting import _2109
...
class RingFittingThermalResults(_0.APIBase):
    ...
    class _Cast_RingFittingThermalResults:
        ...
        def inner_ring_fitting_thermal_results(
            ...
            from mastapy.bearings.bearing_results.rolling.fitting import _2108

            return self._parent._cast(_2108.InnerRingFittingThermalResults)
        ...
        def outer_ring_fitting_thermal_results(
            ...
            return self._parent._cast(_2110.OuterRingFittingThermalResults)
    ...
    @property
    def interference_values(self: Self) -> "List[_2109.InterferenceComponents]":
