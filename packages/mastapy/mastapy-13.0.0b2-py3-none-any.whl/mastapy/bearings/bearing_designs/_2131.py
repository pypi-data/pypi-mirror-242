...
class LinearBearing(_2128.BearingDesign):
    """LinearBearing
    ...
    @property
    def stiffness_options(self: Self) -> "_1880.BearingStiffnessMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1880", "BearingStiffnessMatrixOption"
        )(value)

    @stiffness_options.setter
    @enforce_parameter_types
    def stiffness_options(self: Self, value: "_1880.BearingStiffnessMatrixOption"):
