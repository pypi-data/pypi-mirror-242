...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.fluid_film import _2188, _2190
...
class PlainGreaseFilledJournalBearing(_2189.PlainJournalBearing):
    """PlainGreaseFilledJournalBearing
    ...
    @property
    def housing_type(self: Self) -> "_2188.PlainGreaseFilledJournalBearingHousingType":
    ...
    def housing_type(
        self: Self, value: "_2188.PlainGreaseFilledJournalBearingHousingType"
    ):
    ...
    @property
    def housing_detail(self: Self) -> "_2190.PlainJournalHousing":
