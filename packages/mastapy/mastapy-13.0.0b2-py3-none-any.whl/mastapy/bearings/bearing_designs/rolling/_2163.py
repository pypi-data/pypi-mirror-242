...
from mastapy.bearings import _1890, _1868, _1869, _1893
from mastapy.bearings.bearing_designs.rolling import _2149, _2150, _2156, _2173
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1870, _1867
...
class RollingBearing(_2129.DetailedBearing):
    """RollingBearing
    ...
    @arrangement.setter
    @enforce_parameter_types
    def arrangement(self: Self, value: "_1890.RollingBearingArrangement"):
    ...
    @enforce_parameter_types
    def basic_dynamic_load_rating_calculation(
        self: Self, value: "_1868.BasicDynamicLoadRatingCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def basic_static_load_rating_calculation(
        self: Self, value: "_1869.BasicStaticLoadRatingCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def cage_bridge_shape(self: Self) -> "_2145.CageBridgeShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2145", "CageBridgeShape"
        )(value)

    @cage_bridge_shape.setter
    @enforce_parameter_types
    def cage_bridge_shape(self: Self, value: "_2145.CageBridgeShape"):
    ...
    @property
    def cage_material(self: Self) -> "_1870.BearingCageMaterial":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1870", "BearingCageMaterial"
        )(value)

    @cage_material.setter
    @enforce_parameter_types
    def cage_material(self: Self, value: "_1870.BearingCageMaterial"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def catalogue(self: Self) -> "_1867.BearingCatalog":
        ...
        return constructor.new_from_mastapy("mastapy.bearings._1867", "BearingCatalog")(
            value
        )
    ...
    def diameter_series(
        self: Self,
        value: "Union[_2149.DiameterSeries, Tuple[_2149.DiameterSeries, bool]]",
    ):
    ...
    @enforce_parameter_types
    def fatigue_load_limit_calculation_method(
        self: Self, value: "_2150.FatigueLoadLimitCalculationMethodEnum"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def height_series(
        self: Self, value: "Union[_2156.HeightSeries, Tuple[_2156.HeightSeries, bool]]"
    ):
    ...
    @enforce_parameter_types
    def inner_race_type(self: Self, value: "_1893.RollingBearingRaceType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def outer_race_type(self: Self, value: "_1893.RollingBearingRaceType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
            enum_with_selected_value.EnumWithSelectedValue_RollingBearingRaceType.implicit_type()
        )
    ...
    @property
    def sleeve_type(self: Self) -> "_2166.SleeveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_designs.rolling._2166", "SleeveType"
        )(value)
    ...
    @property
    def type_information(self: Self) -> "_2144.BearingTypeExtraInformation":
    ...
    @enforce_parameter_types
    def width_series(
        self: Self, value: "Union[_2173.WidthSeries, Tuple[_2173.WidthSeries, bool]]"
    ):
    ...
    @property
    def element_material(self: Self) -> "_243.BearingMaterial":
    ...
    @property
    def geometric_constants(self: Self) -> "_2153.GeometricConstants":
    ...
    @property
    def iso153122018(self: Self) -> "_1975.ISO153122018Results":
    ...
    @property
    def inner_ring_material(self: Self) -> "_243.BearingMaterial":
        """mastapy.materials.BearingMaterial
    ...
    @property
    def outer_ring_material(self: Self) -> "_243.BearingMaterial":
        """mastapy.materials.BearingMaterial
    ...
    @property
    def protection(self: Self) -> "_2141.BearingProtection":
