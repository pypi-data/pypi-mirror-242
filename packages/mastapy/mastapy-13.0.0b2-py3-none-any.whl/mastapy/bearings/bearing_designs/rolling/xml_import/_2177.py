...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_designs.rolling.xml_import import _2175, _2174
...
class XmlBearingTypeMapping(_0.APIBase):
    ...
    @property
    def files(self: Self) -> "List[_2175.BearingImportFile]":
    ...
    @property
    def variables(self: Self) -> "List[_2174.AbstractXmlVariableAssignment]":
