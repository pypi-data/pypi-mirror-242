...
if TYPE_CHECKING:
    from mastapy.bearings.roller_bearing_profiles import _1925, _1927, _1937
...
class RollerBearingUserSpecifiedProfile(_1934.RollerBearingProfile):
    """RollerBearingUserSpecifiedProfile
    ...
    class _Cast_RollerBearingUserSpecifiedProfile:
        ...
        def roller_bearing_profile(
            ...
            return self._parent._cast(_1934.RollerBearingProfile)
    ...
    @property
    def data_to_use(self: Self) -> "_1925.ProfileDataToUse":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.roller_bearing_profiles._1925", "ProfileDataToUse"
        )(value)

    @data_to_use.setter
    @enforce_parameter_types
    def data_to_use(self: Self, value: "_1925.ProfileDataToUse"):
    ...
    @property
    def profile_to_fit(self: Self) -> "_1927.ProfileToFit":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.roller_bearing_profiles._1927", "ProfileToFit"
        )(value)

    @profile_to_fit.setter
    @enforce_parameter_types
    def profile_to_fit(self: Self, value: "_1927.ProfileToFit"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def points(self: Self) -> "List[_1937.UserSpecifiedProfilePoint]":
