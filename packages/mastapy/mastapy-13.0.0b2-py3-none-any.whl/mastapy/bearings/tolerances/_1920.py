...
from mastapy.bearings.tolerances import _1908, _1921, _1907
...
class SupportTolerance(_1907.InterferenceTolerance):
    """SupportTolerance
    ...
    def tolerance_band_designation(self: Self, value: "_1908.ITDesignation"):
    ...
    @enforce_parameter_types
    def tolerance_deviation_class(
        self: Self, value: "_1921.SupportToleranceLocationDesignation"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
