...
class ShaftSectionEndDamageResults(_0.APIBase):
    ...
    @property
    def sn_curve(self: Self) -> "_279.SNCurve":
    ...
    @property
    def sn_curve_axial(self: Self) -> "_279.SNCurve":
        """mastapy.materials.SNCurve
    ...
    @property
    def sn_curve_bending_x(self: Self) -> "_279.SNCurve":
        """mastapy.materials.SNCurve
    ...
    @property
    def sn_curve_bending_y(self: Self) -> "_279.SNCurve":
        """mastapy.materials.SNCurve
    ...
    @property
    def sn_curve_torsional(self: Self) -> "_279.SNCurve":
        """mastapy.materials.SNCurve
