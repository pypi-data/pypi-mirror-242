...
class TwodimensionalFunctionLookupTable(
    _1564.LookupTableBase["TwodimensionalFunctionLookupTable"]
):
    """TwodimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: Self) -> "_1563.GriddedSurfaceAccessor":
    ...
    def lookup_table(self: Self, value: "_1563.GriddedSurfaceAccessor"):
