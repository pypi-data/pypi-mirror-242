...
if TYPE_CHECKING:
    from mastapy.math_utility.optimisation import _1549, _1545, _1546
...
class ParetoOptimisationStrategy(_1827.NamedDatabaseItem):
    """ParetoOptimisationStrategy
    ...
    @property
    def charts(self: Self) -> "List[_1549.ParetoOptimisationStrategyChartInformation]":
    ...
    @property
    def inputs(self: Self) -> "List[_1545.ParetoOptimisationInput]":
    ...
    @property
    def outputs(self: Self) -> "List[_1546.ParetoOptimisationOutput]":
