...
class ForceAndDisplacementResults(_1557.AbstractForceAndDisplacementResults):
    """ForceAndDisplacementResults
    ...
    class _Cast_ForceAndDisplacementResults:
        ...
        def abstract_force_and_displacement_results(
            ...
            return self._parent._cast(_1557.AbstractForceAndDisplacementResults)
    ...
    @property
    def displacement(self: Self) -> "_1562.VectorWithLinearAndAngularComponents":
