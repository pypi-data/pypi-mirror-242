...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1459, _1458, _1451
...
class CycloidalAssemblyDesign(_0.APIBase):
    ...
    @property
    def ring_pins(self: Self) -> "_1459.RingPinsDesign":
    ...
    @property
    def disc_phases(self: Self) -> "List[_1458.NamedDiscPhase]":
    ...
    @property
    def discs(self: Self) -> "List[_1451.CycloidalDiscDesign]":
