...
class ElmerResultsViewable(_0.APIBase):
    ...
    class _Cast_ElmerResultsViewable:
        ...
        def electric_machine_mechanical_results_viewable(
            ...
            return self._parent._cast(_1322.ElectricMachineMechanicalResultsViewable)
        ...
        def electric_machine_results_viewable(
            ...
            return self._parent._cast(_1334.ElectricMachineResultsViewable)
    ...
    @enforce_parameter_types
    def degree_of_freedom(self: Self, value: "_1524.ResultOptionsFor3DVector"):
    ...
    @result_type.setter
    @enforce_parameter_types
    def result_type(self: Self, value: "_172.ElmerResultType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def scaling_draw_style(self: Self) -> "_1849.ScalingDrawStyle":
