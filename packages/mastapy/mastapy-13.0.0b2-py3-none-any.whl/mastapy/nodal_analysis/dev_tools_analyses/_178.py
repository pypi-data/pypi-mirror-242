...
class EigenvalueOptions(_0.APIBase):
    ...
    @property
    def mass_matrix_type(self: Self) -> "_197.MassMatrixType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.nodal_analysis.dev_tools_analyses._197", "MassMatrixType"
        )(value)

    @mass_matrix_type.setter
    @enforce_parameter_types
    def mass_matrix_type(self: Self, value: "_197.MassMatrixType"):
