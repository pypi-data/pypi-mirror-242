...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.dev_tools_analyses import _198, _188
...
class FEModel(_0.APIBase):
    ...
    @property
    def model_splitting_method(self: Self) -> "_198.ModelSplittingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.nodal_analysis.dev_tools_analyses._198", "ModelSplittingMethod"
        )(value)

    @model_splitting_method.setter
    @enforce_parameter_types
    def model_splitting_method(self: Self, value: "_198.ModelSplittingMethod"):
    ...
    @property
    def beam_element_properties(self: Self) -> "List[_208.ElementPropertiesBeam]":
    ...
    @property
    def contact_pairs(self: Self) -> "List[_202.ContactPairReporting]":
    ...
    @property
    def coordinate_systems(self: Self) -> "List[_203.CoordinateSystemReporting]":
    ...
    def interface_element_properties(
        self: Self,
    ) -> "List[_209.ElementPropertiesInterface]":
    ...
    @property
    def mass_element_properties(self: Self) -> "List[_210.ElementPropertiesMass]":
    ...
    @property
    def materials(self: Self) -> "List[_216.MaterialPropertiesReporting]":
    ...
    @property
    def model_parts(self: Self) -> "List[_188.FEModelPart]":
    ...
    @property
    def other_element_properties(self: Self) -> "List[_207.ElementPropertiesBase]":
    ...
    @property
    def rigid_element_properties(self: Self) -> "List[_211.ElementPropertiesRigid]":
    ...
    @property
    def shell_element_properties(self: Self) -> "List[_212.ElementPropertiesShell]":
    ...
    @property
    def solid_element_properties(self: Self) -> "List[_213.ElementPropertiesSolid]":
    ...
    def spring_dashpot_element_properties(
        self: Self,
    ) -> "List[_214.ElementPropertiesSpringDashpot]":
    ...
    def get_all_element_details(self: Self) -> "_206.ElementDetailsForFEModel":
    ...
    def get_all_node_details(self: Self) -> "_217.NodeDetailsForFEModel":
