...
if TYPE_CHECKING:
    from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1232
...
class ElementPropertiesBeam(_215.ElementPropertiesWithMaterial):
    ...
    @property
    def section_type(self: Self) -> "_1232.BeamSectionType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.fe_tools.vis_tools_global.vis_tools_global_enums._1232",
            "BeamSectionType",
        )(value)
