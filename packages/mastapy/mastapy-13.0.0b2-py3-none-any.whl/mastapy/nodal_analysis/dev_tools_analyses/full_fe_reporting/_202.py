...
if TYPE_CHECKING:
    from mastapy.fe_tools.vis_tools_global.vis_tools_global_enums import _1233, _1234
...
class ContactPairReporting(_0.APIBase):
    ...
    def constrained_surface_type(
        ...
        return constructor.new_from_mastapy(
            "mastapy.fe_tools.vis_tools_global.vis_tools_global_enums._1233",
    ...
    @property
    def reference_surface_type(self: Self) -> "_1234.ContactPairReferenceSurfaceType":
