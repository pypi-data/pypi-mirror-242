...
class MeshRequestResult(_0.APIBase):
    ...
    @property
    def cad_face_group(self: Self) -> "_309.CADFaceGroup":
    ...
    @enforce_parameter_types
    def cad_face_group(self: Self, value: "_309.CADFaceGroup"):
    ...
    @property
    def faceted_body(self: Self) -> "_1508.FacetedBody":
    ...
    @faceted_body.setter
    @enforce_parameter_types
    def faceted_body(self: Self, value: "_1508.FacetedBody"):
