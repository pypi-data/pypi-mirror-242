...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.interference_fits import _1440, _1441
...
class InterferenceFitDesign(_1384.DetailedRigidConnectorDesign):
    """InterferenceFitDesign
    ...
    class _Cast_InterferenceFitDesign:
        ...
        def keyed_joint_design(
            ...
            from mastapy.detailed_rigid_connectors.keyed_joints import _1434

            return self._parent._cast(_1434.KeyedJointDesign)
    ...
    @property
    def assembly_method(self: Self) -> "_1440.AssemblyMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1440",
            "AssemblyMethods",
        )(value)

    @assembly_method.setter
    @enforce_parameter_types
    def assembly_method(self: Self, value: "_1440.AssemblyMethods"):
    ...
    @property
    def calculation_method(self: Self) -> "_1441.CalculationMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1441",
            "CalculationMethods",
        )(value)

    @calculation_method.setter
    @enforce_parameter_types
    def calculation_method(self: Self, value: "_1441.CalculationMethods"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.DetailedRigidConnectors.InterferenceFits.CalculationMethods",
        )
    ...
    @enforce_parameter_types
    def joint_interface_type(self: Self, value: "_1445.Table4JointInterfaceTypes"):
