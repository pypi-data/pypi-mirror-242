...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1408, _1399
...
class DIN5480SplineHalfDesign(_1416.StandardSplineHalfDesign):
    """DIN5480SplineHalfDesign
    ...
    class _Cast_DIN5480SplineHalfDesign:
        ...
        def standard_spline_half_design(
            ...
            return self._parent._cast(_1416.StandardSplineHalfDesign)
    ...
    @property
    def finishing_method(self: Self) -> "_1408.FinishingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1408", "FinishingMethods"
        )(value)

    @finishing_method.setter
    @enforce_parameter_types
    def finishing_method(self: Self, value: "_1408.FinishingMethods"):
    ...
    @property
    def manufacturing_type(self: Self) -> "_1399.ManufacturingTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1399", "ManufacturingTypes"
        )(value)

    @manufacturing_type.setter
    @enforce_parameter_types
    def manufacturing_type(self: Self, value: "_1399.ManufacturingTypes"):
        value = conversion.mp_to_pn_enum(
