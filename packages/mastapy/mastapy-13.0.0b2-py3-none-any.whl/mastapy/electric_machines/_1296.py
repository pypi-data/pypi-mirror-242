...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1297, _1303
...
class Stator(_1241.AbstractStator):
    """Stator
    ...
    def stator_cut_out_specifications(
        self: Self,
    ) -> "List[_1297.StatorCutOutSpecification]":
    ...
    @property
    def tooth_and_slot(self: Self) -> "_1303.ToothAndSlot":
