...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1332, _1324, _1326, _1328
...
class ElectricMachineResults(_0.APIBase):
    ...
    class _Cast_ElectricMachineResults:
        ...
        def on_load_electric_machine_results(
            ...
            return self._parent._cast(_1341.OnLoadElectricMachineResults)
        ...
        def open_circuit_electric_machine_results(
            ...
            return self._parent._cast(_1342.OpenCircuitElectricMachineResults)
    ...
    @property
    def results_timesteps(self: Self) -> "List[_1332.ElectricMachineResultsTimeStep]":
    ...
    def results_for_conductor_turns(
        self: Self,
    ) -> "List[_1324.ElectricMachineResultsForConductorTurn]":
    ...
    def results_for_line_to_line(
        self: Self,
    ) -> "List[_1326.ElectricMachineResultsForLineToLine]":
    ...
    @property
    def results_for_phases(self: Self) -> "List[_1328.ElectricMachineResultsForPhase]":
