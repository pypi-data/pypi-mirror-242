...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1363, _1360
...
class OnLoadElectricMachineResults(_1323.ElectricMachineResults):
    """OnLoadElectricMachineResults
    ...
    class _Cast_OnLoadElectricMachineResults:
        ...
        def electric_machine_results(
            ...
            return self._parent._cast(_1323.ElectricMachineResults)
    ...
    @property
    def motoring_or_generating(self: Self) -> "_1363.MotoringOrGenerating":
    ...
    @property
    def power_factor_direction(self: Self) -> "_1360.LeadingOrLagging":
    ...
    @property
    def windings(self: Self) -> "_1313.Windings":
