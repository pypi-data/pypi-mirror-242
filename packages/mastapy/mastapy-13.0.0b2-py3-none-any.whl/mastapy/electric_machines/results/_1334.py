...
from mastapy.electric_machines import _1292, _1289
...
if TYPE_CHECKING:
    from mastapy.electric_machines.results import _1335
...
class ElectricMachineResultsViewable(_171.ElmerResultsViewable):
    ...
    @property
    def force_view_options(self: Self) -> "_1335.ElectricMachineForceViewOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines.results._1335", "ElectricMachineForceViewOptions"
        )(value)

    @force_view_options.setter
    @enforce_parameter_types
    def force_view_options(self: Self, value: "_1335.ElectricMachineForceViewOptions"):
    ...
    @results.setter
    @enforce_parameter_types
    def results(self: Self, value: "_1323.ElectricMachineResults"):
        wrapper_type = (
    ...
    @property
    def parts_to_view(self: Self) -> "List[_1841.EnumWithBoolean[_1289.RegionID]]":
