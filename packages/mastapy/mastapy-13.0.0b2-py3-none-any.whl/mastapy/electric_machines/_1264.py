...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1306, _1258
...
class ElectricMachineSetup(_0.APIBase):
    ...
    def two_d_fe_model_for_electro_magnetic_analysis(
        self: Self,
    ) -> "_1306.TwoDimensionalFEModelForAnalysis[_1262.ElectricMachineMeshingOptions]":
    ...
    @property
    def eccentricity(self: Self) -> "_1258.Eccentricity":
