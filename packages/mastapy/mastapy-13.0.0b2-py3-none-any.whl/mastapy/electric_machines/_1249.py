...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1271, _1309
...
class CADToothAndSlot(_1242.AbstractToothAndSlot):
    """CADToothAndSlot
    ...
    def individual_conductor_specification_source(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1271", "IndividualConductorSpecificationSource"
        )(value)

    @individual_conductor_specification_source.setter
    @enforce_parameter_types
    def individual_conductor_specification_source(
        self: Self, value: "_1271.IndividualConductorSpecificationSource"
    ):
