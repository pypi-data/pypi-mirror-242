...
class ElectricMachineLoadCaseGroup(_0.APIBase):
    ...
    @property
    def dynamic_forces_load_cases(self: Self) -> "List[_1345.DynamicForceLoadCase]":
    ...
    def dynamic_forces_load_cases_without_non_linear_dq_model(
        self: Self,
    ) -> "List[_1343.BasicDynamicForceLoadCase]":
    ...
    @property
    def efficiency_map_load_cases(self: Self) -> "List[_1348.EfficiencyMapLoadCase]":
    ...
    def single_operating_point_load_cases_with_non_linear_dq_model(
        self: Self,
    ) -> "List[_1373.SpeedTorqueLoadCase]":
    ...
    def single_operating_point_load_cases_without_non_linear_dq_model(
        self: Self,
    ) -> "List[_1355.ElectricMachineLoadCase]":
    ...
    def speed_torque_curve_load_cases(
        self: Self,
    ) -> "List[_1372.SpeedTorqueCurveLoadCase]":
    ...
    @enforce_parameter_types
    def add_load_case(
        self: Self, load_case_type: "_1361.LoadCaseType"
    ...
    def add_load_case_named(
        self: Self, load_case_type: "_1361.LoadCaseType", name: "str"
    ) -> "_1356.ElectricMachineLoadCaseBase":
        """mastapy.electric_machines.load_cases_and_analyses.ElectricMachineLoadCaseBase
    ...
    def perform_compound_analysis(
        self: Self,
        setup: "_1264.ElectricMachineSetup",
        load_case_type: "_1361.LoadCaseType",
    ) -> "_1588.MethodOutcome":
    ...
    def perform_compound_analysis_with_progress(
        ...
        setup: "_1264.ElectricMachineSetup",
        load_case_type: "_1361.LoadCaseType",
        task_progress: "_7556.TaskProgress",
    ) -> "_1588.MethodOutcome":
        """mastapy.utility.MethodOutcome
    ...
    def try_remove_load_case(
        self: Self, load_case: "_1356.ElectricMachineLoadCaseBase"
    ) -> "bool":
        """bool
