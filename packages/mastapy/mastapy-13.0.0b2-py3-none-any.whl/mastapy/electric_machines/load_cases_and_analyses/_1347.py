...
if TYPE_CHECKING:
    from mastapy.electric_machines.results import _1319
...
class EfficiencyMapAnalysis(_1349.ElectricMachineAnalysis):
    """EfficiencyMapAnalysis
    ...
    @property
    def efficiency_map_results(self: Self) -> "_1319.EfficiencyResults":
    ...
    @property
    def load_case(self: Self) -> "_1348.EfficiencyMapLoadCase":
