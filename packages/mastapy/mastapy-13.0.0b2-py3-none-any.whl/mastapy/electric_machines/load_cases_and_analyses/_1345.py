...
from mastapy.electric_machines.load_cases_and_analyses import _1369, _1343
...
class DynamicForceLoadCase(_1343.BasicDynamicForceLoadCase):
    """DynamicForceLoadCase
    ...
    class _Cast_DynamicForceLoadCase:
        ...
        def electric_machine_load_case_base(
            ...
            return self._parent._cast(_1356.ElectricMachineLoadCaseBase)
    ...
    @property
    def control_strategy(self: Self) -> "_1351.ElectricMachineControlStrategy":
    ...
    def control_strategy(self: Self, value: "_1351.ElectricMachineControlStrategy"):
    ...
    @enforce_parameter_types
    def load_specification(self: Self, value: "_1369.SpecifyTorqueOrCurrent"):
    ...
    @enforce_parameter_types
    def operating_points_specification_method(
        self: Self, value: "_1366.OperatingPointsSpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.OperatingPointsSpecificationMethod",
    ...
    @property
    def speed_points_distribution(self: Self) -> "_1370.SpeedPointsDistribution":
    ...
    @enforce_parameter_types
    def speed_points_distribution(self: Self, value: "_1370.SpeedPointsDistribution"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.SpeedPointsDistribution",
        )
