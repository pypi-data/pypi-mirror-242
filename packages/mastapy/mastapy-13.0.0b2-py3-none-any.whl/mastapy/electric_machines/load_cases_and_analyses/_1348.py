...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1352, _1347
...
class EfficiencyMapLoadCase(_1364.NonLinearDQModelMultipleOperatingPointsLoadCase):
    """EfficiencyMapLoadCase
