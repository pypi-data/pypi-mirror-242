...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1351, _1369, _1350
...
class SpeedTorqueLoadCase(_1355.ElectricMachineLoadCase):
    """SpeedTorqueLoadCase
    ...
    @property
    def load_specification(self: Self) -> "_1369.SpecifyTorqueOrCurrent":
