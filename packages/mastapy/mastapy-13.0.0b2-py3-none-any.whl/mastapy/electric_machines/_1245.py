...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines import _1247, _1248
...
class CADElectricMachineDetail(_1259.ElectricMachineDetail):
    """CADElectricMachineDetail
    ...
    @property
    def rotor(self: Self) -> "_1247.CADRotor":
    ...
    @property
    def stator(self: Self) -> "_1248.CADStator":
