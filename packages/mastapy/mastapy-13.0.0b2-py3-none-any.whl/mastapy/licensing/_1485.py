...
if TYPE_CHECKING:
    from mastapy.licensing import _7569, _7570, _7571
...
class LicenceServer:
    ...
    @staticmethod
    @enforce_parameter_types
    def update_server_settings(server_details: "_7569.LicenceServerDetails"):
    ...
    @staticmethod
    def get_server_settings() -> "_7569.LicenceServerDetails":
    ...
    @staticmethod
    def get_licensed_module_details() -> "Iterable[_7570.ModuleDetails]":
    ...
    @staticmethod
    def get_available_module_details() -> "Iterable[_7570.ModuleDetails]":
        """Iterable[mastapy.licensing.ModuleDetails]"""
        return conversion.pn_to_mp_objects_in_iterable(
    ...
    @staticmethod
    def get_requested_module_statuses() -> "Iterable[_7571.ModuleLicenceStatus]":
