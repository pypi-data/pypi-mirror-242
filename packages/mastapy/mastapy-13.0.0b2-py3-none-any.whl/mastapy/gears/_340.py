...
class PocketingPowerLossCoefficients(_1827.NamedDatabaseItem):
    """PocketingPowerLossCoefficients
    ...
    def extrapolation_options(self: Self, value: "_1507.ExtrapolationOptions"):
    ...
    def specifications_for_the_effect_of_oil_kinematic_viscosity(
        self: Self,
    ) -> "List[_344.SpecificationForTheEffectOfOilKinematicViscosity]":
