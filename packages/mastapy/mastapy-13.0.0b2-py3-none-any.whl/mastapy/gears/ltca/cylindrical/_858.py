...
class CylindricalGearSetLoadDistributionAnalysis(_844.GearSetLoadDistributionAnalysis):
    """CylindricalGearSetLoadDistributionAnalysis
    ...
    @property
    def tiff_analysis(self: Self) -> "_894.CylindricalGearSetTIFFAnalysis":
    ...
    @property
    def meshes(self: Self) -> "List[_855.CylindricalGearMeshLoadDistributionAnalysis]":
