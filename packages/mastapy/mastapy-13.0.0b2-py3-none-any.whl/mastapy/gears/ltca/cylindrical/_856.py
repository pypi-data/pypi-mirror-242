...
class CylindricalGearMeshLoadedContactLine(_841.GearMeshLoadedContactLine):
    """CylindricalGearMeshLoadedContactLine
    ...
    class _Cast_CylindricalGearMeshLoadedContactLine:
        ...
        def gear_mesh_loaded_contact_line(
            ...
            return self._parent._cast(_841.GearMeshLoadedContactLine)
    ...
    def loaded_contact_strip_end_points(
        self: Self,
    ) -> "List[_857.CylindricalGearMeshLoadedContactPoint]":
