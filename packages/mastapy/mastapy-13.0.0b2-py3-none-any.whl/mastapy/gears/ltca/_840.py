...
if TYPE_CHECKING:
    from mastapy.gears.ltca import _847, _841
...
class GearMeshLoadDistributionAtRotation(_0.APIBase):
    ...
    class _Cast_GearMeshLoadDistributionAtRotation:
        ...
        def cylindrical_mesh_load_distribution_at_rotation(
            ...
            return self._parent._cast(_859.CylindricalMeshLoadDistributionAtRotation)
        ...
        def conical_mesh_load_distribution_at_rotation(
            ...
            return self._parent._cast(_869.ConicalMeshLoadDistributionAtRotation)
    ...
    @property
    def loaded_contact_lines(self: Self) -> "List[_841.GearMeshLoadedContactLine]":
    ...
    def meshed_gears(
        self: Self,
    ) -> "List[_847.MeshedGearLoadDistributionAnalysisAtRotation]":
