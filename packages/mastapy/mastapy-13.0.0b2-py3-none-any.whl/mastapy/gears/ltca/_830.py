...
if TYPE_CHECKING:
    ...
    from mastapy.gears.cylindrical import _1209, _1208, _1207, _1206
...
class CylindricalMeshedGearLoadDistributionAnalysis(_0.APIBase):
    ...
    @property
    def contact_charts(self: Self) -> "List[_1207.CylindricalGearLTCAContactCharts]":
    ...
    def contact_charts_as_text_files(
        self: Self,
    ) -> "List[_1206.CylindricalGearLTCAContactChartDataAsTextFile]":
    ...
    def contact_patch_as_text(
        self: Self,
        result_type: "_825.ContactResultType",
