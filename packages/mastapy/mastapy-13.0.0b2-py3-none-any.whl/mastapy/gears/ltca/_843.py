...
if TYPE_CHECKING:
    from mastapy.gears.ltca import _836, _837
...
class GearRootFilletStressResults(_0.APIBase):
    ...
    class _Cast_GearRootFilletStressResults:
        ...
        def conical_gear_root_fillet_stress_results(
            ...
            return self._parent._cast(_824.ConicalGearRootFilletStressResults)
        ...
        def cylindrical_gear_root_fillet_stress_results(
            ...
            return self._parent._cast(_829.CylindricalGearRootFilletStressResults)
    ...
    @property
    def columns(self: Self) -> "List[_836.GearFilletNodeStressResultsColumn]":
    ...
    @property
    def rows(self: Self) -> "List[_837.GearFilletNodeStressResultsRow]":
