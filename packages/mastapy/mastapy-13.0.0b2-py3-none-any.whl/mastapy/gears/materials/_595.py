...
class ISOCylindricalGearMaterial(_589.CylindricalGearMaterial):
    """ISOCylindricalGearMaterial
    ...
    @property
    def quality_grade(self: Self) -> "_276.QualityGrade":
        ...
        return constructor.new_from_mastapy("mastapy.materials._276", "QualityGrade")(
            value
        )

    @quality_grade.setter
    @enforce_parameter_types
    def quality_grade(self: Self, value: "_276.QualityGrade"):
