...
class AGMACylindricalGearMaterial(_589.CylindricalGearMaterial):
    """AGMACylindricalGearMaterial
    ...
    @property
    def grade(self: Self) -> "_240.AGMAMaterialGrade":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._240", "AGMAMaterialGrade"
        )(value)

    @grade.setter
    @enforce_parameter_types
    def grade(self: Self, value: "_240.AGMAMaterialGrade"):
    ...
    @property
    def material_application(self: Self) -> "_238.AGMAMaterialApplications":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._238", "AGMAMaterialApplications"
        )(value)

    @material_application.setter
    @enforce_parameter_types
    def material_application(self: Self, value: "_238.AGMAMaterialApplications"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def material_class(self: Self) -> "_239.AGMAMaterialClasses":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._239", "AGMAMaterialClasses"
        )(value)

    @material_class.setter
    @enforce_parameter_types
    def material_class(self: Self, value: "_239.AGMAMaterialClasses"):
        value = conversion.mp_to_pn_enum(
