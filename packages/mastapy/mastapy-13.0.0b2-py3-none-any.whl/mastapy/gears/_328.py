...
class GearSetOptimisationResult(_0.APIBase):
    ...
    @property
    def gear_set(self: Self) -> "_948.GearSetDesign":
    ...
    @property
    def optimisation_history(self: Self) -> "_1541.OptimisationHistory":
    ...
    def optimisation_history(self: Self, value: "_1541.OptimisationHistory"):
        self.wrapped.OptimisationHistory = value.wrapped

    @property
    def rating(self: Self) -> "_353.AbstractGearSetRating":
