...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.cylindrical import _632, _633
...
class CylindricalGearSpecifiedMicroGeometry(_0.APIBase):
    ...
    @property
    def lead_micro_geometry(self: Self) -> "_632.MicroGeometryInputsLead":
    ...
    @property
    def profile_micro_geometry(self: Self) -> "List[_633.MicroGeometryInputsProfile]":
