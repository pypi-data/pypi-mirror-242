...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _640
...
class ShaverPointCalculationError(_640.CalculationError):
    """ShaverPointCalculationError
    ...
    class _Cast_ShaverPointCalculationError:
        ...
        def calculation_error(
            ...
            return self._parent._cast(_640.CalculationError)
