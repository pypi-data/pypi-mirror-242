...
class PlungeShaverCalculationInputs(_0.APIBase):
    ...
    @property
    def shaver_hand(self: Self) -> "_331.Hand":
        """mastapy.gears.Hand"""
    ...
    @shaver_hand.setter
    @enforce_parameter_types
    def shaver_hand(self: Self, value: "_331.Hand"):
    ...
    @property
    def input_gear_geometry(self: Self) -> "_730.CylindricalCutterSimulatableGear":
    ...
    @property
    def tooth_thickness(self: Self) -> "_1084.ToothThicknessSpecificationBase":
