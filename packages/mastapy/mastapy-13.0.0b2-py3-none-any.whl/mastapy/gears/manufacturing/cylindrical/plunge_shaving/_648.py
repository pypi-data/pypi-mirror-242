...
from mastapy.gears.manufacturing.cylindrical.plunge_shaving import _643, _644
...
class PlungeShaverInputsAndMicroGeometry(_0.APIBase):
    ...
    @enforce_parameter_types
    def micro_geometry_source(self: Self, value: "_644.MicroGeometryDefinitionType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def points_of_interest_left_flank(self: Self) -> "List[_651.PointOfInterest]":
    ...
    @property
    def points_of_interest_right_flank(self: Self) -> "List[_651.PointOfInterest]":
        """List[mastapy.gears.manufacturing.cylindrical.plunge_shaving.PointOfInterest]
