...
T = TypeVar("T", bound="_634.ModificationSegment")
...
class MicroGeometryInputs(_0.APIBase, Generic[T]):
    ...
    class _Cast_MicroGeometryInputs:
        ...
        def micro_geometry_inputs_lead(
            ...
            return self._parent._cast(_632.MicroGeometryInputsLead)
        ...
        def micro_geometry_inputs_profile(
            ...
            return self._parent._cast(_633.MicroGeometryInputsProfile)
