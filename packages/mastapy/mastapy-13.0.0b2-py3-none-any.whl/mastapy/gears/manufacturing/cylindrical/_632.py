...
class MicroGeometryInputsLead(_631.MicroGeometryInputs["_630.LeadModificationSegment"]):
    """MicroGeometryInputsLead
    ...
    class _Cast_MicroGeometryInputsLead:
        ...
        def micro_geometry_inputs(
            ...
            return self._parent._cast(_631.MicroGeometryInputs)
    ...
    @property
    def lead_micro_geometry_range(self: Self) -> "_1486.Range":
