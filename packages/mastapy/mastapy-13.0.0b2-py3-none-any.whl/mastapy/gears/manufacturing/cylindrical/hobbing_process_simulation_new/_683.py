...
class ProcessSimulationInput(_0.APIBase):
    ...
    class _Cast_ProcessSimulationInput:
        ...
        def hobbing_process_simulation_input(
            ...
            return self._parent._cast(_670.HobbingProcessSimulationInput)
        ...
        def worm_grinding_process_simulation_input(
            ...
            return self._parent._cast(_697.WormGrindingProcessSimulationInput)
    ...
    @property
    def analysis_setting(self: Self) -> "_657.AnalysisMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new._657",
            "AnalysisMethod",
        )(value)

    @analysis_setting.setter
    @enforce_parameter_types
    def analysis_setting(self: Self, value: "_657.AnalysisMethod"):
    ...
    @enforce_parameter_types
    def centre_distance_offset_specification_method(
        self: Self, value: "_661.CentreDistanceOffsetMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Manufacturing.Cylindrical.HobbingProcessSimulationNew.CentreDistanceOffsetMethod",
    ...
    @property
    def cutter_head_slide_error(self: Self) -> "_662.CutterHeadSlideError":
    ...
    @property
    def cutter_mounting_error(self: Self) -> "_688.RackMountingError":
    ...
    @property
    def gear_mounting_error(self: Self) -> "_663.GearMountingError":
