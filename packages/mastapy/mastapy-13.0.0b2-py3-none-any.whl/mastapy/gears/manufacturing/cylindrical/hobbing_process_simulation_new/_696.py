...
class WormGrindingProcessProfileCalculation(_692.WormGrindingProcessCalculation):
    """WormGrindingProcessProfileCalculation
    ...
    @property
    def left_flank(self: Self) -> "_660.CalculateProfileDeviationAccuracy":
    ...
    @property
    def right_flank(self: Self) -> "_660.CalculateProfileDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculateProfileDeviationAccuracy
