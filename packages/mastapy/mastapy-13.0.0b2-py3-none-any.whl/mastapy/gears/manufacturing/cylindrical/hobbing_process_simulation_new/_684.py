...
T = TypeVar("T", bound="_683.ProcessSimulationInput")
...
class ProcessSimulationNew(_0.APIBase, Generic[T]):
    ...
    class _Cast_ProcessSimulationNew:
        ...
        def hobbing_process_simulation_new(
            ...
            return self._parent._cast(_671.HobbingProcessSimulationNew)
        ...
        def worm_grinding_process_simulation_new(
            ...
            return self._parent._cast(_698.WormGrindingProcessSimulationNew)
    ...
    @property
    def gear_tooth_shape_calculation(self: Self) -> "_679.ProcessGearShape":
    ...
    @property
    def lead_calculation(self: Self) -> "_680.ProcessLeadCalculation":
    ...
    @property
    def pitch_calculation(self: Self) -> "_681.ProcessPitchCalculation":
    ...
    @property
    def profile_calculation(self: Self) -> "_682.ProcessProfileCalculation":
