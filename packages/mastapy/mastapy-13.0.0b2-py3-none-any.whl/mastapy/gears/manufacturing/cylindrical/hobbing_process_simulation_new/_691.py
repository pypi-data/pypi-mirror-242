...
class WormGrindingLeadCalculation(_692.WormGrindingProcessCalculation):
    """WormGrindingLeadCalculation
    ...
    @property
    def left_flank(self: Self) -> "_658.CalculateLeadDeviationAccuracy":
    ...
    @property
    def right_flank(self: Self) -> "_658.CalculateLeadDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculateLeadDeviationAccuracy
