...
class WormGrindingCutterCalculation(_692.WormGrindingProcessCalculation):
    """WormGrindingCutterCalculation
    ...
    @property
    def grinder_tooth_shape_chart(self: Self) -> "_1865.TwoDChartDefinition":
    ...
    @property
    def input_gear_point_of_interest(self: Self) -> "_651.PointOfInterest":
