...
class HobbingProcessSimulationInput(_683.ProcessSimulationInput):
    """HobbingProcessSimulationInput
    ...
    class _Cast_HobbingProcessSimulationInput:
        ...
        def process_simulation_input(
            ...
            return self._parent._cast(_683.ProcessSimulationInput)
    ...
    def process_method(self: Self, value: "_656.ActiveProcessMethod"):
    ...
    @property
    def hob_manufacture_error(self: Self) -> "_674.HobManufactureError":
    ...
    @property
    def hob_resharpening_error(self: Self) -> "_675.HobResharpeningError":
