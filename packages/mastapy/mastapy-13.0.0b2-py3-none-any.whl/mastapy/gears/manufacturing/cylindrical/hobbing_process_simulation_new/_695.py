...
class WormGrindingProcessPitchCalculation(_692.WormGrindingProcessCalculation):
    """WormGrindingProcessPitchCalculation
    ...
    @property
    def pitch_modification_chart(self: Self) -> "_1865.TwoDChartDefinition":
    ...
    @property
    def left_flank(self: Self) -> "_659.CalculatePitchDeviationAccuracy":
    ...
    @property
    def right_flank(self: Self) -> "_659.CalculatePitchDeviationAccuracy":
        """mastapy.gears.manufacturing.cylindrical.hobbing_process_simulation_new.CalculatePitchDeviationAccuracy
