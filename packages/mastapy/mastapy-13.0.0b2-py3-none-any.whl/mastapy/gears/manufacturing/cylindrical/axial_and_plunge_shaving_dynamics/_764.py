...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _730
...
class ShavingDynamicsCalculation(_0.APIBase, Generic[T]):
    ...
    class _Cast_ShavingDynamicsCalculation:
        ...
        def shaving_dynamics_calculation_for_designed_gears(
            ...
            return self._parent._cast(_765.ShavingDynamicsCalculationForDesignedGears)
        ...
        def shaving_dynamics_calculation_for_hobbed_gears(
            ...
            return self._parent._cast(_766.ShavingDynamicsCalculationForHobbedGears)
    ...
    @property
    def accuracy_level_iso6(self: Self) -> "_760.RollAngleRangeRelativeToAccuracy":
    ...
    @property
    def accuracy_level_iso7(self: Self) -> "_760.RollAngleRangeRelativeToAccuracy":
        """mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics.RollAngleRangeRelativeToAccuracy
    ...
    @property
    def designed_gear(self: Self) -> "_730.CylindricalCutterSimulatableGear":
    ...
    @property
    def life_shaver(self: Self) -> "_713.CylindricalGearShaver":
    ...
    @property
    def shaver(self: Self) -> "_713.CylindricalGearShaver":
        """mastapy.gears.manufacturing.cylindrical.cutters.CylindricalGearShaver
