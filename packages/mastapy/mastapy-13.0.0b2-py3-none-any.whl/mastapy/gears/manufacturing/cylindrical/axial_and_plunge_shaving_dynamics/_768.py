...
T = TypeVar("T", bound="_763.ShavingDynamics")


class ShavingDynamicsViewModel(_769.ShavingDynamicsViewModelBase, Generic[T]):
    """ShavingDynamicsViewModel
    ...
    class _Cast_ShavingDynamicsViewModel:
        ...
        def shaving_dynamics_view_model_base(
            ...
            return self._parent._cast(_769.ShavingDynamicsViewModelBase)
        ...
        def gear_manufacturing_configuration_view_model(
            ...
            return self._parent._cast(_626.GearManufacturingConfigurationViewModel)
        ...
        def conventional_shaving_dynamics_view_model(
            ...
            return self._parent._cast(_752.ConventionalShavingDynamicsViewModel)
        ...
        def plunge_shaving_dynamics_view_model(
            ...
            return self._parent._cast(_758.PlungeShavingDynamicsViewModel)
    ...
    def active_profile_range_calculation_source(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.manufacturing.cylindrical.axial_and_plunge_shaving_dynamics._747",
    ...
    def active_profile_range_calculation_source(
        self: Self, value: "_747.ActiveProfileRangeCalculationSource"
    ):
    ...
    @property
    def redressing_chart(self: Self) -> "_1865.TwoDChartDefinition":
    ...
    @enforce_parameter_types
    def selected_measurement_method(self: Self, value: "_1077.ThicknessType"):
    ...
    @property
    def calculation(self: Self) -> "_764.ShavingDynamicsCalculation[T]":
    ...
    @property
    def redressing_settings(self: Self) -> "List[_759.RedressingSettings[T]]":
