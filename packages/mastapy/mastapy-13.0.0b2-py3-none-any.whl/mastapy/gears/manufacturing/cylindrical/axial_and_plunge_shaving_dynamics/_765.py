...
class ShavingDynamicsCalculationForDesignedGears(_764.ShavingDynamicsCalculation[T]):
    """ShavingDynamicsCalculationForDesignedGears
    ...
    class _Cast_ShavingDynamicsCalculationForDesignedGears:
        ...
        def shaving_dynamics_calculation(
            ...
            return self._parent._cast(_764.ShavingDynamicsCalculation)
    ...
    @property
    def end_of_shaving_profile(self: Self) -> "_1023.CylindricalGearProfileMeasurement":
    ...
    @property
    def redressing(self: Self) -> "_762.ShaverRedressing[T]":
