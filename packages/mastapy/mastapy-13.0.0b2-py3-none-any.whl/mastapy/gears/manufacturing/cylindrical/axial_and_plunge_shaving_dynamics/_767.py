...
class ShavingDynamicsConfiguration(_0.APIBase):
    ...
    def conventional_shaving_dynamics(
        self: Self,
    ) -> "_764.ShavingDynamicsCalculation[_749.ConventionalShavingDynamics]":
    ...
    def plunge_shaving_dynamics(
        self: Self,
    ) -> "_764.ShavingDynamicsCalculation[_753.PlungeShaverDynamics]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_753.PlungeShaverDynamics](
            temp
        )
