...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.bevel.basic_machine_settings import _822, _821
...
class ConicalMeshFlankManufacturingConfig(_780.ConicalMeshFlankMicroGeometryConfig):
    """ConicalMeshFlankManufacturingConfig
    ...
    class _Cast_ConicalMeshFlankManufacturingConfig:
        ...
        def conical_mesh_flank_micro_geometry_config(
            ...
            return self._parent._cast(_780.ConicalMeshFlankMicroGeometryConfig)
