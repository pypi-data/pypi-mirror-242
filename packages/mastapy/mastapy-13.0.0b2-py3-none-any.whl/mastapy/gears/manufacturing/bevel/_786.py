...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel import _783, _779, _804, _808
    from mastapy.gears.manufacturing.bevel.cutters import _811, _812
...
class ConicalPinionManufacturingConfig(_774.ConicalGearManufacturingConfig):
    """ConicalPinionManufacturingConfig
    ...
    @property
    def mesh_config(self: Self) -> "_783.ConicalMeshManufacturingConfig":
    ...
    @property
    def pinion_finish_cutter(self: Self) -> "_811.PinionFinishCutter":
    ...
    @property
    def pinion_rough_cutter(self: Self) -> "_812.PinionRoughCutter":
    ...
    @property
    def pinion_rough_machine_setting(self: Self) -> "_808.PinionRoughMachineSetting":
