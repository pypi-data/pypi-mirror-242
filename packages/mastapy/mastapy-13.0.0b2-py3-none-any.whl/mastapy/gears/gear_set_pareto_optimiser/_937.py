...
class StraightBevelGearSetParetoOptimiser(_910.GearSetParetoOptimiser):
    """StraightBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_961.StraightBevelGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_961.StraightBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_961.StraightBevelGearSetDesign]":
        """List[mastapy.gears.gear_designs.straight_bevel.StraightBevelGearSetDesign]
