...
class GearSetParetoOptimiser(
    _904.DesignSpaceSearchBase[
        "_353.AbstractGearSetRating", "_909.GearSetOptimiserCandidate"
    ]
):
    """GearSetParetoOptimiser
    ...
    class _Cast_GearSetParetoOptimiser:
        ...
        def design_space_search_base(
            ...
            return self._parent._cast(_904.DesignSpaceSearchBase)
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_948.GearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_948.GearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_948.GearSetDesign]":
        """List[mastapy.gears.gear_designs.GearSetDesign]
