...
if TYPE_CHECKING:
    from mastapy.utility.reporting_property_framework import _1787
    from mastapy.math_utility.optimisation import _1549
    from mastapy.gears.gear_set_pareto_optimiser import _904, _900, _912
...
class ChartInfoBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    class _Cast_ChartInfoBase:
        ...
        def pareto_optimiser_chart_information(
            ...
            return self._parent._cast(_930.ParetoOptimiserChartInformation)
    ...
    @property
    def chart_type(self: Self) -> "_1787.CustomChartType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.reporting_property_framework._1787", "CustomChartType"
        )(value)
    ...
    def select_chart_type(
        self: Self,
    ) -> "_1549.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility.optimisation.ParetoOptimisationStrategyChartInformation._1549",
    ...
    def select_chart_type(
        self: Self,
        value: "_1549.ParetoOptimisationStrategyChartInformation.ScatterOrBarChart",
    ):
    ...
    @property
    def optimiser(self: Self) -> "_904.DesignSpaceSearchBase[TAnalysis, TCandidate]":
    ...
    @property
    def bars(self: Self) -> "List[_900.BarForPareto[TAnalysis, TCandidate]]":
    ...
    def input_sliders(
        self: Self,
    ) -> "List[_912.InputSliderForPareto[TAnalysis, TCandidate]]":
