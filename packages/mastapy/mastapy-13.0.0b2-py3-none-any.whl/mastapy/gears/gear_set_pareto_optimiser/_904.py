...
from mastapy.gears.gear_set_pareto_optimiser import _901
...
if TYPE_CHECKING:
    from mastapy.gears.gear_set_pareto_optimiser import _913, _902, _920, _935
    from mastapy.math_utility.optimisation import _1547, _1544, _1538
...
TAnalysis = TypeVar("TAnalysis", bound="_1215.AbstractGearSetAnalysis")
...
class DesignSpaceSearchBase(_0.APIBase, Generic[TAnalysis, TCandidate]):
    ...
    class _Cast_DesignSpaceSearchBase:
        ...
        def cylindrical_gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_903.CylindricalGearSetParetoOptimiser)
        ...
        def face_gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_906.FaceGearSetParetoOptimiser)
        ...
        def gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_910.GearSetParetoOptimiser)
        ...
        def hypoid_gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_911.HypoidGearSetParetoOptimiser)
        ...
        def micro_geometry_design_space_search(
            ...
            return self._parent._cast(_914.MicroGeometryDesignSpaceSearch)
        ...
        def micro_geometry_gear_set_design_space_search(
            ...
            return self._parent._cast(_917.MicroGeometryGearSetDesignSpaceSearch)
        ...
        def spiral_bevel_gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_936.SpiralBevelGearSetParetoOptimiser)
        ...
        def straight_bevel_gear_set_pareto_optimiser(
            ...
            return self._parent._cast(_937.StraightBevelGearSetParetoOptimiser)
    ...
    @enforce_parameter_types
    def display_candidates(self: Self, value: "_901.CandidateDisplayChoice"):
    ...
    @property
    def remove_candidates_with(self: Self) -> "_913.LargerOrSmaller":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_set_pareto_optimiser._913", "LargerOrSmaller"
        )(value)

    @remove_candidates_with.setter
    @enforce_parameter_types
    def remove_candidates_with(self: Self, value: "_913.LargerOrSmaller"):
    ...
    @property
    def chart_details(self: Self) -> "List[_902.ChartInfoBase[TAnalysis, TCandidate]]":
    ...
    @property
    def filters(self: Self) -> "List[_1544.ParetoOptimisationFilter]":
    ...
    @property
    def input_setters(self: Self) -> "List[_1538.InputSetter[TAnalysis]]":
    ...
    @property
    def optimisation_targets(self: Self) -> "List[_920.OptimisationTarget[TAnalysis]]":
    ...
    def reasons_for_invalid_candidates(
        self: Self,
    ) -> "List[_935.ReasonsForInvalidDesigns]":
