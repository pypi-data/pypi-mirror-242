...
class SpiralBevelGearSetParetoOptimiser(_910.GearSetParetoOptimiser):
    """SpiralBevelGearSetParetoOptimiser
    ...
    @property
    def selected_candidate_geometry(self: Self) -> "_969.SpiralBevelGearSetDesign":
    ...
    @property
    def all_candidate_gear_sets(self: Self) -> "List[_969.SpiralBevelGearSetDesign]":
    ...
    @property
    def candidate_gear_sets(self: Self) -> "List[_969.SpiralBevelGearSetDesign]":
        """List[mastapy.gears.gear_designs.spiral_bevel.SpiralBevelGearSetDesign]
