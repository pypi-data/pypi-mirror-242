...
class GearFEModel(_1219.GearImplementationDetail):
    """GearFEModel
    ...
    @property
    def element_settings(self: Self) -> "_1197.GearMeshingElementOptions":
    ...
    @enforce_parameter_types
    def get_stress_influence_coefficients_from_fe(self: Self, flank: "_324.GearFlanks"):
        """Method does not return.
