...
if TYPE_CHECKING:
    ...
    from mastapy.gears.fe_model import _1195, _1196
...
class GearSetFEModel(_1229.GearSetImplementationDetail):
    """GearSetFEModel
    ...
    @property
    def gear_fe_models(self: Self) -> "List[_1195.GearFEModel]":
    ...
    @property
    def mesh_fe_models(self: Self) -> "List[_1196.GearMeshFEModel]":
