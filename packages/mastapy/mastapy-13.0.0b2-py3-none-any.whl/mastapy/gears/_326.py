...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1080, _1012
    from mastapy.gears.rating.cylindrical import _476, _452
...
class GearSetDesignGroup(_0.APIBase):
    ...
    @enforce_parameter_types
    def default_rough_toleranced_metal_measurement(
        self: Self, value: "_1080.TolerancedMetalMeasurements"
    ):
    ...
    @enforce_parameter_types
    def micro_geometry_model_in_system_deflection(
        self: Self, value: "_335.MicroGeometryModel"
    ):
    ...
    @property
    def settings(self: Self) -> "_452.CylindricalGearDesignAndRatingSettingsItem":
