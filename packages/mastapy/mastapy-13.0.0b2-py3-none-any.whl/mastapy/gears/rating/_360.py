...
class GearSetDutyCycleRating(_353.AbstractGearSetRating):
    ...
    @property
    def gear_set_design(self: Self) -> "_948.GearSetDesign":
    ...
    @property
    def gear_ratings(self: Self) -> "List[_356.GearDutyCycleRating]":
    ...
    @property
    def gear_mesh_ratings(self: Self) -> "List[_363.MeshDutyCycleRating]":
    ...
    @property
    def gear_mesh_duty_cycle_ratings(self: Self) -> "List[_363.MeshDutyCycleRating]":
        """List[mastapy.gears.rating.MeshDutyCycleRating]
