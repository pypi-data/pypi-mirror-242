...
class WormGearSetRating(_361.GearSetRating):
    ...
    @property
    def worm_gear_set(self: Self) -> "_957.WormGearSetDesign":
    ...
    @property
    def gear_mesh_ratings(self: Self) -> "List[_371.WormGearMeshRating]":
    ...
    @property
    def worm_mesh_ratings(self: Self) -> "List[_371.WormGearMeshRating]":
        """List[mastapy.gears.rating.worm.WormGearMeshRating]
