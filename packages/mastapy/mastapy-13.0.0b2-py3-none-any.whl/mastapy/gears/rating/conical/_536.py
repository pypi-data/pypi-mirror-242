...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.conical import _539, _538
...
class ConicalGearDutyCycleRating(_356.GearDutyCycleRating):
    ...
    @property
    def left_flank_rating(self: Self) -> "_357.GearFlankRating":
    ...
    @property
    def concave_flank_rating(self: Self) -> "_357.GearFlankRating":
        """mastapy.gears.rating.GearFlankRating
    ...
    @property
    def gear_set_design_duty_cycle(self: Self) -> "_539.ConicalGearSetDutyCycleRating":
    ...
    @property
    def right_flank_rating(self: Self) -> "_357.GearFlankRating":
        """mastapy.gears.rating.GearFlankRating
    ...
    @property
    def convex_flank_rating(self: Self) -> "_357.GearFlankRating":
        """mastapy.gears.rating.GearFlankRating
    ...
    @property
    def gear_ratings(self: Self) -> "List[_538.ConicalGearRating]":
    ...
    @property
    def conical_gear_ratings(self: Self) -> "List[_538.ConicalGearRating]":
        """List[mastapy.gears.rating.conical.ConicalGearRating]
