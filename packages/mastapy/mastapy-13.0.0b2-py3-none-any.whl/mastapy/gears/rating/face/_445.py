...
class FaceGearMeshRating(_358.GearMeshRating):
    ...
    @property
    def active_flank(self: Self) -> "_324.GearFlanks":
        ...
        return constructor.new_from_mastapy("mastapy.gears._324", "GearFlanks")(value)

    @property
    def face_gear_mesh(self: Self) -> "_989.FaceGearMeshDesign":
    ...
    @property
    def gear_set_rating(self: Self) -> "_448.FaceGearSetRating":
    ...
    @property
    def mesh_load_case(self: Self) -> "_879.FaceMeshLoadCase":
    ...
    @property
    def mesh_single_flank_rating(self: Self) -> "_512.ISO63362006MeshSingleFlankRating":
