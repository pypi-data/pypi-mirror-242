...
class CylindricalGearSingleFlankRating(_362.GearSingleFlankRating):
    ...
    @property
    def is_gear_driving_or_driven(self: Self) -> "_355.FlankLoadingState":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating._355", "FlankLoadingState"
        )(value)
    ...
    @property
    def metal_plastic(self: Self) -> "_273.MetalPlasticType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._273", "MetalPlasticType"
        )(value)
