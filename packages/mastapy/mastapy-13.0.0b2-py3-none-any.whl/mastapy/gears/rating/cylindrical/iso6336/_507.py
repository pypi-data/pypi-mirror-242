...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.cylindrical.iso6336 import _528, _525
...
class CylindricalGearToothFatigueFractureResultsN1457(_0.APIBase):
    ...
    @property
    def fatigue_damage_chart(self: Self) -> "_1863.ThreeDChartDefinition":
    ...
    @property
    def critical_section(self: Self) -> "_528.ToothFlankFractureAnalysisRowN1457":
    ...
    @property
    def analysis_rows(self: Self) -> "List[_528.ToothFlankFractureAnalysisRowN1457]":
    ...
    def contact_points(
        self: Self,
    ) -> "List[_525.ToothFlankFractureAnalysisContactPointN1457]":
