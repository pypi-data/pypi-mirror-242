...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1025, _1070
    from mastapy.gears.rating.cylindrical.agma import _535, _532
...
class AGMA2101MeshSingleFlankRating(_465.CylindricalMeshSingleFlankRating):
    """AGMA2101MeshSingleFlankRating
    ...
    def gear_single_flank_ratings(
        self: Self,
    ) -> "List[_532.AGMA2101GearSingleFlankRating]":
