...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1069, _1068
...
class CylindricalMeshSingleFlankRating(_364.MeshSingleFlankRating):
    ...
    @property
    def contact_ratio_source(self: Self) -> "_319.ContactRatioDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._319", "ContactRatioDataSource"
        )(value)
    ...
    @property
    def sorted_scuffing_results(self: Self) -> "_460.CylindricalGearScuffingResults":
    ...
    def gear_single_flank_ratings(
        self: Self,
    ) -> "List[_463.CylindricalGearSingleFlankRating]":
