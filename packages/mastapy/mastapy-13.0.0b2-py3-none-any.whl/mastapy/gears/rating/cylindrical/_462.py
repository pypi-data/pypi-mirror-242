...
class CylindricalGearSetRating(_361.GearSetRating):
    ...
    @property
    def rating_method(self: Self) -> "_249.CylindricalGearRatingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._249", "CylindricalGearRatingMethods"
        )(value)
    ...
    @property
    def optimisations(self: Self) -> "_499.CylindricalGearSetRatingOptimisationHelper":
    ...
    @property
    def gear_ratings(self: Self) -> "List[_458.CylindricalGearRating]":
    ...
    @property
    def gear_mesh_ratings(self: Self) -> "List[_456.CylindricalGearMeshRating]":
    ...
    @property
    def cylindrical_mesh_ratings(self: Self) -> "List[_456.CylindricalGearMeshRating]":
        """List[mastapy.gears.rating.cylindrical.CylindricalGearMeshRating]
    ...
    def vdi_cylindrical_gear_single_flank_ratings(
        self: Self,
    ) -> "List[_487.VDI2737InternalGearSingleFlankRating]":
