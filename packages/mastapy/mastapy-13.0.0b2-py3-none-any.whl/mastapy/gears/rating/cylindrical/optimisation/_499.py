...
from mastapy.gears.rating.cylindrical.optimisation import _503, _504, _505
...
class CylindricalGearSetRatingOptimisationHelper(_0.APIBase):
    ...
    def helix_angle_optimisation_results(
        self: Self,
    ) -> "_500.OptimisationResultsPair[_503.SafetyFactorOptimisationStepResultAngle]":
    ...
    def maximum_transverse_contact_ratio_optimisation_results(
        self: Self,
    ) -> "_500.OptimisationResultsPair[_504.SafetyFactorOptimisationStepResultNumber]":
    ...
    def normal_module_optimisation_results(
        self: Self,
    ) -> "_500.OptimisationResultsPair[_505.SafetyFactorOptimisationStepResultShortLength]":
    ...
    def all_helix_angle_optimisation_results(
        self: Self,
    ) -> "List[_501.SafetyFactorOptimisationResults[_503.SafetyFactorOptimisationStepResultAngle]]":
    ...
    def all_normal_module_optimisation_results(
        self: Self,
    ) -> "List[_501.SafetyFactorOptimisationResults[_505.SafetyFactorOptimisationStepResultShortLength]]":
    ...
    def all_profile_shift_optimisation_results(
        self: Self,
    ) -> "List[_501.SafetyFactorOptimisationResults[_504.SafetyFactorOptimisationStepResultNumber]]":
