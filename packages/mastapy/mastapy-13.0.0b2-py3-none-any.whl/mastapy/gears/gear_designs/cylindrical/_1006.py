...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _998, _1079, _1021
...
class CylindricalGearBasicRack(_1004.CylindricalGearAbstractRack):
    """CylindricalGearBasicRack
    ...
    class _Cast_CylindricalGearBasicRack:
        ...
        def cylindrical_gear_abstract_rack(
            ...
            return self._parent._cast(_1004.CylindricalGearAbstractRack)
    ...
    @property
    def basic_rack_profile(self: Self) -> "_998.BasicRackProfiles":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._998", "BasicRackProfiles"
        )(value)

    @basic_rack_profile.setter
    @enforce_parameter_types
    def basic_rack_profile(self: Self, value: "_998.BasicRackProfiles"):
    ...
    @enforce_parameter_types
    def proportional_method_for_tip_clearance(
        self: Self, value: "_1079.TipAlterationCoefficientMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.TipAlterationCoefficientMethod",
