...
class CylindricalGearPinionTypeCutter(_1004.CylindricalGearAbstractRack):
    """CylindricalGearPinionTypeCutter
    ...
    @property
    def left_flank(self: Self) -> "_1022.CylindricalGearPinionTypeCutterFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1022.CylindricalGearPinionTypeCutterFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearPinionTypeCutterFlank
