...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1070, _1071
...
class Scuffing(_1584.IndependentReportablePropertiesBase["Scuffing"]):
    """Scuffing
    ...
    @enforce_parameter_types
    def coefficient_of_friction_method_flash_temperature_method(
        self: Self, value: "_1069.ScuffingCoefficientOfFrictionMethods"
    ):
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_agma(
        self: Self, value: "_1070.ScuffingTemperatureMethodsAGMA"
    ):
    ...
    @enforce_parameter_types
    def scuffing_temperature_method_iso(
        self: Self, value: "_1071.ScuffingTemperatureMethodsISO"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.ScuffingTemperatureMethodsISO",
