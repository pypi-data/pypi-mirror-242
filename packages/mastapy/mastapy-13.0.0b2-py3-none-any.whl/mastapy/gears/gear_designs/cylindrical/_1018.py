...
class CylindricalGearMicroGeometrySettings(
    _1584.IndependentReportablePropertiesBase["CylindricalGearMicroGeometrySettings"]
):
    """CylindricalGearMicroGeometrySettings
    ...
    @property
    def flank_side_with_zero_face_width(self: Self) -> "_569.FlankSide":
    ...
    def flank_side_with_zero_face_width(self: Self, value: "_569.FlankSide"):
