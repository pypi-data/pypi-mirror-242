...
class CylindricalGearDefaults(_1592.PerMachineSettings):
    """CylindricalGearDefaults
    ...
    @property
    def finish_stock_type(self: Self) -> "_1088.FinishStockType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical.thickness_stock_and_backlash._1088",
            "FinishStockType",
        )(value)

    @finish_stock_type.setter
    @enforce_parameter_types
    def finish_stock_type(self: Self, value: "_1088.FinishStockType"):
    ...
    @property
    def system_of_fits_defaults(self: Self) -> "_1138.DIN3967SystemOfGearFits":
