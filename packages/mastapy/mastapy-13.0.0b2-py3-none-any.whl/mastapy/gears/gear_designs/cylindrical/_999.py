...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1050, _1051
...
class CaseHardeningProperties(_0.APIBase):
    ...
    @enforce_parameter_types
    def hardness_profile_calculation_method(
        self: Self, value: "_1050.HardnessProfileCalculationMethod"
    ):
    ...
    @property
    def heat_treatment_type(self: Self) -> "_1051.HeatTreatmentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1051", "HeatTreatmentType"
        )(value)
