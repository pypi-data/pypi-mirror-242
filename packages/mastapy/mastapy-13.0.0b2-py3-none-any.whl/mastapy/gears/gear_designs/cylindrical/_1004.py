...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1010, _1005
...
class CylindricalGearAbstractRack(_0.APIBase):
    ...
    class _Cast_CylindricalGearAbstractRack:
        ...
        def cylindrical_gear_basic_rack(
            ...
            return self._parent._cast(_1006.CylindricalGearBasicRack)
        ...
        def cylindrical_gear_pinion_type_cutter(
            ...
            return self._parent._cast(_1021.CylindricalGearPinionTypeCutter)
        ...
        def standard_rack(
            ...
            return self._parent._cast(_1074.StandardRack)
    ...
    @property
    def gear(self: Self) -> "_1010.CylindricalGearDesign":
    ...
    @property
    def left_flank(self: Self) -> "_1005.CylindricalGearAbstractRackFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1005.CylindricalGearAbstractRackFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
    ...
    @property
    def shaper_for_agma_rating(self: Self) -> "_712.CylindricalGearShaper":
    ...
    @property
    def flanks(self: Self) -> "List[_1005.CylindricalGearAbstractRackFlank]":
    ...
    @property
    def both_flanks(self: Self) -> "_1005.CylindricalGearAbstractRackFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearAbstractRackFlank
