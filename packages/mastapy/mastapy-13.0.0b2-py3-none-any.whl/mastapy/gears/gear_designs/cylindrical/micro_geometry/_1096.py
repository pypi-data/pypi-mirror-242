...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1024, _1016
...
class CylindricalGearMeshMicroGeometry(_1223.GearMeshImplementationDetail):
    """CylindricalGearMeshMicroGeometry
    ...
    @property
    def left_flank_lead_modification_chart(self: Self) -> "_1865.TwoDChartDefinition":
    ...
    @property
    def right_flank_lead_modification_chart(self: Self) -> "_1865.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    @property
    def cylindrical_mesh(self: Self) -> "_1016.CylindricalGearMeshDesign":
    ...
    def cylindrical_gear_micro_geometries(
        self: Self,
    ) -> "List[_1099.CylindricalGearMicroGeometryBase]":
    ...
    def cylindrical_gear_micro_geometries_specified_per_tooth(
        self: Self,
    ) -> "List[_1102.CylindricalGearMicroGeometryPerTooth]":
    ...
    @property
    def gear_a(self: Self) -> "_1099.CylindricalGearMicroGeometryBase":
    ...
    @property
    def gear_b(self: Self) -> "_1099.CylindricalGearMicroGeometryBase":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearMicroGeometryBase
