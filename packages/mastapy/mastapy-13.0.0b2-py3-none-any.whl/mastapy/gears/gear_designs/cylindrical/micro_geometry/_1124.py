...
class ProfileReliefWithDeviation(_1126.ReliefWithDeviation):
    """ProfileReliefWithDeviation
    ...
    class _Cast_ProfileReliefWithDeviation:
        ...
        def relief_with_deviation(
            ...
            return self._parent._cast(_1126.ReliefWithDeviation)
    ...
    @property
    def position_on_profile(self: Self) -> "_1023.CylindricalGearProfileMeasurement":
