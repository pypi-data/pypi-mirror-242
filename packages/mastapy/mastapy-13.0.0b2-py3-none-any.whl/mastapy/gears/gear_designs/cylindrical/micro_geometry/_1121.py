...
class MicroGeometryViewingOptions(_0.APIBase):
    ...
    def contact_results(self: Self, value: "_825.ContactResultType"):
    ...
    @property
    def gear_option(self: Self) -> "_1110.DrawDefiningGearOrBoth":
    ...
    @gear_option.setter
    @enforce_parameter_types
    def gear_option(self: Self, value: "_1110.DrawDefiningGearOrBoth"):
