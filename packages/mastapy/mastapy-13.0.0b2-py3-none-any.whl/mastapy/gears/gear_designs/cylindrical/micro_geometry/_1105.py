...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1026, _1039, _1010
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1099, _1096
...
class CylindricalGearSetMicroGeometry(_1229.GearSetImplementationDetail):
    """CylindricalGearSetMicroGeometry
    ...
    def cylindrical_mesh_micro_geometries(
        self: Self,
    ) -> "List[_1096.CylindricalGearMeshMicroGeometry]":
    ...
    def duplicate_and_add_to(
        self: Self, gear_set_design: "_1026.CylindricalGearSetDesign"
    ) -> "CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def duplicate_specifying_separate_micro_geometry_for_each_planet_and_add_to(
        self: Self, gear_set_design: "_1039.CylindricalPlanetaryGearSetDesign"
    ) -> "_1229.GearSetImplementationDetail":
        """mastapy.gears.analysis.GearSetImplementationDetail
