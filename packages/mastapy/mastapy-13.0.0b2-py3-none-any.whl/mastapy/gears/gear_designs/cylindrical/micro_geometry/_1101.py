...
class CylindricalGearMicroGeometryMap(_0.APIBase):
    ...
    @property
    def measured_map_data_type(self: Self) -> "_1116.MeasuredMapDataTypes":
    ...
    def measured_map_data_type(self: Self, value: "_1116.MeasuredMapDataTypes"):
    ...
    @property
    def zero_bias_relief(self: Self) -> "_1023.CylindricalGearProfileMeasurement":
