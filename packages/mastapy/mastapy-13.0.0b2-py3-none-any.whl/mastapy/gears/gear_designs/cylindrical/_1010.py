...
class CylindricalGearDesign(_945.GearDesign):
    """CylindricalGearDesign
    ...
    @property
    def internal_external(self: Self) -> "_310.InternalExternalType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.geometry.two_d._310", "InternalExternalType"
        )(value)

    @internal_external.setter
    @enforce_parameter_types
    def internal_external(self: Self, value: "_310.InternalExternalType"):
    ...
    @property
    def limiting_root_diameter(self: Self) -> "float":
        """float

        Note:
            This property is readonly.
        """
        temp = self.wrapped.LimitingRootDiameter
    ...
    @property
    def maximum_tip_diameter(self: Self) -> "float":
        """float
    ...
    @property
    def agma_accuracy_grade(self: Self) -> "_1132.AGMA20151AccuracyGrades":
    ...
    @property
    def case_hardening_properties(self: Self) -> "_999.CaseHardeningProperties":
    ...
    @property
    def cylindrical_gear_set(self: Self) -> "_1026.CylindricalGearSetDesign":
    ...
    @property
    def finish_stock_specification(self: Self) -> "_1087.FinishStockSpecification":
    ...
    @property
    def iso6336_geometry(self: Self) -> "_1053.ISO6336GeometryBase":
    ...
    @property
    def iso_accuracy_grade(self: Self) -> "_1142.ISO1328AccuracyGrades":
    ...
    @property
    def left_flank(self: Self) -> "_1015.CylindricalGearFlankDesign":
    ...
    @property
    def material(self: Self) -> "_592.GearMaterial":
    ...
    @property
    def right_flank(self: Self) -> "_1015.CylindricalGearFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearFlankDesign
    ...
    @property
    def system_of_gear_fits(self: Self) -> "_1138.DIN3967SystemOfGearFits":
    ...
    @property
    def tiff_analysis_settings(self: Self) -> "_1078.TiffAnalysisSettings":
    ...
    @property
    def flanks(self: Self) -> "List[_1015.CylindricalGearFlankDesign]":
    ...
    @property
    def both_flanks(self: Self) -> "_1015.CylindricalGearFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearFlankDesign
    ...
    def manufacturing_configurations(
        self: Self,
    ) -> "List[_610.CylindricalGearManufacturingConfig]":
    ...
    @property
    def micro_geometries(self: Self) -> "List[_1099.CylindricalGearMicroGeometryBase]":
