...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1056, _1035
...
class BacklashSpecification(_1066.RelativeValuesSpecification["BacklashSpecification"]):
    """BacklashSpecification
    ...
    class _Cast_BacklashSpecification:
        ...
        def relative_values_specification(
            ...
            return self._parent._cast(_1066.RelativeValuesSpecification)
    ...
    @property
    def left_flank(self: Self) -> "_1056.LinearBacklashSpecification":
    ...
    @property
    def right_flank(self: Self) -> "_1056.LinearBacklashSpecification":
        """mastapy.gears.gear_designs.cylindrical.LinearBacklashSpecification
    ...
    @property
    def angular_backlash(self: Self) -> "List[_1035.CylindricalMeshAngularBacklash]":
    ...
    @property
    def flanks(self: Self) -> "List[_1056.LinearBacklashSpecification]":
    ...
    @property
    def both_flanks(self: Self) -> "_1056.LinearBacklashSpecification":
        """mastapy.gears.gear_designs.cylindrical.LinearBacklashSpecification
