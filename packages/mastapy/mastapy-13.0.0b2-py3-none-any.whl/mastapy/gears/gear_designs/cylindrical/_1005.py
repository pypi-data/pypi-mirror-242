...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1004, _1010
...
class CylindricalGearAbstractRackFlank(_0.APIBase):
    ...
    class _Cast_CylindricalGearAbstractRackFlank:
        ...
        def cylindrical_gear_basic_rack_flank(
            ...
            return self._parent._cast(_1007.CylindricalGearBasicRackFlank)
        ...
        def cylindrical_gear_pinion_type_cutter_flank(
            ...
            return self._parent._cast(_1022.CylindricalGearPinionTypeCutterFlank)
        ...
        def standard_rack_flank(
            ...
            return self._parent._cast(_1075.StandardRackFlank)
    ...
    @property
    def cutter(self: Self) -> "_1004.CylindricalGearAbstractRack":
