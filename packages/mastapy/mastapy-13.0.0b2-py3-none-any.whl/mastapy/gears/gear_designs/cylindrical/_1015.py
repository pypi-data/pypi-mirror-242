...
class CylindricalGearFlankDesign(_0.APIBase):
    ...
    @property
    def root_form(self: Self) -> "_1023.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
    ...
    @property
    def tip_diameter_reporting(self: Self) -> "_1023.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
    ...
    @property
    def tip_form(self: Self) -> "_1023.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
