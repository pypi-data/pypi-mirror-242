...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1004, _1029
...
class CylindricalGearCuttingOptions(_0.APIBase):
    ...
    def geometry_specification_type(
        self: Self, value: "_1048.GeometrySpecificationType"
    ):
    ...
    @property
    def cylindrical_gear_cutter(self: Self) -> "_1004.CylindricalGearAbstractRack":
