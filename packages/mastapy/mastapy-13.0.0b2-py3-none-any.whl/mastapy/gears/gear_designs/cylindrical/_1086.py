...
class Usage(_1584.IndependentReportablePropertiesBase["Usage"]):
    """Usage
    ...
    @property
    def safety_requirement(self: Self) -> "_343.SafetyRequirementsAGMA":
    ...
    @enforce_parameter_types
    def safety_requirement(self: Self, value: "_343.SafetyRequirementsAGMA"):
    ...
    @property
    def spur_gear_load_sharing_code(self: Self) -> "_1073.SpurGearLoadSharingCodes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1073", "SpurGearLoadSharingCodes"
        )(value)

    @spur_gear_load_sharing_code.setter
    @enforce_parameter_types
    def spur_gear_load_sharing_code(
        self: Self, value: "_1073.SpurGearLoadSharingCodes"
    ):
        value = conversion.mp_to_pn_enum(
