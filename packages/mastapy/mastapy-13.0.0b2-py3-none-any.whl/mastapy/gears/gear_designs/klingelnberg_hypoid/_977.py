...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.klingelnberg_hypoid import _975, _976
...
class KlingelnbergCycloPalloidHypoidGearSetDesign(
    ...
    @property
    def gears(self: Self) -> "List[_975.KlingelnbergCycloPalloidHypoidGearDesign]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears(
        self: Self,
    ) -> "List[_975.KlingelnbergCycloPalloidHypoidGearDesign]":
        """List[mastapy.gears.gear_designs.klingelnberg_hypoid.KlingelnbergCycloPalloidHypoidGearDesign]
    ...
    def klingelnberg_conical_meshes(
        self: Self,
    ) -> "List[_976.KlingelnbergCycloPalloidHypoidGearMeshDesign]":
