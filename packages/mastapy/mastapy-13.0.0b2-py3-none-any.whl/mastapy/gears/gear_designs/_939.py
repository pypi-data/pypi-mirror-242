...
class BevelHypoidGearDesignSettingsItem(_1827.NamedDatabaseItem):
    """BevelHypoidGearDesignSettingsItem
    ...
    @property
    def quality_grade_type(self: Self) -> "_342.QualityGradeTypes":
    ...
    @enforce_parameter_types
    def quality_grade_type(self: Self, value: "_342.QualityGradeTypes"):
