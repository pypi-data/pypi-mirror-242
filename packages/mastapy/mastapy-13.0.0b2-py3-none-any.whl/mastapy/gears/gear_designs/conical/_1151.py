...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.conical import _1159, _1160, _1169, _1168
...
class ConicalGearCutter(_0.APIBase):
    ...
    class _Cast_ConicalGearCutter:
        ...
        def pinion_finish_cutter(self: "ConicalGearCutter._Cast_ConicalGearCutter"):
            from mastapy.gears.manufacturing.bevel.cutters import _811

            return self._parent._cast(_811.PinionFinishCutter)
        ...
        def pinion_rough_cutter(self: "ConicalGearCutter._Cast_ConicalGearCutter"):
            ...
            return self._parent._cast(_812.PinionRoughCutter)
        ...
        def wheel_finish_cutter(self: "ConicalGearCutter._Cast_ConicalGearCutter"):
            ...
            return self._parent._cast(_813.WheelFinishCutter)
        ...
        def wheel_rough_cutter(self: "ConicalGearCutter._Cast_ConicalGearCutter"):
            ...
            return self._parent._cast(_814.WheelRoughCutter)
        ...
        def dummy_conical_gear_cutter(
            ...
            return self._parent._cast(_1161.DummyConicalGearCutter)
    ...
    @property
    def cutter_blade_type(self: Self) -> "_1159.CutterBladeType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1159", "CutterBladeType"
        )(value)

    @cutter_blade_type.setter
    @enforce_parameter_types
    def cutter_blade_type(self: Self, value: "_1159.CutterBladeType"):
    ...
    @property
    def cutter_gauge_length(self: Self) -> "_1160.CutterGaugeLengths":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1160", "CutterGaugeLengths"
        )(value)

    @cutter_gauge_length.setter
    @enforce_parameter_types
    def cutter_gauge_length(self: Self, value: "_1160.CutterGaugeLengths"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_toprem_letter_convex(self: Self) -> "_1169.TopremLetter":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1169", "TopremLetter"
        )(value)

    @inner_toprem_letter_convex.setter
    @enforce_parameter_types
    def inner_toprem_letter_convex(self: Self, value: "_1169.TopremLetter"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def input_toprem_as(self: Self) -> "_1168.TopremEntryType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1168", "TopremEntryType"
        )(value)

    @input_toprem_as.setter
    @enforce_parameter_types
    def input_toprem_as(self: Self, value: "_1168.TopremEntryType"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def outer_toprem_letter_concave(self: Self) -> "_1169.TopremLetter":
        """mastapy.gears.gear_designs.conical.TopremLetter"""
    ...
    @enforce_parameter_types
    def outer_toprem_letter_concave(self: Self, value: "_1169.TopremLetter"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Gears.GearDesigns.Conical.TopremLetter"
        )
