...
class AGMAGleasonConicalGearSetDesign(_1154.ConicalGearSetDesign):
    """AGMAGleasonConicalGearSetDesign
    ...
    def design_method(self: Self, value: "_1177.AGMAGleasonConicalGearGeometryMethods"):
    ...
    @property
    def manufacturing_method(self: Self) -> "_303.CutterMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gleason_smt_link._303", "CutterMethod"
        )(value)

    @manufacturing_method.setter
    @enforce_parameter_types
    def manufacturing_method(self: Self, value: "_303.CutterMethod"):
    ...
    @property
    def reliability_requirement_agma(self: Self) -> "_343.SafetyRequirementsAGMA":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._343", "SafetyRequirementsAGMA"
        )(value)

    @reliability_requirement_agma.setter
    @enforce_parameter_types
    def reliability_requirement_agma(self: Self, value: "_343.SafetyRequirementsAGMA"):
        value = conversion.mp_to_pn_enum(
    ...
    def reliability_requirement_gleason(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.conical._1163", "GleasonSafetyRequirements"
        )(value)

    @reliability_requirement_gleason.setter
    @enforce_parameter_types
    def reliability_requirement_gleason(
        self: Self, value: "_1163.GleasonSafetyRequirements"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def tooth_taper(self: Self) -> "_346.SpiralBevelToothTaper":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._346", "SpiralBevelToothTaper"
        )(value)

    @tooth_taper.setter
    @enforce_parameter_types
    def tooth_taper(self: Self, value: "_346.SpiralBevelToothTaper"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def conical_meshes(self: Self) -> "List[_1192.AGMAGleasonConicalGearMeshDesign]":
    ...
    @property
    def meshes(self: Self) -> "List[_1192.AGMAGleasonConicalGearMeshDesign]":
        """List[mastapy.gears.gear_designs.agma_gleason_conical.AGMAGleasonConicalGearMeshDesign]
