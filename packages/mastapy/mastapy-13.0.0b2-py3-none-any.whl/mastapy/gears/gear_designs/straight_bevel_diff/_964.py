...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.straight_bevel_diff import _965, _963, _966
...
class StraightBevelDiffGearMeshDesign(_1179.BevelGearMeshDesign):
    """StraightBevelDiffGearMeshDesign
    ...
    def straight_bevel_diff_meshed_gears(
        self: Self,
    ) -> "List[_966.StraightBevelDiffMeshedGearDesign]":
