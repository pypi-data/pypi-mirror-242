...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.face import _993, _991, _990
...
class FaceGearSetMicroGeometry(_1229.GearSetImplementationDetail):
    """FaceGearSetMicroGeometry
    ...
    def face_mesh_micro_geometries(
        self: Self,
    ) -> "List[_990.FaceGearMeshMicroGeometry]":
