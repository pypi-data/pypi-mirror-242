...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.straight_bevel import _959, _960
...
class StraightBevelGearSetDesign(_1180.BevelGearSetDesign):
    """StraightBevelGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_959.StraightBevelGearDesign]":
    ...
    @property
    def straight_bevel_gears(self: Self) -> "List[_959.StraightBevelGearDesign]":
        """List[mastapy.gears.gear_designs.straight_bevel.StraightBevelGearDesign]
    ...
    @property
    def straight_bevel_meshes(self: Self) -> "List[_960.StraightBevelGearMeshDesign]":
