...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.zerol_bevel import _950, _951
...
class ZerolBevelGearSetDesign(_1180.BevelGearSetDesign):
    """ZerolBevelGearSetDesign
    ...
    @property
    def tooth_taper_zerol(self: Self) -> "_350.ZerolBevelGleasonToothTaperOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._350", "ZerolBevelGleasonToothTaperOption"
        )(value)

    @tooth_taper_zerol.setter
    @enforce_parameter_types
    def tooth_taper_zerol(self: Self, value: "_350.ZerolBevelGleasonToothTaperOption"):
    ...
    @property
    def gears(self: Self) -> "List[_950.ZerolBevelGearDesign]":
    ...
    @property
    def zerol_bevel_gears(self: Self) -> "List[_950.ZerolBevelGearDesign]":
        """List[mastapy.gears.gear_designs.zerol_bevel.ZerolBevelGearDesign]
    ...
    @property
    def zerol_bevel_meshes(self: Self) -> "List[_951.ZerolBevelGearMeshDesign]":
