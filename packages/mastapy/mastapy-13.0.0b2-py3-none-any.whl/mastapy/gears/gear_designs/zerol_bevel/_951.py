...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.zerol_bevel import _952, _950, _953
...
class ZerolBevelGearMeshDesign(_1179.BevelGearMeshDesign):
    """ZerolBevelGearMeshDesign
    ...
    @property
    def zerol_bevel_meshed_gears(self: Self) -> "List[_953.ZerolBevelMeshedGearDesign]":
