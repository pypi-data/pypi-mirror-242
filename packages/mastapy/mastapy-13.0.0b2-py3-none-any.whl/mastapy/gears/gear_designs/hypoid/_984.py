...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.hypoid import _985, _983, _986
...
class HypoidGearMeshDesign(_1192.AGMAGleasonConicalGearMeshDesign):
    """HypoidGearMeshDesign
    ...
    @property
    def hypoid_gear_set(self: Self) -> "_985.HypoidGearSetDesign":
    ...
    @property
    def hypoid_meshed_gears(self: Self) -> "List[_986.HypoidMeshedGearDesign]":
