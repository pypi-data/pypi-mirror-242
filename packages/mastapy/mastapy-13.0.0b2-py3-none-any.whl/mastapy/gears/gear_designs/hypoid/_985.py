...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.hypoid import _983, _984
...
class HypoidGearSetDesign(_1193.AGMAGleasonConicalGearSetDesign):
    """HypoidGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_983.HypoidGearDesign]":
    ...
    @property
    def hypoid_gears(self: Self) -> "List[_983.HypoidGearDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearDesign]
    ...
    @property
    def meshes(self: Self) -> "List[_984.HypoidGearMeshDesign]":
    ...
    @property
    def hypoid_meshes(self: Self) -> "List[_984.HypoidGearMeshDesign]":
        """List[mastapy.gears.gear_designs.hypoid.HypoidGearMeshDesign]
