...
if TYPE_CHECKING:
    from mastapy.utility.property import _1834
...
class DesignConstraintsCollection(_1827.NamedDatabaseItem):
    """DesignConstraintsCollection
    ...
    def design_constraints(
        self: Self,
    ) -> "List[_1834.DeletableCollectionMember[_942.DesignConstraint]]":
