...
from mastapy.gears.gear_designs.creation_options import _1145
...
class CylindricalGearPairCreationOptions(
    _1145.GearSetCreationOptions["_1026.CylindricalGearSetDesign"]
):
    """CylindricalGearPairCreationOptions
    ...
    class _Cast_CylindricalGearPairCreationOptions:
        ...
        def gear_set_creation_options(
            ...
            return self._parent._cast(_1145.GearSetCreationOptions)
