...
T = TypeVar("T", bound="_948.GearSetDesign")
...
class GearSetCreationOptions(_0.APIBase, Generic[T]):
    ...
    class _Cast_GearSetCreationOptions:
        ...
        def cylindrical_gear_pair_creation_options(
            ...
            return self._parent._cast(_1144.CylindricalGearPairCreationOptions)
        ...
        def hypoid_gear_set_creation_options(
            ...
            return self._parent._cast(_1146.HypoidGearSetCreationOptions)
        ...
        def spiral_bevel_gear_set_creation_options(
            ...
            return self._parent._cast(_1147.SpiralBevelGearSetCreationOptions)
