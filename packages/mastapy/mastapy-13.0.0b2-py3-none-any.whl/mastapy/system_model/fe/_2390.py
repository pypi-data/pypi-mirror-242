...
class FESubstructureWithSelectionForHarmonicAnalysis(_2388.FESubstructureWithSelection):
    """FESubstructureWithSelectionForHarmonicAnalysis
    ...
    @property
    def harmonic_draw_style(self: Self) -> "_185.FEModelHarmonicAnalysisDrawStyle":
