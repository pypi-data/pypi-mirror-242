...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.fe import _2374, _2365, _2366, _2397
...
class FESubstructureWithSelectionComponents(_2388.FESubstructureWithSelection):
    """FESubstructureWithSelectionComponents
    ...
    class _Cast_FESubstructureWithSelectionComponents:
        ...
        def fe_substructure_with_selection(
            ...
            return self._parent._cast(_2388.FESubstructureWithSelection)
        ...
        def base_fe_with_selection(
            ...
            return self._parent._cast(_2358.BaseFEWithSelection)
    ...
    @property
    def manual_alignment(self: Self) -> "_1497.CoordinateSystemEditor":
    ...
    def beam_element_properties(
        self: Self,
    ) -> "List[_2374.ElementPropertiesWithSelection[_208.ElementPropertiesBeam]]":
    ...
    @property
    def component_links(self: Self) -> "List[_2418.FELinkWithSelection]":
    ...
    @property
    def contact_pairs(self: Self) -> "List[_2365.ContactPairWithSelection]":
    ...
    @property
    def coordinate_systems(self: Self) -> "List[_2366.CoordinateSystemWithSelection]":
    ...
    def interface_element_properties(
        self: Self,
    ) -> "List[_2374.ElementPropertiesWithSelection[_209.ElementPropertiesInterface]]":
    ...
    @property
    def links_for_electric_machine(self: Self) -> "List[_2418.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    @property
    def links_for_selected_component(self: Self) -> "List[_2418.FELinkWithSelection]":
        """List[mastapy.system_model.fe.links.FELinkWithSelection]
    ...
    def mass_element_properties(
        self: Self,
    ) -> "List[_2374.ElementPropertiesWithSelection[_210.ElementPropertiesMass]]":
    ...
    @property
    def materials(self: Self) -> "List[_2397.MaterialPropertiesWithSelection]":
    ...
    def other_element_properties(
        self: Self,
    ) -> "List[_2374.ElementPropertiesWithSelection[_207.ElementPropertiesBase]]":
    ...
    def rigid_element_properties(
        self: Self,
    ) -> "List[_2374.ElementPropertiesWithSelection[_211.ElementPropertiesRigid]]":
    ...
    def shell_element_properties(
        self: Self,
    ) -> "List[_2374.ElementPropertiesWithSelection[_212.ElementPropertiesShell]]":
    ...
    def solid_element_properties(
        self: Self,
    ) -> "List[_2374.ElementPropertiesWithSelection[_213.ElementPropertiesSolid]]":
    ...
    def spring_dashpot_element_properties(
        self: Self,
    ) -> "List[_2374.ElementPropertiesWithSelection[_214.ElementPropertiesSpringDashpot]]":
