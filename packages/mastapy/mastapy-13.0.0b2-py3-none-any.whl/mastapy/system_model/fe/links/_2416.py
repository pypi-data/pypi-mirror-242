...
from mastapy.system_model.fe import _2361, _2396, _2400, _2383
...
class FELink(_0.APIBase):
    ...
    @enforce_parameter_types
    def bearing_node_link_option(self: Self, value: "_2361.BearingNodeOption"):
    ...
    def coupling_type(
        self: Self,
        value: "Union[_201.RigidCouplingType, Tuple[_201.RigidCouplingType, bool]]",
    ):
    ...
    @enforce_parameter_types
    def link_node_source(self: Self, value: "_2396.LinkNodeSource"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def node_selection_depth(
        self: Self,
        value: "Union[_2400.NodeSelectionDepthOption, Tuple[_2400.NodeSelectionDepthOption, bool]]",
    ):
    ...
    @property
    def component(self: Self) -> "_2462.MountableComponent":
    ...
    @property
    def socket(self: Self) -> "_2294.Socket":
    ...
    @property
    def support_material(self: Self) -> "_267.Material":
    ...
    def nodes_grouped_by_angle(
        self: Self,
    ) -> "OrderedDict[float, List[_2383.FESubstructureNode]]":
    ...
    @enforce_parameter_types
    def add_or_replace_node(self: Self, node: "_2383.FESubstructureNode"):
