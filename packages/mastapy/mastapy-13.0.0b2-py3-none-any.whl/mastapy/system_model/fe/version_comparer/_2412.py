...
if TYPE_CHECKING:
    from mastapy.system_model.fe.version_comparer import _2414, _2410
...
class FESubstructureVersionComparer(_0.APIBase):
    ...
    @property
    def load_cases_to_run(self: Self) -> "_2414.LoadCasesToRun":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe.version_comparer._2414", "LoadCasesToRun"
        )(value)

    @load_cases_to_run.setter
    @enforce_parameter_types
    def load_cases_to_run(self: Self, value: "_2414.LoadCasesToRun"):
    ...
    @property
    def design_results(self: Self) -> "List[_2410.DesignResults]":
