...
class FESubstructureWithSelectionForStaticAnalysis(_2388.FESubstructureWithSelection):
    """FESubstructureWithSelectionForStaticAnalysis
    ...
    @enforce_parameter_types
    def contour_option(self: Self, value: "_1819.ThreeDViewContourOption"):
    ...
    @property
    def full_fe_results(self: Self) -> "_233.StaticCMSResults":
    ...
    @property
    def static_draw_style(self: Self) -> "_190.FEModelStaticAnalysisDrawStyle":
    ...
    def boundary_conditions_all_nodes(
        self: Self,
    ) -> "List[_2398.NodeBoundaryConditionStaticAnalysis]":
    ...
    @property
    def force_results(self: Self) -> "List[_1562.VectorWithLinearAndAngularComponents]":
        """List[mastapy.math_utility.measured_vectors.VectorWithLinearAndAngularComponents]
