...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs import _939, _941, _944
    from mastapy.gears.gear_designs.cylindrical import _1012, _1020
...
class DesignSettings(_0.APIBase, _1583.IHaveAllSettings):
    """DesignSettings
    ...
    @property
    def bearing_settings(self: Self) -> "_1879.BearingSettingsItem":
    ...
    @property
    def design_constraints_settings(self: Self) -> "_944.DesignConstraintsCollection":
    ...
    @property
    def materials_settings(self: Self) -> "_271.MaterialsSettingsItem":
