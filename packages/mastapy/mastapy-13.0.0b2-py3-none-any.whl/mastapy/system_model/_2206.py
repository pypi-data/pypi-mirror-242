...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1259, _1265, _1283
...
class ElectricMachineGroup(_0.APIBase):
    ...
    @property
    def electric_machine_details(self: Self) -> "List[_1259.ElectricMachineDetail]":
    ...
    def electric_machine_load_case_groups(
        self: Self,
    ) -> "List[_1357.ElectricMachineLoadCaseGroup]":
    ...
    def add_electric_machine_detail(
        self: Self, type_: "_1265.ElectricMachineType", name: "str" = "Motor"
    ...
    def duplicate_electric_machine_detail(
        self: Self, detail: "_1259.ElectricMachineDetail"
    ...
    def remove_electric_machine_detail(
        self: Self, motor: "_1259.ElectricMachineDetail"
    ) -> "bool":
        """bool
    ...
    def try_remove_load_case_group(
        self: Self, load_case_group: "_1357.ElectricMachineLoadCaseGroup"
    ) -> "bool":
        """bool
