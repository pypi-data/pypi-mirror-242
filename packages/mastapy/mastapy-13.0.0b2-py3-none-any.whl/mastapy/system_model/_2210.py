...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1877, _1878, _1891, _1897
    from mastapy.bolts import _1466, _1468, _1473
    from mastapy.cycloidal import _1454, _1461
    from mastapy.electric_machines import _1281, _1299, _1312
    from mastapy.gears import _314, _315, _341
    from mastapy.gears.gear_designs import _938, _940, _943, _949
    from mastapy.gears.gear_designs.cylindrical import _1009, _1013, _1014, _1019, _1030
    ...
    from mastapy.gears.manufacturing.cylindrical.cutters import _703, _709, _714, _715
    from mastapy.gears.manufacturing.cylindrical import _613, _624
    ...
    from mastapy.gears.rating.cylindrical import _450, _451, _466, _467
    ...
    from mastapy.system_model.optimization import _2226, _2234
    from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2562
    from mastapy.system_model.part_model import _2468
    from mastapy.materials import _244, _247, _266, _269, _270
    ...
    from mastapy.utility.cad_export import _1830
    from mastapy.utility.databases import _1825
    from mastapy.utility import _1594, _1595
    from mastapy.utility.scripting import _1737
...
class MASTASettings(_0.APIBase):
    ...
    @property
    def iso14179_settings_database(self: Self) -> "_1973.ISO14179SettingsDatabase":
    ...
    @property
    def bearing_settings(self: Self) -> "_1877.BearingSettings":
    ...
    @property
    def bearing_settings_database(self: Self) -> "_1878.BearingSettingsDatabase":
    ...
    @property
    def rolling_bearing_database(self: Self) -> "_1891.RollingBearingDatabase":
    ...
    @property
    def skf_settings(self: Self) -> "_1897.SKFSettings":
    ...
    @property
    def bolt_geometry_database(self: Self) -> "_1466.BoltGeometryDatabase":
    ...
    @property
    def bolt_material_database(self: Self) -> "_1468.BoltMaterialDatabase":
    ...
    @property
    def ring_pins_material_database(self: Self) -> "_1461.RingPinsMaterialDatabase":
    ...
    @property
    def magnet_material_database(self: Self) -> "_1281.MagnetMaterialDatabase":
    ...
    @property
    def winding_material_database(self: Self) -> "_1312.WindingMaterialDatabase":
    ...
    @property
    def cylindrical_gear_defaults(self: Self) -> "_1009.CylindricalGearDefaults":
    ...
    @property
    def cylindrical_gear_fe_settings(self: Self) -> "_853.CylindricalGearFESettings":
    ...
    @property
    def cylindrical_hob_database(self: Self) -> "_613.CylindricalHobDatabase":
    ...
    @property
    def cylindrical_shaper_database(self: Self) -> "_624.CylindricalShaperDatabase":
    ...
    @property
    def bevel_gear_material_database(self: Self) -> "_586.BevelGearMaterialDatabase":
    ...
    @property
    def raw_material_database(self: Self) -> "_605.RawMaterialDatabase":
    ...
    @property
    def harmonic_analysis_draw_style(self: Self) -> "_5759.HarmonicAnalysisDrawStyle":
    ...
    @property
    def mbd_analysis_draw_style(self: Self) -> "_5457.MBDAnalysisDrawStyle":
    ...
    @property
    def modal_analysis_draw_style(self: Self) -> "_4653.ModalAnalysisDrawStyle":
    ...
    @property
    def power_flow_draw_style(self: Self) -> "_4120.PowerFlowDrawStyle":
    ...
    @property
    def stability_analysis_draw_style(self: Self) -> "_3869.StabilityAnalysisDrawStyle":
    ...
    @property
    def system_deflection_draw_style(self: Self) -> "_2824.SystemDeflectionDrawStyle":
    ...
    @property
    def model_view_options_draw_style(self: Self) -> "_2250.ModelViewOptionsDrawStyle":
    ...
    @property
    def planet_carrier_settings(self: Self) -> "_2468.PlanetCarrierSettings":
    ...
    @property
    def bearing_material_database(self: Self) -> "_244.BearingMaterialDatabase":
    ...
    @property
    def component_material_database(self: Self) -> "_247.ComponentMaterialDatabase":
    ...
    @property
    def lubrication_detail_database(self: Self) -> "_266.LubricationDetailDatabase":
    ...
    @property
    def materials_settings(self: Self) -> "_269.MaterialsSettings":
    ...
    @property
    def materials_settings_database(self: Self) -> "_270.MaterialsSettingsDatabase":
    ...
    @property
    def cad_export_settings(self: Self) -> "_1830.CADExportSettings":
    ...
    @property
    def database_settings(self: Self) -> "_1825.DatabaseSettings":
    ...
    @property
    def program_settings(self: Self) -> "_1594.ProgramSettings":
    ...
    @property
    def pushbullet_settings(self: Self) -> "_1595.PushbulletSettings":
    ...
    @property
    def scripting_setup(self: Self) -> "_1737.ScriptingSetup":
    ...
    @property
    def measurement_settings(self: Self) -> "_1604.MeasurementSettings":
