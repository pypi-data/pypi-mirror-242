...
class BevelDifferentialGearSet(_2518.BevelGearSet):
    """BevelDifferentialGearSet
    ...
    @property
    def conical_gear_set_design(self: Self) -> "_1180.BevelGearSetDesign":
    ...
    @property
    def bevel_gear_set_design(self: Self) -> "_1180.BevelGearSetDesign":
        """mastapy.gears.gear_designs.bevel.BevelGearSetDesign
    ...
    @property
    def bevel_gears(self: Self) -> "List[_2517.BevelGear]":
    ...
    @property
    def bevel_meshes(self: Self) -> "List[_2301.BevelGearMesh]":
