...
class HypoidGear(_2511.AGMAGleasonConicalGear):
    """HypoidGear
    ...
    @property
    def conical_gear_design(self: Self) -> "_983.HypoidGearDesign":
    ...
    @property
    def hypoid_gear_design(self: Self) -> "_983.HypoidGearDesign":
        """mastapy.gears.gear_designs.hypoid.HypoidGearDesign
