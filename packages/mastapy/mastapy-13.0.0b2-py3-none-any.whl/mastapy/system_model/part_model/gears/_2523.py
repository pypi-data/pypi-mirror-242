...
class CylindricalGear(_2528.Gear):
    """CylindricalGear
    ...
    @property
    def clearance_to_maximum_tip_diameter(self: Self) -> "float":
        """float
    ...
    @property
    def limiting_root_diameter(self: Self) -> "overridable.Overridable_float":
        """Overridable[float]"""
    ...
    @limiting_root_diameter.setter
    @enforce_parameter_types
    def limiting_root_diameter(self: Self, value: "Union[float, Tuple[float, bool]]"):
        wrapper_type = overridable.Overridable_float.wrapper_type()
        enclosed_type = overridable.Overridable_float.implicit_type()
        value, is_overridden = _unpack_overridable(value)
        value = wrapper_type[enclosed_type](
        ...
        self.wrapped.LimitingRootDiameter = value
    ...
    @property
    def maximum_tip_diameter(self: Self) -> "overridable.Overridable_float":
        """Overridable[float]"""
    ...
    @enforce_parameter_types
    def maximum_tip_diameter(self: Self, value: "Union[float, Tuple[float, bool]]"):
        wrapper_type = overridable.Overridable_float.wrapper_type()
        enclosed_type = overridable.Overridable_float.implicit_type()
        value, is_overridden = _unpack_overridable(value)
        value = wrapper_type[enclosed_type](
    ...
    @property
    def active_gear_design(self: Self) -> "_1010.CylindricalGearDesign":
    ...
    @property
    def cylindrical_gear_design(self: Self) -> "_1010.CylindricalGearDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign
    ...
    @property
    def cylindrical_meshes(self: Self) -> "List[_2307.CylindricalGearMesh]":
