...
class GearSet(_2474.SpecialisedAssembly):
    """GearSet
    ...
    def active_design(self: Self, value: "_948.GearSetDesign"):
        wrapper_type = (
    ...
    @property
    def active_gear_set_design(self: Self) -> "_948.GearSetDesign":
    ...
    @property
    def gear_set_designs(self: Self) -> "List[_948.GearSetDesign]":
    ...
    @enforce_parameter_types
    def add_gear_set_design(self: Self, design: "_948.GearSetDesign"):
    ...
    @enforce_parameter_types
    def remove_design(self: Self, design: "_948.GearSetDesign"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def set_active_gear_set_design(self: Self, gear_set_design: "_948.GearSetDesign"):
        """Method does not return.
