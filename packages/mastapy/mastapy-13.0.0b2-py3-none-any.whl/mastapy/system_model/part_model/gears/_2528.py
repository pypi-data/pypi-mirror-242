...
class Gear(_2462.MountableComponent):
    """Gear
    ...
    @property
    def active_gear_design(self: Self) -> "_945.GearDesign":
    ...
    @property
    def gear_set(self: Self) -> "_2530.GearSet":
    ...
    @property
    def shaft(self: Self) -> "_2480.Shaft":
