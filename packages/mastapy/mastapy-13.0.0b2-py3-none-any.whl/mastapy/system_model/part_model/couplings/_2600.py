...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.couplings import _2604, _2602
...
class Synchroniser(_2474.SpecialisedAssembly):
    """Synchroniser
    ...
    @property
    def clutch_connection_left(self: Self) -> "_2340.ClutchConnection":
    ...
    @property
    def clutch_connection_right(self: Self) -> "_2340.ClutchConnection":
        """mastapy.system_model.connections_and_sockets.couplings.ClutchConnection
    ...
    @property
    def hub_and_sleeve(self: Self) -> "_2604.SynchroniserSleeve":
    ...
    @property
    def left_cone(self: Self) -> "_2602.SynchroniserHalf":
    ...
    @property
    def right_cone(self: Self) -> "_2602.SynchroniserHalf":
        """mastapy.system_model.part_model.couplings.SynchroniserHalf
