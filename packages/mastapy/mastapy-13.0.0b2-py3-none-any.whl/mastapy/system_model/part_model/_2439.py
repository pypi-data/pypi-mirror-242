...
from mastapy.bearings.bearing_results import _1961, _1962
...
class BearingRaceMountingOptions(_0.APIBase):
    ...
    class _Cast_BearingRaceMountingOptions:
        ...
        def inner_bearing_race_mounting_options(
            ...
            return self._parent._cast(_2456.InnerBearingRaceMountingOptions)
        ...
        def outer_bearing_race_mounting_options(
            ...
            return self._parent._cast(_2465.OuterBearingRaceMountingOptions)
    ...
    def axial_mounting(self: Self, value: "_1961.RaceAxialMountingType"):
    ...
    @enforce_parameter_types
    def simple_radial_mounting(self: Self, value: "_1962.RaceRadialMountingType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def mounting_sleeve_material(self: Self) -> "_243.BearingMaterial":
