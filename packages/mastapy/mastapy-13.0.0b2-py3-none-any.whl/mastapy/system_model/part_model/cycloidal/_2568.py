...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1459, _1460
...
class RingPins(_2462.MountableComponent):
    """RingPins
    ...
    @property
    def ring_pins_design(self: Self) -> "_1459.RingPinsDesign":
    ...
    @property
    def ring_pins_material(self: Self) -> "_1460.RingPinsMaterial":
