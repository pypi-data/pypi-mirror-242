...
from mastapy.system_model.part_model.part_groups import _2484
...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.part_groups import _2485
...
class ParallelPartGroup(_2484.ConcentricOrParallelPartGroup):
    """ParallelPartGroup
    ...
    class _Cast_ParallelPartGroup:
        ...
        def concentric_or_parallel_part_group(
            ...
            return self._parent._cast(_2484.ConcentricOrParallelPartGroup)
        ...
        def part_group(self: "ParallelPartGroup._Cast_ParallelPartGroup"):
            ...
            return self._parent._cast(_2490.PartGroup)
        ...
        def parallel_part_group_selection(
            ...
            return self._parent._cast(_2489.ParallelPartGroupSelection)
    ...
    @property
    def concentric_part_groups(self: Self) -> "List[_2485.ConcentricPartGroup]":
