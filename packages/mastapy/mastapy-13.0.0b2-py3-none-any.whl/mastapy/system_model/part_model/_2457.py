...
from mastapy.bearings.tolerances import _1900, _1902
...
class InternalClearanceTolerance(_0.APIBase):
    ...
    class _Cast_InternalClearanceTolerance:
        ...
        def axial_internal_clearance_tolerance(
            ...
            return self._parent._cast(_2436.AxialInternalClearanceTolerance)
        ...
        def radial_internal_clearance_tolerance(
            ...
            return self._parent._cast(_2471.RadialInternalClearanceTolerance)
    ...
    def clearance_class(self: Self, value: "_1900.InternalClearanceClass"):
