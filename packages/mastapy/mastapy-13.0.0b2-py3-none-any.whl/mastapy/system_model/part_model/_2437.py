...
from mastapy.bearings.bearing_results import _1940, _1959
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings import _1871, _1884, _1867
    from mastapy.system_model.part_model import _2438, _2436, _2471, _2439, _2443
...
class Bearing(_2445.Connector):
    ...
    @enforce_parameter_types
    def bearing_tolerance_class(self: Self, value: "_1901.BearingToleranceClass"):
    ...
    def bearing_tolerance_definition(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.tolerances._1902", "BearingToleranceDefinitionOptions"
        )(value)

    @bearing_tolerance_definition.setter
    @enforce_parameter_types
    def bearing_tolerance_definition(
        self: Self, value: "_1902.BearingToleranceDefinitionOptions"
    ):
    ...
    @property
    def damping_options(self: Self) -> "_1871.BearingDampingMatrixOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1871", "BearingDampingMatrixOption"
        )(value)

    @damping_options.setter
    @enforce_parameter_types
    def damping_options(self: Self, value: "_1871.BearingDampingMatrixOption"):
        value = conversion.mp_to_pn_enum(
    ...
    def efficiency_rating_method(
        self: Self,
        value: "Union[_290.BearingEfficiencyRatingMethod, Tuple[_290.BearingEfficiencyRatingMethod, bool]]",
    ):
        wrapper_type = (
    ...
    def force_at_zero_displacement_input_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2438", "BearingF0InputMethod"
        )(value)

    @force_at_zero_displacement_input_method.setter
    @enforce_parameter_types
    def force_at_zero_displacement_input_method(
        self: Self, value: "_2438.BearingF0InputMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def inner_fitting_chart(self: Self) -> "_1784.SimpleChartDefinition":
    ...
    @property
    def journal_bearing_type(self: Self) -> "_1884.JournalBearingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1884", "JournalBearingType"
        )(value)

    @journal_bearing_type.setter
    @enforce_parameter_types
    def journal_bearing_type(self: Self, value: "_1884.JournalBearingType"):
        value = conversion.mp_to_pn_enum(
    ...
    @model.setter
    @enforce_parameter_types
    def model(self: Self, value: "_1875.BearingModel"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def orientation(self: Self) -> "_1958.Orientations":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings.bearing_results._1958", "Orientations"
        )(value)

    @orientation.setter
    @enforce_parameter_types
    def orientation(self: Self, value: "_1958.Orientations"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def outer_fitting_chart(self: Self) -> "_1784.SimpleChartDefinition":
        """mastapy.utility.report.SimpleChartDefinition
    ...
    def permissible_axial_load_calculation_method(
        self: Self,
        value: "Union[_1940.CylindricalRollerMaxAxialLoadMethod, Tuple[_1940.CylindricalRollerMaxAxialLoadMethod, bool]]",
    ):
        wrapper_type = (
    ...
    @preload.setter
    @enforce_parameter_types
    def preload(self: Self, value: "_1959.PreloadType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def detail(self: Self) -> "_2128.BearingDesign":
    ...
    @property
    def friction_coefficients(self: Self) -> "_2068.RollingBearingFrictionCoefficients":
    ...
    @property
    def inner_support_detail(self: Self) -> "_1918.SupportDetail":
    ...
    @property
    def left_support_detail(self: Self) -> "_1918.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def outer_support_detail(self: Self) -> "_1918.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def overridden_lubrication_detail(self: Self) -> "_265.LubricationDetail":
    ...
    @property
    def right_support_detail(self: Self) -> "_1918.SupportDetail":
        """mastapy.bearings.tolerances.SupportDetail
    ...
    @property
    def ring_tolerance_inner(self: Self) -> "_1904.InnerRingTolerance":
    ...
    @property
    def ring_tolerance_left(self: Self) -> "_1915.RingTolerance":
    ...
    @property
    def ring_tolerance_outer(self: Self) -> "_1910.OuterRingTolerance":
    ...
    @property
    def ring_tolerance_right(self: Self) -> "_1915.RingTolerance":
        """mastapy.bearings.tolerances.RingTolerance
    ...
    @property
    def simple_bearing_detail_property(self: Self) -> "_2128.BearingDesign":
        """mastapy.bearings.bearing_designs.BearingDesign
    ...
    @property
    def support_tolerance_inner(self: Self) -> "_1905.InnerSupportTolerance":
        """mastapy.bearings.tolerances.InnerSupportTolerance
    ...
    @property
    def support_tolerance_left(self: Self) -> "_1920.SupportTolerance":
    ...
    @property
    def support_tolerance_outer(self: Self) -> "_1911.OuterSupportTolerance":
        """mastapy.bearings.tolerances.OuterSupportTolerance
    ...
    @property
    def support_tolerance_right(self: Self) -> "_1920.SupportTolerance":
        """mastapy.bearings.tolerances.SupportTolerance
    ...
    @property
    def mounting(self: Self) -> "List[_2439.BearingRaceMountingOptions]":
    ...
    @property
    def tolerance_combinations(self: Self) -> "List[_1922.ToleranceCombination]":
    ...
    def set_detail_from_catalogue(
        self: Self, catalogue: "_1867.BearingCatalog", designation: "str"
    ):
    ...
    def try_attach_left_side_to(
        self: Self, shaft: "_2480.Shaft", offset: "float" = float("nan")
