...
from mastapy.system_model.part_model import _2470, _2473
...
if TYPE_CHECKING:
    from mastapy.system_model_gui import _1844
    from mastapy.gears import _320, _326
    from mastapy.system_model import _2221, _2222, _2206, _2203, _2220, _2210
    ...
    from mastapy.utility import _1580, _1581
    ...
    from mastapy.system_model.part_model.configurations import _2613, _2610, _2612
    from mastapy.bearings.bearing_results.rolling import _1974
    from mastapy.system_model.database_access import _2262
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6802, _6801
    from mastapy.utility.model_validation import _1791
    from mastapy.system_model.analyses_and_results.synchroniser_analysis import _2980
    ...
    from mastapy.gears.gear_designs.creation_options import _1144, _1146, _1147
...
class Design(_0.APIBase):
    ...
    @property
    def masta_gui(self: Self) -> "_1844.MASTAGUI":
    ...
    @property
    def axial_contact_ratio_requirement(self: Self) -> "_320.ContactRatioRequirements":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._320", "ContactRatioRequirements"
        )(value)

    @axial_contact_ratio_requirement.setter
    @enforce_parameter_types
    def axial_contact_ratio_requirement(
        self: Self, value: "_320.ContactRatioRequirements"
    ):
    ...
    def efficiency_rating_method_for_bearings(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials.efficiency._290", "BearingEfficiencyRatingMethod"
        )(value)

    @efficiency_rating_method_for_bearings.setter
    @enforce_parameter_types
    def efficiency_rating_method_for_bearings(
        self: Self, value: "_290.BearingEfficiencyRatingMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def gear_set_configuration(
        self: Self, value: "_2510.ActiveGearSetDesignSelectionGroup"
    ):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def input_power_load(self: Self, value: "_2470.PowerLoad"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def output_power_load(self: Self, value: "_2470.PowerLoad"):
        wrapper_type = (
            list_with_selected_item.ListWithSelectedItem_PowerLoad.wrapper_type()
        )
        enclosed_type = (
    ...
    @enforce_parameter_types
    def shaft_diameter_modification_due_to_rolling_bearing_rings(
        self: Self, value: "_2473.ShaftDiameterModificationDueToRollingBearingRing"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def thermal_expansion_for_grounded_nodes(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2221", "ThermalExpansionOptionForGroundedNodes"
        )(value)

    @thermal_expansion_for_grounded_nodes.setter
    @enforce_parameter_types
    def thermal_expansion_for_grounded_nodes(
        self: Self, value: "_2221.ThermalExpansionOptionForGroundedNodes"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def unbalanced_mass_inclusion(self: Self) -> "_2476.UnbalancedMassInclusionOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model._2476", "UnbalancedMassInclusionOption"
        )(value)

    @unbalanced_mass_inclusion.setter
    @enforce_parameter_types
    def unbalanced_mass_inclusion(
        self: Self, value: "_2476.UnbalancedMassInclusionOption"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def default_system_temperatures(self: Self) -> "_2222.TransmissionTemperatureSet":
    ...
    @property
    def detailed_spline_settings(self: Self) -> "_1388.DetailedSplineJointSettings":
    ...
    @property
    def electric_machine_group(self: Self) -> "_2206.ElectricMachineGroup":
    ...
    @property
    def fe_batch_operations(self: Self) -> "_2359.BatchOperations":
    ...
    @property
    def file_save_details_all(self: Self) -> "_1580.FileHistory":
    ...
    @property
    def file_save_details_most_recent(self: Self) -> "_1581.FileHistoryItem":
    ...
    @property
    def gear_set_design_group(self: Self) -> "_326.GearSetDesignGroup":
    ...
    @property
    def settings(self: Self) -> "_2203.DesignSettings":
    ...
    @property
    def system(self: Self) -> "_2220.SystemReporting":
    ...
    @property
    def system_optimiser_details(self: Self) -> "_2238.SystemOptimiserDetails":
    ...
    def bearing_detail_configurations(
        self: Self,
    ) -> "List[_2613.BearingDetailConfiguration]":
    ...
    def fe_substructure_configurations(
        self: Self,
    ) -> "List[_2610.ActiveFESubstructureSelectionGroup]":
    ...
    def gear_set_configurations(
        self: Self,
    ) -> "List[_2510.ActiveGearSetDesignSelectionGroup]":
    ...
    def iso14179_settings_per_bearing_type(
        self: Self,
    ) -> "List[_1974.ISO14179SettingsPerBearingType]":
    ...
    def shaft_detail_configurations(
        self: Self,
    ) -> "List[_2612.ActiveShaftDesignSelectionGroup]":
    ...
    @property
    def databases(self: Self) -> "_2262.Databases":
    ...
    @property
    def design_states(self: Self) -> "List[_5660.DesignState]":
    ...
    @property
    def duty_cycles(self: Self) -> "List[_5661.DutyCycle]":
    ...
    @property
    def gear_set_config(self: Self) -> "_2531.GearSetConfiguration":
    ...
    @enforce_parameter_types
    def gear_set_config(self: Self, value: "_2531.GearSetConfiguration"):
        self.wrapped.GearSetConfig = value.wrapped

    @property
    def masta_settings(self: Self) -> "_2210.MASTASettings":
    ...
    @property
    def root_assembly(self: Self) -> "_2472.RootAssembly":
    ...
    @property
    def static_loads(self: Self) -> "List[_6802.StaticLoadCase]":
    ...
    @property
    def system_optimiser(self: Self) -> "_2237.SystemOptimiser":
    ...
    def time_series_load_case_groups(
        self: Self,
    ) -> "List[_5668.TimeSeriesLoadCaseGroup]":
    ...
    @enforce_parameter_types
    def add_duty_cycle(self: Self, name: "str" = "New Duty Cycle") -> "_5661.DutyCycle":
    ...
    def add_synchroniser_shift_empty(self: Self) -> "_2980.SynchroniserShift":
    ...
    @enforce_parameter_types
    def add_synchroniser_shift(self: Self, name: "str") -> "_2980.SynchroniserShift":
        """mastapy.system_model.analyses_and_results.synchroniser_analysis.SynchroniserShift
    ...
    @enforce_parameter_types
    def design_state_named(self: Self, name: "str") -> "_5660.DesignState":
        """mastapy.system_model.analyses_and_results.load_case_groups.DesignState
    ...
    @enforce_parameter_types
    def duty_cycle_named(self: Self, name: "str") -> "_5661.DutyCycle":
        """mastapy.system_model.analyses_and_results.load_case_groups.DutyCycle
    ...
    def remove_bearing_from_database(
        self: Self, rolling_bearing: "_2163.RollingBearing"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_synchroniser_shift(self: Self, shift: "_2980.SynchroniserShift"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def save(self: Self, file_name: "str", save_results: "bool") -> "_1791.Status":
        """mastapy.utility.model_validation.Status
    ...
    def save_load_case_results(
        self: Self, file_name: "str", load_cases: "List[_6801.LoadCase]"
    ):
        """Method does not return.
    ...
    def all_parts_of_type_assembly(self: Self) -> "List[_2431.Assembly]":
    ...
    def load(
        file_path: "str",
        load_full_fe_option: "_1579.ExternalFullFEFileOption" = _1579.ExternalFullFEFileOption.MESH_AND_EXPANSION_VECTORS,
    ) -> "Design":
        """mastapy.system_model.Design
