...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.optimization.system_optimiser import _2238, _2239, _2235
    from mastapy.utility.logging import _1806
    from mastapy.system_model.part_model.gears import _2524, _2530
...
class SystemOptimiser(_0.APIBase):
    ...
    def selected_duty_cycle_for_system_optimiser(self: Self, value: "_5661.DutyCycle"):
        wrapper_type = (
    ...
    @property
    def design(self: Self) -> "_2198.Design":
    ...
    @property
    def details(self: Self) -> "_2238.SystemOptimiserDetails":
    ...
    @property
    def log(self: Self) -> "_1806.Logger":
    ...
    @property
    def tooth_number_finder(self: Self) -> "_2239.ToothNumberFinder":
    ...
    @property
    def gear_set_ratings(self: Self) -> "List[_360.GearSetDutyCycleRating]":
        """List[mastapy.gears.rating.GearSetDutyCycleRating]

        Note:
            This property is readonly.
        """
        temp = self.wrapped.GearSetRatings
    ...
    def system_optimisation_gear_sets(
        self: Self,
    ) -> "List[_5665.SystemOptimisationGearSet]":
    ...
    @property
    def target_ratios(self: Self) -> "List[_2235.DesignStateTargetRatio]":
    ...
    @property
    def system_optimiser_duty_cycle(self: Self) -> "_5661.DutyCycle":
    ...
    @enforce_parameter_types
    def system_optimiser_duty_cycle(self: Self, value: "_5661.DutyCycle"):
