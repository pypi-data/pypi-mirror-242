...
class ModalContributionViewOptions(_0.APIBase):
    ...
    @property
    def filtering_frequency_range(self: Self) -> "_1486.Range":
    ...
    @enforce_parameter_types
    def filtering_frequency_range(self: Self, value: "_1486.Range"):
        self.wrapped.FilteringFrequencyRange = value.wrapped

    @property
    def filtering_method(self: Self) -> "_5847.ModalContributionFilteringMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.harmonic_analyses.results._5847",
            "ModalContributionFilteringMethod",
        )(value)

    @filtering_method.setter
    @enforce_parameter_types
    def filtering_method(self: Self, value: "_5847.ModalContributionFilteringMethod"):
    ...
    @property
    def frequency_range(self: Self) -> "_1486.Range":
        """mastapy.math_utility.Range"""
    ...
    @enforce_parameter_types
    def frequency_range(self: Self, value: "_1486.Range"):
    ...
    @property
    def index_range(self: Self) -> "_1586.IntegerRange":
    ...
    @index_range.setter
    @enforce_parameter_types
    def index_range(self: Self, value: "_1586.IntegerRange"):
        self.wrapped.IndexRange = value.wrapped

    @property
    def modes_to_display(self: Self) -> "_5846.ModalContributionDisplayMethod":
    ...
    @enforce_parameter_types
    def modes_to_display(self: Self, value: "_5846.ModalContributionDisplayMethod"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ModalContributionDisplayMethod",
        )
