...
class ContourDrawStyle(_306.DrawStyleBase):
    ...
    class _Cast_ContourDrawStyle:
        ...
        def system_deflection_draw_style(
            ...
            return self._parent._cast(_2824.SystemDeflectionDrawStyle)
        ...
        def steady_state_synchronous_response_draw_style(
            ...
            return self._parent._cast(_3088.SteadyStateSynchronousResponseDrawStyle)
        ...
        def stability_analysis_draw_style(
            ...
            return self._parent._cast(_3869.StabilityAnalysisDrawStyle)

        @property
        def rotor_dynamics_draw_style(self: "ContourDrawStyle._Cast_ContourDrawStyle"):
            from mastapy.system_model.analyses_and_results.rotor_dynamics import _4024

            return self._parent._cast(_4024.RotorDynamicsDrawStyle)
        ...
        def modal_analysis_draw_style(self: "ContourDrawStyle._Cast_ContourDrawStyle"):
            ...
            return self._parent._cast(_4653.ModalAnalysisDrawStyle)

        @property
        def mbd_analysis_draw_style(self: "ContourDrawStyle._Cast_ContourDrawStyle"):
            from mastapy.system_model.analyses_and_results.mbd_analyses import _5457

            return self._parent._cast(_5457.MBDAnalysisDrawStyle)
        ...
        def harmonic_analysis_draw_style(
            ...
            return self._parent._cast(_5759.HarmonicAnalysisDrawStyle)
        ...
        def dynamic_analysis_draw_style(
            ...
            return self._parent._cast(_6327.DynamicAnalysisDrawStyle)
        ...
        def critical_speed_analysis_draw_style(
            ...
            return self._parent._cast(_6581.CriticalSpeedAnalysisDrawStyle)
    ...
    @property
    def contour(self: Self) -> "_1819.ThreeDViewContourOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.enums._1819", "ThreeDViewContourOption"
        )(value)

    @contour.setter
    @enforce_parameter_types
    def contour(self: Self, value: "_1819.ThreeDViewContourOption"):
    ...
    @property
    def deflection_scaling(self: Self) -> "_1849.ScalingDrawStyle":
    ...
    @property
    def model_view_options(self: Self) -> "_2250.ModelViewOptionsDrawStyle":
