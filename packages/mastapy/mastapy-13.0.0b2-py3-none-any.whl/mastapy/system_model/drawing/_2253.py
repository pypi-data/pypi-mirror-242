...
class RotorDynamicsViewable(_0.APIBase):
    ...
    class _Cast_RotorDynamicsViewable:
        ...
        def critical_speed_analysis_viewable(
            ...
            return self._parent._cast(_2245.CriticalSpeedAnalysisViewable)
        ...
        def stability_analysis_viewable(
            ...
            return self._parent._cast(_2255.StabilityAnalysisViewable)
        ...
        def steady_state_synchronous_response_viewable(
            ...
            return self._parent._cast(_2256.SteadyStateSynchronousResponseViewable)
    ...
    @property
    def rotor_dynamics(self: Self) -> "_4024.RotorDynamicsDrawStyle":
