...
from mastapy.utility.enums import _1820, _1821
...
class PartAnalysisCaseWithContourViewable(_0.APIBase):
    ...
    class _Cast_PartAnalysisCaseWithContourViewable:
        ...
        def abstract_system_deflection_viewable(
            ...
            return self._parent._cast(_2241.AbstractSystemDeflectionViewable)
        ...
        def advanced_system_deflection_viewable(
            ...
            return self._parent._cast(_2242.AdvancedSystemDeflectionViewable)
        ...
        def harmonic_analysis_viewable(
            ...
            return self._parent._cast(_2247.HarmonicAnalysisViewable)
        ...
        def modal_analysis_viewable(
            ...
            return self._parent._cast(_2249.ModalAnalysisViewable)
        ...
        def system_deflection_viewable(
            ...
            return self._parent._cast(_2258.SystemDeflectionViewable)
    ...
    def contour(self: Self, value: "_1820.ThreeDViewContourOptionFirstSelection"):
    ...
    @enforce_parameter_types
    def contour_secondary(
        self: Self, value: "_1821.ThreeDViewContourOptionSecondSelection"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def contour_draw_style(self: Self) -> "_2244.ContourDrawStyle":
