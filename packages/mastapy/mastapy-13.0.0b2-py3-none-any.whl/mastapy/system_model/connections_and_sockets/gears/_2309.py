...
class FaceGearMesh(_2311.GearMesh):
    """FaceGearMesh
    ...
    @property
    def active_gear_mesh_design(self: Self) -> "_989.FaceGearMeshDesign":
    ...
    @property
    def face_gear_mesh_design(self: Self) -> "_989.FaceGearMeshDesign":
        """mastapy.gears.gear_designs.face.FaceGearMeshDesign
