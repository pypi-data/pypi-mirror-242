...
class ConceptGearMesh(_2311.GearMesh):
    """ConceptGearMesh
    ...
    @property
    def active_gear_mesh_design(self: Self) -> "_1175.ConceptGearMeshDesign":
    ...
    @property
    def concept_gear_mesh_design(self: Self) -> "_1175.ConceptGearMeshDesign":
        """mastapy.gears.gear_designs.concept.ConceptGearMeshDesign
