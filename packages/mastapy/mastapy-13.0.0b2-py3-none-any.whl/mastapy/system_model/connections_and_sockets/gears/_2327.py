...
class WormGearMesh(_2311.GearMesh):
    """WormGearMesh
    ...
    @property
    def active_gear_mesh_design(self: Self) -> "_956.WormGearMeshDesign":
    ...
    @property
    def worm_gear_mesh_design(self: Self) -> "_956.WormGearMeshDesign":
        """mastapy.gears.gear_designs.worm.WormGearMeshDesign
