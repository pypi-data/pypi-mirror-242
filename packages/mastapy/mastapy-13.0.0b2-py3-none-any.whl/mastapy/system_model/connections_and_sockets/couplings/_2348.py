...
if TYPE_CHECKING:
    from mastapy.system_model import _2199
...
class SpringDamperConnection(_2344.CouplingConnection):
    """SpringDamperConnection
    ...
    @property
    def damping_option(self: Self) -> "_2199.ComponentDampingOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2199", "ComponentDampingOption"
        )(value)

    @damping_option.setter
    @enforce_parameter_types
    def damping_option(self: Self, value: "_2199.ComponentDampingOption"):
