...
from mastapy.system_model.analyses_and_results.flexible_pin_analyses import _6265
...
class FlexiblePinAnalysis(_6265.CombinationAnalysis):
    """FlexiblePinAnalysis
    ...
    class _Cast_FlexiblePinAnalysis:
        ...
        def combination_analysis(self: "FlexiblePinAnalysis._Cast_FlexiblePinAnalysis"):
            return self._parent._cast(_6265.CombinationAnalysis)
        ...
        def flexible_pin_analysis_concept_level(
            ...
            return self._parent._cast(_6267.FlexiblePinAnalysisConceptLevel)
        ...
        def flexible_pin_analysis_gear_and_bearing_rating(
            ...
            return self._parent._cast(_6269.FlexiblePinAnalysisGearAndBearingRating)
        ...
        def flexible_pin_analysis_manufacture_level(
            ...
            return self._parent._cast(_6270.FlexiblePinAnalysisManufactureLevel)
        ...
        def flexible_pin_analysis_stop_start_analysis(
            ...
            return self._parent._cast(_6272.FlexiblePinAnalysisStopStartAnalysis)
    ...
    @property
    def analysis_options(self: Self) -> "_6271.FlexiblePinAnalysisOptions":
