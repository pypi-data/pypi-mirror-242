...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1016, _1010
...
class CylindricalGearMeshAdvancedSystemDeflection(
    ...
    @property
    def inactive_flank(self: Self) -> "_321.CylindricalFlanks":
        """mastapy.gears.CylindricalFlanks
    ...
    @property
    def gear_mesh_design(self: Self) -> "_1016.CylindricalGearMeshDesign":
    ...
    @property
    def points_with_worst_results(self: Self) -> "_1212.PointsWithWorstResults":
    ...
    def cylindrical_gear_advanced_analyses(
        self: Self,
    ) -> "List[_7318.CylindricalGearAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_mesh_system_deflection_results(
        self: Self,
    ) -> "List[_2738.CylindricalGearMeshSystemDeflectionTimestep]":
    ...
    @property
    def gear_designs(self: Self) -> "List[_1010.CylindricalGearDesign]":
    ...
    def max_pressure_contact_chart_for_each_tooth_pass_for_gear_a(
        self: Self,
    ) -> "List[_7307.ContactChartPerToothPass]":
