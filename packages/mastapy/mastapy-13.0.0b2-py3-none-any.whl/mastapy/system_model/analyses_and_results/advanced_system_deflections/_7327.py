...
class FaceGearSetAdvancedSystemDeflection(_7332.GearSetAdvancedSystemDeflection):
    """FaceGearSetAdvancedSystemDeflection
    ...
    def face_gears_advanced_system_deflection(
        self: Self,
    ) -> "List[_7325.FaceGearAdvancedSystemDeflection]":
    ...
    def face_meshes_advanced_system_deflection(
        self: Self,
    ) -> "List[_7326.FaceGearMeshAdvancedSystemDeflection]":
