...
class WormGearSetAdvancedSystemDeflection(_7332.GearSetAdvancedSystemDeflection):
    """WormGearSetAdvancedSystemDeflection
    ...
    def assembly_system_deflection_results(
        self: Self,
    ) -> "List[_2835.WormGearSetSystemDeflection]":
    ...
    def worm_gears_advanced_system_deflection(
        self: Self,
    ) -> "List[_7397.WormGearAdvancedSystemDeflection]":
    ...
    def worm_meshes_advanced_system_deflection(
        self: Self,
    ) -> "List[_7398.WormGearMeshAdvancedSystemDeflection]":
