...
class SpringDamperConnectionSystemDeflection(_2727.CouplingConnectionSystemDeflection):
    """SpringDamperConnectionSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4136.SpringDamperConnectionPowerFlow":
