...
class CylindricalGearMeshSystemDeflection(_2757.GearMeshSystemDeflection):
    """CylindricalGearMeshSystemDeflection
    ...
    @property
    def gear_a(self: Self) -> "_2743.CylindricalGearSystemDeflection":
    ...
    @property
    def gear_b(self: Self) -> "_2743.CylindricalGearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.CylindricalGearSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4078.CylindricalGearMeshPowerFlow":
    ...
    @property
    def cylindrical_gears(self: Self) -> "List[_2743.CylindricalGearSystemDeflection]":
    ...
    def cylindrical_meshed_gear_system_deflections(
        self: Self,
    ) -> "List[_2747.CylindricalMeshedGearSystemDeflection]":
    ...
    @property
    def mesh_deflections_left_flank(self: Self) -> "List[_2843.MeshDeflectionResults]":
    ...
    @property
    def mesh_deflections_right_flank(self: Self) -> "List[_2843.MeshDeflectionResults]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.reporting.MeshDeflectionResults]
    ...
    @property
    def gear_set(self: Self) -> "_2740.CylindricalGearSetSystemDeflection":
