...
class RootAssemblySystemDeflection(_2690.AssemblySystemDeflection):
    """RootAssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4128.RootAssemblyPowerFlow":
    ...
    @property
    def system_deflection_inputs(self: Self) -> "_2823.SystemDeflection":
    ...
    def shaft_deflection_results(
        self: Self,
    ) -> "List[_2714.ConcentricPartGroupCombinationSystemDeflectionResults]":
