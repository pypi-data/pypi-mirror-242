...
class WormGearMeshSystemDeflection(_2757.GearMeshSystemDeflection):
    """WormGearMeshSystemDeflection
    ...
    @property
    def rating(self: Self) -> "_371.WormGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_371.WormGearMeshRating":
        """mastapy.gears.rating.worm.WormGearMeshRating
    ...
    @property
    def power_flow_results(self: Self) -> "_4158.WormGearMeshPowerFlow":
