...
class AssemblySystemDeflection(_2683.AbstractAssemblySystemDeflection):
    """AssemblySystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4037.AssemblyPowerFlow":
    ...
    @property
    def bearings(self: Self) -> "List[_2696.BearingSystemDeflection]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_2698.BeltDriveSystemDeflection]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_2707.BoltedJointSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_2708.BoltSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_2732.CVTSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_2711.ClutchSystemDeflection]":
    ...
    @property
    def component_details(self: Self) -> "List[_2713.ComponentSystemDeflection]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_2717.ConceptCouplingSystemDeflection]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_2719.ConceptGearSetSystemDeflection]":
    ...
    @property
    def connection_details(self: Self) -> "List[_2725.ConnectionSystemDeflection]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_2736.CycloidalDiscSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_2740.CylindricalGearSetSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_2755.FEPartSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_2753.FaceGearSetSystemDeflection]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_2762.HypoidGearSetSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_2770.KlingelnbergCycloPalloidHypoidGearSetSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_2773.KlingelnbergCycloPalloidSpiralBevelGearSetSystemDeflection]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_2777.MassDiscSystemDeflection]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_2778.MeasurementComponentSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_2782.OilSealSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_2786.PartToPartShearCouplingSystemDeflection]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_2788.PlanetCarrierSystemDeflection]":
    ...
    @property
    def point_loads(self: Self) -> "List[_2789.PointLoadSystemDeflection]":
    ...
    @property
    def power_loads(self: Self) -> "List[_2790.PowerLoadSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_2792.RingPinsSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: Self) -> "List[_2696.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_2795.RollingRingAssemblySystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_2802.ShaftSystemDeflection]":
    ...
    def shafts_and_housings(
        self: Self,
    ) -> "List[_2684.AbstractShaftOrHousingSystemDeflection]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_2810.SpringDamperSystemDeflection]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_2822.SynchroniserSystemDeflection]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_2828.TorqueConverterSystemDeflection]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_2832.UnbalancedMassSystemDeflection]":
    ...
    def unconverged_bearings_sorted_by_load(
        self: Self,
    ) -> "List[_2696.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_2835.WormGearSetSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_2838.ZerolBevelGearSetSystemDeflection]":
