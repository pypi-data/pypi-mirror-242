...
class GearMeshSystemDeflection(_2765.InterMountableComponentConnectionSystemDeflection):
    """GearMeshSystemDeflection
    ...
    @property
    def gear_a(self: Self) -> "_2759.GearSystemDeflection":
    ...
    @property
    def gear_b(self: Self) -> "_2759.GearSystemDeflection":
        """mastapy.system_model.analyses_and_results.system_deflections.GearSystemDeflection
    ...
    @property
    def mesh_separations(self: Self) -> "List[_2779.MeshSeparationsAtFaceWidth]":
    ...
    @property
    def gear_set(self: Self) -> "_2758.GearSetSystemDeflection":
    ...
    @property
    def power_flow_results(self: Self) -> "_4090.GearMeshPowerFlow":
