...
class StraightBevelDiffGearMeshSystemDeflection(_2704.BevelGearMeshSystemDeflection):
    """StraightBevelDiffGearMeshSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4139.StraightBevelDiffGearMeshPowerFlow":
