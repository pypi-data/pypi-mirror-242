...
class PartToPartShearCouplingHalfSystemDeflection(_2728.CouplingHalfSystemDeflection):
    """PartToPartShearCouplingHalfSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4113.PartToPartShearCouplingHalfPowerFlow":
