...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility.measured_vectors import _1562, _1558
...
class FEPartSystemDeflection(_2684.AbstractShaftOrHousingSystemDeflection):
    """FEPartSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4088.FEPartPowerFlow":
    ...
    @property
    def export(self: Self) -> "_2408.SystemDeflectionFEExportOptions":
