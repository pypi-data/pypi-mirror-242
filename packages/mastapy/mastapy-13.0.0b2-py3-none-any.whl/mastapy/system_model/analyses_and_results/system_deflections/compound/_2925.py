...
class MassDiscCompoundSystemDeflection(_2973.VirtualComponentCompoundSystemDeflection):
    """MassDiscCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2777.MassDiscSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.MassDiscSystemDeflection]
