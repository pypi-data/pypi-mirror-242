...
class PartCompoundSystemDeflection(_7543.PartCompoundAnalysis):
    """PartCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2783.PartSystemDeflection]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2783.PartSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PartSystemDeflection]
