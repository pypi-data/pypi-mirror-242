...
class ConceptGearSetCompoundSystemDeflection(_2910.GearSetCompoundSystemDeflection):
    """ConceptGearSetCompoundSystemDeflection
    ...
    def concept_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2878.ConceptGearCompoundSystemDeflection]":
    ...
    def concept_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2879.ConceptGearMeshCompoundSystemDeflection]":
