...
class CVTPulleyCompoundSystemDeflection(_2938.PulleyCompoundSystemDeflection):
    """CVTPulleyCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2731.CVTPulleySystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2731.CVTPulleySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.CVTPulleySystemDeflection]
