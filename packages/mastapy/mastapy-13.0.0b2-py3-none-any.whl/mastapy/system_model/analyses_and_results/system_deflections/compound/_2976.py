...
class WormGearSetCompoundSystemDeflection(_2910.GearSetCompoundSystemDeflection):
    """WormGearSetCompoundSystemDeflection
    ...
    @property
    def worm_gear_set_rating(self: Self) -> "_373.WormGearSetDutyCycleRating":
    ...
    def worm_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2974.WormGearCompoundSystemDeflection]":
    ...
    def worm_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2975.WormGearMeshCompoundSystemDeflection]":
