...
class CylindricalGearMeshCompoundSystemDeflection(
    ...
    @property
    def component_design(self: Self) -> "_2307.CylindricalGearMesh":
    ...
    @property
    def cylindrical_mesh_rating(self: Self) -> "_464.CylindricalMeshDutyCycleRating":
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_2739.CylindricalGearMeshSystemDeflectionWithLTCAResults]":
