...
class PointLoadCompoundSystemDeflection(_2973.VirtualComponentCompoundSystemDeflection):
    """PointLoadCompoundSystemDeflection
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2789.PointLoadSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.PointLoadSystemDeflection]
