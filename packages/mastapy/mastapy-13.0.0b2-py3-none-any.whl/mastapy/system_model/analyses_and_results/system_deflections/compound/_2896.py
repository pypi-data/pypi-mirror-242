...
class CylindricalGearCompoundSystemDeflection(_2908.GearCompoundSystemDeflection):
    """CylindricalGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self: Self) -> "_453.CylindricalGearDutyCycleRating":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2745.CylindricalGearSystemDeflectionWithLTCAResults]":
