...
class BearingCompoundStabilityAnalysis(_3931.ConnectorCompoundStabilityAnalysis):
    """BearingCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3769.BearingStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3769.BearingStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.BearingStabilityAnalysis]
