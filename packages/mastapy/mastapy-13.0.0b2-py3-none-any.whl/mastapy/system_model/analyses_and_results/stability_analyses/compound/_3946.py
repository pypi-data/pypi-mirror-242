...
class DatumCompoundStabilityAnalysis(_3920.ComponentCompoundStabilityAnalysis):
    """DatumCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3813.DatumStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3813.DatumStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.DatumStabilityAnalysis]
