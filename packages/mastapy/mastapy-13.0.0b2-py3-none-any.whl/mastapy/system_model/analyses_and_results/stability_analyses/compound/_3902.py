...
class AssemblyCompoundStabilityAnalysis(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3768.AssemblyStabilityAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_3903.BearingCompoundStabilityAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_3905.BeltDriveCompoundStabilityAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3908.BevelDifferentialGearSetCompoundStabilityAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_3915.BoltedJointCompoundStabilityAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_3914.BoltCompoundStabilityAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3936.CVTCompoundStabilityAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_3916.ClutchCompoundStabilityAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3921.ConceptCouplingCompoundStabilityAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3926.ConceptGearSetCompoundStabilityAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3938.CycloidalAssemblyCompoundStabilityAnalysis]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3940.CycloidalDiscCompoundStabilityAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3944.CylindricalGearSetCompoundStabilityAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_3951.FEPartCompoundStabilityAnalysis]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3950.FaceGearSetCompoundStabilityAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_3952.FlexiblePinAssemblyCompoundStabilityAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3959.HypoidGearSetCompoundStabilityAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3966.KlingelnbergCycloPalloidHypoidGearSetCompoundStabilityAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3969.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundStabilityAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_3970.MassDiscCompoundStabilityAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_3971.MeasurementComponentCompoundStabilityAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_3973.OilSealCompoundStabilityAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3975.PartToPartShearCouplingCompoundStabilityAnalysis]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3980.PlanetCarrierCompoundStabilityAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_3981.PointLoadCompoundStabilityAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_3982.PowerLoadCompoundStabilityAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_3984.RingPinsCompoundStabilityAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_3986.RollingRingAssemblyCompoundStabilityAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3991.ShaftHubConnectionCompoundStabilityAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_3990.ShaftCompoundStabilityAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3996.SpiralBevelGearSetCompoundStabilityAnalysis]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3997.SpringDamperCompoundStabilityAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4002.StraightBevelDiffGearSetCompoundStabilityAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4005.StraightBevelGearSetCompoundStabilityAnalysis]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_4008.SynchroniserCompoundStabilityAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4012.TorqueConverterCompoundStabilityAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_4016.UnbalancedMassCompoundStabilityAnalysis]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_4020.WormGearSetCompoundStabilityAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4023.ZerolBevelGearSetCompoundStabilityAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_3768.AssemblyStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.AssemblyStabilityAnalysis]
