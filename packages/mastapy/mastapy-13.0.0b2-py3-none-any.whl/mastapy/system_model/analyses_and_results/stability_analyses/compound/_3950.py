...
class FaceGearSetCompoundStabilityAnalysis(_3955.GearSetCompoundStabilityAnalysis):
    """FaceGearSetCompoundStabilityAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3817.FaceGearSetStabilityAnalysis]":
    ...
    def face_gears_compound_stability_analysis(
        self: Self,
    ) -> "List[_3948.FaceGearCompoundStabilityAnalysis]":
    ...
    def face_meshes_compound_stability_analysis(
        self: Self,
    ) -> "List[_3949.FaceGearMeshCompoundStabilityAnalysis]":
