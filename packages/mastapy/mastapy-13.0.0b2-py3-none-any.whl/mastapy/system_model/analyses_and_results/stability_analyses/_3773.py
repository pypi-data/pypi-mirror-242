...
class BevelDifferentialGearSetStabilityAnalysis(_3778.BevelGearSetStabilityAnalysis):
    """BevelDifferentialGearSetStabilityAnalysis
    ...
    def bevel_differential_gears_stability_analysis(
        self: Self,
    ) -> "List[_3774.BevelDifferentialGearStabilityAnalysis]":
    ...
    def bevel_differential_meshes_stability_analysis(
        self: Self,
    ) -> "List[_3772.BevelDifferentialGearMeshStabilityAnalysis]":
