...
TAssembly = TypeVar("TAssembly", bound="_2432.AbstractAssembly")
TAssemblyStaticLoad = TypeVar(
    "TAssemblyStaticLoad", bound="_6804.AbstractAssemblyLoadCase"
)


class AbstractAssemblyStaticLoadCaseGroup(
    _5674.PartStaticLoadCaseGroup, Generic[TAssembly, TAssemblyStaticLoad]
):
    """AbstractAssemblyStaticLoadCaseGroup
