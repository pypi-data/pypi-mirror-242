...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6946, _6801
...
class AbstractLoadCaseGroup(_0.APIBase):
    ...
    class _Cast_AbstractLoadCaseGroup:
        ...
        def abstract_static_load_case_group(
            ...
            return self._parent._cast(_5657.AbstractStaticLoadCaseGroup)
        ...
        def time_series_load_case_group(
            ...
            return self._parent._cast(_5668.TimeSeriesLoadCaseGroup)
    ...
    @property
    def model(self: Self) -> "_2198.Design":
    ...
    @property
    def parametric_analysis_options(self: Self) -> "_4386.ParametricStudyToolOptions":
    ...
    @property
    def load_case_root_assemblies(self: Self) -> "List[_6946.RootAssemblyLoadCase]":
    ...
    def create_load_cases(
        self: Self, number_of_load_cases: "int", token: "_7556.TaskProgress"
    ) -> "List[_6801.LoadCase]":
    ...
    @enforce_parameter_types
    def perform_pst_with_progress(self: Self, progress: "_7556.TaskProgress"):
        """Method does not return.
