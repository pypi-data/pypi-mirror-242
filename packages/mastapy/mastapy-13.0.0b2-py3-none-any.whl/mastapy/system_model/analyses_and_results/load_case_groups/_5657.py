...
from mastapy.system_model.part_model import _2437, _2451, _2469, _2470
...
from mastapy.system_model.part_model.gears import _2524, _2523, _2530, _2528
from mastapy.system_model.connections_and_sockets.gears import _2307, _2311
from mastapy.system_model.analyses_and_results.load_case_groups import _5656
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6802, _6815
...
class AbstractStaticLoadCaseGroup(_5656.AbstractLoadCaseGroup):
    """AbstractStaticLoadCaseGroup
    ...
    class _Cast_AbstractStaticLoadCaseGroup:
        ...
        def abstract_load_case_group(
            ...
            return self._parent._cast(_5656.AbstractLoadCaseGroup)

        @property
        def abstract_design_state_load_case_group(
            self: "AbstractStaticLoadCaseGroup._Cast_AbstractStaticLoadCaseGroup",
        ):
            return self._parent._cast(_5655.AbstractDesignStateLoadCaseGroup)
        ...
        def design_state(
            ...
            return self._parent._cast(_5660.DesignState)
        ...
        def duty_cycle(
            ...
            return self._parent._cast(_5661.DutyCycle)
        ...
        def sub_group_in_single_design_state(
            ...
            return self._parent._cast(_5664.SubGroupInSingleDesignState)
    ...
    def bearings(
        ...
        "List[_5670.ComponentStaticLoadCaseGroup[_2437.Bearing, _6817.BearingLoadCase]]"
    ):
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5673.GearSetStaticLoadCaseGroup[_2524.CylindricalGearSet, _2523.CylindricalGear, _6859.CylindricalGearLoadCase, _2307.CylindricalGearMesh, _6861.CylindricalGearMeshLoadCase, _6863.CylindricalGearSetLoadCase]]":
    ...
    @property
    def design_states(self: Self) -> "List[_5655.AbstractDesignStateLoadCaseGroup]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_5670.ComponentStaticLoadCaseGroup[_2451.FEPart, _6885.FEPartLoadCase]]":
    ...
    def gear_sets(
        self: Self,
    ) -> "List[_5673.GearSetStaticLoadCaseGroup[_2530.GearSet, _2528.Gear, _6888.GearLoadCase, _2311.GearMesh, _6890.GearMeshLoadCase, _6893.GearSetLoadCase]]":
    ...
    @property
    def parts_with_excitations(self: Self) -> "List[_5674.PartStaticLoadCaseGroup]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_5670.ComponentStaticLoadCaseGroup[_2469.PointLoad, _6936.PointLoadLoadCase]]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_5670.ComponentStaticLoadCaseGroup[_2470.PowerLoad, _6937.PowerLoadLoadCase]]":
    ...
    @property
    def compound_power_flow(self: Self) -> "_2674.CompoundPowerFlowAnalysis":
    ...
    @property
    def compound_harmonic_analysis(self: Self) -> "_2666.CompoundHarmonicAnalysis":
    ...
    @property
    def compound_modal_analysis(self: Self) -> "_2669.CompoundModalAnalysis":
    ...
    @property
    def compound_stability_analysis(self: Self) -> "_2675.CompoundStabilityAnalysis":
    ...
    @enforce_parameter_types
    def analysis_of(
        self: Self, analysis_type: "_6815.AnalysisType"
