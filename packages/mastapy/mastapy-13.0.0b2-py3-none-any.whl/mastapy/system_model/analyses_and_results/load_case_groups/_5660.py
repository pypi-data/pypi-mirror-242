...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.load_case_groups import _5658, _5659
...
class DesignState(_5655.AbstractDesignStateLoadCaseGroup):
    """DesignState
    ...
    @property
    def clutches(self: Self) -> "List[_5658.ClutchEngagementStatus]":
    ...
    def clutch_engagement_status_for(
        self: Self, clutch_connection: "_2340.ClutchConnection"
    ...
    def concept_synchro_gear_engagement_status_for(
        self: Self, gear: "_2523.CylindricalGear"
