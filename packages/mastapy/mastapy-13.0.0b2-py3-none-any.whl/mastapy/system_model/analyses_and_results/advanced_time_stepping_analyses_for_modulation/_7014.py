...
class AssemblyAdvancedTimeSteppingAnalysisForModulation(
    ...
    @property
    def system_deflection_results(self: Self) -> "_2690.AssemblySystemDeflection":
    ...
    def bearings(
        self: Self,
    ) -> "List[_7016.BearingAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_7018.BeltDriveAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bevel_differential_gear_sets(
        ...
        "List[_7021.BevelDifferentialGearSetAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_7028.BoltedJointAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_7027.BoltAdvancedTimeSteppingAnalysisForModulation]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_7048.CVTAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_7029.ClutchAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7034.ConceptCouplingAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_7039.ConceptGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_7051.CycloidalAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_7052.CycloidalDiscAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7057.CylindricalGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_7064.FEPartAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_7063.FaceGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7065.FlexiblePinAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_7073.HypoidGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7080.KlingelnbergCycloPalloidHypoidGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7083.KlingelnbergCycloPalloidSpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_7084.MassDiscAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_7085.MeasurementComponentAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_7087.OilSealAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_7089.PartToPartShearCouplingAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_7094.PlanetCarrierAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_7095.PointLoadAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_7096.PowerLoadAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_7098.RingPinsAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_7101.RollingRingAssemblyAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7105.ShaftHubConnectionAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_7104.ShaftAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7110.SpiralBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_7111.SpringDamperAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def straight_bevel_diff_gear_sets(
        ...
        "List[_7116.StraightBevelDiffGearSetAdvancedTimeSteppingAnalysisForModulation]"
    ):
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_7119.StraightBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_7122.SynchroniserAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_7126.TorqueConverterAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_7130.UnbalancedMassAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_7134.WormGearSetAdvancedTimeSteppingAnalysisForModulation]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_7137.ZerolBevelGearSetAdvancedTimeSteppingAnalysisForModulation]":
