...
class GearMeshExcitationDetail(_5676.AbstractPeriodicExcitationDetail):
    """GearMeshExcitationDetail
    ...
    @property
    def gear_mesh(self: Self) -> "_2757.GearMeshSystemDeflection":
    ...
    def get_compliance_and_force_data(self: Self) -> "_5701.ComplianceAndForceData":
