...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5768, _5769
...
class HypoidGearSetHarmonicAnalysis(_5682.AGMAGleasonConicalGearSetHarmonicAnalysis):
    """HypoidGearSetHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self: Self) -> "_2762.HypoidGearSetSystemDeflection":
    ...
    @property
    def gears_harmonic_analysis(self: Self) -> "List[_5768.HypoidGearHarmonicAnalysis]":
    ...
    def hypoid_gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5768.HypoidGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.HypoidGearHarmonicAnalysis]
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5769.HypoidGearMeshHarmonicAnalysis]":
