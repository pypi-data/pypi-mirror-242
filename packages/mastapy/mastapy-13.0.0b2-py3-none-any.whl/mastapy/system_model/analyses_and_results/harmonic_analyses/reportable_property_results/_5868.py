...
class ResultsForOrderIncludingNodes(_5866.ResultsForOrder):
    """ResultsForOrderIncludingNodes
    ...
    class _Cast_ResultsForOrderIncludingNodes:
        ...
        def results_for_order_including_surfaces(
            ...
            return self._parent._cast(_5869.ResultsForOrderIncludingSurfaces)
    ...
    def node_results_global_coordinate_system(
        self: Self,
    ) -> "List[_5860.HarmonicAnalysisResultsBrokenDownByNodeWithinAHarmonic]":
