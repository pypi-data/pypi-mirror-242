...
class HarmonicAnalysisOptions(_0.APIBase):
    ...
    class _Cast_HarmonicAnalysisOptions:
        ...
        def harmonic_analysis_options_for_advanced_time_stepping_analysis_for_modulation(
            ...
            return self._parent._cast(
                _7070.HarmonicAnalysisOptionsForAdvancedTimeSteppingAnalysisForModulation
            )
    ...
    @property
    def response_cache_level(self: Self) -> "_5796.ResponseCacheLevel":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.harmonic_analyses._5796",
            "ResponseCacheLevel",
        )(value)

    @response_cache_level.setter
    @enforce_parameter_types
    def response_cache_level(self: Self, value: "_5796.ResponseCacheLevel"):
    ...
    @property
    def excitation_selection(self: Self) -> "_5844.ExcitationSourceSelectionGroup":
    ...
    @property
    def modal_analysis_options(self: Self) -> "_4654.ModalAnalysisOptions":
    ...
    @property
    def stiffness_options(self: Self) -> "_5815.StiffnessOptionsForHarmonicAnalysis":
