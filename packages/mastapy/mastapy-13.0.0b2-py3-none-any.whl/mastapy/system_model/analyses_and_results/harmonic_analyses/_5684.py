...
class BearingHarmonicAnalysis(_5713.ConnectorHarmonicAnalysis):
    """BearingHarmonicAnalysis
    ...
    @property
    def rolling_bearing_speed_results(self: Self) -> "_2069.RollingBearingSpeedResults":
    ...
    @property
    def system_deflection_results(self: Self) -> "_2696.BearingSystemDeflection":
