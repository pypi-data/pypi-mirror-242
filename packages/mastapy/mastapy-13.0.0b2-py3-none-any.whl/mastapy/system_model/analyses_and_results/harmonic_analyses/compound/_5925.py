...
class CylindricalGearSetCompoundHarmonicAnalysis(_5936.GearSetCompoundHarmonicAnalysis):
    """CylindricalGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5726.CylindricalGearSetHarmonicAnalysis]":
    ...
    def cylindrical_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5923.CylindricalGearCompoundHarmonicAnalysis]":
    ...
    def cylindrical_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5924.CylindricalGearMeshCompoundHarmonicAnalysis]":
