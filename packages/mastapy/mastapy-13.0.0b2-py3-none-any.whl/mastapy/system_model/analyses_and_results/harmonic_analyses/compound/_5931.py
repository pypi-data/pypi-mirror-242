...
class FaceGearSetCompoundHarmonicAnalysis(_5936.GearSetCompoundHarmonicAnalysis):
    """FaceGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5746.FaceGearSetHarmonicAnalysis]":
    ...
    def face_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5929.FaceGearCompoundHarmonicAnalysis]":
    ...
    def face_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5930.FaceGearMeshCompoundHarmonicAnalysis]":
