...
class ClutchCompoundHarmonicAnalysis(_5913.CouplingCompoundHarmonicAnalysis):
    """ClutchCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5699.ClutchHarmonicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_5699.ClutchHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.ClutchHarmonicAnalysis]
