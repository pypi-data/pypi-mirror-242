...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5706, _5707
...
class ConceptGearSetHarmonicAnalysis(_5755.GearSetHarmonicAnalysis):
    """ConceptGearSetHarmonicAnalysis
    ...
    def gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5706.ConceptGearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5707.ConceptGearMeshHarmonicAnalysis]":
