...
class ShaftHarmonicAnalysis(
    _5677.AbstractShaftHarmonicAnalysis, _2654.IHaveShaftHarmonicResults
):
    """ShaftHarmonicAnalysis
    ...
    @property
    def coupled_modal_analysis(self: Self) -> "_4676.ShaftModalAnalysis":
    ...
    @property
    def export(self: Self) -> "_5765.HarmonicAnalysisShaftExportOptions":
    ...
    @property
    def system_deflection_results(self: Self) -> "_2802.ShaftSystemDeflection":
