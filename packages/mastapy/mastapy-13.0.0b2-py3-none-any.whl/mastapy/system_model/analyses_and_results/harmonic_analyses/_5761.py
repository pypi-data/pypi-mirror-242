...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5749, _5808
...
class HarmonicAnalysisFEExportOptions(
    _5760.HarmonicAnalysisExportOptions[
        "_2652.IHaveFEPartHarmonicAnalysisResults", "_2451.FEPart"
    ]
):
    """HarmonicAnalysisFEExportOptions
    ...
    class _Cast_HarmonicAnalysisFEExportOptions:
        ...
        def harmonic_analysis_export_options(
            ...
            return self._parent._cast(_5760.HarmonicAnalysisExportOptions)
    ...
    @enforce_parameter_types
    def distance_unit(self: Self, value: "_1608.Unit"):
    ...
    @enforce_parameter_types
    def element_face_group_to_export(self: Self, value: "_223.CMSElementFaceGroup"):
        wrapper_type = (
    ...
    @force_unit.setter
    @enforce_parameter_types
    def force_unit(self: Self, value: "_1608.Unit"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
