...
class ExcitationSourceSelection(_5843.ExcitationSourceSelectionBase):
    """ExcitationSourceSelection
    ...
    @property
    def harmonic_selections(self: Self) -> "List[_5845.HarmonicSelection]":
    ...
    def include_only_harmonic_with_order(
        self: Self, order: "_1526.RoundedOrder"
    ) -> "bool":
        """bool
