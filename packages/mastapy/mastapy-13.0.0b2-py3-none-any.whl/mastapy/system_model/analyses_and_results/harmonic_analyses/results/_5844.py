...
from mastapy.system_model.analyses_and_results.harmonic_analyses.results import _5843
...
class ExcitationSourceSelectionGroup(_5843.ExcitationSourceSelectionBase):
    """ExcitationSourceSelectionGroup
    ...
    class _Cast_ExcitationSourceSelectionGroup:
        ...
        def excitation_source_selection_base(
            ...
            return self._parent._cast(_5843.ExcitationSourceSelectionBase)
    ...
    @property
    def sub_items(self: Self) -> "List[_5843.ExcitationSourceSelectionBase]":
    ...
    @enforce_parameter_types
    def include_only_harmonics_with_order(self: Self, order: "_1526.RoundedOrder"):
