...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5816, _5817
...
class StraightBevelDiffGearSetHarmonicAnalysis(_5694.BevelGearSetHarmonicAnalysis):
    """StraightBevelDiffGearSetHarmonicAnalysis
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5817.StraightBevelDiffGearMeshHarmonicAnalysis]":
