...
class AssemblyModalAnalysisAtAStiffness(
    ...
    @property
    def bearings(self: Self) -> "List[_4862.BearingModalAnalysisAtAStiffness]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4864.BeltDriveModalAnalysisAtAStiffness]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4867.BevelDifferentialGearSetModalAnalysisAtAStiffness]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4873.BoltedJointModalAnalysisAtAStiffness]":
    ...
    @property
    def bolts(self: Self) -> "List[_4874.BoltModalAnalysisAtAStiffness]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4895.CVTModalAnalysisAtAStiffness]":
    ...
    @property
    def clutches(self: Self) -> "List[_4877.ClutchModalAnalysisAtAStiffness]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_4882.ConceptCouplingModalAnalysisAtAStiffness]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_4885.ConceptGearSetModalAnalysisAtAStiffness]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4897.CycloidalAssemblyModalAnalysisAtAStiffness]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_4899.CycloidalDiscModalAnalysisAtAStiffness]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4911.FEPartModalAnalysisAtAStiffness]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_4910.FaceGearSetModalAnalysisAtAStiffness]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4912.FlexiblePinAssemblyModalAnalysisAtAStiffness]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_4919.HypoidGearSetModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4926.KlingelnbergCycloPalloidHypoidGearSetModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4929.KlingelnbergCycloPalloidSpiralBevelGearSetModalAnalysisAtAStiffness]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4930.MassDiscModalAnalysisAtAStiffness]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4931.MeasurementComponentModalAnalysisAtAStiffness]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4934.OilSealModalAnalysisAtAStiffness]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4938.PartToPartShearCouplingModalAnalysisAtAStiffness]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_4941.PlanetCarrierModalAnalysisAtAStiffness]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4942.PointLoadModalAnalysisAtAStiffness]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4943.PowerLoadModalAnalysisAtAStiffness]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4945.RingPinsModalAnalysisAtAStiffness]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4947.RollingRingAssemblyModalAnalysisAtAStiffness]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4951.ShaftHubConnectionModalAnalysisAtAStiffness]":
    ...
    @property
    def shafts(self: Self) -> "List[_4952.ShaftModalAnalysisAtAStiffness]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4957.SpiralBevelGearSetModalAnalysisAtAStiffness]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_4960.SpringDamperModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4963.StraightBevelDiffGearSetModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4966.StraightBevelGearSetModalAnalysisAtAStiffness]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_4970.SynchroniserModalAnalysisAtAStiffness]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4974.TorqueConverterModalAnalysisAtAStiffness]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_4977.UnbalancedMassModalAnalysisAtAStiffness]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_4981.WormGearSetModalAnalysisAtAStiffness]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4984.ZerolBevelGearSetModalAnalysisAtAStiffness]":
