...
class AssemblyCompoundModalAnalysisAtAStiffness(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4861.AssemblyModalAnalysisAtAStiffness]":
    ...
    @property
    def bearings(self: Self) -> "List[_4993.BearingCompoundModalAnalysisAtAStiffness]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_4995.BeltDriveCompoundModalAnalysisAtAStiffness]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4998.BevelDifferentialGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_5005.BoltedJointCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def bolts(self: Self) -> "List[_5004.BoltCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_5026.CVTCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def clutches(self: Self) -> "List[_5006.ClutchCompoundModalAnalysisAtAStiffness]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_5011.ConceptCouplingCompoundModalAnalysisAtAStiffness]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_5016.ConceptGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_5028.CycloidalAssemblyCompoundModalAnalysisAtAStiffness]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_5030.CycloidalDiscCompoundModalAnalysisAtAStiffness]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_5034.CylindricalGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_5041.FEPartCompoundModalAnalysisAtAStiffness]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_5040.FaceGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_5042.FlexiblePinAssemblyCompoundModalAnalysisAtAStiffness]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_5049.HypoidGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_5056.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5059.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_5060.MassDiscCompoundModalAnalysisAtAStiffness]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_5061.MeasurementComponentCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_5063.OilSealCompoundModalAnalysisAtAStiffness]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_5065.PartToPartShearCouplingCompoundModalAnalysisAtAStiffness]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_5070.PlanetCarrierCompoundModalAnalysisAtAStiffness]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_5071.PointLoadCompoundModalAnalysisAtAStiffness]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_5072.PowerLoadCompoundModalAnalysisAtAStiffness]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_5074.RingPinsCompoundModalAnalysisAtAStiffness]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_5076.RollingRingAssemblyCompoundModalAnalysisAtAStiffness]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_5081.ShaftHubConnectionCompoundModalAnalysisAtAStiffness]":
    ...
    @property
    def shafts(self: Self) -> "List[_5080.ShaftCompoundModalAnalysisAtAStiffness]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_5086.SpiralBevelGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_5087.SpringDamperCompoundModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_5092.StraightBevelDiffGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_5095.StraightBevelGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_5098.SynchroniserCompoundModalAnalysisAtAStiffness]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_5102.TorqueConverterCompoundModalAnalysisAtAStiffness]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_5106.UnbalancedMassCompoundModalAnalysisAtAStiffness]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_5110.WormGearSetCompoundModalAnalysisAtAStiffness]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_5113.ZerolBevelGearSetCompoundModalAnalysisAtAStiffness]":
