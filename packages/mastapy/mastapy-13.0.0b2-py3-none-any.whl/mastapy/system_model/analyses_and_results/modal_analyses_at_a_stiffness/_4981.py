...
class WormGearSetModalAnalysisAtAStiffness(_4915.GearSetModalAnalysisAtAStiffness):
    """WormGearSetModalAnalysisAtAStiffness
    ...
    def worm_gears_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4980.WormGearModalAnalysisAtAStiffness]":
    ...
    def worm_meshes_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4979.WormGearMeshModalAnalysisAtAStiffness]":
