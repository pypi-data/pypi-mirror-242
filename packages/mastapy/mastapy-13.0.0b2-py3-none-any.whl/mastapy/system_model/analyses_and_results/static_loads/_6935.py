...
if TYPE_CHECKING:
    from mastapy.math_utility import _1501, _1510
...
class PointLoadHarmonicLoadData(_1380.SpeedDependentHarmonicLoadData):
    """PointLoadHarmonicLoadData
    ...
    @property
    def degree_of_freedom(self: Self) -> "_1501.DegreeOfFreedom":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1501", "DegreeOfFreedom"
        )(value)

    @degree_of_freedom.setter
    @enforce_parameter_types
    def degree_of_freedom(self: Self, value: "_1501.DegreeOfFreedom"):
