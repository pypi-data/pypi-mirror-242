...
class TorqueInputOptions(_6996.PowerLoadInputOptions):
    """TorqueInputOptions
    ...
    @property
    def conversion_to_load_case(self: Self) -> "_7002.TorqueValuesObtainedFrom":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads.duty_cycle_definition._7002",
            "TorqueValuesObtainedFrom",
        )(value)

    @conversion_to_load_case.setter
    @enforce_parameter_types
    def conversion_to_load_case(self: Self, value: "_7002.TorqueValuesObtainedFrom"):
