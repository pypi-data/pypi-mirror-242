...
class CylindricalGearMeshLoadCase(_6890.GearMeshLoadCase):
    """CylindricalGearMeshLoadCase
    ...
    def helical_gear_micro_geometry_option(
        self: Self,
        value: "Union[_508.HelicalGearMicroGeometryOption, Tuple[_508.HelicalGearMicroGeometryOption, bool]]",
    ):
        wrapper_type = (
