...
from mastapy.bearings.bearing_results.rolling import _1964, _1965, _1970, _2067
from mastapy.materials.efficiency import _290
from mastapy.system_model.part_model import _2438
from mastapy.math_utility.hertzian_contact import _1571
...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling.dysla import _2112
    from mastapy.bearings.bearing_results.rolling import _2068
    from mastapy.bearings.tolerances import _1912, _1918
...
class BearingLoadCase(_6848.ConnectorLoadCase):
    """BearingLoadCase
    ...
    @enforce_parameter_types
    def ball_bearing_analysis_method(
        self: Self, value: "_1964.BallBearingAnalysisMethod"
    ):
    ...
    def ball_bearing_contact_calculation(
        self: Self,
        value: "Union[_1965.BallBearingContactCalculation, Tuple[_1965.BallBearingContactCalculation, bool]]",
    ):
        wrapper_type = (
    ...
    def ball_bearing_friction_model_for_gyroscopic_moment(
        self: Self,
        value: "Union[_1970.FrictionModelForGyroscopicMoment, Tuple[_1970.FrictionModelForGyroscopicMoment, bool]]",
    ):
        wrapper_type = (
    ...
    @property
    def bearing_stiffness_model(self: Self) -> "_5383.BearingStiffnessModel":
    ...
    @enforce_parameter_types
    def bearing_stiffness_model(self: Self, value: "_5383.BearingStiffnessModel"):
    ...
    def force_at_zero_displacement_input_method(
        self: Self,
        value: "Union[_2438.BearingF0InputMethod, Tuple[_2438.BearingF0InputMethod, bool]]",
    ):
    ...
    @enforce_parameter_types
    def hertzian_contact_deflection_calculation_method(
        self: Self, value: "_1571.HertzianContactDeflectionCalculationMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def include_fitting_effects(self: Self) -> "_1587.LoadCaseOverrideOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility._1587", "LoadCaseOverrideOption"
        )(value)

    @include_fitting_effects.setter
    @enforce_parameter_types
    def include_fitting_effects(self: Self, value: "_1587.LoadCaseOverrideOption"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def include_ring_ovality(self: Self) -> "_1587.LoadCaseOverrideOption":
        """mastapy.utility.LoadCaseOverrideOption"""
    ...
    @enforce_parameter_types
    def include_ring_ovality(self: Self, value: "_1587.LoadCaseOverrideOption"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Utility.LoadCaseOverrideOption"
        )
    ...
    @property
    def include_thermal_expansion_effects(self: Self) -> "_1587.LoadCaseOverrideOption":
        """mastapy.utility.LoadCaseOverrideOption"""
    ...
    def include_thermal_expansion_effects(
        self: Self, value: "_1587.LoadCaseOverrideOption"
    ):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Utility.LoadCaseOverrideOption"
        )
    ...
    def roller_analysis_method(
        self: Self,
        value: "Union[_2067.RollerAnalysisMethod, Tuple[_2067.RollerAnalysisMethod, bool]]",
    ):
    ...
    @property
    def dynamic_analysis_options(self: Self) -> "_2112.DynamicBearingAnalysisOptions":
    ...
    @property
    def inner_ring_detail(self: Self) -> "_1912.RaceDetail":
    ...
    @property
    def left_ring_detail(self: Self) -> "_1912.RaceDetail":
        """mastapy.bearings.tolerances.RaceDetail
    ...
    @property
    def outer_ring_detail(self: Self) -> "_1912.RaceDetail":
        """mastapy.bearings.tolerances.RaceDetail
    ...
    @property
    def right_ring_detail(self: Self) -> "_1912.RaceDetail":
        """mastapy.bearings.tolerances.RaceDetail
