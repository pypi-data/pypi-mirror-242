...
class StaticLoadCase(_6801.LoadCase):
    """StaticLoadCase
    ...
    @property
    def system_deflection(self: Self) -> "_2644.SystemDeflectionAnalysis":
    ...
    @property
    def power_flow(self: Self) -> "_2639.PowerFlowAnalysis":
    ...
    @property
    def harmonic_analysis(self: Self) -> "_2630.HarmonicAnalysis":
    ...
    @property
    def parametric_study_tool(self: Self) -> "_2638.ParametricStudyToolAnalysis":
    ...
    @property
    def modal_analysis(self: Self) -> "_2633.ModalAnalysis":
    ...
    @property
    def critical_speed_analysis(self: Self) -> "_2623.CriticalSpeedAnalysis":
    ...
    @property
    def stability_analysis(self: Self) -> "_2640.StabilityAnalysis":
    ...
    def planetary_rating_load_sharing_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._339", "PlanetaryRatingLoadSharingOption"
        )(value)

    @planetary_rating_load_sharing_method.setter
    @enforce_parameter_types
    def planetary_rating_load_sharing_method(
        self: Self, value: "_339.PlanetaryRatingLoadSharingOption"
    ):
    ...
    def unbalanced_mass_inclusion(
        self: Self,
        value: "Union[_2476.UnbalancedMassInclusionOption, Tuple[_2476.UnbalancedMassInclusionOption, bool]]",
    ):
        wrapper_type = (
    ...
    @property
    def clutch_engagements(self: Self) -> "List[_5658.ClutchEngagementStatus]":
    ...
    def concept_clutch_engagements(
        self: Self,
    ) -> "List[_5659.ConceptSynchroGearEngagementStatus]":
    ...
    @property
    def design_state_load_case_group(self: Self) -> "_5660.DesignState":
    ...
    @enforce_parameter_types
    def duplicate(
        self: Self, new_design_state_group: "_5660.DesignState", name: "str" = "None"
    ) -> "StaticLoadCase":
