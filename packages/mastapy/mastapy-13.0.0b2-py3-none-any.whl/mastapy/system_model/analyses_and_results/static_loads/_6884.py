...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6882, _6883
...
class FaceGearSetLoadCase(_6893.GearSetLoadCase):
    """FaceGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6882.FaceGearLoadCase]":
    ...
    @property
    def face_gears_load_case(self: Self) -> "List[_6882.FaceGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.FaceGearLoadCase]
    ...
    @property
    def face_meshes_load_case(self: Self) -> "List[_6883.FaceGearMeshLoadCase]":
