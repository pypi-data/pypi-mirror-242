...
class CompoundAnalysis(_7550.MarshalByRefObjectPermanent):
    """CompoundAnalysis
    ...
    class _Cast_CompoundAnalysis:
        ...
        def compound_advanced_system_deflection_analysis(
            ...
            return self._parent._cast(_2656.CompoundAdvancedSystemDeflectionAnalysis)
        ...
        def compound_advanced_system_deflection_sub_analysis(
            ...
            return self._parent._cast(_2657.CompoundAdvancedSystemDeflectionSubAnalysis)
        ...
        def compound_critical_speed_analysis(
            ...
            return self._parent._cast(_2659.CompoundCriticalSpeedAnalysis)
        ...
        def compound_dynamic_analysis(self: "CompoundAnalysis._Cast_CompoundAnalysis"):
            ...
            return self._parent._cast(_2660.CompoundDynamicAnalysis)
        ...
        def compound_dynamic_model_at_a_stiffness_analysis(
            ...
            return self._parent._cast(_2661.CompoundDynamicModelAtAStiffnessAnalysis)
        ...
        def compound_dynamic_model_for_harmonic_analysis(
            ...
            return self._parent._cast(_2662.CompoundDynamicModelForHarmonicAnalysis)
        ...
        def compound_dynamic_model_for_modal_analysis(
            ...
            return self._parent._cast(_2663.CompoundDynamicModelForModalAnalysis)
        ...
        def compound_dynamic_model_for_stability_analysis(
            ...
            return self._parent._cast(_2664.CompoundDynamicModelForStabilityAnalysis)
        ...
        def compound_harmonic_analysis(self: "CompoundAnalysis._Cast_CompoundAnalysis"):
            ...
            return self._parent._cast(_2666.CompoundHarmonicAnalysis)
        ...
        def compound_harmonic_analysis_for_advanced_time_stepping_analysis_for_modulation(
            ...
            return self._parent._cast(
                _2667.CompoundHarmonicAnalysisForAdvancedTimeSteppingAnalysisForModulation
            )
        ...
        def compound_modal_analysis(self: "CompoundAnalysis._Cast_CompoundAnalysis"):
            ...
            return self._parent._cast(_2669.CompoundModalAnalysis)
        ...
        def compound_modal_analysis_at_a_speed(
            ...
            return self._parent._cast(_2670.CompoundModalAnalysisAtASpeed)
        ...
        def compound_modal_analysis_at_a_stiffness(
            ...
            return self._parent._cast(_2671.CompoundModalAnalysisAtAStiffness)
        ...
        def compound_modal_analysis_for_harmonic_analysis(
            ...
            return self._parent._cast(_2672.CompoundModalAnalysisForHarmonicAnalysis)
        ...
        def compound_multibody_dynamics_analysis(
            ...
            return self._parent._cast(_2673.CompoundMultibodyDynamicsAnalysis)
        ...
        def compound_power_flow_analysis(
            ...
            return self._parent._cast(_2674.CompoundPowerFlowAnalysis)
        ...
        def compound_stability_analysis(
            ...
            return self._parent._cast(_2675.CompoundStabilityAnalysis)
        ...
        def compound_system_deflection_analysis(
            ...
            return self._parent._cast(_2679.CompoundSystemDeflectionAnalysis)
        ...
        def compound_torsional_system_deflection_analysis(
            ...
            return self._parent._cast(_2680.CompoundTorsionalSystemDeflectionAnalysis)
    ...
    def perform_analysis_with_progress(self: Self, progress: "_7556.TaskProgress"):
        """Method does not return.
    ...
    ) -> "Iterable[_7540.DesignEntityCompoundAnalysis]":
