...
class AssemblyHarmonicAnalysisOfSingleExcitation(
    ...
    @property
    def bearings(self: Self) -> "List[_6013.BearingHarmonicAnalysisOfSingleExcitation]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_6015.BeltDriveHarmonicAnalysisOfSingleExcitation]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6018.BevelDifferentialGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_6024.BoltedJointHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def bolts(self: Self) -> "List[_6025.BoltHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6046.CVTHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def clutches(self: Self) -> "List[_6028.ClutchHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_6033.ConceptCouplingHarmonicAnalysisOfSingleExcitation]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_6036.ConceptGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6048.CycloidalAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_6050.CycloidalDiscHarmonicAnalysisOfSingleExcitation]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6054.CylindricalGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6061.FEPartHarmonicAnalysisOfSingleExcitation]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_6060.FaceGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6062.FlexiblePinAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6077.KlingelnbergCycloPalloidHypoidGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6080.KlingelnbergCycloPalloidSpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_6081.MassDiscHarmonicAnalysisOfSingleExcitation]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6082.MeasurementComponentHarmonicAnalysisOfSingleExcitation]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_6085.OilSealHarmonicAnalysisOfSingleExcitation]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6089.PartToPartShearCouplingHarmonicAnalysisOfSingleExcitation]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_6092.PlanetCarrierHarmonicAnalysisOfSingleExcitation]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_6093.PointLoadHarmonicAnalysisOfSingleExcitation]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_6094.PowerLoadHarmonicAnalysisOfSingleExcitation]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_6096.RingPinsHarmonicAnalysisOfSingleExcitation]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6098.RollingRingAssemblyHarmonicAnalysisOfSingleExcitation]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6103.ShaftHubConnectionHarmonicAnalysisOfSingleExcitation]":
    ...
    @property
    def shafts(self: Self) -> "List[_6102.ShaftHarmonicAnalysisOfSingleExcitation]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6108.SpiralBevelGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_6111.SpringDamperHarmonicAnalysisOfSingleExcitation]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_6114.StraightBevelDiffGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_6121.SynchroniserHarmonicAnalysisOfSingleExcitation]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_6125.TorqueConverterHarmonicAnalysisOfSingleExcitation]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_6128.UnbalancedMassHarmonicAnalysisOfSingleExcitation]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_6132.WormGearSetHarmonicAnalysisOfSingleExcitation]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6135.ZerolBevelGearSetHarmonicAnalysisOfSingleExcitation]":
