...
class AssemblyDynamicAnalysis(_6274.AbstractAssemblyDynamicAnalysis):
    """AssemblyDynamicAnalysis
    ...
    @property
    def bearings(self: Self) -> "List[_6282.BearingDynamicAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_6284.BeltDriveDynamicAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_6287.BevelDifferentialGearSetDynamicAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_6294.BoltedJointDynamicAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_6293.BoltDynamicAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_6315.CVTDynamicAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_6296.ClutchDynamicAnalysis]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_6301.ConceptCouplingDynamicAnalysis]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_6305.ConceptGearSetDynamicAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_6317.CycloidalAssemblyDynamicAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_6319.CycloidalDiscDynamicAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_6323.CylindricalGearSetDynamicAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_6332.FEPartDynamicAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_6331.FaceGearSetDynamicAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_6333.FlexiblePinAssemblyDynamicAnalysis]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_6340.HypoidGearSetDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_6347.KlingelnbergCycloPalloidHypoidGearSetDynamicAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_6350.KlingelnbergCycloPalloidSpiralBevelGearSetDynamicAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_6351.MassDiscDynamicAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_6352.MeasurementComponentDynamicAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_6354.OilSealDynamicAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_6357.PartToPartShearCouplingDynamicAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_6361.PlanetCarrierDynamicAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_6362.PointLoadDynamicAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_6363.PowerLoadDynamicAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_6365.RingPinsDynamicAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_6367.RollingRingAssemblyDynamicAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_6372.ShaftHubConnectionDynamicAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_6371.ShaftDynamicAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_6379.SpringDamperDynamicAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_6386.StraightBevelGearSetDynamicAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_6389.SynchroniserDynamicAnalysis]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_6394.TorqueConverterDynamicAnalysis]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_6397.UnbalancedMassDynamicAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_6401.WormGearSetDynamicAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_6404.ZerolBevelGearSetDynamicAnalysis]":
