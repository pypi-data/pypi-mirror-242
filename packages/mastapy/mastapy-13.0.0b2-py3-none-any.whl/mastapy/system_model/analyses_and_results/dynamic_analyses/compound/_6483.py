...
class OilSealCompoundDynamicAnalysis(_6441.ConnectorCompoundDynamicAnalysis):
    """OilSealCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6354.OilSealDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6354.OilSealDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.OilSealDynamicAnalysis]
