...
class CVTPulleyCompoundDynamicAnalysis(_6493.PulleyCompoundDynamicAnalysis):
    """CVTPulleyCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6316.CVTPulleyDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6316.CVTPulleyDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.CVTPulleyDynamicAnalysis]
