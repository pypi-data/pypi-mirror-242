...
class PointLoadCompoundDynamicAnalysis(_6527.VirtualComponentCompoundDynamicAnalysis):
    """PointLoadCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6362.PointLoadDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6362.PointLoadDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.PointLoadDynamicAnalysis]
