...
class ConceptGearSetCompoundDynamicAnalysis(_6465.GearSetCompoundDynamicAnalysis):
    """ConceptGearSetCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6305.ConceptGearSetDynamicAnalysis]":
    ...
    def concept_gears_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6434.ConceptGearCompoundDynamicAnalysis]":
    ...
    def concept_meshes_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6435.ConceptGearMeshCompoundDynamicAnalysis]":
