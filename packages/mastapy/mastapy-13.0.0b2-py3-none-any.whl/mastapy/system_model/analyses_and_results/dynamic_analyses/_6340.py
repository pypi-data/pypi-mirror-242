...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6338, _6339
...
class HypoidGearSetDynamicAnalysis(_6280.AGMAGleasonConicalGearSetDynamicAnalysis):
    """HypoidGearSetDynamicAnalysis
    ...
    def hypoid_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6338.HypoidGearDynamicAnalysis]":
    ...
    def hypoid_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6339.HypoidGearMeshDynamicAnalysis]":
