...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6303, _6304
...
class ConceptGearSetDynamicAnalysis(_6336.GearSetDynamicAnalysis):
    """ConceptGearSetDynamicAnalysis
    ...
    def concept_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6303.ConceptGearDynamicAnalysis]":
    ...
    def concept_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6304.ConceptGearMeshDynamicAnalysis]":
