...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6321, _6322
...
class CylindricalGearSetDynamicAnalysis(_6336.GearSetDynamicAnalysis):
    """CylindricalGearSetDynamicAnalysis
    ...
    def cylindrical_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6322.CylindricalGearMeshDynamicAnalysis]":
