...
class AssemblyCompoundSteadyStateSynchronousResponseAtASpeed(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3509.AssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def bearings(
        self: Self,
    ) -> "List[_3640.BearingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_3642.BeltDriveCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3645.BevelDifferentialGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_3652.BoltedJointCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bolts(
        self: Self,
    ) -> "List[_3651.BoltCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cv_ts(
        self: Self,
    ) -> "List[_3673.CVTCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_3653.ClutchCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3658.ConceptCouplingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3663.ConceptGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3675.CycloidalAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3677.CycloidalDiscCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3681.CylindricalGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_3688.FEPartCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3687.FaceGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def flexible_pin_assemblies(
        ...
        "List[_3689.FlexiblePinAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3696.HypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_3703.KlingelnbergCycloPalloidHypoidGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3706.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_3707.MassDiscCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def measurement_components(
        ...
        "List[_3708.MeasurementComponentCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_3710.OilSealCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3712.PartToPartShearCouplingCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3717.PlanetCarrierCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_3718.PointLoadCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_3719.PowerLoadCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3721.RingPinsCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def rolling_ring_assemblies(
        ...
        "List[_3723.RollingRingAssemblyCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3728.ShaftHubConnectionCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def shafts(
        self: Self,
    ) -> "List[_3727.ShaftCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3733.SpiralBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3734.SpringDamperCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_3739.StraightBevelDiffGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        ...
        "List[_3742.StraightBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]"
    ):
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_3745.SynchroniserCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3749.TorqueConverterCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_3753.UnbalancedMassCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3757.WormGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_3760.ZerolBevelGearSetCompoundSteadyStateSynchronousResponseAtASpeed]":
