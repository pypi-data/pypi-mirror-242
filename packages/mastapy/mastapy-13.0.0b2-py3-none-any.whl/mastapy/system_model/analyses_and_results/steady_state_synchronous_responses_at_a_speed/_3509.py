...
class AssemblySteadyStateSynchronousResponseAtASpeed(
    ...
    def bearings(
        self: Self,
    ) -> "List[_3510.BearingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_3512.BeltDriveSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_3514.BevelDifferentialGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_3521.BoltedJointSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def bolts(self: Self) -> "List[_3522.BoltSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_3544.CVTSteadyStateSynchronousResponseAtASpeed]":
    ...
    def clutches(
        self: Self,
    ) -> "List[_3525.ClutchSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_3530.ConceptCouplingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_3532.ConceptGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_3545.CycloidalAssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_3548.CycloidalDiscSteadyStateSynchronousResponseAtASpeed]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_3550.CylindricalGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def fe_parts(
        self: Self,
    ) -> "List[_3558.FEPartSteadyStateSynchronousResponseAtASpeed]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_3556.FaceGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_3559.FlexiblePinAssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_3565.HypoidGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3575.KlingelnbergCycloPalloidSpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_3577.MassDiscSteadyStateSynchronousResponseAtASpeed]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_3578.MeasurementComponentSteadyStateSynchronousResponseAtASpeed]":
    ...
    def oil_seals(
        self: Self,
    ) -> "List[_3580.OilSealSteadyStateSynchronousResponseAtASpeed]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_3584.PartToPartShearCouplingSteadyStateSynchronousResponseAtASpeed]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_3587.PlanetCarrierSteadyStateSynchronousResponseAtASpeed]":
    ...
    def ring_pins(
        self: Self,
    ) -> "List[_3591.RingPinsSteadyStateSynchronousResponseAtASpeed]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_3593.RollingRingAssemblySteadyStateSynchronousResponseAtASpeed]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_3597.ShaftHubConnectionSteadyStateSynchronousResponseAtASpeed]":
    ...
    @property
    def shafts(self: Self) -> "List[_3598.ShaftSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_3602.SpiralBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_3606.SpringDamperSteadyStateSynchronousResponseAtASpeed]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_3612.StraightBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_3619.SynchroniserSteadyStateSynchronousResponseAtASpeed]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_3622.TorqueConverterSteadyStateSynchronousResponseAtASpeed]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_3624.UnbalancedMassSteadyStateSynchronousResponseAtASpeed]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_3627.WormGearSetSteadyStateSynchronousResponseAtASpeed]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_3630.ZerolBevelGearSetSteadyStateSynchronousResponseAtASpeed]":
