...
class BoltCompoundModalAnalysisAtASpeed(_5269.ComponentCompoundModalAnalysisAtASpeed):
    """BoltCompoundModalAnalysisAtASpeed
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5134.BoltModalAnalysisAtASpeed]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5134.BoltModalAnalysisAtASpeed]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.BoltModalAnalysisAtASpeed]
