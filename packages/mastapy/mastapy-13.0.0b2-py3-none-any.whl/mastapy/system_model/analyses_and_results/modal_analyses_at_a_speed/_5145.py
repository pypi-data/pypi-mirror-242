...
class ConceptGearSetModalAnalysisAtASpeed(_5174.GearSetModalAnalysisAtASpeed):
    """ConceptGearSetModalAnalysisAtASpeed
    ...
    def concept_gears_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5144.ConceptGearModalAnalysisAtASpeed]":
    ...
    def concept_meshes_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5143.ConceptGearMeshModalAnalysisAtASpeed]":
