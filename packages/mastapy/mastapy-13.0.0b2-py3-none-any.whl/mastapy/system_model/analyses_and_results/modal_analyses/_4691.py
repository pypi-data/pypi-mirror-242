...
class StraightBevelGearSetModalAnalysis(_4587.BevelGearSetModalAnalysis):
    """StraightBevelGearSetModalAnalysis
    ...
    def straight_bevel_gears_modal_analysis(
        self: Self,
    ) -> "List[_4690.StraightBevelGearModalAnalysis]":
    ...
    def straight_bevel_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4689.StraightBevelGearMeshModalAnalysis]":
