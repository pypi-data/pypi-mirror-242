...
from mastapy.system_model.analyses_and_results.modal_analyses import _4623, _4624
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.math_utility import _1492, _1524
...
if TYPE_CHECKING:
    ...
    from mastapy.math_utility import _1531, _1517
    ...
    from mastapy.system_model.drawing.options import _2261, _2259
...
class WhineWaterfallSettings(_0.APIBase):
    ...
    @chart_type.setter
    @enforce_parameter_types
    def chart_type(self: Self, value: "_4623.DynamicsResponse3DChartType"):
    ...
    @enforce_parameter_types
    def complex_component(self: Self, value: "_1492.ComplexPartDisplayOption"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def connected_component_type(self: Self) -> "_5841.ConnectedComponentType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.harmonic_analyses.results._5841",
            "ConnectedComponentType",
        )(value)

    @connected_component_type.setter
    @enforce_parameter_types
    def connected_component_type(self: Self, value: "_5841.ConnectedComponentType"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.HarmonicAnalyses.Results.ConnectedComponentType",
        )
    ...
    @property
    def coordinate_system(self: Self) -> "_4606.CoordinateSystemForWhine":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.modal_analyses._4606",
            "CoordinateSystemForWhine",
        )(value)

    @coordinate_system.setter
    @enforce_parameter_types
    def coordinate_system(self: Self, value: "_4606.CoordinateSystemForWhine"):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.CoordinateSystemForWhine",
        )
    ...
    @enforce_parameter_types
    def response_type(self: Self, value: "_4624.DynamicsResponseType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def speed_range_for_combining_excitations(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.modal_analyses._4656",
    ...
    @enforce_parameter_types
    def speed_range_for_combining_excitations(
        self: Self, value: "_4656.MultipleExcitationsSpeedRangeOption"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.MultipleExcitationsSpeedRangeOption",
    ...
    @property
    def translation_or_rotation(self: Self) -> "_1531.TranslationRotation":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1531", "TranslationRotation"
        )(value)

    @translation_or_rotation.setter
    @enforce_parameter_types
    def translation_or_rotation(self: Self, value: "_1531.TranslationRotation"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def vector_magnitude_method(self: Self) -> "_1517.ComplexMagnitudeMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.math_utility._1517", "ComplexMagnitudeMethod"
        )(value)

    @vector_magnitude_method.setter
    @enforce_parameter_types
    def vector_magnitude_method(self: Self, value: "_1517.ComplexMagnitudeMethod"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def whine_waterfall_export_option(self: Self) -> "_4705.WhineWaterfallExportOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.modal_analyses._4705",
    ...
    def whine_waterfall_export_option(
        self: Self, value: "_4705.WhineWaterfallExportOption"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.ModalAnalyses.WhineWaterfallExportOption",
    ...
    @property
    def data_scaling(self: Self) -> "_1567.DataScalingOptions":
    ...
    @property
    def order_cuts_chart_settings(self: Self) -> "_4658.OrderCutsChartSettings":
    ...
    @property
    def selected_excitations(self: Self) -> "_5844.ExcitationSourceSelectionGroup":
    ...
    @property
    def waterfall_chart_settings(self: Self) -> "_4704.WaterfallChartSettings":
    ...
    @property
    def active_result_locations(self: Self) -> "List[_5850.ResultNodeSelection]":
    ...
    def degrees_of_freedom(
        self: Self,
    ) -> "List[_1841.EnumWithBoolean[_1524.ResultOptionsFor3DVector]]":
