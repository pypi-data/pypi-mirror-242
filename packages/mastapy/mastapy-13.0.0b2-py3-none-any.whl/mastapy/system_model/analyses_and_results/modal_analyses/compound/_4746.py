...
class ClutchCompoundModalAnalysis(_4762.CouplingCompoundModalAnalysis):
    """ClutchCompoundModalAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4592.ClutchModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4592.ClutchModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ClutchModalAnalysis]
