...
class FaceGearCompoundModalAnalysis(_4783.GearCompoundModalAnalysis):
    """FaceGearCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4627.FaceGearModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4627.FaceGearModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.FaceGearModalAnalysis]
