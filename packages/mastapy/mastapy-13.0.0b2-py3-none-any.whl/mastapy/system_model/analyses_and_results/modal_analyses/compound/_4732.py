...
class AssemblyCompoundModalAnalysis(_4725.AbstractAssemblyCompoundModalAnalysis):
    """AssemblyCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4576.AssemblyModalAnalysis]":
    ...
    @property
    def bearings(self: Self) -> "List[_4733.BearingCompoundModalAnalysis]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4735.BeltDriveCompoundModalAnalysis]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4738.BevelDifferentialGearSetCompoundModalAnalysis]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4745.BoltedJointCompoundModalAnalysis]":
    ...
    @property
    def bolts(self: Self) -> "List[_4744.BoltCompoundModalAnalysis]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4766.CVTCompoundModalAnalysis]":
    ...
    @property
    def clutches(self: Self) -> "List[_4746.ClutchCompoundModalAnalysis]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_4751.ConceptCouplingCompoundModalAnalysis]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_4756.ConceptGearSetCompoundModalAnalysis]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4768.CycloidalAssemblyCompoundModalAnalysis]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4770.CycloidalDiscCompoundModalAnalysis]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_4774.CylindricalGearSetCompoundModalAnalysis]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4781.FEPartCompoundModalAnalysis]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4780.FaceGearSetCompoundModalAnalysis]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4782.FlexiblePinAssemblyCompoundModalAnalysis]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_4789.HypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4796.KlingelnbergCycloPalloidHypoidGearSetCompoundModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4799.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4800.MassDiscCompoundModalAnalysis]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4801.MeasurementComponentCompoundModalAnalysis]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4803.OilSealCompoundModalAnalysis]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4805.PartToPartShearCouplingCompoundModalAnalysis]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4810.PlanetCarrierCompoundModalAnalysis]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4811.PointLoadCompoundModalAnalysis]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4812.PowerLoadCompoundModalAnalysis]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4814.RingPinsCompoundModalAnalysis]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4816.RollingRingAssemblyCompoundModalAnalysis]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4821.ShaftHubConnectionCompoundModalAnalysis]":
    ...
    @property
    def shafts(self: Self) -> "List[_4820.ShaftCompoundModalAnalysis]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4826.SpiralBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4827.SpringDamperCompoundModalAnalysis]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4832.StraightBevelDiffGearSetCompoundModalAnalysis]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4835.StraightBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4838.SynchroniserCompoundModalAnalysis]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4842.TorqueConverterCompoundModalAnalysis]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_4846.UnbalancedMassCompoundModalAnalysis]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4850.WormGearSetCompoundModalAnalysis]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4853.ZerolBevelGearSetCompoundModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4576.AssemblyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.AssemblyModalAnalysis]
