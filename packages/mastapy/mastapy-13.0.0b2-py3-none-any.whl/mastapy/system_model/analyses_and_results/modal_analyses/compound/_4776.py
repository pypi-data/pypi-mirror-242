...
class DatumCompoundModalAnalysis(_4750.ComponentCompoundModalAnalysis):
    """DatumCompoundModalAnalysis
    ...
    @property
    def component_design(self: Self) -> "_2446.Datum":
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4621.DatumModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4621.DatumModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.DatumModalAnalysis]
