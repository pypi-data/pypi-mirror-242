...
class SpringDamperCompoundModalAnalysis(_4762.CouplingCompoundModalAnalysis):
    """SpringDamperCompoundModalAnalysis
    ...
    @property
    def component_design(self: Self) -> "_2598.SpringDamper":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4685.SpringDamperModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4685.SpringDamperModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.SpringDamperModalAnalysis]
