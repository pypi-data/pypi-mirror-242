...
class ShaftCompoundModalAnalysis(_4726.AbstractShaftCompoundModalAnalysis):
    """ShaftCompoundModalAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4676.ShaftModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4676.ShaftModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.ShaftModalAnalysis]
