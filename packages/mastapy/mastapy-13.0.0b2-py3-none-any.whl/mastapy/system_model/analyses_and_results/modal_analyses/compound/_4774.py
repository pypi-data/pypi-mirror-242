...
class CylindricalGearSetCompoundModalAnalysis(_4785.GearSetCompoundModalAnalysis):
    """CylindricalGearSetCompoundModalAnalysis
    ...
    def cylindrical_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4772.CylindricalGearCompoundModalAnalysis]":
    ...
    def cylindrical_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4773.CylindricalGearMeshCompoundModalAnalysis]":
