...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4637, _4636
...
class HypoidGearSetModalAnalysis(_4575.AGMAGleasonConicalGearSetModalAnalysis):
    """HypoidGearSetModalAnalysis
    ...
    def hypoid_gears_modal_analysis(
        self: Self,
    ) -> "List[_4637.HypoidGearModalAnalysis]":
    ...
    def hypoid_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4636.HypoidGearMeshModalAnalysis]":
