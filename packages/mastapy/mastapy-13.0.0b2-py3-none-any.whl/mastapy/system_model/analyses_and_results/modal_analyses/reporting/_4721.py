...
if TYPE_CHECKING:
    from mastapy.utility.modal_analysis import _1794
...
class RigidlyConnectedDesignEntityGroupModalAnalysis(_2650.DesignEntityGroupAnalysis):
    """RigidlyConnectedDesignEntityGroupModalAnalysis
    ...
    def excitation_frequencies_at_reference_speed(
        self: Self,
    ) -> "List[_1794.DesignEntityExcitationDescription]":
