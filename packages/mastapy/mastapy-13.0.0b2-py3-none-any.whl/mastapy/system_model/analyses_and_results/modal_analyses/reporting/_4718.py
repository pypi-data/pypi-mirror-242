...
class PerModeResultsReport(_1754.CustomReportChart):
    """PerModeResultsReport
    ...
    @property
    def display_option(self: Self) -> "_1818.TableAndChartOptions":
    ...
    def display_option(self: Self, value: "_1818.TableAndChartOptions"):
