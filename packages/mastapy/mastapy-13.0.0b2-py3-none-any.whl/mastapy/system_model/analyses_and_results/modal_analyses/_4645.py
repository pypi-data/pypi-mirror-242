...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.modal_analyses import _4644, _4643
...
class KlingelnbergCycloPalloidHypoidGearSetModalAnalysis(
    ...
    def klingelnberg_cyclo_palloid_hypoid_gears_modal_analysis(
        self: Self,
    ) -> "List[_4644.KlingelnbergCycloPalloidHypoidGearModalAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4643.KlingelnbergCycloPalloidHypoidGearMeshModalAnalysis]":
