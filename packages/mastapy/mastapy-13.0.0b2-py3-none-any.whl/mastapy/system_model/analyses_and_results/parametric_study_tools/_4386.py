...
if TYPE_CHECKING:
    ...
    from mastapy.system_model import _2207, _2201
...
class ParametricStudyToolOptions(_0.APIBase):
    ...
    def analysis_type(self: Self, value: "_6815.AnalysisType"):
    ...
    @property
    def parametric_study_type(self: Self) -> "_6925.ParametricStudyType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.static_loads._6925",
            "ParametricStudyType",
        )(value)

    @parametric_study_type.setter
    @enforce_parameter_types
    def parametric_study_type(self: Self, value: "_6925.ParametricStudyType"):
    ...
    @property
    def external_full_fe_loader(self: Self) -> "_2207.ExternalFullFELoader":
    ...
    @property
    def step_results(self: Self) -> "List[_4388.ParametricStudyToolStepResult]":
    ...
    @property
    def study_variables(self: Self) -> "List[_4389.ParametricStudyVariable]":
    ...
    def parametric_study_logging_variables(
        self: Self,
    ) -> "List[_2646.AnalysisCaseVariable]":
    ...
    def add_logging_variable(
        self: Self, design_entity: "_2201.DesignEntity", path: "List[str]"
    ...
    def move_study_variable_down(
        self: Self, study_variable: "_4389.ParametricStudyVariable"
    ):
        """Method does not return.
    ...
    def remove_logging_variable(
        self: Self, analysis_variable: "_2646.AnalysisCaseVariable"
    ):
        """Method does not return.
