...
class DutyCycleResultsForAllComponents(_0.APIBase):
    ...
    @property
    def results_for_all_gear_sets(self: Self) -> "_4348.DutyCycleResultsForAllGearSets":
    ...
    def results_for_all_bearings(
        self: Self,
    ) -> "List[_4350.DutyCycleResultsForSingleBearing]":
    ...
    def results_for_all_shafts(
        self: Self,
    ) -> "List[_4351.DutyCycleResultsForSingleShaft]":
