...
class CylindricalGearSetParametricStudyTool(_4360.GearSetParametricStudyTool):
    """CylindricalGearSetParametricStudyTool
    ...
    def cylindrical_gears_parametric_study_tool(
        self: Self,
    ) -> "List[_4341.CylindricalGearParametricStudyTool]":
    ...
    def cylindrical_meshes_parametric_study_tool(
        self: Self,
    ) -> "List[_4340.CylindricalGearMeshParametricStudyTool]":
