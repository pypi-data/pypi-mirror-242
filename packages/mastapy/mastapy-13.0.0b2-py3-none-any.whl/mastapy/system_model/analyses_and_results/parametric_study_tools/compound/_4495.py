...
class FaceGearSetCompoundParametricStudyTool(_4500.GearSetCompoundParametricStudyTool):
    """FaceGearSetCompoundParametricStudyTool
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4355.FaceGearSetParametricStudyTool]":
    ...
    def face_gears_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4493.FaceGearCompoundParametricStudyTool]":
    ...
    def face_meshes_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4494.FaceGearMeshCompoundParametricStudyTool]":
