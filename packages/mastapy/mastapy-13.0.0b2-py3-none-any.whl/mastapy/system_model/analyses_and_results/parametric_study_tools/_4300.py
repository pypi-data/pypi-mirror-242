...
class AssemblyParametricStudyTool(_4293.AbstractAssemblyParametricStudyTool):
    """AssemblyParametricStudyTool
    ...
    def all_duty_cycle_results(
        self: Self,
    ) -> "List[_4347.DutyCycleResultsForAllComponents]":
    ...
    @property
    def bearings(self: Self) -> "List[_4301.BearingParametricStudyTool]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4303.BeltDriveParametricStudyTool]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4312.BoltedJointParametricStudyTool]":
    ...
    @property
    def bolts(self: Self) -> "List[_4313.BoltParametricStudyTool]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4334.CVTParametricStudyTool]":
    ...
    @property
    def clutches(self: Self) -> "List[_4316.ClutchParametricStudyTool]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_4321.ConceptCouplingParametricStudyTool]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4336.CycloidalAssemblyParametricStudyTool]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4338.CycloidalDiscParametricStudyTool]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_4342.CylindricalGearSetParametricStudyTool]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4356.FEPartParametricStudyTool]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4355.FaceGearSetParametricStudyTool]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4357.FlexiblePinAssemblyParametricStudyTool]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4364.HypoidGearSetParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4371.KlingelnbergCycloPalloidHypoidGearSetParametricStudyTool]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4375.MassDiscParametricStudyTool]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4376.MeasurementComponentParametricStudyTool]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4379.OilSealParametricStudyTool]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4396.PlanetCarrierParametricStudyTool]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4397.PointLoadParametricStudyTool]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4398.PowerLoadParametricStudyTool]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4400.RingPinsParametricStudyTool]":
    ...
    @property
    def shafts(self: Self) -> "List[_4407.ShaftParametricStudyTool]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4412.SpiralBevelGearSetParametricStudyTool]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4415.SpringDamperParametricStudyTool]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4418.StraightBevelDiffGearSetParametricStudyTool]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4421.StraightBevelGearSetParametricStudyTool]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4425.SynchroniserParametricStudyTool]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4429.TorqueConverterParametricStudyTool]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_4432.UnbalancedMassParametricStudyTool]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4436.WormGearSetParametricStudyTool]":
