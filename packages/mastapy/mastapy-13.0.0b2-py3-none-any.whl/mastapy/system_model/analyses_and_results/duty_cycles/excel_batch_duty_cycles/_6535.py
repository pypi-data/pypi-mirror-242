...
class ExcelBatchDutyCycleSpectraCreatorDetails(_0.APIBase):
    ...
    @property
    def excel_file_details(self: Self) -> "_6536.ExcelFileDetails":
    ...
    @property
    def masta_file_details(self: Self) -> "_6539.MASTAFileDetails":
    ...
    @property
    def working_folder(self: Self) -> "_1597.SelectableFolder":
    ...
    def excel_sheet_design_state_selection(
        self: Self,
    ) -> "List[_6538.ExcelSheetDesignStateSelector]":
