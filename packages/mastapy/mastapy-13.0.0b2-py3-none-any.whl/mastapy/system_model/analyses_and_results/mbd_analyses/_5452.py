...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5451, _5450
...
class KlingelnbergCycloPalloidHypoidGearSetMultibodyDynamicsAnalysis(
    ...
    def gears(
        self: Self,
    ) -> "List[_5451.KlingelnbergCycloPalloidHypoidGearMultibodyDynamicsAnalysis]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_meshes_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5450.KlingelnbergCycloPalloidHypoidGearMeshMultibodyDynamicsAnalysis]":
