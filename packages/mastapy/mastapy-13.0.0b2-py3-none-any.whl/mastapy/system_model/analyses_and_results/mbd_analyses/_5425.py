...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.mbd_analyses import _5424, _5423
...
class CylindricalGearSetMultibodyDynamicsAnalysis(
    ...
    @property
    def gears(self: Self) -> "List[_5424.CylindricalGearMultibodyDynamicsAnalysis]":
    ...
    def cylindrical_gears_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5424.CylindricalGearMultibodyDynamicsAnalysis]":
        """List[mastapy.system_model.analyses_and_results.mbd_analyses.CylindricalGearMultibodyDynamicsAnalysis]
    ...
    def cylindrical_meshes_multibody_dynamics_analysis(
        self: Self,
    ) -> "List[_5423.CylindricalGearMeshMultibodyDynamicsAnalysis]":
