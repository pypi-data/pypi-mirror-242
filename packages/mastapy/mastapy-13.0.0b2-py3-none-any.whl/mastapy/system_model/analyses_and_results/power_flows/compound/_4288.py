...
class WormGearMeshCompoundPowerFlow(_4223.GearMeshCompoundPowerFlow):
    """WormGearMeshCompoundPowerFlow
    ...
    @property
    def component_design(self: Self) -> "_2327.WormGearMesh":
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_4158.WormGearMeshPowerFlow]":
    ...
    @property
    def connection_analysis_cases(self: Self) -> "List[_4158.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
