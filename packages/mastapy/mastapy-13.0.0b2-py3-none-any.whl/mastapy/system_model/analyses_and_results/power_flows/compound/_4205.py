...
class CVTCompoundPowerFlow(_4174.BeltDriveCompoundPowerFlow):
    """CVTCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4071.CVTPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4071.CVTPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.CVTPowerFlow]
