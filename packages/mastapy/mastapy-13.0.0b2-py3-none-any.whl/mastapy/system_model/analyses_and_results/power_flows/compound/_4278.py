...
class SynchroniserHalfCompoundPowerFlow(_4279.SynchroniserPartCompoundPowerFlow):
    """SynchroniserHalfCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4147.SynchroniserHalfPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4147.SynchroniserHalfPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SynchroniserHalfPowerFlow]
