...
class ZerolBevelGearSetCompoundPowerFlow(_4182.BevelGearSetCompoundPowerFlow):
    """ZerolBevelGearSetCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4163.ZerolBevelGearSetPowerFlow]":
    ...
    def zerol_bevel_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4290.ZerolBevelGearCompoundPowerFlow]":
    ...
    def zerol_bevel_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4291.ZerolBevelGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4163.ZerolBevelGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ZerolBevelGearSetPowerFlow]
