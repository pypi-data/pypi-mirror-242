...
class ExternalCADModelCompoundPowerFlow(_4189.ComponentCompoundPowerFlow):
    """ExternalCADModelCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4083.ExternalCADModelPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4083.ExternalCADModelPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ExternalCADModelPowerFlow]
