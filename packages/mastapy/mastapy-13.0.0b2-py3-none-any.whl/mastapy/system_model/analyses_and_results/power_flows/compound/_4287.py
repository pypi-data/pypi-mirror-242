...
class WormGearCompoundPowerFlow(_4222.GearCompoundPowerFlow):
    """WormGearCompoundPowerFlow
    ...
    @property
    def gear_duty_cycle_rating(self: Self) -> "_370.WormGearDutyCycleRating":
    ...
    @property
    def worm_gear_duty_cycle_rating(self: Self) -> "_370.WormGearDutyCycleRating":
        """mastapy.gears.rating.worm.WormGearDutyCycleRating
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4159.WormGearPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4159.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
