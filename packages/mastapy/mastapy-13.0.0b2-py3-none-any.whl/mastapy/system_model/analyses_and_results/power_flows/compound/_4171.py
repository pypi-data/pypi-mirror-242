...
class AssemblyCompoundPowerFlow(_4164.AbstractAssemblyCompoundPowerFlow):
    """AssemblyCompoundPowerFlow
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4037.AssemblyPowerFlow]":
    ...
    @property
    def bearings(self: Self) -> "List[_4172.BearingCompoundPowerFlow]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4174.BeltDriveCompoundPowerFlow]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4177.BevelDifferentialGearSetCompoundPowerFlow]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4184.BoltedJointCompoundPowerFlow]":
    ...
    @property
    def bolts(self: Self) -> "List[_4183.BoltCompoundPowerFlow]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4205.CVTCompoundPowerFlow]":
    ...
    @property
    def clutches(self: Self) -> "List[_4185.ClutchCompoundPowerFlow]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_4190.ConceptCouplingCompoundPowerFlow]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_4195.ConceptGearSetCompoundPowerFlow]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4207.CycloidalAssemblyCompoundPowerFlow]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4209.CycloidalDiscCompoundPowerFlow]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_4213.CylindricalGearSetCompoundPowerFlow]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4220.FEPartCompoundPowerFlow]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4219.FaceGearSetCompoundPowerFlow]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4221.FlexiblePinAssemblyCompoundPowerFlow]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4228.HypoidGearSetCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4235.KlingelnbergCycloPalloidHypoidGearSetCompoundPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4238.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4239.MassDiscCompoundPowerFlow]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4240.MeasurementComponentCompoundPowerFlow]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4242.OilSealCompoundPowerFlow]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4244.PartToPartShearCouplingCompoundPowerFlow]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4249.PlanetCarrierCompoundPowerFlow]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4250.PointLoadCompoundPowerFlow]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4251.PowerLoadCompoundPowerFlow]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4253.RingPinsCompoundPowerFlow]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4255.RollingRingAssemblyCompoundPowerFlow]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4260.ShaftHubConnectionCompoundPowerFlow]":
    ...
    @property
    def shafts(self: Self) -> "List[_4259.ShaftCompoundPowerFlow]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4265.SpiralBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4266.SpringDamperCompoundPowerFlow]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4271.StraightBevelDiffGearSetCompoundPowerFlow]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4274.StraightBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4277.SynchroniserCompoundPowerFlow]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_4281.TorqueConverterCompoundPowerFlow]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_4285.UnbalancedMassCompoundPowerFlow]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4289.WormGearSetCompoundPowerFlow]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4292.ZerolBevelGearSetCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4037.AssemblyPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.AssemblyPowerFlow]
