...
class VirtualComponentCompoundPowerFlow(_4241.MountableComponentCompoundPowerFlow):
    """VirtualComponentCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4157.VirtualComponentPowerFlow]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4157.VirtualComponentPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.VirtualComponentPowerFlow]
