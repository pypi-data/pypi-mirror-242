...
class FaceGearSetCompoundPowerFlow(_4224.GearSetCompoundPowerFlow):
    """FaceGearSetCompoundPowerFlow
    ...
    @property
    def component_design(self: Self) -> "_2527.FaceGearSet":
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4086.FaceGearSetPowerFlow]":
    ...
    def face_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4217.FaceGearCompoundPowerFlow]":
    ...
    def face_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4218.FaceGearMeshCompoundPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4086.FaceGearSetPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.FaceGearSetPowerFlow]
