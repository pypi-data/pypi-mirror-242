...
class BevelGearMeshCompoundPowerFlow(_4169.AGMAGleasonConicalGearMeshCompoundPowerFlow):
    """BevelGearMeshCompoundPowerFlow
    ...
    @property
    def connection_analysis_cases(self: Self) -> "List[_4046.BevelGearMeshPowerFlow]":
    ...
    def connection_analysis_cases_ready(
        self: Self,
    ) -> "List[_4046.BevelGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BevelGearMeshPowerFlow]
