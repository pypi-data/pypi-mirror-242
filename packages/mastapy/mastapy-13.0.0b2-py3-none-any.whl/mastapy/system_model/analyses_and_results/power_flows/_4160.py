...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4159, _4158
...
class WormGearSetPowerFlow(_4092.GearSetPowerFlow):
    """WormGearSetPowerFlow
    ...
    @property
    def rating(self: Self) -> "_374.WormGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_374.WormGearSetRating":
        """mastapy.gears.rating.worm.WormGearSetRating
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4159.WormGearPowerFlow]":
    ...
    @property
    def worm_gears_power_flow(self: Self) -> "List[_4159.WormGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4158.WormGearMeshPowerFlow]":
    ...
    @property
    def worm_meshes_power_flow(self: Self) -> "List[_4158.WormGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.WormGearMeshPowerFlow]
