...
class ZerolBevelGearSetPowerFlow(_4048.BevelGearSetPowerFlow):
    """ZerolBevelGearSetPowerFlow
    ...
    @property
    def rating(self: Self) -> "_369.ZerolBevelGearSetRating":
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_369.ZerolBevelGearSetRating":
        """mastapy.gears.rating.zerol_bevel.ZerolBevelGearSetRating
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4162.ZerolBevelGearPowerFlow]":
    ...
    def zerol_bevel_gears_power_flow(
        self: Self,
    ) -> "List[_4162.ZerolBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ZerolBevelGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4161.ZerolBevelGearMeshPowerFlow]":
    ...
    def zerol_bevel_meshes_power_flow(
        self: Self,
    ) -> "List[_4161.ZerolBevelGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ZerolBevelGearMeshPowerFlow]
