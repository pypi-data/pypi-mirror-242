...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4134, _4133
...
class SpiralBevelGearSetPowerFlow(_4048.BevelGearSetPowerFlow):
    """SpiralBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4134.SpiralBevelGearPowerFlow]":
    ...
    def spiral_bevel_gears_power_flow(
        self: Self,
    ) -> "List[_4134.SpiralBevelGearPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpiralBevelGearPowerFlow]
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4133.SpiralBevelGearMeshPowerFlow]":
    ...
    def spiral_bevel_meshes_power_flow(
        self: Self,
    ) -> "List[_4133.SpiralBevelGearMeshPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpiralBevelGearMeshPowerFlow]
