...
class StraightBevelGearSetPowerFlow(_4048.BevelGearSetPowerFlow):
    """StraightBevelGearSetPowerFlow
    ...
    @property
    def gears_power_flow(self: Self) -> "List[_4143.StraightBevelGearPowerFlow]":
    ...
    @property
    def meshes_power_flow(self: Self) -> "List[_4142.StraightBevelGearMeshPowerFlow]":
