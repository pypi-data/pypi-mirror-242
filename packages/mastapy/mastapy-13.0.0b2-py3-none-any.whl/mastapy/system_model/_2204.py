...
from mastapy.system_model.part_model import _2469, _2470
...
if TYPE_CHECKING:
    from mastapy.system_model import _2205, _2209
...
class DutyCycleImporter(_0.APIBase):
    ...
    def design_state_destinations(
        self: Self,
    ) -> "List[_2205.DutyCycleImporterDesignEntityMatch[_5660.DesignState]]":
    ...
    @property
    def duty_cycles_to_import(self: Self) -> "List[_2209.IncludeDutyCycleOption]":
    ...
    def point_load_destinations(
        self: Self,
    ) -> "List[_2205.DutyCycleImporterDesignEntityMatch[_2469.PointLoad]]":
    ...
    def power_load_destinations(
        self: Self,
    ) -> "List[_2205.DutyCycleImporterDesignEntityMatch[_2470.PowerLoad]]":
