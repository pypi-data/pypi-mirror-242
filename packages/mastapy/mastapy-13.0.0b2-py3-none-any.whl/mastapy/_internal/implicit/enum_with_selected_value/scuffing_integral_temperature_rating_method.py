...
class EnumWithSelectedValue_ScuffingIntegralTemperatureRatingMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_480.ScuffingIntegralTemperatureRatingMethod":
        ...
        return _480.ScuffingIntegralTemperatureRatingMethod

    @classmethod
    def implicit_type(cls) -> "_480.ScuffingIntegralTemperatureRatingMethod.type_()":
        ...
        return _480.ScuffingIntegralTemperatureRatingMethod.type_()

    @property
    def selected_value(self: Self) -> "_480.ScuffingIntegralTemperatureRatingMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_480.ScuffingIntegralTemperatureRatingMethod]":
