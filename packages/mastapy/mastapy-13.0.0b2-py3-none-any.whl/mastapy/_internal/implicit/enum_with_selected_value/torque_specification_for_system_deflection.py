...
class EnumWithSelectedValue_TorqueSpecificationForSystemDeflection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6975.TorqueSpecificationForSystemDeflection":
        ...
        return _6975.TorqueSpecificationForSystemDeflection

    @classmethod
    def implicit_type(cls) -> "_6975.TorqueSpecificationForSystemDeflection.type_()":
        ...
        return _6975.TorqueSpecificationForSystemDeflection.type_()

    @property
    def selected_value(self: Self) -> "_6975.TorqueSpecificationForSystemDeflection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_6975.TorqueSpecificationForSystemDeflection]":
