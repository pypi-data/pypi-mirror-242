...
class EnumWithSelectedValue_FatigueLoadLimitCalculationMethodEnum(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2150.FatigueLoadLimitCalculationMethodEnum":
        ...
        return _2150.FatigueLoadLimitCalculationMethodEnum

    @classmethod
    def implicit_type(cls) -> "_2150.FatigueLoadLimitCalculationMethodEnum.type_()":
        ...
        return _2150.FatigueLoadLimitCalculationMethodEnum.type_()

    @property
    def selected_value(self: Self) -> "_2150.FatigueLoadLimitCalculationMethodEnum":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2150.FatigueLoadLimitCalculationMethodEnum]":
