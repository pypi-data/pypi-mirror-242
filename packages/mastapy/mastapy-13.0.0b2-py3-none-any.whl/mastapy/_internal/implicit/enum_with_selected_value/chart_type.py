...
class EnumWithSelectedValue_ChartType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_641.ChartType":
        ...
        return _641.ChartType

    @classmethod
    def implicit_type(cls) -> "_641.ChartType.type_()":
        ...
        return _641.ChartType.type_()

    @property
    def selected_value(self: Self) -> "_641.ChartType":
    ...
    @property
    def available_values(self: Self) -> "List[_641.ChartType]":
