...
class EnumWithSelectedValue_ThreeDViewContourOptionSecondSelection(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1821.ThreeDViewContourOptionSecondSelection":
        ...
        return _1821.ThreeDViewContourOptionSecondSelection

    @classmethod
    def implicit_type(cls) -> "_1821.ThreeDViewContourOptionSecondSelection.type_()":
        ...
        return _1821.ThreeDViewContourOptionSecondSelection.type_()

    @property
    def selected_value(self: Self) -> "_1821.ThreeDViewContourOptionSecondSelection":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1821.ThreeDViewContourOptionSecondSelection]":
