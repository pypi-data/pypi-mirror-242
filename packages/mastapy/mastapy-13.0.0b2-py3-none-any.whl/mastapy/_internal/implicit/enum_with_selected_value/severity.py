...
from mastapy.utility.model_validation import _1790
...
class EnumWithSelectedValue_Severity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1790.Severity":
        ...
        return _1790.Severity

    @classmethod
    def implicit_type(cls) -> "_1790.Severity.type_()":
        ...
        return _1790.Severity.type_()

    @property
    def selected_value(self: Self) -> "_1790.Severity":
    ...
    @property
    def available_values(self: Self) -> "List[_1790.Severity]":
