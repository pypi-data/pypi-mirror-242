...
class EnumWithSelectedValue_ExtrapolationOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1507.ExtrapolationOptions":
        ...
        return _1507.ExtrapolationOptions

    @classmethod
    def implicit_type(cls) -> "_1507.ExtrapolationOptions.type_()":
        ...
        return _1507.ExtrapolationOptions.type_()

    @property
    def selected_value(self: Self) -> "_1507.ExtrapolationOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1507.ExtrapolationOptions]":
