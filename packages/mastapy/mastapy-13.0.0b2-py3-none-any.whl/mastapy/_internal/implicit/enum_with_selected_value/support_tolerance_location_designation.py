...
class EnumWithSelectedValue_SupportToleranceLocationDesignation(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1921.SupportToleranceLocationDesignation":
        ...
        return _1921.SupportToleranceLocationDesignation

    @classmethod
    def implicit_type(cls) -> "_1921.SupportToleranceLocationDesignation.type_()":
        ...
        return _1921.SupportToleranceLocationDesignation.type_()

    @property
    def selected_value(self: Self) -> "_1921.SupportToleranceLocationDesignation":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1921.SupportToleranceLocationDesignation]":
