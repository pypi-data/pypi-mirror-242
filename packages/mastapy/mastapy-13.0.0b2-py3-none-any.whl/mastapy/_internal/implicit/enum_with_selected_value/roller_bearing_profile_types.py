...
class EnumWithSelectedValue_RollerBearingProfileTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1889.RollerBearingProfileTypes":
        ...
        return _1889.RollerBearingProfileTypes

    @classmethod
    def implicit_type(cls) -> "_1889.RollerBearingProfileTypes.type_()":
        ...
        return _1889.RollerBearingProfileTypes.type_()

    @property
    def selected_value(self: Self) -> "_1889.RollerBearingProfileTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1889.RollerBearingProfileTypes]":
