...
class EnumWithSelectedValue_LocationOfRootReliefEvaluation(
    ...
    @classmethod
    def wrapped_type(cls) -> "_573.LocationOfRootReliefEvaluation":
        ...
        return _573.LocationOfRootReliefEvaluation

    @classmethod
    def implicit_type(cls) -> "_573.LocationOfRootReliefEvaluation.type_()":
        ...
        return _573.LocationOfRootReliefEvaluation.type_()

    @property
    def selected_value(self: Self) -> "_573.LocationOfRootReliefEvaluation":
    ...
    @property
    def available_values(self: Self) -> "List[_573.LocationOfRootReliefEvaluation]":
