...
class EnumWithSelectedValue_CandidateDisplayChoice(
    ...
    @classmethod
    def wrapped_type(cls) -> "_901.CandidateDisplayChoice":
        ...
        return _901.CandidateDisplayChoice

    @classmethod
    def implicit_type(cls) -> "_901.CandidateDisplayChoice.type_()":
        ...
        return _901.CandidateDisplayChoice.type_()

    @property
    def selected_value(self: Self) -> "_901.CandidateDisplayChoice":
    ...
    @property
    def available_values(self: Self) -> "List[_901.CandidateDisplayChoice]":
