...
class EnumWithSelectedValue_DestinationDesignState(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6989.DestinationDesignState":
        ...
        return _6989.DestinationDesignState

    @classmethod
    def implicit_type(cls) -> "_6989.DestinationDesignState.type_()":
        ...
        return _6989.DestinationDesignState.type_()

    @property
    def selected_value(self: Self) -> "_6989.DestinationDesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_6989.DestinationDesignState]":
