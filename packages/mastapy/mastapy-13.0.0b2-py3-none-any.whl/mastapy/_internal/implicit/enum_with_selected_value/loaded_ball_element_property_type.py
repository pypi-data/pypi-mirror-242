...
class EnumWithSelectedValue_LoadedBallElementPropertyType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1960.LoadedBallElementPropertyType":
        ...
        return _1960.LoadedBallElementPropertyType

    @classmethod
    def implicit_type(cls) -> "_1960.LoadedBallElementPropertyType.type_()":
        ...
        return _1960.LoadedBallElementPropertyType.type_()

    @property
    def selected_value(self: Self) -> "_1960.LoadedBallElementPropertyType":
    ...
    @property
    def available_values(self: Self) -> "List[_1960.LoadedBallElementPropertyType]":
