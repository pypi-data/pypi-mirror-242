...
class EnumWithSelectedValue_ConicalManufactureMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1156.ConicalManufactureMethods":
        ...
        return _1156.ConicalManufactureMethods

    @classmethod
    def implicit_type(cls) -> "_1156.ConicalManufactureMethods.type_()":
        ...
        return _1156.ConicalManufactureMethods.type_()

    @property
    def selected_value(self: Self) -> "_1156.ConicalManufactureMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_1156.ConicalManufactureMethods]":
