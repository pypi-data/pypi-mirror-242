...
class EnumWithSelectedValue_HertzianContactDeflectionCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1571.HertzianContactDeflectionCalculationMethod":
        ...
        return _1571.HertzianContactDeflectionCalculationMethod

    @classmethod
    def implicit_type(
        cls,
    ) -> "_1571.HertzianContactDeflectionCalculationMethod.type_()":
        ...
        return _1571.HertzianContactDeflectionCalculationMethod.type_()

    @property
    def selected_value(
        self: Self,
    ) -> "_1571.HertzianContactDeflectionCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1571.HertzianContactDeflectionCalculationMethod]":
