...
class EnumWithSelectedValue_BearingStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5383.BearingStiffnessModel":
        ...
        return _5383.BearingStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5383.BearingStiffnessModel.type_()":
        ...
        return _5383.BearingStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5383.BearingStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5383.BearingStiffnessModel]":
