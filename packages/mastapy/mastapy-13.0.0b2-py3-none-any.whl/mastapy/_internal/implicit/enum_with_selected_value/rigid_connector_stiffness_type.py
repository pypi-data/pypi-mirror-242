...
class EnumWithSelectedValue_RigidConnectorStiffnessType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2589.RigidConnectorStiffnessType":
        ...
        return _2589.RigidConnectorStiffnessType

    @classmethod
    def implicit_type(cls) -> "_2589.RigidConnectorStiffnessType.type_()":
        ...
        return _2589.RigidConnectorStiffnessType.type_()

    @property
    def selected_value(self: Self) -> "_2589.RigidConnectorStiffnessType":
    ...
    @property
    def available_values(self: Self) -> "List[_2589.RigidConnectorStiffnessType]":
