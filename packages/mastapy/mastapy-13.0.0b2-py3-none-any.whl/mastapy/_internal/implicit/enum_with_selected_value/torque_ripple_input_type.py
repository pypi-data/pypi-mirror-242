...
class EnumWithSelectedValue_TorqueRippleInputType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6974.TorqueRippleInputType":
        ...
        return _6974.TorqueRippleInputType

    @classmethod
    def implicit_type(cls) -> "_6974.TorqueRippleInputType.type_()":
        ...
        return _6974.TorqueRippleInputType.type_()

    @property
    def selected_value(self: Self) -> "_6974.TorqueRippleInputType":
    ...
    @property
    def available_values(self: Self) -> "List[_6974.TorqueRippleInputType]":
