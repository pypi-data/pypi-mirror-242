...
class EnumWithSelectedValue_RaceRadialMountingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1962.RaceRadialMountingType":
        ...
        return _1962.RaceRadialMountingType

    @classmethod
    def implicit_type(cls) -> "_1962.RaceRadialMountingType.type_()":
        ...
        return _1962.RaceRadialMountingType.type_()

    @property
    def selected_value(self: Self) -> "_1962.RaceRadialMountingType":
    ...
    @property
    def available_values(self: Self) -> "List[_1962.RaceRadialMountingType]":
