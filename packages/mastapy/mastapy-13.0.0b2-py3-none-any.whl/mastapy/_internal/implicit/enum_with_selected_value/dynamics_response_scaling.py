...
class EnumWithSelectedValue_DynamicsResponseScaling(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1503.DynamicsResponseScaling":
        ...
        return _1503.DynamicsResponseScaling

    @classmethod
    def implicit_type(cls) -> "_1503.DynamicsResponseScaling.type_()":
        ...
        return _1503.DynamicsResponseScaling.type_()

    @property
    def selected_value(self: Self) -> "_1503.DynamicsResponseScaling":
    ...
    @property
    def available_values(self: Self) -> "List[_1503.DynamicsResponseScaling]":
