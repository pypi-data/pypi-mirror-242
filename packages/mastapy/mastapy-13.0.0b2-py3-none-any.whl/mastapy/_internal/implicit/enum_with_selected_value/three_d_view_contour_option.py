...
class EnumWithSelectedValue_ThreeDViewContourOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1819.ThreeDViewContourOption":
        ...
        return _1819.ThreeDViewContourOption

    @classmethod
    def implicit_type(cls) -> "_1819.ThreeDViewContourOption.type_()":
        ...
        return _1819.ThreeDViewContourOption.type_()

    @property
    def selected_value(self: Self) -> "_1819.ThreeDViewContourOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1819.ThreeDViewContourOption]":
