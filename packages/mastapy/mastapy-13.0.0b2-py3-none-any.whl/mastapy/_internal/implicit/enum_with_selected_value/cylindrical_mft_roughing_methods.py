...
class EnumWithSelectedValue_CylindricalMftRoughingMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_622.CylindricalMftRoughingMethods":
        ...
        return _622.CylindricalMftRoughingMethods

    @classmethod
    def implicit_type(cls) -> "_622.CylindricalMftRoughingMethods.type_()":
        ...
        return _622.CylindricalMftRoughingMethods.type_()

    @property
    def selected_value(self: Self) -> "_622.CylindricalMftRoughingMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_622.CylindricalMftRoughingMethods]":
