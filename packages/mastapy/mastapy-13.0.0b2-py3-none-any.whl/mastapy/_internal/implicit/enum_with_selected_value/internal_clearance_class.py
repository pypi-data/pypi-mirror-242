...
class EnumWithSelectedValue_InternalClearanceClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1900.InternalClearanceClass":
        ...
        return _1900.InternalClearanceClass

    @classmethod
    def implicit_type(cls) -> "_1900.InternalClearanceClass.type_()":
        ...
        return _1900.InternalClearanceClass.type_()

    @property
    def selected_value(self: Self) -> "_1900.InternalClearanceClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1900.InternalClearanceClass]":
