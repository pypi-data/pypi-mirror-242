...
class EnumWithSelectedValue_ActiveProcessMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_656.ActiveProcessMethod":
        ...
        return _656.ActiveProcessMethod

    @classmethod
    def implicit_type(cls) -> "_656.ActiveProcessMethod.type_()":
        ...
        return _656.ActiveProcessMethod.type_()

    @property
    def selected_value(self: Self) -> "_656.ActiveProcessMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_656.ActiveProcessMethod]":
