...
class EnumWithSelectedValue_PowerLoadInputTorqueSpecificationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2215.PowerLoadInputTorqueSpecificationMethod":
        ...
        return _2215.PowerLoadInputTorqueSpecificationMethod

    @classmethod
    def implicit_type(cls) -> "_2215.PowerLoadInputTorqueSpecificationMethod.type_()":
        ...
        return _2215.PowerLoadInputTorqueSpecificationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2215.PowerLoadInputTorqueSpecificationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_2215.PowerLoadInputTorqueSpecificationMethod]":
