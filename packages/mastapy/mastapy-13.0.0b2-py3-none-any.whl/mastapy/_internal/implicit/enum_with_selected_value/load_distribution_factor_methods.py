...
class EnumWithSelectedValue_LoadDistributionFactorMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1167.LoadDistributionFactorMethods":
        ...
        return _1167.LoadDistributionFactorMethods

    @classmethod
    def implicit_type(cls) -> "_1167.LoadDistributionFactorMethods.type_()":
        ...
        return _1167.LoadDistributionFactorMethods.type_()

    @property
    def selected_value(self: Self) -> "_1167.LoadDistributionFactorMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_1167.LoadDistributionFactorMethods]":
