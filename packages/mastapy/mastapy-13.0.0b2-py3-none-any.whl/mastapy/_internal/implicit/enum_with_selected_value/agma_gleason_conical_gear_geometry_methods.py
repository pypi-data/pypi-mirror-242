...
class EnumWithSelectedValue_AGMAGleasonConicalGearGeometryMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1177.AGMAGleasonConicalGearGeometryMethods":
        ...
        return _1177.AGMAGleasonConicalGearGeometryMethods

    @classmethod
    def implicit_type(cls) -> "_1177.AGMAGleasonConicalGearGeometryMethods.type_()":
        ...
        return _1177.AGMAGleasonConicalGearGeometryMethods.type_()

    @property
    def selected_value(self: Self) -> "_1177.AGMAGleasonConicalGearGeometryMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1177.AGMAGleasonConicalGearGeometryMethods]":
