...
class EnumWithSelectedValue_AlignmentAxis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1488.AlignmentAxis":
        ...
        return _1488.AlignmentAxis

    @classmethod
    def implicit_type(cls) -> "_1488.AlignmentAxis.type_()":
        ...
        return _1488.AlignmentAxis.type_()

    @property
    def selected_value(self: Self) -> "_1488.AlignmentAxis":
    ...
    @property
    def available_values(self: Self) -> "List[_1488.AlignmentAxis]":
