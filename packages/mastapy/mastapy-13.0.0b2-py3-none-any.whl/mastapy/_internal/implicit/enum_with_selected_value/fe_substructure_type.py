...
from mastapy.system_model.fe import _2386
...
class EnumWithSelectedValue_FESubstructureType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2386.FESubstructureType":
        ...
        return _2386.FESubstructureType

    @classmethod
    def implicit_type(cls) -> "_2386.FESubstructureType.type_()":
        ...
        return _2386.FESubstructureType.type_()

    @property
    def selected_value(self: Self) -> "_2386.FESubstructureType":
    ...
    @property
    def available_values(self: Self) -> "List[_2386.FESubstructureType]":
