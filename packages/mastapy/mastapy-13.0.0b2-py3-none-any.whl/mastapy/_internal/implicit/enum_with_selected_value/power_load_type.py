...
class EnumWithSelectedValue_PowerLoadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2217.PowerLoadType":
        ...
        return _2217.PowerLoadType

    @classmethod
    def implicit_type(cls) -> "_2217.PowerLoadType.type_()":
        ...
        return _2217.PowerLoadType.type_()

    @property
    def selected_value(self: Self) -> "_2217.PowerLoadType":
    ...
    @property
    def available_values(self: Self) -> "List[_2217.PowerLoadType]":
