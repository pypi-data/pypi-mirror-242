...
class EnumWithSelectedValue_StatusItemSeverity(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1793.StatusItemSeverity":
        ...
        return _1793.StatusItemSeverity

    @classmethod
    def implicit_type(cls) -> "_1793.StatusItemSeverity.type_()":
        ...
        return _1793.StatusItemSeverity.type_()

    @property
    def selected_value(self: Self) -> "_1793.StatusItemSeverity":
    ...
    @property
    def available_values(self: Self) -> "List[_1793.StatusItemSeverity]":
