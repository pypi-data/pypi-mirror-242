...
class EnumWithSelectedValue_DudleyEffectiveLengthApproximationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1391.DudleyEffectiveLengthApproximationOption":
        ...
        return _1391.DudleyEffectiveLengthApproximationOption

    @classmethod
    def implicit_type(cls) -> "_1391.DudleyEffectiveLengthApproximationOption.type_()":
        ...
        return _1391.DudleyEffectiveLengthApproximationOption.type_()

    @property
    def selected_value(self: Self) -> "_1391.DudleyEffectiveLengthApproximationOption":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1391.DudleyEffectiveLengthApproximationOption]":
