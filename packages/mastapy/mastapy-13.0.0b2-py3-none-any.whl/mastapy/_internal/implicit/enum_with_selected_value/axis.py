...
class EnumWithSelectedValue_Axis(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1489.Axis":
    ...
    @classmethod
    def implicit_type(cls) -> "_1489.Axis.type_()":
        ...
        return _1489.Axis.type_()

    @property
    def selected_value(self: Self) -> "_1489.Axis":
    ...
    @property
    def available_values(self: Self) -> "List[_1489.Axis]":
