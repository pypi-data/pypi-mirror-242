...
class EnumWithSelectedValue_SplineToleranceClassTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1415.SplineToleranceClassTypes":
        ...
        return _1415.SplineToleranceClassTypes

    @classmethod
    def implicit_type(cls) -> "_1415.SplineToleranceClassTypes.type_()":
        ...
        return _1415.SplineToleranceClassTypes.type_()

    @property
    def selected_value(self: Self) -> "_1415.SplineToleranceClassTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_1415.SplineToleranceClassTypes]":
