...
class EnumWithSelectedValue_ShaftAndHousingFlexibilityOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5481.ShaftAndHousingFlexibilityOption":
        ...
        return _5481.ShaftAndHousingFlexibilityOption

    @classmethod
    def implicit_type(cls) -> "_5481.ShaftAndHousingFlexibilityOption.type_()":
        ...
        return _5481.ShaftAndHousingFlexibilityOption.type_()

    @property
    def selected_value(self: Self) -> "_5481.ShaftAndHousingFlexibilityOption":
    ...
    @property
    def available_values(self: Self) -> "List[_5481.ShaftAndHousingFlexibilityOption]":
