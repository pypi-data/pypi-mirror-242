...
class EnumWithSelectedValue_ThermalExpansionOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2409.ThermalExpansionOption":
        ...
        return _2409.ThermalExpansionOption

    @classmethod
    def implicit_type(cls) -> "_2409.ThermalExpansionOption.type_()":
        ...
        return _2409.ThermalExpansionOption.type_()

    @property
    def selected_value(self: Self) -> "_2409.ThermalExpansionOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2409.ThermalExpansionOption]":
