...
from mastapy.fe_tools.enums import _1240
...
class EnumWithSelectedValue_MaterialPropertyClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1240.MaterialPropertyClass":
        ...
        return _1240.MaterialPropertyClass

    @classmethod
    def implicit_type(cls) -> "_1240.MaterialPropertyClass.type_()":
        ...
        return _1240.MaterialPropertyClass.type_()

    @property
    def selected_value(self: Self) -> "_1240.MaterialPropertyClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1240.MaterialPropertyClass]":
