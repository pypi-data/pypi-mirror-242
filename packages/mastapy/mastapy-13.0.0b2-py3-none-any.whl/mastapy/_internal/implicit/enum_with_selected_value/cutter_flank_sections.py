...
class EnumWithSelectedValue_CutterFlankSections(
    ...
    @classmethod
    def wrapped_type(cls) -> "_607.CutterFlankSections":
        ...
        return _607.CutterFlankSections

    @classmethod
    def implicit_type(cls) -> "_607.CutterFlankSections.type_()":
        ...
        return _607.CutterFlankSections.type_()

    @property
    def selected_value(self: Self) -> "_607.CutterFlankSections":
    ...
    @property
    def available_values(self: Self) -> "List[_607.CutterFlankSections]":
