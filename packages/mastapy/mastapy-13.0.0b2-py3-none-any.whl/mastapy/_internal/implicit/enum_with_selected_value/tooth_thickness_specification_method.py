...
class EnumWithSelectedValue_ToothThicknessSpecificationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1188.ToothThicknessSpecificationMethod":
        ...
        return _1188.ToothThicknessSpecificationMethod

    @classmethod
    def implicit_type(cls) -> "_1188.ToothThicknessSpecificationMethod.type_()":
        ...
        return _1188.ToothThicknessSpecificationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1188.ToothThicknessSpecificationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1188.ToothThicknessSpecificationMethod]":
