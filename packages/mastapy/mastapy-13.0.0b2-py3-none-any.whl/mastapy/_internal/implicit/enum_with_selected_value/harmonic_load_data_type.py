...
class EnumWithSelectedValue_HarmonicLoadDataType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1379.HarmonicLoadDataType":
        ...
        return _1379.HarmonicLoadDataType

    @classmethod
    def implicit_type(cls) -> "_1379.HarmonicLoadDataType.type_()":
        ...
        return _1379.HarmonicLoadDataType.type_()

    @property
    def selected_value(self: Self) -> "_1379.HarmonicLoadDataType":
    ...
    @property
    def available_values(self: Self) -> "List[_1379.HarmonicLoadDataType]":
