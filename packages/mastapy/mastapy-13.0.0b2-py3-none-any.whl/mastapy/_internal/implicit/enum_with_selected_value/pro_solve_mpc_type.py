...
from mastapy.fe_tools.vfx_tools.vfx_enums import _1237
...
class EnumWithSelectedValue_ProSolveMpcType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1237.ProSolveMpcType":
        ...
        return _1237.ProSolveMpcType

    @classmethod
    def implicit_type(cls) -> "_1237.ProSolveMpcType.type_()":
        ...
        return _1237.ProSolveMpcType.type_()

    @property
    def selected_value(self: Self) -> "_1237.ProSolveMpcType":
    ...
    @property
    def available_values(self: Self) -> "List[_1237.ProSolveMpcType]":
