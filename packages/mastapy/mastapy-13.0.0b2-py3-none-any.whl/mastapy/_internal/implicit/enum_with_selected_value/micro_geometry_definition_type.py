...
class EnumWithSelectedValue_MicroGeometryDefinitionType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_644.MicroGeometryDefinitionType":
        ...
        return _644.MicroGeometryDefinitionType

    @classmethod
    def implicit_type(cls) -> "_644.MicroGeometryDefinitionType.type_()":
        ...
        return _644.MicroGeometryDefinitionType.type_()

    @property
    def selected_value(self: Self) -> "_644.MicroGeometryDefinitionType":
    ...
    @property
    def available_values(self: Self) -> "List[_644.MicroGeometryDefinitionType]":
