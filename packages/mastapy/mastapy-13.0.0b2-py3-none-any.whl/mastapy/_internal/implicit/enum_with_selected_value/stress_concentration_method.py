...
class EnumWithSelectedValue_StressConcentrationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2107.StressConcentrationMethod":
        ...
        return _2107.StressConcentrationMethod

    @classmethod
    def implicit_type(cls) -> "_2107.StressConcentrationMethod.type_()":
        ...
        return _2107.StressConcentrationMethod.type_()

    @property
    def selected_value(self: Self) -> "_2107.StressConcentrationMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_2107.StressConcentrationMethod]":
