...
class EnumWithSelectedValue_BearingToleranceClass(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1901.BearingToleranceClass":
        ...
        return _1901.BearingToleranceClass

    @classmethod
    def implicit_type(cls) -> "_1901.BearingToleranceClass.type_()":
        ...
        return _1901.BearingToleranceClass.type_()

    @property
    def selected_value(self: Self) -> "_1901.BearingToleranceClass":
    ...
    @property
    def available_values(self: Self) -> "List[_1901.BearingToleranceClass]":
