...
class EnumWithSelectedValue_RigidConnectorToothSpacingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2592.RigidConnectorToothSpacingType":
        ...
        return _2592.RigidConnectorToothSpacingType

    @classmethod
    def implicit_type(cls) -> "_2592.RigidConnectorToothSpacingType.type_()":
        ...
        return _2592.RigidConnectorToothSpacingType.type_()

    @property
    def selected_value(self: Self) -> "_2592.RigidConnectorToothSpacingType":
    ...
    @property
    def available_values(self: Self) -> "List[_2592.RigidConnectorToothSpacingType]":
