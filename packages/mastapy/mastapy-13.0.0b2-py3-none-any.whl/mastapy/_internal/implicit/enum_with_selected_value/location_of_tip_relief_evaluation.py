...
class EnumWithSelectedValue_LocationOfTipReliefEvaluation(
    ...
    @classmethod
    def wrapped_type(cls) -> "_574.LocationOfTipReliefEvaluation":
        ...
        return _574.LocationOfTipReliefEvaluation

    @classmethod
    def implicit_type(cls) -> "_574.LocationOfTipReliefEvaluation.type_()":
        ...
        return _574.LocationOfTipReliefEvaluation.type_()

    @property
    def selected_value(self: Self) -> "_574.LocationOfTipReliefEvaluation":
    ...
    @property
    def available_values(self: Self) -> "List[_574.LocationOfTipReliefEvaluation]":
