...
class EnumWithSelectedValue_ScuffingFlashTemperatureRatingMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_479.ScuffingFlashTemperatureRatingMethod":
        ...
        return _479.ScuffingFlashTemperatureRatingMethod

    @classmethod
    def implicit_type(cls) -> "_479.ScuffingFlashTemperatureRatingMethod.type_()":
        ...
        return _479.ScuffingFlashTemperatureRatingMethod.type_()

    @property
    def selected_value(self: Self) -> "_479.ScuffingFlashTemperatureRatingMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_479.ScuffingFlashTemperatureRatingMethod]":
