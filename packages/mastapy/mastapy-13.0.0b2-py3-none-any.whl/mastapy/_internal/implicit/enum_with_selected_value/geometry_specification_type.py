...
class EnumWithSelectedValue_GeometrySpecificationType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1048.GeometrySpecificationType":
        ...
        return _1048.GeometrySpecificationType

    @classmethod
    def implicit_type(cls) -> "_1048.GeometrySpecificationType.type_()":
        ...
        return _1048.GeometrySpecificationType.type_()

    @property
    def selected_value(self: Self) -> "_1048.GeometrySpecificationType":
    ...
    @property
    def available_values(self: Self) -> "List[_1048.GeometrySpecificationType]":
