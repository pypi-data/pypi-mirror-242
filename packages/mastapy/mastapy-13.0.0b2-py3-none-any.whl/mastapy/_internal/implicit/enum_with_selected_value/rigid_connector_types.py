...
class EnumWithSelectedValue_RigidConnectorTypes(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2593.RigidConnectorTypes":
        ...
        return _2593.RigidConnectorTypes

    @classmethod
    def implicit_type(cls) -> "_2593.RigidConnectorTypes.type_()":
        ...
        return _2593.RigidConnectorTypes.type_()

    @property
    def selected_value(self: Self) -> "_2593.RigidConnectorTypes":
    ...
    @property
    def available_values(self: Self) -> "List[_2593.RigidConnectorTypes]":
