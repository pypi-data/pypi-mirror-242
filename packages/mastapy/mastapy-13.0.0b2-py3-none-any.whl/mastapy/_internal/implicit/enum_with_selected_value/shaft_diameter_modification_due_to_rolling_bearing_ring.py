...
class EnumWithSelectedValue_ShaftDiameterModificationDueToRollingBearingRing(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2473.ShaftDiameterModificationDueToRollingBearingRing":
        ...
        return _2473.ShaftDiameterModificationDueToRollingBearingRing

    @classmethod
    def implicit_type(
        cls,
    ) -> "_2473.ShaftDiameterModificationDueToRollingBearingRing.type_()":
        ...
        return _2473.ShaftDiameterModificationDueToRollingBearingRing.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_2473.ShaftDiameterModificationDueToRollingBearingRing]":
