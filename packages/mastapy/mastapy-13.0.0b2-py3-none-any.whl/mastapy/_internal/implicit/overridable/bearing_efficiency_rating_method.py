...
class Overridable_BearingEfficiencyRatingMethod(mixins.OverridableMixin, Enum):
    ...
    @property
    def value(self: Self) -> "_290.BearingEfficiencyRatingMethod":
    ...
    @property
    def override_value(self: Self) -> "_290.BearingEfficiencyRatingMethod":
        """mastapy.materials.efficiency.BearingEfficiencyRatingMethod
    ...
    @property
    def calculated_value(self: Self) -> "_290.BearingEfficiencyRatingMethod":
        """mastapy.materials.efficiency.BearingEfficiencyRatingMethod
