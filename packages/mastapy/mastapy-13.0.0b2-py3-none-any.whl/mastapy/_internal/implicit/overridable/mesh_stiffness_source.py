...
class Overridable_MeshStiffnessSource(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_6921.MeshStiffnessSource":
        ...
        return _6921.MeshStiffnessSource

    @classmethod
    def implicit_type(cls) -> "_6921.MeshStiffnessSource.type_()":
        ...
        return _6921.MeshStiffnessSource.type_()

    @property
    def value(self: Self) -> "_6921.MeshStiffnessSource":
    ...
    @property
    def override_value(self: Self) -> "_6921.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource
    ...
    @property
    def calculated_value(self: Self) -> "_6921.MeshStiffnessSource":
        """mastapy.system_model.analyses_and_results.static_loads.MeshStiffnessSource
