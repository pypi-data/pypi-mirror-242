...
class Overridable_WidthSeries(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2173.WidthSeries":
        ...
        return _2173.WidthSeries

    @classmethod
    def implicit_type(cls) -> "_2173.WidthSeries.type_()":
        ...
        return _2173.WidthSeries.type_()

    @property
    def value(self: Self) -> "_2173.WidthSeries":
    ...
    @property
    def override_value(self: Self) -> "_2173.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
    ...
    @property
    def calculated_value(self: Self) -> "_2173.WidthSeries":
        """mastapy.bearings.bearing_designs.rolling.WidthSeries
