...
class Overridable_ContactRatioRequirements(mixins.OverridableMixin, Enum):
    ...
    @property
    def value(self: Self) -> "_320.ContactRatioRequirements":
    ...
    @property
    def override_value(self: Self) -> "_320.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
    ...
    @property
    def calculated_value(self: Self) -> "_320.ContactRatioRequirements":
        """mastapy.gears.ContactRatioRequirements
