...
class ListWithSelectedItem_ElectricMachineDataSet(
    _2371.ElectricMachineDataSet, mixins.ListWithSelectedItemMixin
):
    ...
    def __init__(
        self, instance_to_wrap: "ListWithSelectedItem_ElectricMachineDataSet.TYPE"
    ):
        try:
    ...
    @classmethod
    def implicit_type(cls) -> "_2371.ElectricMachineDataSet.TYPE":
        ...
        return _2371.ElectricMachineDataSet.TYPE

    @property
    def selected_value(self: Self) -> "_2371.ElectricMachineDataSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2371.ElectricMachineDataSet]":
