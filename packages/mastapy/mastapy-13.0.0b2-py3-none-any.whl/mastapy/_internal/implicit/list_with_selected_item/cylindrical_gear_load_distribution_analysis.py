...
class ListWithSelectedItem_CylindricalGearLoadDistributionAnalysis(
    _854.CylindricalGearLoadDistributionAnalysis, mixins.ListWithSelectedItemMixin
):
    ...
    def __init__(
        self,
        instance_to_wrap: "ListWithSelectedItem_CylindricalGearLoadDistributionAnalysis.TYPE",
    ):
        try:
    ...
    @classmethod
    def implicit_type(cls) -> "_854.CylindricalGearLoadDistributionAnalysis.TYPE":
        ...
        return _854.CylindricalGearLoadDistributionAnalysis.TYPE

    @property
    def selected_value(self: Self) -> "_854.CylindricalGearLoadDistributionAnalysis":
    ...
    def available_values(
        self: Self,
    ) -> "List[_854.CylindricalGearLoadDistributionAnalysis]":
