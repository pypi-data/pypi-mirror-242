...
class ListWithSelectedItem_FESubstructureNode(
    _2383.FESubstructureNode, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2383.FESubstructureNode.TYPE":
        ...
        return _2383.FESubstructureNode.TYPE

    @property
    def selected_value(self: Self) -> "_2383.FESubstructureNode":
    ...
    @property
    def available_values(self: Self) -> "List[_2383.FESubstructureNode]":
