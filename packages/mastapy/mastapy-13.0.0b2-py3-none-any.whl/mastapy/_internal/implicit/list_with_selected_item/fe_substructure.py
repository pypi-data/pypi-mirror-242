...
class ListWithSelectedItem_FESubstructure(
    _2381.FESubstructure, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2381.FESubstructure.TYPE":
        ...
        return _2381.FESubstructure.TYPE

    @property
    def selected_value(self: Self) -> "_2381.FESubstructure":
    ...
    @property
    def available_values(self: Self) -> "List[_2381.FESubstructure]":
