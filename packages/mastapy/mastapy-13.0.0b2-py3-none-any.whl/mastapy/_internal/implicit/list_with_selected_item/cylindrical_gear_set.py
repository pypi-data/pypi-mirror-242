...
class ListWithSelectedItem_CylindricalGearSet(
    _2524.CylindricalGearSet, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2524.CylindricalGearSet.TYPE":
        ...
        return _2524.CylindricalGearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2524.CylindricalGearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2524.CylindricalGearSet]":
