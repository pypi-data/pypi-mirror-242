...
class ListWithSelectedItem_DesignState(
    _5660.DesignState, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5660.DesignState.TYPE":
        ...
        return _5660.DesignState.TYPE

    @property
    def selected_value(self: Self) -> "_5660.DesignState":
    ...
    @property
    def available_values(self: Self) -> "List[_5660.DesignState]":
