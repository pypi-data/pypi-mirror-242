...
class ListWithSelectedItem_CylindricalGear(
    _2523.CylindricalGear, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2523.CylindricalGear.TYPE":
        ...
        return _2523.CylindricalGear.TYPE

    @property
    def selected_value(self: Self) -> "_2523.CylindricalGear":
    ...
    @property
    def available_values(self: Self) -> "List[_2523.CylindricalGear]":
