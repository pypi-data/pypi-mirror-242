...
class ListWithSelectedItem_ShaftHubConnection(
    _2596.ShaftHubConnection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2596.ShaftHubConnection.TYPE":
        ...
        return _2596.ShaftHubConnection.TYPE

    @property
    def selected_value(self: Self) -> "_2596.ShaftHubConnection":
    ...
    @property
    def available_values(self: Self) -> "List[_2596.ShaftHubConnection]":
