...
class ListWithSelectedItem_PointLoad(_2469.PointLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2469.PointLoad.TYPE":
        ...
        return _2469.PointLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2469.PointLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2469.PointLoad]":
