...
class ListWithSelectedItem_Unit(_1608.Unit, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_1608.Unit.TYPE":
        ...
        return _1608.Unit.TYPE

    @property
    def selected_value(self: Self) -> "_1608.Unit":
    ...
    @property
    def available_values(self: Self) -> "List[_1608.Unit]":
