...
Self = TypeVar("Self", bound="ListWithSelectedItem_CylindricalSetManufacturingConfig")


class ListWithSelectedItem_CylindricalSetManufacturingConfig(
    _623.CylindricalSetManufacturingConfig, mixins.ListWithSelectedItemMixin
):
    ...
    def __init__(
        self,
        instance_to_wrap: "ListWithSelectedItem_CylindricalSetManufacturingConfig.TYPE",
    ):
        try:
    ...
    @classmethod
    def implicit_type(cls) -> "_623.CylindricalSetManufacturingConfig.TYPE":
        ...
        return _623.CylindricalSetManufacturingConfig.TYPE

    @property
    def selected_value(self: Self) -> "_623.CylindricalSetManufacturingConfig":
    ...
    @property
    def available_values(self: Self) -> "List[_623.CylindricalSetManufacturingConfig]":
