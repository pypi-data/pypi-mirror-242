...
class ListWithSelectedItem_ActiveGearSetDesignSelectionGroup(
    _2510.ActiveGearSetDesignSelectionGroup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2510.ActiveGearSetDesignSelectionGroup.TYPE":
        ...
        return _2510.ActiveGearSetDesignSelectionGroup.TYPE

    @property
    def selected_value(self: Self) -> "_2510.ActiveGearSetDesignSelectionGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_2510.ActiveGearSetDesignSelectionGroup]":
