...
class ListWithSelectedItem_GearSet(_2530.GearSet, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2530.GearSet.TYPE":
        ...
        return _2530.GearSet.TYPE

    @property
    def selected_value(self: Self) -> "_2530.GearSet":
    ...
    @property
    def available_values(self: Self) -> "List[_2530.GearSet]":
