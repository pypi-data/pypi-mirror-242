...
class ListWithSelectedItem_StaticLoadCase(
    _6802.StaticLoadCase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_6802.StaticLoadCase.TYPE":
        ...
        return _6802.StaticLoadCase.TYPE

    @property
    def selected_value(self: Self) -> "_6802.StaticLoadCase":
    ...
    @property
    def available_values(self: Self) -> "List[_6802.StaticLoadCase]":
