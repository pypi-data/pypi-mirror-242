...
class ListWithSelectedItem_ElectricMachineDetail(
    _1259.ElectricMachineDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1259.ElectricMachineDetail.TYPE":
        ...
        return _1259.ElectricMachineDetail.TYPE

    @property
    def selected_value(self: Self) -> "_1259.ElectricMachineDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_1259.ElectricMachineDetail]":
