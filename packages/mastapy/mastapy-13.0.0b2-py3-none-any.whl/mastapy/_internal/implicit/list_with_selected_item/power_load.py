...
class ListWithSelectedItem_PowerLoad(_2470.PowerLoad, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2470.PowerLoad.TYPE":
        ...
        return _2470.PowerLoad.TYPE

    @property
    def selected_value(self: Self) -> "_2470.PowerLoad":
    ...
    @property
    def available_values(self: Self) -> "List[_2470.PowerLoad]":
