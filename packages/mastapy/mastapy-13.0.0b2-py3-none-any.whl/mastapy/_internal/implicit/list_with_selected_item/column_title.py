...
class ListWithSelectedItem_ColumnTitle(
    _1815.ColumnTitle, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1815.ColumnTitle.TYPE":
        ...
        return _1815.ColumnTitle.TYPE

    @property
    def selected_value(self: Self) -> "_1815.ColumnTitle":
    ...
    @property
    def available_values(self: Self) -> "List[_1815.ColumnTitle]":
