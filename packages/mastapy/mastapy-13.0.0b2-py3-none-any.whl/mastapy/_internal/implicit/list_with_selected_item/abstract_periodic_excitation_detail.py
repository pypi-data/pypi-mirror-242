...
class ListWithSelectedItem_AbstractPeriodicExcitationDetail(
    _5676.AbstractPeriodicExcitationDetail, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_5676.AbstractPeriodicExcitationDetail.TYPE":
        ...
        return _5676.AbstractPeriodicExcitationDetail.TYPE

    @property
    def selected_value(self: Self) -> "_5676.AbstractPeriodicExcitationDetail":
    ...
    @property
    def available_values(self: Self) -> "List[_5676.AbstractPeriodicExcitationDetail]":
