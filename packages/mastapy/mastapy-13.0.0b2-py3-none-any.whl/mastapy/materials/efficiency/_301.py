...
class ResistiveTorque(_0.APIBase):
    ...
    class _Cast_ResistiveTorque:
        ...
        def combined_resistive_torque(self: "ResistiveTorque._Cast_ResistiveTorque"):
            from mastapy.materials.efficiency import _291

            return self._parent._cast(_291.CombinedResistiveTorque)

        @property
        def independent_resistive_torque(self: "ResistiveTorque._Cast_ResistiveTorque"):
            from mastapy.materials.efficiency import _294

            return self._parent._cast(_294.IndependentResistiveTorque)
