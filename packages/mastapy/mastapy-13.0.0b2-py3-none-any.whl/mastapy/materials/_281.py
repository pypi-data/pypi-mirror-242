...
class SoundPressureEnclosure(_0.APIBase):
    ...
    @property
    def enclosure_type(self: Self) -> "_282.SoundPressureEnclosureType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._282", "SoundPressureEnclosureType"
        )(value)

    @enclosure_type.setter
    @enforce_parameter_types
    def enclosure_type(self: Self, value: "_282.SoundPressureEnclosureType"):
