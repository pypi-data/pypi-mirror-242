...
if TYPE_CHECKING:
    from mastapy.materials import _257, _289, _253, _285, _288, _241, _265, _287
...
class GeneralTransmissionProperties(_0.APIBase):
    ...
    def bearing_iso762006_static_safety_factor_limit(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._257", "ISO76StaticSafetyFactorLimits"
        )(value)

    @bearing_iso762006_static_safety_factor_limit.setter
    @enforce_parameter_types
    def bearing_iso762006_static_safety_factor_limit(
        self: Self, value: "_257.ISO76StaticSafetyFactorLimits"
    ):
    ...
    @property
    def driven_machine_characteristics(self: Self) -> "_289.WorkingCharacteristics":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._289", "WorkingCharacteristics"
        )(value)

    @driven_machine_characteristics.setter
    @enforce_parameter_types
    def driven_machine_characteristics(
        self: Self, value: "_289.WorkingCharacteristics"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def driving_machine_characteristics(self: Self) -> "_289.WorkingCharacteristics":
        """mastapy.materials.WorkingCharacteristics"""
    ...
    @property
    def gearing_type(self: Self) -> "_253.GearingTypes":
        ...
        return constructor.new_from_mastapy("mastapy.materials._253", "GearingTypes")(
            value
        )

    @gearing_type.setter
    @enforce_parameter_types
    def gearing_type(self: Self, value: "_253.GearingTypes"):
    ...
    @property
    def transmission_application(self: Self) -> "_285.TransmissionApplications":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._285", "TransmissionApplications"
        )(value)

    @transmission_application.setter
    @enforce_parameter_types
    def transmission_application(self: Self, value: "_285.TransmissionApplications"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def wind_turbine_standard(self: Self) -> "_288.WindTurbineStandards":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._288", "WindTurbineStandards"
        )(value)

    @wind_turbine_standard.setter
    @enforce_parameter_types
    def wind_turbine_standard(self: Self, value: "_288.WindTurbineStandards"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def air_properties(self: Self) -> "_241.AirProperties":
    ...
    @property
    def vehicle_dynamics(self: Self) -> "_287.VehicleDynamicsProperties":
