...
if TYPE_CHECKING:
    from mastapy.utility.report import _1781, _1782
    from mastapy.utility.reporting_property_framework import _1786
...
class CustomReportPropertyItem(_0.APIBase):
    ...
    class _Cast_CustomReportPropertyItem:
        ...
        def blank_row(self: "CustomReportPropertyItem._Cast_CustomReportPropertyItem"):
            ...
            return self._parent._cast(_1742.BlankRow)
        ...
        def user_text_row(
            ...
            return self._parent._cast(_1785.UserTextRow)
    ...
    @property
    def font_style(self: Self) -> "_1781.FontStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1781", "FontStyle"
        )(value)

    @font_style.setter
    @enforce_parameter_types
    def font_style(self: Self, value: "_1781.FontStyle"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Utility.Report.FontStyle")
        self.wrapped.FontStyle = value

    @property
    def font_weight(self: Self) -> "_1782.FontWeight":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1782", "FontWeight"
        )(value)

    @font_weight.setter
    @enforce_parameter_types
    def font_weight(self: Self, value: "_1782.FontWeight"):
    ...
    @property
    def horizontal_position(self: Self) -> "_1786.CellValuePosition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.reporting_property_framework._1786", "CellValuePosition"
        )(value)

    @horizontal_position.setter
    @enforce_parameter_types
    def horizontal_position(self: Self, value: "_1786.CellValuePosition"):
        value = conversion.mp_to_pn_enum(
