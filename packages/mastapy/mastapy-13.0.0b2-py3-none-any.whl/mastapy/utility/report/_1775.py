...
class CustomReportText(_1758.CustomReportDefinitionItem):
    """CustomReportText
    ...
    @property
    def heading_type(self: Self) -> "_302.HeadingType":
        ...
        return constructor.new_from_mastapy("mastapy.html._302", "HeadingType")(value)

    @heading_type.setter
    @enforce_parameter_types
    def heading_type(self: Self, value: "_302.HeadingType"):
