...
class CustomReportChartItem(_1771.CustomReportPropertyItem):
    """CustomReportChartItem
    ...
    class _Cast_CustomReportChartItem:
        ...
        def custom_report_property_item(
            ...
            return self._parent._cast(_1771.CustomReportPropertyItem)
    ...
    @property
    def point_shape(self: Self) -> "_1747.SMTChartPointShape":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.report._1747", "SMTChartPointShape"
        )(value)

    @point_shape.setter
    @enforce_parameter_types
    def point_shape(self: Self, value: "_1747.SMTChartPointShape"):
