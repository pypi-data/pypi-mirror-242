...
class MeasurementSettings(_1592.PerMachineSettings):
    """MeasurementSettings
    ...
    @enforce_parameter_types
    def selected_measurement(self: Self, value: "_1603.MeasurementBase"):
        wrapper_type = (
    ...
    @property
    def current_selected_measurement(self: Self) -> "_1603.MeasurementBase":
    ...
    @enforce_parameter_types
    def find_measurement_by_name(self: Self, name: "str") -> "_1603.MeasurementBase":
        """mastapy.utility.units_and_measurements.MeasurementBase
    ...
    @enforce_parameter_types
    def get_measurement(
        self: Self, measurement_type: "_7557.MeasurementType"
