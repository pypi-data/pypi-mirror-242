...
from mastapy.utility.property import _1835
...
class DutyCyclePropertySummaryStress(_1835.DutyCyclePropertySummary["_1712.Stress", T]):
    """DutyCyclePropertySummaryStress
    ...
    class _Cast_DutyCyclePropertySummaryStress:
        ...
        def duty_cycle_property_summary(
            ...
            return self._parent._cast(_1835.DutyCyclePropertySummary)
