...
class BoltMaterial(_1463.BoltedJointMaterial):
    """BoltMaterial
    ...
    @property
    def strength_grade(self: Self) -> "_1482.StrengthGrades":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1482", "StrengthGrades")(
            value
        )

    @strength_grade.setter
    @enforce_parameter_types
    def strength_grade(self: Self, value: "_1482.StrengthGrades"):
