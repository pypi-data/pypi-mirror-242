...
if TYPE_CHECKING:
    from mastapy.bearings import _1894, _1867, _1883
...
class RollingBearingDatabase(
    _1829.SQLDatabase["_1892.RollingBearingKey", "_2163.RollingBearing"]
):
    """RollingBearingDatabase
    ...
    def add_to_database(self: Self, bearing: "_2163.RollingBearing"):
    ...
    @enforce_parameter_types
    def create_bearing(
        self: Self, type_: "_1894.RollingBearingType", designation: "str" = "None"
    ...
    @enforce_parameter_types
    def remove_from_database(self: Self, bearing: "_2163.RollingBearing"):
        """Method does not return.
    ...
    def search_for_rolling_bearing_with_catalog(
        self: Self, catalog: "_1867.BearingCatalog"
    ) -> "List[_2163.RollingBearing]":
    ...
    def search_for_rolling_bearing_with_name_and_catalog(
        self: Self, designation: "str", catalog: "_1867.BearingCatalog"
    ) -> "_2163.RollingBearing":
        """mastapy.bearings.bearing_designs.rolling.RollingBearing
    ...
    def search_for_rolling_bearing_with_name_catalog_and_type(
        self: Self,
        designation: "str",
        catalog: "_1867.BearingCatalog",
        type_: "_1894.RollingBearingType",
    ) -> "List[_2163.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
    ...
    def search_for_rolling_bearing(
        ...
        catalog: "_1867.BearingCatalog",
        type_: "_1894.RollingBearingType",
        bore_range: "_1486.Range",
        outer_diameter_range: "_1486.Range",
        width_range: "_1486.Range",
        dynamic_capacity_range: "_1486.Range",
        number_of_rows: "int",
        material_type: "_1883.HybridSteelAll",
    ) -> "List[_2163.RollingBearing]":
        """List[mastapy.bearings.bearing_designs.rolling.RollingBearing]
