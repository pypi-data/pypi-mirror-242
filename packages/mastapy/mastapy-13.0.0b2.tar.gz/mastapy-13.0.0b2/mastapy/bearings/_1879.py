...
if TYPE_CHECKING:
    from mastapy.bearings import _1888, _1881
...
class BearingSettingsItem(_1827.NamedDatabaseItem):
    """BearingSettingsItem
    ...
    @property
    def failure_probability_for_rating_life_percent(self: Self) -> "_1888.RatingLife":
        ...
        return constructor.new_from_mastapy("mastapy.bearings._1888", "RatingLife")(
            value
        )
    ...
    def failure_probability_for_rating_life_percent(
        self: Self, value: "_1888.RatingLife"
    ):
    ...
    def include_exponent_and_reduction_factors_in_isots162812008(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1881", "ExponentAndReductionFactorsInISO16281Calculation"
        )(value)

    @include_exponent_and_reduction_factors_in_isots162812008.setter
    @enforce_parameter_types
    def include_exponent_and_reduction_factors_in_isots162812008(
        self: Self, value: "_1881.ExponentAndReductionFactorsInISO16281Calculation"
    ):
    ...
    @enforce_parameter_types
    def lubricant_film_temperature_calculation_pressure_fed_grease_filled_bearings(
        self: Self, value: "_1882.FluidFilmTemperatureOptions"
    ):
