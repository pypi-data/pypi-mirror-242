...
class InterferenceTolerance(_1899.BearingConnectionComponent):
    """InterferenceTolerance
    ...
    class _Cast_InterferenceTolerance:
        ...
        def bearing_connection_component(
            ...
            return self._parent._cast(_1899.BearingConnectionComponent)
        ...
        def inner_ring_tolerance(
            ...
            return self._parent._cast(_1904.InnerRingTolerance)
        ...
        def inner_support_tolerance(
            ...
            return self._parent._cast(_1905.InnerSupportTolerance)
        ...
        def outer_ring_tolerance(
            ...
            return self._parent._cast(_1910.OuterRingTolerance)
        ...
        def support_tolerance(
            ...
            return self._parent._cast(_1920.SupportTolerance)
    ...
    @property
    def definition_option(self: Self) -> "_1902.BearingToleranceDefinitionOptions":
    ...
    def definition_option(self: Self, value: "_1902.BearingToleranceDefinitionOptions"):
    ...
    def mounting_point_surface_finish(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1886", "MountingPointSurfaceFinishes"
        )(value)

    @mounting_point_surface_finish.setter
    @enforce_parameter_types
    def mounting_point_surface_finish(
        self: Self, value: "_1886.MountingPointSurfaceFinishes"
    ):
        value = conversion.mp_to_pn_enum(
