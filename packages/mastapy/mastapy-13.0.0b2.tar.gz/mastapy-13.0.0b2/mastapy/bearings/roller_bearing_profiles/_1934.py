...
class RollerBearingProfile(_0.APIBase):
    ...
    class _Cast_RollerBearingProfile:
        ...
        def roller_bearing_conical_profile(
            ...
            from mastapy.bearings.roller_bearing_profiles import _1928

            return self._parent._cast(_1928.RollerBearingConicalProfile)

        @property
        def roller_bearing_crowned_profile(
            self: "RollerBearingProfile._Cast_RollerBearingProfile",
        ):
            from mastapy.bearings.roller_bearing_profiles import _1929

            return self._parent._cast(_1929.RollerBearingCrownedProfile)
        ...
        def roller_bearing_din_lundberg_profile(
            ...
            return self._parent._cast(_1930.RollerBearingDinLundbergProfile)
        ...
        def roller_bearing_flat_profile(
            ...
            return self._parent._cast(_1931.RollerBearingFlatProfile)
        ...
        def roller_bearing_johns_gohar_profile(
            ...
            return self._parent._cast(_1932.RollerBearingJohnsGoharProfile)
        ...
        def roller_bearing_lundberg_profile(
            ...
            return self._parent._cast(_1933.RollerBearingLundbergProfile)
        ...
        def roller_bearing_user_specified_profile(
            ...
            return self._parent._cast(_1935.RollerBearingUserSpecifiedProfile)
