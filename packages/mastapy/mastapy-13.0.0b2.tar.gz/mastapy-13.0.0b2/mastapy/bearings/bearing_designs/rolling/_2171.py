...
class ThrustBallBearing(_2138.BallBearing):
    """ThrustBallBearing
    ...
    @property
    def outer_ring_mounting(self: Self) -> "_1887.OuterRingMounting":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1887", "OuterRingMounting"
        )(value)

    @outer_ring_mounting.setter
    @enforce_parameter_types
    def outer_ring_mounting(self: Self, value: "_1887.OuterRingMounting"):
