...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_designs.fluid_film import _2180, _2181, _2182
...
class PlainOilFedJournalBearing(_2189.PlainJournalBearing):
    """PlainOilFedJournalBearing
    ...
    @property
    def feed_type(self: Self) -> "_1885.JournalOilFeedType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1885", "JournalOilFeedType"
        )(value)

    @feed_type.setter
    @enforce_parameter_types
    def feed_type(self: Self, value: "_1885.JournalOilFeedType"):
    ...
    @property
    def axial_groove_oil_feed(self: Self) -> "_2180.AxialGrooveJournalBearing":
    ...
    @property
    def axial_hole_oil_feed(self: Self) -> "_2181.AxialHoleJournalBearing":
