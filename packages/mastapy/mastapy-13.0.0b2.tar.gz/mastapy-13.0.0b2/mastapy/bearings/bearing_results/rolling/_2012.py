...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling import _1971, _2071
...
class LoadedElement(_0.APIBase):
    ...
    class _Cast_LoadedElement:
        ...
        def loaded_angular_contact_ball_bearing_element(
            ...
            return self._parent._cast(_1980.LoadedAngularContactBallBearingElement)
        ...
        def loaded_ball_bearing_element(self: "LoadedElement._Cast_LoadedElement"):
            ...
            return self._parent._cast(_1998.LoadedBallBearingElement)
        ...
        def loaded_deep_groove_ball_bearing_element(
            ...
            return self._parent._cast(_2009.LoadedDeepGrooveBallBearingElement)
        ...
        def loaded_four_point_contact_ball_bearing_element(
            ...
            return self._parent._cast(_2013.LoadedFourPointContactBallBearingElement)
        ...
        def loaded_multi_point_contact_ball_bearing_element(
            ...
            return self._parent._cast(_2017.LoadedMultiPointContactBallBearingElement)
        ...
        def loaded_self_aligning_ball_bearing_element(
            ...
            return self._parent._cast(_2033.LoadedSelfAligningBallBearingElement)
        ...
        def loaded_three_point_contact_ball_bearing_element(
            ...
            return self._parent._cast(_2048.LoadedThreePointContactBallBearingElement)
        ...
        def loaded_thrust_ball_bearing_element(
            ...
            return self._parent._cast(_2051.LoadedThrustBallBearingElement)
    ...
    @property
    def force_from_inner_race(self: Self) -> "_1942.ElementForce":
    ...
    @property
    def operating_internal_clearance(self: Self) -> "_1971.InternalClearance":
