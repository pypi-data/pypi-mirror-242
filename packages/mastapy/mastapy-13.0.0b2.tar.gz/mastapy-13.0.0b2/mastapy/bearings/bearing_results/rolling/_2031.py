...
if TYPE_CHECKING:
    ...
    from mastapy.bearings.bearing_results.rolling.fitting import _2108, _2110, _2111
...
class LoadedRollingBearingResults(_1952.LoadedDetailedBearingResults):
    """LoadedRollingBearingResults
    ...
    def fluid_film_temperature_source(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bearings._1882", "FluidFilmTemperatureOptions"
        )(value)
    ...
    @property
    def ansiabma(self: Self) -> "_2115.ANSIABMAResults":
    ...
    @property
    def din7322010(self: Self) -> "_1967.DIN7322010Results":
    ...
    @property
    def iso2812007(self: Self) -> "_2101.ISO2812007Results":
    ...
    @property
    def iso762006(self: Self) -> "_2102.ISO762006Results":
    ...
    @property
    def isotr1417912001(self: Self) -> "_1976.ISOTR1417912001Results":
    ...
    @property
    def isotr1417922001(self: Self) -> "_1978.ISOTR1417922001Results":
    ...
    @property
    def isots162812008(self: Self) -> "_2104.ISOTS162812008Results":
    ...
    @property
    def maximum_static_contact_stress(self: Self) -> "_2058.MaximumStaticContactStress":
    ...
    @property
    def skf_module_results(self: Self) -> "_2096.SKFModuleResults":
    ...
    @property
    def all_mounting_results(self: Self) -> "List[_2111.RingFittingThermalResults]":
    ...
    @property
    def rows(self: Self) -> "List[_2032.LoadedRollingBearingRow]":
