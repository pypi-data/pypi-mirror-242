...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2015, _2014
...
class LoadedFourPointContactBallBearingRow(_2001.LoadedBallBearingRow):
    """LoadedFourPointContactBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2015.LoadedFourPointContactBallBearingResults":
    ...
    def race_results(
        self: Self,
    ) -> "List[_2014.LoadedFourPointContactBallBearingRaceResults]":
