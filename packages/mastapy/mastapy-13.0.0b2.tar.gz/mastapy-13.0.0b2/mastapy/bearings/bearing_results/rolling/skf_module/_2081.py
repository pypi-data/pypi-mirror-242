...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling.skf_module import _2083, _2082
...
class Friction(_2094.SKFCalculationResult):
    """Friction
    ...
    @property
    def friction_sources(self: Self) -> "_2083.FrictionSources":
    ...
    @property
    def frictional_moment(self: Self) -> "_2082.FrictionalMoment":
