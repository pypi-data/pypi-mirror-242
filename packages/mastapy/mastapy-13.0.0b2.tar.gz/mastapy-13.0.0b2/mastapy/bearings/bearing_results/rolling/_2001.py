...
if TYPE_CHECKING:
    from mastapy.bearings.bearing_results.rolling import _2000, _1999
...
class LoadedBallBearingRow(_2032.LoadedRollingBearingRow):
    """LoadedBallBearingRow
    ...
    @property
    def loaded_bearing(self: Self) -> "_2000.LoadedBallBearingResults":
    ...
    @property
    def race_results(self: Self) -> "List[_1999.LoadedBallBearingRaceResults]":
