...
if TYPE_CHECKING:
    from mastapy.utility.property import _1836, _1839, _1837, _1838
...
class LoadedRollingBearingDutyCycle(_1954.LoadedNonLinearBearingDutyCycleResults):
    """LoadedRollingBearingDutyCycle
    ...
    class _Cast_LoadedRollingBearingDutyCycle:
        ...
        def loaded_non_linear_bearing_duty_cycle_results(
            ...
            return self._parent._cast(_1954.LoadedNonLinearBearingDutyCycleResults)
    ...
    def ansiabma_dynamic_equivalent_load_summary(
        self: Self,
    ) -> "_1836.DutyCyclePropertySummaryForce[_1873.BearingLoadCaseResultsLightweight]":
    ...
    def maximum_element_normal_stress_inner_summary(
        ...
        "_1839.DutyCyclePropertySummaryStress[_1873.BearingLoadCaseResultsLightweight]"
    ):
    ...
    def maximum_truncation_summary(
        self: Self,
    ) -> "_1837.DutyCyclePropertySummaryPercentage[_1873.BearingLoadCaseResultsLightweight]":
    ...
    def misalignment_summary(
        self: Self,
    ) -> "_1838.DutyCyclePropertySummarySmallAngle[_1873.BearingLoadCaseResultsLightweight]":
