...
if TYPE_CHECKING:
    ...
    from mastapy.cycloidal import _1452, _1455
...
class CycloidalDiscDesign(_0.APIBase):
    ...
    @property
    def crowning_chart(self: Self) -> "_1865.TwoDChartDefinition":
    ...
    @property
    def exporter(self: Self) -> "_1452.CycloidalDiscDesignExporter":
