...
class CMSModel(_0.APIBase):
    ...
    @property
    def software_used_for_reduction(self: Self) -> "_232.SoftwareUsedForReductionType":
    ...
    @property
    def fe_model(self: Self) -> "_183.FEModel":
    ...
    @property
    def reduction_information(self: Self) -> "_1576.AnalysisRunInformation":
    ...
    @property
    def reduction_options(self: Self) -> "_227.CMSOptions":
    ...
    @property
    def element_face_groups(self: Self) -> "List[_223.CMSElementFaceGroup]":
