...
if TYPE_CHECKING:
    ...
    from mastapy.fe_tools.vfx_tools import _1236
...
class CMSOptions(_0.APIBase):
    ...
    @property
    def precision_when_saving_expansion_vectors(self: Self) -> "_1500.DataPrecision":
    ...
    @property
    def internal_mode_options(self: Self) -> "_178.EigenvalueOptions":
    ...
    @property
    def solver_options(self: Self) -> "_1236.ProSolveOptions":
