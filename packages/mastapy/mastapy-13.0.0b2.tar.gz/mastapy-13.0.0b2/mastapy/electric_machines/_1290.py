...
class Rotor(_0.APIBase):
    ...
    class _Cast_Rotor:
        ...
        def cad_rotor(self: "Rotor._Cast_Rotor"):
            ...
            return self._parent._cast(_1247.CADRotor)
        ...
        def surface_permanent_magnet_rotor(self: "Rotor._Cast_Rotor"):
            ...
            return self._parent._cast(_1301.SurfacePermanentMagnetRotor)
    ...
    def d_axis_and_q_axis_convention(
        self: Self,
        value: "Union[_1257.DQAxisConvention, Tuple[_1257.DQAxisConvention, bool]]",
    ):
    ...
    @property
    def skew_slices(self: Self) -> "List[_1292.RotorSkewSlice]":
