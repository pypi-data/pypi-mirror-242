...
class ElectricMachineMeshingOptions(_1263.ElectricMachineMeshingOptionsBase):
    """ElectricMachineMeshingOptions
    ...
    class _Cast_ElectricMachineMeshingOptions:
        ...
        def electric_machine_meshing_options_base(
            ...
            return self._parent._cast(_1263.ElectricMachineMeshingOptionsBase)
    ...
    @property
    def air_gap_partition(self: Self) -> "_1243.AirGapPartition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1243", "AirGapPartition"
        )(value)

    @air_gap_partition.setter
    @enforce_parameter_types
    def air_gap_partition(self: Self, value: "_1243.AirGapPartition"):
