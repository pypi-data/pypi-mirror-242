...
class Windings(_0.APIBase):
    ...
    def double_layer_winding_slot_positions(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1256", "DoubleLayerWindingSlotPositions"
        )(value)

    @double_layer_winding_slot_positions.setter
    @enforce_parameter_types
    def double_layer_winding_slot_positions(
        self: Self, value: "_1256.DoubleLayerWindingSlotPositions"
    ):
    ...
    @property
    def end_winding_inductance_method(self: Self) -> "_1359.EndWindingInductanceMethod":
    ...
    def end_winding_inductance_method(
        self: Self, value: "_1359.EndWindingInductanceMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.ElectricMachines.LoadCasesAndAnalyses.EndWindingInductanceMethod",
    ...
    def fill_factor_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1266", "FillFactorSpecificationMethod"
        )(value)

    @fill_factor_specification_method.setter
    @enforce_parameter_types
    def fill_factor_specification_method(
        self: Self, value: "_1266.FillFactorSpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def mmf(self: Self) -> "_1865.TwoDChartDefinition":
    ...
    @property
    def single_double_layer_windings(self: Self) -> "_1294.SingleOrDoubleLayerWindings":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1294", "SingleOrDoubleLayerWindings"
        )(value)

    @single_double_layer_windings.setter
    @enforce_parameter_types
    def single_double_layer_windings(
        self: Self, value: "_1294.SingleOrDoubleLayerWindings"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def winding_connection(self: Self) -> "_1310.WindingConnection":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1310", "WindingConnection"
        )(value)

    @winding_connection.setter
    @enforce_parameter_types
    def winding_connection(self: Self, value: "_1310.WindingConnection"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def winding_type(self: Self) -> "_1315.WindingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1315", "WindingType"
        )(value)

    @winding_type.setter
    @enforce_parameter_types
    def winding_type(self: Self, value: "_1315.WindingType"):
        value = conversion.mp_to_pn_enum(
    ...
    def wire_size_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1316", "WireSizeSpecificationMethod"
        )(value)

    @wire_size_specification_method.setter
    @enforce_parameter_types
    def wire_size_specification_method(
        self: Self, value: "_1316.WireSizeSpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def mmf_fourier_series_electrical(self: Self) -> "_1510.FourierSeries":
    ...
    @property
    def mmf_fourier_series_mechanical(self: Self) -> "_1510.FourierSeries":
        """mastapy.math_utility.FourierSeries
    ...
    @property
    def windings_viewer(self: Self) -> "_1314.WindingsViewer":
    ...
    @property
    def coils(self: Self) -> "List[_1250.Coil]":
    ...
    @property
    def conductors(self: Self) -> "List[_1309.WindingConductor]":
    ...
    @property
    def phases(self: Self) -> "List[_1288.Phase]":
    ...
    @property
    def slot_section_details(self: Self) -> "List[_1295.SlotSectionDetail]":
