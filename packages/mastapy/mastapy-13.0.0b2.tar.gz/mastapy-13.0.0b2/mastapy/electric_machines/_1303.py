...
from mastapy.electric_machines import _1242
...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1305, _1304
...
class ToothAndSlot(_1242.AbstractToothAndSlot):
    """ToothAndSlot
    ...
    class _Cast_ToothAndSlot:
        ...
        def abstract_tooth_and_slot(self: "ToothAndSlot._Cast_ToothAndSlot"):
            return self._parent._cast(_1242.AbstractToothAndSlot)
    ...
    @property
    def tooth_taper_specification(self: Self) -> "_1305.ToothTaperSpecification":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1305", "ToothTaperSpecification"
        )(value)

    @tooth_taper_specification.setter
    @enforce_parameter_types
    def tooth_taper_specification(self: Self, value: "_1305.ToothTaperSpecification"):
    ...
    @property
    def tooth_slot_style(self: Self) -> "_1304.ToothSlotStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1304", "ToothSlotStyle"
        )(value)

    @tooth_slot_style.setter
    @enforce_parameter_types
    def tooth_slot_style(self: Self, value: "_1304.ToothSlotStyle"):
        value = conversion.mp_to_pn_enum(
