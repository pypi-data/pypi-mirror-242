...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1274, _1255
...
class StatorRotorMaterial(_267.Material):
    ...
    def coefficient_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1274", "IronLossCoefficientSpecificationMethod"
        )(value)

    @coefficient_specification_method.setter
    @enforce_parameter_types
    def coefficient_specification_method(
        self: Self, value: "_1274.IronLossCoefficientSpecificationMethod"
    ):
    ...
    @property
    def loss_curves(self: Self) -> "_1865.TwoDChartDefinition":
    ...
    @property
    def bh_curve_specification(self: Self) -> "_246.BHCurveSpecification":
    ...
    @property
    def core_loss_coefficients(self: Self) -> "_1255.CoreLossCoefficients":
