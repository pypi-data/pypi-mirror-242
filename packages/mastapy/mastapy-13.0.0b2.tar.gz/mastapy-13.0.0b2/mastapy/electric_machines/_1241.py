...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1242, _1313
...
class AbstractStator(_0.APIBase):
    ...
    @property
    def tooth_and_slot(self: Self) -> "_1242.AbstractToothAndSlot":
