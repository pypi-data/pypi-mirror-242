...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.load_cases_and_analyses import _1355, _1368
...
class SingleOperatingPointAnalysis(_1349.ElectricMachineAnalysis):
    """SingleOperatingPointAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1355.ElectricMachineLoadCase":
    ...
    def slot_section_details_for_analysis(
        self: Self,
    ) -> "List[_1368.SlotDetailForAnalysis]":
