...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1343, _1353
...
class DynamicForceAnalysis(
    _1349.ElectricMachineAnalysis, _1336.IHaveDynamicForceResults
):
    """DynamicForceAnalysis
    ...
    class _Cast_DynamicForceAnalysis:
        ...
        def electric_machine_analysis(
            ...
            return self._parent._cast(_1349.ElectricMachineAnalysis)
    ...
    @property
    def load_case(self: Self) -> "_1343.BasicDynamicForceLoadCase":
    ...
    @property
    def results(self: Self) -> "_1318.DynamicForceResults":
    ...
    def single_operating_point_analyses(
        self: Self,
    ) -> "List[_1353.ElectricMachineFEAnalysis]":
