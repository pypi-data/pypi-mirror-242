...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1374, _1349, _1357
...
class ElectricMachineLoadCaseBase(_0.APIBase):
    ...
    class _Cast_ElectricMachineLoadCaseBase:
        ...
        def basic_dynamic_force_load_case(
            ...
            from mastapy.electric_machines.load_cases_and_analyses import _1343

            return self._parent._cast(_1343.BasicDynamicForceLoadCase)
        ...
        def dynamic_force_load_case(
            ...
            return self._parent._cast(_1345.DynamicForceLoadCase)
        ...
        def efficiency_map_load_case(
            ...
            return self._parent._cast(_1348.EfficiencyMapLoadCase)
        ...
        def electric_machine_load_case(
            ...
            return self._parent._cast(_1355.ElectricMachineLoadCase)
        ...
        def electric_machine_mechanical_load_case(
            ...
            return self._parent._cast(_1358.ElectricMachineMechanicalLoadCase)
        ...
        def speed_torque_curve_load_case(
            ...
            from mastapy.electric_machines.load_cases_and_analyses import _1372

            return self._parent._cast(_1372.SpeedTorqueCurveLoadCase)
        ...
        def speed_torque_load_case(
            ...
            return self._parent._cast(_1373.SpeedTorqueLoadCase)
    ...
    @property
    def temperatures(self: Self) -> "_1374.Temperatures":
    ...
    @property
    def analyses(self: Self) -> "List[_1349.ElectricMachineAnalysis]":
    ...
    @enforce_parameter_types
    def copy_to(
        self: Self, another_group: "_1357.ElectricMachineLoadCaseGroup"
    ) -> "ElectricMachineLoadCaseBase":
    ...
    @enforce_parameter_types
    def remove_analysis(
        self: Self, electric_machine_analysis: "_1349.ElectricMachineAnalysis"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_analysis_for(self: Self, setup: "_1264.ElectricMachineSetup"):
        """Method does not return.
