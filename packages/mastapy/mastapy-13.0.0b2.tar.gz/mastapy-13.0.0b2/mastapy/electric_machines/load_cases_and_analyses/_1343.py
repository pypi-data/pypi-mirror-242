...
if TYPE_CHECKING:
    from mastapy.electric_machines.load_cases_and_analyses import _1365, _1346, _1344
...
class BasicDynamicForceLoadCase(_1356.ElectricMachineLoadCaseBase):
    """BasicDynamicForceLoadCase
    ...
    def analysis_period(self: Self, value: "_168.ElectricMachineAnalysisPeriod"):
    ...
    @enforce_parameter_types
    def number_of_steps_per_operating_point_specification_method(
        self: Self, value: "_1365.NumberOfStepsPerOperatingPointSpecificationMethod"
    ):
    ...
    @property
    def operating_points(self: Self) -> "List[_1346.DynamicForcesOperatingPoint]":
    ...
    def remove_operating_point(
        self: Self, operating_point: "_1346.DynamicForcesOperatingPoint"
    ):
        """Method does not return.
