...
class SpeedTorqueCurveAnalysis(_1349.ElectricMachineAnalysis):
    """SpeedTorqueCurveAnalysis
    ...
    @property
    def load_case(self: Self) -> "_1372.SpeedTorqueCurveLoadCase":
    ...
    @property
    def results_points(self: Self) -> "List[_1338.MaximumTorqueResultsPoints]":
