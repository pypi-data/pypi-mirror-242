...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1259, _1264
...
class ElectricMachineAnalysis(_0.APIBase):
    ...
    class _Cast_ElectricMachineAnalysis:
        ...
        def dynamic_force_analysis(
            ...
            from mastapy.electric_machines.load_cases_and_analyses import _1344

            return self._parent._cast(_1344.DynamicForceAnalysis)
        ...
        def efficiency_map_analysis(
            ...
            return self._parent._cast(_1347.EfficiencyMapAnalysis)
        ...
        def electric_machine_fe_analysis(
            ...
            return self._parent._cast(_1353.ElectricMachineFEAnalysis)

        @property
        def electric_machine_fe_mechanical_analysis(
            self: "ElectricMachineAnalysis._Cast_ElectricMachineAnalysis",
        ):
            from mastapy.electric_machines.load_cases_and_analyses import _1354

            return self._parent._cast(_1354.ElectricMachineFEMechanicalAnalysis)
        ...
        def single_operating_point_analysis(
            ...
            return self._parent._cast(_1367.SingleOperatingPointAnalysis)
        ...
        def speed_torque_curve_analysis(
            ...
            return self._parent._cast(_1371.SpeedTorqueCurveAnalysis)
    ...
    @property
    def load_case(self: Self) -> "_1356.ElectricMachineLoadCaseBase":
    ...
    @property
    def setup(self: Self) -> "_1264.ElectricMachineSetup":
    ...
    def perform_analysis_with_progress(self: Self, token: "_7556.TaskProgress"):
        """Method does not return.
