...
class ElectricMachineFEAnalysis(
    _1367.SingleOperatingPointAnalysis, _1336.IHaveDynamicForceResults
):
    """ElectricMachineFEAnalysis
    ...
    @property
    def dynamic_force_results(self: Self) -> "_1318.DynamicForceResults":
    ...
    @property
    def viewable(self: Self) -> "_171.ElmerResultsViewable":
