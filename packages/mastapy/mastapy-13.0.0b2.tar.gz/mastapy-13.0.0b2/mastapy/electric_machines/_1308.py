...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1275, _1267
...
class VShapedMagnetLayerSpecification(_1291.RotorInternalLayerSpecification):
    """VShapedMagnetLayerSpecification
    ...
    @property
    def magnet_clearance(self: Self) -> "_1275.MagnetClearance":
    ...
    @enforce_parameter_types
    def magnet_clearance(self: Self, value: "_1275.MagnetClearance"):
    ...
    @property
    def upper_flux_barrier_web_specification(self: Self) -> "_1267.FluxBarrierOrWeb":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1267", "FluxBarrierOrWeb"
        )(value)

    @upper_flux_barrier_web_specification.setter
    @enforce_parameter_types
    def upper_flux_barrier_web_specification(
        self: Self, value: "_1267.FluxBarrierOrWeb"
    ):
        value = conversion.mp_to_pn_enum(
