...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1268, _1293, _1252, _1285, _1307, _1308
...
class InteriorPermanentMagnetAndSynchronousReluctanceRotor(_1287.PermanentMagnetRotor):
    """InteriorPermanentMagnetAndSynchronousReluctanceRotor
    ...
    class _Cast_InteriorPermanentMagnetAndSynchronousReluctanceRotor:
        ...
        def permanent_magnet_rotor(
            ...
            return self._parent._cast(_1287.PermanentMagnetRotor)
        ...
        def rotor(
            ...
            return self._parent._cast(_1290.Rotor)
    ...
    @property
    def flux_barrier_style(self: Self) -> "_1268.FluxBarrierStyle":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1268", "FluxBarrierStyle"
        )(value)

    @flux_barrier_style.setter
    @enforce_parameter_types
    def flux_barrier_style(self: Self, value: "_1268.FluxBarrierStyle"):
    ...
    @property
    def rotor_type(self: Self) -> "_1293.RotorType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1293", "RotorType"
        )(value)

    @rotor_type.setter
    @enforce_parameter_types
    def rotor_type(self: Self, value: "_1293.RotorType"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def cooling_duct_layers(self: Self) -> "List[_1252.CoolingDuctLayerSpecification]":
    ...
    @property
    def notch_specifications(self: Self) -> "List[_1285.NotchSpecification]":
    ...
    @property
    def u_shape_layers(self: Self) -> "List[_1307.UShapedLayerSpecification]":
    ...
    def v_shape_magnet_layers(
        self: Self,
    ) -> "List[_1308.VShapedMagnetLayerSpecification]":
