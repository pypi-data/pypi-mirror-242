...
if TYPE_CHECKING:
    from mastapy.electric_machines import _1254, _1265, _1290, _1241
    from mastapy.electric_machines.results import _1339, _1340
...
class ElectricMachineDetail(_0.APIBase):
    ...
    class _Cast_ElectricMachineDetail:
        ...
        def cad_electric_machine_detail(
            ...
            return self._parent._cast(_1245.CADElectricMachineDetail)
        ...
        def interior_permanent_magnet_machine(
            ...
            return self._parent._cast(_1273.InteriorPermanentMagnetMachine)
        ...
        def non_cad_electric_machine_detail(
            ...
            return self._parent._cast(_1283.NonCADElectricMachineDetail)
        ...
        def surface_permanent_magnet_machine(
            ...
            return self._parent._cast(_1300.SurfacePermanentMagnetMachine)
        ...
        def synchronous_reluctance_machine(
            ...
            return self._parent._cast(_1302.SynchronousReluctanceMachine)
        ...
        def wound_field_synchronous_machine(
            ...
            return self._parent._cast(_1317.WoundFieldSynchronousMachine)
    ...
    def core_loss_build_factor_specification_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1254", "CoreLossBuildFactorSpecificationMethod"
        )(value)

    @core_loss_build_factor_specification_method.setter
    @enforce_parameter_types
    def core_loss_build_factor_specification_method(
        self: Self, value: "_1254.CoreLossBuildFactorSpecificationMethod"
    ):
    ...
    @property
    def electric_machine_type(self: Self) -> "_1265.ElectricMachineType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.electric_machines._1265", "ElectricMachineType"
        )(value)
    ...
    @select_setup.setter
    @enforce_parameter_types
    def select_setup(self: Self, value: "_1264.ElectricMachineSetup"):
        wrapper_type = (
    ...
    @property
    def non_linear_dq_model(self: Self) -> "_1339.NonLinearDQModel":
    ...
    @property
    def rotor(self: Self) -> "_1290.Rotor":
    ...
    @property
    def selected_setup(self: Self) -> "_1264.ElectricMachineSetup":
    ...
    @property
    def stator(self: Self) -> "_1241.AbstractStator":
    ...
    @property
    def results_locations(self: Self) -> "List[_1519.Named2DLocation]":
    ...
    @property
    def setups(self: Self) -> "List[_1264.ElectricMachineSetup]":
    ...
    def add_setup(self: Self) -> "_1264.ElectricMachineSetup":
        """mastapy.electric_machines.ElectricMachineSetup"""
    ...
    @enforce_parameter_types
    def duplicate_setup(
        self: Self, setup: "_1264.ElectricMachineSetup"
    ...
    def generate_design_without_non_linear_dq_model(
        self: Self,
    ) -> "_1589.MethodOutcomeWithResult[ElectricMachineDetail]":
    ...
    @enforce_parameter_types
    def remove_setup(self: Self, setup: "_1264.ElectricMachineSetup"):
        """Method does not return.
    ...
    @enforce_parameter_types
    def setup_named(self: Self, name: "str") -> "_1264.ElectricMachineSetup":
        """mastapy.electric_machines.ElectricMachineSetup
    ...
    def try_generate_non_linear_dq_model_with_task_progress(
        self: Self, progress: "_7556.TaskProgress"
    ) -> "_1589.MethodOutcomeWithResult[ElectricMachineDetail]":
        """mastapy.utility.MethodOutcomeWithResult[mastapy.electric_machines.ElectricMachineDetail]
