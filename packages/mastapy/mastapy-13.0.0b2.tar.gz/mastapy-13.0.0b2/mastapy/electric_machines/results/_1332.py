...
if TYPE_CHECKING:
    ...
    from mastapy.electric_machines.results import _1330, _1333, _1331, _1329
...
class ElectricMachineResultsTimeStep(_0.APIBase):
    ...
    @property
    def flux_density_in_air_gap_chart(self: Self) -> "_1865.TwoDChartDefinition":
    ...
    @property
    def force_density_in_air_gap_mst_chart(self: Self) -> "_1865.TwoDChartDefinition":
        """mastapy.utility_gui.charts.TwoDChartDefinition
    ...
    def results_for_stator_teeth(
        self: Self,
    ) -> "List[_1330.ElectricMachineResultsForStatorToothAtTimeStep]":
    ...
    def results_at_locations(
        self: Self,
    ) -> "List[_1333.ElectricMachineResultsTimeStepAtLocation]":
    ...
    def results_for_line_to_line(
        self: Self,
    ) -> "List[_1331.ElectricMachineResultsLineToLineAtTimeStep]":
    ...
    def results_for_phases(
        self: Self,
    ) -> "List[_1329.ElectricMachineResultsForPhaseAtTimeStep]":
