...
if TYPE_CHECKING:
    from mastapy.utility_gui.charts import _1851, _1861
...
class TwoDChartDefinition(_1857.NDChartDefinition):
    """TwoDChartDefinition
    ...
    @property
    def const_lines(self: Self) -> "List[_1851.ConstantLine]":
    ...
    @property
    def series_list(self: Self) -> "List[_1861.Series2D]":
