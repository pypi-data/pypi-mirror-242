...
class NDChartDefinition(_1746.ChartDefinition):
    """NDChartDefinition
    ...
    class _Cast_NDChartDefinition:
        ...
        def matrix_visualisation_definition(
            ...
            return self._parent._cast(_1855.MatrixVisualisationDefinition)
    ...
    @property
    def x_axis(self: Self) -> "_1741.AxisSettings":
    ...
    @property
    def y_axis(self: Self) -> "_1741.AxisSettings":
        """mastapy.utility.report.AxisSettings
