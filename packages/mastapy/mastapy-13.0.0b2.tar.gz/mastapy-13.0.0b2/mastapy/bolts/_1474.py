...
if TYPE_CHECKING:
    from mastapy.bolts import _1472, _1477, _1480, _1465, _1467, _1463
...
class DetailedBoltDesign(_0.APIBase):
    ...
    @property
    def clamped_parts(self: Self) -> "List[_1472.ClampedSection]":
    ...
    @enforce_parameter_types
    def clamped_parts(self: Self, value: "List[_1472.ClampedSection]"):
    ...
    @property
    def joint_geometry(self: Self) -> "_1477.JointGeometries":
        ...
        return constructor.new_from_mastapy("mastapy.bolts._1477", "JointGeometries")(
            value
        )

    @joint_geometry.setter
    @enforce_parameter_types
    def joint_geometry(self: Self, value: "_1477.JointGeometries"):
    ...
    def rolled_before_or_after_heat_treatment(
        ...
        return constructor.new_from_mastapy(
            "mastapy.bolts._1480", "RolledBeforeOrAfterHeatTreatment"
        )(value)

    @rolled_before_or_after_heat_treatment.setter
    @enforce_parameter_types
    def rolled_before_or_after_heat_treatment(
        self: Self, value: "_1480.RolledBeforeOrAfterHeatTreatment"
    ):
    ...
    @property
    def bolt_geometry(self: Self) -> "_1465.BoltGeometry":
    ...
    @property
    def material_of_bolt(self: Self) -> "_1467.BoltMaterial":
    ...
    @property
    def material_of_nut(self: Self) -> "_1463.BoltedJointMaterial":
    ...
    @property
    def material_of_tapped_thread(self: Self) -> "_1463.BoltedJointMaterial":
        """mastapy.bolts.BoltedJointMaterial
    ...
    @property
    def clamped_sections(self: Self) -> "List[_1472.ClampedSection]":
        """List[mastapy.bolts.ClampedSection]
