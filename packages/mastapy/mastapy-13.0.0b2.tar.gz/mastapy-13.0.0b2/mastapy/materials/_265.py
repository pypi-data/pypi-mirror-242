...
from mastapy.materials import _259, _263
...
class LubricationDetail(_1827.NamedDatabaseItem):
    """LubricationDetail
    ...
    @property
    def agma925a03_lubricant_type(self: Self) -> "_237.AGMALubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._237", "AGMALubricantType"
        )(value)

    @agma925a03_lubricant_type.setter
    @enforce_parameter_types
    def agma925a03_lubricant_type(self: Self, value: "_237.AGMALubricantType"):
    ...
    @property
    def delivery(self: Self) -> "_260.LubricantDelivery":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._260", "LubricantDelivery"
        )(value)
    ...
    @property
    def density_specification_method(self: Self) -> "_250.DensitySpecificationMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._250", "DensitySpecificationMethod"
        )(value)

    @density_specification_method.setter
    @enforce_parameter_types
    def density_specification_method(
        self: Self, value: "_250.DensitySpecificationMethod"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def density_vs_temperature(self: Self) -> "_1532.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def density_vs_temperature(self: Self, value: "_1532.Vector2DListAccessor"):
    ...
    @property
    def grease_contamination_level(self: Self) -> "_255.GreaseContaminationOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._255", "GreaseContaminationOptions"
        )(value)

    @grease_contamination_level.setter
    @enforce_parameter_types
    def grease_contamination_level(
        self: Self, value: "_255.GreaseContaminationOptions"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def iso_lubricant_type(self: Self) -> "_258.ISOLubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._258", "ISOLubricantType"
        )(value)

    @iso_lubricant_type.setter
    @enforce_parameter_types
    def iso_lubricant_type(self: Self, value: "_258.ISOLubricantType"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def lubricant_definition(self: Self, value: "_259.LubricantDefinition"):
    ...
    @property
    def lubricant_grade_agma(self: Self) -> "_261.LubricantViscosityClassAGMA":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._261", "LubricantViscosityClassAGMA"
        )(value)

    @lubricant_grade_agma.setter
    @enforce_parameter_types
    def lubricant_grade_agma(self: Self, value: "_261.LubricantViscosityClassAGMA"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def lubricant_grade_iso(self: Self, value: "_263.LubricantViscosityClassISO"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def lubricant_grade_sae(self: Self) -> "_264.LubricantViscosityClassSAE":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._264", "LubricantViscosityClassSAE"
        )(value)

    @lubricant_grade_sae.setter
    @enforce_parameter_types
    def lubricant_grade_sae(self: Self, value: "_264.LubricantViscosityClassSAE"):
        value = conversion.mp_to_pn_enum(
    ...
    def lubricant_type_ampersand_supply(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._242", "BearingLubricationCondition"
        )(value)

    @lubricant_type_ampersand_supply.setter
    @enforce_parameter_types
    def lubricant_type_ampersand_supply(
        self: Self, value: "_242.BearingLubricationCondition"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    def lubricant_viscosity_classification(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._262", "LubricantViscosityClassification"
        )(value)

    @lubricant_viscosity_classification.setter
    @enforce_parameter_types
    def lubricant_viscosity_classification(
        self: Self, value: "_262.LubricantViscosityClassification"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def oil_filtration_and_contamination(self: Self) -> "_274.OilFiltrationOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._274", "OilFiltrationOptions"
        )(value)

    @oil_filtration_and_contamination.setter
    @enforce_parameter_types
    def oil_filtration_and_contamination(
        self: Self, value: "_274.OilFiltrationOptions"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    def pressure_viscosity_coefficient_method(
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._275", "PressureViscosityCoefficientMethod"
        )(value)

    @pressure_viscosity_coefficient_method.setter
    @enforce_parameter_types
    def pressure_viscosity_coefficient_method(
        self: Self, value: "_275.PressureViscosityCoefficientMethod"
    ):
        value = conversion.mp_to_pn_enum(
