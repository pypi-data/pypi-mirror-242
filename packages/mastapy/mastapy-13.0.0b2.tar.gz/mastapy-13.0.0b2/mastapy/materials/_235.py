...
class AcousticRadiationEfficiency(_0.APIBase):
    ...
    @property
    def input_type(self: Self) -> "_236.AcousticRadiationEfficiencyInputType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._236", "AcousticRadiationEfficiencyInputType"
        )(value)

    @input_type.setter
    @enforce_parameter_types
    def input_type(self: Self, value: "_236.AcousticRadiationEfficiencyInputType"):
    ...
    @property
    def radiation_efficiency_curve(self: Self) -> "_1532.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def radiation_efficiency_curve(self: Self, value: "_1532.Vector2DListAccessor"):
