...
if TYPE_CHECKING:
    from mastapy.utility import _1591, _1577
...
class EnvironmentSummary(_0.APIBase):
    ...
    @property
    def current_culture(self: Self) -> "_1591.NumberFormatInfoSummary":
    ...
    @property
    def dispatchers(self: Self) -> "List[_1577.DispatcherHelper]":
