...
if TYPE_CHECKING:
    from mastapy.utility.modal_analysis.gears import _1797, _1800
...
class GearOrderForTE(_1802.OrderWithRadius):
    """GearOrderForTE
    ...
    class _Cast_GearOrderForTE:
        ...
        def order_for_te(self: "GearOrderForTE._Cast_GearOrderForTE"):
            return self._parent._cast(_1800.OrderForTE)
    ...
    @property
    def position(self: Self) -> "_1797.GearPositions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.modal_analysis.gears._1797", "GearPositions"
        )(value)

    @property
    def additional_orders_and_harmonics(self: Self) -> "List[_1800.OrderForTE]":
