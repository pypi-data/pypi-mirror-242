...
TValue = TypeVar("TValue", bound="_1827.NamedDatabaseItem")


class NamedDatabase(_1829.SQLDatabase["_1828.NamedKey", TValue]):
    """NamedDatabase
    ...
    @enforce_parameter_types
    def duplicate(
        self: Self, new_name: "str", item: "_1827.NamedDatabaseItem"
    ...
    @enforce_parameter_types
    def rename(self: Self, item: "_1827.NamedDatabaseItem", new_name: "str") -> "bool":
        """bool
