...
class ListWithSelectedItem_DutyCycle(_5661.DutyCycle, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_5661.DutyCycle.TYPE":
        ...
        return _5661.DutyCycle.TYPE

    @property
    def selected_value(self: Self) -> "_5661.DutyCycle":
    ...
    @property
    def available_values(self: Self) -> "List[_5661.DutyCycle]":
