...
class ListWithSelectedItem_CylindricalGearSystemDeflection(
    _2743.CylindricalGearSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2743.CylindricalGearSystemDeflection.TYPE":
        ...
        return _2743.CylindricalGearSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2743.CylindricalGearSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2743.CylindricalGearSystemDeflection]":
