...
class ListWithSelectedItem_GearMeshSystemDeflection(
    _2757.GearMeshSystemDeflection, mixins.ListWithSelectedItemMixin
):
    ...
    def __init__(
        self, instance_to_wrap: "ListWithSelectedItem_GearMeshSystemDeflection.TYPE"
    ):
        try:
    ...
    @classmethod
    def implicit_type(cls) -> "_2757.GearMeshSystemDeflection.TYPE":
        ...
        return _2757.GearMeshSystemDeflection.TYPE

    @property
    def selected_value(self: Self) -> "_2757.GearMeshSystemDeflection":
    ...
    @property
    def available_values(self: Self) -> "List[_2757.GearMeshSystemDeflection]":
