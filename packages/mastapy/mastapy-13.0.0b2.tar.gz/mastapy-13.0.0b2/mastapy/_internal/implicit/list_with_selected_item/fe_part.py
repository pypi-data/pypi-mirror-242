...
class ListWithSelectedItem_FEPart(_2451.FEPart, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2451.FEPart.TYPE":
        ...
        return _2451.FEPart.TYPE

    @property
    def selected_value(self: Self) -> "_2451.FEPart":
    ...
    @property
    def available_values(self: Self) -> "List[_2451.FEPart]":
