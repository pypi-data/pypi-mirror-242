...
class ListWithSelectedItem_CMSElementFaceGroup(
    _223.CMSElementFaceGroup, mixins.ListWithSelectedItemMixin
):
    ...
    def __init__(
        self, instance_to_wrap: "ListWithSelectedItem_CMSElementFaceGroup.TYPE"
    ):
        try:
    ...
    @property
    def selected_value(self: Self) -> "_223.CMSElementFaceGroup":
    ...
    @property
    def available_values(self: Self) -> "List[_223.CMSElementFaceGroup]":
