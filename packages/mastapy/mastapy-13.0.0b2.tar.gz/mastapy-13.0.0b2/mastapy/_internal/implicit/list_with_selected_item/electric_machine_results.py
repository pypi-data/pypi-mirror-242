...
class ListWithSelectedItem_ElectricMachineResults(
    _1323.ElectricMachineResults, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1323.ElectricMachineResults.TYPE":
        ...
        return _1323.ElectricMachineResults.TYPE

    @property
    def selected_value(self: Self) -> "_1323.ElectricMachineResults":
    ...
    @property
    def available_values(self: Self) -> "List[_1323.ElectricMachineResults]":
