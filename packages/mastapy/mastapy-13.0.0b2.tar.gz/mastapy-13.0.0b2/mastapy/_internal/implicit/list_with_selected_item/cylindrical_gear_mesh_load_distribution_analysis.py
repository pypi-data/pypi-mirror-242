...
class ListWithSelectedItem_CylindricalGearMeshLoadDistributionAnalysis(
    _855.CylindricalGearMeshLoadDistributionAnalysis, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_855.CylindricalGearMeshLoadDistributionAnalysis.TYPE":
        ...
        return _855.CylindricalGearMeshLoadDistributionAnalysis.TYPE
    ...
    def available_values(
        self: Self,
    ) -> "List[_855.CylindricalGearMeshLoadDistributionAnalysis]":
