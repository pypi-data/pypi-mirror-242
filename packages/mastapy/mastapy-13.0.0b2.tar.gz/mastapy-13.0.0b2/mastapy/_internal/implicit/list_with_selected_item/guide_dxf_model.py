...
class ListWithSelectedItem_GuideDxfModel(
    _2453.GuideDxfModel, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_2453.GuideDxfModel.TYPE":
        ...
        return _2453.GuideDxfModel.TYPE

    @property
    def selected_value(self: Self) -> "_2453.GuideDxfModel":
    ...
    @property
    def available_values(self: Self) -> "List[_2453.GuideDxfModel]":
