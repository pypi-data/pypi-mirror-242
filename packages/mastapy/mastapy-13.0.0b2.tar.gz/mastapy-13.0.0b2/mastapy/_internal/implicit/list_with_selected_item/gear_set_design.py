...
class ListWithSelectedItem_GearSetDesign(
    _948.GearSetDesign, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_948.GearSetDesign.TYPE":
        ...
        return _948.GearSetDesign.TYPE

    @property
    def selected_value(self: Self) -> "_948.GearSetDesign":
    ...
    @property
    def available_values(self: Self) -> "List[_948.GearSetDesign]":
