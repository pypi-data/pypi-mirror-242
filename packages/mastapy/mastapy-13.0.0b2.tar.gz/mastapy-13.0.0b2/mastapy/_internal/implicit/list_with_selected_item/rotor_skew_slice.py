...
class ListWithSelectedItem_RotorSkewSlice(
    _1292.RotorSkewSlice, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1292.RotorSkewSlice.TYPE":
        ...
        return _1292.RotorSkewSlice.TYPE

    @property
    def selected_value(self: Self) -> "_1292.RotorSkewSlice":
    ...
    @property
    def available_values(self: Self) -> "List[_1292.RotorSkewSlice]":
