...
class ListWithSelectedItem_ElectricMachineSetup(
    _1264.ElectricMachineSetup, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1264.ElectricMachineSetup.TYPE":
        ...
        return _1264.ElectricMachineSetup.TYPE

    @property
    def selected_value(self: Self) -> "_1264.ElectricMachineSetup":
    ...
    @property
    def available_values(self: Self) -> "List[_1264.ElectricMachineSetup]":
