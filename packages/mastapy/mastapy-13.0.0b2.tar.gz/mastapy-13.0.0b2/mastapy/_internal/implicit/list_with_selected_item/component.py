...
class ListWithSelectedItem_Component(_2442.Component, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2442.Component.TYPE":
        ...
        return _2442.Component.TYPE

    @property
    def selected_value(self: Self) -> "_2442.Component":
    ...
    @property
    def available_values(self: Self) -> "List[_2442.Component]":
