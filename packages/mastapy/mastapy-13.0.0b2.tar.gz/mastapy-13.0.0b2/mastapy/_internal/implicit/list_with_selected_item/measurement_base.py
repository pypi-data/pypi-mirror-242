...
class ListWithSelectedItem_MeasurementBase(
    _1603.MeasurementBase, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1603.MeasurementBase.TYPE":
        ...
        return _1603.MeasurementBase.TYPE

    @property
    def selected_value(self: Self) -> "_1603.MeasurementBase":
    ...
    @property
    def available_values(self: Self) -> "List[_1603.MeasurementBase]":
