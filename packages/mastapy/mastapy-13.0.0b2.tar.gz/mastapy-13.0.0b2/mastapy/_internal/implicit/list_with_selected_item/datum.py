...
class ListWithSelectedItem_Datum(_2446.Datum, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2446.Datum.TYPE":
        ...
        return _2446.Datum.TYPE

    @property
    def selected_value(self: Self) -> "_2446.Datum":
    ...
    @property
    def available_values(self: Self) -> "List[_2446.Datum]":
