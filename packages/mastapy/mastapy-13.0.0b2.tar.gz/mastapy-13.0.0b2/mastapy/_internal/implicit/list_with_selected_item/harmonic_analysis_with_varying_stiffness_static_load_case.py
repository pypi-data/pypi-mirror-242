...
class ListWithSelectedItem_HarmonicAnalysisWithVaryingStiffnessStaticLoadCase(
    ...
    def implicit_type(
        cls,
    ) -> "_5767.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE":
        ...
        return _5767.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase.TYPE
    ...
    def available_values(
        self: Self,
    ) -> "List[_5767.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase]":
