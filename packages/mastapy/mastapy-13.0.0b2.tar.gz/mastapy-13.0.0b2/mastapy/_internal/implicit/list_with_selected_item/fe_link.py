...
class ListWithSelectedItem_FELink(_2416.FELink, mixins.ListWithSelectedItemMixin):
    ...
    @classmethod
    def implicit_type(cls) -> "_2416.FELink.TYPE":
        ...
        return _2416.FELink.TYPE

    @property
    def selected_value(self: Self) -> "_2416.FELink":
    ...
    @property
    def available_values(self: Self) -> "List[_2416.FELink]":
