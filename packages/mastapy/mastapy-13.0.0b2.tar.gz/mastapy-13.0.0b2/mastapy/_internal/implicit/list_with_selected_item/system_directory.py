...
class ListWithSelectedItem_SystemDirectory(
    _1598.SystemDirectory, mixins.ListWithSelectedItemMixin
):
    ...
    @classmethod
    def implicit_type(cls) -> "_1598.SystemDirectory.TYPE":
        ...
        return _1598.SystemDirectory.TYPE

    @property
    def selected_value(self: Self) -> "_1598.SystemDirectory":
    ...
    @property
    def available_values(self: Self) -> "List[_1598.SystemDirectory]":
