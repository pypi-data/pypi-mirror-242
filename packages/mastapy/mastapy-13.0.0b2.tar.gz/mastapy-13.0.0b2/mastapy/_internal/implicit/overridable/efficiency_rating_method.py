...
__all__ = ("Overridable_EfficiencyRatingMethod",)


Self = TypeVar("Self", bound="Overridable_EfficiencyRatingMethod")
...
class Overridable_EfficiencyRatingMethod(mixins.OverridableMixin, Enum):
    ...
    @property
    def value(self: Self) -> "_292.EfficiencyRatingMethod":
    ...
    @property
    def override_value(self: Self) -> "_292.EfficiencyRatingMethod":
        """mastapy.materials.efficiency.EfficiencyRatingMethod
    ...
    @property
    def calculated_value(self: Self) -> "_292.EfficiencyRatingMethod":
        """mastapy.materials.efficiency.EfficiencyRatingMethod
