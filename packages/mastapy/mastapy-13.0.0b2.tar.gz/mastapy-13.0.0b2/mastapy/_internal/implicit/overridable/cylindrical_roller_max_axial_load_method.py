...
class Overridable_CylindricalRollerMaxAxialLoadMethod(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1940.CylindricalRollerMaxAxialLoadMethod":
        ...
        return _1940.CylindricalRollerMaxAxialLoadMethod

    @classmethod
    def implicit_type(cls) -> "_1940.CylindricalRollerMaxAxialLoadMethod.type_()":
        ...
        return _1940.CylindricalRollerMaxAxialLoadMethod.type_()

    @property
    def value(self: Self) -> "_1940.CylindricalRollerMaxAxialLoadMethod":
    ...
    @property
    def override_value(self: Self) -> "_1940.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
    ...
    @property
    def calculated_value(self: Self) -> "_1940.CylindricalRollerMaxAxialLoadMethod":
        """mastapy.bearings.bearing_results.CylindricalRollerMaxAxialLoadMethod
