...
class Overridable_NodeSelectionDepthOption(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2400.NodeSelectionDepthOption":
        ...
        return _2400.NodeSelectionDepthOption

    @classmethod
    def implicit_type(cls) -> "_2400.NodeSelectionDepthOption.type_()":
        ...
        return _2400.NodeSelectionDepthOption.type_()

    @property
    def value(self: Self) -> "_2400.NodeSelectionDepthOption":
    ...
    @property
    def override_value(self: Self) -> "_2400.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
    ...
    @property
    def calculated_value(self: Self) -> "_2400.NodeSelectionDepthOption":
        """mastapy.system_model.fe.NodeSelectionDepthOption
