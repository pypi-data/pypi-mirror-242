...
class Overridable_ISOToleranceStandard(mixins.OverridableMixin, Enum):
    ...
    @property
    def value(self: Self) -> "_332.ISOToleranceStandard":
    ...
    @property
    def override_value(self: Self) -> "_332.ISOToleranceStandard":
        """mastapy.gears.ISOToleranceStandard
    ...
    @property
    def calculated_value(self: Self) -> "_332.ISOToleranceStandard":
        """mastapy.gears.ISOToleranceStandard
