...
class Overridable_SealLocation(mixins.OverridableMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1896.SealLocation":
        ...
        return _1896.SealLocation

    @classmethod
    def implicit_type(cls) -> "_1896.SealLocation.type_()":
        ...
        return _1896.SealLocation.type_()

    @property
    def value(self: Self) -> "_1896.SealLocation":
    ...
    @property
    def override_value(self: Self) -> "_1896.SealLocation":
        """mastapy.bearings.SealLocation
    ...
    @property
    def calculated_value(self: Self) -> "_1896.SealLocation":
        """mastapy.bearings.SealLocation
