...
class Overridable_CoefficientOfFrictionCalculationMethod(mixins.OverridableMixin, Enum):
    ...
    @property
    def value(self: Self) -> "_317.CoefficientOfFrictionCalculationMethod":
    ...
    @property
    def override_value(self: Self) -> "_317.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod
    ...
    @property
    def calculated_value(self: Self) -> "_317.CoefficientOfFrictionCalculationMethod":
        """mastapy.gears.CoefficientOfFrictionCalculationMethod
