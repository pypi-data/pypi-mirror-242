...
class EnumWithSelectedValue_BearingNodeOption(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2361.BearingNodeOption":
        ...
        return _2361.BearingNodeOption

    @classmethod
    def implicit_type(cls) -> "_2361.BearingNodeOption.type_()":
        ...
        return _2361.BearingNodeOption.type_()

    @property
    def selected_value(self: Self) -> "_2361.BearingNodeOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2361.BearingNodeOption]":
