...
class EnumWithSelectedValue_TorqueConverterLockupRule(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5506.TorqueConverterLockupRule":
        ...
        return _5506.TorqueConverterLockupRule

    @classmethod
    def implicit_type(cls) -> "_5506.TorqueConverterLockupRule.type_()":
        ...
        return _5506.TorqueConverterLockupRule.type_()

    @property
    def selected_value(self: Self) -> "_5506.TorqueConverterLockupRule":
    ...
    @property
    def available_values(self: Self) -> "List[_5506.TorqueConverterLockupRule]":
