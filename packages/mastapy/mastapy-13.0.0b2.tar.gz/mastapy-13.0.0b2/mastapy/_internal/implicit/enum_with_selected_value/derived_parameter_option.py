...
from mastapy.gears.gear_designs.creation_options import _1144
...
class EnumWithSelectedValue_CylindricalGearPairCreationOptions_DerivedParameterOption(
    ...
    def wrapped_type(
        cls,
    ) -> "_1144.CylindricalGearPairCreationOptions.DerivedParameterOption":
        ...
        return _1144.CylindricalGearPairCreationOptions.DerivedParameterOption

    @classmethod
    def implicit_type(
        cls,
    ) -> "_1144.CylindricalGearPairCreationOptions.DerivedParameterOption.type_()":
        ...
        return _1144.CylindricalGearPairCreationOptions.DerivedParameterOption.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_1144.CylindricalGearPairCreationOptions.DerivedParameterOption]":
