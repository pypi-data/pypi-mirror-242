...
class EnumWithSelectedValue_HarmonicAnalysisFEExportOptions_ComplexNumberOutput(
    ...
    def wrapped_type(
        cls,
    ) -> "_5761.HarmonicAnalysisFEExportOptions.ComplexNumberOutput":
        ...
        return _5761.HarmonicAnalysisFEExportOptions.ComplexNumberOutput

    @classmethod
    def implicit_type(
        cls,
    ) -> "_5761.HarmonicAnalysisFEExportOptions.ComplexNumberOutput.type_()":
        ...
        return _5761.HarmonicAnalysisFEExportOptions.ComplexNumberOutput.type_()
    ...
    def available_values(
        self: Self,
    ) -> "List[_5761.HarmonicAnalysisFEExportOptions.ComplexNumberOutput]":
