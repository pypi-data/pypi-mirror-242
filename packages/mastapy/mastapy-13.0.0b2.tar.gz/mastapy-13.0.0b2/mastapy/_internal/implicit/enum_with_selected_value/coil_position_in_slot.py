...
class EnumWithSelectedValue_CoilPositionInSlot(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1251.CoilPositionInSlot":
        ...
        return _1251.CoilPositionInSlot

    @classmethod
    def implicit_type(cls) -> "_1251.CoilPositionInSlot.type_()":
        ...
        return _1251.CoilPositionInSlot.type_()

    @property
    def selected_value(self: Self) -> "_1251.CoilPositionInSlot":
    ...
    @property
    def available_values(self: Self) -> "List[_1251.CoilPositionInSlot]":
