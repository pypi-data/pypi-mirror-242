...
class EnumWithSelectedValue_LinkNodeSource(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_2396.LinkNodeSource":
        ...
        return _2396.LinkNodeSource

    @classmethod
    def implicit_type(cls) -> "_2396.LinkNodeSource.type_()":
        ...
        return _2396.LinkNodeSource.type_()

    @property
    def selected_value(self: Self) -> "_2396.LinkNodeSource":
    ...
    @property
    def available_values(self: Self) -> "List[_2396.LinkNodeSource]":
