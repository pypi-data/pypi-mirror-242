...
class EnumWithSelectedValue_ComplexPartDisplayOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1492.ComplexPartDisplayOption":
        ...
        return _1492.ComplexPartDisplayOption

    @classmethod
    def implicit_type(cls) -> "_1492.ComplexPartDisplayOption.type_()":
        ...
        return _1492.ComplexPartDisplayOption.type_()

    @property
    def selected_value(self: Self) -> "_1492.ComplexPartDisplayOption":
    ...
    @property
    def available_values(self: Self) -> "List[_1492.ComplexPartDisplayOption]":
