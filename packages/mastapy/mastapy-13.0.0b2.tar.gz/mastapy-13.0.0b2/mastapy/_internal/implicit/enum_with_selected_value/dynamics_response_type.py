...
class EnumWithSelectedValue_DynamicsResponseType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_4624.DynamicsResponseType":
        ...
        return _4624.DynamicsResponseType

    @classmethod
    def implicit_type(cls) -> "_4624.DynamicsResponseType.type_()":
        ...
        return _4624.DynamicsResponseType.type_()

    @property
    def selected_value(self: Self) -> "_4624.DynamicsResponseType":
    ...
    @property
    def available_values(self: Self) -> "List[_4624.DynamicsResponseType]":
