...
class EnumWithSelectedValue_GearMeshStiffnessModel(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5435.GearMeshStiffnessModel":
        ...
        return _5435.GearMeshStiffnessModel

    @classmethod
    def implicit_type(cls) -> "_5435.GearMeshStiffnessModel.type_()":
        ...
        return _5435.GearMeshStiffnessModel.type_()

    @property
    def selected_value(self: Self) -> "_5435.GearMeshStiffnessModel":
    ...
    @property
    def available_values(self: Self) -> "List[_5435.GearMeshStiffnessModel]":
