...
class EnumWithSelectedValue_Modules(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1400.Modules":
        ...
        return _1400.Modules

    @classmethod
    def implicit_type(cls) -> "_1400.Modules.type_()":
        ...
        return _1400.Modules.type_()

    @property
    def selected_value(self: Self) -> "_1400.Modules":
    ...
    @property
    def available_values(self: Self) -> "List[_1400.Modules]":
