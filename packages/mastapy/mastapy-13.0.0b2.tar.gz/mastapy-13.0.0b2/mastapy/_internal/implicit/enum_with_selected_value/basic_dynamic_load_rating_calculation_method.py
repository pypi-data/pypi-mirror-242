...
class EnumWithSelectedValue_BasicDynamicLoadRatingCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1868.BasicDynamicLoadRatingCalculationMethod":
        ...
        return _1868.BasicDynamicLoadRatingCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1868.BasicDynamicLoadRatingCalculationMethod.type_()":
        ...
        return _1868.BasicDynamicLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1868.BasicDynamicLoadRatingCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1868.BasicDynamicLoadRatingCalculationMethod]":
