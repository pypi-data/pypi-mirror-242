...
class EnumWithSelectedValue_SpecifyTorqueOrCurrent(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1369.SpecifyTorqueOrCurrent":
        ...
        return _1369.SpecifyTorqueOrCurrent

    @classmethod
    def implicit_type(cls) -> "_1369.SpecifyTorqueOrCurrent.type_()":
        ...
        return _1369.SpecifyTorqueOrCurrent.type_()

    @property
    def selected_value(self: Self) -> "_1369.SpecifyTorqueOrCurrent":
    ...
    @property
    def available_values(self: Self) -> "List[_1369.SpecifyTorqueOrCurrent]":
