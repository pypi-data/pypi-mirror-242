...
class EnumWithSelectedValue_ScuffingCoefficientOfFrictionMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1069.ScuffingCoefficientOfFrictionMethods":
        ...
        return _1069.ScuffingCoefficientOfFrictionMethods

    @classmethod
    def implicit_type(cls) -> "_1069.ScuffingCoefficientOfFrictionMethods.type_()":
        ...
        return _1069.ScuffingCoefficientOfFrictionMethods.type_()

    @property
    def selected_value(self: Self) -> "_1069.ScuffingCoefficientOfFrictionMethods":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1069.ScuffingCoefficientOfFrictionMethods]":
