...
class EnumWithSelectedValue_LoadCaseType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1361.LoadCaseType":
        ...
        return _1361.LoadCaseType

    @classmethod
    def implicit_type(cls) -> "_1361.LoadCaseType.type_()":
        ...
        return _1361.LoadCaseType.type_()

    @property
    def selected_value(self: Self) -> "_1361.LoadCaseType":
    ...
    @property
    def available_values(self: Self) -> "List[_1361.LoadCaseType]":
