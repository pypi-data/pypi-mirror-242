...
class EnumWithSelectedValue_Flank(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_625.Flank":
    ...
    @classmethod
    def implicit_type(cls) -> "_625.Flank.type_()":
        ...
        return _625.Flank.type_()

    @property
    def selected_value(self: Self) -> "_625.Flank":
    ...
    @property
    def available_values(self: Self) -> "List[_625.Flank]":
