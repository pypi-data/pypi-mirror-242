...
class EnumWithSelectedValue_RotationalDirections(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1895.RotationalDirections":
        ...
        return _1895.RotationalDirections

    @classmethod
    def implicit_type(cls) -> "_1895.RotationalDirections.type_()":
        ...
        return _1895.RotationalDirections.type_()

    @property
    def selected_value(self: Self) -> "_1895.RotationalDirections":
    ...
    @property
    def available_values(self: Self) -> "List[_1895.RotationalDirections]":
