...
class EnumWithSelectedValue_BallBearingAnalysisMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1964.BallBearingAnalysisMethod":
        ...
        return _1964.BallBearingAnalysisMethod

    @classmethod
    def implicit_type(cls) -> "_1964.BallBearingAnalysisMethod.type_()":
        ...
        return _1964.BallBearingAnalysisMethod.type_()

    @property
    def selected_value(self: Self) -> "_1964.BallBearingAnalysisMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_1964.BallBearingAnalysisMethod]":
