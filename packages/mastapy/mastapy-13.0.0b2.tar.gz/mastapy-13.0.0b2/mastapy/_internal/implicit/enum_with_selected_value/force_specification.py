...
class EnumWithSelectedValue_PointLoadLoadCase_ForceSpecification(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6936.PointLoadLoadCase.ForceSpecification":
        ...
        return _6936.PointLoadLoadCase.ForceSpecification

    @classmethod
    def implicit_type(cls) -> "_6936.PointLoadLoadCase.ForceSpecification.type_()":
        ...
        return _6936.PointLoadLoadCase.ForceSpecification.type_()

    @property
    def selected_value(self: Self) -> "_6936.PointLoadLoadCase.ForceSpecification":
    ...
    def available_values(
        self: Self,
    ) -> "List[_6936.PointLoadLoadCase.ForceSpecification]":
