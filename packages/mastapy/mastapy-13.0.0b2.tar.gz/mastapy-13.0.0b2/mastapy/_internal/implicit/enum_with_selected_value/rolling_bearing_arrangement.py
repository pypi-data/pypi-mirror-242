...
class EnumWithSelectedValue_RollingBearingArrangement(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1890.RollingBearingArrangement":
        ...
        return _1890.RollingBearingArrangement

    @classmethod
    def implicit_type(cls) -> "_1890.RollingBearingArrangement.type_()":
        ...
        return _1890.RollingBearingArrangement.type_()

    @property
    def selected_value(self: Self) -> "_1890.RollingBearingArrangement":
    ...
    @property
    def available_values(self: Self) -> "List[_1890.RollingBearingArrangement]":
