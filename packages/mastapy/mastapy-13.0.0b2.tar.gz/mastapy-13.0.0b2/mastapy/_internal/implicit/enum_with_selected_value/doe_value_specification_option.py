...
class EnumWithSelectedValue_DoeValueSpecificationOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_4346.DoeValueSpecificationOption":
        ...
        return _4346.DoeValueSpecificationOption

    @classmethod
    def implicit_type(cls) -> "_4346.DoeValueSpecificationOption.type_()":
        ...
        return _4346.DoeValueSpecificationOption.type_()

    @property
    def selected_value(self: Self) -> "_4346.DoeValueSpecificationOption":
    ...
    @property
    def available_values(self: Self) -> "List[_4346.DoeValueSpecificationOption]":
