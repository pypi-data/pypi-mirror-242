...
class EnumWithSelectedValue_RaceAxialMountingType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1961.RaceAxialMountingType":
        ...
        return _1961.RaceAxialMountingType

    @classmethod
    def implicit_type(cls) -> "_1961.RaceAxialMountingType.type_()":
        ...
        return _1961.RaceAxialMountingType.type_()

    @property
    def selected_value(self: Self) -> "_1961.RaceAxialMountingType":
    ...
    @property
    def available_values(self: Self) -> "List[_1961.RaceAxialMountingType]":
