...
class EnumWithSelectedValue_MicroGeometryDefinitionMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_643.MicroGeometryDefinitionMethod":
        ...
        return _643.MicroGeometryDefinitionMethod

    @classmethod
    def implicit_type(cls) -> "_643.MicroGeometryDefinitionMethod.type_()":
        ...
        return _643.MicroGeometryDefinitionMethod.type_()

    @property
    def selected_value(self: Self) -> "_643.MicroGeometryDefinitionMethod":
    ...
    @property
    def available_values(self: Self) -> "List[_643.MicroGeometryDefinitionMethod]":
