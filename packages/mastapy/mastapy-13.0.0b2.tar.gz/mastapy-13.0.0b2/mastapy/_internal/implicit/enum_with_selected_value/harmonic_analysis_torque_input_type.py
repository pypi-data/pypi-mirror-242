...
class EnumWithSelectedValue_HarmonicAnalysisTorqueInputType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_5766.HarmonicAnalysisTorqueInputType":
        ...
        return _5766.HarmonicAnalysisTorqueInputType

    @classmethod
    def implicit_type(cls) -> "_5766.HarmonicAnalysisTorqueInputType.type_()":
        ...
        return _5766.HarmonicAnalysisTorqueInputType.type_()

    @property
    def selected_value(self: Self) -> "_5766.HarmonicAnalysisTorqueInputType":
    ...
    @property
    def available_values(self: Self) -> "List[_5766.HarmonicAnalysisTorqueInputType]":
