...
class EnumWithSelectedValue_LocationOfEvaluationLowerLimit(
    ...
    @classmethod
    def wrapped_type(cls) -> "_571.LocationOfEvaluationLowerLimit":
        ...
        return _571.LocationOfEvaluationLowerLimit

    @classmethod
    def implicit_type(cls) -> "_571.LocationOfEvaluationLowerLimit.type_()":
        ...
        return _571.LocationOfEvaluationLowerLimit.type_()

    @property
    def selected_value(self: Self) -> "_571.LocationOfEvaluationLowerLimit":
    ...
    @property
    def available_values(self: Self) -> "List[_571.LocationOfEvaluationLowerLimit]":
