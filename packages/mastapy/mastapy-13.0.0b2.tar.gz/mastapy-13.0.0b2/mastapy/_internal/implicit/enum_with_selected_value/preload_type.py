...
class EnumWithSelectedValue_PreloadType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1959.PreloadType":
        ...
        return _1959.PreloadType

    @classmethod
    def implicit_type(cls) -> "_1959.PreloadType.type_()":
        ...
        return _1959.PreloadType.type_()

    @property
    def selected_value(self: Self) -> "_1959.PreloadType":
    ...
    @property
    def available_values(self: Self) -> "List[_1959.PreloadType]":
