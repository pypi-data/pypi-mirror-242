...
class EnumWithSelectedValue_RollingBearingRaceType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1893.RollingBearingRaceType":
        ...
        return _1893.RollingBearingRaceType

    @classmethod
    def implicit_type(cls) -> "_1893.RollingBearingRaceType.type_()":
        ...
        return _1893.RollingBearingRaceType.type_()

    @property
    def selected_value(self: Self) -> "_1893.RollingBearingRaceType":
    ...
    @property
    def available_values(self: Self) -> "List[_1893.RollingBearingRaceType]":
