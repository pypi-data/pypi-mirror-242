...
class EnumWithSelectedValue_ThicknessType(mixins.EnumWithSelectedValueMixin, Enum):
    ...
    @classmethod
    def wrapped_type(cls) -> "_1077.ThicknessType":
        ...
        return _1077.ThicknessType

    @classmethod
    def implicit_type(cls) -> "_1077.ThicknessType.type_()":
        ...
        return _1077.ThicknessType.type_()

    @property
    def selected_value(self: Self) -> "_1077.ThicknessType":
    ...
    @property
    def available_values(self: Self) -> "List[_1077.ThicknessType]":
