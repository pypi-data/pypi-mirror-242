...
class EnumWithSelectedValue_HarmonicExcitationType(
    ...
    @classmethod
    def wrapped_type(cls) -> "_6895.HarmonicExcitationType":
        ...
        return _6895.HarmonicExcitationType

    @classmethod
    def implicit_type(cls) -> "_6895.HarmonicExcitationType.type_()":
        ...
        return _6895.HarmonicExcitationType.type_()

    @property
    def selected_value(self: Self) -> "_6895.HarmonicExcitationType":
    ...
    @property
    def available_values(self: Self) -> "List[_6895.HarmonicExcitationType]":
