...
class EnumWithSelectedValue_LocationOfEvaluationUpperLimit(
    ...
    @classmethod
    def wrapped_type(cls) -> "_572.LocationOfEvaluationUpperLimit":
        ...
        return _572.LocationOfEvaluationUpperLimit

    @classmethod
    def implicit_type(cls) -> "_572.LocationOfEvaluationUpperLimit.type_()":
        ...
        return _572.LocationOfEvaluationUpperLimit.type_()

    @property
    def selected_value(self: Self) -> "_572.LocationOfEvaluationUpperLimit":
    ...
    @property
    def available_values(self: Self) -> "List[_572.LocationOfEvaluationUpperLimit]":
