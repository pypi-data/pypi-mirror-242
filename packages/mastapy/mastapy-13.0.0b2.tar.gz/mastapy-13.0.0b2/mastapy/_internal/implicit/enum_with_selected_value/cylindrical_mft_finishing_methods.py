...
class EnumWithSelectedValue_CylindricalMftFinishingMethods(
    ...
    @classmethod
    def wrapped_type(cls) -> "_621.CylindricalMftFinishingMethods":
        ...
        return _621.CylindricalMftFinishingMethods

    @classmethod
    def implicit_type(cls) -> "_621.CylindricalMftFinishingMethods.type_()":
        ...
        return _621.CylindricalMftFinishingMethods.type_()

    @property
    def selected_value(self: Self) -> "_621.CylindricalMftFinishingMethods":
    ...
    @property
    def available_values(self: Self) -> "List[_621.CylindricalMftFinishingMethods]":
