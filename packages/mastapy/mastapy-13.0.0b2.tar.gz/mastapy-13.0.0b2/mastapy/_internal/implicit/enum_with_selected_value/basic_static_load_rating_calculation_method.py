...
class EnumWithSelectedValue_BasicStaticLoadRatingCalculationMethod(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1869.BasicStaticLoadRatingCalculationMethod":
        ...
        return _1869.BasicStaticLoadRatingCalculationMethod

    @classmethod
    def implicit_type(cls) -> "_1869.BasicStaticLoadRatingCalculationMethod.type_()":
        ...
        return _1869.BasicStaticLoadRatingCalculationMethod.type_()

    @property
    def selected_value(self: Self) -> "_1869.BasicStaticLoadRatingCalculationMethod":
    ...
    def available_values(
        self: Self,
    ) -> "List[_1869.BasicStaticLoadRatingCalculationMethod]":
