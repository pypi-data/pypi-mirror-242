...
class EnumWithSelectedValue_ExcitationAnalysisViewOption(
    ...
    @classmethod
    def wrapped_type(cls) -> "_2260.ExcitationAnalysisViewOption":
        ...
        return _2260.ExcitationAnalysisViewOption

    @classmethod
    def implicit_type(cls) -> "_2260.ExcitationAnalysisViewOption.type_()":
        ...
        return _2260.ExcitationAnalysisViewOption.type_()

    @property
    def selected_value(self: Self) -> "_2260.ExcitationAnalysisViewOption":
    ...
    @property
    def available_values(self: Self) -> "List[_2260.ExcitationAnalysisViewOption]":
