...
class EnumWithSelectedValue_FluidFilmTemperatureOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1882.FluidFilmTemperatureOptions":
        ...
        return _1882.FluidFilmTemperatureOptions

    @classmethod
    def implicit_type(cls) -> "_1882.FluidFilmTemperatureOptions.type_()":
        ...
        return _1882.FluidFilmTemperatureOptions.type_()

    @property
    def selected_value(self: Self) -> "_1882.FluidFilmTemperatureOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1882.FluidFilmTemperatureOptions]":
