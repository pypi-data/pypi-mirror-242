...
class EnumWithSelectedValue_BearingToleranceDefinitionOptions(
    ...
    @classmethod
    def wrapped_type(cls) -> "_1902.BearingToleranceDefinitionOptions":
        ...
        return _1902.BearingToleranceDefinitionOptions

    @classmethod
    def implicit_type(cls) -> "_1902.BearingToleranceDefinitionOptions.type_()":
        ...
        return _1902.BearingToleranceDefinitionOptions.type_()

    @property
    def selected_value(self: Self) -> "_1902.BearingToleranceDefinitionOptions":
    ...
    @property
    def available_values(self: Self) -> "List[_1902.BearingToleranceDefinitionOptions]":
