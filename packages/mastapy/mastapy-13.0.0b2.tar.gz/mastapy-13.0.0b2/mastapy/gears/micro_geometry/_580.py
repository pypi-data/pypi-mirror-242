...
from mastapy.gears.micro_geometry import _571, _572, _573, _574, _577
...
if TYPE_CHECKING:
    from mastapy.gears.micro_geometry import _575, _576, _578, _579
...
class ProfileModification(_577.Modification):
    """ProfileModification
    ...
    class _Cast_ProfileModification:
        ...
        def modification(self: "ProfileModification._Cast_ProfileModification"):
            return self._parent._cast(_577.Modification)
    ...
    @property
    def measured_data(self: Self) -> "_1532.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def measured_data(self: Self, value: "_1532.Vector2DListAccessor"):
