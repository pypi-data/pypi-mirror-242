...
class GearSetDesign(_946.GearDesignComponent):
    ...
    @property
    def active_ltcafe_model(self: Self) -> "_1198.GearSetFEModel":
    ...
    @property
    def tifffe_model(self: Self) -> "_1198.GearSetFEModel":
        """mastapy.gears.fe_model.GearSetFEModel
    ...
    @property
    def gears(self: Self) -> "List[_945.GearDesign]":
    ...
    @property
    def ltcafe_models(self: Self) -> "List[_1198.GearSetFEModel]":
