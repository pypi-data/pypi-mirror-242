...
class CylindricalGearProfileModification(_580.ProfileModification):
    """CylindricalGearProfileModification
    ...
    @property
    def profile_modification_chart(self: Self) -> "_1865.TwoDChartDefinition":
    ...
    @property
    def barrelling_peak_point(self: Self) -> "_1023.CylindricalGearProfileMeasurement":
    ...
    @property
    def evaluation_lower_limit(self: Self) -> "_1023.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
    ...
    @property
    def evaluation_upper_limit(self: Self) -> "_1023.CylindricalGearProfileMeasurement":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearProfileMeasurement
