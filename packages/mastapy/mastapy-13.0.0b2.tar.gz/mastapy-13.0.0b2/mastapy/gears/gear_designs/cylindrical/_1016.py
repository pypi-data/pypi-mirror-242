...
class CylindricalGearMeshDesign(_947.GearMeshDesign):
    ...
    @property
    def centre_distance_change_method(self: Self) -> "_316.CentreDistanceChangeMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._316", "CentreDistanceChangeMethod"
        )(value)

    @centre_distance_change_method.setter
    @enforce_parameter_types
    def centre_distance_change_method(
        self: Self, value: "_316.CentreDistanceChangeMethod"
    ):
    ...
    @enforce_parameter_types
    def lubrication_method(self: Self, value: "_333.LubricationMethods"):
    ...
    @property
    def profile_modification(self: Self) -> "_1025.CylindricalGearProfileModifications":
    ...
    def profile_modification(
        self: Self, value: "_1025.CylindricalGearProfileModifications"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearProfileModifications",
    ...
    @property
    def type_of_mechanism_housing(self: Self) -> "_1085.TypeOfMechanismHousing":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1085", "TypeOfMechanismHousing"
        )(value)

    @type_of_mechanism_housing.setter
    @enforce_parameter_types
    def type_of_mechanism_housing(self: Self, value: "_1085.TypeOfMechanismHousing"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def valid_normal_module_range(self: Self) -> "_1486.Range":
    ...
    @property
    def backlash_specification(self: Self) -> "_997.BacklashSpecification":
    ...
    @property
    def left_flank(self: Self) -> "_1017.CylindricalGearMeshFlankDesign":
    ...
    @property
    def right_flank(self: Self) -> "_1017.CylindricalGearMeshFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearMeshFlankDesign
    ...
    @property
    def cylindrical_meshed_gear(self: Self) -> "List[_1036.CylindricalMeshedGear]":
    ...
    @property
    def flanks(self: Self) -> "List[_1017.CylindricalGearMeshFlankDesign]":
    ...
    @property
    def both_flanks(self: Self) -> "_1017.CylindricalGearMeshFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearMeshFlankDesign
    ...
    @property
    def gear_a(self: Self) -> "_1010.CylindricalGearDesign":
    ...
    @property
    def gear_b(self: Self) -> "_1010.CylindricalGearDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign
