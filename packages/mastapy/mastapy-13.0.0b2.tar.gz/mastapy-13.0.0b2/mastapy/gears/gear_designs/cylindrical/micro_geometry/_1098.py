...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical.micro_geometry import _1093, _1119
...
class CylindricalGearMicroGeometry(_1099.CylindricalGearMicroGeometryBase):
    """CylindricalGearMicroGeometry
    ...
    @property
    def left_flank(self: Self) -> "_1093.CylindricalGearFlankMicroGeometry":
    ...
    @property
    def right_flank(self: Self) -> "_1093.CylindricalGearFlankMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearFlankMicroGeometry
    ...
    @property
    def flanks(self: Self) -> "List[_1093.CylindricalGearFlankMicroGeometry]":
    ...
    @property
    def meshed_gears(self: Self) -> "List[_1119.MeshedCylindricalGearMicroGeometry]":
    ...
    @property
    def both_flanks(self: Self) -> "_1093.CylindricalGearFlankMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearFlankMicroGeometry
