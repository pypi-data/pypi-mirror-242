...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1023, _1010
...
class CylindricalGearFlankMicroGeometry(_568.FlankMicroGeometry):
    """CylindricalGearFlankMicroGeometry
    ...
    class _Cast_CylindricalGearFlankMicroGeometry:
        ...
        def flank_micro_geometry(
            ...
            return self._parent._cast(_568.FlankMicroGeometry)
    ...
    @property
    def micro_geometry_matrix(self: Self) -> "_1563.GriddedSurfaceAccessor":
    ...
    def micro_geometry_matrix(self: Self, value: "_1563.GriddedSurfaceAccessor"):
    ...
    @property
    def bias(self: Self) -> "_1091.CylindricalGearBiasModification":
    ...
    @property
    def lead_relief(self: Self) -> "_1094.CylindricalGearLeadModification":
    ...
    @property
    def micro_geometry_map(self: Self) -> "_1101.CylindricalGearMicroGeometryMap":
    ...
    @property
    def profile_relief(self: Self) -> "_1103.CylindricalGearProfileModification":
    ...
    def lead_form_deviation_points(
        self: Self,
    ) -> "List[_1112.LeadFormReliefWithDeviation]":
    ...
    def lead_slope_deviation_points(
        self: Self,
    ) -> "List[_1114.LeadSlopeReliefWithDeviation]":
    ...
    def profile_form_deviation_points(
        self: Self,
    ) -> "List[_1123.ProfileFormReliefWithDeviation]":
    ...
    def profile_slope_deviation_at_10_percent_face_width(
        self: Self,
    ) -> "List[_1125.ProfileSlopeReliefWithDeviation]":
    ...
    def total_lead_relief_points(
        self: Self,
    ) -> "List[_1128.TotalLeadReliefWithDeviation]":
    ...
    def total_profile_relief_points(
        self: Self,
    ) -> "List[_1129.TotalProfileReliefWithDeviation]":
    ...
    @property
    def gear_design(self: Self) -> "_1010.CylindricalGearDesign":
