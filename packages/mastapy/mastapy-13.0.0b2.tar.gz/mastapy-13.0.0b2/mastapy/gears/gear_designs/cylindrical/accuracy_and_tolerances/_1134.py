...
class CylindricalAccuracyGrader(_0.APIBase):
    ...
    class _Cast_CylindricalAccuracyGrader:
        ...
        def agma2000a88_accuracy_grader(
            ...
            return self._parent._cast(_1130.AGMA2000A88AccuracyGrader)
        ...
        def agma20151a01_accuracy_grader(
            ...
            return self._parent._cast(_1131.AGMA20151A01AccuracyGrader)
    ...
    @property
    def accuracy_grades(self: Self) -> "_1136.CylindricalAccuracyGrades":
