...
from mastapy.utility.units_and_measurements.measurements import _1665, _1686
...
class ToothThicknessSpecificationBase(_0.APIBase):
    ...
    class _Cast_ToothThicknessSpecificationBase:
        ...
        def finish_tooth_thickness_design_specification(
            ...
            return self._parent._cast(_1044.FinishToothThicknessDesignSpecification)
        ...
        def readonly_tooth_thickness_specification(
            ...
            return self._parent._cast(_1064.ReadonlyToothThicknessSpecification)
        ...
        def tooth_thickness_specification(
            ...
            return self._parent._cast(_1083.ToothThicknessSpecification)
    ...
    def chordal_span(
        self: Self,
    ) -> "_1034.CylindricalGearToothThicknessSpecification[_1665.LengthShort]":
    ...
    def profile_shift_coefficient(
        self: Self,
    ) -> "_1034.CylindricalGearToothThicknessSpecification[_1686.Number]":
    ...
    def tooth_thickness(
        self: Self,
    ) -> "List[_1034.CylindricalGearToothThicknessSpecification[_1665.LengthShort]]":
