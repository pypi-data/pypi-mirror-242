...
class FinishStockSpecification(
    _1066.RelativeValuesSpecification["FinishStockSpecification"]
):
    """FinishStockSpecification
    ...
    def finish_stock_rough_thickness_specification_method(
        self: Self, value: "_1088.FinishStockType"
    ):
    ...
    def normal(
        self: Self,
    ) -> "_1081.TolerancedValueSpecification[FinishStockSpecification]":
