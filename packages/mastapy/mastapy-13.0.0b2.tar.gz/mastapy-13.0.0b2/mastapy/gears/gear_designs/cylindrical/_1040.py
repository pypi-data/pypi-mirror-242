...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.cylindrical import _1062, _1063
...
class CylindricalPlanetGearDesign(_1010.CylindricalGearDesign):
    """CylindricalPlanetGearDesign
    ...
    @property
    def planet_assembly_indices(self: Self) -> "List[_1062.NamedPlanetAssemblyIndex]":
    ...
    def planetary_sidebands_amplitude_factors(
        self: Self,
    ) -> "List[_1063.NamedPlanetSideBandAmplitudeFactor]":
