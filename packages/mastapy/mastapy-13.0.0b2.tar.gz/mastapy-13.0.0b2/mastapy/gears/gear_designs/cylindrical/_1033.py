...
class CylindricalGearTableWithMGCharts(_1778.CustomTable):
    """CylindricalGearTableWithMGCharts
    ...
    @property
    def item_detail(self: Self) -> "_1032.CylindricalGearTableMGItemDetail":
    ...
    @item_detail.setter
    @enforce_parameter_types
    def item_detail(self: Self, value: "_1032.CylindricalGearTableMGItemDetail"):
