...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.cylindrical import _452, _461
...
class CylindricalGearSetDesign(_948.GearSetDesign):
    """CylindricalGearSetDesign
    ...
    def coefficient_of_friction_calculation_method(
        self: Self,
        value: "Union[_317.CoefficientOfFrictionCalculationMethod, Tuple[_317.CoefficientOfFrictionCalculationMethod, bool]]",
    ):
        wrapper_type = (
    ...
    @property
    def efficiency_rating_method(self: Self) -> "_292.EfficiencyRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials.efficiency._292", "EfficiencyRatingMethod"
        )(value)

    @efficiency_rating_method.setter
    @enforce_parameter_types
    def efficiency_rating_method(self: Self, value: "_292.EfficiencyRatingMethod"):
    ...
    @property
    def gear_fit_system(self: Self) -> "_1045.GearFitSystems":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1045", "GearFitSystems"
        )(value)

    @gear_fit_system.setter
    @enforce_parameter_types
    def gear_fit_system(self: Self, value: "_1045.GearFitSystems"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def helical_gear_micro_geometry_option(
        self: Self, value: "_508.HelicalGearMicroGeometryOption"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Cylindrical.ISO6336.HelicalGearMicroGeometryOption",
    ...
    def profile_shift_distribution_rule(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._996",
    ...
    @enforce_parameter_types
    def profile_shift_distribution_rule(
        self: Self, value: "_996.AddendumModificationDistributionRule"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.AddendumModificationDistributionRule",
    ...
    @property
    def ltca_settings(self: Self) -> "_1058.LTCASettings":
    ...
    @property
    def left_flank(self: Self) -> "_1027.CylindricalGearSetFlankDesign":
    ...
    @property
    def micropitting(self: Self) -> "_1061.Micropitting":
    ...
    @property
    def right_flank(self: Self) -> "_1027.CylindricalGearSetFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetFlankDesign
    ...
    @property
    def scuffing(self: Self) -> "_1068.Scuffing":
    ...
    @property
    def usage(self: Self) -> "_1086.Usage":
    ...
    @property
    def gears(self: Self) -> "List[_1010.CylindricalGearDesign]":
    ...
    @property
    def cylindrical_gears(self: Self) -> "List[_1010.CylindricalGearDesign]":
        """List[mastapy.gears.gear_designs.cylindrical.CylindricalGearDesign]
    ...
    @property
    def cylindrical_meshes(self: Self) -> "List[_1016.CylindricalGearMeshDesign]":
    ...
    @property
    def flanks(self: Self) -> "List[_1027.CylindricalGearSetFlankDesign]":
    ...
    @property
    def both_flanks(self: Self) -> "_1027.CylindricalGearSetFlankDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetFlankDesign
    ...
    @property
    def micro_geometries(self: Self) -> "List[_1105.CylindricalGearSetMicroGeometry]":
    ...
    def manufacturing_configurations(
        self: Self,
    ) -> "List[_623.CylindricalSetManufacturingConfig]":
    ...
    def add_new_micro_geometry(self: Self) -> "_1105.CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry"""
    ...
    def add_new_micro_geometry_specifying_separate_micro_geometry_per_tooth_for(
        self: Self, gears: "List[_1010.CylindricalGearDesign]"
    ) -> "_1105.CylindricalGearSetMicroGeometry":
        """mastapy.gears.gear_designs.cylindrical.micro_geometry.CylindricalGearSetMicroGeometry
    ...
    def create_optimiser(
        self: Self, duty_cycle: "_461.CylindricalGearSetDutyCycleRating"
    ...
    def delete_manufacturing_configuration(
        self: Self, config: "_623.CylindricalSetManufacturingConfig"
    ):
        """Method does not return.
    ...
    def delete_micro_geometry(
        self: Self, micro_geometry: "_1105.CylindricalGearSetMicroGeometry"
    ):
        """Method does not return.
    ...
    def set_active_manufacturing_configuration(
        self: Self, value: "_623.CylindricalSetManufacturingConfig"
    ):
        """Method does not return.
    ...
    def set_active_micro_geometry(
        self: Self, value: "_1105.CylindricalGearSetMicroGeometry"
    ):
        """Method does not return.
