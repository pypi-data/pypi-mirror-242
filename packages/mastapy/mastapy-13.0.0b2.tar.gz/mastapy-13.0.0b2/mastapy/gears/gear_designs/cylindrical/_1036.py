...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1037, _1010, _1016
...
class CylindricalMeshedGear(_0.APIBase):
    ...
    @property
    def left_flank(self: Self) -> "_1037.CylindricalMeshedGearFlank":
    ...
    @property
    def right_flank(self: Self) -> "_1037.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    def flanks(self: Self) -> "List[_1037.CylindricalMeshedGearFlank]":
    ...
    @property
    def both_flanks(self: Self) -> "_1037.CylindricalMeshedGearFlank":
        """mastapy.gears.gear_designs.cylindrical.CylindricalMeshedGearFlank
    ...
    @property
    def mesh(self: Self) -> "_1016.CylindricalGearMeshDesign":
