...
class TiffAnalysisSettings(
    _1584.IndependentReportablePropertiesBase["TiffAnalysisSettings"]
):
    """TiffAnalysisSettings
    ...
    @property
    def core_material_properties(self: Self) -> "_1049.HardenedMaterialProperties":
    ...
    @property
    def surface_material_properties(self: Self) -> "_1049.HardenedMaterialProperties":
        """mastapy.gears.gear_designs.cylindrical.HardenedMaterialProperties
