...
class CylindricalGearSetMicroGeometryDutyCycle(
    ...
    @property
    def rating(self: Self) -> "_461.CylindricalGearSetDutyCycleRating":
    ...
    @property
    def tiff_analysis(self: Self) -> "_895.CylindricalGearSetTIFFAnalysisDutyCycle":
    ...
    @property
    def meshes(self: Self) -> "List[_1097.CylindricalGearMeshMicroGeometryDutyCycle]":
