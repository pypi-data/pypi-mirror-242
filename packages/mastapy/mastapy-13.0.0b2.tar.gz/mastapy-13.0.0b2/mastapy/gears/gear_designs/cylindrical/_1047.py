...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.cylindrical import _1000, _1046
...
class GearSetManufacturingConfigurationSetup(_0.APIBase):
    ...
    def create_new_suitable_cutters(
        self: Self, value: "_1000.CreateNewSuitableCutterOption"
    ):
    ...
    @property
    def gears(self: Self) -> "List[_1046.GearManufacturingConfigSetupViewModel]":
