...
class FaceGearMicroGeometry(_1219.GearImplementationDetail):
    """FaceGearMicroGeometry
    ...
    @property
    def face_gear(self: Self) -> "_987.FaceGearDesign":
    ...
    @property
    def micro_geometry(self: Self) -> "_1099.CylindricalGearMicroGeometryBase":
