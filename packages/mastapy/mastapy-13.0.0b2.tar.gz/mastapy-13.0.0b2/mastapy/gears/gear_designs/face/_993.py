...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.face import _994, _995, _992, _987, _989
...
class FaceGearSetDesign(_948.GearSetDesign):
    """FaceGearSetDesign
    ...
    @property
    def face_gear(self: Self) -> "_995.FaceGearWheelDesign":
    ...
    @property
    def pinion(self: Self) -> "_992.FaceGearPinionDesign":
    ...
    @property
    def gears(self: Self) -> "List[_987.FaceGearDesign]":
    ...
    @property
    def face_gears(self: Self) -> "List[_987.FaceGearDesign]":
        """List[mastapy.gears.gear_designs.face.FaceGearDesign]
    ...
    @property
    def face_meshes(self: Self) -> "List[_989.FaceGearMeshDesign]":
