...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.spiral_bevel import _969, _967, _970
...
class SpiralBevelGearMeshDesign(_1179.BevelGearMeshDesign):
    """SpiralBevelGearMeshDesign
    ...
    @property
    def spiral_bevel_gear_set(self: Self) -> "_969.SpiralBevelGearSetDesign":
    ...
    def spiral_bevel_meshed_gears(
        self: Self,
    ) -> "List[_970.SpiralBevelMeshedGearDesign]":
