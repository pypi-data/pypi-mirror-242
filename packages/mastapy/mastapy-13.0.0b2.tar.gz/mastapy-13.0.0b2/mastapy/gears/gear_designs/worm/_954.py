...
class WormDesign(_955.WormGearDesign):
    """WormDesign
    ...
    @property
    def addendum_factor(self: Self) -> "_348.WormAddendumFactor":
        ...
        return constructor.new_from_mastapy("mastapy.gears._348", "WormAddendumFactor")(
            value
        )

    @addendum_factor.setter
    @enforce_parameter_types
    def addendum_factor(self: Self, value: "_348.WormAddendumFactor"):
