...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.worm import _955, _956
...
class WormGearSetDesign(_948.GearSetDesign):
    """WormGearSetDesign
    ...
    @property
    def worm_type(self: Self) -> "_349.WormType":
        ...
        return constructor.new_from_mastapy("mastapy.gears._349", "WormType")(value)

    @worm_type.setter
    @enforce_parameter_types
    def worm_type(self: Self, value: "_349.WormType"):
        value = conversion.mp_to_pn_enum(value, "SMT.MastaAPI.Gears.WormType")
        self.wrapped.WormType = value

    @property
    def gears(self: Self) -> "List[_955.WormGearDesign]":
    ...
    @property
    def worm_gears(self: Self) -> "List[_955.WormGearDesign]":
        """List[mastapy.gears.gear_designs.worm.WormGearDesign]
    ...
    @property
    def worm_meshes(self: Self) -> "List[_956.WormGearMeshDesign]":
