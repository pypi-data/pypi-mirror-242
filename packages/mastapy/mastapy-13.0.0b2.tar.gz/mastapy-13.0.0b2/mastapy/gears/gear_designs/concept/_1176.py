...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.concept import _1174, _1175
...
class ConceptGearSetDesign(_948.GearSetDesign):
    """ConceptGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_1174.ConceptGearDesign]":
    ...
    @property
    def concept_gears(self: Self) -> "List[_1174.ConceptGearDesign]":
        """List[mastapy.gears.gear_designs.concept.ConceptGearDesign]
    ...
    @property
    def concept_meshes(self: Self) -> "List[_1175.ConceptGearMeshDesign]":
