...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.straight_bevel import _961, _959, _962
...
class StraightBevelGearMeshDesign(_1179.BevelGearMeshDesign):
    """StraightBevelGearMeshDesign
    ...
    @property
    def straight_bevel_gear_set(self: Self) -> "_961.StraightBevelGearSetDesign":
    ...
    def straight_bevel_meshed_gears(
        self: Self,
    ) -> "List[_962.StraightBevelMeshedGearDesign]":
