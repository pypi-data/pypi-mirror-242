...
class StraightBevelDiffGearDesign(_1178.BevelGearDesign):
    """StraightBevelDiffGearDesign
    ...
    @property
    def edge_radius_from(self: Self) -> "_1183.EdgeRadiusType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.bevel._1183", "EdgeRadiusType"
        )(value)

    @edge_radius_from.setter
    @enforce_parameter_types
    def edge_radius_from(self: Self, value: "_1183.EdgeRadiusType"):
