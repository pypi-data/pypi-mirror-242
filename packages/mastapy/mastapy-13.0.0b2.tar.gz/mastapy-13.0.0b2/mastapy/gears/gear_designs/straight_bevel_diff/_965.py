...
if TYPE_CHECKING:
    from mastapy.gears.gear_designs.straight_bevel_diff import _963, _964
...
class StraightBevelDiffGearSetDesign(_1180.BevelGearSetDesign):
    """StraightBevelDiffGearSetDesign
    ...
    @property
    def gears(self: Self) -> "List[_963.StraightBevelDiffGearDesign]":
    ...
    def straight_bevel_diff_gears(
        self: Self,
    ) -> "List[_963.StraightBevelDiffGearDesign]":
        """List[mastapy.gears.gear_designs.straight_bevel_diff.StraightBevelDiffGearDesign]
    ...
    def straight_bevel_diff_meshes(
        self: Self,
    ) -> "List[_964.StraightBevelDiffGearMeshDesign]":
