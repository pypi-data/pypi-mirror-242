...
if TYPE_CHECKING:
    ...
    from mastapy.gears.gear_designs.conical.micro_geometry import _1170, _1172, _1173
...
class ConicalGearFlankMicroGeometry(_568.FlankMicroGeometry):
    """ConicalGearFlankMicroGeometry
    ...
    @property
    def micro_geometry_input_type(self: Self) -> "_334.MicroGeometryInputTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._334", "MicroGeometryInputTypes"
        )(value)

    @micro_geometry_input_type.setter
    @enforce_parameter_types
    def micro_geometry_input_type(self: Self, value: "_334.MicroGeometryInputTypes"):
    ...
    @property
    def bias(self: Self) -> "_1170.ConicalGearBiasModification":
    ...
    @property
    def lead_relief(self: Self) -> "_1172.ConicalGearLeadModification":
    ...
    @property
    def profile_relief(self: Self) -> "_1173.ConicalGearProfileModification":
    ...
    @property
    def gear_design(self: Self) -> "_1152.ConicalGearDesign":
