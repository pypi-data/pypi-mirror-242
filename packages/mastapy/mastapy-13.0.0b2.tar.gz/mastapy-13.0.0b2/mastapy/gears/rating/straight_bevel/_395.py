...
class StraightBevelGearSetRating(_554.BevelGearSetRating):
    """StraightBevelGearSetRating
    ...
    @property
    def straight_bevel_gear_ratings(self: Self) -> "List[_394.StraightBevelGearRating]":
    ...
    def straight_bevel_mesh_ratings(
        self: Self,
    ) -> "List[_393.StraightBevelGearMeshRating]":
