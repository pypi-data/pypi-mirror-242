...
class WormGearDutyCycleRating(_356.GearDutyCycleRating):
    ...
    @property
    def gear_set_design_duty_cycle(self: Self) -> "_373.WormGearSetDutyCycleRating":
    ...
    @property
    def gear_ratings(self: Self) -> "List[_372.WormGearRating]":
    ...
    @property
    def worm_gear_ratings(self: Self) -> "List[_372.WormGearRating]":
        """List[mastapy.gears.rating.worm.WormGearRating]
