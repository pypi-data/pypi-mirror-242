...
class StraightBevelDiffGearMeshRating(_537.ConicalGearMeshRating):
    """StraightBevelDiffGearMeshRating
    ...
    @property
    def meshed_gears(self: Self) -> "List[_399.StraightBevelDiffMeshedGearRating]":
    ...
    @property
    def gears_in_mesh(self: Self) -> "List[_399.StraightBevelDiffMeshedGearRating]":
        """List[mastapy.gears.rating.straight_bevel_diff.StraightBevelDiffMeshedGearRating]
    ...
    def straight_bevel_diff_gear_ratings(
        self: Self,
    ) -> "List[_397.StraightBevelDiffGearRating]":
