...
class SafetyFactorOptimisationStepResultNumber(_502.SafetyFactorOptimisationStepResult):
    """SafetyFactorOptimisationStepResultNumber
    ...
    class _Cast_SafetyFactorOptimisationStepResultNumber:
        ...
        def safety_factor_optimisation_step_result(
            ...
            return self._parent._cast(_502.SafetyFactorOptimisationStepResult)
