...
if TYPE_CHECKING:
    ...
    from mastapy.gears.rating.cylindrical.vdi import _487
...
class CylindricalGearMeshRating(_358.GearMeshRating):
    ...
    @property
    def active_flank(self: Self) -> "_321.CylindricalFlanks":
        ...
        return constructor.new_from_mastapy("mastapy.gears._321", "CylindricalFlanks")(
            value
        )
    ...
    @property
    def cylindrical_gear_mesh(self: Self) -> "_1016.CylindricalGearMeshDesign":
    ...
    @property
    def gear_set_rating(self: Self) -> "_462.CylindricalGearSetRating":
    ...
    @property
    def mesh_load_case(self: Self) -> "_882.CylindricalMeshLoadCase":
    ...
    @property
    def mesh_single_flank_rating(self: Self) -> "_465.CylindricalMeshSingleFlankRating":
        """mastapy.gears.rating.cylindrical.CylindricalMeshSingleFlankRating
    ...
    def vdi_cylindrical_gear_single_flank_rating(
        self: Self,
    ) -> "_487.VDI2737InternalGearSingleFlankRating":
    ...
    @property
    def cylindrical_gear_ratings(self: Self) -> "List[_458.CylindricalGearRating]":
