...
class SafetyFactorOptimisationStepResult(_0.APIBase):
    ...
    class _Cast_SafetyFactorOptimisationStepResult:
        ...
        def safety_factor_optimisation_step_result_angle(
            ...
            return self._parent._cast(_503.SafetyFactorOptimisationStepResultAngle)
        ...
        def safety_factor_optimisation_step_result_number(
            ...
            return self._parent._cast(_504.SafetyFactorOptimisationStepResultNumber)
    ...
    @property
    def normalised_safety_factors(self: Self) -> "_366.SafetyFactorResults":
    ...
    @property
    def safety_factors(self: Self) -> "_366.SafetyFactorResults":
        """mastapy.gears.rating.SafetyFactorResults
