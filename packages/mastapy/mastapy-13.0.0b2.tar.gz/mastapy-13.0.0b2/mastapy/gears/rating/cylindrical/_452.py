...
from mastapy.gears.rating.cylindrical import _479, _480
...
if TYPE_CHECKING:
    from mastapy.gears import _342, _313
...
class CylindricalGearDesignAndRatingSettingsItem(_1827.NamedDatabaseItem):
    """CylindricalGearDesignAndRatingSettingsItem
    ...
    @property
    def agma_quality_grade_type(self: Self) -> "_342.QualityGradeTypes":
        ...
        return constructor.new_from_mastapy("mastapy.gears._342", "QualityGradeTypes")(
            value
        )

    @agma_quality_grade_type.setter
    @enforce_parameter_types
    def agma_quality_grade_type(self: Self, value: "_342.QualityGradeTypes"):
    ...
    @property
    def agma_tolerances_standard(self: Self) -> "_313.AGMAToleranceStandard":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears._313", "AGMAToleranceStandard"
        )(value)

    @agma_tolerances_standard.setter
    @enforce_parameter_types
    def agma_tolerances_standard(self: Self, value: "_313.AGMAToleranceStandard"):
    ...
    def chosen_tooth_thickness_for_bending_strength(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._485", "ToothThicknesses"
        )(value)

    @chosen_tooth_thickness_for_bending_strength.setter
    @enforce_parameter_types
    def chosen_tooth_thickness_for_bending_strength(
        self: Self, value: "_485.ToothThicknesses"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def cylindrical_gear_profile_measurement(
        self: Self, value: "_1024.CylindricalGearProfileMeasurementType"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.GearDesigns.Cylindrical.CylindricalGearProfileMeasurementType",
    ...
    @property
    def dynamic_factor_method(self: Self) -> "_470.DynamicFactorMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._470", "DynamicFactorMethods"
        )(value)

    @dynamic_factor_method.setter
    @enforce_parameter_types
    def dynamic_factor_method(self: Self, value: "_470.DynamicFactorMethods"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def film_thickness_equation_for_scuffing(self: Self) -> "_481.ScuffingMethods":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._481", "ScuffingMethods"
        )(value)

    @film_thickness_equation_for_scuffing.setter
    @enforce_parameter_types
    def film_thickness_equation_for_scuffing(self: Self, value: "_481.ScuffingMethods"):
        value = conversion.mp_to_pn_enum(
    ...
    def gear_blank_factor_calculation_option(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._471", "GearBlankFactorCalculationOptions"
        )(value)

    @gear_blank_factor_calculation_option.setter
    @enforce_parameter_types
    def gear_blank_factor_calculation_option(
        self: Self, value: "_471.GearBlankFactorCalculationOptions"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.Gears.Rating.Cylindrical.GearBlankFactorCalculationOptions",
    ...
    def iso_tolerances_standard(
        self: Self,
        value: "Union[_332.ISOToleranceStandard, Tuple[_332.ISOToleranceStandard, bool]]",
    ):
    ...
    @property
    def micropitting_rating_method(self: Self) -> "_474.MicropittingRatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._474", "MicropittingRatingMethod"
        )(value)

    @micropitting_rating_method.setter
    @enforce_parameter_types
    def micropitting_rating_method(self: Self, value: "_474.MicropittingRatingMethod"):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def permissible_bending_stress_method(self: Self) -> "_477.RatingMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._477", "RatingMethod"
        )(value)

    @permissible_bending_stress_method.setter
    @enforce_parameter_types
    def permissible_bending_stress_method(self: Self, value: "_477.RatingMethod"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def rating_method(self: Self, value: "_249.CylindricalGearRatingMethods"):
    ...
    @enforce_parameter_types
    def scuffing_rating_method_flash_temperature_method(
        self: Self, value: "_479.ScuffingFlashTemperatureRatingMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @enforce_parameter_types
    def scuffing_rating_method_integral_temperature_method(
        self: Self, value: "_480.ScuffingIntegralTemperatureRatingMethod"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def tip_relief_in_scuffing_calculation(
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.rating.cylindrical._484", "TipReliefScuffingOptions"
        )(value)

    @tip_relief_in_scuffing_calculation.setter
    @enforce_parameter_types
    def tip_relief_in_scuffing_calculation(
        self: Self, value: "_484.TipReliefScuffingOptions"
    ):
        value = conversion.mp_to_pn_enum(
    ...
    @property
    def tolerance_rounding_system(self: Self) -> "_1605.MeasurementSystem":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.units_and_measurements._1605", "MeasurementSystem"
        )(value)

    @tolerance_rounding_system.setter
    @enforce_parameter_types
    def tolerance_rounding_system(self: Self, value: "_1605.MeasurementSystem"):
        value = conversion.mp_to_pn_enum(
    ...
    def vdi_rating_geometry_calculation_method(
        self: Self,
        value: "Union[_249.CylindricalGearRatingMethods, Tuple[_249.CylindricalGearRatingMethods, bool]]",
    ):
        wrapper_type = (
