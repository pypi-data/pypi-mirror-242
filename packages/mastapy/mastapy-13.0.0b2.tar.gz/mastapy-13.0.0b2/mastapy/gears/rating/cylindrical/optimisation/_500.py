...
if TYPE_CHECKING:
    from mastapy.gears.rating.cylindrical.optimisation import _501, _502
...
T = TypeVar("T", bound="_502.SafetyFactorOptimisationStepResult")
...
class OptimisationResultsPair(_0.APIBase, Generic[T]):
    ...
    @property
    def results(self: Self) -> "_501.SafetyFactorOptimisationResults[T]":
    ...
    def results_without_warnings(
        self: Self,
    ) -> "_501.SafetyFactorOptimisationResults[T]":
        """mastapy.gears.rating.cylindrical.optimisation.SafetyFactorOptimisationResults[T]
