...
if TYPE_CHECKING:
    from mastapy.gears.rating.cylindrical import _474, _479, _480, _457
    from mastapy.gears.gear_designs.cylindrical import _1071
    from mastapy.gears.rating.cylindrical.iso6336 import _512, _517
...
class ISO6336AbstractMetalMeshSingleFlankRating(
    ...
    def isodin_cylindrical_gear_single_flank_ratings(
        self: Self,
    ) -> "List[_517.ISO6336AbstractMetalGearSingleFlankRating]":
