...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical.cutter_simulation import _730, _735
...
class CutterSimulationCalc(_0.APIBase):
    ...
    class _Cast_CutterSimulationCalc:
        ...
        def form_wheel_grinding_simulation_calculator(
            ...
            return self._parent._cast(_736.FormWheelGrindingSimulationCalculator)
        ...
        def hob_simulation_calculator(
            ...
            return self._parent._cast(_738.HobSimulationCalculator)
        ...
        def rack_simulation_calculator(
            ...
            return self._parent._cast(_741.RackSimulationCalculator)
        ...
        def shaper_simulation_calculator(
            ...
            return self._parent._cast(_743.ShaperSimulationCalculator)
        ...
        def shaving_simulation_calculator(
            ...
            return self._parent._cast(_744.ShavingSimulationCalculator)
        ...
        def virtual_simulation_calculator(
            ...
            return self._parent._cast(_745.VirtualSimulationCalculator)
        ...
        def worm_grinder_simulation_calculator(
            ...
            return self._parent._cast(_746.WormGrinderSimulationCalculator)
    ...
    @property
    def gear(self: Self) -> "_730.CylindricalCutterSimulatableGear":
    ...
    @property
    def stock_removed_at_designed_sap(self: Self) -> "_735.FinishStockPoint":
    ...
    @property
    def stock_removed_at_reference_diameter(self: Self) -> "_735.FinishStockPoint":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint
    ...
    @property
    def stock_removed_at_rough_tip_form(self: Self) -> "_735.FinishStockPoint":
        """mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint
    ...
    @property
    def finish_stock_indexed_arcs(self: Self) -> "List[_735.FinishStockPoint]":
    ...
    @property
    def gear_fillet_points(self: Self) -> "List[_727.NamedPoint]":
    ...
    @property
    def main_profile_finish_stock(self: Self) -> "List[_735.FinishStockPoint]":
        """List[mastapy.gears.manufacturing.cylindrical.cutter_simulation.FinishStockPoint]
