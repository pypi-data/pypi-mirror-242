...
if TYPE_CHECKING:
    ...
    from mastapy.gears.manufacturing.cylindrical.cutters.tangibles import _723, _728
...
class CylindricalGearHobDesign(_710.CylindricalGearRackDesign):
    """CylindricalGearHobDesign
    ...
    @property
    def hob_edge_type(self: Self) -> "_629.HobEdgeTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.manufacturing.cylindrical._629", "HobEdgeTypes"
        )(value)

    @hob_edge_type.setter
    @enforce_parameter_types
    def hob_edge_type(self: Self, value: "_629.HobEdgeTypes"):
    ...
    @property
    def maximum_hob_material_shape(self: Self) -> "_723.CylindricalGearHobShape":
    ...
    @property
    def minimum_hob_material_shape(self: Self) -> "_723.CylindricalGearHobShape":
        """mastapy.gears.manufacturing.cylindrical.cutters.tangibles.CylindricalGearHobShape
    ...
    @property
    def nominal_hob_shape(self: Self) -> "_723.CylindricalGearHobShape":
        """mastapy.gears.manufacturing.cylindrical.cutters.tangibles.CylindricalGearHobShape
    ...
    @property
    def nominal_rack_shape(self: Self) -> "_728.RackShape":
