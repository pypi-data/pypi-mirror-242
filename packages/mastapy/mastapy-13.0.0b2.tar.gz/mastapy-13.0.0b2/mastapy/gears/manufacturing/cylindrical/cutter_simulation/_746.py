...
class WormGrinderSimulationCalculator(_741.RackSimulationCalculator):
    """WormGrinderSimulationCalculator
    ...
    class _Cast_WormGrinderSimulationCalculator:
        ...
        def cutter_simulation_calc(
            ...
            return self._parent._cast(_729.CutterSimulationCalc)
    ...
    @property
    def worm_grinder(self: Self) -> "_726.CylindricalGearWormGrinderShape":
