...
class MutableCommon(_701.CurveInLinkedList):
    """MutableCommon
    ...
    class _Cast_MutableCommon:
        ...
        def mutable_fillet(self: "MutableCommon._Cast_MutableCommon"):
            ...
            return self._parent._cast(_719.MutableFillet)
    ...
    @section.setter
    @enforce_parameter_types
    def section(self: Self, value: "_607.CutterFlankSections"):
