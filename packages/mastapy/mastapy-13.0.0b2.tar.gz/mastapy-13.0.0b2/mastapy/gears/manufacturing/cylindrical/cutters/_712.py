...
class CylindricalGearShaper(_716.InvoluteCutterDesign):
    """CylindricalGearShaper
    ...
    @property
    def shaper_edge_type(self: Self) -> "_1072.ShaperEdgeTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.gear_designs.cylindrical._1072", "ShaperEdgeTypes"
        )(value)

    @shaper_edge_type.setter
    @enforce_parameter_types
    def shaper_edge_type(self: Self, value: "_1072.ShaperEdgeTypes"):
