...
class CylindricalGearRealCutterDesign(_704.CylindricalGearAbstractCutterDesign):
    """CylindricalGearRealCutterDesign
    ...
    @property
    def customised_cutting_edge_profile(self: Self) -> "_702.CustomisableEdgeProfile":
    ...
    @property
    def nominal_cutter_shape(self: Self) -> "_721.CutterShapeDefinition":
