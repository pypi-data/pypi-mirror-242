...
class CutterShapeDefinition(_0.APIBase):
    ...
    class _Cast_CutterShapeDefinition:
        ...
        def cylindrical_gear_formed_wheel_grinder_tangible(
            ...
            return self._parent._cast(_722.CylindricalGearFormedWheelGrinderTangible)
        ...
        def cylindrical_gear_hob_shape(
            ...
            return self._parent._cast(_723.CylindricalGearHobShape)
        ...
        def cylindrical_gear_shaper_tangible(
            ...
            return self._parent._cast(_724.CylindricalGearShaperTangible)
        ...
        def cylindrical_gear_shaver_tangible(
            ...
            return self._parent._cast(_725.CylindricalGearShaverTangible)
        ...
        def cylindrical_gear_worm_grinder_shape(
            ...
            return self._parent._cast(_726.CylindricalGearWormGrinderShape)
        ...
        def rack_shape(self: "CutterShapeDefinition._Cast_CutterShapeDefinition"):
            ...
            return self._parent._cast(_728.RackShape)
    ...
    @property
    def design(self: Self) -> "_711.CylindricalGearRealCutterDesign":
    ...
    @property
    def fillet_points(self: Self) -> "List[_727.NamedPoint]":
    ...
    @property
    def main_blade_points(self: Self) -> "List[_727.NamedPoint]":
        """List[mastapy.gears.manufacturing.cylindrical.cutters.tangibles.NamedPoint]
