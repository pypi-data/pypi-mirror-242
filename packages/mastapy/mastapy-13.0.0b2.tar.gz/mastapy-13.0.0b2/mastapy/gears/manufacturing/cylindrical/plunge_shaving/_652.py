...
class RealPlungeShaverOutputs(_649.PlungeShaverOutputs):
    """RealPlungeShaverOutputs
    ...
    class _Cast_RealPlungeShaverOutputs:
        ...
        def plunge_shaver_outputs(
            ...
            return self._parent._cast(_649.PlungeShaverOutputs)
    ...
    @property
    def lead_measurement_method(self: Self) -> "_643.MicroGeometryDefinitionMethod":
    ...
    def lead_measurement_method(
        self: Self, value: "_643.MicroGeometryDefinitionMethod"
    ):
    ...
    @property
    def profile_measurement_method(self: Self) -> "_643.MicroGeometryDefinitionMethod":
        """mastapy.gears.manufacturing.cylindrical.plunge_shaving.MicroGeometryDefinitionMethod"""
    ...
    @property
    def shaver(self: Self) -> "_708.CylindricalGearPlungeShaver":
    ...
    def micro_geometry(
        self: Self,
    ) -> "List[_611.CylindricalGearSpecifiedMicroGeometry]":
