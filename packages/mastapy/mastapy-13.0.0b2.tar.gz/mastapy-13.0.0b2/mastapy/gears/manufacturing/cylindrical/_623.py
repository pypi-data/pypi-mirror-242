...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.cylindrical import _610, _620
...
class CylindricalSetManufacturingConfig(_1229.GearSetImplementationDetail):
    """CylindricalSetManufacturingConfig
    ...
    def cylindrical_mesh_manufacturing_configurations(
        self: Self,
    ) -> "List[_620.CylindricalMeshManufacturingConfig]":
