...
class CutterProcessSimulation(_0.APIBase):
    ...
    class _Cast_CutterProcessSimulation:
        ...
        def form_wheel_grinding_process_simulation(
            ...
            from mastapy.gears.manufacturing.cylindrical.process_simulation import _638

            return self._parent._cast(_638.FormWheelGrindingProcessSimulation)
        ...
        def shaping_process_simulation(
            ...
            return self._parent._cast(_639.ShapingProcessSimulation)
