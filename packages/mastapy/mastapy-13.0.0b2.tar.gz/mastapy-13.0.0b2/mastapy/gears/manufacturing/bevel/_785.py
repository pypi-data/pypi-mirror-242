...
class ConicalMeshMicroGeometryConfigBase(_1223.GearMeshImplementationDetail):
    """ConicalMeshMicroGeometryConfigBase
    ...
    @property
    def mesh(self: Self) -> "_1153.ConicalGearMeshDesign":
    ...
    @property
    def wheel_config(self: Self) -> "_776.ConicalGearMicroGeometryConfigBase":
