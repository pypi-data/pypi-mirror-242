...
class ConicalMeshFlankMicroGeometryConfig(_0.APIBase):
    ...
    class _Cast_ConicalMeshFlankMicroGeometryConfig:
        ...
        def conical_mesh_flank_manufacturing_config(
            ...
            return self._parent._cast(_779.ConicalMeshFlankManufacturingConfig)
        ...
        def conical_mesh_flank_nurbs_micro_geometry_config(
            ...
            return self._parent._cast(_781.ConicalMeshFlankNURBSMicroGeometryConfig)
    ...
    @property
    def specified_ease_off_surface(self: Self) -> "_1171.ConicalGearFlankMicroGeometry":
