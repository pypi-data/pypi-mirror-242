...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel import _775, _784
...
class ConicalSetMicroGeometryConfig(_791.ConicalSetMicroGeometryConfigBase):
    """ConicalSetMicroGeometryConfig
    ...
    def gear_micro_geometry_configuration(
        self: Self,
    ) -> "List[_775.ConicalGearMicroGeometryConfig]":
    ...
    @property
    def meshes(self: Self) -> "List[_784.ConicalMeshMicroGeometryConfig]":
