...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel.basic_machine_settings import _822, _819
...
class ConicalWheelManufacturingConfig(_774.ConicalGearManufacturingConfig):
    """ConicalWheelManufacturingConfig
    ...
    @property
    def wheel_finish_cutter(self: Self) -> "_813.WheelFinishCutter":
    ...
    @property
    def wheel_rough_cutter(self: Self) -> "_814.WheelRoughCutter":
