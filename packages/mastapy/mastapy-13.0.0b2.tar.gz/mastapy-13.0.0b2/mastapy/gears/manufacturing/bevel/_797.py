...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel import _796, _810
...
class ManufacturingMachine(_1827.NamedDatabaseItem):
    """ManufacturingMachine
    ...
    @property
    def machine_type(self: Self) -> "_796.MachineTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.manufacturing.bevel._796", "MachineTypes"
        )(value)

    @machine_type.setter
    @enforce_parameter_types
    def machine_type(self: Self, value: "_796.MachineTypes"):
    ...
    @property
    def wheel_formate_machine_type(self: Self) -> "_810.WheelFormatMachineTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.manufacturing.bevel._810", "WheelFormatMachineTypes"
        )(value)

    @wheel_formate_machine_type.setter
    @enforce_parameter_types
    def wheel_formate_machine_type(self: Self, value: "_810.WheelFormatMachineTypes"):
        value = conversion.mp_to_pn_enum(
