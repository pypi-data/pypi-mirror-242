...
from mastapy.gears.gear_designs.conical import _1155, _1156
...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel import _774, _783
...
class ConicalSetManufacturingConfig(_791.ConicalSetMicroGeometryConfigBase):
    """ConicalSetManufacturingConfig
    ...
    def gear_manufacturing_configurations(
        self: Self,
    ) -> "List[_774.ConicalGearManufacturingConfig]":
    ...
    @property
    def meshes(self: Self) -> "List[_783.ConicalMeshManufacturingConfig]":
