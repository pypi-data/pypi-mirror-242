...
if TYPE_CHECKING:
    from mastapy.gears.manufacturing.bevel import _786, _792
...
class ConicalMeshManufacturingConfig(_785.ConicalMeshMicroGeometryConfigBase):
    """ConicalMeshManufacturingConfig
    ...
    @property
    def pinion_config(self: Self) -> "_786.ConicalPinionManufacturingConfig":
    ...
    @property
    def wheel_config(self: Self) -> "_792.ConicalWheelManufacturingConfig":
