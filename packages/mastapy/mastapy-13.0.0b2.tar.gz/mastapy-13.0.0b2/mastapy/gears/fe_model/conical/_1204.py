...
class ConicalSetFEModel(_1198.GearSetFEModel):
    """ConicalSetFEModel
    ...
    @property
    def flank_data_source(self: Self) -> "_1205.FlankDataSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.fe_model.conical._1205", "FlankDataSource"
        )(value)

    @flank_data_source.setter
    @enforce_parameter_types
    def flank_data_source(self: Self, value: "_1205.FlankDataSource"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def selected_design(self: Self, value: "_789.ConicalSetManufacturingConfig"):
        wrapper_type = (
