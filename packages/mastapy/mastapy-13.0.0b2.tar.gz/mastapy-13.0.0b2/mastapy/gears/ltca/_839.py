...
if TYPE_CHECKING:
    ...
    from mastapy.gears.ltca import _840, _838
...
class GearMeshLoadDistributionAnalysis(_1221.GearMeshImplementationAnalysis):
    """GearMeshLoadDistributionAnalysis
    ...
    @property
    def moment_about_centre_fourier_series(self: Self) -> "_1510.FourierSeries":
    ...
    @property
    def transmission_error_fourier_series(self: Self) -> "_1510.FourierSeries":
        """mastapy.math_utility.FourierSeries
    ...
    def load_distribution_analyses_at_single_rotation(
        self: Self,
    ) -> "List[_840.GearMeshLoadDistributionAtRotation]":
    ...
    def maximum_root_stress_with_flanks(
        self: Self,
        gear: "_838.GearLoadDistributionAnalysis",
        flank: "_324.GearFlanks",
