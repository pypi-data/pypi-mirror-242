...
class MeshedGearLoadDistributionAnalysisAtRotation(_0.APIBase):
    ...
    _CastSelf = TypeVar(
        "_CastSelf", bound="_Cast_MeshedGearLoadDistributionAnalysisAtRotation"
    )
    ...
    class _Cast_MeshedGearLoadDistributionAnalysisAtRotation:
        ...
        def __init__(
            self: "MeshedGearLoadDistributionAnalysisAtRotation._Cast_MeshedGearLoadDistributionAnalysisAtRotation",
            parent: "MeshedGearLoadDistributionAnalysisAtRotation",
        ):
            self._parent = parent
    ...
    def __init__(
        self: Self,
        instance_to_wrap: "MeshedGearLoadDistributionAnalysisAtRotation.TYPE",
    ):
    ...
    def compression_side_fillet_results(
        self: Self,
    ) -> "List[_843.GearRootFilletStressResults]":
    ...
    def cast_to(
        self: Self,
    ) -> "MeshedGearLoadDistributionAnalysisAtRotation._Cast_MeshedGearLoadDistributionAnalysisAtRotation":
        return self._Cast_MeshedGearLoadDistributionAnalysisAtRotation(self)
