...
class CylindricalMeshLoadDistributionAtRotation(
    ...
    class _Cast_CylindricalMeshLoadDistributionAtRotation:
        ...
        def gear_mesh_load_distribution_at_rotation(
            ...
            return self._parent._cast(_840.GearMeshLoadDistributionAtRotation)
    ...
    @property
    def mesh_alignment(self: Self) -> "_1117.MeshAlignment":
    ...
    def loaded_contact_lines(
        self: Self,
    ) -> "List[_856.CylindricalGearMeshLoadedContactLine]":
