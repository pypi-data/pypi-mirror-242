...
class ConicalGearToothSurface(_0.APIBase):
    ...
    class _Cast_ConicalGearToothSurface:
        ...
        def conical_meshed_wheel_flank_manufacturing_config(
            ...
            return self._parent._cast(_778.ConicalMeshedWheelFlankManufacturingConfig)
        ...
        def pinion_bevel_generating_tilt_machine_settings(
            ...
            return self._parent._cast(_800.PinionBevelGeneratingTiltMachineSettings)
        ...
        def pinion_conical_machine_settings_specified(
            ...
            return self._parent._cast(_802.PinionConicalMachineSettingsSpecified)
        ...
        def pinion_finish_machine_settings(
            ...
            return self._parent._cast(_804.PinionFinishMachineSettings)
        ...
        def pinion_hypoid_formate_tilt_machine_settings(
            ...
            return self._parent._cast(_805.PinionHypoidFormateTiltMachineSettings)
        ...
        def pinion_hypoid_generating_tilt_machine_settings(
            ...
            return self._parent._cast(_806.PinionHypoidGeneratingTiltMachineSettings)
        ...
        def pinion_machine_settings_smt(
            ...
            return self._parent._cast(_807.PinionMachineSettingsSMT)
