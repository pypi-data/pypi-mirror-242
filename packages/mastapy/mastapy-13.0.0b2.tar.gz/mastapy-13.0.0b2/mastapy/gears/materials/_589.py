...
class CylindricalGearMaterial(_592.GearMaterial):
    """CylindricalGearMaterial
    ...
    @property
    def heat_treatment_distortion_control(self: Self) -> "_600.ManufactureRating":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.materials._600", "ManufactureRating"
        )(value)

    @heat_treatment_distortion_control.setter
    @enforce_parameter_types
    def heat_treatment_distortion_control(self: Self, value: "_600.ManufactureRating"):
    ...
    @property
    def heat_treatment_process_development(self: Self) -> "_600.ManufactureRating":
        """mastapy.gears.materials.ManufactureRating"""
    ...
    @enforce_parameter_types
    def heat_treatment_process_development(self: Self, value: "_600.ManufactureRating"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Gears.Materials.ManufactureRating"
        )
    ...
    @property
    def machine_process_development(self: Self) -> "_600.ManufactureRating":
        """mastapy.gears.materials.ManufactureRating"""
    ...
    @enforce_parameter_types
    def machine_process_development(self: Self, value: "_600.ManufactureRating"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Gears.Materials.ManufactureRating"
        )
    ...
    @property
    def manufacturability(self: Self) -> "_600.ManufactureRating":
        """mastapy.gears.materials.ManufactureRating"""
    ...
    @enforce_parameter_types
    def manufacturability(self: Self, value: "_600.ManufactureRating"):
        value = conversion.mp_to_pn_enum(
            value, "SMT.MastaAPI.Gears.Materials.ManufactureRating"
        )
