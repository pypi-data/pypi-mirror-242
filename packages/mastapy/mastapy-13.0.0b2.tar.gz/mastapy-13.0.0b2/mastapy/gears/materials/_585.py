...
class BevelGearMaterial(_592.GearMaterial):
    """BevelGearMaterial
    ...
    @property
    def sn_curve_definition(self: Self) -> "_606.SNCurveDefinition":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.materials._606", "SNCurveDefinition"
        )(value)

    @sn_curve_definition.setter
    @enforce_parameter_types
    def sn_curve_definition(self: Self, value: "_606.SNCurveDefinition"):
