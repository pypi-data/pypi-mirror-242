...
if TYPE_CHECKING:
    from mastapy.materials import _286, _283, _284
...
class PlasticSNCurve(_0.APIBase):
    ...
    @property
    def lubricant(self: Self) -> "_286.VDI2736LubricantType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials._286", "VDI2736LubricantType"
        )(value)

    @lubricant.setter
    @enforce_parameter_types
    def lubricant(self: Self, value: "_286.VDI2736LubricantType"):
    ...
    @property
    def material(self: Self) -> "_601.PlasticCylindricalGearMaterial":
    ...
    def bending_stress_cycle_data_for_damage_tables(
        self: Self,
    ) -> "List[_283.StressCyclesDataForTheBendingSNCurveOfAPlasticMaterial]":
    ...
    def contact_stress_cycle_data_for_damage_tables(
        self: Self,
    ) -> "List[_284.StressCyclesDataForTheContactSNCurveOfAPlasticMaterial]":
