...
from mastapy.system_model.analyses_and_results.harmonic_analyses import _5676, _5767
...
from mastapy.system_model.drawing.options import _2260
...
class HarmonicAnalysisViewable(_2246.DynamicAnalysisViewable):
    """HarmonicAnalysisViewable
    ...
    class _Cast_HarmonicAnalysisViewable:
        ...
        def dynamic_analysis_viewable(
            ...
            return self._parent._cast(_2246.DynamicAnalysisViewable)
        ...
        def part_analysis_case_with_contour_viewable(
            ...
            return self._parent._cast(_2251.PartAnalysisCaseWithContourViewable)
    ...
    def excitation(self: Self, value: "_5676.AbstractPeriodicExcitationDetail"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def harmonic_analysis_with_varying_stiffness_step(
        self: Self, value: "_5767.HarmonicAnalysisWithVaryingStiffnessStaticLoadCase"
    ):
        wrapper_type = (
    ...
    @order.setter
    @enforce_parameter_types
    def order(self: Self, value: "_1526.RoundedOrder"):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def uncoupled_mesh(self: Self, value: "_2757.GearMeshSystemDeflection"):
        wrapper_type = (
    ...
    @view_type.setter
    @enforce_parameter_types
    def view_type(self: Self, value: "_2260.ExcitationAnalysisViewOption"):
    ...
    @property
    def dynamic_analysis_draw_style(self: Self) -> "_6327.DynamicAnalysisDrawStyle":
