...
from mastapy.system_model.part_model import _2442, _2446
from mastapy._internal.overridable_constructor import _unpack_overridable
from mastapy.utility.units_and_measurements import _1608
from mastapy._internal.python_net import python_net_import
from mastapy.system_model.fe import _2409, _2386
...
if TYPE_CHECKING:
    ...
    from mastapy.materials import _235, _281
    ...
    from mastapy.system_model.fe.links import _2416
...
class FESubstructure(_66.FEStiffness):
    ...
    @property
    def alignment_method(self: Self) -> "_2354.AlignmentMethod":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2354", "AlignmentMethod"
        )(value)

    @alignment_method.setter
    @enforce_parameter_types
    def alignment_method(self: Self, value: "_2354.AlignmentMethod"):
    ...
    @property
    def bearing_node_alignment(self: Self) -> "_2360.BearingNodeAlignmentOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2360", "BearingNodeAlignmentOption"
        )(value)

    @bearing_node_alignment.setter
    @enforce_parameter_types
    def bearing_node_alignment(self: Self, value: "_2360.BearingNodeAlignmentOption"):
        value = conversion.mp_to_pn_enum(
    ...
    @enforce_parameter_types
    def component_to_align_to(self: Self, value: "_2442.Component"):
        wrapper_type = (
    ...
    @datum.setter
    @enforce_parameter_types
    def datum(self: Self, value: "_2446.Datum"):
    ...
    @enforce_parameter_types
    def distance_display_unit(self: Self, value: "_1608.Unit"):
    ...
    @enforce_parameter_types
    def force_display_unit(self: Self, value: "_1608.Unit"):
        wrapper_type = list_with_selected_item.ListWithSelectedItem_Unit.wrapper_type()
        enclosed_type = (
            list_with_selected_item.ListWithSelectedItem_Unit.implicit_type()
        )
    ...
    @enforce_parameter_types
    def thermal_expansion_option(self: Self, value: "_2409.ThermalExpansionOption"):
    ...
    @type_.setter
    @enforce_parameter_types
    def type_(self: Self, value: "_2386.FESubstructureType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    @property
    def acoustic_radiation_efficiency(self: Self) -> "_235.AcousticRadiationEfficiency":
    ...
    def alignment_to_component(
        self: Self,
    ) -> "_2218.RelativeComponentAlignment[_2442.Component]":
        ...
        type_ = temp.GetType()
        return constructor.new(type_.Namespace, type_.Name)[_2442.Component](temp)

    @property
    def cms_model(self: Self) -> "_225.CMSModel":
    ...
    @property
    def coordinate_system(self: Self) -> "_1496.CoordinateSystem3D":
    ...
    @property
    def export(self: Self) -> "_2382.FESubstructureExportOptions":
    ...
    @property
    def fe_part(self: Self) -> "_2451.FEPart":
    ...
    @property
    def sound_pressure_enclosure(self: Self) -> "_281.SoundPressureEnclosure":
    ...
    @property
    def gear_meshing_options(self: Self) -> "List[_2393.GearMeshingOptions]":
    ...
    @property
    def geometries(self: Self) -> "List[_2379.FEStiffnessGeometry]":
    ...
    def independent_masta_created_condensation_nodes(
        self: Self,
    ) -> "List[_2394.IndependentMASTACreatedCondensationNode]":
    ...
    @property
    def links(self: Self) -> "List[_2416.FELink]":
    ...
    @property
    def nodes(self: Self) -> "List[_2383.FESubstructureNode]":
    ...
    @property
    def replaced_shafts(self: Self) -> "List[_2480.Shaft]":
    ...
    def shafts_that_can_be_replaced(
        self: Self,
    ) -> "List[_2407.ReplacedShaftSelectionHelper]":
    ...
    def thermal_expansion_displacements(
        self: Self,
    ) -> "List[_1562.VectorWithLinearAndAngularComponents]":
    ...
    def import_fe_mesh(
        ...
        progress: Optional["_7556.TaskProgress"] = None,
    ):
        """Method does not return.
    ...
    def import_node_positions(
        self: Self, file_name: "str", distance_unit: "_1608.Unit"
    ):
        """Method does not return.
    ...
    def import_reduced_stiffness(
        self: Self,
        file_name: "str",
        distance_unit: "_1608.Unit",
        force_unit: "_1608.Unit",
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def links_for(self: Self, node: "_2383.FESubstructureNode") -> "List[_2416.FELink]":
        """List[mastapy.system_model.fe.links.FELink]
    ...
    def load_existing_masta_fe_file_with_progress(
        self: Self, file_name: "str", progress: "_7556.TaskProgress"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def load_stl_geometry(self: Self, length_unit: "_1608.Unit", file_name: "str"):
        """Method does not return.
