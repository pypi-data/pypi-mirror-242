...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.dev_tools_analyses import _178, _187
...
class FESubstructureWithSelectionForModalAnalysis(_2388.FESubstructureWithSelection):
    """FESubstructureWithSelectionForModalAnalysis
    ...
    @property
    def eigenvalue_options(self: Self) -> "_178.EigenvalueOptions":
    ...
    @property
    def modal_draw_style(self: Self) -> "_187.FEModelModalAnalysisDrawStyle":
    ...
    def full_fe_mode_shapes_at_condensation_nodes(
        self: Self,
    ) -> "List[_2385.FESubstructureNodeModeShapes]":
