...
class IndependentMASTACreatedCondensationNode(_0.APIBase):
    ...
    @property
    def rigid_coupling_type(self: Self) -> "_201.RigidCouplingType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.nodal_analysis.dev_tools_analyses._201", "RigidCouplingType"
        )(value)

    @rigid_coupling_type.setter
    @enforce_parameter_types
    def rigid_coupling_type(self: Self, value: "_201.RigidCouplingType"):
    ...
    @property
    def fe_substructure_node(self: Self) -> "_2383.FESubstructureNode":
