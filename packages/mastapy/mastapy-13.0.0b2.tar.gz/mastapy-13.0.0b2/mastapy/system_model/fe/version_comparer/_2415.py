...
if TYPE_CHECKING:
    from mastapy.math_utility.measured_vectors import _1562, _1560
...
class NodeComparisonResult(_0.APIBase):
    ...
    @property
    def displacement_change(self: Self) -> "_1562.VectorWithLinearAndAngularComponents":
    ...
    @property
    def new_result(self: Self) -> "_1560.NodeResults":
    ...
    @property
    def original_result(self: Self) -> "_1560.NodeResults":
        """mastapy.math_utility.measured_vectors.NodeResults
