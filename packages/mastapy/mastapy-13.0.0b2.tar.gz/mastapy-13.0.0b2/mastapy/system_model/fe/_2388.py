...
if TYPE_CHECKING:
    from mastapy.system_model.fe import _2381, _2373, _2399
...
class FESubstructureWithSelection(_2358.BaseFEWithSelection):
    """FESubstructureWithSelection
    ...
    @property
    def fe_substructure(self: Self) -> "_2381.FESubstructure":
    ...
    @property
    def element_face_groups(self: Self) -> "List[_2373.ElementFaceGroupWithSelection]":
    ...
    @property
    def node_groups(self: Self) -> "List[_2399.NodeGroupWithSelection]":
