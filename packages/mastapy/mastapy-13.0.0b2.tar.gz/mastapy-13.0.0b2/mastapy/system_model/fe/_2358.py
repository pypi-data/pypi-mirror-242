...
if TYPE_CHECKING:
    from mastapy.nodal_analysis.dev_tools_analyses import _184, _177, _193, _192
...
class BaseFEWithSelection(_0.APIBase):
    ...
    class _Cast_BaseFEWithSelection:
        ...
        def fe_substructure_with_selection_components(
            ...
            return self._parent._cast(_2389.FESubstructureWithSelectionComponents)
        ...
        def fe_substructure_with_selection_for_modal_analysis(
            ...
            return self._parent._cast(_2391.FESubstructureWithSelectionForModalAnalysis)
        ...
        def race_bearing_fe_with_selection(
            ...
            return self._parent._cast(_2406.RaceBearingFEWithSelection)
    ...
    @property
    def component_draw_style(self: Self) -> "_184.FEModelComponentDrawStyle":
    ...
    @property
    def draw_style(self: Self) -> "_177.DrawStyleForFE":
    ...
    @property
    def node_selection(self: Self) -> "_193.FENodeSelectionDrawStyle":
    ...
    @property
    def transparency_draw_style(self: Self) -> "_192.FEModelTransparencyDrawStyle":
    ...
    def select_component(self: Self, component: "_2442.Component"):
