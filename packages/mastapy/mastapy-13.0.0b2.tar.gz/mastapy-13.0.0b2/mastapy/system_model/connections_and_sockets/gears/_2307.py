...
class CylindricalGearMesh(_2311.GearMesh):
    """CylindricalGearMesh
    ...
    @property
    def centre_distance_range(self: Self) -> "_1486.Range":
    ...
    @property
    def active_gear_mesh_design(self: Self) -> "_1016.CylindricalGearMeshDesign":
    ...
    @property
    def cylindrical_gear_mesh_design(self: Self) -> "_1016.CylindricalGearMeshDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearMeshDesign
    ...
    @property
    def cylindrical_gear_set(self: Self) -> "_2524.CylindricalGearSet":
