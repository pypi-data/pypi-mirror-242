...
class ZerolBevelGearMesh(_2301.BevelGearMesh):
    """ZerolBevelGearMesh
    ...
    @property
    def bevel_gear_mesh_design(self: Self) -> "_951.ZerolBevelGearMeshDesign":
    ...
    @property
    def zerol_bevel_gear_mesh_design(self: Self) -> "_951.ZerolBevelGearMeshDesign":
        """mastapy.gears.gear_designs.zerol_bevel.ZerolBevelGearMeshDesign
