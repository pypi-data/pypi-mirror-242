...
T = TypeVar("T", bound="_2442.Component")
...
class RelativeComponentAlignment(_0.APIBase, Generic[T]):
    ...
    @property
    def alignment_axis(self: Self) -> "_1488.AlignmentAxis":
    ...
    def alignment_axis(self: Self, value: "_1488.AlignmentAxis"):
    ...
    @property
    def axial_offset(self: Self) -> "_2219.RelativeOffsetOption":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model._2219", "RelativeOffsetOption"
        )(value)

    @axial_offset.setter
    @enforce_parameter_types
    def axial_offset(self: Self, value: "_2219.RelativeOffsetOption"):
        value = conversion.mp_to_pn_enum(
