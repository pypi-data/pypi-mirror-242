...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6820, _6821
...
class BevelDifferentialGearSetLoadCase(_6827.BevelGearSetLoadCase):
    """BevelDifferentialGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6820.BevelDifferentialGearLoadCase]":
    ...
    def bevel_differential_gears_load_case(
        self: Self,
    ) -> "List[_6820.BevelDifferentialGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.BevelDifferentialGearLoadCase]
    ...
    def bevel_differential_meshes_load_case(
        self: Self,
    ) -> "List[_6821.BevelDifferentialGearMeshLoadCase]":
