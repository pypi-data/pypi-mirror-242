...
class ClutchConnectionLoadCase(_6849.CouplingConnectionLoadCase):
    """ClutchConnectionLoadCase
    ...
    @property
    def clutch_pressures(self: Self) -> "_1532.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def clutch_pressures(self: Self, value: "_1532.Vector2DListAccessor"):
