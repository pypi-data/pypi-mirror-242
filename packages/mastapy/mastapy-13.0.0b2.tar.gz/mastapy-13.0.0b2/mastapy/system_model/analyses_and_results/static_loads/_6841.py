...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6839, _6840
...
class ConceptGearSetLoadCase(_6893.GearSetLoadCase):
    """ConceptGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6839.ConceptGearLoadCase]":
    ...
    @property
    def concept_gears_load_case(self: Self) -> "List[_6839.ConceptGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.ConceptGearLoadCase]
    ...
    @property
    def concept_meshes_load_case(self: Self) -> "List[_6840.ConceptGearMeshLoadCase]":
