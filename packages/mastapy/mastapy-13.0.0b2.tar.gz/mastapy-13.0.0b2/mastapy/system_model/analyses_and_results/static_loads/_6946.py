...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6802, _6863
...
class RootAssemblyLoadCase(_6816.AssemblyLoadCase):
    """RootAssemblyLoadCase
    ...
    @property
    def drive_cycle_pid_control_settings(self: Self) -> "_1574.PIDControlSettings":
    ...
    @property
    def load_case(self: Self) -> "_6802.StaticLoadCase":
    ...
    @property
    def supercharger_rotor_sets(self: Self) -> "List[_6863.CylindricalGearSetLoadCase]":
