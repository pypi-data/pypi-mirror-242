...
from mastapy.utility_gui import _1846
...
if TYPE_CHECKING:
    from mastapy.utility.file_access_helpers import _1816
...
class MultiTimeSeriesDataInputFileOptions(_1846.DataInputFileOptions):
    """MultiTimeSeriesDataInputFileOptions
    ...
    class _Cast_MultiTimeSeriesDataInputFileOptions:
        ...
        def data_input_file_options(
            ...
            return self._parent._cast(_1846.DataInputFileOptions)
    ...
    @property
    def delimiter_options(self: Self) -> "_1816.TextFileDelimiterOptions":
