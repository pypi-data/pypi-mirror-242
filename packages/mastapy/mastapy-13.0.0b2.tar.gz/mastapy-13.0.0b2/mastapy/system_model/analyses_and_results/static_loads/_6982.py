...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6980, _6981
...
class WormGearSetLoadCase(_6893.GearSetLoadCase):
    """WormGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6980.WormGearLoadCase]":
    ...
    @property
    def worm_gears_load_case(self: Self) -> "List[_6980.WormGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.WormGearLoadCase]
    ...
    @property
    def worm_meshes_load_case(self: Self) -> "List[_6981.WormGearMeshLoadCase]":
