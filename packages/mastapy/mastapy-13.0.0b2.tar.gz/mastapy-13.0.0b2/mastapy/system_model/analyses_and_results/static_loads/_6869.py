...
from mastapy.electric_machines.harmonic_load_data import _1379, _1375
...
class ElectricMachineHarmonicLoadData(_1375.ElectricMachineHarmonicLoadDataBase):
    """ElectricMachineHarmonicLoadData
    ...
    @enforce_parameter_types
    def data_type_for_scaling(self: Self, value: "_1379.HarmonicLoadDataType"):
    ...
    @enforce_parameter_types
    def torque_ripple_input_type(self: Self, value: "_6974.TorqueRippleInputType"):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
