...
class FEPartLoadCase(_6806.AbstractShaftOrHousingLoadCase):
    """FEPartLoadCase
    ...
    @property
    def angle_source(self: Self) -> "_2357.AngleSource":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.fe._2357", "AngleSource"
        )(value)
    ...
    @enforce_parameter_types
    def fe_substructure(self: Self, value: "_2381.FESubstructure"):
        wrapper_type = (
    ...
    def surfaces_for_data_logging(
        self: Self,
    ) -> "List[_6833.CMSElementFaceGroupWithSelectionOption]":
