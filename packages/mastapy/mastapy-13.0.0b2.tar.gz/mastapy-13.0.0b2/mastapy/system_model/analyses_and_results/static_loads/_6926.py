...
from mastapy.system_model.analyses_and_results.static_loads import _6895, _6802
...
class PartLoadCase(_2655.PartAnalysis):
    """PartLoadCase
    ...
    def harmonic_excitation_type(self: Self, value: "_6895.HarmonicExcitationType"):
    ...
    @enforce_parameter_types
    def load_case_for_harmonic_excitation_type_advanced_system_deflection_current_load_case_set_up(
        self: Self, value: "_6802.StaticLoadCase"
    ):
        wrapper_type = (
    ...
    @property
    def static_load_case(self: Self) -> "_6802.StaticLoadCase":
    ...
    @property
    def time_series_load_case(self: Self) -> "_6803.TimeSeriesLoadCase":
    ...
    def get_harmonic_load_data_for_import(self: Self) -> "_1377.HarmonicLoadDataBase":
