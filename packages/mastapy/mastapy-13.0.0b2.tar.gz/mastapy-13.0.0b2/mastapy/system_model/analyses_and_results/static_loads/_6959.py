...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.static_loads import _6957, _6958
...
class StraightBevelDiffGearSetLoadCase(_6827.BevelGearSetLoadCase):
    """StraightBevelDiffGearSetLoadCase
    ...
    @property
    def gears(self: Self) -> "List[_6957.StraightBevelDiffGearLoadCase]":
    ...
    def straight_bevel_diff_gears_load_case(
        self: Self,
    ) -> "List[_6957.StraightBevelDiffGearLoadCase]":
        """List[mastapy.system_model.analyses_and_results.static_loads.StraightBevelDiffGearLoadCase]
    ...
    def straight_bevel_diff_meshes_load_case(
        self: Self,
    ) -> "List[_6958.StraightBevelDiffGearMeshLoadCase]":
