...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results import _2637, _2618
...
class TimeSeriesLoadCase(_6801.LoadCase):
    """TimeSeriesLoadCase
    ...
    @property
    def multibody_dynamics_analysis(self: Self) -> "_2637.MultibodyDynamicsAnalysis":
    ...
    @property
    def driva_analysis_options(self: Self) -> "_5458.MBDAnalysisOptions":
    ...
    @property
    def time_series_load_case_group(self: Self) -> "_5668.TimeSeriesLoadCaseGroup":
    ...
    def duplicate(
        self: Self,
        new_load_case_group: "_5668.TimeSeriesLoadCaseGroup",
        name: "str" = "None",
    ) -> "TimeSeriesLoadCase":
