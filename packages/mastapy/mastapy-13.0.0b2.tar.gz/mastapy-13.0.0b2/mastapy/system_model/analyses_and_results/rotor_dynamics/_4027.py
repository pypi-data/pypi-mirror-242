...
from mastapy.system_model.analyses_and_results.rotor_dynamics import _4025
...
class ShaftModalComplexShape(_4025.ShaftComplexShape["_1686.Number", "_1686.Number"]):
    """ShaftModalComplexShape
    ...
    class _Cast_ShaftModalComplexShape:
        ...
        def shaft_complex_shape(
            ...
            return self._parent._cast(_4025.ShaftComplexShape)
