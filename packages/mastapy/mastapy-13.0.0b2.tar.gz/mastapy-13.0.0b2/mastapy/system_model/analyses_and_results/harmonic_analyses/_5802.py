...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5764, _5758
...
class RootAssemblyHarmonicAnalysis(
    _5683.AssemblyHarmonicAnalysis, _2653.IHaveRootHarmonicAnalysisResults
):
    """RootAssemblyHarmonicAnalysis
    ...
    @property
    def export(self: Self) -> "_5764.HarmonicAnalysisRootAssemblyExportOptions":
    ...
    @property
    def harmonic_analysis_inputs(self: Self) -> "_5758.HarmonicAnalysis":
