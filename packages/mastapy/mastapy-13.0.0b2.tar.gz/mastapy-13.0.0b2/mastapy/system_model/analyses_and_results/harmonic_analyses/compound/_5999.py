...
class WormGearCompoundHarmonicAnalysis(_5934.GearCompoundHarmonicAnalysis):
    """WormGearCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5835.WormGearHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5835.WormGearHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.WormGearHarmonicAnalysis]
