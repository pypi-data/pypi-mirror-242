...
class WormGearSetCompoundHarmonicAnalysis(_5936.GearSetCompoundHarmonicAnalysis):
    """WormGearSetCompoundHarmonicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5837.WormGearSetHarmonicAnalysis]":
    ...
    def worm_gears_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_5999.WormGearCompoundHarmonicAnalysis]":
    ...
    def worm_meshes_compound_harmonic_analysis(
        self: Self,
    ) -> "List[_6000.WormGearMeshCompoundHarmonicAnalysis]":
