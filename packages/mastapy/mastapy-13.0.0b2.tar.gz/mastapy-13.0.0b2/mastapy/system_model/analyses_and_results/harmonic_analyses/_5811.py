...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.harmonic_analyses import _5809, _5810
...
class SpiralBevelGearSetHarmonicAnalysis(_5694.BevelGearSetHarmonicAnalysis):
    """SpiralBevelGearSetHarmonicAnalysis
    ...
    def gears_harmonic_analysis(
        self: Self,
    ) -> "List[_5809.SpiralBevelGearHarmonicAnalysis]":
    ...
    def meshes_harmonic_analysis(
        self: Self,
    ) -> "List[_5810.SpiralBevelGearMeshHarmonicAnalysis]":
