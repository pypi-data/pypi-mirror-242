...
class ResultsForOrderIncludingSurfaces(_5868.ResultsForOrderIncludingNodes):
    """ResultsForOrderIncludingSurfaces
    ...
    class _Cast_ResultsForOrderIncludingSurfaces:
        ...
        def results_for_order_including_nodes(
            ...
            return self._parent._cast(_5868.ResultsForOrderIncludingNodes)
        ...
        def results_for_order(
            ...
            return self._parent._cast(_5866.ResultsForOrder)
    ...
    def fe_surfaces(
        self: Self,
    ) -> "List[_5861.HarmonicAnalysisResultsBrokenDownBySurfaceWithinAHarmonic]":
