...
class RootAssemblyHarmonicAnalysisResultsPropertyAccessor(_0.APIBase):
    ...
    @property
    def combined_orders(self: Self) -> "_5865.ResultsForMultipleOrdersForGroups":
    ...
    def excitations(
        self: Self,
    ) -> "List[_5874.RootAssemblySingleWhineAnalysisResultsPropertyAccessor]":
    ...
    def orders_for_combined_excitations(
        self: Self,
    ) -> "List[_5867.ResultsForOrderIncludingGroups]":
