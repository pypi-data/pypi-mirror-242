...
class DatumHarmonicAnalysis(_5702.ComponentHarmonicAnalysis):
    """DatumHarmonicAnalysis
    ...
    @property
    def component_load_case(self: Self) -> "_6867.DatumLoadCase":
    ...
    @property
    def system_deflection_results(self: Self) -> "_2749.DatumSystemDeflection":
