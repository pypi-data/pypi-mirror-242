...
class OilSealHarmonicAnalysis(_5713.ConnectorHarmonicAnalysis):
    """OilSealHarmonicAnalysis
    ...
    @property
    def component_load_case(self: Self) -> "_6924.OilSealLoadCase":
    ...
    @property
    def system_deflection_results(self: Self) -> "_2782.OilSealSystemDeflection":
