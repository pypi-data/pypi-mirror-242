...
class PowerLoadCompoundHarmonicAnalysis(_5998.VirtualComponentCompoundHarmonicAnalysis):
    """PowerLoadCompoundHarmonicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5794.PowerLoadHarmonicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5794.PowerLoadHarmonicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.harmonic_analyses.PowerLoadHarmonicAnalysis]
