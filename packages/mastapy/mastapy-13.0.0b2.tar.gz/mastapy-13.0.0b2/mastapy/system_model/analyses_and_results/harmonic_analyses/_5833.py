...
class UnbalancedMassHarmonicAnalysis(_5834.VirtualComponentHarmonicAnalysis):
    """UnbalancedMassHarmonicAnalysis
    ...
    @property
    def system_deflection_results(self: Self) -> "_2832.UnbalancedMassSystemDeflection":
