...
class WormGearSetSystemDeflection(_2758.GearSetSystemDeflection):
    """WormGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4160.WormGearSetPowerFlow":
    ...
    def worm_meshes_system_deflection(
        self: Self,
    ) -> "List[_2834.WormGearMeshSystemDeflection]":
