...
class AssemblyCompoundSystemDeflection(_2849.AbstractAssemblyCompoundSystemDeflection):
    """AssemblyCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2690.AssemblySystemDeflection]":
    ...
    @property
    def bearings(self: Self) -> "List[_2857.BearingCompoundSystemDeflection]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_2859.BeltDriveCompoundSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_2862.BevelDifferentialGearSetCompoundSystemDeflection]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_2869.BoltedJointCompoundSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_2868.BoltCompoundSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_2890.CVTCompoundSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_2870.ClutchCompoundSystemDeflection]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_2875.ConceptCouplingCompoundSystemDeflection]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_2880.ConceptGearSetCompoundSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_2892.CycloidalAssemblyCompoundSystemDeflection]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_2894.CycloidalDiscCompoundSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_2898.CylindricalGearSetCompoundSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_2906.FEPartCompoundSystemDeflection]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_2905.FaceGearSetCompoundSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_2907.FlexiblePinAssemblyCompoundSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_2914.HypoidGearSetCompoundSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_2921.KlingelnbergCycloPalloidHypoidGearSetCompoundSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        ...
        "List[_2924.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundSystemDeflection]"
    ):
    ...
    @property
    def mass_discs(self: Self) -> "List[_2925.MassDiscCompoundSystemDeflection]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_2926.MeasurementComponentCompoundSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_2928.OilSealCompoundSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_2930.PartToPartShearCouplingCompoundSystemDeflection]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_2935.PlanetCarrierCompoundSystemDeflection]":
    ...
    @property
    def point_loads(self: Self) -> "List[_2936.PointLoadCompoundSystemDeflection]":
    ...
    @property
    def power_loads(self: Self) -> "List[_2937.PowerLoadCompoundSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_2939.RingPinsCompoundSystemDeflection]":
    ...
    @property
    def rolling_bearings(self: Self) -> "List[_2857.BearingCompoundSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.compound.BearingCompoundSystemDeflection]
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_2941.RollingRingAssemblyCompoundSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_2947.ShaftHubConnectionCompoundSystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_2945.ShaftCompoundSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_2952.SpiralBevelGearSetCompoundSystemDeflection]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_2953.SpringDamperCompoundSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_2958.StraightBevelDiffGearSetCompoundSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_2961.StraightBevelGearSetCompoundSystemDeflection]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_2964.SynchroniserCompoundSystemDeflection]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_2968.TorqueConverterCompoundSystemDeflection]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_2972.UnbalancedMassCompoundSystemDeflection]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_2976.WormGearSetCompoundSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_2979.ZerolBevelGearSetCompoundSystemDeflection]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_2690.AssemblySystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.AssemblySystemDeflection]
