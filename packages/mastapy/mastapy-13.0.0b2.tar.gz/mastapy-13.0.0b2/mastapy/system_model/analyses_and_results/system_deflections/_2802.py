...
class ShaftSystemDeflection(_2685.AbstractShaftSystemDeflection):
    """ShaftSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4130.ShaftPowerFlow":
    ...
    @property
    def mounted_components_applying_torque(self: Self) -> "List[_1559.ForceResults]":
    ...
    def shaft_section_end_results_by_offset_with_worst_safety_factor(
        self: Self,
    ) -> "List[_2800.ShaftSectionEndResultsSystemDeflection]":
    ...
    @property
    def shaft_section_results(self: Self) -> "List[_2801.ShaftSectionSystemDeflection]":
