...
class WormGearCompoundSystemDeflection(_2908.GearCompoundSystemDeflection):
    """WormGearCompoundSystemDeflection
    ...
    @property
    def duty_cycle_rating(self: Self) -> "_370.WormGearDutyCycleRating":
    ...
    @property
    def worm_duty_cycle_rating(self: Self) -> "_370.WormGearDutyCycleRating":
        """mastapy.gears.rating.worm.WormGearDutyCycleRating
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2836.WormGearSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2836.WormGearSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.WormGearSystemDeflection]
