...
class BevelDifferentialGearSetSystemDeflection(_2705.BevelGearSetSystemDeflection):
    """BevelDifferentialGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4043.BevelDifferentialGearSetPowerFlow":
