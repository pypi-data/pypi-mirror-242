...
class ConceptGearMeshSystemDeflection(_2757.GearMeshSystemDeflection):
    """ConceptGearMeshSystemDeflection
    ...
    @property
    def rating(self: Self) -> "_548.ConceptGearMeshRating":
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_548.ConceptGearMeshRating":
        """mastapy.gears.rating.concept.ConceptGearMeshRating
    ...
    @property
    def power_flow_results(self: Self) -> "_4059.ConceptGearMeshPowerFlow":
