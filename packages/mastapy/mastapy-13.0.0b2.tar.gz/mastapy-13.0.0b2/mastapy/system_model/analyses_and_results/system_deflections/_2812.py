...
class StraightBevelDiffGearSetSystemDeflection(_2705.BevelGearSetSystemDeflection):
    """StraightBevelDiffGearSetSystemDeflection
    ...
    @property
    def power_flow_results(self: Self) -> "_4141.StraightBevelDiffGearSetPowerFlow":
    ...
    def straight_bevel_diff_meshes_system_deflection(
        self: Self,
    ) -> "List[_2811.StraightBevelDiffGearMeshSystemDeflection]":
