...
class DatumCompoundSystemDeflection(_2874.ComponentCompoundSystemDeflection):
    """DatumCompoundSystemDeflection
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_2749.DatumSystemDeflection]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2749.DatumSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.DatumSystemDeflection]
