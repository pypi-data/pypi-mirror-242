...
class FaceGearSetCompoundSystemDeflection(_2910.GearSetCompoundSystemDeflection):
    """FaceGearSetCompoundSystemDeflection
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_2753.FaceGearSetSystemDeflection]":
    ...
    def face_gears_compound_system_deflection(
        self: Self,
    ) -> "List[_2903.FaceGearCompoundSystemDeflection]":
    ...
    def face_meshes_compound_system_deflection(
        self: Self,
    ) -> "List[_2904.FaceGearMeshCompoundSystemDeflection]":
