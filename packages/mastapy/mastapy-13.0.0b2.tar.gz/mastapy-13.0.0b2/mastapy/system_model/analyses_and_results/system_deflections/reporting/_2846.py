...
class RigidlyConnectedComponentGroupSystemDeflection(_2650.DesignEntityGroupAnalysis):
    """RigidlyConnectedComponentGroupSystemDeflection
    ...
    class _Cast_RigidlyConnectedComponentGroupSystemDeflection:
        ...
        def design_entity_group_analysis(
            ...
            return self._parent._cast(_2650.DesignEntityGroupAnalysis)
    ...
    @property
    def mass_properties(self: Self) -> "_1515.MassProperties":
    ...
    @property
    def components(self: Self) -> "List[_2713.ComponentSystemDeflection]":
