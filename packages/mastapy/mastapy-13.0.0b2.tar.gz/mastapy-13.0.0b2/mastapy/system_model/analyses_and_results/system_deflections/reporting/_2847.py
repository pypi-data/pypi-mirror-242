...
if TYPE_CHECKING:
    from mastapy.utility.enums import _1818
...
class ShaftSystemDeflectionSectionsReport(_1754.CustomReportChart):
    """ShaftSystemDeflectionSectionsReport
    ...
    @property
    def display(self: Self) -> "_1818.TableAndChartOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.utility.enums._1818", "TableAndChartOptions"
        )(value)

    @display.setter
    @enforce_parameter_types
    def display(self: Self, value: "_1818.TableAndChartOptions"):
