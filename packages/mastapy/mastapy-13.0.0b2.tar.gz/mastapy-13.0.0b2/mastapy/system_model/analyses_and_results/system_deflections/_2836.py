...
class WormGearSystemDeflection(_2759.GearSystemDeflection):
    """WormGearSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_372.WormGearRating":
    ...
    @property
    def power_flow_results(self: Self) -> "_4159.WormGearPowerFlow":
