...
class BearingCompoundSystemDeflection(_2885.ConnectorCompoundSystemDeflection):
    """BearingCompoundSystemDeflection
    ...
    @property
    def component_detailed_analysis(self: Self) -> "_1946.LoadedBearingDutyCycle":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_2696.BearingSystemDeflection]":
        """List[mastapy.system_model.analyses_and_results.system_deflections.BearingSystemDeflection]
