...
class GearMultibodyDynamicsAnalysis(_5461.MountableComponentMultibodyDynamicsAnalysis):
    """GearMultibodyDynamicsAnalysis
    ...
    @property
    def peak_gear_torque(self: Self) -> "List[_5523.DynamicTorqueResultAtTime]":
