...
from mastapy.system_model.analyses_and_results.mbd_analyses import _5383, _5435, _5481
...
class MBDAnalysisOptions(_0.APIBase):
    ...
    @property
    def analysis_type(self: Self) -> "_5380.AnalysisTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5380",
            "AnalysisTypes",
        )(value)

    @analysis_type.setter
    @enforce_parameter_types
    def analysis_type(self: Self, value: "_5380.AnalysisTypes"):
    ...
    @enforce_parameter_types
    def include_shaft_and_housing_flexibilities(
        self: Self, value: "_5481.ShaftAndHousingFlexibilityOption"
    ):
        wrapper_type = enum_with_selected_value_runtime.ENUM_WITH_SELECTED_VALUE
        enclosed_type = (
    ...
    def method_to_define_period(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5442",
    ...
    @enforce_parameter_types
    def method_to_define_period(
        self: Self, value: "_5442.InertiaAdjustedLoadCasePeriodMethod"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCasePeriodMethod",
    ...
    @enforce_parameter_types
    def reference_power_load_to_define_period(self: Self, value: "_2470.PowerLoad"):
        wrapper_type = (
    ...
    def static_load_cases_to_create(
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.analyses_and_results.mbd_analyses._5443",
    ...
    @enforce_parameter_types
    def static_load_cases_to_create(
        self: Self, value: "_5443.InertiaAdjustedLoadCaseResultsToCreate"
    ):
        value = conversion.mp_to_pn_enum(
            value,
            "SMT.MastaAPI.SystemModel.AnalysesAndResults.MBDAnalyses.InertiaAdjustedLoadCaseResultsToCreate",
    ...
    @property
    def run_up_analysis_options(self: Self) -> "_5459.MBDRunUpAnalysisOptions":
