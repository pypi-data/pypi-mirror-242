...
class ConceptGearSetParametricStudyTool(_4360.GearSetParametricStudyTool):
    """ConceptGearSetParametricStudyTool
    ...
    def concept_gears_parametric_study_tool(
        self: Self,
    ) -> "List[_4323.ConceptGearParametricStudyTool]":
    ...
    def concept_meshes_parametric_study_tool(
        self: Self,
    ) -> "List[_4322.ConceptGearMeshParametricStudyTool]":
