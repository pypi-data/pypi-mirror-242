...
class WormGearSetCompoundParametricStudyTool(_4500.GearSetCompoundParametricStudyTool):
    """WormGearSetCompoundParametricStudyTool
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4436.WormGearSetParametricStudyTool]":
    ...
    def worm_gears_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4563.WormGearCompoundParametricStudyTool]":
    ...
    def worm_meshes_compound_parametric_study_tool(
        self: Self,
    ) -> "List[_4564.WormGearMeshCompoundParametricStudyTool]":
