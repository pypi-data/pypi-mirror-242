...
class AssemblyCompoundParametricStudyTool(
    ...
    @property
    def all_duty_cycle_results(self: Self) -> "_4347.DutyCycleResultsForAllComponents":
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4300.AssemblyParametricStudyTool]":
    ...
    @property
    def bearings(self: Self) -> "List[_4448.BearingCompoundParametricStudyTool]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4450.BeltDriveCompoundParametricStudyTool]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4453.BevelDifferentialGearSetCompoundParametricStudyTool]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_4460.BoltedJointCompoundParametricStudyTool]":
    ...
    @property
    def bolts(self: Self) -> "List[_4459.BoltCompoundParametricStudyTool]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4481.CVTCompoundParametricStudyTool]":
    ...
    @property
    def clutches(self: Self) -> "List[_4461.ClutchCompoundParametricStudyTool]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_4466.ConceptCouplingCompoundParametricStudyTool]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_4471.ConceptGearSetCompoundParametricStudyTool]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_4483.CycloidalAssemblyCompoundParametricStudyTool]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_4485.CycloidalDiscCompoundParametricStudyTool]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_4489.CylindricalGearSetCompoundParametricStudyTool]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4496.FEPartCompoundParametricStudyTool]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_4495.FaceGearSetCompoundParametricStudyTool]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4497.FlexiblePinAssemblyCompoundParametricStudyTool]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_4504.HypoidGearSetCompoundParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4511.KlingelnbergCycloPalloidHypoidGearSetCompoundParametricStudyTool]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4514.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundParametricStudyTool]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4515.MassDiscCompoundParametricStudyTool]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4516.MeasurementComponentCompoundParametricStudyTool]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4518.OilSealCompoundParametricStudyTool]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4520.PartToPartShearCouplingCompoundParametricStudyTool]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_4525.PlanetCarrierCompoundParametricStudyTool]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4526.PointLoadCompoundParametricStudyTool]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4527.PowerLoadCompoundParametricStudyTool]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4529.RingPinsCompoundParametricStudyTool]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4531.RollingRingAssemblyCompoundParametricStudyTool]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_4536.ShaftHubConnectionCompoundParametricStudyTool]":
    ...
    @property
    def shafts(self: Self) -> "List[_4535.ShaftCompoundParametricStudyTool]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4541.SpiralBevelGearSetCompoundParametricStudyTool]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_4542.SpringDamperCompoundParametricStudyTool]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_4547.StraightBevelDiffGearSetCompoundParametricStudyTool]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4550.StraightBevelGearSetCompoundParametricStudyTool]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_4553.SynchroniserCompoundParametricStudyTool]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_4557.TorqueConverterCompoundParametricStudyTool]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_4561.UnbalancedMassCompoundParametricStudyTool]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_4565.WormGearSetCompoundParametricStudyTool]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_4568.ZerolBevelGearSetCompoundParametricStudyTool]":
