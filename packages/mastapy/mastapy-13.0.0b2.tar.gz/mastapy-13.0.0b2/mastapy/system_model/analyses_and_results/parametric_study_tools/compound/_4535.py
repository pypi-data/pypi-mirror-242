...
class ShaftCompoundParametricStudyTool(_4441.AbstractShaftCompoundParametricStudyTool):
    """ShaftCompoundParametricStudyTool
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4407.ShaftParametricStudyTool]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4407.ShaftParametricStudyTool]":
        """List[mastapy.system_model.analyses_and_results.parametric_study_tools.ShaftParametricStudyTool]
