...
class ShaftCompoundDynamicAnalysis(_6406.AbstractShaftCompoundDynamicAnalysis):
    """ShaftCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6371.ShaftDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6371.ShaftDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ShaftDynamicAnalysis]
