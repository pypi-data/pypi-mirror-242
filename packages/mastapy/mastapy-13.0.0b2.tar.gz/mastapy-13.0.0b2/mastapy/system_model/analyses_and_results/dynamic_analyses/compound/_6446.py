...
class CVTCompoundDynamicAnalysis(_6415.BeltDriveCompoundDynamicAnalysis):
    """CVTCompoundDynamicAnalysis
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_6315.CVTDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6315.CVTDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.CVTDynamicAnalysis]
