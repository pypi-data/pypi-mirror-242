...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6399, _6400
...
class WormGearSetDynamicAnalysis(_6336.GearSetDynamicAnalysis):
    """WormGearSetDynamicAnalysis
    ...
    def worm_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6399.WormGearDynamicAnalysis]":
    ...
    def worm_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6400.WormGearMeshDynamicAnalysis]":
