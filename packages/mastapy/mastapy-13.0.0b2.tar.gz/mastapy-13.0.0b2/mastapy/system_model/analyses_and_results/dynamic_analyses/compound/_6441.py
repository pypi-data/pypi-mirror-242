...
class ConnectorCompoundDynamicAnalysis(_6482.MountableComponentCompoundDynamicAnalysis):
    """ConnectorCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6310.ConnectorDynamicAnalysis]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6310.ConnectorDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ConnectorDynamicAnalysis]
