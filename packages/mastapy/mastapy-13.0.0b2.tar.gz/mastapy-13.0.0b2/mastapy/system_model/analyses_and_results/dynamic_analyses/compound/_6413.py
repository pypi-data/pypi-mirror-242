...
class BearingCompoundDynamicAnalysis(_6441.ConnectorCompoundDynamicAnalysis):
    """BearingCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6282.BearingDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6282.BearingDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.BearingDynamicAnalysis]
