...
class CylindricalGearSetCompoundDynamicAnalysis(_6465.GearSetCompoundDynamicAnalysis):
    """CylindricalGearSetCompoundDynamicAnalysis
    ...
    def cylindrical_gears_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6452.CylindricalGearCompoundDynamicAnalysis]":
    ...
    def cylindrical_meshes_compound_dynamic_analysis(
        self: Self,
    ) -> "List[_6453.CylindricalGearMeshCompoundDynamicAnalysis]":
