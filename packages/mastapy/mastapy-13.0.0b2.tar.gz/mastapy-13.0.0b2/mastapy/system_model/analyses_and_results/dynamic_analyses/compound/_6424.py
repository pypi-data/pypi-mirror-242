...
class BoltCompoundDynamicAnalysis(_6430.ComponentCompoundDynamicAnalysis):
    """BoltCompoundDynamicAnalysis
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_6293.BoltDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6293.BoltDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.BoltDynamicAnalysis]
