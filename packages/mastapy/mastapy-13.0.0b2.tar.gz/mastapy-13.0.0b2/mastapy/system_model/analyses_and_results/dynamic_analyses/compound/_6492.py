...
class PowerLoadCompoundDynamicAnalysis(_6527.VirtualComponentCompoundDynamicAnalysis):
    """PowerLoadCompoundDynamicAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_6363.PowerLoadDynamicAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_6363.PowerLoadDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.PowerLoadDynamicAnalysis]
