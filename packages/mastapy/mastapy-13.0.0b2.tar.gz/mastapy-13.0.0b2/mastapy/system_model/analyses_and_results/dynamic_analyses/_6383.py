...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.dynamic_analyses import _6381, _6382
...
class StraightBevelDiffGearSetDynamicAnalysis(_6292.BevelGearSetDynamicAnalysis):
    """StraightBevelDiffGearSetDynamicAnalysis
    ...
    def straight_bevel_diff_gears_dynamic_analysis(
        self: Self,
    ) -> "List[_6381.StraightBevelDiffGearDynamicAnalysis]":
    ...
    def straight_bevel_diff_meshes_dynamic_analysis(
        self: Self,
    ) -> "List[_6382.StraightBevelDiffGearMeshDynamicAnalysis]":
