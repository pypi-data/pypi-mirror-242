...
class ClutchCompoundDynamicAnalysis(_6442.CouplingCompoundDynamicAnalysis):
    """ClutchCompoundDynamicAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_6296.ClutchDynamicAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_6296.ClutchDynamicAnalysis]":
        """List[mastapy.system_model.analyses_and_results.dynamic_analyses.ClutchDynamicAnalysis]
