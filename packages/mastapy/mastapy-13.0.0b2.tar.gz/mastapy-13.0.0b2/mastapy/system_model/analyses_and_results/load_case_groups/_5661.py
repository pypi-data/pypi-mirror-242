...
class DutyCycle(_5657.AbstractStaticLoadCaseGroup):
    """DutyCycle
    ...
    def duty_cycle_design_states(
        self: Self,
    ) -> "List[_5664.SubGroupInSingleDesignState]":
    ...
    @property
    def time_series_importer(self: Self) -> "_6999.TimeSeriesImporter":
    ...
    def add_static_load(self: Self, static_load: "_6802.StaticLoadCase"):
        """Method does not return.
    ...
    def remove_design_state_sub_group(
        self: Self, sub_group: "_5664.SubGroupInSingleDesignState"
    ):
        """Method does not return.
    ...
    @enforce_parameter_types
    def remove_static_load(self: Self, static_load: "_6802.StaticLoadCase"):
        """Method does not return.
