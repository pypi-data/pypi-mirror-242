...
if TYPE_CHECKING:
    from mastapy.system_model.analyses_and_results.static_loads import _6803, _6815
    from mastapy.system_model.analyses_and_results import _2673, _2617
...
class TimeSeriesLoadCaseGroup(_5656.AbstractLoadCaseGroup):
    """TimeSeriesLoadCaseGroup
    ...
    @property
    def load_cases(self: Self) -> "List[_6803.TimeSeriesLoadCase]":
