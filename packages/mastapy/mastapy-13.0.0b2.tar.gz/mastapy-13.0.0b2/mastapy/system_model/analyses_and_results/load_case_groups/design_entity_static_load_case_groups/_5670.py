...
TReal = TypeVar("TReal", bound="_2442.Component")
TComponentStaticLoad = TypeVar("TComponentStaticLoad", bound="_6835.ComponentLoadCase")


class ComponentStaticLoadCaseGroup(
    _5674.PartStaticLoadCaseGroup, Generic[TReal, TComponentStaticLoad]
):
    """ComponentStaticLoadCaseGroup
