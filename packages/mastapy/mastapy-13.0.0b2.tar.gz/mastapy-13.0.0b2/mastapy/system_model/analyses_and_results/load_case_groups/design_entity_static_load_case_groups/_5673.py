...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears import _2530, _2528
...
TGearSet = TypeVar("TGearSet", bound="_2530.GearSet")
TGear = TypeVar("TGear", bound="_2528.Gear")
TGearStaticLoad = TypeVar("TGearStaticLoad", bound="_6888.GearLoadCase")
TGearMesh = TypeVar("TGearMesh", bound="_2311.GearMesh")
TGearMeshStaticLoad = TypeVar("TGearMeshStaticLoad", bound="_6890.GearMeshLoadCase")
TGearSetStaticLoad = TypeVar("TGearSetStaticLoad", bound="_6893.GearSetLoadCase")
...
class GearSetStaticLoadCaseGroup(
    ...
    class _Cast_GearSetStaticLoadCaseGroup:
        ...
        def part_static_load_case_group(
            ...
            return self._parent._cast(_5674.PartStaticLoadCaseGroup)
        ...
        def design_entity_static_load_case_group(
            ...
            return self._parent._cast(_5672.DesignEntityStaticLoadCaseGroup)
    ...
    def gears_load_cases(
        self: Self,
    ) -> "List[_5670.ComponentStaticLoadCaseGroup[TGear, TGearStaticLoad]]":
    ...
    def meshes_load_cases(
        self: Self,
    ) -> "List[_5671.ConnectionStaticLoadCaseGroup[TGearMesh, TGearMeshStaticLoad]]":
