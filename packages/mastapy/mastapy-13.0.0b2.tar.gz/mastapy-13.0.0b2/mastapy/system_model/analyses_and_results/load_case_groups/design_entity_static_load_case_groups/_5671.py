...
TConnection = TypeVar("TConnection", bound="_2270.Connection")
TConnectionStaticLoad = TypeVar(
    "TConnectionStaticLoad", bound="_6847.ConnectionLoadCase"
)


class ConnectionStaticLoadCaseGroup(
    _5672.DesignEntityStaticLoadCaseGroup, Generic[TConnection, TConnectionStaticLoad]
):
    """ConnectionStaticLoadCaseGroup
