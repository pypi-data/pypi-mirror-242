...
class FaceGearCompoundStabilityAnalysis(_3953.GearCompoundStabilityAnalysis):
    """FaceGearCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3818.FaceGearStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3818.FaceGearStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.FaceGearStabilityAnalysis]
