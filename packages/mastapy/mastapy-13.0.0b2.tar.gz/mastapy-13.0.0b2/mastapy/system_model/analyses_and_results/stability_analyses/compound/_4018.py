...
class WormGearCompoundStabilityAnalysis(_3953.GearCompoundStabilityAnalysis):
    """WormGearCompoundStabilityAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_3891.WormGearStabilityAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_3891.WormGearStabilityAnalysis]":
        """List[mastapy.system_model.analyses_and_results.stability_analyses.WormGearStabilityAnalysis]
