...
class ConceptGearSetCompoundModalAnalysis(_4785.GearSetCompoundModalAnalysis):
    """ConceptGearSetCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4600.ConceptGearSetModalAnalysis]":
    ...
    def concept_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4754.ConceptGearCompoundModalAnalysis]":
    ...
    def concept_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4755.ConceptGearMeshCompoundModalAnalysis]":
