...
class RootAssemblyCompoundModalAnalysis(_4732.AssemblyCompoundModalAnalysis):
    """RootAssemblyCompoundModalAnalysis
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4674.RootAssemblyModalAnalysis]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4674.RootAssemblyModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.RootAssemblyModalAnalysis]
