...
class RollingRingCompoundModalAnalysis(_4764.CouplingHalfCompoundModalAnalysis):
    """RollingRingCompoundModalAnalysis
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4673.RollingRingModalAnalysis]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4673.RollingRingModalAnalysis]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses.RollingRingModalAnalysis]
