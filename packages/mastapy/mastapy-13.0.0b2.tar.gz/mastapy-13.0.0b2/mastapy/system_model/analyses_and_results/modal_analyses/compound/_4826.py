...
class SpiralBevelGearSetCompoundModalAnalysis(_4743.BevelGearSetCompoundModalAnalysis):
    """SpiralBevelGearSetCompoundModalAnalysis
    ...
    def spiral_bevel_gears_compound_modal_analysis(
        self: Self,
    ) -> "List[_4824.SpiralBevelGearCompoundModalAnalysis]":
    ...
    def spiral_bevel_meshes_compound_modal_analysis(
        self: Self,
    ) -> "List[_4825.SpiralBevelGearMeshCompoundModalAnalysis]":
