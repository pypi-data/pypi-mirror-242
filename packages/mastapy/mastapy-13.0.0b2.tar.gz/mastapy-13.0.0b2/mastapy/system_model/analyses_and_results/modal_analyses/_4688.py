...
class StraightBevelDiffGearSetModalAnalysis(_4587.BevelGearSetModalAnalysis):
    """StraightBevelDiffGearSetModalAnalysis
    ...
    def straight_bevel_diff_gears_modal_analysis(
        self: Self,
    ) -> "List[_4687.StraightBevelDiffGearModalAnalysis]":
    ...
    def straight_bevel_diff_meshes_modal_analysis(
        self: Self,
    ) -> "List[_4686.StraightBevelDiffGearMeshModalAnalysis]":
