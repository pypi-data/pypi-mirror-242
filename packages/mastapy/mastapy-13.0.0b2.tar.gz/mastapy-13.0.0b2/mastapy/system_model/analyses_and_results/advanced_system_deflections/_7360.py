...
class PowerLoadAdvancedSystemDeflection(_7396.VirtualComponentAdvancedSystemDeflection):
    """PowerLoadAdvancedSystemDeflection
    ...
    def component_system_deflection_results(
        self: Self,
    ) -> "List[_2790.PowerLoadSystemDeflection]":
    ...
    def transmission_error_to_other_power_loads(
        self: Self,
    ) -> "List[_7394.TransmissionErrorToOtherPowerLoad]":
