...
class AdvancedSystemDeflectionOptions(_0.APIBase):
    ...
    @enforce_parameter_types
    def specified_gear_set(self: Self, value: "_2530.GearSet"):
        wrapper_type = (
    ...
    @property
    def use_advanced_ltca(self: Self) -> "_848.UseAdvancedLTCAOptions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.gears.ltca._848", "UseAdvancedLTCAOptions"
        )(value)

    @use_advanced_ltca.setter
    @enforce_parameter_types
    def use_advanced_ltca(self: Self, value: "_848.UseAdvancedLTCAOptions"):
