...
class ConceptGearSetAdvancedSystemDeflection(_7332.GearSetAdvancedSystemDeflection):
    """ConceptGearSetAdvancedSystemDeflection
    ...
    def assembly_system_deflection_results(
        self: Self,
    ) -> "List[_2719.ConceptGearSetSystemDeflection]":
    ...
    def concept_gears_advanced_system_deflection(
        self: Self,
    ) -> "List[_7299.ConceptGearAdvancedSystemDeflection]":
    ...
    def concept_meshes_advanced_system_deflection(
        self: Self,
    ) -> "List[_7300.ConceptGearMeshAdvancedSystemDeflection]":
