...
class CylindricalGearAdvancedSystemDeflection(_7330.GearAdvancedSystemDeflection):
    """CylindricalGearAdvancedSystemDeflection
    ...
    def cylindrical_gear_advanced_system_deflection_meshes(
        self: Self,
    ) -> "List[_7319.CylindricalGearMeshAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_advanced_system_deflections_in_meshes(
        self: Self,
    ) -> "List[_7321.CylindricalMeshedGearAdvancedSystemDeflection]":
