...
class AssemblyCompoundAdvancedSystemDeflection(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_7277.AssemblyAdvancedSystemDeflection]":
    ...
    @property
    def bearings(self: Self) -> "List[_7411.BearingCompoundAdvancedSystemDeflection]":
    ...
    def belt_drives(
        self: Self,
    ) -> "List[_7413.BeltDriveCompoundAdvancedSystemDeflection]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_7416.BevelDifferentialGearSetCompoundAdvancedSystemDeflection]":
    ...
    def bolted_joints(
        self: Self,
    ) -> "List[_7423.BoltedJointCompoundAdvancedSystemDeflection]":
    ...
    @property
    def bolts(self: Self) -> "List[_7422.BoltCompoundAdvancedSystemDeflection]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_7444.CVTCompoundAdvancedSystemDeflection]":
    ...
    @property
    def clutches(self: Self) -> "List[_7424.ClutchCompoundAdvancedSystemDeflection]":
    ...
    def concept_couplings(
        self: Self,
    ) -> "List[_7429.ConceptCouplingCompoundAdvancedSystemDeflection]":
    ...
    def concept_gear_sets(
        self: Self,
    ) -> "List[_7434.ConceptGearSetCompoundAdvancedSystemDeflection]":
    ...
    def cycloidal_assemblies(
        self: Self,
    ) -> "List[_7446.CycloidalAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def cycloidal_discs(
        self: Self,
    ) -> "List[_7448.CycloidalDiscCompoundAdvancedSystemDeflection]":
    ...
    def cylindrical_gear_sets(
        self: Self,
    ) -> "List[_7452.CylindricalGearSetCompoundAdvancedSystemDeflection]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_7459.FEPartCompoundAdvancedSystemDeflection]":
    ...
    def face_gear_sets(
        self: Self,
    ) -> "List[_7458.FaceGearSetCompoundAdvancedSystemDeflection]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_7460.FlexiblePinAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def hypoid_gear_sets(
        self: Self,
    ) -> "List[_7467.HypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_7474.KlingelnbergCycloPalloidHypoidGearSetCompoundAdvancedSystemDeflection]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7477.KlingelnbergCycloPalloidSpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def mass_discs(
        self: Self,
    ) -> "List[_7478.MassDiscCompoundAdvancedSystemDeflection]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_7479.MeasurementComponentCompoundAdvancedSystemDeflection]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_7481.OilSealCompoundAdvancedSystemDeflection]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_7483.PartToPartShearCouplingCompoundAdvancedSystemDeflection]":
    ...
    def planet_carriers(
        self: Self,
    ) -> "List[_7488.PlanetCarrierCompoundAdvancedSystemDeflection]":
    ...
    def point_loads(
        self: Self,
    ) -> "List[_7489.PointLoadCompoundAdvancedSystemDeflection]":
    ...
    def power_loads(
        self: Self,
    ) -> "List[_7490.PowerLoadCompoundAdvancedSystemDeflection]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_7492.RingPinsCompoundAdvancedSystemDeflection]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_7494.RollingRingAssemblyCompoundAdvancedSystemDeflection]":
    ...
    def shaft_hub_connections(
        self: Self,
    ) -> "List[_7499.ShaftHubConnectionCompoundAdvancedSystemDeflection]":
    ...
    @property
    def shafts(self: Self) -> "List[_7498.ShaftCompoundAdvancedSystemDeflection]":
    ...
    def spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_7504.SpiralBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def spring_dampers(
        self: Self,
    ) -> "List[_7505.SpringDamperCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_diff_gear_sets(
        self: Self,
    ) -> "List[_7510.StraightBevelDiffGearSetCompoundAdvancedSystemDeflection]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_7513.StraightBevelGearSetCompoundAdvancedSystemDeflection]":
    ...
    def synchronisers(
        self: Self,
    ) -> "List[_7516.SynchroniserCompoundAdvancedSystemDeflection]":
    ...
    def torque_converters(
        self: Self,
    ) -> "List[_7520.TorqueConverterCompoundAdvancedSystemDeflection]":
    ...
    def unbalanced_masses(
        self: Self,
    ) -> "List[_7524.UnbalancedMassCompoundAdvancedSystemDeflection]":
    ...
    def worm_gear_sets(
        self: Self,
    ) -> "List[_7528.WormGearSetCompoundAdvancedSystemDeflection]":
    ...
    def zerol_bevel_gear_sets(
        self: Self,
    ) -> "List[_7531.ZerolBevelGearSetCompoundAdvancedSystemDeflection]":
