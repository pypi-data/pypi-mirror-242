...
class PlanetCarrierCompoundPowerFlow(_4241.MountableComponentCompoundPowerFlow):
    """PlanetCarrierCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4117.PlanetCarrierPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4117.PlanetCarrierPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.PlanetCarrierPowerFlow]
