...
class RollingRingCompoundPowerFlow(_4203.CouplingHalfCompoundPowerFlow):
    """RollingRingCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4127.RollingRingPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4127.RollingRingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.RollingRingPowerFlow]
