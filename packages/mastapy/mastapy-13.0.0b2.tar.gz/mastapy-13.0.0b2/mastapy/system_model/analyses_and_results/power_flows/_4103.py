...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.analyses_and_results.power_flows import _4102, _4101
...
class KlingelnbergCycloPalloidHypoidGearSetPowerFlow(
    ...
    def gears_power_flow(
        self: Self,
    ) -> "List[_4102.KlingelnbergCycloPalloidHypoidGearPowerFlow]":
    ...
    def meshes_power_flow(
        self: Self,
    ) -> "List[_4101.KlingelnbergCycloPalloidHypoidGearMeshPowerFlow]":
