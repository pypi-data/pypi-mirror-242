...
class ConceptCouplingCompoundPowerFlow(_4201.CouplingCompoundPowerFlow):
    """ConceptCouplingCompoundPowerFlow
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_4058.ConceptCouplingPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4058.ConceptCouplingPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConceptCouplingPowerFlow]
