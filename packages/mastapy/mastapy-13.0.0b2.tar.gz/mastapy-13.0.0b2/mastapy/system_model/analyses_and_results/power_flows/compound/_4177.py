...
class BevelDifferentialGearSetCompoundPowerFlow(_4182.BevelGearSetCompoundPowerFlow):
    """BevelDifferentialGearSetCompoundPowerFlow
    ...
    def bevel_differential_gears_compound_power_flow(
        self: Self,
    ) -> "List[_4175.BevelDifferentialGearCompoundPowerFlow]":
    ...
    def bevel_differential_meshes_compound_power_flow(
        self: Self,
    ) -> "List[_4176.BevelDifferentialGearMeshCompoundPowerFlow]":
