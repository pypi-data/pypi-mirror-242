...
class BoltedJointCompoundPowerFlow(_4262.SpecialisedAssemblyCompoundPowerFlow):
    """BoltedJointCompoundPowerFlow
    ...
    @property
    def component_design(self: Self) -> "_2441.BoltedJoint":
    ...
    @property
    def assembly_analysis_cases_ready(self: Self) -> "List[_4049.BoltedJointPowerFlow]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_4049.BoltedJointPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.BoltedJointPowerFlow]
