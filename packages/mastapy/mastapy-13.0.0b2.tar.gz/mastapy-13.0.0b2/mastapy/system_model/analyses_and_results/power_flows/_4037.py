...
class AssemblyPowerFlow(_4030.AbstractAssemblyPowerFlow):
    """AssemblyPowerFlow
    ...
    @property
    def bearings(self: Self) -> "List[_4038.BearingPowerFlow]":
    ...
    @property
    def belt_drives(self: Self) -> "List[_4040.BeltDrivePowerFlow]":
    ...
    def bevel_differential_gear_sets(
        self: Self,
    ) -> "List[_4043.BevelDifferentialGearSetPowerFlow]":
    ...
    @property
    def bolted_joints(self: Self) -> "List[_4049.BoltedJointPowerFlow]":
    ...
    @property
    def bolts(self: Self) -> "List[_4050.BoltPowerFlow]":
    ...
    @property
    def cv_ts(self: Self) -> "List[_4071.CVTPowerFlow]":
    ...
    @property
    def clutches(self: Self) -> "List[_4053.ClutchPowerFlow]":
    ...
    @property
    def concept_couplings(self: Self) -> "List[_4058.ConceptCouplingPowerFlow]":
    ...
    @property
    def concept_gear_sets(self: Self) -> "List[_4061.ConceptGearSetPowerFlow]":
    ...
    @property
    def cycloidal_assemblies(self: Self) -> "List[_4073.CycloidalAssemblyPowerFlow]":
    ...
    @property
    def cycloidal_discs(self: Self) -> "List[_4076.CycloidalDiscPowerFlow]":
    ...
    @property
    def cylindrical_gear_sets(self: Self) -> "List[_4080.CylindricalGearSetPowerFlow]":
    ...
    @property
    def fe_parts(self: Self) -> "List[_4088.FEPartPowerFlow]":
    ...
    @property
    def face_gear_sets(self: Self) -> "List[_4086.FaceGearSetPowerFlow]":
    ...
    def flexible_pin_assemblies(
        self: Self,
    ) -> "List[_4089.FlexiblePinAssemblyPowerFlow]":
    ...
    @property
    def hypoid_gear_sets(self: Self) -> "List[_4096.HypoidGearSetPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_hypoid_gear_sets(
        self: Self,
    ) -> "List[_4103.KlingelnbergCycloPalloidHypoidGearSetPowerFlow]":
    ...
    def klingelnberg_cyclo_palloid_spiral_bevel_gear_sets(
        self: Self,
    ) -> "List[_4106.KlingelnbergCycloPalloidSpiralBevelGearSetPowerFlow]":
    ...
    @property
    def loaded_gear_sets(self: Self) -> "List[_4092.GearSetPowerFlow]":
    ...
    @property
    def mass_discs(self: Self) -> "List[_4107.MassDiscPowerFlow]":
    ...
    def measurement_components(
        self: Self,
    ) -> "List[_4108.MeasurementComponentPowerFlow]":
    ...
    @property
    def oil_seals(self: Self) -> "List[_4110.OilSealPowerFlow]":
    ...
    def part_to_part_shear_couplings(
        self: Self,
    ) -> "List[_4114.PartToPartShearCouplingPowerFlow]":
    ...
    @property
    def planet_carriers(self: Self) -> "List[_4117.PlanetCarrierPowerFlow]":
    ...
    @property
    def point_loads(self: Self) -> "List[_4118.PointLoadPowerFlow]":
    ...
    @property
    def power_loads(self: Self) -> "List[_4121.PowerLoadPowerFlow]":
    ...
    @property
    def ring_pins(self: Self) -> "List[_4123.RingPinsPowerFlow]":
    ...
    def rolling_ring_assemblies(
        self: Self,
    ) -> "List[_4125.RollingRingAssemblyPowerFlow]":
    ...
    @property
    def shaft_hub_connections(self: Self) -> "List[_4129.ShaftHubConnectionPowerFlow]":
    ...
    @property
    def shafts(self: Self) -> "List[_4130.ShaftPowerFlow]":
    ...
    @property
    def spiral_bevel_gear_sets(self: Self) -> "List[_4135.SpiralBevelGearSetPowerFlow]":
    ...
    @property
    def spring_dampers(self: Self) -> "List[_4138.SpringDamperPowerFlow]":
    ...
    def straight_bevel_gear_sets(
        self: Self,
    ) -> "List[_4144.StraightBevelGearSetPowerFlow]":
    ...
    @property
    def synchronisers(self: Self) -> "List[_4149.SynchroniserPowerFlow]":
    ...
    @property
    def torque_converters(self: Self) -> "List[_4153.TorqueConverterPowerFlow]":
    ...
    @property
    def unbalanced_masses(self: Self) -> "List[_4156.UnbalancedMassPowerFlow]":
    ...
    @property
    def worm_gear_sets(self: Self) -> "List[_4160.WormGearSetPowerFlow]":
    ...
    @property
    def zerol_bevel_gear_sets(self: Self) -> "List[_4163.ZerolBevelGearSetPowerFlow]":
