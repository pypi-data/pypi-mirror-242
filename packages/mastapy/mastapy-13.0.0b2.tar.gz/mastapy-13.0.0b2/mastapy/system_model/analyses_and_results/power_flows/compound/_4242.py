...
class OilSealCompoundPowerFlow(_4200.ConnectorCompoundPowerFlow):
    """OilSealCompoundPowerFlow
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4110.OilSealPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4110.OilSealPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.OilSealPowerFlow]
