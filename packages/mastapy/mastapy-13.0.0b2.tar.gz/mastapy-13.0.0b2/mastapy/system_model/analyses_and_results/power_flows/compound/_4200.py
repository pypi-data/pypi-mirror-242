...
class ConnectorCompoundPowerFlow(_4241.MountableComponentCompoundPowerFlow):
    """ConnectorCompoundPowerFlow
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4066.ConnectorPowerFlow]":
    ...
    @property
    def component_analysis_cases_ready(self: Self) -> "List[_4066.ConnectorPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.ConnectorPowerFlow]
