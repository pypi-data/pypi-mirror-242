...
class SpringDamperHalfCompoundPowerFlow(_4203.CouplingHalfCompoundPowerFlow):
    """SpringDamperHalfCompoundPowerFlow
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_4137.SpringDamperHalfPowerFlow]":
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_4137.SpringDamperHalfPowerFlow]":
        """List[mastapy.system_model.analyses_and_results.power_flows.SpringDamperHalfPowerFlow]
