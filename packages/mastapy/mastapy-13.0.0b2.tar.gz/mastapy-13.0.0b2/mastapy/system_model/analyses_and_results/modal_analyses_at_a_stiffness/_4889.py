...
class ConnectionModalAnalysisAtAStiffness(_7538.ConnectionStaticLoadAnalysisCase):
    """ConnectionModalAnalysisAtAStiffness
    ...
    @property
    def modal_analysis_at_a_stiffness(self: Self) -> "_4932.ModalAnalysisAtAStiffness":
