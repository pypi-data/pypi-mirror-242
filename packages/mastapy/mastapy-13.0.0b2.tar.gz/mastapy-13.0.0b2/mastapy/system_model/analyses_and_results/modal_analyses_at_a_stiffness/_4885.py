...
class ConceptGearSetModalAnalysisAtAStiffness(_4915.GearSetModalAnalysisAtAStiffness):
    """ConceptGearSetModalAnalysisAtAStiffness
    ...
    def concept_gears_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4884.ConceptGearModalAnalysisAtAStiffness]":
    ...
    def concept_meshes_modal_analysis_at_a_stiffness(
        self: Self,
    ) -> "List[_4883.ConceptGearMeshModalAnalysisAtAStiffness]":
