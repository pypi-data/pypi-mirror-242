...
class CylindricalGearSetCompoundSteadyStateSynchronousResponseOnAShaft(
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_3291.CylindricalGearSetSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cylindrical_gears_compound_steady_state_synchronous_response_on_a_shaft(
        self: Self,
    ) -> "List[_3420.CylindricalGearCompoundSteadyStateSynchronousResponseOnAShaft]":
    ...
    def cylindrical_meshes_compound_steady_state_synchronous_response_on_a_shaft(
        ...
        "List[_3421.CylindricalGearMeshCompoundSteadyStateSynchronousResponseOnAShaft]"
    ):
