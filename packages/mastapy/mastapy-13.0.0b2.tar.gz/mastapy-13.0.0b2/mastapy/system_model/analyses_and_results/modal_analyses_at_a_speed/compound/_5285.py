...
class CVTCompoundModalAnalysisAtASpeed(_5254.BeltDriveCompoundModalAnalysisAtASpeed):
    """CVTCompoundModalAnalysisAtASpeed
    ...
    def assembly_analysis_cases_ready(
        self: Self,
    ) -> "List[_5155.CVTModalAnalysisAtASpeed]":
    ...
    @property
    def assembly_analysis_cases(self: Self) -> "List[_5155.CVTModalAnalysisAtASpeed]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.CVTModalAnalysisAtASpeed]
