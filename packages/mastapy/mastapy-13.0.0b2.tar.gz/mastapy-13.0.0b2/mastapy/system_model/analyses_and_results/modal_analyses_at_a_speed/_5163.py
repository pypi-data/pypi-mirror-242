...
class CylindricalGearSetModalAnalysisAtASpeed(_5174.GearSetModalAnalysisAtASpeed):
    """CylindricalGearSetModalAnalysisAtASpeed
    ...
    def cylindrical_gears_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5162.CylindricalGearModalAnalysisAtASpeed]":
    ...
    def cylindrical_meshes_modal_analysis_at_a_speed(
        self: Self,
    ) -> "List[_5161.CylindricalGearMeshModalAnalysisAtASpeed]":
