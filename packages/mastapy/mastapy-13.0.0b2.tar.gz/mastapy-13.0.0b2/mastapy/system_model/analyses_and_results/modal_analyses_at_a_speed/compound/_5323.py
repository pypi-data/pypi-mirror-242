...
class PartCompoundModalAnalysisAtASpeed(_7543.PartCompoundAnalysis):
    """PartCompoundModalAnalysisAtASpeed
    ...
    @property
    def component_analysis_cases(self: Self) -> "List[_5194.PartModalAnalysisAtASpeed]":
    ...
    def component_analysis_cases_ready(
        self: Self,
    ) -> "List[_5194.PartModalAnalysisAtASpeed]":
        """List[mastapy.system_model.analyses_and_results.modal_analyses_at_a_speed.PartModalAnalysisAtASpeed]
