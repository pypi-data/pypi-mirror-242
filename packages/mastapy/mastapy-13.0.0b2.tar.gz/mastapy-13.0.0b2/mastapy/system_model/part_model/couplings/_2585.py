...
from mastapy.system_model.part_model.couplings import _2596, _2588
...
class CVTPulley(_2588.Pulley):
    ...
    @enforce_parameter_types
    def sliding_connection(self: Self, value: "_2596.ShaftHubConnection"):
        wrapper_type = (
