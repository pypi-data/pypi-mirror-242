...
class Coupling(_2474.SpecialisedAssembly):
    """Coupling
    ...
    @property
    def halves(self: Self) -> "List[_2582.CouplingHalf]":
    ...
    @property
    def half_a(self: Self) -> "_2582.CouplingHalf":
    ...
    @property
    def half_b(self: Self) -> "_2582.CouplingHalf":
        """mastapy.system_model.part_model.couplings.CouplingHalf
