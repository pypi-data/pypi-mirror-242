...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.couplings import _2575, _2588
...
class BeltDrive(_2474.SpecialisedAssembly):
    """BeltDrive
    ...
    @property
    def type_of_belt(self: Self) -> "_2575.BeltDriveType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.system_model.part_model.couplings._2575", "BeltDriveType"
        )(value)

    @type_of_belt.setter
    @enforce_parameter_types
    def type_of_belt(self: Self, value: "_2575.BeltDriveType"):
    ...
    @property
    def belt_connections(self: Self) -> "List[_2266.BeltConnection]":
    ...
    @property
    def pulleys(self: Self) -> "List[_2588.Pulley]":
