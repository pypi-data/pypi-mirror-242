...
if TYPE_CHECKING:
    from mastapy.system_model.part_model import _2447, _2479
...
class PowerLoad(_2477.VirtualComponent):
    """PowerLoad
    ...
    @enforce_parameter_types
    def electric_machine_detail_selector(
        self: Self, value: "_1259.ElectricMachineDetail"
    ):
        wrapper_type = (
    ...
    @enforce_parameter_types
    def electric_machine_search_region_specification_method(
        self: Self, value: "_2447.ElectricMachineSearchRegionSpecificationMethod"
    ):
    ...
    @property
    def engine_fuel_consumption_grid(self: Self) -> "_1563.GriddedSurfaceAccessor":
    ...
    @enforce_parameter_types
    def engine_fuel_consumption_grid(self: Self, value: "_1563.GriddedSurfaceAccessor"):
        self.wrapped.EngineFuelConsumptionGrid = value.wrapped

    @property
    def engine_torque_grid(self: Self) -> "_1563.GriddedSurfaceAccessor":
        """mastapy.math_utility.measured_data.GriddedSurfaceAccessor"""
    ...
    @enforce_parameter_types
    def engine_torque_grid(self: Self, value: "_1563.GriddedSurfaceAccessor"):
    ...
    @enforce_parameter_types
    def power_load_type(self: Self, value: "_2217.PowerLoadType"):
    ...
    @property
    def electric_machine_detail(self: Self) -> "_1259.ElectricMachineDetail":
    ...
    @property
    def oil_pump_detail(self: Self) -> "_296.OilPumpDetail":
    ...
    @property
    def single_blade_details(self: Self) -> "_2479.WindTurbineSingleBladeDetails":
