...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.import_export import _2240
...
class Part(_2201.DesignEntity):
    ...
    @property
    def mass_properties_from_design(self: Self) -> "_1515.MassProperties":
    ...
    @property
    def local_connections(self: Self) -> "List[_2270.Connection]":
        """List[mastapy.system_model.connections_and_sockets.Connection]
    ...
    @enforce_parameter_types
    def connections_to(self: Self, part: "Part") -> "List[_2270.Connection]":
        """List[mastapy.system_model.connections_and_sockets.Connection]
    ...
    @enforce_parameter_types
    def copy_to(self: Self, container: "_2431.Assembly") -> "Part":
    ...
    def create_geometry_export_options(self: Self) -> "_2240.GeometryExportOptions":
