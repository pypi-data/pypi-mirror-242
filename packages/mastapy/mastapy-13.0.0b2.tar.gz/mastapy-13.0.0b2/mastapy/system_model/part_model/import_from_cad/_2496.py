...
from mastapy.system_model.part_model.gears import _2524, _2523
...
class CylindricalGearFromCAD(_2502.MountableComponentFromCAD):
    """CylindricalGearFromCAD
    ...
    @enforce_parameter_types
    def existing_gear_set(self: Self, value: "_2524.CylindricalGearSet"):
        wrapper_type = (
    ...
    @meshing_gear.setter
    @enforce_parameter_types
    def meshing_gear(self: Self, value: "_2523.CylindricalGear"):
        wrapper_type = (
