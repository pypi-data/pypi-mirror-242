...
if TYPE_CHECKING:
    from mastapy.system_model.part_model.gears import _2523, _2525
...
class PlanetaryGearSet(_2524.CylindricalGearSet):
    """PlanetaryGearSet
    ...
    @property
    def annuluses(self: Self) -> "List[_2523.CylindricalGear]":
    ...
    @property
    def planets(self: Self) -> "List[_2525.CylindricalPlanetGear]":
    ...
    @property
    def suns(self: Self) -> "List[_2523.CylindricalGear]":
        """List[mastapy.system_model.part_model.gears.CylindricalGear]
    ...
    def add_annulus(self: Self) -> "_2523.CylindricalGear":
    ...
    def add_planet(self: Self) -> "_2523.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
    ...
    def add_sun(self: Self) -> "_2523.CylindricalGear":
        """mastapy.system_model.part_model.gears.CylindricalGear"""
