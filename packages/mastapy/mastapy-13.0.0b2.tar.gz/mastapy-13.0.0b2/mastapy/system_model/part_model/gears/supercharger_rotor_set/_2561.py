...
class SuperchargerRotorSet(_1827.NamedDatabaseItem):
    """SuperchargerRotorSet
    ...
    @property
    def supercharger_map_chart(self: Self) -> "_1863.ThreeDChartDefinition":
    ...
    @property
    def y_variable_for_imported_data(self: Self) -> "_2563.YVariableForImportedData":
    ...
    def y_variable_for_imported_data(
        self: Self, value: "_2563.YVariableForImportedData"
    ):
    ...
    @property
    def boost_pressure(self: Self) -> "_2553.BoostPressureInputOptions":
    ...
    @property
    def file(self: Self) -> "_2556.RotorSetDataInputFileOptions":
    ...
    @property
    def input_power(self: Self) -> "_2554.InputPowerInputOptions":
    ...
    @property
    def pressure_ratio(self: Self) -> "_2555.PressureRatioInputOptions":
    ...
    @property
    def rotor_speed(self: Self) -> "_2558.RotorSpeedInputOptions":
    ...
    @property
    def measured_points(self: Self) -> "List[_2557.RotorSetMeasuredPoint]":
