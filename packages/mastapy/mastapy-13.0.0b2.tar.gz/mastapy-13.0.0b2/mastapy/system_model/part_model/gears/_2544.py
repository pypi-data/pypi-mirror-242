...
class StraightBevelDiffGearSet(_2518.BevelGearSet):
    """StraightBevelDiffGearSet
    ...
    @property
    def straight_bevel_diff_gears(self: Self) -> "List[_2543.StraightBevelDiffGear]":
    ...
    def straight_bevel_diff_meshes(
        self: Self,
    ) -> "List[_2323.StraightBevelDiffGearMesh]":
