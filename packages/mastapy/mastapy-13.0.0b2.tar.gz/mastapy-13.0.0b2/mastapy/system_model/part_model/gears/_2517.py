...
class BevelGear(_2511.AGMAGleasonConicalGear):
    """BevelGear
    ...
    @property
    def conical_gear_design(self: Self) -> "_1178.BevelGearDesign":
    ...
    @property
    def bevel_gear_design(self: Self) -> "_1178.BevelGearDesign":
        """mastapy.gears.gear_designs.bevel.BevelGearDesign
