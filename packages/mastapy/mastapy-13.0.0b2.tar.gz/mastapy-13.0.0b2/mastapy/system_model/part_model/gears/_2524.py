...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.gears.supercharger_rotor_set import _2561
...
class CylindricalGearSet(_2530.GearSet):
    """CylindricalGearSet
    ...
    def axial_contact_ratio_requirement(
        self: Self,
        value: "Union[_320.ContactRatioRequirements, Tuple[_320.ContactRatioRequirements, bool]]",
    ):
    ...
    @property
    def active_gear_set_design(self: Self) -> "_1026.CylindricalGearSetDesign":
    ...
    @property
    def cylindrical_gear_set_design(self: Self) -> "_1026.CylindricalGearSetDesign":
        """mastapy.gears.gear_designs.cylindrical.CylindricalGearSetDesign
    ...
    @property
    def supercharger_rotor_set(self: Self) -> "_2561.SuperchargerRotorSet":
    ...
    @property
    def cylindrical_gears(self: Self) -> "List[_2523.CylindricalGear]":
    ...
    @property
    def gear_set_designs(self: Self) -> "List[_1026.CylindricalGearSetDesign]":
    ...
    def add_gear(self: Self) -> "_2523.CylindricalGear":
