...
class ZerolBevelGearSet(_2518.BevelGearSet):
    """ZerolBevelGearSet
    ...
    @property
    def conical_gear_set_design(self: Self) -> "_952.ZerolBevelGearSetDesign":
    ...
    @property
    def zerol_bevel_gear_set_design(self: Self) -> "_952.ZerolBevelGearSetDesign":
        """mastapy.gears.gear_designs.zerol_bevel.ZerolBevelGearSetDesign
    ...
    @property
    def zerol_bevel_gears(self: Self) -> "List[_2551.ZerolBevelGear]":
    ...
    @property
    def zerol_bevel_meshes(self: Self) -> "List[_2329.ZerolBevelGearMesh]":
