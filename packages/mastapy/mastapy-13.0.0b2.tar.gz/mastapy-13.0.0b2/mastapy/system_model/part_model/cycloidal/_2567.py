...
class CycloidalDisc(_2433.AbstractShaft):
    """CycloidalDisc
    ...
    @property
    def cycloidal_disc_design(self: Self) -> "_1451.CycloidalDiscDesign":
    ...
    @property
    def disc_material(self: Self) -> "_267.Material":
    ...
    @property
    def load_sharing_settings(self: Self) -> "_2459.LoadSharingSettings":
    ...
    def planetary_bearing_sockets(
        self: Self,
    ) -> "List[_2337.CycloidalDiscPlanetaryBearingSocket]":
