...
if TYPE_CHECKING:
    from mastapy.cycloidal import _1450
    from mastapy.system_model.part_model.cycloidal import _2568, _2567
...
class CycloidalAssembly(_2474.SpecialisedAssembly):
    """CycloidalAssembly
    ...
    @property
    def cycloidal_assembly_design(self: Self) -> "_1450.CycloidalAssemblyDesign":
    ...
    @property
    def ring_pins(self: Self) -> "_2568.RingPins":
    ...
    @property
    def known_designs(self: Self) -> "List[_1450.CycloidalAssemblyDesign]":
    ...
    def add_disc(self: Self) -> "_2567.CycloidalDisc":
    ...
    def design_named(self: Self, name: "str") -> "_1450.CycloidalAssemblyDesign":
        """mastapy.cycloidal.CycloidalAssemblyDesign
    ...
    def set_active_cycloidal_assembly_design(
        self: Self, cycloidal_assembly_design: "_1450.CycloidalAssemblyDesign"
    ):
        """Method does not return.
    ...
    def try_remove_design(
        self: Self, design: "_1450.CycloidalAssemblyDesign"
    ) -> "bool":
        """bool
