...
from mastapy.system_model.part_model import _2453, _2433
...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model import _2454, _2462
...
class Shaft(_2433.AbstractShaft):
    """Shaft
    ...
    @cad_model.setter
    @enforce_parameter_types
    def cad_model(self: Self, value: "_2453.GuideDxfModel"):
        wrapper_type = (
    ...
    @property
    def guide_image(self: Self) -> "_2454.GuideImage":
    ...
    @property
    def fe_substructure_replacing_this(self: Self) -> "_2381.FESubstructure":
    ...
    @enforce_parameter_types
    def mount_component(
        self: Self, component: "_2462.MountableComponent", offset: "float"
    ):
        """Method does not return.
