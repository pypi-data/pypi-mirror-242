...
if TYPE_CHECKING:
    ...
    from mastapy.system_model.part_model.projections import _2483
...
class RootAssembly(_2431.Assembly):
    """RootAssembly
    ...
    @property
    def packaging_limits(self: Self) -> "_307.PackagingLimits":
    ...
    @property
    def parallel_part_groups(self: Self) -> "List[_2488.ParallelPartGroup]":
    ...
    def parallel_part_groups_drawing_order(
        self: Self,
    ) -> "List[_2483.SpecifiedParallelPartGroupDrawingOrder]":
