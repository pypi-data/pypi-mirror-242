...
class OilSeal(_2445.Connector):
    ...
    @property
    def drag_torque_vs_rotational_speed(self: Self) -> "_1532.Vector2DListAccessor":
    ...
    @enforce_parameter_types
    def oil_seal_loss_calculation_method(
        self: Self, value: "_298.OilSealLossCalculationMethod"
    ):
    ...
    @property
    def oil_seal_material(self: Self) -> "_299.OilSealMaterialType":
        ...
        return constructor.new_from_mastapy(
            "mastapy.materials.efficiency._299", "OilSealMaterialType"
        )(value)

    @oil_seal_material.setter
    @enforce_parameter_types
    def oil_seal_material(self: Self, value: "_299.OilSealMaterialType"):
    ...
    @property
    def oil_seal_orientation(self: Self) -> "_1958.Orientations":
    ...
    @enforce_parameter_types
    def oil_seal_orientation(self: Self, value: "_1958.Orientations"):
        value = conversion.mp_to_pn_enum(
