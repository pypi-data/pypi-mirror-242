...
class InterferenceFitHalfDesign(_1385.DetailedRigidConnectorHalfDesign):
    """InterferenceFitHalfDesign
    ...
    @property
    def stress_region(self: Self) -> "_1444.StressRegions":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.interference_fits._1444", "StressRegions"
        )(value)
    ...
    @property
    def tolerance(self: Self) -> "_1920.SupportTolerance":
