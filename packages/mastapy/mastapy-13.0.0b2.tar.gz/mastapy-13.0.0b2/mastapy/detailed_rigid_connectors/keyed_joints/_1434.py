...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.keyed_joints import _1435, _1437
...
class KeyedJointDesign(_1442.InterferenceFitDesign):
    """KeyedJointDesign
    ...
    @property
    def geometry_type(self: Self) -> "_1435.KeyTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.keyed_joints._1435", "KeyTypes"
        )(value)

    @geometry_type.setter
    @enforce_parameter_types
    def geometry_type(self: Self, value: "_1435.KeyTypes"):
    ...
    @property
    def number_of_keys(self: Self) -> "_1437.NumberOfKeys":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.keyed_joints._1437", "NumberOfKeys"
        )(value)

    @number_of_keys.setter
    @enforce_parameter_types
    def number_of_keys(self: Self, value: "_1437.NumberOfKeys"):
        value = conversion.mp_to_pn_enum(
