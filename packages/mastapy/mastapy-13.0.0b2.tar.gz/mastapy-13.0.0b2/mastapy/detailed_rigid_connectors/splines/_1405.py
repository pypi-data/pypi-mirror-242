...
class SAESplineJointDesign(_1417.StandardSplineJointDesign):
    """SAESplineJointDesign
    ...
    @property
    def fit_type(self: Self) -> "_1392.FitTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1392", "FitTypes"
        )(value)

    @fit_type.setter
    @enforce_parameter_types
    def fit_type(self: Self, value: "_1392.FitTypes"):
