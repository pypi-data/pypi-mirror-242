...
if TYPE_CHECKING:
    from mastapy.detailed_rigid_connectors.splines import _1395, _1412
...
class SplineHalfDesign(_1385.DetailedRigidConnectorHalfDesign):
    """SplineHalfDesign
    ...
    class _Cast_SplineHalfDesign:
        ...
        def custom_spline_half_design(self: "SplineHalfDesign._Cast_SplineHalfDesign"):
            ...
            return self._parent._cast(_1386.CustomSplineHalfDesign)
    ...
    @property
    def heat_treatment(self: Self) -> "_1395.HeatTreatmentTypes":
        ...
        return constructor.new_from_mastapy(
            "mastapy.detailed_rigid_connectors.splines._1395", "HeatTreatmentTypes"
        )(value)

    @heat_treatment.setter
    @enforce_parameter_types
    def heat_treatment(self: Self, value: "_1395.HeatTreatmentTypes"):
    ...
    @property
    def fit_and_tolerance(self: Self) -> "_1418.FitAndTolerance":
