...
class OptimizationVariable(_0.APIBase):
    ...
    class _Cast_OptimizationVariable:
        ...
        def optimization_input(self: "OptimizationVariable._Cast_OptimizationVariable"):
            ...
            return self._parent._cast(_1542.OptimizationInput)
        ...
        def reporting_optimization_input(
            ...
            return self._parent._cast(_1554.ReportingOptimizationInput)
    ...
    @property
    def measurement(self: Self) -> "_1603.MeasurementBase":
    ...
    def measurement(self: Self, value: "_1603.MeasurementBase"):
