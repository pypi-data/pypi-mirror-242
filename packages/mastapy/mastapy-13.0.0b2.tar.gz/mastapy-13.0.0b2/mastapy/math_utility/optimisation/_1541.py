...
class OptimisationHistory(_0.APIBase):
    ...
    @property
    def input_history(self: Self) -> "List[_1543.OptimizationVariable]":
    ...
    @property
    def target_history(self: Self) -> "List[_1543.OptimizationVariable]":
        """List[mastapy.math_utility.optimisation.OptimizationVariable]
    ...
    def add_input_history(self: Self, value: "_1543.OptimizationVariable"):
    ...
    @enforce_parameter_types
    def add_target_history(self: Self, value: "_1543.OptimizationVariable"):
        """Method does not return.
