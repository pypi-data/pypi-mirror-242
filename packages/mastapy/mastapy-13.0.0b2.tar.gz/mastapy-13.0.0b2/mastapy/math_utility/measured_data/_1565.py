...
class OnedimensionalFunctionLookupTable(
    _1564.LookupTableBase["OnedimensionalFunctionLookupTable"]
):
    """OnedimensionalFunctionLookupTable
    ...
    @property
    def lookup_table(self: Self) -> "_1532.Vector2DListAccessor":
    ...
    def lookup_table(self: Self, value: "_1532.Vector2DListAccessor"):
