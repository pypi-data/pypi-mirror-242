...
## What's Changed
* The program clears the console with a more secure method. by @yesseruser in https://github.com/yesseruser/YesserPackageUpdater/pull/44


**Full Changelog**: https://github.com/yesseruser/YesserPackageUpdater/compare/1.7.0...1.7.1
