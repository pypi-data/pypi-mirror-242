...
class ArtifactDistributionResponse(object):
    ...
    def __init__(self, base_path=None, base_url=None, name=None, pulp_created=None, pulp_labels=None, content_guard=None, pulp_href=None, hidden=False, local_vars_configuration=None):  # noqa: E501
