...
def rolar_dado_notacao(notacao: str) -> int:
    """
    Rola um conjunto de _dados com base na linguagem de RPG, estilo "3d6+3" e retorna o valor total

    :param notacao: A fórmula do dado. Aceita mais de um dado, como "1d8+1d6"
    """
    # converte a notação em _dados
    notacao = converter_notacao_dado(notacao)

    resultado = 0

    # insere os _dados
    for dado in notacao.get("_dados"):
