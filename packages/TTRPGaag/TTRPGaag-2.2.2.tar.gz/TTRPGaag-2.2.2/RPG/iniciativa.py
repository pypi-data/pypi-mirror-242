def ordena_iniciativa(lista: dict[str:int], maior_ganha: bool = True) -> list[str]:
    """
    :param lista: dicionário com nome do personagem e o valor rolado
    ...
    """
    lista = sorted(lista.items(), key=lambda x: x[1], reverse=maior_ganha)
    return [personagem[0] for personagem in lista]
