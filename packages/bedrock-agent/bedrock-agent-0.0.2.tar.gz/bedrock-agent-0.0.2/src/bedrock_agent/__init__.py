...
See [API.md](API.md) for more desriptions.
...
class BedrockAgent(
    ...
    def __init__(
        ...
        *,
        ...
        action_group: typing.Optional[typing.Union[ActionGroup, typing.Dict[builtins.str, typing.Any]]] = None,
        ...
        knowledge_base: typing.Optional[typing.Union["KnowledgeBase", typing.Dict[builtins.str, typing.Any]]] = None,
    ) -> None:
        '''
        :param scope: -
        :param name: -
        ...
        :param action_group: Optional. Action group for the agent. If specified must contain ``s3BucketName`` and ``s3ObjectKey`` with JSON or yaml Open API schema, as well as Lambda ARN for the action group executor, and action group name.
        ...
        :param knowledge_base: Optional. Knowledge base. If provided must be either of type ``openSearchServerlessConfiguration`` or ``pineconeConfiguration`` or ``redisEnterpriseCloudConfiguration``.
        '''
        if __debug__:
    ...
    def action_group(self) -> ActionGroup:
        return typing.cast(ActionGroup, jsii.get(self, "actionGroup"))
    ...
    def knowledge_base(self) -> "KnowledgeBase":
        return typing.cast("KnowledgeBase", jsii.get(self, "knowledgeBase"))
...
class BedrockAgentProps:
    def __init__(
        ...
        *,
        ...
        if action_group is not None:
            self._values["action_group"] = action_group
    ...
    @builtins.property
    def action_group(self) -> typing.Optional[ActionGroup]:
        '''Optional.
        ...
        return typing.cast(typing.Optional[ActionGroup], result)
    ...
    @builtins.property
    def knowledge_base(self) -> typing.Optional["KnowledgeBase"]:
        '''Optional.
        ...
        return typing.cast(typing.Optional["KnowledgeBase"], result)
...
class DataSource:
    def __init__(
        ...
        *,
        ...
        :param name: Optional. Name for your data source. Default: - ``MyDataSource-${agentName}``
        '''
...
@jsii.data_type(
    jsii_type="bedrock-agents-cdk.KnowledgeBase",
    jsii_struct_bases=[],
    name_mapping={
...
class KnowledgeBase:
    def __init__(
        ...
        *,
        ...
        if __debug__:
            type_hints = typing.get_type_hints(_typecheckingstub__97fa7063a857af6614e50d8a0168b2c5d36887205571d0d24a99698c7d65b041)
...
def _typecheckingstub__97fa7063a857af6614e50d8a0168b2c5d36887205571d0d24a99698c7d65b041(
    *,
    data_source: typing.Union[DataSource, typing.Dict[builtins.str, typing.Any]],
    instruction: builtins.str,
    name: builtins.str,
