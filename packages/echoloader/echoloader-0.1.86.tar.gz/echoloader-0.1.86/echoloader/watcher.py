...
class HandlerWorker:
    ...
    def file_params(self, ds, ae_title, filename=None):
        ...
        if ae_title and self.args.enforce_ae_title:
...
def read_args():
    ...
    if args.app_config:
        ...
        if not args.env.cloud and not args.pacs_tls:
            args.pacs_tls = args.auth.user.get('pacs_config', {}).get('enabled', False)
