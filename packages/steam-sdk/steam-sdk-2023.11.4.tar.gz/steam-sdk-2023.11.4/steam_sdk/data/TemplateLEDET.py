def get_template_LEDET_inputs_sheet():
    ...
    template_LEDET_inputs_sheet = [
        ...
        ['R_EE_power', None, 'If different from 0, energy-extraction system will be based on a varistor with equivalent resistance R_EE(t)=R_EE_triggered*abs(Ia_t)^R_EE_power [-]'],
        [None, None, None],
        ...
        ['Ud_Diode_ESC', None, 'Forward voltage drop of the Diodes across the ESC auxiliary coils (set to a large value to effectively remove the Diode) [V]'],
        [None, None, None],
...
def get_template_LEDET_options_sheet():
    ...
    template_LEDET_options_sheet = [
        ...
        ['flag_controlInductiveVoltages', None, '[only working in 3D simulations] Set the inductive voltages across each inductive block (if flag=1) following a look-up table acquired from an external file'],
        ...
        ['material_properties_set', None, 'Select the set of STEAM material properties to use. Supported options are 1 for Matlab functions (default) and 2 for .mex functions (i.e. compiled C functions).'],
        [None, None, None],
