...
def analyze_circuit_event(settings_dictionary: dict, input_csv_file: str,circuit_type: str, flag_run_software: bool, software: str, file_counter: int):
    ...
    unique_identifier_event = generate_unique_event_identifier_from_eventfile(
        file_name=os.path.splitext(os.path.basename(input_csv_file))[0])
    ...
    yaml_file_name = f'infile_{software}_{circuit_type}_{unique_identifier_event}_{file_counter}.yaml'
    ...
    if software == 'PSPICE':
            shutil.copyfile(input_csv_file,os.path.join(aSTEAM.settings.local_PSPICE_folder, f'{circuit_type}', f'{file_counter}',f'Evenfile_{unique_identifier_event}.csv'))
    elif software == 'XYCE':
            shutil.copyfile(input_csv_file,os.path.join(aSTEAM.settings.local_XYCE_folder, f'{circuit_type}', f'{file_counter}', f'Evenfile_{unique_identifier_event}.csv'))
...
def analyze_RCD_RCO_event(settings_dictionary: dict, input_csv_file: str, flag_run_software: bool, software: str, file_counter: int):
    ...
    unique_identifier_event = generate_unique_event_identifier_from_eventfile(file_name=os.path.splitext(os.path.basename(input_csv_file))[0])
    ...
    if input_csv_file.endswith('.csv'):
        ...
        yaml_file_name_RCO = f'Infile_{software}_RCO_{unique_identifier_event}_{file_counter}.yaml'
        yaml_file_name_RCD = f'Infile_{software}_RCD_{unique_identifier_event}_{file_counter}.yaml'
        ...
        # copy the eventfile to the local PSPICE Folder:
        if software == 'PSPICE':
            shutil.copyfile(input_csv_file,os.path.join(aSTEAM_1.settings.local_PSPICE_folder, 'RCO', f'{file_counter}',f'Evenfile_{unique_identifier_event}.csv'))
            shutil.copyfile(input_csv_file,os.path.join(aSTEAM_2.settings.local_PSPICE_folder, 'RCD', f'{file_counter}',f'Evenfile_{unique_identifier_event}.csv'))
        elif software == 'XYCE':
            shutil.copyfile(input_csv_file, os.path.join(aSTEAM_1.settings.local_XYCE_folder, 'RCO', f'{file_counter}',f'Evenfile_{unique_identifier_event}.csv'))
            shutil.copyfile(input_csv_file,os.path.join(aSTEAM_2.settings.local_XYCE_folder, 'RCD', f'{file_counter}',f'Evenfile_{unique_identifier_event}.csv'))