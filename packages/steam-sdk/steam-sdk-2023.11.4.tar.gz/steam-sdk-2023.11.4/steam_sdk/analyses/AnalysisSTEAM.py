...
class AnalysisSTEAM:
    ...
    def step_modify_model(self, step, verbose: bool = False):
        ...
        for v, value in enumerate(step.variable_value):
            ...
            if len_simulation_numbers > 0:
                ...
                if 'FiQuS' in step.software:
                    BM.buildFiQuS(simulation_name=f"{step.simulation_name}_{simulation_number}", library_path=self.library_path)
    ...
    def setup_sim_FiQuS(self, simulation_name, sim_number, magnet_type=None):
        ...
        except: print(f"No roxie file {os.path.join(self.output_path, file_name)}")
    ...
    def run_sim(self, software: str, simulation_name: str, sim_number: int, simFileType: str = None,
        ...
        if software == 'FiQuS':
            ...
            self.summary = dFiQuS.run_FiQuS(sim_file_name=simulation_name + '_' + str(sim_number), output_directory=os.path.join(self.settings.local_FiQuS_folder, simulation_name))
        elif software == 'LEDET':
