...
class BuilderLEDET:
    ...
    def setSelfMutualInductances(self):
        ...
        if self.Auxiliary.overwrite_HalfTurnToInductanceBlock:
            ...
            if magnet_type == 'multipole':
                ...
                selfMutualInductanceMatrix_csv = Path.joinpath(self.path_magnet, f'{self.model_data.GeneralParameters.magnet_name}_selfMutualInductanceMatrix_{str(self.model_data.Options_LEDET.input_generation_options.selfMutualInductanceFileNumber)}.csv')
                ...
                fL_I_fL_L_file = Path.joinpath(self.path_magnet, f'{self.model_data.GeneralParameters.magnet_name}_fL_I_fL_L_{str(self.model_data.Options_LEDET.input_generation_options.selfMutualInductanceFileNumber)}.csv')
    ...
    def assignSolenoidValuesWindings(self):
        ...
        out_dir = os.path.join(self.path_magnet.parent, 'output')
    ...
    def assignCWSValuesWindings(self):
        ...
        """
        wwns = self.model_data.Options_FiQuS.cws.postproc.field_map.conductors_wwns  # number of wires in width direction
        whns = self.model_data.Options_FiQuS.cws.postproc.field_map.conductors_whns  # number of wires in height direction
