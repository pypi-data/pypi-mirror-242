...
def get_parser():
    ...
    parser.add_argument('ref', type=argparse.FileType('r', encoding='utf-8'), help='Reference transcript filename')
    parser.add_argument('hyp', type=argparse.FileType('r', encoding='utf-8'), help='ASR hypothesis filename')
