...
class Window(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    async def boot(self):
        ...
        filepath = f"{introduction.INSTALLED_PATH}/static/product_icon.png"
        ...
        for symbol in target_symbols:
            ...
            if coin_icon_url != "":
                ...
                pixmap.load(f"{introduction.INSTALLED_PATH}/static/icon/blank_coin.png")
...
def bring_to_life():
    ...
    QtGui.QFontDatabase.addApplicationFont(
        cwd + f"{introduction.INSTALLED_PATH}/static/source_code_pro.ttf"
    )
    QtGui.QFontDatabase.addApplicationFont(
        cwd + f"{introduction.INSTALLED_PATH}/static/notosans_regular.ttf"
    )
    QtGui.QFontDatabase.addApplicationFont(
        cwd + f"{introduction.INSTALLED_PATH}/static/lexend_bold.ttf"
    )
