        ...
        try:
            ...
            for mission in range(total_missions):
                ...
                try:
                    ...
                    self.logger.exception(f'Wrong json format', object=e)
                    raise
                ...
                if "returned_value: " in result.stdout:
                    stdout, returned_value = result.stdout.split("returned_value: ")  # TODO: the delimiter should be defined once
                else:
