...
class TestConfigurationServer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ConfigurationServer:
        """Test ConfigurationServer
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConfigurationServer`
        """
        ...
        if include_optional:
            return ConfigurationServer(
                ...
                power_supply = boaviztapi_sdk.models.power_supply.PowerSupply(
                    units = 56, 
                    usage = null, 
                    unit_weight = 1.337, )
            )
