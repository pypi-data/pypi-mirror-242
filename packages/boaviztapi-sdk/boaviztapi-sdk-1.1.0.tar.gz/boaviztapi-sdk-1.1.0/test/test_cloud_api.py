...
class TestCloudApi(unittest.TestCase):
    ...
    def test_get_archetype_config_v1_cloud_instance_instance_config_get(self) -> None:
        """Test case for get_archetype_config_v1_cloud_instance_instance_config_get

        Get Archetype Config
        """
        pass

    def test_instance_cloud_impact_v1_cloud_instance_get(self) -> None:
        """Test case for instance_cloud_impact_v1_cloud_instance_get

        Instance Cloud Impact
        """
        pass

    def test_instance_cloud_impact_v1_cloud_instance_post(self) -> None:
        """Test case for instance_cloud_impact_v1_cloud_instance_post

        Instance Cloud Impact
        """
        pass

    def test_server_get_all_archetype_name_v1_cloud_instance_all_instances_get(self) -> None:
        """Test case for server_get_all_archetype_name_v1_cloud_instance_all_instances_get

        Server Get All Archetype Name
        """
        pass

    def test_server_get_all_provider_name_v1_cloud_instance_all_providers_get(self) -> None:
        """Test case for server_get_all_provider_name_v1_cloud_instance_all_providers_get
