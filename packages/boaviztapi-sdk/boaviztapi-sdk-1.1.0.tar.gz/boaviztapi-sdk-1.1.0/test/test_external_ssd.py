...
class TestExternalSSD(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ExternalSSD:
        """Test ExternalSSD
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalSSD`
        """
        model = ExternalSSD()
        if include_optional:
            return ExternalSSD(
