...
class TestServerApi(unittest.TestCase):
    ...
    def test_get_archetype_config_v1_server_archetype_config_get(self) -> None:
        """Test case for get_archetype_config_v1_server_archetype_config_get

        Get Archetype Config
        """
        pass

    def test_server_get_all_archetype_name_v1_server_archetypes_get(self) -> None:
        """Test case for server_get_all_archetype_name_v1_server_archetypes_get

        Server Get All Archetype Name
        """
        pass

    def test_server_impact_from_configuration_v1_server_post(self) -> None:
        """Test case for server_impact_from_configuration_v1_server_post

        Server Impact From Configuration
        """
        pass

    def test_server_impact_from_model_v1_server_get(self) -> None:
        """Test case for server_impact_from_model_v1_server_get
