...
class TestElecFactors(unittest.TestCase):
    """ElecFactors unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ElecFactors:
        """Test ElecFactors
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ElecFactors`
        """
        model = ElecFactors()
        if include_optional:
            return ElecFactors(
