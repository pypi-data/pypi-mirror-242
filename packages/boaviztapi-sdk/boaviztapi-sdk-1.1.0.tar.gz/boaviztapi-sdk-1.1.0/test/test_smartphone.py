...
class TestSmartphone(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Smartphone:
        """Test Smartphone
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Smartphone`
        """
        model = Smartphone()
        if include_optional:
            return Smartphone(
