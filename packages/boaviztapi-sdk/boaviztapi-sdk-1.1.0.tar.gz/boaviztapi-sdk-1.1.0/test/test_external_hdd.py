...
class TestExternalHDD(unittest.TestCase):
    """ExternalHDD unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExternalHDD:
        """Test ExternalHDD
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExternalHDD`
        """
        model = ExternalHDD()
        if include_optional:
            return ExternalHDD(
                usage = boaviztapi_sdk.models.usage.Usage(
