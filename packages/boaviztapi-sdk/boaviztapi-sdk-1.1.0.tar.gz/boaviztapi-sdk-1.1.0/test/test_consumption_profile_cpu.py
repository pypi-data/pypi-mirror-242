...
class TestConsumptionProfileCPU(unittest.TestCase):
    """ConsumptionProfileCPU unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ConsumptionProfileCPU:
        """Test ConsumptionProfileCPU
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ConsumptionProfileCPU`
        """
        model = ConsumptionProfileCPU()
        if include_optional:
            return ConsumptionProfileCPU(
                workload = [
                    boaviztapi_sdk.models.workload_power.WorkloadPower(
                        load_percentage = 1.337, 
                        power_watt = 1.337, )
                    ],
                cpu = boaviztapi_sdk.models.cpu.CPU(
                    units = 56, 
                    usage = null, 
                    core_units = 56, 
                    die_size = 1.337, 
                    die_size_per_core = 1.337, 
                    manufacturer = '', 
                    model_range = '', 
                    family = '', 
                    name = '', 
    ...
    def testConsumptionProfileCPU(self):
        """Test ConsumptionProfileCPU"""
