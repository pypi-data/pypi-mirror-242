...
class TestTelevision(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Television:
        """Test Television
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Television`
        """
        model = Television()
        if include_optional:
            return Television(
