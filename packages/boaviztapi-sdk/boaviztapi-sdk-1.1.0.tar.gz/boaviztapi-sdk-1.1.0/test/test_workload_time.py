...
class TestWorkloadTime(unittest.TestCase):
    """WorkloadTime unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadTime:
        """Test WorkloadTime
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkloadTime`
        """
        model = WorkloadTime()
        if include_optional:
            return WorkloadTime(
                time_percentage = 1.337,
