...
class TestUsageCloud(unittest.TestCase):
    """UsageCloud unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsageCloud:
        """Test UsageCloud
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsageCloud`
        """
        model = UsageCloud()
        if include_optional:
            return UsageCloud(
                ...
                time_workload = None,
                usage_location = '',
                elec_factors = boaviztapi_sdk.models.elec_factors.ElecFactors(
                    gwp = 1.337, 
                    adp = 1.337, 
                    pe = 1.337, 
                    gwppb = 1.337, 
