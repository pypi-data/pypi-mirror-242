...
class TestMotherboard(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Motherboard:
        """Test Motherboard
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Motherboard`
        """
        model = Motherboard()
        if include_optional:
            return Motherboard(
