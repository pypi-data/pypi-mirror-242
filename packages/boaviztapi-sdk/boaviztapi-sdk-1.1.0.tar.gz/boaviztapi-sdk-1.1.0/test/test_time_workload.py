...
class TestTimeWorkload(unittest.TestCase):
    """TimeWorkload unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimeWorkload:
        """Test TimeWorkload
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimeWorkload`
        """
        model = TimeWorkload()
        if include_optional:
            return TimeWorkload(
