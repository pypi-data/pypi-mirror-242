...
class TestConsumptionProfileApi(unittest.TestCase):
    """ConsumptionProfileApi unit test stubs"""

    def setUp(self) -> None:
        self.api = ConsumptionProfileApi()

    def tearDown(self) -> None:
        pass

    def test_cpu_consumption_profile_v1_consumption_profile_cpu_post(self) -> None:
        """Test case for cpu_consumption_profile_v1_consumption_profile_cpu_post
