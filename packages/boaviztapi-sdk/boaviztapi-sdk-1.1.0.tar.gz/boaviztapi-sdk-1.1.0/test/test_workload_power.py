...
class TestWorkloadPower(unittest.TestCase):
    """WorkloadPower unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WorkloadPower:
        """Test WorkloadPower
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WorkloadPower`
        """
        model = WorkloadPower()
        if include_optional:
            return WorkloadPower(
