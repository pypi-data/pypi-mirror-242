...
class TestUsbStick(unittest.TestCase):
    """UsbStick unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UsbStick:
        """Test UsbStick
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UsbStick`
        """
        model = UsbStick()
        if include_optional:
            return UsbStick(
