...
class ConsumptionProfileApi:
    ...
    @validate_call
    def cpu_consumption_profile_v1_consumption_profile_cpu_post(
        self,
        verbose: Optional[StrictBool] = None,
        consumption_profile_cpu: Optional[ConsumptionProfileCPU] = None,
        ...
        :param verbose:
        :type verbose: bool
        :param consumption_profile_cpu:
        :type consumption_profile_cpu: ConsumptionProfileCPU
        ...
        _param = self._cpu_consumption_profile_v1_consumption_profile_cpu_post_serialize(
            verbose=verbose,
            consumption_profile_cpu=consumption_profile_cpu,
    ...
    @validate_call
    def cpu_consumption_profile_v1_consumption_profile_cpu_post_with_http_info(
        self,
        verbose: Optional[StrictBool] = None,
        consumption_profile_cpu: Optional[ConsumptionProfileCPU] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def cpu_consumption_profile_v1_consumption_profile_cpu_post_without_preload_content(
        self,
        verbose: Optional[StrictBool] = None,
        consumption_profile_cpu: Optional[ConsumptionProfileCPU] = None,
        _request_timeout: Union[
    ...
    def _cpu_consumption_profile_v1_consumption_profile_cpu_post_serialize(
        self,
        verbose,
        ...
        if consumption_profile_cpu is not None:
            _body_params = consumption_profile_cpu
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/consumption_profile/cpu',
