...
class WorkloadPower(BaseModel):
    ...
    power_watt: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["load_percentage", "power_watt"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WorkloadPower from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WorkloadPower from a dict"""
        if obj is None:
            return None
