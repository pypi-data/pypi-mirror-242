...
class IoT(BaseModel):
    ...
    """ # noqa: E501
    functional_blocks: Optional[List[FunctionalBlock]] = None
    usage: Optional[Usage] = None
    __properties: ClassVar[List[str]] = ["functional_blocks", "usage"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of IoT from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in functional_blocks (list)
        _items = []
        if self.functional_blocks:
            for _item in self.functional_blocks:
                if _item:
                    _items.append(_item.to_dict())
            _dict['functional_blocks'] = _items
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of IoT from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "functional_blocks": [FunctionalBlock.from_dict(_item) for _item in obj.get("functional_blocks")] if obj.get("functional_blocks") is not None else None,
