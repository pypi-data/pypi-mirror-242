...
class ConsumptionProfileCPU(BaseModel):
    """
    BaseDTO is simple BaseModel object
    """ # noqa: E501
    workload: Optional[List[WorkloadPower]] = None
    cpu: Optional[CPU] = None
    __properties: ClassVar[List[str]] = ["workload", "cpu"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of ConsumptionProfileCPU from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in workload (list)
        _items = []
        if self.workload:
            for _item in self.workload:
                if _item:
                    _items.append(_item.to_dict())
            _dict['workload'] = _items
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of ConsumptionProfileCPU from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "workload": [WorkloadPower.from_dict(_item) for _item in obj.get("workload")] if obj.get("workload") is not None else None,
