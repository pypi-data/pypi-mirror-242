...
class UsageCloud(BaseModel):
    ...
    instance_per_server: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["use_time_ratio", "hours_life_time", "avg_power", "time_workload", "usage_location", "elec_factors", "other_consumption_ratio", "instance_per_server"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UsageCloud from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UsageCloud from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "time_workload": TimeWorkload.from_dict(obj.get("time_workload")) if obj.get("time_workload") is not None else None,
            "usage_location": obj.get("usage_location"),
            "elec_factors": ElecFactors.from_dict(obj.get("elec_factors")) if obj.get("elec_factors") is not None else None,
            "other_consumption_ratio": obj.get("other_consumption_ratio"),
            "instance_per_server": obj.get("instance_per_server")
        })
        return _obj
