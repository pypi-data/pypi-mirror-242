...
class FunctionalBlock(BaseModel):
    ...
    hsl_level: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["units", "usage", "hsl_level", "type"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of FunctionalBlock from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of FunctionalBlock from a dict"""
        if obj is None:
            return None
