...
class CPU(BaseModel):
    ...
    core_units: Optional[StrictInt] = None
    die_size: Optional[Union[StrictFloat, StrictInt]] = None
    die_size_per_core: Optional[Union[StrictFloat, StrictInt]] = None
    manufacturer: Optional[StrictStr] = None
    model_range: Optional[StrictStr] = None
    family: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    tdp: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["units", "usage", "core_units", "die_size", "die_size_per_core", "manufacturer", "model_range", "family", "name", "tdp"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "core_units": obj.get("core_units"),
            "die_size": obj.get("die_size"),
            "die_size_per_core": obj.get("die_size_per_core"),
            "manufacturer": obj.get("manufacturer"),
            "model_range": obj.get("model_range"),
