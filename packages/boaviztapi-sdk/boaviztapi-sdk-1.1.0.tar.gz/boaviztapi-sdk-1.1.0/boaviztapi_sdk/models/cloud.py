...
class Cloud(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["model", "configuration", "usage", "provider", "instance_type"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "model": ModelServer.from_dict(obj.get("model")) if obj.get("model") is not None else None,
            "configuration": ConfigurationServer.from_dict(obj.get("configuration")) if obj.get("configuration") is not None else None,
            "usage": UsageCloud.from_dict(obj.get("usage")) if obj.get("usage") is not None else None,
