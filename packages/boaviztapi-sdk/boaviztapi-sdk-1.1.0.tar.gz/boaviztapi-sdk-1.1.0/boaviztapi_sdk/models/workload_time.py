...
class WorkloadTime(BaseModel):
    ...
    """ # noqa: E501
    time_percentage: Optional[Union[StrictFloat, StrictInt]] = None
    load_percentage: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["time_percentage", "load_percentage"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of WorkloadTime from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of WorkloadTime from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "time_percentage": obj.get("time_percentage"),
            "load_percentage": obj.get("load_percentage")
        })
        return _obj
