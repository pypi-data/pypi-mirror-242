...
class ConfigurationServer(BaseModel):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            ...
            "ram": [RAM.from_dict(_item) for _item in obj.get("ram")] if obj.get("ram") is not None else None,
            "disk": [Disk.from_dict(_item) for _item in obj.get("disk")] if obj.get("disk") is not None else None,
            "power_supply": PowerSupply.from_dict(obj.get("power_supply")) if obj.get("power_supply") is not None else None
        })
        return _obj
