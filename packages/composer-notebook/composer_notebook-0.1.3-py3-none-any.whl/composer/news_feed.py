...
def do_search_news(search_term: str):
    if not serp_api_key or serp_api_key.strip() or serp_load_api_key() == "":
        raise ValueError("API key is not set or is empty. Please set the API key.")
