...
from nomad_envoy_cli.models.base_api_response_data import BaseApiResponseData  # noqa: E501
from nomad_envoy_cli.rest import ApiException

class TestBaseApiResponseData(unittest.TestCase):
    """BaseApiResponseData unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test BaseApiResponseData
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = nomad_envoy_cli.models.base_api_response_data.BaseApiResponseData()  # noqa: E501
        if include_optional :
            return BaseApiResponseData(
                return_value = '0'
            )
        else :
            return BaseApiResponseData(
    ...
    def testBaseApiResponseData(self):
        """Test BaseApiResponseData"""
