...
from nomad_envoy_cli.models.product_api_response_required import ProductApiResponseRequired  # noqa: E501
from nomad_envoy_cli.rest import ApiException

class TestProductApiResponseRequired(unittest.TestCase):
    """ProductApiResponseRequired unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test ProductApiResponseRequired
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = nomad_envoy_cli.models.product_api_response_required.ProductApiResponseRequired()  # noqa: E501
        if include_optional :
            return ProductApiResponseRequired(
                data = null
            )
        else :
            return ProductApiResponseRequired(
    ...
    def testProductApiResponseRequired(self):
        """Test ProductApiResponseRequired"""
