...
class OrderApi(object):
    ...
    def get_order_by_field(self, store, **kwargs):  # noqa: E501
        ...
        :param async_req bool: execute request asynchronously
        :param str store: ID of the store. (required)
        :param str order_id: Order ref of ERP system.
        :param str client_order_ref: Client order ref of E-commerce platform.
        :param str status: Order status, available options are: WAIT_BUYER_PAY, WAIT_SELLER_SEND_GOODS, WAIT_BUYER_CONFIRM_GOODS, TRADE_SUCCESS, TRADE_CLOSED,TRADE_REFUND, TRADE_FAILED.
        :param str type: Order type, 2 available options: NORMAL, DISTRIBUTION
        :param str created_range: The time range of order creation, use ISO_8601 format here.
        :param str updated_range: The time range of order update, use ISO_8601 format here.
        :param int page_no: Page number, between 1 and 1000.
        :param int page_size: Page size, options: 1, 10, 50, 100.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
