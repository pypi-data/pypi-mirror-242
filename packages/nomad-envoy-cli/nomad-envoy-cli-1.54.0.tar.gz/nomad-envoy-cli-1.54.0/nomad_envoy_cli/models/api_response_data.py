...
class ApiResponseData(object):
    ...
    def __init__(self, return_value=None, products=None, product=None, product_id=None, orders=None, order=None, order_id=None, local_vars_configuration=None):  # noqa: E501
