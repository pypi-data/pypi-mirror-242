...
class CheltuieliPlanificate:
    def __init__(self):
        ...
        self.ini_file = r"D:\Python\MySQL\mysqlquerys\src\mysqlquerys\local.ini"
    ...
    def get_all_sql_vals(self):
        ...
        for table in self.dataBase.allAvailableTablesInDatabase:
            ...
            check = all(item in list(active_table.columnsProperties.keys()) for item in self.tableHead)
            if check:
