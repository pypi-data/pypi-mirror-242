...
from .grpc_auth import Auth0Client, ForceTokenInterceptor
...
def create_grpc_channel(
    ...
    Args:
        ...
        force_token_header: force bearer token header on all request, even without ssl
    ...
    try:
        ...
        if force_token_header and not (enable_ssl or url.endswith(":443")):
            interceptors = interceptors + (ForceTokenInterceptor(),)
