...
class AI_RL:
    def __init__(self) -> None:
        ...
        #state = torch.load("models/model_03_97.pt")       # times: [2.54]s nS, nA = 17, 9
        #state = torch.load("models/model_026_-93.19.pt") # times: [2.20]s  rew: -100.5 ± 1.8   nS, nA = 17, 5
        #state = torch.load("models/model_027_-91.51.pt") # times: [2.25]s  rew:  -99.8 ± 1.8   nS, nA = 17, 5
        #state = torch.load("models/model_028_-90.51.pt") # times: [2.54]s  rew: -106.5 ± 1.9   nS, nA = 17, 5

        #state = torch.load("models/model_015_-87.72.pt") # times: [2.54]s  rew: -106.5 ± 1.9   nS, nA = 17, 5
