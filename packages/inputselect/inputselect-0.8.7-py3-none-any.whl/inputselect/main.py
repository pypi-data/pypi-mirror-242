...
def List(message: str = "", choices=None, separator: str = " ", spin_speed: int = 0, colors=DEFAULT_COLORS, underline=False):
...
def Slider(message: str = "", choices=None, spin_speed: int = 0, colors=DEFAULT_COLORS, wrap=True, underline=False):
...
def Checkbox(message: str = "", choices=None, separator: str = " ", min_choices: int = 2, max_choices: int = 2, colors=DEFAULT_COLORS, alt_colors=ALT_COLORS, underline=False):
