...
def List(message: str = "pick an animal: ", choices=("cow", "dog", "horse", "camel"), separator: str = " ", colors=DEFAULT_COLORS, underline=False):
...
def Slider(message: str = "pick a letter: ", choices=("A", "B", "C", "D", "E"), colors=DEFAULT_COLORS, wrap=True, underline=False):
