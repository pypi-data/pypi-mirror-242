...
DEF_COLORS, ALT_COLORS = ["blue", "blank"], ["yellow", "blank"]
Q_MARK = f"[{COLORS.get('yellow')[0]}?{STYLES['reset']}] "

EXIT_SEQUENCE = "-EXIT-"


def List(message: str = "", choices=None, separator: str = " ", spin_speed: int = 0, colors=DEF_COLORS, underline=False):
...
def Slider(message: str = "", choices=None, spin_speed: int = 0, colors=DEF_COLORS, wrap=True, underline=False):
...
def Checkbox(message: str = "pick an animal: ", choices=None, separator: str = " ", min_choices=2, colors=DEF_COLORS, alt_colors=ALT_COLORS, underline=False):
