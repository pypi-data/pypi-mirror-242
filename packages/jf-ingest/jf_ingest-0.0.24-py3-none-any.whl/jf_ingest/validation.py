...
def validate_jira(config: JiraIngestionConfig):
    ...
    try:
        ...
        jira_connection = get_jira_connection(config=auth_config, auth_method=JiraAuthMethod.BasicAuth, max_retries=1)
    ...
    try:
        ...
        user_count = len(download_users(jira_basic_connection=jira_connection,
    ...
    print(len(projects_and_versions))

    for project in projects_and_versions:
        print(project['key'])
