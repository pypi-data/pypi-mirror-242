...
class Event(BaseEvent):
    ...
    def get_event_body(self) -> dict:
        ...
        return {
            ...
            "event_type": self.event_type, "extra_data": self.event_properties,
            "device_id": self.device_id or pydash.get(self, "event_properties.device_id"),
            "region": self.region or pydash.get(self, "event_properties.region"),
...
class User(IdentifyEvent):
    ...
    def get_event_body(self) -> dict:
        return {
            ...
            "udid": self.android_id or pydash.get(self, "user_properties.android_id"),
            ...
            "sign_up_at": pydash.get(self, "user_properties.sign_up_at") or self.time,
            "extra_data": self.user_properties
        }
