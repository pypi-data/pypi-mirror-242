...
def get_3dspectrogramplot_params(config):
    ...
    return spec3_title, spec3_dbmlt, spec3_ylabel, spec3_zlabel, spec3_colormap, spec3_edgecol
...
def get_freqplots_tooltip_params(config):
    freqpl_config = get_freqplots_config(config)
    legenda_config = freqpl_config['tooltip']
