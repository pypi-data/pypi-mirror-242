...
def save_plots(datafile_name, iter_token, config_hnd, out_directory, out_overwrite, subpl_diction, ui_is_multitab, plot_out_mode):
    ...
    if (ui_is_multitab):
        #logger.warning('plot_save.save_plots - TBI - multitab to be implemented')
        ...
        save_plots_impl(datafile_name, iter_token, config_hnd, out_directory, out_overwrite, subpl_diction, plot_out_mode)
