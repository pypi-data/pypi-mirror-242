        ...
        for channelset in channelsets:
            ...
            if (cnum_samples > 1):
                ...
                for cur_channel in get_channelset_signals(channelset):
                    ...
                    sigtransformer = SignalTransformer(config_hnd, cnum_samples, average_x_difference, signal_vals, include_envelope, include_phase, include_psd, frequency_filter, include_wl_transform)
                    num_freq_vals, sampling_freq, frequencies, signal_fft, signal_fft_magnitude, signal_ft_phase, signal_filtered_vals, signal_peaks_vals, psd_x_vals, psd_y_vals, wv_scales, wavelet_transform_data, wavelet_type = sigtransformer.transform()
...
def parse_opt():
    ...
    parser.add_argument('--out-directory', type=str, default='./plots', help='plots target directory')
