...
def kiwi(host,delay=0,scripts=False,cores=1):
    global hits
    clear()
    init_host = host
    hits = []
    ...
    subdomains = ["","aams","accent","accounts","acs-xs","acsamid01","acsids","acsnas","activeapplicant","activeresources","ad","adams","adfs","adm","admin","aes","aesdvr1","aggies","agsd520","ahs","ain-fortigate","airwatch","akhistory","akp-fortigate","akpk","alex2","alio","aliointel","alioportal","alltube","alpine","alt","alumni","ambler","ams","anc-fortigate","anc-opn","anchserv","angel","aovpn","apache","api","aplus","apple","appleid","apply","apps","apps2","apps3","aps","arabamid","arboretum","archiver","asas","asburyhigh","asg","assessment","assets","atq-fortigate","atrium","atriuum","attalla","auth","auth1","auth2","autodiscover","av","aw","backup","barracuda","barracuda1","bbb","bbbsd-iv-1","bbcesmoodle","bbchsmoodle","bcbeiboss2","bcboefilewave","bcrobotics","bcsipmonitor","bear","believeyoucan","bes","bess-proxy","bet-vm-moodle4","beverlye","bibbcompass","bibbdestiny","bibbdocumentserver","bigbluebutton","bigboy","blackboard","block","blocker","blog","blogs","bm","bmon","bms-audioe","boe-emailsrv","books","bridgit","brindleemiddle","brindleemountainhigh","brw-ava-cctv-1","brw-fortigate","brw-opn","bsl","buckhornhigh","busshop","butlerco","calendar","canvas","carver","casarry","casper","cassidy","catalog","causeyband","cbfw","ccctc","cchs","ccs","ccsd","certifiedportal","cesmoodle","choice","chsmoodle","ciscoasa","citrix","cl","classlink","classweb","claysville","claysvillejuniorhigh","clearpass1","cloverdale","cms","cmsmoodle","cnp","cobalt","collab-edge","communityeducation","compass","compasslearning","conecuh","connect","connectdev","counseling","cov","covid19","cpanel","cpcalendars","cpcontacts","cpi","cppm1","cs-voip","csg","ctcsec","cyberbase","cybernew","d2l","daleville","dare","darelementary","darhigh","darmiddle","dart","dartdemo","dartdemo2","dataservice","datavault","datsrv055","dcsamid01","dcsfws","dcsnamidcl","dcsxserve","ddi","decisioned","dell-learn","denali","des","designthefuture","desigo","destination","destiny","dev","dialin","dio","diocam","discovervideo","dlg","dlgconferences","dmm","dmsftp","dn","dns","dns1","docefill","docs","documentservices","domain","donehoo","dothan","dothanhigh","dothantech","douglaselementary","douglashigh","douglasmiddle","dreamjob411","dsviewer","e2010","ebes","ebooks","eclass","eclass2","ecsinow","ecspowerschool","edulog","edutrax","edynamic","ees","eforms","eli","email","employeeportal","employees","engage","engage2","engagepd","enrollment","ens","eonline","es","eschool","eschoolhac","esmoodle","esms","ess","et","etcentral","etcontent","etsecurity","etsts","eurabrown","evans","excert","exchange","exchange-edge","expressway","faine","fairbanks-allworx","fairview","falcon1","familylink","fce","fea","fed","fes","filemaker","filewave","filter","finance","floyd","flp","fmpcal","follett","formcentral","forms","fortigate","fortis","frame","franklin","fs","ftp","fw","gadsdencity-hs","gam","gchs","geo","gila","girard","girardms","gje","glennallenhonorsocieties","glv","gmail","gms","go","gpa","grades","grandview","greene","groups","grpwise","guac","guac-test","gwguard","happytimes","hcs-ess","hct","hd","hdcsmtp1","hdctab","heard","hekla","help","helpdesk","henryclay","henryconnects","heritagehigh","hes","hhs","highlands","hms","home","homewood","honeysuckle","hs","hydaburg","iboss","ibossoc","ibossreporter","icl","icreports","idb","imail","info","infocus","infonowweb","inow","inowapi","inowhome","inowreports","inowtest","interventions","interweb","intranet","inventory","iparent","it","ivisions","jasper","jds","jds-ext","join","jrotc1","jsj-cam","jss","jupiter","kak-fortigate","kb","kbox","kc","keklms","kellysprings","keynet","kgk","kgklms","kibsdenrollment","kibsdzendto","kka","kobuk","kronmobile","kronos","kts","lcs-amid01","ldap","lee","les","lesmoodle","lessonplans","lhs","lhsmoodle","lib","library","lightspeed","lightspeed2","links","listsrv","lms","lunch","maconexch","madisoncity","mahara","mail","mail1","mail2","mail4","mail7","mailserver","maintenance","maps","marengo","math","matterhorn","mbsasa","mc","mcep","mconline","mcpsnet","mcs-tools","mcsportal","mdm","mdm2","mealapp","mealapplication","mealapps","media","meet","meetme","mes","mesmoodle","mhsmoodle","micollab","midfield","mine","mitchell","mmsmoodle","mobile","mobilefilter","monroe","montage","montagebeta","montana","moodle","moodle17","moodle2","mps","mps-filewave","mps-powerschool","mps-rdp-01","mps-solarwinds","msc-mobile","msc-print","msc7","mscs","mserve","mta","mta-sts","mts","mx","mx1","my","mydocs","myfiles","mypay","mystop","mytime","n2h2","nactec","nagios","nas","nes","netview","newmail","nextcloud","nextgen","ng","ngweb","nms","noatak","northview","ns","ns1","ns2","ns3","nui-fortigate","nutrition","oaes","ocsad3","ocsarchive","ocsbo","ocscomm","ocsgwava","ocshelpdesk","ocslms","ocsmail","ocsweb","ocswww","odyssey","office","oldmail","oldregistration","onesync","onlinemealapp","opelika-ls","owa","packetview","pages","palmer","pandora","paperless","parent","parentportal","parentsurvey","passwordreset","passwordresetregistration","patriotpath","payday","paydocs","payroll","paystubs","pbx","pcmon","pcslibrary","pd","pdexpress","pdmoodle","pho-fortigate","piedmont","pinpoint","piz-fortigate","pl","pm","podcasts","pop","portal","powerschool","pres","preschool","proxy","proxy2","ps","ps-sandbox","ps-test","pssb","pstest","pulse","pwchange","quarantine","radius","randolph","rbhudson","rcs","rdp","rds","read","readydesk","records","registration","relay","relay1","relay2","remotesupport","renlearn","reporter","reportmax","request","res","reset","rise","roatws1","rocket","rollcall","router","rp","rpad","rsapi","rta-app-a","rta-app-b","s","safari","safariaves","sav4","sav5","sav6","school","schoolboard","schoolmax","schools","scim","score","scripting","scs","scsinfnow","scsmail","scsnxgnsvc","sdp","search","searchsoft","searchsoftauth","secure","securelink","security","securityportal","sedna","selawik","selmast","services","ses","sesmoodle","sets","setshome","setsser","setsti","setsweb","sftp","sfw","shelbyed","shh","showcase","shssec","shungnak","sif","silverthrone","sis","siteproxy","sites","sjhs","skk","slingluff","slomanprimary","smk","sms","smtp","smtp-1","smtp1","smtp11","smtp2","sonicwallva","sophos","spam","spam2","spamtitan1","spamtitan2","spc","specialty","speedtest","sports","sresmoodle","sso","sspr","staff","staffportal","staffsurvey","status","sti","stidistrict","stisets","stisetsweb","striplin","sts","studentportal","subfinder","subportal","sumter","support","supportportal","sva","swinstall","synergy","synergypsv","synldap","sysaid","szmcg","talk","tarrant","tbcparent","tcchsmoodle","tcm","tcs-docs","tcsd-ns-01","tcsd-ns-02","tcsdns","tcsfirewall","tcsscobia","teacherportal","teaching","technology","techweb","techwiki","temp","temptrak","tes","test","test5","testps","thompson","ths","tickets","timeclock","tla","tm","tools","trans","transelog","transportation","trend","tserver","ttc-smb","ttc-spam","turn","tuscumbia","twa","tyler","tylerweb","ubnt","uc-exe","uc-exe-2","ugms","uisp","unifi","uniongrove","unk","updates","utm","view","view1","view2","voip-expressway-e","vpec01","vpn","vpn-brw","waa","walnutpark","wanutil","wayfinder","wb","wbb","wboesfb","web","web2","webapps","webcentral","webcrd","webdisk","webmail","webmail2","websets","wes","wesmoodle","wessec","whsmoodle","wiki","wilcox","williamblount","windows-vs","winfield","workorder","workorders","wpes","www","www1","www2","wx","zendto"]
    kiwi_thread_list = []
    thread_count = 0
    for host in hosts:
        if subnet:
