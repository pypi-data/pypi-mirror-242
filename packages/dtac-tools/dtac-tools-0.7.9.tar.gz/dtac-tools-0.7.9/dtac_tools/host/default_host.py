...
from ..plugins.types import EndpointRequest, EndpointResponse
...
class DefaultPluginHost(PluginHost):
    ...
    # be used to register the plugin with the DTAC Agent and to setup the endpoints that the plugin will handle.
        ...
        try :
            ...
            for endpoint in response:
                api_ep = PluginEndpoint(
                    ...
                    auth_group = endpoint.auth_group,
    ...
    def Call(self, request: EndpointRequestMessage, context: grpc.ServicerContext) -> EndpointResponseMessage:
        try:
            ...
            request_args = EndpointRequest.from_api_request(request.request)
    ...
    def serve(self):
        ...
        tls = True if cert is not "" and key is not "" else False
        options = [
