...
import uuid
import json
from mq_listener.activemq.BaseAction import BaseAction
class ActiveMQ:
...
# class TestListener(BaseAction.BaseAction):
#     def trigger_action(self, message_data: object):
#         return super().trigger_action(message_data)


# if  __name__ == '__main__':
#     objMq = ActiveMQ()
#     objMq.message_listener('convert-images',4400,TestListener())