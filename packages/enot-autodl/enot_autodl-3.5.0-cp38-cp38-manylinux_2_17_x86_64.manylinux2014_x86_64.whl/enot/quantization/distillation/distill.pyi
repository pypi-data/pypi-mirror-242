...
class distill(ContextDecorator):
    ...
    """
    def __init__(self, fq_model: FakeQuantizedModel, model: Optional[Union[nn.Module, GraphModule]] = ..., strategy: DistillationLayerSelectionStrategy = ..., tune_weight_scale_factors: bool = ...) -> None:
        """
        Parameters
        ----------
