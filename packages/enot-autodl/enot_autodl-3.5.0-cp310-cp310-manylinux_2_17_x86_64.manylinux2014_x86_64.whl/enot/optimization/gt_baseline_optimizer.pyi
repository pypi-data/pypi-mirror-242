...
class GTBaselineOptimizer:
    ...
    """
    def __init__(self, model: nn.Module, optimizer: Union[Optimizer, Any], *, allow_non_optimizer: bool = ..., **kwargs) -> None:
        """
        Parameters
        ----------
    ...
    def add_param_group(self, param_group: Dict[str, Any]) -> None:
        ...
        """
    def model_step(self, closure: Callable) -> Optional[Union[float, torch.Tensor]]:
        '''
        ...
        '''
    def step(self, closure: Optional[Callable] = ...) -> Optional[Union[float, torch.Tensor]]:
        """
