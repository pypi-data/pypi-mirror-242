...
class FakeQuantizedModel(nn.Module):
    ...
    """
    def __init__(self, model: nn.Module, transform_patterns: Sequence[Tuple[SubgraphTransformPattern, ...]], activations_quantization_type: QuantizationType, leaf_modules: Optional[List[Union[Type[nn.Module], nn.Module]]] = ..., inplace: bool = ..., **kwargs) -> None:
        """
        Parameters
        ----------
    ...
    def regular_parameters(self) -> Iterator[nn.Parameter]:
        ...
        """
    def enable_calibration_mode(self, mode: bool = ...) -> FakeQuantizedModel:
        """
        ...
        """
    def enable_quantization_mode(self, mode: bool = ...) -> FakeQuantizedModel:
        """
