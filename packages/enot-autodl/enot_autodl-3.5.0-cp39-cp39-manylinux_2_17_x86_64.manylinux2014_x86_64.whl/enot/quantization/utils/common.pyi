...
class QuantizationType:
    ...
    quantize_bias: bool = ...
    def __init__(self, granularity: QuantizationGranularity, strategy: QuantizationStrategy, calibration_method: CalibrationMethod = ..., rounding_function: RoundingFunction = ..., bitness: int = ..., calibration_options: Optional[Dict[str, Any]] = ..., use_weight_scale_factors: bool = ..., use_bias_scale_factors: bool = ..., quantize_bias: bool = ...) -> None:
        """
        Parameters
        ----------
        granularity : QuantizationGranularity
