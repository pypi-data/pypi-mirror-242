...
from .config import a_stock_list_url, a_stock_trade_date_url, a_stock_index_url, stock_intl_index_url, \
    index_stock_composition_url, stock_bonus_url
...
class StockServices:
    ...
    def common_func(self, params: Dict[str, Union[int, str]], item_url) -> Dict[str, Union[int, str]]:
    ...
    def stock_to_kline_data(self, **kwargs) -> Dict[str, Union[int, str]]:
    ...
    def stock_to_trade_date_list(self, **kwargs) -> Dict[str, Union[int, str]]:
        """
        交易日历数据
        Parameters
        ----------
    ...
    def stock_to_index_list(self, **kwargs) -> Dict[str, Union[int, str]]:
        is_explain = kwargs.pop("is_explain", False)
    ...
    def stock_to_intl_index_list(self, **kwargs) -> Dict[str, Union[int, str]]:
        is_explain = kwargs.pop("is_explain", False)
    ...
    def stock_to_index_stock_composition(self, **kwargs) -> Dict[str, Union[int, str]]:
        is_explain = kwargs.pop("is_explain", False)
    ...
    def stock_to_bonus(self, **kwargs) -> Dict[str, Union[int, str]]:
        is_explain = kwargs.pop("is_explain", False)
