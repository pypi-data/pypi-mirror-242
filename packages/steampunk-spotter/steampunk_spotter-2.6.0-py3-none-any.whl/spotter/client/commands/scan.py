...
def add_parser(subparsers: "argparse._SubParsersAction[argparse.ArgumentParser]") -> None:
    ...
    parser.add_argument(
        "-o", "--option", type=lambda s: s.strip().split("="), action="append", default=[], help=argparse.SUPPRESS
    )
    parser.add_argument(
        "-a",
        "--ansible-version",
...
def _parser_callback(args: argparse.Namespace) -> None:
    ...
    if args.option:
        print("Warning: the --option option is deprecated. Use specific CLI options instead.")
    ...
    if args.include_values:
        print(
            "Warning: the --include-values option is deprecated. Playbook values are now included by "
            "default. You can exclude them with --exclude-values."
        )
    if args.include_metadata:
        print(
            "Warning: the --include-metadata option is deprecated. Metadata (i.e., file names, line and "
