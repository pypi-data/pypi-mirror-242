...
individual_order_details = smartApi.individual_order_details(qParam)
print("individual_order_details",individual_order_details)
...
print("margin_api_result",margin_api_result)
