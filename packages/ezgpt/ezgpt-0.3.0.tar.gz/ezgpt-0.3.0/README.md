...
An even simpler way to use GPT is using the `conversation()` function. Here you can use the normal GPT arguments, and when you use it, you'll be able to have a conversation with GPT. Type in `!` to end.
