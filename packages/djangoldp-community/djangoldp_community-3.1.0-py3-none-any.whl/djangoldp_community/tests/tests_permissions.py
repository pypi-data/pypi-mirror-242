...
class PermissionsTestCase(APITestCase):
    ...
    #     community = self._get_random_community()
    #     me = self._add_community_member(user=self.user, community=community, is_admin=False)
    #     member = self._add_community_member(user=another_user, community=community, is_admin=True)
