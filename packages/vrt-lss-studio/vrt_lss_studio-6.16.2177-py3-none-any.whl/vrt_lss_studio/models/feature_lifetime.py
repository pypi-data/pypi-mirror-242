...
class FeatureLifetime(BaseModel):
    ...
    """
    feature: Annotated[str, Field(min_length=1, strict=True, max_length=256)] = Field(description="Feature. ")
    time_windows: Annotated[List[TimeWindow], Field(min_length=0, max_length=2)] = Field(description="A list of time windows within which the specified feature exists in the `performer_features` lists. If compatibility is affected by several features with different windows - entities will be considered compatible within the intersection of windows. ")
