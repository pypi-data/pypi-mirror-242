...
class TransportFactor(BaseModel):
    ...
    speed: Union[Annotated[float, Field(le=1000, strict=True, ge=0.1)], Annotated[int, Field(le=1000, strict=True, ge=1)]] = Field(description="Average transport speed multiplier.")
