...
class HardlinksApi:
    ...
    @validate_arguments
    def create_hardlink(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_hardlink : Annotated[WebHardlink, Field(description="New essence creation request.")], **kwargs) -> WebHardlink:  # noqa: E501
    ...
    @validate_arguments
    def create_hardlink_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_hardlink : Annotated[WebHardlink, Field(description="New essence creation request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create hardlink  # noqa: E501
    ...
    @validate_arguments
    def delete_hardlink(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def enable_hardlinks(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Enable hardlinks request.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def read_hardlink(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> WebHardlink:  # noqa: E501
    ...
    @validate_arguments
    def read_hardlinks_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, sort_field : Annotated[Optional[TableHardlinkColumnType], Field(description="Hardlink table column name. ")] = None, sort_direction : Annotated[Optional[StrictStr], Field(description="Sort direction.")] = None, table_hardlink_filter_list : Annotated[Optional[TableHardlinkFilterList], Field(description="Hardlinks filter.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """List hardlinks  # noqa: E501
    ...
    @validate_arguments
    def update_hardlink(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_hardlink : Annotated[WebHardlink, Field(description="Essence update request.")], **kwargs) -> WebHardlink:  # noqa: E501
    ...
    @validate_arguments
    def update_hardlink_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_hardlink : Annotated[WebHardlink, Field(description="Essence update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update hardlink  # noqa: E501
