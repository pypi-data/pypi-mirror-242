...
class TripsApi:
    ...
    @validate_arguments
    def create_trip(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_trip : Annotated[WebTrip, Field(description="New essence creation request.")], **kwargs) -> WebTrip:  # noqa: E501
    ...
    @validate_arguments
    def create_trip_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_trip : Annotated[WebTrip, Field(description="New essence creation request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Trip create  # noqa: E501
    ...
    @validate_arguments
    def delete_trip(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def read_trip(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> WebTrip:  # noqa: E501
        """Read trip  # noqa: E501
    ...
    @validate_arguments
    def read_trip_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read trip  # noqa: E501
    ...
    @validate_arguments
    def read_trips_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, sort_field : Annotated[Optional[TableTripColumnType], Field(description="Trip table column name. ")] = None, sort_direction : Annotated[Optional[StrictStr], Field(description="Sort direction.")] = None, table_trip_filter_list : Annotated[Optional[TableTripFilterList], Field(description="Trip filter.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Trip list  # noqa: E501
    ...
    @validate_arguments
    def read_trips_charts(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, sort_field : Annotated[Optional[TableTripColumnType], Field(description="Trip table column name. ")] = None, sort_direction : Annotated[Optional[StrictStr], Field(description="Sort direction.")] = None, table_trip_filter_list : Annotated[Optional[TableTripFilterList], Field(description="Trips filter.")] = None, **kwargs) -> WebTripChartList:  # noqa: E501
    ...
    @validate_arguments
    def read_trips_tracks(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], tracks_type : Annotated[BasicTracksType, Field(description="Tracks type.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, table_trip_filter_list : Annotated[Optional[TableTripFilterList], Field(description="Trips filter.")] = None, **kwargs) -> WebTripTrackList:  # noqa: E501
        ...
        :param experiment_key: Key, unique identifier. (required)
        :type experiment_key: str
        :param tracks_type: Tracks type. (required)
    ...
    @validate_arguments
    def read_trips_tracks_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], tracks_type : Annotated[BasicTracksType, Field(description="Tracks type.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, table_trip_filter_list : Annotated[Optional[TableTripFilterList], Field(description="Trips filter.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Trip tracks  # noqa: E501
    ...
    @validate_arguments
    def update_trip(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_trip : Annotated[WebTrip, Field(description="Essence update request.")], **kwargs) -> WebTrip:  # noqa: E501
    ...
    @validate_arguments
    def update_trip_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_trip : Annotated[WebTrip, Field(description="Essence update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Trip update  # noqa: E501
