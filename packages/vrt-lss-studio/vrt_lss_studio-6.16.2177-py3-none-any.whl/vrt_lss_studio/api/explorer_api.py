...
class ExplorerApi:
    ...
    @validate_arguments
    def delete_folder(self, folder_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Folder key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_folder_with_http_info(self, folder_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Folder key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Folder removal  # noqa: E501
    ...
    @validate_arguments
    def duplicate_folder(self, folder_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Folder key, unique identifier.")], folder_specification : Annotated[FolderSpecification, Field(description="Folder duplicate request.")], **kwargs) -> str:  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the duplicate_folder_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.duplicate_folder_with_http_info(folder_key, folder_specification, **kwargs)  # noqa: E501

    @validate_arguments
    def duplicate_folder_with_http_info(self, folder_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Folder key, unique identifier.")], folder_specification : Annotated[FolderSpecification, Field(description="Folder duplicate request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Folder duplicate  # noqa: E501
    ...
    @validate_arguments
    def read_filesystem(self, filter : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]], Field(description="Filter for searching by text fields.")] = None, **kwargs) -> Filesystem:  # noqa: E501
    ...
    @validate_arguments
    def read_filesystem_with_http_info(self, filter : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]], Field(description="Filter for searching by text fields.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Getting a filesystem  # noqa: E501
    ...
    @validate_arguments
    def read_folder(self, folder_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Folder key, unique identifier.")], filter : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]], Field(description="Filter for searching by text fields.")] = None, **kwargs) -> ExperimentList:  # noqa: E501
    ...
    @validate_arguments
    def read_folder_with_http_info(self, folder_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Folder key, unique identifier.")], filter : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=64)]], Field(description="Filter for searching by text fields.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Experiment list  # noqa: E501
    ...
    @validate_arguments
    def update_folder(self, folder_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Folder key, unique identifier.")], folder_specification : Annotated[FolderSpecification, Field(description="Folder update request.")], **kwargs) -> Filesystem:  # noqa: E501
    ...
    @validate_arguments
    def update_folder_with_http_info(self, folder_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Folder key, unique identifier.")], folder_specification : Annotated[FolderSpecification, Field(description="Folder update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update folder  # noqa: E501
