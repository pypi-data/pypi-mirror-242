...
class TransportsApi:
    ...
    @validate_arguments
    def create_transport(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_transport : Annotated[WebTransport, Field(description="New essence creation request.")], **kwargs) -> WebTransport:  # noqa: E501
    ...
    @validate_arguments
    def create_transport_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_transport : Annotated[WebTransport, Field(description="New essence creation request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create transport  # noqa: E501
    ...
    @validate_arguments
    def delete_transport(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def disable_transports_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Disable transports request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Disable transports  # noqa: E501
    ...
    @validate_arguments
    def enable_transports(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Enable transports request.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def enable_transports_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(min_length=0, max_length=15001, description="Enable transports request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Enable transports  # noqa: E501
    ...
    @validate_arguments
    def read_transport(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> WebTransport:  # noqa: E501
    ...
    @validate_arguments
    def read_transport_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Reading transport  # noqa: E501
    ...
    @validate_arguments
    def update_transport(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_transport : Annotated[WebTransport, Field(description="Essence update request.")], **kwargs) -> WebTransport:  # noqa: E501
    ...
    @validate_arguments
    def update_transport_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_transport : Annotated[WebTransport, Field(description="Essence update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update transport  # noqa: E501
