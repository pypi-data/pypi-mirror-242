...
class ExperimentsApi:
    ...
    @validate_arguments
    def create_experiment_share(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> Experiment:  # noqa: E501
        """Share experiment  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the create_experiment_share_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.create_experiment_share_with_http_info(experiment_key, **kwargs)  # noqa: E501

    @validate_arguments
    def create_experiment_share_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Share experiment  # noqa: E501
        ...
        >>> thread = api.create_experiment_share_with_http_info(experiment_key, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method create_experiment_share" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/studio/experiments/{experiment_key}/share', 'POST',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def delete_experiment(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def delete_experiment_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Experiment removal  # noqa: E501
    ...
    @validate_arguments
    def delete_experiment_share(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> Experiment:  # noqa: E501
        """Stop sharing  # noqa: E501

        Stop experiment sharing.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs['_return_http_data_only'] = True
        if '_preload_content' in kwargs:
            message = "Error! Please call the delete_experiment_share_with_http_info method with `_preload_content` instead and obtain raw data from ApiResponse.raw_data"  # noqa: E501
            raise ValueError(message)
        return self.delete_experiment_share_with_http_info(experiment_key, **kwargs)  # noqa: E501

    @validate_arguments
    def delete_experiment_share_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Stop sharing  # noqa: E501
        ...
        >>> thread = api.delete_experiment_share_with_http_info(experiment_key, async_req=True)
        >>> result = thread.get()
        ...
        for _key, _val in _params['kwargs'].items():
            if _key not in _all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method delete_experiment_share" % _key
                )
            _params[_key] = _val
        del _params['kwargs']
        ...
        return self.api_client.call_api(
            '/studio/experiments/{experiment_key}/share', 'DELETE',
            _path_params,
            _query_params,
            _header_params,
            body=_body_params,
    ...
    @validate_arguments
    def duplicate_experiment(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], experiment_specification : Annotated[ExperimentSpecification, Field(description="Experiment duplicate request.")], **kwargs) -> str:  # noqa: E501
    ...
    @validate_arguments
    def duplicate_experiment_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], experiment_specification : Annotated[ExperimentSpecification, Field(description="Experiment duplicate request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Experiment duplicate  # noqa: E501
    ...
    @validate_arguments
    def export_json(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> UniversalData:  # noqa: E501
    ...
    @validate_arguments
    def export_json_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Export (JSON)  # noqa: E501
    ...
    @validate_arguments
    def export_xlsx(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], timezone : Annotated[Optional[Annotated[int, Field(le=12, strict=True, ge=-12)]], Field(description="Timezone.")] = None, **kwargs) -> bytearray:  # noqa: E501
    ...
    @validate_arguments
    def export_xlsx_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], timezone : Annotated[Optional[Annotated[int, Field(le=12, strict=True, ge=-12)]], Field(description="Timezone.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Export (XLSX)  # noqa: E501
    ...
    @validate_arguments
    def import_json(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], universal_data : Annotated[UniversalData, Field(description="Data (JSON).")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def import_json_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], universal_data : Annotated[UniversalData, Field(description="Data (JSON).")], **kwargs) -> ApiResponse:  # noqa: E501
        """Import (JSON)  # noqa: E501
    ...
    @validate_arguments
    def import_json_url(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], url : Annotated[str, Field(min_length=10, strict=True, max_length=512, description="Url to json file.")], **kwargs) -> Experiment:  # noqa: E501
        """Import (JSON) from URL  # noqa: E501
    ...
    @validate_arguments
    def import_json_url_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], url : Annotated[str, Field(min_length=10, strict=True, max_length=512, description="Url to json file.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Import (JSON) from URL  # noqa: E501
    ...
    @validate_arguments
    def import_xlsx(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], body : Annotated[Union[StrictBytes, StrictStr], Field(description="Data (XLSX).")], timezone : Annotated[Optional[Annotated[int, Field(le=12, strict=True, ge=-12)]], Field(description="Timezone.")] = None, **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def read_experiment(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def read_experiment_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Reading experiment  # noqa: E501
    ...
    @validate_arguments
    def run_experiment_calculation(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], process_name : Annotated[BasicProcess, Field(description="Process name:   * `PLAN` - планирование   * `REPLAN` - перепланирование   * `ACTUALIZE` - актуализация ")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def run_experiment_calculation_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], process_name : Annotated[BasicProcess, Field(description="Process name:   * `PLAN` - планирование   * `REPLAN` - перепланирование   * `ACTUALIZE` - актуализация ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Run calculation  # noqa: E501
    ...
    @validate_arguments
    def run_experiment_validation_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], process_name : Annotated[BasicProcess, Field(description="Process name:   * `PLAN` - планирование   * `REPLAN` - перепланирование   * `ACTUALIZE` - актуализация ")], **kwargs) -> ApiResponse:  # noqa: E501
        """Run validation  # noqa: E501
    ...
    @validate_arguments
    def stop_experiment_calculation(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def stop_experiment_calculation_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Calculation stop  # noqa: E501
    ...
    @validate_arguments
    def update_experiment(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], experiment_specification : Annotated[ExperimentSpecification, Field(description="Experiment specification update request.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def update_experiment_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], experiment_specification : Annotated[ExperimentSpecification, Field(description="Experiment specification update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Experiment update  # noqa: E501
    ...
    @validate_arguments
    def update_experiment_indicators(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], request_body : Annotated[List[Annotated[str, Field(min_length=2, strict=True, max_length=256)]], Field(min_length=0, max_length=100, description="Indicators update request.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def update_experiment_settings(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], experiment_settings : Annotated[ExperimentSettings, Field(description="Experiment settings update request.")], **kwargs) -> Experiment:  # noqa: E501
    ...
    @validate_arguments
    def update_experiment_settings_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], experiment_settings : Annotated[ExperimentSettings, Field(description="Experiment settings update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Settings update  # noqa: E501
