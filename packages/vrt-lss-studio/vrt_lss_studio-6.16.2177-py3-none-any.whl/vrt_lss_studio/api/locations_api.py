...
class LocationsApi:
    ...
    @validate_arguments
    def create_location(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_location : Annotated[WebLocation, Field(description="New essence creation request.")], **kwargs) -> WebLocation:  # noqa: E501
    ...
    @validate_arguments
    def create_location_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_location : Annotated[WebLocation, Field(description="New essence creation request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create location  # noqa: E501
    ...
    @validate_arguments
    def delete_location(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> None:  # noqa: E501
    ...
    @validate_arguments
    def read_location(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> WebLocation:  # noqa: E501
    ...
    @validate_arguments
    def read_location_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], essence_key : Annotated[Optional[Annotated[str, Field(min_length=1, strict=True, max_length=1024)]], Field(description="Key, unique identifier.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Read location  # noqa: E501
    ...
    @validate_arguments
    def read_locations_geopoints(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, table_location_filter_list : Annotated[Optional[TableLocationFilterList], Field(description="Locations filter.")] = None, **kwargs) -> WebLocationGeopointList:  # noqa: E501
    ...
    @validate_arguments
    def read_locations_geopoints_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], offset : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=0)]], Field(description="The number of items to skip before starting to collect the result set.")] = None, limit : Annotated[Optional[Annotated[int, Field(le=10000000, strict=True, ge=1)]], Field(description="The number of items to return.")] = None, table_location_filter_list : Annotated[Optional[TableLocationFilterList], Field(description="Locations filter.")] = None, **kwargs) -> ApiResponse:  # noqa: E501
        """Location geopoints  # noqa: E501
    ...
    @validate_arguments
    def update_location(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_location : Annotated[WebLocation, Field(description="Essence update request.")], **kwargs) -> WebLocation:  # noqa: E501
    ...
    @validate_arguments
    def update_location_with_http_info(self, experiment_key : Annotated[str, Field(min_length=2, strict=True, max_length=256, description="Key, unique identifier.")], web_location : Annotated[WebLocation, Field(description="Essence update request.")], **kwargs) -> ApiResponse:  # noqa: E501
        """Update location  # noqa: E501
