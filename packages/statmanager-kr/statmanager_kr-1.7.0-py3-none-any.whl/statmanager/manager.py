...
class Stat_Manager:
    ...
    def progress(self, method: str, vars: list, group_vars: str = None, group_names: list = None, effectsize: bool = False, posthoc: bool = False, posthoc_method: str = 'bonf', selector: dict = None):
        ...
        Args:
            ...
            group_vars (str, optional): _description_. Defaults to None.
            group_names (list, optional): _description_. Defaults to None.
            effectsize (bool, optional): _description_. Defaults to False.
            posthoc (bool, optional): _description_. Defaults to False.
            posthoc_method (str, optional): _description_. Defaults to 'bonf'.
            selector (dict, optional): _description_. Defaults to None.
    ...
    def howtouse(self, keyword = None):
        print(self.link)
