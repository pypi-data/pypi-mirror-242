...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.enableManualWorkFolderSelectionCheckBox = QtWidgets.QCheckBox(self.tab_10)
        self.enableManualWorkFolderSelectionCheckBox.setObjectName("enableManualWorkFolderSelectionCheckBox")
        self.verticalLayout_31.addWidget(self.enableManualWorkFolderSelectionCheckBox)
        ...
        self.applyDarkFlatCorrectionsCheckBox.setMinimumSize(QtCore.QSize(90, 0))
        self.applyDarkFlatCorrectionsCheckBox.setMaximumSize(QtCore.QSize(90, 16777215))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.readAviFileButton.setText(_translate("MainWindow", "Open AVI/MOV/SER/ADV/AAV/RAVF file"))
        self.createAVIWCSfolderButton.setToolTip(_translate("MainWindow", "<html><head/><body><p>This button will only be active when a \'bare\' avi/mov/ser/adv/aav/ravf file is opened (rather than from an AVI/MOV/SER/ADV/AAV/RAVF-WCS folder) and manual selection of work folder is enabled (using the check box on the <span style=\" font-weight:700; color:#0000ff;\">Median/Misc</span> tab).</p><p>This button has been added because of the decision to perform timestamp OCR only on files that live in an AVI/MOV/SER/ADV/AAV/RAVF-WCS folder. While that is a good way to collect the (many) files that result from OCR, WCS, PyMovie, and PyOTE operations, there are likely to be users that have opted for a flat (or flatter) directory structure. This button will ease (hopefully) the transition to an alternate file organization.</p><p>When clicked, a Directory dialog will appear to allow the user to select (or even create) the directory that is to hold the newly created (and filled) AVI/MOV/SER/ADV/AAV/RAVF-WCS folder. It defaults to the directory that holds the opened video file.</p><p>The name of the newly created AVI/MOV/SER/ADV/AAV/RAVF-WCS folder will always be the name of the video file with its outermost extension removed.</p><p>The folder will then be populated with an alias (Mac) to the video or a Shortcut (Windows) to the video, so this file structure will be frugal with file space.</p><p>Finally, behind-the-scenes, the program simulates the user clicking on <span style=\" font-weight:600; color:#fc0107;\">Select AVI/MOV/SER/ADV/AAV/RAVF-WCS folder</span> button and then clicking on <span style=\" font-weight:600; color:#fc0107;\">Accept</span> (possible because after a \'creation of AVI/MOV/SER/ADV/AAV/RAVF-WCS folder\', the default directory/folder is set to that of the newly created folder). We could not imagine a workflow where a user would <span style=\" font-weight:600;\">not</span> want to immediately start processing the video from within an AVI/MOV/SER/ADV/AAV/RAVF-WCS folder, so the automation seems reasonable and unlikely to get in anyone\'s way.<br/></p></body></html>"))
        self.createAVIWCSfolderButton.setText(_translate("MainWindow", "Create AVI/MOV/SER/ADV/AAV/RAVF-WCS folder from file"))
        ...
        self.selectAviWcsFolderButton.setText(_translate("MainWindow", "Select AVI/MOV/SER/ADV/AAV/RAVF-WCS folder"))
        ...
        self.metadataButton.setText(_translate("MainWindow", "Show FITS/SER/ADV/AAV/RAVF file metadata"))
        ...
        self.enableAdvFrameStatusDisplay.setText(_translate("MainWindow", "Display frame metadata for ADV/AAV/RAVF frames"))
