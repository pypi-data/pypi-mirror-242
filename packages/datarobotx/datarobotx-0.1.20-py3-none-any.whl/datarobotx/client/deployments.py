...
from datarobotx.common.client import raise_status_error, raise_value_error, read_resp_data, session
...
async def get_model_packages(model_package_id: str) -> Dict[str, Any]:
    """Return the model package ostensibly from a deployment to understand its capabilities."""
