...
class ModelingModeConfig(DrxConfig):  # type: ignore[type-arg]
    ...
    monotonic_increasing_featurelist_id : str
        ...
        project that can be overriden at model submission time if desired.
    ...
    def monotonic_increasing_featurelist_id(self) -> str:
        ...
        the project that can be overriden at model submission time if desired.
...
class TargetAutoMLConfig(DrxConfig):  # type: ignore[type-arg]
    ...
    @property
    def model_baselines(self) -> List[str]:
        """
        An array of strings with names of a columns specifying row model baselines.The
        data in this column must be pure numeric (e.g. not currency, date,
        length, etc.).
        ...
        model_baselines : list of str
        """
        return self._model_baselines

    @model_baselines.setter
    def model_baselines(self, value: List[str]) -> None:
        self._model_baselines = value
    ...
    def model_group_id(self, value: str) -> None:
        self._model_group_id = value

    @property
    def model_regime_id(self) -> str:
        """
        The name of a column specifying row model regime id.
        ...
        model_regime_id : str
        """
        return self._model_regime_id

    @model_regime_id.setter
    def model_regime_id(self, value: str) -> None:
        self._model_regime_id = value
