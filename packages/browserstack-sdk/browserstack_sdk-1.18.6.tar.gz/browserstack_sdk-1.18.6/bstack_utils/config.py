...
conf = {
    bstack1l1ll1l_opy_ (u"࠭ࡡࡱࡲࡢࡥࡺࡺ࡯࡮ࡣࡷࡩࠬᎯ"): False,
    bstack1l1ll1l_opy_ (u"ࠧࡣࡵࡷࡥࡨࡱ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࠨᎰ"): True,
}
class Config(object):
    instance = None
    def __init__(self):
        self._111l1llll1_opy_ = conf
    @classmethod
    ...
    def get_property(self, property_name):
        return self._111l1llll1_opy_.get(property_name, None)
    def bstack11l11ll1_opy_(self, property_name, bstack111l1lllll_opy_):
        self._111l1llll1_opy_[property_name] = bstack111l1lllll_opy_