...
class SimpleGuiFunctionsManager:
    ...
    def _resolve_function_name(self, function_name):
        ...
        if function_name not in self.function_names:
            function_name = find_original_case(self.function_names, function_name) or \
                            get_closest_match_from_list(comp_str=function_name, total_list=self.function_names)
