...
if TYPE_CHECKING:
    from ..models.windmill_file_preview_content_preview import WindmillFilePreviewContentPreview
...
class WindmillFilePreview:
    """
    Attributes:
        content_preview (WindmillFilePreviewContentPreview):
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        content_preview = WindmillFilePreviewContentPreview.from_dict(d.pop("content_preview"))
