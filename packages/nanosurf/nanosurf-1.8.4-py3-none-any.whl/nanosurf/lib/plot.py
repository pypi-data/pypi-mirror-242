...
def plot_bode(plot_data:Union[ss.SciStream,list[ss.SciStream], Tuple[list,list, list]], title:str = None, amp_as_dB: bool = False, show:bool=True) -> Tuple[plt.Figure, list[plt.Axes]]:
...
def plot_spectrum(plot_data:Union[ss.SciStream,list[ss.SciStream]], ch_list:list[int] = None, individual_plots:bool = True, title:str = None, as_dB: bool = False, show:bool=True) -> Tuple[plt.Figure, list[plt.Axes]]:
    ...
    """
    return plot_stream(plot_data, ch_list = ch_list, individual_plots=individual_plots, title=title, as_dB=as_dB,show=show, log_x=True, log_y=False)
