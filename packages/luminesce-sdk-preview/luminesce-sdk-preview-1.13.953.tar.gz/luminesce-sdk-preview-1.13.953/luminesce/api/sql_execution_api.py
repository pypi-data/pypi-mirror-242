...
"""
    ...
    The version of the OpenAPI document: 1.13.953
...
class SqlExecutionApi(object):
    ...
    def get_by_query_csv_with_http_info(self, query, **kwargs):  # noqa: E501
        ...
        header_params['X-LUSID-SDK-Version'] = '1.13.953'
    ...
    def put_sql_to_file_read_design(self, body, **kwargs):  # noqa: E501
        ...
        >>> thread = api.put_sql_to_file_read_design(body, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.put_sql_to_file_read_design_with_http_info(body, **kwargs)  # noqa: E501

    def put_sql_to_file_read_design_with_http_info(self, body, **kwargs):  # noqa: E501
        """[EXPERIMENTAL] PutSqlToFileReadDesign: Generates a SQL-file-read-design object from SQL string, if possible.  # noqa: E501
        ...
        >>> thread = api.put_sql_to_file_read_design_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and ('body' not in local_var_params or  # noqa: E501
                                                        local_var_params['body'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `body` when calling `put_sql_to_file_read_design`")  # noqa: E501
