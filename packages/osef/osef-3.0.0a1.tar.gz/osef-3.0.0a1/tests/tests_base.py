...
class BaseTestCase(TestCase):
    ...
    EXAMPLE_TRACKING_FILEPATH = str(RESOURCES.joinpath("alb_tracking_mode_record.osef"))
    LIGHT_TRACKING_FILEPATH = str(RESOURCES.joinpath("light_tracking_record.osef"))
    SLAM_FILEPATH = str(RESOURCES.joinpath("alb_slam_mode_record.osef"))
    PASSTHROUGH_FILEPATH = str(RESOURCES.joinpath("alb_passthrough_mode_record.osef"))
    ...
    ONE_FRAME_TRACKING_RECORD = str(
        RESOURCES.joinpath("one_frame_tracking_record.osef")
    )
    ...
    ITS_TRACKING_RECORD = str(RESOURCES.joinpath("its_tracking_record.osef"))
