from alpr.schema import constraint
...
class Graph(networkx.Graph):
    ...
    def replace_matching_subgraph(self, subgraph, skip=None, node_match=None, edge_match=None):
        ...
        new_subckt_names = self._replace_matches_with_subckt(matches, subgraph.subckt, skip)
        # print('01',matches)
        # print('02',new_subckt_names)
        # print('03',skip,subgraph)
