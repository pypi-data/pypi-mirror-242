...
def get(table: str, value: str, where: str = None, fetchone: bool = True, cog_file: bool = True) -> str | None | list:
...
def insert(table: str, parameter: list, values: list, cog_file: bool = True):
...
def edit(table: str, parameter: str, value: str, where: str = None, cog_file: bool = True):

    # Get database file path
    print(inspect.getmodule(inspect.currentframe().f_back).__file__)
    path = inspect.getmodule(inspect.currentframe().f_back).__file__.replace('\\', '/').split('/')
    path.pop(-1)
    if cog_file is True:
        path.pop(-1)
...
def delete(table: str, value: str = None, where: str = None, cog_file: bool = True):
