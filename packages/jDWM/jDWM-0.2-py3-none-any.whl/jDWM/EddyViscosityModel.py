...
class EddyViscosityModel(CustomBaseModel):
    ...
    filter: FilterFunctions.FilterFunction = None
    ...
    def get_subclass(cls, name):
        for _cls in cls.__subclasses__():
            ...
            raise AttributeError(f"{name} not found among viscosity models.")
...
class madsen(EddyViscosityModel):
    ...
    def __init__(self, **kwargs):
        ...
        self.filter = FilterFunctions.madsen(**kwargs)

    def function(self, x, r, U):
        """
...
class larsen(EddyViscosityModel):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.filter = FilterFunctions.larsen(**kwargs)
...
class IEC(EddyViscosityModel):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.filter = FilterFunctions.IEC(**kwargs)
...
class keck(EddyViscosityModel):
    ...
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.filter = FilterFunctions.keck(**kwargs)
