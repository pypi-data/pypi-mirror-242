...
class StaticWake(utilities.CustomBaseModel):
    ...
    def __init__(
        self,
        axial_induction_model="Joukowsky",
        viscosity_model="madsen",
        boundary_model="madsen",
        meandercompensator="none",
        solver="implicit",
        **kwargs,
    ):
    ...
    def solve(self, Nx=101, x_max=10, **kwargs):
        ...
        r, a = self.axial_induction_model.function(**kwargs)
        Nr = len(r)
...
class Particle(utilities.CustomBaseModel):
    ...
    def evolve_profile(self, dx):
        ...
        visc = self.viscosity_model.function(self.x, self.r, self.U)
...
class DynamicWake(utilities.CustomBaseModel):
    ...
    def _update_boundary_particle(self):
        r, a = self.axial_induction_model.function()
        U, V = self.boundary_condition.function(r, a)
