...
class MeanderCompensator(CustomBaseModel):
    ...
    def get_subclass(cls, name):
        for _cls in cls.__subclasses__():
            ...
            raise AttributeError(f"{name} not found among boundary condition models.")
...
class none(MeanderCompensator):
    ...
    def function(self, r_in, x_in, U_in, V_in, widths_in, **kwargs):
...
class Reinwardt(MeanderCompensator):
    ...
    def update(self, **params):
        ...
        self.base_std_dev = np.sqrt(np.trapz(spec, f))
