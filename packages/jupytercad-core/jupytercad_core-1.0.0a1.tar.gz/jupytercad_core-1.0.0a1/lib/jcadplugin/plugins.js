...
import { IAnnotationToken, IJCadWorkerRegistryToken, IJupyterCadDocTracker, JupyterCadDoc } from '@jupytercad/schema';
...
const activate = (app, tracker, themeManager, annotationModel, browserFactory, drive, workerRegistry, launcher, palette) => {
