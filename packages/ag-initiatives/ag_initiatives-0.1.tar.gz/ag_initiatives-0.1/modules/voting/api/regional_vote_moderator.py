...
# from modules.voting.api.serializers.municipal_vote_moderator_srlz import (
#     VoteModeratorCreateAnswerSerializerNew,
#     VoteModeratorCreateQuestionSerializerNew,
#     VoteModeratorUpdateAnswerSerializerNew,
#     VoteModeratorUpdateQuestionSerializerNew,
#     VoteModeratorUpdateSerializerNew
# )
...
class RegionalVoteModeratorAPI(viewsets.ReadOnlyModelViewSet):
    queryset = (
        VoteRegional.objects.filter(state__in=[VoteState.CREATED])
    ...
    @transaction.atomic
    @action(methods=["get", "put"], detail=True, url_path="regional-update-details")
