...
class VoteMunicipalQuestion(models.Model):
    """
    Вопрос голосования.
    ...
    vote = models.ForeignKey(
        to="voting.VoteMunicipal",
        verbose_name="Голосование",
        related_name="municipal_questions",
    ...
    photo = models.ForeignKey(
        ...
        to="core.File",
        on_delete=models.CASCADE,
        related_name="vote_municipal_questions_images",
    )
    ...
    class Meta:
        verbose_name = "Вопросы для муниципального голосования"
        verbose_name_plural = "Вопросы для муниципальных голосований"
