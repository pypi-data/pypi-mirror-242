...
class VoteMunicipal(models.Model):
    """
    Конкретное муниципальное голосование.
    ...
    municipal_formation = models.ManyToManyField(
        ...
        related_name = "vote_municipality",
    )
    locality = models.ManyToManyField(
        to="core.Locality",
        verbose_name="Населенный пункт",
        blank=True,
        related_name = "vote_locality"
    )
    ...
    brief_image = models.ForeignKey(
        ...
        to="core.File",
        on_delete=models.CASCADE,
        related_name="votes_municipal_brief_images",
    )
    ...
    multi_municipality_vote = models.BooleanField(
    ...
    age_restriction_start = models.SmallIntegerField(verbose_name="Ограничение С какого возраста", blank=True, null=True)
    age_restriction_finish = models.SmallIntegerField(verbose_name="Ограничение ДО какого возраста", blank=True, null=True)
    ...
    image = models.ForeignKey(
        ...
        to="core.File",
        on_delete=models.CASCADE,
        related_name="municipal_vote_image",
    )
