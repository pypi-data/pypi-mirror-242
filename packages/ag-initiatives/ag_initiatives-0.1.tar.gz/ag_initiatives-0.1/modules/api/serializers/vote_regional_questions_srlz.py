...
from modules.api.serializers import VoteRegionalAnswerSerializer, FileField
...
class VoteRegionalQuestionSerializer(
    serializers.ModelSerializer, VotedUsersCountMixin, VotesCountMixin
):
    answers = VoteRegionalAnswerSerializer(many=True, read_only=True, source="regional_answers")
    photo = FileField()
