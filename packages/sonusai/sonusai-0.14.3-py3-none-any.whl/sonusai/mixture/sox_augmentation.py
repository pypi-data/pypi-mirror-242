...
def apply_sox_augmentation(audio: AudioT, augmentation: Augmentation, length_common_denominator: int = 1) -> AudioT:
    ...
    from .augmentation import _pad_audio
...
def apply_sox_ir(audio: AudioT, ir: ImpulseResponseData) -> AudioT:
