...
def main() -> None:
    ...
    if ext == '.wav':
        ...
        targets = [mixdb.targets[tfi] for tfi in mixdb.mixtures[mixid].target_id]
        ...
        for n in range(len(mixture_record.target_id)):
            name = mixdb.targets[mixture_record.target_id[n]].name
            duration = mixdb.targets[mixture_record.target_id[n]].duration
            augmentation = mixdb.target_augmentations[mixture_record.target_augmentation_id[n]]
