...
def balance_targets(augmented_targets: AugmentedTargets,
                    ...
                    class_balancing_augmentation: Augmentation,
                    num_classes: int,
                    truth_mutex: bool,
                    num_ir: int,
                    first_cba_id: int) -> tuple[AugmentedTargets, Augmentations]:
    import numpy as np
...
def _get_unused_balancing_augmentation(augmented_targets: AugmentedTargets,
                                       ...
                                       mixup: int,
                                       num_ir: int,
                                       first_cba_id: int) -> tuple[int, Augmentations]:
    ...
    new_augmentation = get_augmentations(rules=asdict(class_balancing_augmentation), num_ir=num_ir)[0]
...
def get_class_balancing_augmentation(target: TargetFile, default_cba: Augmentation) -> Augmentation | None:
