...
def lsdb(mixdb: MixtureDatabase,
    ...
    logger.info(f'{"Targets":{desc_len}} {mixdb.num_targets}')
    logger.info(f'{"Target augmentations":{desc_len}} {mixdb.num_target_augmentations}')
    logger.info(f'{"Noise augmentations":{desc_len}} {mixdb.num_noise_augmentations}')
    logger.info(f'{"Noises":{desc_len}} {mixdb.num_noises}')
    ...
    if list_targets:
        ...
        idx_len = max_text_width(mixdb.num_targets)
