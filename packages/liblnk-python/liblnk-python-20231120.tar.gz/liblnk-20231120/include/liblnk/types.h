...
#if !defined( _LIBLNK_TYPES_H )
#define _LIBLNK_TYPES_H
...
#define __USE_UNIX98
#define LIBLNK_DEFINITION_UNIX98
#endif

#include <wchar.h>

#if defined( LIBLNK_DEFINITION_UNIX98 )
#undef __USE_UNIX98
#undef LIBLNK_DEFINITION_UNIX98
#endif
