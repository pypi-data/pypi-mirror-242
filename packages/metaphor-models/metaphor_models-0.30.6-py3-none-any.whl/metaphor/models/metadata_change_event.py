...
class Dashboard:
    ...
    def from_dict(obj: Any) -> 'Dashboard':
        ...
        return Dashboard(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, dashboard_created_at, dashboard_info, deleted_at, display_name, entity_type, entity_upstream, force_shown, dashboard_id, is_complete, is_deleted, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, source_info, structure, upstream, dashboard_versioned_id)
...
class Dataset:
    ...
    def from_dict(obj: Any) -> 'Dataset':
        ...
        return Dataset(created_at, id, versioned_id, asset_contacts, asset_followers, asset_governed_tags, dataset_created_at, custom_metadata, data_quality, deleted_at, description_assignment, display_name, documentation, entity_type, entity_upstream, field_associations, field_statistics, force_shown, dataset_id, is_complete, is_deleted, is_production, last_ingested_at, last_modified_at, logical_id, overall_data_quality, ownership_assignment, parsed_lineage, pipeline_info, schema, snowflake_stream_info, soda_data_quality, source_info, statistics, structure, tag_assignment, unity_catalog, upstream, usage, dataset_versioned_id)
