...
def gen_all_data(smiles_file: str, num_mol: int, csv_file: str, min_atom: int, max_atom: int, num_cpus: int,
                 ...
                 gen_demo_img: bool, gen_mol_drawing:bool, img_show: bool,
...
def main() -> None:
    ...
    parser.add_argument("--gen_demo_img", type=bool, default=True, help="Whether to generate original images.")
    ...
    gen_all_data(smiles_file=args.smiles_file, num_mol=args.num_mol, csv_file=args.csv_file, min_atom=args.min_atom,
                 ...
                 use_gaussian_noise=args.use_gaussian_noise, gen_demo_img=args.gen_demo_img, gen_mol_drawing=args.gen_mol_drawing,
                 img_show=False,
