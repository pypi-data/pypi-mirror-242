...
from gmlutil import data_extraction as dte
...
#             df.columns = df.columns.str.lower()
            ...
            for upc in upc_list:
                try:
                    try:
                        search_dict = self.search_func(upc, conf.bucket_name, conf.brand_standards_str)
                    except:
                        search_dict = self.search_func(upc, conf.bucket_name_prd, conf.brand_standards_str)
