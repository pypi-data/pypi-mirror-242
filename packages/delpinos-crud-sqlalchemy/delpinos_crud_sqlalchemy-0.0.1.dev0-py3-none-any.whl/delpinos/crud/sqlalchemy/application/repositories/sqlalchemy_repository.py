...
from delpinos.crud.sqlalchemy.connection import SqlAlchemySession
...
class SqlAlchemyRepository(BaseRepository):
    def add_factories(self):
        ...
        self.add_factory(
            ...
            lambda config: SqlAlchemySession(**config),
        )
        self.add_factory(
            "sqlalchemy.session",
    ...
    @property
    def sqlalchemy_connection(self) -> SqlAlchemySession:
