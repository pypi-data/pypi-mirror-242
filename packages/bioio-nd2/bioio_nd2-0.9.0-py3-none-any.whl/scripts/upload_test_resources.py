...
from bioio_nd2 import __version__
...
def upload_test_resources(args: Args):
    ...
    try:
        ...
        resources_dir = (
            Path(__file__).parent.parent / "bioio_nd2" / "tests" / "resources"
        ).resolve(strict=True)
        ...
        package_name = "bioio_nd2/test_resources"
        ...
        # Upload
            ...
            if confirmation:
                pushed = package.push(
                    ...
                    message=f"Test resources for `bioio_nd2` version: {__version__}.",
                )
