...
class UserArgs:
    def __init__(__self__, *,
        ...
        UserArgs._configure(
            ...
            role_ids=role_ids,
            tenant_id=tenant_id,
            automatically_verify=automatically_verify,
            password=password,
    ...
    def _configure(
        ...
        if automatically_verify is None and 'automaticallyVerify' in kwargs:
            automatically_verify = kwargs['automaticallyVerify']
        if skip_invite_email is None and 'skipInviteEmail' in kwargs:
            skip_invite_email = kwargs['skipInviteEmail']

        _setter("email", email)
        _setter("role_ids", role_ids)
        _setter("tenant_id", tenant_id)
        if automatically_verify is not None:
            _setter("automatically_verify", automatically_verify)
        if password is not None:
            _setter("password", password)
        if skip_invite_email is not None:
            _setter("skip_invite_email", skip_invite_email)
