...
class WorkspaceArgs:
    def __init__(__self__, *,
        ...
        WorkspaceArgs._configure(
            ...
            open_saas_installed=open_saas_installed,
            password_policy=password_policy,
            bulk_tenants_invites_email=bulk_tenants_invites_email,
            captcha_policy=captcha_policy,
            custom_domain=custom_domain,
            facebook_social_login=facebook_social_login,
            github_social_login=github_social_login,
            google_social_login=google_social_login,
            hosted_login=hosted_login,
            lockout_policy=lockout_policy,
            magic_code_email=magic_code_email,
            magic_link_email=magic_link_email,
            mfa_authentication_app=mfa_authentication_app,
            microsoft_social_login=microsoft_social_login,
            name=name,
            new_device_connected_email=new_device_connected_email,
            oidc=oidc,
            pwned_password_email=pwned_password_email,
            reset_password_email=reset_password_email,
            reset_phone_number_email=reset_phone_number_email,
            saml=saml,
            user_activation_email=user_activation_email,
            user_invitation_email=user_invitation_email,
            user_used_invitation_email=user_used_invitation_email,
        )
    @staticmethod
    def _configure(
             ...
             **kwargs):
        if admin_portal is None and 'adminPortal' in kwargs:
            admin_portal = kwargs['adminPortal']
        if admin_portal is None:
            raise TypeError("Missing 'admin_portal' argument")
        ...
        if auth_policy is None and 'authPolicy' in kwargs:
            auth_policy = kwargs['authPolicy']
        if auth_policy is None:
            raise TypeError("Missing 'auth_policy' argument")
        if backend_stack is None and 'backendStack' in kwargs:
            backend_stack = kwargs['backendStack']
        if backend_stack is None:
            raise TypeError("Missing 'backend_stack' argument")
        if country is None:
            raise TypeError("Missing 'country' argument")
        if frontegg_domain is None and 'fronteggDomain' in kwargs:
            frontegg_domain = kwargs['fronteggDomain']
        if frontegg_domain is None:
            raise TypeError("Missing 'frontegg_domain' argument")
        if frontend_stack is None and 'frontendStack' in kwargs:
            frontend_stack = kwargs['frontendStack']
        if frontend_stack is None:
            raise TypeError("Missing 'frontend_stack' argument")
        if mfa_policy is None and 'mfaPolicy' in kwargs:
            mfa_policy = kwargs['mfaPolicy']
        if mfa_policy is None:
            raise TypeError("Missing 'mfa_policy' argument")
        if open_saas_installed is None and 'openSaasInstalled' in kwargs:
            open_saas_installed = kwargs['openSaasInstalled']
        if open_saas_installed is None:
            raise TypeError("Missing 'open_saas_installed' argument")
        ...
        if bulk_tenants_invites_email is None and 'bulkTenantsInvitesEmail' in kwargs:
            bulk_tenants_invites_email = kwargs['bulkTenantsInvitesEmail']
        if captcha_policy is None and 'captchaPolicy' in kwargs:
            captcha_policy = kwargs['captchaPolicy']
        if custom_domain is None and 'customDomain' in kwargs:
            custom_domain = kwargs['customDomain']
        if facebook_social_login is None and 'facebookSocialLogin' in kwargs:
            facebook_social_login = kwargs['facebookSocialLogin']
        if github_social_login is None and 'githubSocialLogin' in kwargs:
            github_social_login = kwargs['githubSocialLogin']
        if google_social_login is None and 'googleSocialLogin' in kwargs:
            google_social_login = kwargs['googleSocialLogin']
        if hosted_login is None and 'hostedLogin' in kwargs:
            hosted_login = kwargs['hostedLogin']
        if lockout_policy is None and 'lockoutPolicy' in kwargs:
            lockout_policy = kwargs['lockoutPolicy']
        if magic_code_email is None and 'magicCodeEmail' in kwargs:
            magic_code_email = kwargs['magicCodeEmail']
        if magic_link_email is None and 'magicLinkEmail' in kwargs:
            magic_link_email = kwargs['magicLinkEmail']
        if mfa_authentication_app is None and 'mfaAuthenticationApp' in kwargs:
            mfa_authentication_app = kwargs['mfaAuthenticationApp']
        if microsoft_social_login is None and 'microsoftSocialLogin' in kwargs:
            microsoft_social_login = kwargs['microsoftSocialLogin']
        if new_device_connected_email is None and 'newDeviceConnectedEmail' in kwargs:
            new_device_connected_email = kwargs['newDeviceConnectedEmail']
        if pwned_password_email is None and 'pwnedPasswordEmail' in kwargs:
            pwned_password_email = kwargs['pwnedPasswordEmail']
        if reset_password_email is None and 'resetPasswordEmail' in kwargs:
            reset_password_email = kwargs['resetPasswordEmail']
        if reset_phone_number_email is None and 'resetPhoneNumberEmail' in kwargs:
            reset_phone_number_email = kwargs['resetPhoneNumberEmail']
        if user_activation_email is None and 'userActivationEmail' in kwargs:
            user_activation_email = kwargs['userActivationEmail']
        if user_invitation_email is None and 'userInvitationEmail' in kwargs:
            user_invitation_email = kwargs['userInvitationEmail']
        if user_used_invitation_email is None and 'userUsedInvitationEmail' in kwargs:
            user_used_invitation_email = kwargs['userUsedInvitationEmail']

        _setter("admin_portal", admin_portal)
        _setter("allowed_origins", allowed_origins)
        _setter("auth_policy", auth_policy)
        _setter("backend_stack", backend_stack)
        _setter("country", country)
        _setter("frontegg_domain", frontegg_domain)
        _setter("frontend_stack", frontend_stack)
        _setter("mfa_policy", mfa_policy)
        _setter("open_saas_installed", open_saas_installed)
        _setter("password_policy", password_policy)
        if bulk_tenants_invites_email is not None:
            _setter("bulk_tenants_invites_email", bulk_tenants_invites_email)
        if captcha_policy is not None:
            _setter("captcha_policy", captcha_policy)
        if custom_domain is not None:
            _setter("custom_domain", custom_domain)
        if facebook_social_login is not None:
            _setter("facebook_social_login", facebook_social_login)
        if github_social_login is not None:
            _setter("github_social_login", github_social_login)
        if google_social_login is not None:
            _setter("google_social_login", google_social_login)
        if hosted_login is not None:
            _setter("hosted_login", hosted_login)
        if lockout_policy is not None:
            _setter("lockout_policy", lockout_policy)
        if magic_code_email is not None:
            _setter("magic_code_email", magic_code_email)
        if magic_link_email is not None:
            _setter("magic_link_email", magic_link_email)
        if mfa_authentication_app is not None:
            _setter("mfa_authentication_app", mfa_authentication_app)
        if microsoft_social_login is not None:
            _setter("microsoft_social_login", microsoft_social_login)
        if name is not None:
            _setter("name", name)
        if new_device_connected_email is not None:
            _setter("new_device_connected_email", new_device_connected_email)
        if oidc is not None:
            _setter("oidc", oidc)
        if pwned_password_email is not None:
            _setter("pwned_password_email", pwned_password_email)
        if reset_password_email is not None:
            _setter("reset_password_email", reset_password_email)
        if reset_phone_number_email is not None:
            _setter("reset_phone_number_email", reset_phone_number_email)
        if saml is not None:
            _setter("saml", saml)
        if user_activation_email is not None:
            _setter("user_activation_email", user_activation_email)
        if user_invitation_email is not None:
            _setter("user_invitation_email", user_invitation_email)
        if user_used_invitation_email is not None:
            _setter("user_used_invitation_email", user_used_invitation_email)
...
class Workspace(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            admin_portal = _utilities.configure(admin_portal, WorkspaceAdminPortalArgs, True)
            ...
            auth_policy = _utilities.configure(auth_policy, WorkspaceAuthPolicyArgs, True)
            ...
            bulk_tenants_invites_email = _utilities.configure(bulk_tenants_invites_email, WorkspaceBulkTenantsInvitesEmailArgs, True)
            __props__.__dict__["bulk_tenants_invites_email"] = bulk_tenants_invites_email
            captcha_policy = _utilities.configure(captcha_policy, WorkspaceCaptchaPolicyArgs, True)
            ...
            facebook_social_login = _utilities.configure(facebook_social_login, WorkspaceFacebookSocialLoginArgs, True)
            ...
            github_social_login = _utilities.configure(github_social_login, WorkspaceGithubSocialLoginArgs, True)
            __props__.__dict__["github_social_login"] = github_social_login
            google_social_login = _utilities.configure(google_social_login, WorkspaceGoogleSocialLoginArgs, True)
            __props__.__dict__["google_social_login"] = google_social_login
            hosted_login = _utilities.configure(hosted_login, WorkspaceHostedLoginArgs, True)
            __props__.__dict__["hosted_login"] = hosted_login
            lockout_policy = _utilities.configure(lockout_policy, WorkspaceLockoutPolicyArgs, True)
            __props__.__dict__["lockout_policy"] = lockout_policy
            magic_code_email = _utilities.configure(magic_code_email, WorkspaceMagicCodeEmailArgs, True)
            __props__.__dict__["magic_code_email"] = magic_code_email
            magic_link_email = _utilities.configure(magic_link_email, WorkspaceMagicLinkEmailArgs, True)
            __props__.__dict__["magic_link_email"] = magic_link_email
            mfa_authentication_app = _utilities.configure(mfa_authentication_app, WorkspaceMfaAuthenticationAppArgs, True)
            __props__.__dict__["mfa_authentication_app"] = mfa_authentication_app
            mfa_policy = _utilities.configure(mfa_policy, WorkspaceMfaPolicyArgs, True)
            ...
            microsoft_social_login = _utilities.configure(microsoft_social_login, WorkspaceMicrosoftSocialLoginArgs, True)
            __props__.__dict__["microsoft_social_login"] = microsoft_social_login
            __props__.__dict__["name"] = name
            new_device_connected_email = _utilities.configure(new_device_connected_email, WorkspaceNewDeviceConnectedEmailArgs, True)
            __props__.__dict__["new_device_connected_email"] = new_device_connected_email
            oidc = _utilities.configure(oidc, WorkspaceOidcArgs, True)
            ...
            password_policy = _utilities.configure(password_policy, WorkspacePasswordPolicyArgs, True)
            if password_policy is None and not opts.urn:
                raise TypeError("Missing required property 'password_policy'")
            __props__.__dict__["password_policy"] = password_policy
            pwned_password_email = _utilities.configure(pwned_password_email, WorkspacePwnedPasswordEmailArgs, True)
            __props__.__dict__["pwned_password_email"] = pwned_password_email
            reset_password_email = _utilities.configure(reset_password_email, WorkspaceResetPasswordEmailArgs, True)
            __props__.__dict__["reset_password_email"] = reset_password_email
            reset_phone_number_email = _utilities.configure(reset_phone_number_email, WorkspaceResetPhoneNumberEmailArgs, True)
            __props__.__dict__["reset_phone_number_email"] = reset_phone_number_email
            saml = _utilities.configure(saml, WorkspaceSamlArgs, True)
            __props__.__dict__["saml"] = saml
            user_activation_email = _utilities.configure(user_activation_email, WorkspaceUserActivationEmailArgs, True)
            __props__.__dict__["user_activation_email"] = user_activation_email
            user_invitation_email = _utilities.configure(user_invitation_email, WorkspaceUserInvitationEmailArgs, True)
            __props__.__dict__["user_invitation_email"] = user_invitation_email
            user_used_invitation_email = _utilities.configure(user_used_invitation_email, WorkspaceUserUsedInvitationEmailArgs, True)
