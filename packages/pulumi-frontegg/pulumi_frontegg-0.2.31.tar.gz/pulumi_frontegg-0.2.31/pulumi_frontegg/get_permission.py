...
class GetPermissionResult:
    ...
    """
    def __init__(__self__, category_id=None, created_at=None, description=None, id=None, key=None, name=None):
...
def get_permission(key: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('frontegg:index/getPermission:getPermission', __args__, opts=opts, typ=GetPermissionResult).value
