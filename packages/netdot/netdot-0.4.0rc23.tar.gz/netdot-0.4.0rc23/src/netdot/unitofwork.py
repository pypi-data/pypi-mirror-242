...
'''
    ...
    def status_report(self, terse=defaults.TERSE):
        ...
        Args:
            terse (bool, optional): Whether to truncate each line according to your terminal width. Defaults to defaults.TERSE.
        """
        message = f'''
Completed Actions:
...
'''
    ...
    def dry_run(self, terse=defaults.TERSE) -> str:
