...
class NetdotAction(CSVDataclass):
    ...
    def as_table_row(self, select_columns: Iterable[str] = None, maxchars=defaults.TERSE_MAX_CHARS, display_full_objects=defaults.DISPLAY_FULL_OBJECTS) -> Tuple[str, ...]:
        ...
        Args:
            ...
            maxchars (int, optional): Truncate each attribute to this many characters. Defaults to defaults.TERSE_MAX_CHARS.
