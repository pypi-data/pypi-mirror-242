...
'''
    ...
    def status_report(self, terse=config.TERSE):
...
'''
    ...
    def changes_as_tables(self, terse=config.TERSE, select_cols=None, display_full_objects=config.DISPLAY_FULL_OBJECTS) -> str:
    ...
    def dry_run(self, terse=config.TERSE) -> str:
    ...
    def _tabulate_planned_changes(
        self, dataclass: CSVDataclass, selected_columns, maxcolwidths=None, display_full_objects=config.DISPLAY_FULL_OBJECTS
    ):
