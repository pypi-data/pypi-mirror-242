...
Failed to: {self.proposed_changes.failed_action_msg()}."""
    ...
    #
    #
    def show_all_changes(self, one_line=config.TERSE):
    ...
    def show_changes(self, terse=config.TERSE):  # pragma: no cover  (wrapper method)
    ...
    def show_changes_as_tables(self, terse=config.TERSE, select_cols=None):
    ...
    #
    #
    def enable_trace_downloads(self, threshold_bytes: config.TRACE_THRESHOLD):
