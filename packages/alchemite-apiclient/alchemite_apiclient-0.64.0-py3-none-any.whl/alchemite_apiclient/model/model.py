...
class Model(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            validation_metric (float, none_type): The median of validation metrics (whether R^2 for continuous columns or MCC for categorical columns) across the target columns in the validation set.. [optional]  # noqa: E501
            ...
            shared_through ([str]): If a model has been shared with the user then this will show through which group(s) it has been shared. Won't be set if the user requesting the resource owns it. . [optional]  # noqa: E501
