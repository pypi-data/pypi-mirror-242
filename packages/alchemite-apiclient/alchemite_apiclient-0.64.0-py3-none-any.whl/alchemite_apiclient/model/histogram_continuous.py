...
class HistogramContinuous(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, min, step, counts, *args, **kwargs):  # noqa: E501
        """HistogramContinuous - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, min, step, counts, *args, **kwargs):  # noqa: E501
        """HistogramContinuous - a model defined in OpenAPI
