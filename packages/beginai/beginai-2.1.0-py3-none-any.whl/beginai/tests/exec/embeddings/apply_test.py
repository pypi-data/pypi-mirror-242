...
def test_learn_from_data_for_session():
    ...
    expected = [['2023-01-01', {'embedding': [], 'labels': [], 'tokens': {'input_ids': [], 'attention_mask': [], 'len_': 0}, 'identifiers': {}, 'created_at': None}], ['2023-02-02', {'embedding': [], 'labels': [], 'tokens': {'input_ids': [], 'attention_mask': [], 'len_': 0}, 'identifiers': {}, 'created_at': None}], {'person_id': 'user1', 'object_id': '2023-01-01', 'interaction': {'plays': [
        {'embedding': [100.0, 0.00011], 'created_at': 1715817600.0}, {'embedding': [5000.0, 0.00011], 'created_at': 1715817600.0}]}}, {'person_id': 'user1', 'object_id': '2023-02-02', 'interaction': {'plays': [{'embedding': [130.0, 0.00011], 'created_at': 1715817600.0}]}}, {'person_id': 'user2', 'object_id': '2023-01-01', 'interaction': {'plays': [{'embedding': [900.0, 0.00011], 'created_at': 1715817600.0}]}}]
...
def test_learn_from_data_for_session_and_interactions_and_object():
    ...
    expected = [['22', {'embedding': [], 'labels': [], 'tokens': {'input_ids': [], 'attention_mask': [], 'len_': 0}, 'identifiers': {}, 'created_at': 1715817600.0}], ['90', {'embedding': [], 'labels': [], 'tokens': {'input_ids': [], 'attention_mask': [], 'len_': 0}, 'identifiers': {}, 'created_at': 1715817600.0}], ['2023-01-01', {'embedding': [], 'labels': [], 'tokens': {'input_ids': [], 'attention_mask': [], 'len_': 0}, 'identifiers': {}, 'created_at': None}], ['2023-02-02', {'embedding': [], 'labels': [], 'tokens': {'input_ids': [], 'attention_mask': [], 'len_': 0}, 'identifiers': {}, 'created_at': None}], {'person_id': 'user1', 'object_id': '2023-01-01', 'interaction': {'plays': [{'embedding': [100.0, 0.00011], 'created_at': 1715817600.0}, {'embedding': [5000.0, 0.00011], 'created_at': 1715817600.0}]}}, {'person_id': 'user1', 'object_id': '2023-02-02', 'interaction': {'plays': [{'embedding': [130.0, 0.00011], 'created_at': 1715817600.0}]}}, {'person_id': 'user2', 'object_id': '2023-01-01', 'interaction': {'plays': [{'embedding': [900.0, 0.00011], 'created_at': 1715817600.0}]}}, {'person_id': 'user1', 'object_id': 'hero1', 'interaction': {'has': [{'embedding': [1.0, 1.0, 1.0, 1.0, 0.00011, 0.00011, 0.00011, 0.00011], 'created_at': 1715817600.0}], 'played': [{'embedding': [], 'created_at': 1715817600.0}]}}, {'person_id': 'user1', 'object_id': 'hero2', 'interaction': {'has': [{'embedding': [1.0, 1.0, 1.0, 2.0, 0.00011, 0.00011, 0.00011, 0.00011], 'created_at': 1715817600.0}]}}, {'person_id': 'user2', 'object_id': 'hero1', 'interaction': {'has': [{'embedding': [3.0, 0.00011, 0.00011, 4.0, 0.00011, 0.00011, 0.00011, 0.00011], 'created_at': 1715817600.0}]}}]
