...
def plot_bar_mat(a, b, qmin, qmax, qscore, work_dir, plot_name):
    """
...
def bar(new_entry_dict, score_type, work_dir, score_dir, plot_name):
    ...
    plot_bar_mat(target_value, target_value_two, qmin, qmax, new_entry_dict[score_type], work_dir, plot_name)
