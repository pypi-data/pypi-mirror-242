...
class Device(object):
    ...
    def __init__(self, device_id=None, device_index=None, name=None, description=None, device_type=None, port_count=None, button_count=None, led_count=None, local_vars_configuration=None):  # noqa: E501
