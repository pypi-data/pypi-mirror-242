...
class TestKodiakDatabaseRemoveEndpoint(unittest.TestCase):
    def setUp(self):
    ...
    def test_stop_endpoint_with_valid_data(self):
        ...
        response = self.app.post('/kodiak/database/remove', json=data)
    ...
    def test_stop_endpoint_with_missing_data(self):
        ...
        response = self.app.post('/kodiak/database/remove')
        data = json.loads(response.data)
