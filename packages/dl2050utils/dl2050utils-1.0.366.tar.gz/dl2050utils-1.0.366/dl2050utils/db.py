...
async def calc_query_rows(con, q):
    """
        ...
        The number of rows is obtained by changer the query to count(*) and dropping the sort.
        TODO: Use explain -> fail on joins
    """
    # if 'join' in q:
    q = q.lower()
...
class DB():
    ...
    async def select(self, tbl, join=None, filters=None, sfilters=None, cols='*', sort=None, ascending=True,
