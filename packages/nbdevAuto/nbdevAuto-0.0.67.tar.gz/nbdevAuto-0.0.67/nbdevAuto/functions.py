...
# %% auto 0
__all__ = ['searches', 'path', 'read_from_file', 'download_pic', 'create_searches_folder', 'download_search_image',
           'download_search_images', 'verify_pics', 'resize_pics', 'create_data_folder', 'classify_images',
           'kaggle_download']
...
# %% ../nbs/900_Functions.ipynb 22
#|code-fold: true
def kaggle_download(name:str,
                    folderpath:str = './Data'):
