...
# %% ../nbs/910_Automate.ipynb 8
def upload():
    "prep, then gacp"
    prep()
    gacp()

# %% ../nbs/910_Automate.ipynb 9
def reinstall():
    "runs pip install -e ."
    import subprocess
    subprocess.run(["pip", "install", "-e", "."])

# %% ../nbs/910_Automate.ipynb 10
def update():
    "prep, then reinstall"
    prep()
    reinstall()

# %% ../nbs/910_Automate.ipynb 12
def release_git():
    "release to git"
    import nbdev.release
    nbdev.release.release_git()

# %% ../nbs/910_Automate.ipynb 13
def release_pypi():
    "release to pypi"
    import nbdev.release
    nbdev.release.release_pypi()

# %% ../nbs/910_Automate.ipynb 14
def release():
    "release to github and pip"
    release_git()
    release_pypi()

# %% ../nbs/910_Automate.ipynb 16
def help_output():
    "Show help for all console scripts"
    from fastcore.xtras import console_help
    console_help('nbdevAuto')

# %% ../nbs/910_Automate.ipynb 18
def everything():
