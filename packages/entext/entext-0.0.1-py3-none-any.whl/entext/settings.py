...
SYSTEM_PROMPT: str = (
    ...
    "department/school and which part the university name. Reply in JSON "
    "with no explanation. The JSON should have two fields, one called"
    ...
    'responses use double quotes (") and not single quotes.'
)
