...
from oligopipe.preprocess.annotation import VariantAnnotator, GenePairAnnotator, Annotator
...
class PreprocessPipeline:
    ...
    def execute(self, patient_information, genome_build, db_credentials):
        ...
        annotated_variants, discarded_vars = list(VariantAnnotator(db_credentials, genome_build)
                                                  .annotate(vars_for_annotation, self.variants_compkeys_to_zygosity,
        ...
        db_schema = Annotator(db_credentials, genome_build).db_schema
        logger.info("VarCoPP preprocessing completed!")

        return input_data, discarded_vars_original, db_schema
...
class HOPPreprocessPipeline(PreprocessPipeline):
    ...
    def create_input_data(self, patient_information, annotated_variants, gene_pairs):
        # TODO preprocessing of the seeds ?
