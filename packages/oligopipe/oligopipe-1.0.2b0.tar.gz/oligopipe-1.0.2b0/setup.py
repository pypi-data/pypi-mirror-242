...
setup(
    ...
    url="https://orval.ibsquare.be",
    long_description=read("README.md"),
    long_description_content_type="text/markdown",
    author="Interuniveristy Institute of Bioinformatics Brussels",
    author_email="orval@ibsquare.be",
    maintainer="Emma Verkinderen",
    maintainer_email="orval@ibsquare.be",
    license="MIT",
