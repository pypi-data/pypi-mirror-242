...
from llama.tools.upload_client import upload_file_azure, upload_file_local, upload_data_local, upload_data_azure
import logging
...
class Lamini:
    ...
    def upload_data(self, data_pairs, azure_dir_name="default"):
        try:
            upload_base_path = self.config["powerml"]["upload_base_path"]
        except KeyError:
            upload_base_path = "azure"

        if upload_base_path == "azure":
            upload_path = upload_data_azure(data_pairs, azure_dir_name)
        else:
            upload_path = upload_data_local(data_pairs, upload_base_path)
        self.upload_file_path = upload_path
    ...
    def upload_file(self, data_path, azure_dir_name="default"):
        ...
        if upload_base_path == "azure":
            upload_path = upload_file_azure(data_path, azure_dir_name)
        else:
            upload_path = upload_file_local(data_path, upload_base_path)
        self.upload_file_path = upload_path
