import time
import serial
from .motor_stage_abstract import MotorStageAbstract
...
class MotorStageController(MotorStageAbstract):
    """
    Motorized stage controller interface
    """
    _device_address = 1
    ...
    def disconnect_stage(self):
        ...
        print('Disconnected from Motorized Stage')

    def set_stage_home(self):
        """
        Motorized stage homing
        """
        print('Moving Motorized Stage to Home position...')
    ...
    def move_abs(self, position, units, is_poll=True):
        ...
        Args:
            ...
            is_poll (bool, optional): Wait for arrival to target position.
                                      Defaults to True.
        """
        print(f'Moving stage absolute {position}{units}')
    ...
    def move_rel(self, distance, units, is_poll=True):
        ...
        Args:
            ...
            is_poll (bool, optional): Wait for arrival to target position.
                                      Defaults to True.
        """
        print(f'Moving stage relative {distance}{units}')
