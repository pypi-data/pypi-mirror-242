<template>
  <div :class="[$style['ops-input-wrapper'], props.class]">
    <ULabel v-if="labelText" :required="required" :label-text="labelText" />
    <div
...
.ops-input {
  ...
  &__input {
    @apply w-full text-grey-950 text-[0.875rem] font-medium py-0 px-0 bg-transparent border-0 outline-none #{!important};
    &::placeholder {
