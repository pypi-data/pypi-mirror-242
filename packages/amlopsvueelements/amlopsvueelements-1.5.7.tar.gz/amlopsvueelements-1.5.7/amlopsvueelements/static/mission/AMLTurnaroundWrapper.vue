                  ...
                  <div class="flex items-center justify-between w-full">
                    ...
                    <div class="flex justify-between gap-x-[0.5rem] items-center pr-1">
                      <UCheckboxWrapper
                        ...
                        :disabled="
                          isDisabledField ||
                          !findServiceById(service.service, serviceOptions, missionFormModel.legs[legIndex]?.arrival_location.id).arrival
                        "
                        class="!mb-0 d-flex"
                        size="24px"
                      />
                      <UCheckboxWrapper
                        ...
                        :disabled="
                          isDisabledField ||
                          !findServiceById(service.service, serviceOptions, missionFormModel.legs[legIndex]?.arrival_location.id).departure
                        "
                        class="gap-0 !mb-0"
                        size="24px"
                      />
