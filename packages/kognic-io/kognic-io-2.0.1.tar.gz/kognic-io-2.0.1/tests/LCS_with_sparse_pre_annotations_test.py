...
def build_sparse_pre_annotation_with_interpolated() -> OLM.OpenLabelAnnotation:
    ...
    return OLM.OpenLabelAnnotation(
        openlabel=OLM.Openlabel(
            ...
            objects={
                object_uuid: OLM.Object(
                    name="MyNameIsBox", type="SpaceShip", object_data=OLM.ObjectData(text=[OLM.Text(name="faction", val="empire")])
                )
            },
            frames={
                "0": build_frame(0, object_uuid, build_frame_object_interpolated(0, False, "Medium")),
                "1": build_frame(100, object_uuid, build_frame_object_interpolated(5, True, "Light")),
                "2": build_frame(200, object_uuid, build_frame_object_interpolated(10, True, "Light")),
                "3": build_frame(300, object_uuid, build_frame_object_interpolated(5, False, "Light")),
            },
