...
class Directory:
    ...
    def rename(self, new_name: str) -> None:
        ...
        new_name: Name only (not the entire path)
        """
        try:
    ...
    def delete(
        ...
        :param entire: `True`: deletes the folder itself. `False`: deletes content inside only
        :param based_on_time: `True`: deletes everything except `keep` period. `False`: works normal
        :param keep: Delete all file except current Year|Month|Day
        """
        try:
