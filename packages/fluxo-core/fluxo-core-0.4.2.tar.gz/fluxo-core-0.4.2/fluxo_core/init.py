...
from fluxo_core.settings import settings_path_files_python
from fluxo_core.task import execute_tasks
from fluxo_core.database.db import _verify_if_db_exists
...
class FluxosExecutor:
    ...
    def __init__(self) -> None:
        ...
        '''
        self.path = settings_path_files_python.PATH_FILES_PYTHON
        self.processes = []
