...
class PlotCurve:
    ...
    def single_curve_plot(self,
        ...
        Thus, it will be automatically converted into uM.
        ...
        same unit as the X-axis. i.e., if the axis is in uM, then the number for hte x_concentration should be in uM and
        vice versa.
        :param figsize:
        ...
        if xscale_unit == 'nM':
            ...
            print('Concentration on X-axis converted to uM')
            concentration = concentration / 1000  # convert drug concentration to uM
        else:
        ...
        if xscale_unit == None and xscale_ticks == None:
            ...
            x_fit = np.logspace(0, 5, 100)
        elif xscale_unit == 'uM' and xscale_ticks == None:
            ...
            print('uM with ticks constraints!')
            x_fit = np.logspace(xscale_ticks[0], xscale_ticks[1], 100)
        else:
