...
from turkeypy.compiler import compile, ParseError
from turkeypy.vm import Machine

EXIT_FAILURE = 1
EXIT_SUCCESS = 0

log = logging.getLogger("turkeypy")
...
def main(file: click.File, debug: bool, input: int) -> int:
    """
    A Python re-implementation of the chicken esoteric programming language.
