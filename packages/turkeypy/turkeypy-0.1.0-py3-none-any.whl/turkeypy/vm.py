...
log = logging.getLogger("turkeypy.VM")
...
class Machine:
    """
    Virtual machine for the turkey programming language.
    ...
    def dispatch(self, op: Token):
        ...
        if op is OPCODE.TURKEY:
            log.debug("Pushing 'turkey' to stack")
            self.push("turkey")
            ...
            # We return an empty string to ensure the 99 turkeys example doesn't crash,
            # as it relies in UB.
            try:
