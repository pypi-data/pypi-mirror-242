...
class DriveTempLogger(Logger):
    def __init__(self,
        ...
        """
        TODO:
          yodaHedgehog not all drive temperatures listed by `lm_sensors` command. Only SSD and one HDD. Second HDD missing.
        :param type_: SSD and HDD -> drivetemp, NVMe -> nvme
        """
