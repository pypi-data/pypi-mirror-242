...
class DisallowedScopeError(ValueError):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(
            "Magic comment found in a forbidden scope."
            "Substitutions within a class or function are not allowed.", *args,
            **kwargs
        )
...
class MissingMagicCommentsError(ValueError):
    ...
    def __init__(self, *args, **kwargs):
        super().__init__(
            "No magic comments were found within the file.", *args, **kwargs
        )
...
def parse_file(filename: Path) -> cst.Module:
...
def substitute(filename: Path) -> str:
    ...
    transformer = MagicCommentTransformer(tree.config_for_parsing)
