...
HyperSpy stores the data in the :py:class:`~.api.signals.BaseSignal` class, that is
the object that you get when e.g. you load a single file using
:py:func:`~.api.load`. Most of the data analysis functions are also contained in
this class or its specialized subclasses. The :py:class:`~.api.signals.BaseSignal`
...
:py:attr:`~.api.signals.BaseSignal.data` attribute, the original parameters in the
:py:attr:`~.api.signals.BaseSignal.original_metadata` attribute, the mapped parameters
in the :py:attr:`~.signals.BaseSignal.metadata` attribute and the axes
