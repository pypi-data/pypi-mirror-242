...
:py:class:`~.api.signals.BaseSignal` accept an optional argument `out`. If an
...
shows how to use this feature to slice a :py:class:`~.api.signals.BaseSignal`. It is
important to know that the :py:class:`~.api.signals.BaseSignal` instance passed in
...
:py:class:`~.api.signals.BaseSignal` that would normally be returned by the
operation.
