...
pattern:
{
	...
	"nature": {
		...
		"measures": {
			...
			'''	
			"mass + mass equivalents, of measured ingredients ": {
				"per package": {
					"grams": {
						"decimal string: "",
						"fraction string": "",
						"grams sci note": [ "113.00", "e0" ]
					},
					"ounces": {
						"decimal string: "",
						"fraction string": ""
			...
			#
			#	non-essential, this is not present
		...
		"measured ingredients": {
			...
			"grove": [{
				...
				"measures": {
					#
					#	This is probably almost always one or the other,
					#	but that would imply that it would be like,
					#	0 + 100 or 100 + 0, therefore, this is solid.
					#
