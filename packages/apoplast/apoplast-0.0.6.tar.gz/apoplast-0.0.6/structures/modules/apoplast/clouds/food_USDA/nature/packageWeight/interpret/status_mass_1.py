...
'''
	python3 insurance.py "clouds/food_USDA/nature/packageWeight/interpret/status_1.py"
'''
...
import apoplast.clouds.food_USDA.nature.packageWeight.interpret as interpreter

def check_1 ():	
	proceeds = interpreter.start ("12 oz")
...
def check_2 ():
	proceeds = interpreter.start ("12 oz/340 g")	
	calculated = proceeds.calculated;
	listed = proceeds.listed;
...
def check_3 ():	
	proceeds = interpreter.start ("1 g")
	calculated = proceeds.calculated;
	listed = proceeds.listed;
