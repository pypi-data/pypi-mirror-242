...
#
# Generated Thu Nov 23 00:19:32 2023 by generateDS.py version 2.43.3.
...
#
# Command line:
#   /home/one/init-build-jenkins.zz75cS/one/src/oca/python/bin/generateDS -q -f -o "pyone/bindings/supbind.py" -s "pyone/bindings/__init__.py" --super="supbind" --external-encoding="utf-8" --silence ../../../share/doc/xsd/index.xsd
#
...
class VNETType111Sub(TemplatedType, supermod.VNETType111):
    def __init__(self, ID=None, UID=None, GID=None, UNAME=None, GNAME=None, NAME=None, PERMISSIONS=None, CLUSTERS=None, BRIDGE=None, BRIDGE_TYPE=None, STATE=None, PREV_STATE=None, PARENT_NETWORK_ID=None, VN_MAD=None, PHYDEV=None, VLAN_ID=None, OUTER_VLAN_ID=None, VLAN_ID_AUTOMATIC=None, OUTER_VLAN_ID_AUTOMATIC=None, USED_LEASES=None, VROUTERS=None, TEMPLATE=None, AR_POOL=None, **kwargs_):
        super(VNETType111Sub, self).__init__(ID, UID, GID, UNAME, GNAME, NAME, PERMISSIONS, CLUSTERS, BRIDGE, BRIDGE_TYPE, STATE, PREV_STATE, PARENT_NETWORK_ID, VN_MAD, PHYDEV, VLAN_ID, OUTER_VLAN_ID, VLAN_ID_AUTOMATIC, OUTER_VLAN_ID_AUTOMATIC, USED_LEASES, VROUTERS, TEMPLATE, AR_POOL,  **kwargs_)
...
class LOCKType114Sub(TemplatedType, supermod.LOCKType114):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None, **kwargs_):
        super(LOCKType114Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID,  **kwargs_)
supermod.LOCKType114.subclass = LOCKType114Sub
# end class LOCKType114Sub
...
class VROUTERSType117Sub(TemplatedType, supermod.VROUTERSType117):
    def __init__(self, ID=None, **kwargs_):
        super(VROUTERSType117Sub, self).__init__(ID,  **kwargs_)
supermod.VROUTERSType117.subclass = VROUTERSType117Sub
# end class VROUTERSType117Sub


class TEMPLATEType118Sub(TemplatedType, supermod.TEMPLATEType118):
    def __init__(self, DNS=None, GATEWAY=None, GATEWAY6=None, GUEST_MTU=None, IP6_METHOD=None, IP6_METRIC=None, METHOD=None, METRIC=None, NETWORK_ADDRESS=None, NETWORK_MASK=None, SEARCH_DOMAIN=None, VCENTER_FROM_WILD=None, VCENTER_INSTANCE_ID=None, VCENTER_NET_REF=None, VCENTER_PORTGROUP_TYPE=None, VCENTER_TEMPLATE_REF=None, anytypeobjs_=None, **kwargs_):
        super(TEMPLATEType118Sub, self).__init__(DNS, GATEWAY, GATEWAY6, GUEST_MTU, IP6_METHOD, IP6_METRIC, METHOD, METRIC, NETWORK_ADDRESS, NETWORK_MASK, SEARCH_DOMAIN, VCENTER_FROM_WILD, VCENTER_INSTANCE_ID, VCENTER_NET_REF, VCENTER_PORTGROUP_TYPE, VCENTER_TEMPLATE_REF, anytypeobjs_,  **kwargs_)
supermod.TEMPLATEType118.subclass = TEMPLATEType118Sub
# end class TEMPLATEType118Sub


class AR_POOLType119Sub(TemplatedType, supermod.AR_POOLType119):
    def __init__(self, AR=None, **kwargs_):
        super(AR_POOLType119Sub, self).__init__(AR,  **kwargs_)
supermod.AR_POOLType119.subclass = AR_POOLType119Sub
# end class AR_POOLType119Sub


class ARType120Sub(TemplatedType, supermod.ARType120):
    def __init__(self, AR_ID=None, GLOBAL_PREFIX=None, IP=None, MAC=None, PARENT_NETWORK_AR_ID=None, SIZE=None, TYPE=None, ULA_PREFIX=None, VN_MAD=None, MAC_END=None, IP_END=None, IP6_ULA=None, IP6_ULA_END=None, IP6_GLOBAL=None, IP6_GLOBAL_END=None, IP6=None, IP6_END=None, PORT_START=None, PORT_SIZE=None, USED_LEASES=None, LEASES=None, **kwargs_):
        super(ARType120Sub, self).__init__(AR_ID, GLOBAL_PREFIX, IP, MAC, PARENT_NETWORK_AR_ID, SIZE, TYPE, ULA_PREFIX, VN_MAD, MAC_END, IP_END, IP6_ULA, IP6_ULA_END, IP6_GLOBAL, IP6_GLOBAL_END, IP6, IP6_END, PORT_START, PORT_SIZE, USED_LEASES, LEASES,  **kwargs_)
supermod.ARType120.subclass = ARType120Sub
# end class ARType120Sub
...
class TEMPLATEType123Sub(TemplatedType, supermod.TEMPLATEType123):
    def __init__(self, VN_MAD=None, anytypeobjs_=None, **kwargs_):
        super(TEMPLATEType123Sub, self).__init__(VN_MAD, anytypeobjs_,  **kwargs_)
supermod.TEMPLATEType123.subclass = TEMPLATEType123Sub
# end class TEMPLATEType123Sub


class PERMISSIONSType124Sub(TemplatedType, supermod.PERMISSIONSType124):
    def __init__(self, OWNER_U=None, OWNER_M=None, OWNER_A=None, GROUP_U=None, GROUP_M=None, GROUP_A=None, OTHER_U=None, OTHER_M=None, OTHER_A=None, **kwargs_):
        super(PERMISSIONSType124Sub, self).__init__(OWNER_U, OWNER_M, OWNER_A, GROUP_U, GROUP_M, GROUP_A, OTHER_U, OTHER_M, OTHER_A,  **kwargs_)
supermod.PERMISSIONSType124.subclass = PERMISSIONSType124Sub
# end class PERMISSIONSType124Sub


class LOCKType125Sub(TemplatedType, supermod.LOCKType125):
    def __init__(self, LOCKED=None, OWNER=None, TIME=None, REQ_ID=None, **kwargs_):
        super(LOCKType125Sub, self).__init__(LOCKED, OWNER, TIME, REQ_ID,  **kwargs_)
supermod.LOCKType125.subclass = LOCKType125Sub
# end class LOCKType125Sub


class VMSType126Sub(TemplatedType, supermod.VMSType126):
    def __init__(self, ID=None, **kwargs_):
        super(VMSType126Sub, self).__init__(ID,  **kwargs_)
supermod.VMSType126.subclass = VMSType126Sub
# end class VMSType126Sub
...
class TEMPLATEType127Sub(TemplatedType, supermod.TEMPLATEType127):
    def __init__(self, ENDPOINT=None, **kwargs_):
        super(TEMPLATEType127Sub, self).__init__(ENDPOINT,  **kwargs_)
...
class TEMPLATEType128Sub(TemplatedType, supermod.TEMPLATEType128):
    def __init__(self, ENDPOINT=None, **kwargs_):
        super(TEMPLATEType128Sub, self).__init__(ENDPOINT,  **kwargs_)
supermod.TEMPLATEType128.subclass = TEMPLATEType128Sub
# end class TEMPLATEType128Sub


class SERVER_POOLType129Sub(TemplatedType, supermod.SERVER_POOLType129):
    def __init__(self, SERVER=None, **kwargs_):
        super(SERVER_POOLType129Sub, self).__init__(SERVER,  **kwargs_)
supermod.SERVER_POOLType129.subclass = SERVER_POOLType129Sub
# end class SERVER_POOLType129Sub


class SERVERType130Sub(TemplatedType, supermod.SERVERType130):
    def __init__(self, ENDPOINT=None, ID=None, NAME=None, STATE=None, TERM=None, VOTEDFOR=None, COMMIT=None, LOG_INDEX=None, FEDLOG_INDEX=None, **kwargs_):
        super(SERVERType130Sub, self).__init__(ENDPOINT, ID, NAME, STATE, TERM, VOTEDFOR, COMMIT, LOG_INDEX, FEDLOG_INDEX,  **kwargs_)
supermod.SERVERType130.subclass = SERVERType130Sub
# end class SERVERType130Sub
