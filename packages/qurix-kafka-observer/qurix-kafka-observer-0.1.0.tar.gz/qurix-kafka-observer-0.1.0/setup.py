...
main_ns = {}
with open("qurix/kafka/__version__.py", "r") as file_handler:
...
setup(
    ...
    description="qurix package for observing kafka messages",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/qurixtechnology/qurix-kafka-observer.git",
