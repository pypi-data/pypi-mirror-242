...
class linear_model(object):
    def __init__(self, fitter=HuberRegressor(), transform=None, invtransform=None):
        ...
        Args:
            fitter (scikit-learn model, optional): Linear model class with fit(), predict() and score(). Defaults to HuberRegressor().
    ...
    def fit(self, X, y, shift=0, **kwargs):
        ...
        return prediction, self.uncertainty, self.fitter.score(X_transformed, y_transformed)
