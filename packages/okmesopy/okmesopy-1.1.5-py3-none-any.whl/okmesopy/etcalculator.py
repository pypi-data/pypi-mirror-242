...
class ETCalculator:
    ...
    def hourly_radiation(self,
        ...
        #print(len(w1[numpy.where(w1 < -ws)]), len(ws), len(w1))
        #print(ws)
        #print(w1[1:25], ws[1:25])
        w1[numpy.where(w1 < -ws)] = -ws[numpy.where(w1 < -ws)]
        w2[numpy.where(w2 < -ws)] = -ws[numpy.where(w2 < -ws)]
        w1[numpy.where(w1 >  ws)] =  ws[numpy.where(w1 >  ws)]
        w2[numpy.where(w2 >  ws)] =  ws[numpy.where(w2 >  ws)]
        w1[numpy.where(w1 >  w2)] =  w2[numpy.where(w1 >  w2)]
