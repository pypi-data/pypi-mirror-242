...
setuptools.setup(
    ...
    packages=['ai_management', 'examples'],
    py_modules=['main', 'constants', '__init__'],
    package_data={
        'examples': ['usage_examples.ipynb'], 
        'ai_management': ['main', 'constants', '__init__'],
    },
    install_requires=[
        'pandas', 'numpy', 'scikit-learn', 'google-cloud', 'google-colab', 'google-auth'
    ...
    version='1.0.10',                                # important for updates
