...
CONFIG_TEMPLATE = {
    ...
    'workflow_template_names': ['list',
                                ['Alteon_VX_Status', 'openstack_LBaaS', 'openstack_LBaaS_services_sync', ],
                                None],
...
class RadwareConfFileConfig (RadwareConfig):
    ...
    def convert(value, value_type):
        return RadwareConfFileConfig.types[value_type](value)
    ...
    def get_dict(self):
        ...
        try:
            ...
            raise ex.ConfigurationReadFailure(message=str(e))
