...
MetaCHIP2 detect -o op_dir -i gbk_dir -x gbk -c taxon.tsv -s rooted.tree -v -t 12 -f -r pcofg -mmseqs
MetaCHIP2 detect -o op_dir -i gbk_dir -x gbk -c taxon.tsv -s rooted.tree -v -t 12 -f -r pco
