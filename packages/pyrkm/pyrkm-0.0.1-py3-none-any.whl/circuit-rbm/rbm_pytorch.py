...
class RBM(object):
	...
	*****************************************************************************************************
    ...
    def power_forward(self, v, g_v = 0.5, g_h = 0.5):
        ...
        h_eq = self._RKM_v_to_h(v_centered, W_centered, v_bias_centered, h_bias_centered, g_v, g_h)
    ...
    def power_backward(self, h, g_v = 0.5, g_h = 0.5):
        ...
        h_centered = h - 0.5
        W_centered, v_bias_centered, h_bias_centered = self._center(g_v, g_h)
        v_eq = self._RKM_h_to_v(h_centered, W_centered, v_bias_centered, h_bias_centered, g_v, g_h)
