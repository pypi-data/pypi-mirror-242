...
class convolutional_RBM(RBM):
    def __init__(self,
        ...
        super(convolutional_RBM, self).__init__(model_name, n_vis, n_vis, k, lr, max_epochs, minMax_W, energy_type, optimizer, regularization, l1_factor, l2_factor, ground_v, ground_h, batch_size, train_algo, centering, average_data, sampling_model_beta, nrelu, mytype)
    ...
    #    # Gradients 
    #    dW = (-dEdW_data      + dEdW_model).to_sparse()
