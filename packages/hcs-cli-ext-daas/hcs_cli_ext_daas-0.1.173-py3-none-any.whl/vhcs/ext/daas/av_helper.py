...
from vhcs.sglib.client_util import wait_for_res_status
from vhcs.plan.provider.azure._az_facade import resource_management_client as client
from vhcs.plan.provider.azure._az_facade import storage_management_client as sclient
from azure.storage.fileshare import ShareClient, ShareFileClient
from vhcs.util import hcs_constants
...
def _wait_for_fs_copy_completion(res_group: str, _blob: str, _dest_file: ShareFileClient, timeout: str | int = "10m"):
