...
def input_field(text, key=None):
    """Create a new instance of the custom text input component
    ...
    -------
    list of str
        The user-entered values for each of the custom-styled text input fields.
    """
    input_values = _component_func(text=text, key=key, default=[])
