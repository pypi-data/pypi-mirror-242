...
import typing
__all__ = ['Affine', 'CartesianPose', 'CartesianPoseMotion', 'CartesianPoseReaction', 'CartesianPoseStopMotion', 'CartesianVelocities', 'CartesianVelocityMotion', 'CartesianVelocityReaction', 'CartesianWaypoint', 'CartesianWaypointMotion', 'CommandException', 'Condition', 'ControlException', 'ControlSignalType', 'ControllerMode', 'Duration', 'Errors', 'Exception', 'ExponentialImpedanceMotion', 'GripperException', 'GripperInternal', 'GripperState', 'ImpedanceMotion', 'IncompatibleVersionException', 'InvalidMotionTypeException', 'InvalidOperationException', 'JointPositionMotion', 'JointPositionReaction', 'JointPositionStopMotion', 'JointPositions', 'JointVelocities', 'JointVelocityMotion', 'JointVelocityReaction', 'JointWaypoint', 'JointWaypointMotion', 'Kinematics', 'LinearImpedanceMotion', 'LinearMotion', 'Measure', 'ModelException', 'NetworkException', 'NullSpaceHandling', 'ProtocolException', 'ReactionRecursionException', 'RealtimeConfig', 'RealtimeException', 'ReferenceType', 'RelativeDynamicsFactor', 'RobotInternal', 'RobotMode', 'RobotPose', 'RobotState', 'TorqueMotion', 'TorqueReaction', 'Torques']
class Affine:
    @staticmethod
    ...
    def __getstate__(self) -> tuple:
        ...
    def __mul__(self, arg0: Affine | RobotPose) -> Affine:
        ...
...
class CartesianWaypoint:
    def __init__(self, robot_pose: RobotPose, reference_type: ReferenceType = ..., relative_dynamics_factor: RelativeDynamicsFactor = 1.0, minimum_time: float | None = None) -> None:
        ...
    @property
...
class CartesianWaypointMotion(CartesianPoseMotion):
    def __init__(self, waypoints: list[CartesianWaypoint], frame: Affine | None = None, relative_dynamics_factor: RelativeDynamicsFactor = 1.0, return_when_finished: bool | Condition = True) -> None:
        ...
...
class Condition:
    ...
    def __and__(self, arg0: Condition) -> Condition:
        ...
    @typing.overload
    def __and__(self, arg0: bool | Condition) -> Condition:
        ...
    @typing.overload
    def __eq__(self, arg0: Condition) -> Condition:
        ...
    @typing.overload
    def __eq__(self, arg0: bool | Condition) -> Condition:
        ...
    def __init__(self, constant_value: bool | Condition) -> None:
        ...
    ...
    def __ne__(self, arg0: Condition) -> Condition:
        ...
    @typing.overload
    def __ne__(self, arg0: bool | Condition) -> Condition:
        ...
    @typing.overload
    def __or__(self, arg0: Condition) -> Condition:
        ...
    @typing.overload
    def __or__(self, arg0: bool | Condition) -> Condition:
        ...
...
class ExponentialImpedanceMotion(ImpedanceMotion):
    def __init__(self, target: Affine | RobotPose, target_type: ReferenceType = ..., translational_stiffness: float | RelativeDynamicsFactor = 2000, rotational_stiffness: float | RelativeDynamicsFactor = 200, force_constraints: typing.Annotated[list[float | None], pybind11_stubgen.typing_ext.FixedSize(6)] | None = None, exponential_decay: float | RelativeDynamicsFactor = 0.005) -> None:
        ...
...
class GripperInternal:
    gripper_force: float
    gripper_speed: float
    def __init__(self, fci_hostname: str, speed: float | RelativeDynamicsFactor = 0.02, force: float | RelativeDynamicsFactor = 20.0) -> None:
        ...
    @typing.overload
    def clamp(self) -> bool:
        ...
    @typing.overload
    def clamp(self, min_clamping_width: float | RelativeDynamicsFactor) -> bool:
        ...
    def grasp(self, width: float | RelativeDynamicsFactor, speed: float | RelativeDynamicsFactor, force: float | RelativeDynamicsFactor, epsilon_inner: float | RelativeDynamicsFactor = 0.005, epsilon_outer: float | RelativeDynamicsFactor = 0.005) -> bool:
        ...
    def homing(self) -> bool:
        ...
    @typing.overload
    def move(self, width: float | RelativeDynamicsFactor, speed: float | RelativeDynamicsFactor) -> bool:
        ...
    @typing.overload
    def move(self, width: float | RelativeDynamicsFactor) -> bool:
        ...
    def move_unsafe(self, width: float | RelativeDynamicsFactor) -> bool:
        ...
    def open(self) -> bool:
        ...
    @typing.overload
    def release(self) -> bool:
        ...
    @typing.overload
    def release(self, width: float | RelativeDynamicsFactor) -> bool:
        ...
    def release_relative(self, width_relative: float | RelativeDynamicsFactor) -> bool:
        ...
    def stop(self) -> bool:
        ...
    @property
...
class JointVelocityReaction:
    ...
    def register_callback(self, callback: typing.Callable[[_franky.RobotState, float, float], None]) -> None:
        ...
class JointWaypoint:
    def __init__(self, target: numpy.ndarray[numpy.float64[7, 1]], reference_type: ReferenceType = ..., relative_dynamics_factor: RelativeDynamicsFactor = 1.0, minimum_time: float | None = None) -> None:
        ...
    @property
    def minimum_time(self) -> float | None:
        ...
...
class JointWaypointMotion(JointPositionMotion):
    def __init__(self, waypoints: list[JointWaypoint], relative_dynamics_factor: RelativeDynamicsFactor = 1.0, return_when_finished: bool | Condition = True) -> None:
        ...
class Kinematics:
    @staticmethod
    ...
    def jacobian(q: numpy.ndarray[numpy.float64[7, 1]]) -> numpy.ndarray[numpy.float64[6, 7]]:
        ...
class LinearImpedanceMotion(ImpedanceMotion):
    def __init__(self, target: Affine | RobotPose, duration: float | RelativeDynamicsFactor, target_type: ReferenceType = ..., translational_stiffness: float | RelativeDynamicsFactor = 2000, rotational_stiffness: float | RelativeDynamicsFactor = 200, force_constraints: typing.Annotated[list[float | None], pybind11_stubgen.typing_ext.FixedSize(6)] | None = None, return_when_finished: bool | Condition = True, finish_wait_factor: float | RelativeDynamicsFactor = 1.2) -> None:
        ...
class LinearMotion(CartesianWaypointMotion):
    def __init__(self, target: RobotPose, reference_type: ReferenceType = ..., frame: Affine | None = None, relative_dynamics_factor: RelativeDynamicsFactor = 1.0, return_when_finished: bool | Condition = True) -> None:
        ...
class Measure:
    ...
    def __add__(self, arg0: Measure) -> Measure:
        ...
    @typing.overload
    def __add__(self, arg0: float | RelativeDynamicsFactor) -> Measure:
        ...
    @typing.overload
    def __eq__(self, arg0: Measure) -> Condition:
        ...
    @typing.overload
    def __eq__(self, arg0: float | RelativeDynamicsFactor) -> Condition:
        ...
    @typing.overload
    def __ge__(self, arg0: Measure) -> Condition:
        ...
    @typing.overload
    def __ge__(self, arg0: float | RelativeDynamicsFactor) -> Condition:
        ...
    @typing.overload
    def __gt__(self, arg0: Measure) -> Condition:
        ...
    @typing.overload
    def __gt__(self, arg0: float | RelativeDynamicsFactor) -> Condition:
        ...
    @typing.overload
    def __le__(self, arg0: Measure) -> Condition:
        ...
    @typing.overload
    def __le__(self, arg0: float | RelativeDynamicsFactor) -> Condition:
        ...
    @typing.overload
    def __lt__(self, arg0: Measure) -> Condition:
        ...
    @typing.overload
    def __lt__(self, arg0: float | RelativeDynamicsFactor) -> Condition:
        ...
    @typing.overload
    def __mul__(self, arg0: Measure) -> Measure:
        ...
    @typing.overload
    def __mul__(self, arg0: float | RelativeDynamicsFactor) -> Measure:
        ...
    @typing.overload
    def __ne__(self, arg0: Measure) -> Condition:
        ...
    @typing.overload
    def __ne__(self, arg0: float | RelativeDynamicsFactor) -> Condition:
        ...
    ...
    def __pow__(self, arg0: Measure) -> Measure:
        ...
    @typing.overload
    def __pow__(self, arg0: float | RelativeDynamicsFactor) -> Measure:
        ...
    def __radd__(self, arg0: float | RelativeDynamicsFactor) -> Measure:
        ...
    def __repr__(self) -> str:
        ...
    def __rmul__(self, arg0: float | RelativeDynamicsFactor) -> Measure:
        ...
    def __rpow__(self, arg0: float | RelativeDynamicsFactor) -> Measure:
        ...
    def __rsub__(self, arg0: float | RelativeDynamicsFactor) -> Measure:
        ...
    def __rtruediv__(self, arg0: float | RelativeDynamicsFactor) -> Measure:
        ...
    @typing.overload
    def __sub__(self, arg0: Measure) -> Measure:
        ...
    @typing.overload
    def __sub__(self, arg0: float | RelativeDynamicsFactor) -> Measure:
        ...
    @typing.overload
    def __truediv__(self, arg0: Measure) -> Measure:
        ...
    @typing.overload
    def __truediv__(self, arg0: float | RelativeDynamicsFactor) -> Measure:
        ...
...
class NullSpaceHandling:
    joint_index: int
    value: float
    def __init__(self, joint_index: int, value: float | RelativeDynamicsFactor) -> None:
        ...
...
class RelativeDynamicsFactor:
    ...
    def __init__(self) -> None:
        ...
    @typing.overload
    def __init__(self, value: float | RelativeDynamicsFactor) -> None:
        ...
    @typing.overload
    def __init__(self, velocity: float | RelativeDynamicsFactor, acceleration: float | RelativeDynamicsFactor, jerk: float | RelativeDynamicsFactor) -> None:
        ...
...
class RobotInternal:
    ...
    def forward_kinematics(q: numpy.ndarray[numpy.float64[7, 1]]) -> Affine:
        ...
    @staticmethod
    def inverseKinematics(target: Affine | RobotPose, q0: numpy.ndarray[numpy.float64[7, 1]]) -> numpy.ndarray[numpy.float64[7, 1]]:
        ...
    def __init__(self, fci_hostname: str, relative_dynamics_factor: RelativeDynamicsFactor = 1.0, default_torque_threshold: float | RelativeDynamicsFactor = 20.0, default_force_threshold: float | RelativeDynamicsFactor = 30.0, controller_mode: ControllerMode = ..., realtime_config: RealtimeConfig = ...) -> None:
        ...
    def join_motion(self) -> None:
        ...
    @typing.overload
    def move(self, motion: CartesianPoseMotion, asynchronous: bool | Condition = False) -> None:
        ...
    @typing.overload
    def move(self, motion: CartesianVelocityMotion, asynchronous: bool | Condition = False) -> None:
        ...
    @typing.overload
    def move(self, motion: JointPositionMotion, asynchronous: bool | Condition = False) -> None:
        ...
    @typing.overload
    def move(self, motion: JointVelocityMotion, asynchronous: bool | Condition = False) -> None:
        ...
    @typing.overload
    def move(self, motion: TorqueMotion, asynchronous: bool | Condition = False) -> None:
        ...
    ...
    def set_ee(self, NE_T_EE: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(16)]) -> None:
        ...
    def set_guiding_mode(self, guiding_mode: typing.Annotated[list[bool], pybind11_stubgen.typing_ext.FixedSize(6)], elbow: bool | Condition) -> None:
        ...
    ...
    def set_k(self, EE_T_K: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(16)]) -> None:
        ...
    def set_load(self, load_mass: float | RelativeDynamicsFactor, F_x_Cload: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(3)], load_inertia: typing.Annotated[list[float], pybind11_stubgen.typing_ext.FixedSize(9)]) -> None:
        ...
    def stop(self) -> None:
        ...
    @property
...
class RobotPose:
    def __getstate__(self) -> tuple:
        ...
    @typing.overload
    def __init__(self, end_effector_pose: Affine | RobotPose, elbow_position: float | None = None) -> None:
        ...
    @typing.overload
    def __init__(self, arg0: RobotPose) -> None:
        ...
    def __mul__(self, arg0: Affine | RobotPose) -> RobotPose:
        ...
    def __repr__(self) -> str:
        ...
    def __rmul__(self, arg0: Affine | RobotPose) -> RobotPose:
        ...
    def __setstate__(self, arg0: tuple) -> None:
        ...
