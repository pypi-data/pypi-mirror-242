...
## To use feast package in template -
```python
from refractio import fs

# To get feature store object to perform any operation with feature store
store = fs.get_feature_store("feature_store_name")
```
