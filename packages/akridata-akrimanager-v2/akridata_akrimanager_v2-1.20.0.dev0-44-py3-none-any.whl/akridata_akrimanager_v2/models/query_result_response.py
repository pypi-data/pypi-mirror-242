...
class QueryResultResponse(object):
    ...
    def __init__(self, query_id=None, max_per_page=None, row_count=None, page_token=None, columns_list=None, result_set=None, local_vars_configuration=None):  # noqa: E501
    ...
    def result_set(self, result_set):
        ...
        """
        if self.local_vars_configuration.client_side_validation and result_set is None:  # noqa: E501
            raise ValueError("Invalid value for `result_set`, must not be `None`")  # noqa: E501
