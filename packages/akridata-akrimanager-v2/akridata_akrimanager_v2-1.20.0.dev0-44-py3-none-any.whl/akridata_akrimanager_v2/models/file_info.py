...
class FileInfo(object):
    ...
    def header_map(self, header_map):
        ...
        """
        if self.local_vars_configuration.client_side_validation and header_map is None:  # noqa: E501
            raise ValueError("Invalid value for `header_map`, must not be `None`")  # noqa: E501
