...
class Leapcell(object):
    ...
    def table(
        self, repository: str, table_id: str, name_type: str = "id"
    ) -> LeapcellTable:
        ...
        Args:
            ...
            name_type (str, optional): name_type is the type of the field, it can be "id" or "name". Defaults to "id". if it's "id", the field name will be "13145252145", "13145252147" ...; if it's "name", the field name will be "field-0", "field-1", "field-2", ...,
