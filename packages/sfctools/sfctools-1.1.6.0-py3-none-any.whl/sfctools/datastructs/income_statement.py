...
+---------------------------+--------------------+------------------------------------------------------------------+
    ...
    def __init__(self, owner,data=None,tot_dict=None,total_spendings=0.0,last=None,is_empty=True):
        """
        ...
        self.last = last  # stores income statement of previous period
    ...
    def reset(self):
        ...
        """
        self.last = IncomeStatement(owner=self.owner,data=self.data.copy(),tot_dict=self.tot_dict.copy(),total_spendings=self.total_spendings,is_empty=False) # < TODO test this properly
        self.restore()
