...
from chck import isnone, isdict, notnone, isslice
...
def try2slc(a) -> slice:
    ...
    try: return slice(*list(a))
    except: return a

# %% ../nbs/06_slcs.ipynb 17
def slcchain(x, funcs, *args, **kwargs): 
    return applyfns(x, funcs, isslice, *args, **kwargs)

# %% ../nbs/06_slcs.ipynb 19
def asslc(a, *args, **kwargs) -> slice:
    if isslice(a): return a
    return slcchain(a, (safeslice, try2slc,), *args, **kwargs)
