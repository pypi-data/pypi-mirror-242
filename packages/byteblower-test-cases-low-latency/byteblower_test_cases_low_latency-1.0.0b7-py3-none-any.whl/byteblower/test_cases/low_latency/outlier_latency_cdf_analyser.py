from byteblower_test_framework._analysis.data_analysis import DataAnalyser
import logging
from typing import Optional, Sequence  # for type hinting

from pandas import DataFrame, concat  # for type hinting

from byteblower_test_framework._analysis.storage.trigger import LatencyDistributionData
from byteblower_test_framework._analysis.render.frameblasting import LatencyCDFRenderer
from byteblower_test_framework._analysis.data_gathering.data_gatherer import DataGatherer  # for type hinting
...
class LatencyOutlierDataAnalyser(LatencyCDFAnalyser):
    ...
    def __init__(
        ...
        self._trimmed_avg_latency = None
    ...
    def analyse(self) -> None:
        ...
        try:
            trimmed_latencies_sum, trimmed_packet_count = trimmed_latency_calculator(
...
#! Add as class method ?
def trimmed_latency_calculator(
