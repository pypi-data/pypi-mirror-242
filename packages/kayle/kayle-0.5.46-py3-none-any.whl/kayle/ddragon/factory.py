...
class DDragonFactory:
    ...
    def runes(self, version, language='en_US'):
        ...
        if version + language not in self._runes:
            ...
            extended_informations = requests.get(f"https://raw.communitydragon.org/{cdragon_patch if cdragon_patch != '13.3' else '13.4'}/plugins/rcp-be-lol-game-data/global/en_gb/v1/perks.json").json()
