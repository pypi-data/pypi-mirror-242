...
class ChoiceRule:
    ...
    def run_string_less_than(self):
        raise NotImplementedError()

    def run_string_less_than_path(self):
        raise NotImplementedError()

    def run_string_greater_than(self):
        raise NotImplementedError()

    def run_string_greater_than_path(self):
        raise NotImplementedError()

    def run_string_less_than_equals(self):
        raise NotImplementedError()

    def run_string_less_than_equals_path(self):
        raise NotImplementedError()

    def run_string_greater_than_equals(self):
        raise NotImplementedError()

    def run_string_greater_than_equals_path(self):
        raise NotImplementedError()

    def run_numeric_equals(self):
        raise NotImplementedError()

    def run_numeric_equals_path(self):
        raise NotImplementedError()

    def run_numeric_less_than(self):
        raise NotImplementedError()

    def run_numeric_less_than_path(self):
        raise NotImplementedError()

    def run_numeric_greater_than(self):
        raise NotImplementedError()

    def run_numeric_greater_than_path(self):
        raise NotImplementedError()

    def run_numeric_less_than_equals(self):
        raise NotImplementedError()

    def run_numeric_less_than_equals_path(self):
        raise NotImplementedError()

    def run_numeric_greater_than_equals(self, input_value, rule_value):
        return input_value >= rule_value

    def run_numeric_greater_than_equals_path(self):
        raise NotImplementedError()

    def run_boolean_equals(self):
        raise NotImplementedError()

    def run_boolean_equals_path(self):
        raise NotImplementedError()

    def run_timestamp_equals(self):
        raise NotImplementedError()

    def run_timestamp_equals_path(self):
        raise NotImplementedError()

    def run_timestamp_less_than(self):
        raise NotImplementedError()

    def run_timestamp_less_than_path(self):
        raise NotImplementedError()

    def run_timestamp_greater_than(self):
        raise NotImplementedError()

    def run_timestamp_greater_than_path(self):
        raise NotImplementedError()

    def run_timestamp_less_than_equals(self):
        raise NotImplementedError()

    def run_timestamp_less_than_equals_path(self):
        raise NotImplementedError()

    def run_timestamp_greater_than_equals(self):
        raise NotImplementedError()

    def run_timestamp_greater_than_equals_path(self):
        raise NotImplementedError()

    def run_is_null(self):
        raise NotImplementedError()

    def run_is_present(self):
        raise NotImplementedError()

    def run_is_string(self):
        raise NotImplementedError()

    def run_is_numeric(self):
        raise NotImplementedError()

    def run_is_timestamp(self):
        raise NotImplementedError()

    def run_is_boolean(self):
        raise NotImplementedError()
