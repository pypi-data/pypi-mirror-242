...
class TestVideoUploadInitResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> VideoUploadInitResponse:
        """Test VideoUploadInitResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VideoUploadInitResponse`
        """
        model = VideoUploadInitResponse()  # noqa: E501
        if include_optional:
    ...
    def testVideoUploadInitResponse(self):
        """Test VideoUploadInitResponse"""
