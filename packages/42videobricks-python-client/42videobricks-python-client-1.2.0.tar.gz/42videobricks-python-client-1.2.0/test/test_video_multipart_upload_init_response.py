...
from 42videobricks-python-client.models.video_multipart_upload_init_response import VideoMultipartUploadInitResponse  # noqa: E501
    ...
    def make_instance(self, include_optional) -> VideoMultipartUploadInitResponse:
        ...
        if include_optional:
            return VideoMultipartUploadInitResponse(
                ...
                parts = [
                    42videobricks-python-client.models.video_multipart_upload_init_response_parts_inner.VideoMultipartUploadInitResponse_parts_inner(
