    ...
    def from_omas(self, ods, passive_map='F'):
        ...
        for coil_type in ['pf_active.coil', 'pf_passive.loop']:
            ...
            for isum in ods[coil_type]:
                ...
                if efund_name == 'S':
                    continue
                elif efund_name == 'VS' and coil_type == 'pf_passive.loop':
                    self['IN3']['RSISVS'].append(coil['resistivity'])
        ...
        if 'wall.description_2d[0].vessel.unit' in ods:
            ...
            for i in ods['wall.description_2d.0.vessel.unit']:
                ...
                if 'element' in unit:
                    ...
                    rsisvs[n] = unit['element.0.resistivity']
                    vsid[n] = n + 1
                    vsname[n] = unit['name']
                    n += 1
                elif 'annular' in unit:
                    ...
                    rsisvs[n:nl] = unit['annular.resistivity']
