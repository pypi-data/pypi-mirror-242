...
# This was proposed in https://jira.iter.org/projects/IMAS/issues/IMAS-4207.
# The differences between chi_squared_total and chi_squared_extended come from how EFIT outputs the results.  It is unlikely both will be allowed to enter the IMAS standard, but still are useful in the context of EFIT.
_extra_structures = {
    'equilibrium': {
        'equilibrium.time_slice[:].constraints.chi_squared_total': {
            "data_type": "FLT_0D",
            "documentation": "A sum of the chi squared values for measurements " "which is checked to determine the convergence.",
            "full_path": "equilibrium/time_slice(itime)/constraints/chi_squared_total",
        },
        'equilibrium.time_slice[:].constraints.chi_squared_extended': {
            "data_type": "FLT_0D",
            "documentation": "A sum of all the chi squared values for measurements " "which isn't directly used in the code.",
            "full_path": "equilibrium/time_slice(itime)/constraints/chi_squared_extended",
        },
    }
}
...
class OMFITaeqdsk(SortedDict, OMFITascii):
    ...
    def add_aeqdsk_documentation(self):
        ...
        desc['aaq1'] = 'minor radius of q=1 surface in cm, 100 if not found'
        desc['aaq2'] = 'minor radius of q=2 surface in cm, 100 if not found'
        desc['aaq3'] = 'minor radius of q=3 surface in cm, 100 if not found'
        desc['ali'] = 'li with normalization average poloidal magnetic defined  through Ampere’s law '
        desc['ali3'] = ''
        desc['alpha'] = 'Shafranov boundary line integral parameter'
        desc['aout'] = 'plasma minor radius in cm'
        desc['areao'] = 'cross sectional area in cm2'
        ...
        desc['cpasma'] = 'fitted plasma toroidal current in Ampere-turn'
        ...
        desc['doutl'] = 'upper triangularity'
        desc['doutu'] = 'upper triangularity'
        desc['eccurt'] = 'measured E-coil current in Ampere'
        desc['elongm'] = 'elongation at magnetic axis'
        desc['eout'] = 'Plasma boundary elongation'
        ...
        desc['nsilop0'] = ''
        desc['obots'] = 'bottom gap of external second separatrix in cm'
        desc['obott'] = 'plasma bottom gap in cm'
        desc['olefs'] = 'inner gap of external second separatrix in cm'
        desc['oleft'] = 'plasma inner gap in cm'
        desc['orighs'] = 'outer gap of external second separatrix in cm'
        desc['oright'] = 'plasma outer gap in cm'
        desc['oring'] = 'not used'
        desc['otop'] = 'plasma top gap in cm'
        desc['otops'] = 'top gap of external second separatrix in cm'
        desc['pasmat'] = 'measured plasma toroidal current in Ampere'
        ...
        desc['qpsib'] = 'q at 95% of poloidal flux'
        desc['qqmagx'] = 'axial safety factor q(0)'
        desc['qqmin'] = 'minimum safety factor qmin'
        desc['qsta'] = 'equivalent safety factor q*'
        ...
        desc['shearb'] = 'magnetic shear at 95% enclosed normalized poloidal flux'
        desc['shot'] = 'Machine specific shot number'
        desc['sibdry'] = 'plasma boundary poloidal flux in Weber/rad'
        desc['simagx'] = 'boundary poloidal flux in Weber/rad at magnetic axis'
        desc['slantl'] = 'gap to lower outboard limiter in cm'
        desc['slantu'] = 'gap to upper outboard limiter in cm'
        desc[
            'ssep'
        ] = 'outboard radial distance to external second separatrix in  cm for single null  configurations, > 0 for SNT,  < 0 for SNB, defaulted to    be 40 cm '
        ...
        desc['tchimls'] = ''
        desc['terror'] = 'equilibrium convergence error'
        desc['tflux'] = ''
        desc['time'] = 'time in ms'
        desc['tsaisq'] = 'total χ2 from magnetic probes, flux loops, Rogowskiand external  coils '
        desc['twagap'] = ''
        desc['vertn'] = 'vacuum field index at current centroid'
        desc['vloopt'] = 'measured loop voltage in volt'
        desc['vout'] = 'plasma volume in m3'
        desc['vsurfa'] = 'plasma surface loop voltage in volt, E EQDSK only'
        desc['wbdot'] = 'time derivative of poloidal magnetic  energy in Watt, E EQDSK  only '
        desc['wpdot'] = 'time derivative of plasma stored  energy in Watt, E EQDSK  only '
        desc['wplasm'] = ''
        desc['wplasmd'] = 'diamagnetic plasma stored energy in Joule'
        desc['xbetapr'] = ''
        desc['xndnt'] = 'plasma boundary indentation'
        ...
        desc['zmagx'] = 'Z in cm at magnetic axis'
        desc['zout'] = 'Z of geometric center in cm'
...
class OMFITmeqdsk(OMFITnc):
    ...
    def to_omas(self, ods=None, time_index=0, time_index_efit=0):
        ...
        with omas_environment(ods, cocosio=1):
            ...
            constr['chi_squared_total'] = self['cchisq']['data'][time_index_efit, i - 1]
            # Only in EFIT-AI version
            if 'chifin' in self:
                # better to use the updated chi squared value rather than the last iteration, when available
                constr['chi_squared_total'] = self['chifin']['data'][time_index_efit]
            if 'chitot' in self:
                constr['chi_squared_extended'] = self['chitot']['data'][time_index_efit]
