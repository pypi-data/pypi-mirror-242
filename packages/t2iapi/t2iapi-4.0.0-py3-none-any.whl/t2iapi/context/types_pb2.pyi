...
class ContextType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = []
    CONTEXT_TYPE_PATIENT: _ClassVar[ContextType]
    CONTEXT_TYPE_LOCATION: _ClassVar[ContextType]
    CONTEXT_TYPE_WORKFLOW: _ClassVar[ContextType]
    CONTEXT_TYPE_OPERATOR: _ClassVar[ContextType]
    CONTEXT_TYPE_MEANS: _ClassVar[ContextType]
    CONTEXT_TYPE_ENSEMBLE: _ClassVar[ContextType]
